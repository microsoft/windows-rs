...
impl AutomationHeadingLevel {
    fn property_value(self) -> PropertyValue {
        match self {
            ...
            Self::Level2 => PropertyValue::Enum {
                kind: "AutomationHeadingLevel",
                variant: "Level2",
            },
            Self::Level3 => PropertyValue::Enum {
                kind: "AutomationHeadingLevel",
                variant: "Level3",
            },
            Self::Level4 => PropertyValue::Enum {
                kind: "AutomationHeadingLevel",
                variant: "Level4",
            },
            Self::Level5 => PropertyValue::Enum {
                kind: "AutomationHeadingLevel",
                variant: "Level5",
            },
            Self::Level6 => PropertyValue::Enum {
                kind: "AutomationHeadingLevel",
                variant: "Level6",
            },
            Self::Level7 => PropertyValue::Enum {
                kind: "AutomationHeadingLevel",
                variant: "Level7",
            },
            Self::Level8 => PropertyValue::Enum {
                kind: "AutomationHeadingLevel",
                variant: "Level8",
            },
            Self::Level9 => PropertyValue::Enum {
                kind: "AutomationHeadingLevel",
                variant: "Level9",
            },
        }
...
macro_rules! visual_methods {
    () => {
        ...
        pub fn grid_row(mut self, grid_row: i32) -> Self {
            assert!(grid_row >= 0, "GridRow requires non_negative");
            self.0 = self
                .0
                .property(PropertyId::GridRow, PropertyValue::I32(grid_row));
            self
        }
        pub fn grid_column(mut self, grid_column: i32) -> Self {
            assert!(grid_column >= 0, "GridColumn requires non_negative");
            self.0 = self
                .0
                .property(PropertyId::GridColumn, PropertyValue::I32(grid_column));
            self
        }
        pub fn grid_row_span(mut self, grid_row_span: i32) -> Self {
            assert!(grid_row_span > 0, "GridRowSpan requires positive");
            self.0 = self
                .0
                .property(PropertyId::GridRowSpan, PropertyValue::I32(grid_row_span));
            self
        }
        pub fn grid_column_span(mut self, grid_column_span: i32) -> Self {
            assert!(grid_column_span > 0, "GridColumnSpan requires positive");
            self.0 = self.0.property(
                PropertyId::GridColumnSpan,
                PropertyValue::I32(grid_column_span),
            );
            self
        }
        pub fn relative_align_left(mut self) -> Self {
            self.0 = self
                .0
                .property(PropertyId::RelativeAlignLeft, PropertyValue::Bool(true));
            self
        }
        pub fn relative_align_top(mut self) -> Self {
            self.0 = self
                .0
                .property(PropertyId::RelativeAlignTop, PropertyValue::Bool(true));
            self
        }
        pub fn relative_align_right(mut self) -> Self {
            self.0 = self
                .0
                .property(PropertyId::RelativeAlignRight, PropertyValue::Bool(true));
            self
        }
        pub fn relative_align_bottom(mut self) -> Self {
            self.0 = self
                .0
                .property(PropertyId::RelativeAlignBottom, PropertyValue::Bool(true));
            self
        }
        pub fn relative_align_horizontal_center(mut self) -> Self {
            self.0 = self.0.property(
        ...
        pub fn relative_align_vertical_center(mut self) -> Self {
            self.0 = self.0.property(
        ...
        pub fn automation_name(mut self, automation_name: impl Into<Rc<str>>) -> Self {
            self.0 = self.0.property(
                PropertyId::AutomationName,
                PropertyValue::String(automation_name.into()),
            );
            self
        }
        pub fn automation_id(mut self, automation_id: impl Into<Rc<str>>) -> Self {
            self.0 = self.0.property(
                PropertyId::AutomationId,
                PropertyValue::String(automation_id.into()),
            );
            self
        }
        pub fn automation_heading_level(
            mut self,
            automation_heading_level: AutomationHeadingLevel,
        ) -> Self {
            self.0 = self.0.property(
                PropertyId::AutomationHeadingLevel,
                automation_heading_level.property_value(),
            );
            self
        }
        ...
        pub fn min_width(mut self, min_width: f64) -> Self {
            self.0 = self
                .0
                .property(PropertyId::MinWidth, PropertyValue::F64(min_width));
            self
        }
        pub fn max_width(mut self, max_width: f64) -> Self {
            self.0 = self
                .0
                .property(PropertyId::MaxWidth, PropertyValue::F64(max_width));
            self
        }
        pub fn min_height(mut self, min_height: f64) -> Self {
            self.0 = self
                .0
                .property(PropertyId::MinHeight, PropertyValue::F64(min_height));
            self
        }
        pub fn max_height(mut self, max_height: f64) -> Self {
            self.0 = self
                .0
                .property(PropertyId::MaxHeight, PropertyValue::F64(max_height));
            self
        }
...
impl TextBlock {
    ...
    pub fn font_weight(mut self, font_weight: FontWeight) -> Self {
        self.0 = self.0.property(
            ...
            PropertyValue::FontWeight(font_weight),
        );
        self
    }
...
impl Grid {
    ...
    pub fn rows(mut self, values: impl IntoIterator<Item = GridLength>) -> Self {
        self.0 = self.0.property(
            PropertyId::GridRows,
            PropertyValue::GridLengths(values.into_iter().collect()),
        );
        self
    }
...
impl ItemsRepeater {
    ...
    pub fn item(mut self, key: impl Into<Key>, visual: impl Into<Visual>) -> Self {
        self.0 = self.0.virtual_item(RelationId::Items, keyed(key, visual));
        self
    }
    pub fn items(mut self, items: impl IntoIterator<Item = KeyedVisual>) -> Self {
        self.0 = self
            .0
            .virtual_items(RelationId::Items, VirtualItems::eager(items));
        self
    }
    pub fn virtual_source(mut self, source: VirtualSource) -> Self {
        self.0 = self
            .0
            .virtual_items(RelationId::Items, VirtualItems::Lazy(source));
        self
    }
}
...
impl RichEditBox {
    ...
    pub fn text(mut self, text: impl Into<Rc<str>>) -> Self {
        self.0 = self.0.property(
            PropertyId::Document,
            PropertyValue::String(canonical_rich_edit_text(text.into())),
        );
        self
    }
    pub fn placeholder_text(mut self, placeholder_text: impl Into<Rc<str>>) -> Self {
