...
This sample qualifies `windows-reactor` virtualization with application behavior rather than
...
- direct selection input for each keyed row;
...
```powershell
cargo run -p reactor-virtual --bin reactor-virtual-live-perf `
