fn main() -> windows::core::Result<()> {
    ...
    unsafe {
        ...
        let job = job.unwrap();
        let destination = std::env::temp_dir().join("windows-rs-bits.svg");
        ...
        job.AddFile(
            w!(
                "https://raw.githubusercontent.com/microsoft/windows-rs/master/crates/samples/reactor/icon-elements/image.svg"
            ),
