...
impl windows_core::RuntimeName for IWidget {
    const NAME: &'static str = "Bench.IWidget";
}
pub trait IWidget_Impl: windows_core::IUnknownImpl {
    ...
    fn ObjectOperation(&self)
    -> windows_core::Result<windows_future::IAsyncOperation<INonDefault>>;
    fn Add(&self, a: i32, b: i32) -> windows_core::Result<i32>;
    fn SumArray(&self, values: &[i32]) -> windows_core::Result<i32>;
    fn Values(&self) -> windows_core::Result<windows_core::Array<i32>>;
    fn GetValues(&self, values: &mut windows_core::Array<i32>) -> windows_core::Result<()>;
    fn EchoString(
        &self,
        value: &windows_core::HSTRING,
    ) -> windows_core::Result<windows_core::HSTRING>;
    fn Echo(&self, value: windows_core::Ref<INonDefault>) -> windows_core::Result<INonDefault>;
    fn LiveCount(&self) -> windows_core::Result<i32>;
    fn Fail(&self) -> windows_core::Result<()>;
    fn FailWithMessage(&self) -> windows_core::Result<()>;
    fn Signal(&self, value: i32) -> windows_core::Result<()>;
    ...
    fn Map(&self, count: u32) -> windows_core::Result<windows_collections::IMap<i32, i32>>;
    fn StringMap(
        &self,
        count: u32,
    ...
    fn ItemsView(&self, count: u32) -> windows_core::Result<windows_collections::IVectorView<i32>>;
    fn MapView(&self, count: u32) -> windows_core::Result<windows_collections::IMapView<i32, i32>>;
    fn Changed(&self, handler: windows_core::Ref<ChangedHandler>) -> windows_core::Result<i64>;
    fn RemoveChanged(&self, token: i64) -> windows_core::Result<()>;
}
impl IWidget_Vtbl {
    pub const fn new<Identity: IWidget_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Int32Property<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::Int32Property(this) {
                    Ok(ok__) => {
                        result__.write(ok__);
                        windows_core::HRESULT(0)
                    }
        ...
        unsafe extern "system" fn SetInt32Property<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWidget_Impl::SetInt32Property(this, value).into()
            }
        }
        unsafe extern "system" fn StringProperty<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::StringProperty(this) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn SetStringProperty<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWidget_Impl::SetStringProperty(this, core::mem::transmute(&value)).into()
            }
        }
        unsafe extern "system" fn ObjectProperty<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::ObjectProperty(this) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn SetObjectProperty<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWidget_Impl::SetObjectProperty(this, core::mem::transmute_copy(&value)).into()
            }
        }
        unsafe extern "system" fn ReferenceProperty<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::ReferenceProperty(this) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWidget_Impl::SetReferenceProperty(this, core::mem::transmute_copy(&value)).into()
            }
        }
        unsafe extern "system" fn Operation<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::Operation(this) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn StringOperation<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::StringOperation(this) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn ObjectOperation<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::ObjectOperation(this) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn Add<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            a: i32,
            b: i32,
            result__: *mut i32,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::Add(this, a, b) {
                    Ok(ok__) => {
                        result__.write(ok__);
                        windows_core::HRESULT(0)
                    }
        ...
        unsafe extern "system" fn SumArray<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ...
        unsafe extern "system" fn Values<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::Values(this) {
                    Ok(ok__) => {
        ...
        unsafe extern "system" fn GetValues<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            values_array_size: *mut u32,
            values: *mut *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWidget_Impl::GetValues(
                    this,
        ...
        unsafe extern "system" fn EchoString<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::EchoString(this, core::mem::transmute(&value)) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn Echo<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: *mut core::ffi::c_void,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::Echo(this, core::mem::transmute_copy(&value)) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn LiveCount<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            result__: *mut i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::LiveCount(this) {
                    Ok(ok__) => {
                        result__.write(ok__);
                        windows_core::HRESULT(0)
                    }
        ...
        unsafe extern "system" fn Fail<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWidget_Impl::Fail(this).into()
            }
        }
        unsafe extern "system" fn FailWithMessage<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWidget_Impl::FailWithMessage(this).into()
            }
        }
        unsafe extern "system" fn Signal<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            value: i32,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWidget_Impl::Signal(this, value).into()
            }
        }
        unsafe extern "system" fn Items<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::Items(this, count) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn StringItems<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::StringItems(this, count) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn Map<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::Map(this, count) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn StringMap<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::StringMap(this, count) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn StringValues<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::StringValues(this, count) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn ItemsView<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::ItemsView(this, count) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn MapView<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            count: u32,
            result__: *mut *mut core::ffi::c_void,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::MapView(this, count) {
                    Ok(ok__) => {
                        result__.write(core::mem::transmute_copy(&ok__));
                        core::mem::forget(ok__);
                        windows_core::HRESULT(0)
        ...
        unsafe extern "system" fn Changed<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IWidget_Impl::Changed(this, core::mem::transmute_copy(&handler)) {
                    Ok(ok__) => {
                        result__.write(ok__);
                        windows_core::HRESULT(0)
                    }
        ...
        unsafe extern "system" fn RemoveChanged<Identity: IWidget_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            token: i64,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IWidget_Impl::RemoveChanged(this, token).into()
            }
        }
        Self {
            ...
            StringOperation: StringOperation::<Identity, OFFSET>,
            ObjectOperation: ObjectOperation::<Identity, OFFSET>,
            Add: Add::<Identity, OFFSET>,
            SumArray: SumArray::<Identity, OFFSET>,
            Values: Values::<Identity, OFFSET>,
            GetValues: GetValues::<Identity, OFFSET>,
            EchoString: EchoString::<Identity, OFFSET>,
            Echo: Echo::<Identity, OFFSET>,
            LiveCount: LiveCount::<Identity, OFFSET>,
            Fail: Fail::<Identity, OFFSET>,
            FailWithMessage: FailWithMessage::<Identity, OFFSET>,
            Signal: Signal::<Identity, OFFSET>,
            Items: Items::<Identity, OFFSET>,
            StringItems: StringItems::<Identity, OFFSET>,
            Map: Map::<Identity, OFFSET>,
            StringMap: StringMap::<Identity, OFFSET>,
            StringValues: StringValues::<Identity, OFFSET>,
            ItemsView: ItemsView::<Identity, OFFSET>,
            MapView: MapView::<Identity, OFFSET>,
