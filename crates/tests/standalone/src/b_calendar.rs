...
impl Calendar {
    ...
    pub fn Clone(&self) -> ::windows_core::Result<Calendar> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<Calendar>();
    ...
    pub fn Languages(&self) -> ::windows_core::Result<IVectorView<::windows_core::HSTRING>> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<IVectorView<::windows_core::HSTRING>>();
    ...
    pub fn DayOfWeek(&self) -> ::windows_core::Result<DayOfWeek> {
        let this = self;
        unsafe {
            let mut result__ = ::windows_core::zeroed::<DayOfWeek>();
