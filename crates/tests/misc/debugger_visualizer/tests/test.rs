...
//     fn GetGUID(&self) -> Result<GUID, HRESULT> {
//         Err(Error::new(E_OUTOFMEMORY, "Out of memory message").into())
//     }
//     fn GetSource(&self) -> Result<BSTR, HRESULT> {
//         Err(Error::new(E_INVALIDARG, "Invalid argument message").into())
//     }
//     fn GetDescription(&self) -> Result<BSTR, HRESULT> {
//         Ok(BSTR::new())
//     }
//     fn GetHelpFile(&self) -> Result<BSTR, HRESULT> {
//         Ok(BSTR::new())
//     }
//     fn GetHelpContext(&self) -> Result<u32, HRESULT> {
//         Ok(1)
//     }
// }
...
//         let out_of_memory_error: Error = result.unwrap_err().into();
...
//         let invalid_argument_error: Error = result.unwrap_err().into();
