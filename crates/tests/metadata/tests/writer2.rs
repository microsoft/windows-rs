...
fn writer() {
    let temp_file = std::env::temp_dir().join("test2.winmd");
    {
        ...
        items.push(Struct::new("Test", "Outer", vec![Field::new("Value", Type::named("Test", "Inner"))]));

        items.push(Enum::new("Test", "Things", vec![Constant::new("One", Value::U32(1)), Constant::new("Two", Value::U32(2))]));
