...
impl Activatable {
    ...
    pub fn WithValue(arg: i32) -> windows_result::Result<Activatable> {
    ...
    fn IActivatableFactory<R, F: FnOnce(&IActivatableFactory) -> windows_result::Result<R>>(
        callback: F,
    ) -> windows_result::Result<R> {
...
impl Composable {
    ...
    pub fn new() -> windows_result::Result<Composable> {
    ...
    pub fn WithValue(arg: i32) -> windows_result::Result<Composable> {
        Self::IComposableFactory(|this| unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(this).WithValue)(
                windows_core::Interface::as_raw(this),
    ...
    fn IComposableFactory<R, F: FnOnce(&IComposableFactory) -> windows_result::Result<R>>(
        callback: F,
    ) -> windows_result::Result<R> {
...
pub trait IActivatableFactory_Impl: windows_core::IUnknownImpl {
    fn WithValue(&self, arg: i32) -> windows_result::Result<Activatable>;
}
...
pub trait IComposableFactory_Impl: windows_core::IUnknownImpl {
    ...
    ) -> windows_result::Result<Composable>;
    fn WithValue(
        &self,
        arg: i32,
        baseInterface: windows_core::Ref<windows_core::IInspectable>,
