...
impl Class {
    ...
    pub fn Signal(&self, value: i32) -> windows_result::Result<i32> {
        let this = self;
        unsafe {
    ...
    pub fn Event<P0>(&self, handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveEvent(&self, token: i64) -> windows_result::Result<()> {
        let this = self;
        unsafe {
    ...
    pub fn StaticSignal(value: i32) -> windows_result::Result<i32> {
    ...
    pub fn StaticEvent<P0>(handler: P0) -> windows_result::Result<i64>
    where
    ...
    pub fn RemoveStaticEvent(token: i64) -> windows_result::Result<()> {
        Self::IClassStatics(|this| unsafe {
    ...
    fn IClassStatics<R, F: FnOnce(&IClassStatics) -> windows_result::Result<R>>(
        callback: F,
    ) -> windows_result::Result<R> {
...
pub trait IClass_Impl: windows_core::IUnknownImpl {
    fn Signal(&self, value: i32) -> windows_result::Result<i32>;
    fn Event(
        &self,
        handler: windows_core::Ref<windows::Foundation::TypedEventHandler<Class, i32>>,
    ) -> windows_result::Result<i64>;
    fn RemoveEvent(&self, token: i64) -> windows_result::Result<()>;
}
impl IClass_Vtbl {
...
pub trait IClassStatics_Impl: windows_core::IUnknownImpl {
    fn StaticSignal(&self, value: i32) -> windows_result::Result<i32>;
    fn StaticEvent(
        &self,
        handler: windows_core::Ref<windows::Foundation::EventHandler<i32>>,
    ) -> windows_result::Result<i64>;
    fn RemoveStaticEvent(&self, token: i64) -> windows_result::Result<()>;
}
