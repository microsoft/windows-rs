...
impl bindings::IA_Impl for A_Impl {
    fn Method(&self) -> Result<i32, HRESULT> {
        Ok(1)
    }
    fn Method2(&self, _: i32) -> Result<i32, HRESULT> {
        Ok(2)
    }
}
...
impl bindings::IB_Impl for B_Impl {
    fn MethodOne(&self) -> Result<i32, HRESULT> {
        Ok(3)
    }
    fn MethodTwo(&self, _: i32) -> Result<i32, HRESULT> {
        Ok(4)
    }
}
...
impl bindings::ID2_Impl for D_Impl {
    fn Method(&self, _: i32, _: i32) -> Result<i32, HRESULT> {
        Ok(9)
    }
    fn Method2(&self, _: i32, _: i32, _: i32) -> Result<i32, HRESULT> {
        Ok(10)
    }
}
...
impl bindings::IE2_Impl for E_Impl {
    fn MethodThree(&self, _: i32, _: i32) -> Result<i32, HRESULT> {
        Ok(13)
    }
    fn MethodFour(&self, _: i32, _: i32, _: i32) -> Result<i32, HRESULT> {
        Ok(14)
    }
}
