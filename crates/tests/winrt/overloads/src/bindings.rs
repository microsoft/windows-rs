...
pub trait IA_Impl: windows_core::IUnknownImpl {
    fn Method(&self) -> windows_result::Result<i32>;
    fn Method2(&self, a: i32) -> windows_result::Result<i32>;
}
impl IA_Vtbl {
...
pub trait IB_Impl: windows_core::IUnknownImpl {
    fn MethodOne(&self) -> windows_result::Result<i32>;
    fn MethodTwo(&self, a: i32) -> windows_result::Result<i32>;
}
impl IB_Vtbl {
...
pub trait ID2_Impl: windows_core::IUnknownImpl {
    fn Method(&self, a: i32, b: i32) -> windows_result::Result<i32>;
    fn Method2(&self, a: i32, b: i32, c: i32) -> windows_result::Result<i32>;
}
impl ID2_Vtbl {
...
pub trait IE2_Impl: windows_core::IUnknownImpl {
    fn MethodThree(&self, a: i32, b: i32) -> windows_result::Result<i32>;
    fn MethodFour(&self, a: i32, b: i32, c: i32) -> windows_result::Result<i32>;
}
impl IE2_Vtbl {
