...
unsafe trait ITestPersistMemory: windows::Win32::objidl::IPersist {
    unsafe fn IsDirty(&self) -> windows::core::HRESULT;
}

#[windows::core::implement(ITestPersistMemory, windows::Win32::objidl::IPersist)]
struct Test;

impl windows::Win32::objidl::IPersist_Impl for Test_Impl {
...
impl ITestPersistMemory_Impl for Test_Impl {
    unsafe fn IsDirty(&self) -> windows::core::HRESULT {
        windows::Win32::winerror::S_FALSE
    }
}
...
fn test() -> windows::core::Result<()> {
    unsafe {
        let p: windows::Win32::objidl::IPersist = Test.into();
        assert_eq!(
            p.GetClassID()?,
            "CEE1D356-0860-4262-90D4-C77423F0E352".try_into()?
        );
        ...
        assert_eq!(m.IsDirty(), windows::Win32::winerror::S_FALSE);
