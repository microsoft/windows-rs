pub mod Test {
    ...
    impl Foo {
        pub fn Direct(&self) -> i32 {
            unsafe {
                ...
                let hresult__ = (windows_core::Interface::vtable(self).Direct)(
    ...
    windows_core::imp::define_interface!(
        IFooFactory,
        IFooFactory_Vtbl,
        0x9d53c1f7_c520_55c6_bc47_036eb66767bd
    );
    ...
    pub struct IFooFactory_Vtbl {
        pub base__: windows_core::IInspectable_Vtbl,
        pub CreateFoo: unsafe extern "system" fn(
            *mut core::ffi::c_void,
    ...
    windows_core::imp::define_interface!(
        IFooStatics,
        IFooStatics_Vtbl,
        0x73778a72_36a6_5937_9647_359ca4774f29
    );
