namespace Sample
{
    public sealed unsafe class Handle : WindowsCsharp.ComObject, WindowsCsharp.IComInterface<Handle>, WindowsCsharp.IObjectParameter<Sample.Handle._Parameter>
    {
        public readonly struct _Parameter {}
        public static Guid Iid { get; } = new Guid(0x8f5935f4, 0x6f3d, 0x52fc, 0x94, 0x90, 0xa8, 0x87, 0xbe, 0xda, 0xf9, 0x21);

        internal Handle(nint self) : base(self, Iid) {}
        internal Handle(nint self, bool trustedAgile) : base(self, trustedAgile) {}
        static Handle WindowsCsharp.IComInterface<Handle>.FromAbi(nint self) => new Handle(self);
        static Handle WindowsCsharp.IComInterface<Handle>.FromAgileAbi(nint self) => new Handle(self, true);
