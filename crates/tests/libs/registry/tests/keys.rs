...
fn keys() -> Result<(), HRESULT> {
    ...
    assert_eq!(err, HRESULT(0x80070002u32 as i32)); // HRESULT_FROM_WIN32(ERROR_FILE_NOT_FOUND)
    ...
    assert_eq!(err, HRESULT(0x80070005u32 as i32)); // E_ACCESSDENIED
