...
struct ITypes {
    ...
    virtual void __stdcall VoidPtrMut2(void** a) = 0;          // PtrMut(PtrMut(Void, 1), 1)
    ...
    virtual void __stdcall BoolPtrMut2(bool** a) = 0;          // PtrMut(PtrMut(Bool, 1), 1)
    virtual void __stdcall BoolPtrConst(bool const* a) = 0;    // PtrConst(Bool, 1)
    // TODO: Type::ArrayFixed
    ...
    virtual void __stdcall TypeValue(Type a) = 0;              // Type::ValueName
    virtual void __stdcall TypeRefMut(Type& a) = 0;            // Type::RefMut
    virtual void __stdcall TypeRefConst(Type const& a) = 0;    // Type::RefConst
    virtual void __stdcall TypePtrMut(Type* a) = 0;            // Type::PtrMut(T, 1)
    virtual void __stdcall TypePtrMut2(Type** a) = 0;          // Type::PtrMut(T, 2)
    virtual void __stdcall TypePtrConst(Type const* a) = 0;    // Type::PtrConst(T, 1)
    // TODO: Type::ArrayFixed
};
