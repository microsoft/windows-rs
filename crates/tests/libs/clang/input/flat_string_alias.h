...
// Flat per-header scrape (`tool-win32` mode, `header_root.is_some()`): string-pointer
...
// the namespaced (`tool-webview`) counterpart, where only parameters normalise and the
