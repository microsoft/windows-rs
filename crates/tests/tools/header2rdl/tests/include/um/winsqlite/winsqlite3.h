...
struct sqlite3_vfs {
  ...
  int (SQLITE_CALLBACK *xOpen)(sqlite3_vfs*, sqlite3_filename zName, sqlite3_file*,
...
** has been released.
*/
SQLITE_API int SQLITE_APICALL sqlite3_setlk_timeout(sqlite3*, int ms, int flags);
...
*/
SQLITE_API const char *SQLITE_APICALL sqlite3_uri_parameter(sqlite3_filename z, const char *zParam);
SQLITE_API int SQLITE_APICALL sqlite3_uri_boolean(sqlite3_filename z, const char *zParam, int bDefault);
SQLITE_API sqlite3_int64 SQLITE_APICALL sqlite3_uri_int64(sqlite3_filename, const char*, sqlite3_int64);
#if NTDDI_VERSION >= NTDDI_WIN10_CO
SQLITE_API const char *SQLITE_APICALL sqlite3_uri_key(sqlite3_filename z, int N);
#endif /* NTDDI_VERSION >= NTDDI_WIN10_CO */
...
*/
SQLITE_API const char *SQLITE_APICALL sqlite3_filename_database(sqlite3_filename);
SQLITE_API const char *SQLITE_APICALL sqlite3_filename_journal(sqlite3_filename);
SQLITE_API const char *SQLITE_APICALL sqlite3_filename_wal(sqlite3_filename);
...
** behavior.
*/
SQLITE_API sqlite3_file *SQLITE_APICALL sqlite3_database_file_object(const char*);
...
*/
SQLITE_API sqlite3_filename SQLITE_APICALL sqlite3_create_filename(
...
SQLITE_API void SQLITE_APICALL sqlite3_free_filename(sqlite3_filename);
#endif /* NTDDI_VERSION >= NTDDI_WIN10_CO */
...
*/
SQLITE_API int SQLITE_APICALL sqlite3_set_errmsg(sqlite3 *db, int errcode, const char *zErrMsg);
...
*/
SQLITE_API void *SQLITE_APICALL sqlite3_get_clientdata(sqlite3*,const char*);
SQLITE_API int SQLITE_APICALL sqlite3_set_clientdata(sqlite3*, const char*, void*, void(SQLITE_CALLBACK *)(void*));
...
** </ul>
*/
SQLITE_API sqlite3_filename SQLITE_APICALL sqlite3_db_filename(sqlite3 *db, const char *zDbName);
...
*/
SQLITE_API int SQLITE_APICALL sqlite3_txn_state(sqlite3*,const char *zSchema);
...
** </pre></blockquote>
*/
SQLITE_API int SQLITE_APICALL sqlite3_autovacuum_pages(
  sqlite3 *db,
...
#if NTDDI_VERSION >= NTDDI_WIN10_CO
SQLITE_API sqlite3_int64 SQLITE_APICALL sqlite3_hard_heap_limit64(sqlite3_int64 N);
#endif /* NTDDI_VERSION >= NTDDI_WIN10_CO */
...
#if NTDDI_VERSION >= NTDDI_WIN11_GE
  int (SQLITE_CALLBACK *xIntegrity)(sqlite3_vtab *pVTab, const char *zSchema,
...
*/
SQLITE_API int SQLITE_APICALL sqlite3_drop_modules(
...
SQLITE_API int SQLITE_APICALL sqlite3_db_status64(sqlite3*,int,sqlite3_int64*,sqlite3_int64*,int);
...
** </ol>
*/
SQLITE_API const char *SQLITE_APICALL sqlite3_vtab_collation(sqlite3_index_info*,int);
#endif /* NTDDI_VERSION >= NTDDI_WIN10_RS5 */
...
** results.
*/
SQLITE_API int SQLITE_APICALL sqlite3_vtab_distinct(sqlite3_index_info*);
...
*/
SQLITE_API int SQLITE_APICALL sqlite3_vtab_in(sqlite3_index_info*, int iCons, int bHandle);
...
*/
SQLITE_API int SQLITE_APICALL sqlite3_vtab_in_first(sqlite3_value *pVal, sqlite3_value **ppOut);
SQLITE_API int SQLITE_APICALL sqlite3_vtab_in_next(sqlite3_value *pVal, sqlite3_value **ppOut);
...
SQLITE_API int SQLITE_APICALL sqlite3_preupdate_blobwrite(sqlite3 *);
#endif
...
** [SQLITE_ENABLE_SNAPSHOT] compile-time option is used.
*/
SQLITE_API void SQLITE_APICALL sqlite3_snapshot_free(sqlite3_snapshot*);
#endif /* NTDDI_VERSION >= NTDDI_WIN10_RS1 */
...
*/
SQLITE_API int SQLITE_APICALL sqlite3_snapshot_cmp(
  sqlite3_snapshot *p1,
  sqlite3_snapshot *p2
);
#endif /* NTDDI_VERSION >= NTDDI_WIN10_RS2 */
...
** [SQLITE_ENABLE_SNAPSHOT] option.
*/
SQLITE_API int SQLITE_APICALL sqlite3_snapshot_recover(sqlite3 *db, const char *zDb);
...
*/
SQLITE_API int SQLITE_APICALL sqlite3_carray_bind(
  sqlite3_stmt *pStmt,        /* Statement to be bound */
  int i,                      /* Parameter index */
  void *aData,                /* Pointer to array data */
  int nData,                  /* Number of data elements */
  int mFlags,                 /* CARRAY flags */
  void (SQLITE_CALLBACK *xDel)(void*)         /* Destructor for aData */
);
...
**
*/
SQLITE_API int SQLITE_APICALL sqlite3session_object_config(sqlite3_session*, int op, void *pArg);
...
*/
SQLITE_API sqlite3_int64 SQLITE_APICALL sqlite3session_changeset_size(sqlite3_session *pSession);
...
*/
SQLITE_API sqlite3_int64 SQLITE_APICALL sqlite3session_memory_used(sqlite3_session *pSession);
...
*/
SQLITE_API int SQLITE_APICALL sqlite3changegroup_schema(sqlite3_changegroup*, sqlite3*, const char *zDb);
...
** returned.
*/
SQLITE_API int SQLITE_APICALL sqlite3changegroup_add_change(
  sqlite3_changegroup*,
...
SQLITE_API int SQLITE_APICALL sqlite3changeset_apply_v3(
  sqlite3 *db,                    /* Apply change to "main" db of this handle */
  int nChangeset,                 /* Size of changeset in bytes */
  void *pChangeset,               /* Changeset blob */
  int(SQLITE_CALLBACK *xFilter)(
...
SQLITE_API int SQLITE_APICALL sqlite3changeset_apply_v3_strm(
  sqlite3 *db,                    /* Apply change to "main" db of this handle */
...
struct Fts5ExtensionApi {
  ...
  int (SQLITE_CALLBACK *xQueryToken)(Fts5Context*,
      int iPhrase, int iToken,
      const char **ppToken, int *pnToken
  );
  int (SQLITE_CALLBACK *xInstToken)(Fts5Context*, int iIdx, int iToken, const char**, int*);

  /* Below this point are iVersion>=4 only */
  int (SQLITE_CALLBACK *xColumnLocale)(Fts5Context*, int iCol, const char **pz, int *pn);
  int (SQLITE_CALLBACK *xTokenize_v2)(Fts5Context*,
    const char *pText, int nText,      /* Text to tokenize */
...
struct fts5_api {
  ...
  /* Create a new tokenizer */
  int (SQLITE_CALLBACK *xCreateTokenizer_v2)(
    fts5_api *pApi,
    const char *zName,
    void *pUserData,
  ...
  /* Find an existing tokenizer */
  int (SQLITE_CALLBACK *xFindTokenizer_v2)(
    fts5_api *pApi,
    const char *zName,
    void **ppUserData,
