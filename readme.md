...
Watch the [getting started video](https://youtu.be/LajquCjHXK4)! Microsoft Docs also has content on [developing with Rust on Windows](https://docs.microsoft.com/en-us/windows/dev-environment/rust/).
