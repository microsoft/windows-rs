...
#[doc(hidden)]
pub struct IWebViewControlAcceleratorKeyPressedEventArgs(::windows::runtime::IInspectable);
...
pub struct IWebViewControlAcceleratorKeyPressedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::UI::Core::CoreAcceleratorKeyEventType,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::UI::Core::CorePhysicalKeyStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "UI_Core"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WebViewControlAcceleratorKeyRoutingStage,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
...
#[doc(hidden)]
pub struct IWebViewControlMoveFocusRequestedEventArgs(::windows::runtime::IInspectable);
...
pub struct IWebViewControlMoveFocusRequestedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WebViewControlMoveFocusReason,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
#[doc(hidden)]
pub struct IWebViewControlProcess(::windows::runtime::IInspectable);
...
pub struct IWebViewControlProcess_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        bounds: super::super::super::Foundation::Rect,
...
#[doc(hidden)]
pub struct IWebViewControlProcessFactory(::windows::runtime::IInspectable);
...
pub struct IWebViewControlProcessFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        processoptions: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
#[doc(hidden)]
pub struct IWebViewControlProcessOptions(::windows::runtime::IInspectable);
...
pub struct IWebViewControlProcessOptions_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WebViewControlProcessCapabilityState,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
#[doc(hidden)]
pub struct IWebViewControlSite(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IWebViewControlSite2(::windows::runtime::IInspectable);
...
impl WebViewControl {
    ...
    pub fn SetDefaultBackgroundColor<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::UI::Color>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn DefaultBackgroundColor(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::UI::Color> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::super::UI::Color>(result__)
        }
    }
    ...
    pub fn Settings(&self) -> ::windows::runtime::Result<super::WebViewControlSettings> {
        ...
        unsafe {
            ...
            .from_abi::<super::WebViewControlSettings>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn DeferredPermissionRequests(
        ...
        super::super::super::Foundation::Collections::IVectorView<
            super::WebViewControlDeferredPermissionRequest,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn NavigateToLocalStreamUri<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::IUriToStreamResolver>,
    >(
        &self,
        source: Param0,
    ...
    pub fn NavigateWithHttpRequestMessage<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Http::HttpRequestMessage>,
    >(
        &self,
    ...
    pub fn CapturePreviewToStreamAsync<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Storage::Streams::IRandomAccessStream,
        >,
    >(
        &self,
        stream: Param0,
    ...
    pub fn CaptureSelectedContentToDataPackageAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::ApplicationModel::DataTransfer::DataPackage,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn GetDeferredPermissionRequestById(
        &self,
        id: u32,
        result: &mut ::std::option::Option<super::WebViewControlDeferredPermissionRequest>,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
    ...
    pub fn NavigationStarting<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlNavigationStartingEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn ContentLoading<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlContentLoadingEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn DOMContentLoaded<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlDOMContentLoadedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn NavigationCompleted<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlNavigationCompletedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn ScriptNotify<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlScriptNotifyEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn LongRunningScriptDetected<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlLongRunningScriptDetectedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn UnviewableContentIdentified<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlUnviewableContentIdentifiedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn PermissionRequested<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlPermissionRequestedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn UnsupportedUriSchemeIdentified<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlUnsupportedUriSchemeIdentifiedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn NewWindowRequested<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlNewWindowRequestedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn WebResourceRequested<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::TypedEventHandler<
                super::IWebViewControl,
                super::WebViewControlWebResourceRequestedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn Process(&self) -> ::windows::runtime::Result<WebViewControlProcess> {
        ...
        unsafe {
            ...
            .from_abi::<WebViewControlProcess>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for WebViewControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Web.UI.Interop.WebViewControl;{3f921316-bc70-4bda-9136-c94370899fab})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, super::IWebViewControl> for &WebViewControl {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::IWebViewControl> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<super::IWebViewControl>::into(
...
impl<'a> ::windows::runtime::IntoParam<'a, super::IWebViewControl2> for &WebViewControl {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::IWebViewControl2> {
        ::std::convert::TryInto::<super::IWebViewControl2>::try_into(self)
...
impl WebViewControlAcceleratorKeyPressedEventArgs {
    ...
    pub fn EventType(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::UI::Core::CoreAcceleratorKeyEventType>
    {
        let this = self;
        unsafe {
            let mut result__: super::super::super::UI::Core::CoreAcceleratorKeyEventType =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::super::UI::Core::CoreAcceleratorKeyEventType>(result__)
        }
    }
    #[cfg(feature = "System")]
    pub fn VirtualKey(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::System::VirtualKey> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::super::System::VirtualKey>(result__)
        }
    }
    #[cfg(feature = "UI_Core")]
    pub fn KeyStatus(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::UI::Core::CorePhysicalKeyStatus> {
        let this = self;
        unsafe {
            let mut result__: super::super::super::UI::Core::CorePhysicalKeyStatus =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::super::UI::Core::CorePhysicalKeyStatus>(result__)
        }
    }
    pub fn RoutingStage(
        &self,
    ) -> ::windows::runtime::Result<WebViewControlAcceleratorKeyRoutingStage> {
        let this = self;
        unsafe {
            ...
            .from_abi::<WebViewControlAcceleratorKeyRoutingStage>(result__)
        }
    }
...
impl ::std::convert::From<WebViewControlAcceleratorKeyPressedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebViewControlAcceleratorKeyPressedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WebViewControlAcceleratorKeyRoutingStage {
    pub const Tunneling: WebViewControlAcceleratorKeyRoutingStage =
        WebViewControlAcceleratorKeyRoutingStage(0i32);
    pub const Bubbling: WebViewControlAcceleratorKeyRoutingStage =
        WebViewControlAcceleratorKeyRoutingStage(1i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for WebViewControlAcceleratorKeyRoutingStage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Web.UI.Interop.WebViewControlAcceleratorKeyRoutingStage;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for WebViewControlMoveFocusReason {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Web.UI.Interop.WebViewControlMoveFocusReason;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl WebViewControlMoveFocusRequestedEventArgs {
    pub fn Reason(&self) -> ::windows::runtime::Result<WebViewControlMoveFocusReason> {
        ...
        unsafe {
            ...
            .from_abi::<WebViewControlMoveFocusReason>(result__)
        }
    }
}
...
impl ::std::convert::From<WebViewControlMoveFocusRequestedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for WebViewControlMoveFocusRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebViewControlMoveFocusRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WebViewControlProcess {
    ...
    pub fn IsPrivateNetworkClientServerCapabilityEnabled(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateWebViewControlAsync<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Rect>,
    >(
        &self,
        hostwindowhandle: i64,
        bounds: Param1,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncOperation<WebViewControl>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<WebViewControl>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetWebViewControls(
        ...
        super::super::super::Foundation::Collections::IVectorView<WebViewControl>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::Collections::IVectorView<WebViewControl>>(
                result__,
            )
        }
    }
    ...
    pub fn CreateWithOptions<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, WebViewControlProcessOptions>,
    >(
        processoptions: Param0,
    ) -> ::windows::runtime::Result<WebViewControlProcess> {
        Self::IWebViewControlProcessFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                processoptions.into_param().abi(),
                &mut result__,
            )
            .from_abi::<WebViewControlProcess>(result__)
        })
    }
    pub fn IWebViewControlProcessFactory<
        R,
        F: FnOnce(&IWebViewControlProcessFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for WebViewControlProcess {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Web.UI.Interop.WebViewControlProcess;{02c723ec-98d6-424a-b63e-c6136c36a0f2})",
    );
}
...
impl WebViewControlProcessCapabilityState {
    pub const Default: WebViewControlProcessCapabilityState =
        WebViewControlProcessCapabilityState(0i32);
    pub const Disabled: WebViewControlProcessCapabilityState =
        WebViewControlProcessCapabilityState(1i32);
    pub const Enabled: WebViewControlProcessCapabilityState =
        WebViewControlProcessCapabilityState(2i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for WebViewControlProcessCapabilityState {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Web.UI.Interop.WebViewControlProcessCapabilityState;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl WebViewControlProcessOptions {
    ...
    pub fn SetPrivateNetworkClientServerCapability(
        &self,
        value: WebViewControlProcessCapabilityState,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn PrivateNetworkClientServerCapability(
        &self,
    ) -> ::windows::runtime::Result<WebViewControlProcessCapabilityState> {
        let this = self;
        unsafe {
            ...
            .from_abi::<WebViewControlProcessCapabilityState>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for WebViewControlProcessOptions
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebViewControlProcessOptions
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
