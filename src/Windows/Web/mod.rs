...
impl IUriToStreamResolver {
    ...
    pub fn UriToStreamAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Foundation::Uri>,
    >(
        &self,
        uri: Param0,
    ) -> ::windows::runtime::Result<
        super::Foundation::IAsyncOperation<super::Storage::Streams::IInputStream>,
    > {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::Foundation::IAsyncOperation<super::Storage::Streams::IInputStream>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for IUriToStreamResolver {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{b0aba86a-9aeb-4d3a-9590-003e3ca7e290}");
}
...
impl WebError {
    pub fn GetStatus(hresult: i32) -> ::windows::runtime::Result<WebErrorStatus> {
        Self::IWebErrorStatics(|this| unsafe {
            ...
            .from_abi::<WebErrorStatus>(result__)
        })
    }
    pub fn IWebErrorStatics<R, F: FnOnce(&IWebErrorStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<WebError, IWebErrorStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for WebErrorStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Web.WebErrorStatus;i4)");
}
