...
impl AtomPubClient {
    ...
    pub fn RetrieveServiceDocumentAsync<
        'a,
    ...
    #[cfg(all(
        ...
        feature = "Web_Syndication"
    ))]
    pub fn RetrieveMediaResourceAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
    >(
        &self,
    ...
    #[cfg(all(feature = "Foundation", feature = "Web_Syndication"))]
    pub fn CreateResourceAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param2: ::windows::runtime::IntoParam<'a, super::Syndication::SyndicationItem>,
    >(
        &self,
        uri: Param0,
        description: Param1,
    ...
    pub fn CreateMediaResourceAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param3: ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IInputStream>,
    >(
        &self,
        uri: Param0,
        mediatype: Param1,
    ...
    pub fn UpdateMediaResourceAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    ...
    >(
        ...
        super::super::Foundation::IAsyncActionWithProgress<super::Syndication::TransferProgress>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncActionWithProgress<
                super::Syndication::TransferProgress,
            >>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Web_Syndication"))]
    pub fn UpdateResourceAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, super::Syndication::SyndicationItem>,
    >(
        &self,
        uri: Param0,
        item: Param1,
    ...
    #[cfg(all(feature = "Foundation", feature = "Web_Syndication"))]
    pub fn UpdateResourceItemAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Syndication::SyndicationItem>,
    >(
        &self,
        item: Param0,
    ) -> ::windows::runtime::Result<
    ...
    #[cfg(all(feature = "Foundation", feature = "Web_Syndication"))]
    pub fn DeleteResourceItemAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Syndication::SyndicationItem>,
    >(
        &self,
    ...
    pub fn ServerCredential(
        ...
        let this =
            &::windows::runtime::Interface::cast::<super::Syndication::ISyndicationClient>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn CreateAtomPubClientWithCredentials<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::PasswordCredential>,
    >(
        servercredential: Param0,
    ) -> ::windows::runtime::Result<AtomPubClient> {
        Self::IAtomPubClientFactory(|this| unsafe {
            ...
            .from_abi::<AtomPubClient>(result__)
        })
    }
    pub fn IAtomPubClientFactory<
        R,
        F: FnOnce(&IAtomPubClientFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<AtomPubClient, IAtomPubClientFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for AtomPubClient {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Web.AtomPub.AtomPubClient;{35392c38-cded-4d4c-9637-05f15c1c9406})",
    );
}
...
#[cfg(feature = "Web_Syndication")]
impl<'a> ::windows::runtime::IntoParam<'a, super::Syndication::ISyndicationClient>
    for AtomPubClient
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Syndication::ISyndicationClient> {
        ::std::convert::TryInto::<super::Syndication::ISyndicationClient>::try_into(self)
...
pub struct IAtomPubClient_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        description: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        mediastream: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Foundation",
...
impl ResourceCollection {
    ...
    pub fn Title(&self) -> ::windows::runtime::Result<super::Syndication::ISyndicationText> {
        ...
        unsafe {
            ...
            .from_abi::<super::Syndication::ISyndicationText>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn Categories(
        ...
        super::super::Foundation::Collections::IVectorView<super::Syndication::SyndicationCategory>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<
                super::Syndication::SyndicationCategory,
            >>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    ...
    pub fn NodeName(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        let this =
            &::windows::runtime::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
        unsafe {
    ...
    pub fn AttributeExtensions(
        ...
        super::super::Foundation::Collections::IVector<super::Syndication::SyndicationAttribute>,
    > {
        let this =
            &::windows::runtime::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<
                super::Syndication::SyndicationAttribute,
            >>(result__)
        }
    }
    #[cfg(all(feature = "Foundation_Collections", feature = "Web_Syndication"))]
    pub fn ElementExtensions(
        ...
        super::super::Foundation::Collections::IVector<super::Syndication::ISyndicationNode>,
    > {
        let this =
            &::windows::runtime::Interface::cast::<super::Syndication::ISyndicationNode>(self)?;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<
                super::Syndication::ISyndicationNode,
            >>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for ResourceCollection {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Web.AtomPub.ResourceCollection;{7f5fd609-bc88-41d4-88fa-3de6704d428e})",
    );
}
...
#[cfg(feature = "Web_Syndication")]
impl<'a> ::windows::runtime::IntoParam<'a, super::Syndication::ISyndicationNode>
    for ResourceCollection
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Syndication::ISyndicationNode> {
        ::std::convert::TryInto::<super::Syndication::ISyndicationNode>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl ServiceDocument {
    ...
    pub fn Workspaces(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<Workspace>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<Workspace>>(result__)
        }
    }
    #[cfg(feature = "Web_Syndication")]
    pub fn NodeName(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
...
unsafe impl ::windows::runtime::RuntimeType for ServiceDocument {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Web.AtomPub.ServiceDocument;{8b7ec771-2ab3-4dbe-8bcc-778f92b75e51})",
    );
}
...
impl Workspace {
    ...
    pub fn Collections(
        ...
        super::super::Foundation::Collections::IVectorView<ResourceCollection>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<ResourceCollection>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for Workspace {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Web.AtomPub.Workspace;{b41da63b-a4b8-4036-89c5-83c31266ba49})",
    );
}
