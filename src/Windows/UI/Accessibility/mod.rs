...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ScreenReaderPositionChangedEventArgs
{
...
impl ::std::convert::From<ScreenReaderPositionChangedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ScreenReaderPositionChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl ScreenReaderService {
    ...
    pub fn CurrentScreenReaderPosition(
        &self,
    ) -> ::windows::runtime::Result<ScreenReaderPositionChangedEventArgs> {
        let this = self;
        unsafe {
            ...
            .from_abi::<ScreenReaderPositionChangedEventArgs>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ScreenReaderPositionChanged<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveScreenReaderPositionChanged<
        'a,
...
unsafe impl ::windows::runtime::RuntimeType for ScreenReaderService {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Accessibility.ScreenReaderService;{19475427-eac0-50d3-bdd9-9b487a226256})",
    );
}
