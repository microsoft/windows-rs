...
impl AccountsSettingsPane {
    ...
    pub fn AccountCommandsRequested<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveAccountCommandsRequested<
        'a,
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<AccountsSettingsPane> {
        Self::IAccountsSettingsPaneStatics(|this| unsafe {
            ...
            .from_abi::<AccountsSettingsPane>(result__)
        })
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn ShowManageAccountsAsync(
    ...
    pub fn ShowManageAccountsForUserAsync<
        'a,
    ...
    #[cfg(all(feature = "Foundation", feature = "System"))]
    pub fn ShowAddAccountForUserAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::System::User>,
    >(
        user: Param0,
    ...
    pub fn IAccountsSettingsPaneStatics<
        R,
        F: FnOnce(&IAccountsSettingsPaneStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IAccountsSettingsPaneStatics2<
        R,
        F: FnOnce(&IAccountsSettingsPaneStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IAccountsSettingsPaneStatics3<
        R,
        F: FnOnce(&IAccountsSettingsPaneStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl AccountsSettingsPaneCommandsRequestedEventArgs {
    ...
    pub fn WebAccountProviderCommands(
        ...
        super::super::Foundation::Collections::IVector<WebAccountProviderCommand>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<WebAccountProviderCommand>>(
                result__,
            )
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn WebAccountCommands(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<WebAccountCommand>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<WebAccountCommand>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn CredentialCommands(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<CredentialCommand>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<CredentialCommand>>(result__)
        }
    }
    #[cfg(all(feature = "Foundation_Collections", feature = "UI_Popups"))]
    pub fn Commands(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<SettingsCommand>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<SettingsCommand>>(result__)
        }
    }
    ...
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<AccountsSettingsPaneEventDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<AccountsSettingsPaneEventDeferral>(result__)
        }
    }
    #[cfg(feature = "System")]
...
impl ::std::convert::From<AccountsSettingsPaneCommandsRequestedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AccountsSettingsPaneCommandsRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AccountsSettingsPaneEventDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AccountsSettingsPaneEventDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CredentialCommand {
    ...
    pub fn CredentialDeleted(
        &self,
    ) -> ::windows::runtime::Result<CredentialCommandCredentialDeletedHandler> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<CredentialCommandCredentialDeletedHandler>(result__)
        }
    }
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateCredentialCommand<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::PasswordCredential>,
    >(
        passwordcredential: Param0,
    ) -> ::windows::runtime::Result<CredentialCommand> {
        Self::ICredentialCommandFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                passwordcredential.into_param().abi(),
                &mut result__,
            )
            .from_abi::<CredentialCommand>(result__)
        })
    }
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateCredentialCommandWithHandler<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::PasswordCredential>,
    ...
    >(
        ...
        Self::ICredentialCommandFactory(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                passwordcredential.into_param().abi(),
                deleted.into_param().abi(),
                &mut result__,
            )
            .from_abi::<CredentialCommand>(result__)
        })
    }
    pub fn ICredentialCommandFactory<
        R,
        F: FnOnce(&ICredentialCommandFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::Interface for CredentialCommand {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        24899,
        19066,
        [169, 113, 176, 23, 186, 151, 140, 226],
    );
}
...
impl CredentialCommandCredentialDeletedHandler {
    pub fn new<
        F: FnMut(&::std::option::Option<CredentialCommand>) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ) -> Self {
    ...
    pub fn Invoke<'a, Param0: ::windows::runtime::IntoParam<'a, CredentialCommand>>(
        &self,
        command: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for CredentialCommandCredentialDeletedHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({61c0e185-0977-4678-b4e2-98727afbeed9})",
    );
}
unsafe impl ::windows::runtime::Interface for CredentialCommandCredentialDeletedHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        2423,
        18040,
        [180, 226, 152, 114, 122, 251, 238, 217],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct CredentialCommandCredentialDeletedHandler_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        command: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(C)]
struct CredentialCommandCredentialDeletedHandler_box<
    F: FnMut(&::std::option::Option<CredentialCommand>) -> ::windows::runtime::Result<()> + 'static,
> {
...
impl<
        F: FnMut(&::std::option::Option<CredentialCommand>) -> ::windows::runtime::Result<()>
            + 'static,
    > CredentialCommandCredentialDeletedHandler_box<F>
{
    const VTABLE: CredentialCommandCredentialDeletedHandler_abi =
        CredentialCommandCredentialDeletedHandler_abi(
            Self::QueryInterface,
            Self::AddRef,
            Self::Release,
            Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid
            == &<CredentialCommandCredentialDeletedHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&command as *const <CredentialCommand as ::windows::runtime::Abi>::Abi
                as *const <CredentialCommand as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
unsafe impl ::windows::runtime::Interface for IAccountsSettingsPaneCommandsRequestedEventArgs2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        20023,
        18791,
        [140, 64, 231, 142, 231, 161, 229, 187],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ICredentialCommandFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        passwordcredential: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Security_Credentials"))] usize,
    #[cfg(feature = "Security_Credentials")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        passwordcredential: ::windows::runtime::RawPtr,
        deleted: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Security_Credentials"))] usize,
);
...
pub struct ISettingsCommandFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        settingscommandid: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for ISettingsPaneStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        65305,
        18203,
        [186, 107, 248, 243, 86, 148, 173, 154],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct ISettingsPaneStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SettingsEdgeLocation,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IWebAccountCommand_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SupportedWebAccountActions,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IWebAccountCommandFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        invoked: ::windows::runtime::RawPtr,
...
pub struct IWebAccountProviderCommandFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        webaccountprovider: ::windows::runtime::RawPtr,
        invoked: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Security_Credentials"))] usize,
...
impl SettingsCommand {
    ...
    #[cfg(feature = "UI_Popups")]
    pub fn CreateSettingsCommand<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param2: ::windows::runtime::IntoParam<'a, super::Popups::UICommandInvokedHandler>,
    >(
        settingscommandid: Param0,
        label: Param1,
        handler: Param2,
    ) -> ::windows::runtime::Result<SettingsCommand> {
        Self::ISettingsCommandFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                settingscommandid.into_param().abi(),
                label.into_param().abi(),
                handler.into_param().abi(),
                &mut result__,
            )
            .from_abi::<SettingsCommand>(result__)
        })
    }
    #[cfg(feature = "UI_Popups")]
    ...
    pub fn ISettingsCommandFactory<
        R,
        F: FnOnce(&ISettingsCommandFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ISettingsCommandStatics<
        R,
        F: FnOnce(&ISettingsCommandStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, super::Popups::IUICommand> for SettingsCommand {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Popups::IUICommand> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<super::Popups::IUICommand>::into(
            self,
        ))
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for SettingsEdgeLocation {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.ApplicationSettings.SettingsEdgeLocation;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl SettingsPane {
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn RemoveCommandsRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<SettingsPane> {
        Self::ISettingsPaneStatics(|this| unsafe {
            ...
            .from_abi::<SettingsPane>(result__)
        })
    }
    #[cfg(feature = "deprecated")]
    pub fn Show() -> ::windows::runtime::Result<()> {
    ...
    pub fn Edge() -> ::windows::runtime::Result<SettingsEdgeLocation> {
        Self::ISettingsPaneStatics(|this| unsafe {
            ...
            .from_abi::<SettingsEdgeLocation>(result__)
        })
    }
    pub fn ISettingsPaneStatics<
        R,
        F: FnOnce(&ISettingsPaneStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<SettingsPane, ISettingsPaneStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for SettingsPane {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.ApplicationSettings.SettingsPane;{b1cd0932-4570-4c69-8d38-89446561ace0})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SettingsPaneCommandsRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SettingsPaneCommandsRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SettingsPaneCommandsRequestedEventArgs {
    ...
    pub fn Request(&self) -> ::windows::runtime::Result<SettingsPaneCommandsRequest> {
        ...
        unsafe {
            ...
            .from_abi::<SettingsPaneCommandsRequest>(result__)
        }
    }
}
...
impl ::std::convert::From<&SettingsPaneCommandsRequestedEventArgs>
    for ::windows::runtime::IUnknown
{
    fn from(value: &SettingsPaneCommandsRequestedEventArgs) -> Self {
        ::std::convert::From::from(::std::clone::Clone::clone(value))
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SettingsPaneCommandsRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for SupportedWebAccountActions {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.ApplicationSettings.SupportedWebAccountActions;u4)",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for WebAccountAction {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.ApplicationSettings.WebAccountAction;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl WebAccountCommand {
    ...
    pub fn Invoked(&self) -> ::windows::runtime::Result<WebAccountCommandInvokedHandler> {
        ...
        unsafe {
            ...
            .from_abi::<WebAccountCommandInvokedHandler>(result__)
        }
    }
    pub fn Actions(&self) -> ::windows::runtime::Result<SupportedWebAccountActions> {
        ...
        unsafe {
            ...
            .from_abi::<SupportedWebAccountActions>(result__)
        }
    }
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWebAccountCommand<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::WebAccount>,
        Param1: ::windows::runtime::IntoParam<'a, WebAccountCommandInvokedHandler>,
    >(
        webaccount: Param0,
        invoked: Param1,
        actions: SupportedWebAccountActions,
    ) -> ::windows::runtime::Result<WebAccountCommand> {
        Self::IWebAccountCommandFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                webaccount.into_param().abi(),
                invoked.into_param().abi(),
                actions,
                &mut result__,
            )
            .from_abi::<WebAccountCommand>(result__)
        })
    }
    pub fn IWebAccountCommandFactory<
        R,
        F: FnOnce(&IWebAccountCommandFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl WebAccountCommandInvokedHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<WebAccountCommand>,
                &::std::option::Option<WebAccountInvokedArgs>,
            ) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ...
    pub fn Invoke<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, WebAccountCommand>,
        Param1: ::windows::runtime::IntoParam<'a, WebAccountInvokedArgs>,
    >(
        &self,
        command: Param0,
        args: Param1,
...
unsafe impl ::windows::runtime::RuntimeType for WebAccountCommandInvokedHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({1ee6e459-1705-4a9a-b599-a0c3d6921973})",
    );
}
unsafe impl ::windows::runtime::Interface for WebAccountCommandInvokedHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        5893,
        19098,
        [181, 153, 160, 195, 214, 146, 25, 115],
    );
}
#[repr(C)]
#[doc(hidden)]
...
#[repr(C)]
struct WebAccountCommandInvokedHandler_box<
    F: FnMut(
            &::std::option::Option<WebAccountCommand>,
            &::std::option::Option<WebAccountInvokedArgs>,
        ) -> ::windows::runtime::Result<()>
...
impl<
        F: FnMut(
            ...
            + 'static,
    > WebAccountCommandInvokedHandler_box<F>
{
    const VTABLE: WebAccountCommandInvokedHandler_abi = WebAccountCommandInvokedHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid
            == &<WebAccountCommandInvokedHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&command as *const <WebAccountCommand as ::windows::runtime::Abi>::Abi
                as *const <WebAccountCommand as ::windows::runtime::Abi>::DefaultType),
            &*(&args as *const <WebAccountInvokedArgs as ::windows::runtime::Abi>::Abi
                as *const <WebAccountInvokedArgs as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
impl WebAccountInvokedArgs {
    pub fn Action(&self) -> ::windows::runtime::Result<WebAccountAction> {
        ...
        unsafe {
            ...
            .from_abi::<WebAccountAction>(result__)
        }
    }
}
...
impl WebAccountProviderCommand {
    #[cfg(feature = "Security_Credentials")]
    pub fn WebAccountProvider(
        &self,
    ) -> ::windows::runtime::Result<super::super::Security::Credentials::WebAccountProvider> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::Security::Credentials::WebAccountProvider>(result__)
        }
    }
    pub fn Invoked(&self) -> ::windows::runtime::Result<WebAccountProviderCommandInvokedHandler> {
        ...
        unsafe {
            ...
            .from_abi::<WebAccountProviderCommandInvokedHandler>(result__)
        }
    }
    #[cfg(feature = "Security_Credentials")]
    pub fn CreateWebAccountProviderCommand<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::WebAccountProvider>,
        Param1: ::windows::runtime::IntoParam<'a, WebAccountProviderCommandInvokedHandler>,
    >(
        webaccountprovider: Param0,
        invoked: Param1,
    ) -> ::windows::runtime::Result<WebAccountProviderCommand> {
        Self::IWebAccountProviderCommandFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                webaccountprovider.into_param().abi(),
                invoked.into_param().abi(),
                &mut result__,
            )
            .from_abi::<WebAccountProviderCommand>(result__)
        })
    }
    pub fn IWebAccountProviderCommandFactory<
        R,
        F: FnOnce(&IWebAccountProviderCommandFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebAccountProviderCommand
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WebAccountProviderCommandInvokedHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<WebAccountProviderCommand>,
            ) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ...
    pub fn Invoke<'a, Param0: ::windows::runtime::IntoParam<'a, WebAccountProviderCommand>>(
        &self,
        command: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for WebAccountProviderCommandInvokedHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({b7de5527-4c8f-42dd-84da-5ec493abdb9a})",
    );
}
unsafe impl ::windows::runtime::Interface for WebAccountProviderCommandInvokedHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        19599,
        17117,
        [132, 218, 94, 196, 147, 171, 219, 154],
    );
}
#[repr(C)]
#[doc(hidden)]
...
#[repr(C)]
struct WebAccountProviderCommandInvokedHandler_box<
    F: FnMut(&::std::option::Option<WebAccountProviderCommand>) -> ::windows::runtime::Result<()>
        + 'static,
> {
...
impl<
        F: FnMut(
            ...
            + 'static,
    > WebAccountProviderCommandInvokedHandler_box<F>
{
    const VTABLE: WebAccountProviderCommandInvokedHandler_abi =
        WebAccountProviderCommandInvokedHandler_abi(
            Self::QueryInterface,
            Self::AddRef,
            Self::Release,
            Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid
            == &<WebAccountProviderCommandInvokedHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&command as *const <WebAccountProviderCommand as ::windows::runtime::Abi>::Abi
                as *const <WebAccountProviderCommand as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
