...
unsafe impl ::windows::runtime::RuntimeType for ForegroundText {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.StartScreen.ForegroundText;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
pub struct IJumpList_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut JumpListSystemGroupKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: JumpListSystemGroupKind,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IJumpListItemStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        51114,
        18891,
        [141, 222, 236, 252, 205, 122, 215, 228],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISecondaryTile_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        invocationpoint: super::super::Foundation::Point,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        selection: super::super::Foundation::Rect,
        preferredplacement: super::Popups::Placement,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct ISecondaryTileFactory2_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        displayname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        arguments: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        square150x150logo: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for ISecondaryTileVisualElements2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        22492,
        18324,
        [142, 207, 86, 130, 245, 243, 230, 239],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISecondaryTileVisualElements3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        53596,
        16628,
        [129, 231, 87, 255, 216, 248, 164, 233],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IStartScreenManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        applistentry: ::windows::runtime::RawPtr,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for ITileMixedRealityModel2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        55237,
        16651,
        [131, 25, 148, 134, 162, 123, 108, 103],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct ITileMixedRealityModel2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: TileMixedRealityModelActivationBehavior,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut TileMixedRealityModelActivationBehavior,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IVisualElementsRequest {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        37640,
        16498,
        [136, 204, 208, 104, 219, 52, 124, 104],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl JumpList {
    ...
    pub fn Items(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<JumpListItem>>
    {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<JumpListItem>>(result__)
        }
    }
    pub fn SystemGroupKind(&self) -> ::windows::runtime::Result<JumpListSystemGroupKind> {
        ...
        unsafe {
            ...
            .from_abi::<JumpListSystemGroupKind>(result__)
        }
    }
    pub fn SetSystemGroupKind(
        &self,
        value: JumpListSystemGroupKind,
    ...
    #[cfg(feature = "Foundation")]
    pub fn LoadCurrentAsync(
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<JumpList>> {
        Self::IJumpListStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<JumpList>>(result__)
        })
    }
    ...
    pub fn IJumpListStatics<R, F: FnOnce(&IJumpListStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<JumpList, IJumpListStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for JumpList {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.StartScreen.JumpList;{b0234c3e-cd6f-4cb6-a611-61fd505f3ed1})",
    );
}
...
impl JumpListItem {
    pub fn Kind(&self) -> ::windows::runtime::Result<JumpListItemKind> {
        ...
        unsafe {
            ...
            .from_abi::<JumpListItemKind>(result__)
        }
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetLogo<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    >(
        arguments: Param0,
        displayname: Param1,
    ) -> ::windows::runtime::Result<JumpListItem> {
        Self::IJumpListItemStatics(|this| unsafe {
            ...
            .from_abi::<JumpListItem>(result__)
        })
    }
    ...
    pub fn IJumpListItemStatics<
        R,
        F: FnOnce(&IJumpListItemStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<JumpListItem, IJumpListItemStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for JumpListItem {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.StartScreen.JumpListItem;{7adb6717-8b5d-4820-995b-9b418dbe48b0})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for JumpListItemKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.StartScreen.JumpListItemKind;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for JumpListSystemGroupKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.StartScreen.JumpListSystemGroupKind;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl SecondaryTile {
    ...
    pub fn SetTileId<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn SetLockScreenDisplayBadgeAndTileText(
        &self,
        value: bool,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn ForegroundText(&self) -> ::windows::runtime::Result<ForegroundText> {
        ...
        unsafe {
            ...
            .from_abi::<ForegroundText>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn SetBackgroundColor<'a, Param0: ::windows::runtime::IntoParam<'a, super::Color>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    >(
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).31)(
                ::std::mem::transmute_copy(this),
                invocationpoint.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<bool>>(result__)
        }
    ...
    #[cfg(feature = "Foundation")]
    pub fn RequestCreateAsyncWithRect<
        'a,
    ...
    #[cfg(all(feature = "Foundation", feature = "UI_Popups"))]
    pub fn RequestCreateAsyncWithRectAndPlacement<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Rect>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RequestDeleteAsyncWithPoint<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Point>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RequestDeleteAsyncWithRect<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Rect>,
    >(
        &self,
    ...
    #[cfg(all(feature = "Foundation", feature = "UI_Popups"))]
    pub fn RequestDeleteAsyncWithRectAndPlacement<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Rect>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn VisualElementsRequested<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveVisualElementsRequested<
        'a,
    ...
    >(
        ...
        Self::ISecondaryTileFactory(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                shortname.into_param().abi(),
                displayname.into_param().abi(),
                arguments.into_param().abi(),
                tileoptions,
                logoreference.into_param().abi(),
                &mut result__,
            )
            .from_abi::<SecondaryTile>(result__)
        })
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn CreateWideTile<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param3: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param5: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param6: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
    >(
        tileid: Param0,
        shortname: Param1,
        displayname: Param2,
        ...
        Self::ISecondaryTileFactory(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ...
                tileoptions,
                logoreference.into_param().abi(),
                widelogoreference.into_param().abi(),
                &mut result__,
            )
            .from_abi::<SecondaryTile>(result__)
        })
    ...
    >(
        ...
        Self::ISecondaryTileFactory2(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                displayname.into_param().abi(),
                arguments.into_param().abi(),
                square150x150logo.into_param().abi(),
                desiredsize,
                &mut result__,
            )
            .from_abi::<SecondaryTile>(result__)
    ...
    pub fn Exists<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        tileid: Param0,
    ...
    pub fn FindAllAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<SecondaryTile>,
        >,
    > {
        Self::ISecondaryTileStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn FindAllForPackageAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<SecondaryTile>,
        >,
    > {
    ...
    pub fn ISecondaryTileFactory<
        R,
        F: FnOnce(&ISecondaryTileFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<SecondaryTile, ISecondaryTileFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn ISecondaryTileFactory2<
        R,
        F: FnOnce(&ISecondaryTileFactory2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<SecondaryTile, ISecondaryTileFactory2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn ISecondaryTileStatics<
        R,
        F: FnOnce(&ISecondaryTileStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<SecondaryTile, ISecondaryTileStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for SecondaryTile {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.StartScreen.SecondaryTile;{9e9e51e0-2bb5-4bc0-bb8d-42b23abcc88d})",
    );
}
...
impl SecondaryTileVisualElements {
    ...
    pub fn MixedRealityModel(&self) -> ::windows::runtime::Result<TileMixedRealityModel> {
        ...
        unsafe {
            ...
            .from_abi::<TileMixedRealityModel>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SecondaryTileVisualElements
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl StartScreenManager {
    ...
    #[cfg(feature = "ApplicationModel_Core")]
    pub fn SupportsAppListEntry<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::ApplicationModel::Core::AppListEntry>,
    >(
        &self,
        applistentry: Param0,
    ) -> ::windows::runtime::Result<bool> {
    ...
    #[cfg(all(feature = "ApplicationModel_Core", feature = "Foundation"))]
    pub fn ContainsAppListEntryAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::ApplicationModel::Core::AppListEntry>,
    >(
        &self,
    ...
    #[cfg(all(feature = "ApplicationModel_Core", feature = "Foundation"))]
    pub fn RequestAddAppListEntryAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::ApplicationModel::Core::AppListEntry>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn ContainsSecondaryTileAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn TryRemoveSecondaryTileAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
    ...
    pub fn IStartScreenManagerStatics<
        R,
        F: FnOnce(&IStartScreenManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for StartScreenManager {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.StartScreen.StartScreenManager;{4a1dcbcb-26e9-4eb4-8933-859eb6ecdb29})",
    );
}
...
impl TileMixedRealityModel {
    ...
    pub fn SetBoundingBox<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::IReference<
                super::super::Perception::Spatial::SpatialBoundingBox,
            >,
        >,
    >(
        &self,
    ...
    pub fn BoundingBox(
        ...
        super::super::Foundation::IReference<super::super::Perception::Spatial::SpatialBoundingBox>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn ActivationBehavior(
        &self,
    ) -> ::windows::runtime::Result<TileMixedRealityModelActivationBehavior> {
        let this = &::windows::runtime::Interface::cast::<ITileMixedRealityModel2>(self)?;
        unsafe {
            ...
            .from_abi::<TileMixedRealityModelActivationBehavior>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for TileMixedRealityModel {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.StartScreen.TileMixedRealityModel;{b0764e5b-887d-4242-9a19-3d0a4ea78031})",
    );
}
...
impl TileMixedRealityModelActivationBehavior {
    pub const Default: TileMixedRealityModelActivationBehavior =
        TileMixedRealityModelActivationBehavior(0i32);
    pub const None: TileMixedRealityModelActivationBehavior =
        TileMixedRealityModelActivationBehavior(1i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for TileMixedRealityModelActivationBehavior {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.StartScreen.TileMixedRealityModelActivationBehavior;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for TileOptions {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.UI.StartScreen.TileOptions;u4)");
}
...
unsafe impl ::windows::runtime::RuntimeType for TileSize {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.UI.StartScreen.TileSize;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl VisualElementsRequest {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AlternateVisualElements(
        &self,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<SecondaryTileVisualElements>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<VisualElementsRequestDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<VisualElementsRequestDeferral>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for VisualElementsRequest {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.StartScreen.VisualElementsRequest;{c138333a-9308-4072-88cc-d068db347c68})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a VisualElementsRequestDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl VisualElementsRequestedEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<VisualElementsRequest> {
        ...
        unsafe {
            ...
            .from_abi::<VisualElementsRequest>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a VisualElementsRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
