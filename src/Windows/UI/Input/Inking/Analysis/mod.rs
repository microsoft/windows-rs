...
pub struct IInkAnalysisInkDrawing_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InkAnalysisDrawingKind,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IInkAnalysisListItem {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        50371,
        19514,
        [161, 166, 157, 133, 84, 126, 229, 134],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl IInkAnalysisNode {
    ...
    pub fn Kind(&self) -> ::windows::runtime::Result<InkAnalysisNodeKind> {
        ...
        unsafe {
            ...
            .from_abi::<InkAnalysisNodeKind>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn BoundingRect(
    ...
    pub fn Children(
        ...
        super::super::super::super::Foundation::Collections::IVectorView<IInkAnalysisNode>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn Parent(&self) -> ::windows::runtime::Result<IInkAnalysisNode> {
        ...
        unsafe {
            ...
            .from_abi::<IInkAnalysisNode>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetStrokeIds(
        ...
        super::super::super::super::Foundation::Collections::IVectorView<u32>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::super::Foundation::Collections::IVectorView<u32>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for IInkAnalysisNode {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{30831f05-5f64-4a2c-ba37-4f4887879574}");
}
...
pub struct IInkAnalysisResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InkAnalysisStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IInkAnalyzer {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        2150,
        19909,
        [140, 119, 248, 134, 20, 223, 227, 140],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IInkAnalyzer_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        strokeids: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IInkAnalyzerFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        6499,
        18904,
        [149, 137, 225, 67, 132, 199, 105, 227],
    );
}
impl IInkAnalyzerFactory {
    pub fn CreateAnalyzer(&self) -> ::windows::runtime::Result<InkAnalyzer> {
        ...
        unsafe {
            ...
            .from_abi::<InkAnalyzer>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for IInkAnalyzerFactory {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{29138686-1963-49d8-9589-e14384c769e3}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IInkAnalysisNode> for &InkAnalysisInkBullet {
    fn into_param(self) -> ::windows::runtime::Param<'a, IInkAnalysisNode> {
        ::std::convert::TryInto::<IInkAnalysisNode>::try_into(self)
...
impl InkAnalysisInkDrawing {
    pub fn DrawingKind(&self) -> ::windows::runtime::Result<InkAnalysisDrawingKind> {
        ...
        unsafe {
            ...
            .from_abi::<InkAnalysisDrawingKind>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Center(
...
impl<'a> ::windows::runtime::IntoParam<'a, IInkAnalysisNode> for &InkAnalysisNode {
    fn into_param(self) -> ::windows::runtime::Param<'a, IInkAnalysisNode> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IInkAnalysisNode>::into(
...
impl InkAnalysisResult {
    pub fn Status(&self) -> ::windows::runtime::Result<InkAnalysisStatus> {
        ...
        unsafe {
            ...
            .from_abi::<InkAnalysisStatus>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a InkAnalysisWritingRegion
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl InkAnalyzer {
    ...
    pub fn AnalysisRoot(&self) -> ::windows::runtime::Result<InkAnalysisRoot> {
        ...
        unsafe {
            ...
            .from_abi::<InkAnalysisRoot>(result__)
        }
    }
    ...
    pub fn AddDataForStroke<'a, Param0: ::windows::runtime::IntoParam<'a, super::InkStroke>>(
        &self,
        stroke: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AddDataForStrokes<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::Collections::IIterable<super::InkStroke>,
        >,
    >(
        &self,
        strokes: Param0,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn RemoveDataForStrokes<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::Collections::IIterable<u32>,
        >,
    >(
        &self,
        strokeids: Param0,
    ...
    pub fn ReplaceDataForStroke<'a, Param0: ::windows::runtime::IntoParam<'a, super::InkStroke>>(
        &self,
        stroke: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn AnalyzeAsync(
        ...
        super::super::super::super::Foundation::IAsyncOperation<InkAnalysisResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::super::Foundation::IAsyncOperation<InkAnalysisResult>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for InkAnalyzer {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Input.Inking.Analysis.InkAnalyzer;{f12b8f95-0866-4dc5-8c77-f88614dfe38c})",
    );
}
