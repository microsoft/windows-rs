...
impl CoreIncrementalInkStroke {
    ...
    pub fn AppendInkPoints<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::Collections::IIterable<super::InkPoint>,
        >,
    >(
        &self,
        inkpoints: Param0,
    ...
    pub fn CreateInkStroke(&self) -> ::windows::runtime::Result<super::InkStroke> {
        ...
        unsafe {
            ...
            .from_abi::<super::InkStroke>(result__)
        }
    }
    pub fn DrawingAttributes(&self) -> ::windows::runtime::Result<super::InkDrawingAttributes> {
        ...
        unsafe {
            ...
            .from_abi::<super::InkDrawingAttributes>(result__)
        }
    }
    #[cfg(feature = "Foundation_Numerics")]
    pub fn PointTransform(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::super::Foundation::Numerics::Matrix3x2>
    {
        let this = self;
        unsafe {
            let mut result__: super::super::super::super::Foundation::Numerics::Matrix3x2 =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::super::super::Foundation::Numerics::Matrix3x2>(result__)
        }
    }
    ...
    pub fn Create<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::InkDrawingAttributes>,
        Param1: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::Numerics::Matrix3x2,
        >,
    >(
        drawingattributes: Param0,
        pointtransform: Param1,
    ) -> ::windows::runtime::Result<CoreIncrementalInkStroke> {
        Self::ICoreIncrementalInkStrokeFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                drawingattributes.into_param().abi(),
                pointtransform.into_param().abi(),
                &mut result__,
            )
            .from_abi::<CoreIncrementalInkStroke>(result__)
        })
    }
    pub fn ICoreIncrementalInkStrokeFactory<
        R,
        F: FnOnce(&ICoreIncrementalInkStrokeFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::Interface for CoreIncrementalInkStroke {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        40294,
        20349,
        [165, 127, 204, 112, 185, 207, 170, 118],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreIncrementalInkStroke
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl CoreInkIndependentInputSource {
    ...
    pub fn PointerEntering<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::TypedEventHandler<
                CoreInkIndependentInputSource,
                super::super::super::Core::PointerEventArgs,
            >,
        >,
    >(
        &self,
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::super::super::Foundation::EventRegistrationToken>
    {
        let this = self;
        unsafe {
            let mut result__: super::super::super::super::Foundation::EventRegistrationToken =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::super::super::Foundation::EventRegistrationToken>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn RemovePointerEntering<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
    ...
    pub fn InkPresenter(&self) -> ::windows::runtime::Result<super::InkPresenter> {
        ...
        unsafe {
            ...
            .from_abi::<super::InkPresenter>(result__)
        }
    }
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, super::InkPresenter>>(
        inkpresenter: Param0,
    ) -> ::windows::runtime::Result<CoreInkIndependentInputSource> {
        Self::ICoreInkIndependentInputSourceStatics(|this| unsafe {
            ...
            .from_abi::<CoreInkIndependentInputSource>(result__)
        })
    }
    #[cfg(feature = "UI_Core")]
    pub fn PointerCursor(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Core::CoreCursor> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Core::CoreCursor>(result__)
        }
    }
    #[cfg(feature = "UI_Core")]
    pub fn SetPointerCursor<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Core::CoreCursor>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn ICoreInkIndependentInputSourceStatics<
        R,
        F: FnOnce(&ICoreInkIndependentInputSourceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreInkIndependentInputSource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreInkPresenterHost {
    ...
    pub fn RootVisual(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Composition::ContainerVisual> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::super::Composition::ContainerVisual>(result__)
        }
    }
    #[cfg(feature = "UI_Composition")]
    pub fn SetRootVisual<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Composition::ContainerVisual>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
...
unsafe impl ::windows::runtime::RuntimeType for CoreWetStrokeDisposition {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.Input.Inking.Core.CoreWetStrokeDisposition;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl CoreWetStrokeUpdateEventArgs {
    ...
    pub fn NewInkPoints(
        ...
        super::super::super::super::Foundation::Collections::IVector<super::InkPoint>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn Disposition(&self) -> ::windows::runtime::Result<CoreWetStrokeDisposition> {
        ...
        unsafe {
            ...
            .from_abi::<CoreWetStrokeDisposition>(result__)
        }
    }
    pub fn SetDisposition(
        &self,
        value: CoreWetStrokeDisposition,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreWetStrokeUpdateEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreWetStrokeUpdateEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreWetStrokeUpdateSource {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveWetStrokeStarting<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::EventRegistrationToken,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveWetStrokeContinuing<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::EventRegistrationToken,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveWetStrokeStopping<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::EventRegistrationToken,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveWetStrokeCompleted<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::EventRegistrationToken,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveWetStrokeCanceled<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::EventRegistrationToken,
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, super::InkPresenter>>(
        inkpresenter: Param0,
    ) -> ::windows::runtime::Result<CoreWetStrokeUpdateSource> {
        Self::ICoreWetStrokeUpdateSourceStatics(|this| unsafe {
            ...
            .from_abi::<CoreWetStrokeUpdateSource>(result__)
        })
    }
    pub fn ICoreWetStrokeUpdateSourceStatics<
        R,
        F: FnOnce(&ICoreWetStrokeUpdateSourceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreWetStrokeUpdateSource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct ICoreIncrementalInkStroke_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::super::Foundation::Numerics::Matrix3x2,
    ) -> ::windows::runtime::HRESULT,
...
pub struct ICoreIncrementalInkStrokeFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        pointtransform: super::super::super::super::Foundation::Numerics::Matrix3x2,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Numerics"))] usize,
);
...
pub struct ICoreInkIndependentInputSource_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        cookie: super::super::super::super::Foundation::EventRegistrationToken,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(all(feature = "Foundation", feature = "UI_Core"))]
    pub  unsafe extern "system" fn(
...
pub struct ICoreWetStrokeUpdateEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreWetStrokeDisposition,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: CoreWetStrokeDisposition,
