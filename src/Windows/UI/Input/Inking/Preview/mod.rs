...
pub struct IPalmRejectionDelayZonePreviewStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        inputpanelvisual: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        ...
        inputpanelvisual: ::windows::runtime::RawPtr,
        inputpanelrect: super::super::super::super::Foundation::Rect,
        viewportvisual: ::windows::runtime::RawPtr,
...
impl PalmRejectionDelayZonePreview {
    ...
    pub fn CreateForVisual<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Composition::Visual>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::Rect>,
    >(
        ...
        Self::IPalmRejectionDelayZonePreviewStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                inputpanelvisual.into_param().abi(),
                inputpanelrect.into_param().abi(),
                &mut result__,
            )
            .from_abi::<PalmRejectionDelayZonePreview>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "UI_Composition"))]
    pub fn CreateForVisualWithViewportClip<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Composition::Visual>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::Rect>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::Composition::Visual>,
        Param3: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::Rect>,
    >(
        inputpanelvisual: Param0,
        inputpanelrect: Param1,
        ...
        Self::IPalmRejectionDelayZonePreviewStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ...
                inputpanelvisual.into_param().abi(),
                inputpanelrect.into_param().abi(),
                viewportvisual.into_param().abi(),
                viewportrect.into_param().abi(),
                &mut result__,
            )
            .from_abi::<PalmRejectionDelayZonePreview>(result__)
        })
    }
    pub fn IPalmRejectionDelayZonePreviewStatics<
        R,
        F: FnOnce(&IPalmRejectionDelayZonePreviewStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PalmRejectionDelayZonePreview
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PalmRejectionDelayZonePreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<PalmRejectionDelayZonePreview>
    for super::super::super::super::Foundation::IClosable
{
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::IClosable>
    for PalmRejectionDelayZonePreview
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::super::super::Foundation::IClosable> {
    ...
    for &PalmRejectionDelayZonePreview
{
    fn into_param(
        ...
        ::std::convert::TryInto::<super::super::super::super::Foundation::IClosable>::try_into(self)
