...
impl InputActivationListenerPreview {
    #[cfg(feature = "UI_WindowManagement")]
    pub fn CreateForApplicationWindow<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::WindowManagement::AppWindow>,
    >(
        window: Param0,
    ) -> ::windows::runtime::Result<super::InputActivationListener> {
        Self::IInputActivationListenerPreviewStatics(|this| unsafe {
            ...
            .from_abi::<super::InputActivationListener>(result__)
        })
    }
    pub fn IInputActivationListenerPreviewStatics<
        R,
        F: FnOnce(&IInputActivationListenerPreviewStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
