...
pub struct IInjectedInputGamepadInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::super::Gaming::Input::GamepadButtons,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IInjectedInputKeyboardInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InjectedInputKeyOptions,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: InjectedInputKeyOptions,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u16,
...
pub struct IInjectedInputMouseInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InjectedInputMouseOptions,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IInjectedInputPenInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InjectedInputPointerInfo,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InjectedInputPenButtons,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: InjectedInputPenButtons,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InjectedInputPenParameters,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IInjectedInputTouchInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InjectedInputRectangle,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InjectedInputTouchParameters,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IInputInjector_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        shortcut: InjectedInputShortcut,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IInputInjectorStatics2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        56716,
        16719,
        [149, 234, 248, 126, 244, 192, 174, 108],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl InjectedInputGamepadInfo {
    ...
    pub fn Buttons(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::super::Gaming::Input::GamepadButtons> {
        let this = self;
        unsafe {
            let mut result__: super::super::super::super::Gaming::Input::GamepadButtons =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::super::super::Gaming::Input::GamepadButtons>(result__)
        }
    }
    #[cfg(feature = "Gaming_Input")]
    pub fn SetButtons(
    ...
    >(
        reading: Param0,
    ) -> ::windows::runtime::Result<InjectedInputGamepadInfo> {
        Self::IInjectedInputGamepadInfoFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                reading.into_param().abi(),
                &mut result__,
            )
            .from_abi::<InjectedInputGamepadInfo>(result__)
        })
    }
    pub fn IInjectedInputGamepadInfoFactory<
        R,
        F: FnOnce(&IInjectedInputGamepadInfoFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a InjectedInputGamepadInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl InjectedInputKeyboardInfo {
    ...
    pub fn KeyOptions(&self) -> ::windows::runtime::Result<InjectedInputKeyOptions> {
        ...
        unsafe {
            ...
            .from_abi::<InjectedInputKeyOptions>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a InjectedInputKeyboardInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl InjectedInputMouseInfo {
    ...
    pub fn MouseOptions(&self) -> ::windows::runtime::Result<InjectedInputMouseOptions> {
        ...
        unsafe {
            ...
            .from_abi::<InjectedInputMouseOptions>(result__)
        }
    }
    pub fn SetMouseOptions(
        &self,
        value: InjectedInputMouseOptions,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl InjectedInputPenInfo {
    ...
    pub fn PointerInfo(&self) -> ::windows::runtime::Result<InjectedInputPointerInfo> {
        ...
        unsafe {
            ...
            .from_abi::<InjectedInputPointerInfo>(result__)
        }
    }
    pub fn SetPointerInfo<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, InjectedInputPointerInfo>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn PenButtons(&self) -> ::windows::runtime::Result<InjectedInputPenButtons> {
        ...
        unsafe {
            ...
            .from_abi::<InjectedInputPenButtons>(result__)
        }
    }
    ...
    pub fn PenParameters(&self) -> ::windows::runtime::Result<InjectedInputPenParameters> {
        ...
        unsafe {
            ...
            .from_abi::<InjectedInputPenParameters>(result__)
        }
    }
    pub fn SetPenParameters(
        &self,
        value: InjectedInputPenParameters,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl ::std::fmt::Debug for InjectedInputPoint {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("InjectedInputPoint")
            .field("PositionX", &self.PositionX)
            .field("PositionY", &self.PositionY)
            .finish()
    }
}
...
impl ::std::fmt::Debug for InjectedInputPointerInfo {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("InjectedInputPointerInfo")
            .field("PointerId", &self.PointerId)
            .field("PointerOptions", &self.PointerOptions)
            .field("PixelLocation", &self.PixelLocation)
            .field("TimeOffsetInMilliseconds", &self.TimeOffsetInMilliseconds)
...
impl ::std::cmp::PartialEq for InjectedInputPointerInfo {
    fn eq(&self, other: &Self) -> bool {
        self.PointerId == other.PointerId
            && self.PointerOptions == other.PointerOptions
            && self.PixelLocation == other.PixelLocation
            && self.TimeOffsetInMilliseconds == other.TimeOffsetInMilliseconds
...
impl ::std::fmt::Debug for InjectedInputRectangle {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("InjectedInputRectangle")
...
impl InjectedInputTouchInfo {
    ...
    pub fn Contact(&self) -> ::windows::runtime::Result<InjectedInputRectangle> {
        ...
        unsafe {
            ...
            .from_abi::<InjectedInputRectangle>(result__)
        }
    }
    pub fn SetContact<'a, Param0: ::windows::runtime::IntoParam<'a, InjectedInputRectangle>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn TouchParameters(&self) -> ::windows::runtime::Result<InjectedInputTouchParameters> {
        ...
        unsafe {
            ...
            .from_abi::<InjectedInputTouchParameters>(result__)
        }
    }
...
impl InputInjector {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn InjectMouseInput<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::Collections::IIterable<InjectedInputMouseInfo>,
        >,
    >(
        &self,
        input: Param0,
    ...
    pub fn InjectTouchInput<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Foundation::Collections::IIterable<InjectedInputTouchInfo>,
        >,
    >(
        &self,
        input: Param0,
    ...
    pub fn InjectPenInput<'a, Param0: ::windows::runtime::IntoParam<'a, InjectedInputPenInfo>>(
        &self,
        input: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn TryCreate() -> ::windows::runtime::Result<InputInjector> {
        Self::IInputInjectorStatics(|this| unsafe {
            ...
            .from_abi::<InputInjector>(result__)
        })
    }
    ...
    pub fn InjectGamepadInput<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, InjectedInputGamepadInfo>,
    >(
        &self,
        input: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn IInputInjectorStatics<
        R,
        F: FnOnce(&IInputInjectorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<InputInjector, IInputInjectorStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IInputInjectorStatics2<
        R,
        F: FnOnce(&IInputInjectorStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<InputInjector, IInputInjectorStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
