...
pub struct ISpatialGestureRecognizer_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        interaction: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SpatialGestureSettings,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for ISpatialGestureRecognizerFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        22457,
        12624,
        [131, 130, 105, 139, 36, 226, 100, 208],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISpatialHoldCanceledEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SpatialInteractionSourceKind,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for ISpatialInteractionControllerProperties {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        31657,
        20021,
        [185, 63, 146, 114, 203, 169, 178, 139],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialInteractionDetectedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        22881,
        15169,
        [157, 251, 206, 165, 216, 156, 195, 138],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISpatialInteractionSource3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SpatialInteractionSourceHandedness,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for ISpatialInteractionSource4 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        57190,
        23185,
        [162, 186, 206, 163, 229, 197, 138, 25],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISpatialInteractionSourceEventArgs2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SpatialInteractionPressKind,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for ISpatialInteractionSourceLocation {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        32395,
        12490,
        [188, 197, 199, 113, 137, 206, 163, 10],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISpatialInteractionSourceLocation3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SpatialInteractionSourcePositionAccuracy,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(all(feature = "Foundation", feature = "Foundation_Numerics"))]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for ISpatialInteractionSourceState {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        19299,
        14316,
        [152, 185, 159, 198, 82, 185, 210, 242],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialNavigationStartedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        64356,
        18006,
        [142, 189, 157, 238, 202, 175, 228, 117],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialPointerInteractionSourcePose {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        11307,
        19770,
        [146, 167, 128, 206, 215, 196, 160, 208],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialPointerInteractionSourcePose2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        21211,
        18079,
        [158, 63, 128, 196, 127, 116, 188, 233],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialPointerPose2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        38222,
        19980,
        [150, 209, 182, 121, 11, 111, 194, 253],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialPointerPose3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        60489,
        23371,
        [184, 209, 209, 108, 187, 22, 190, 132],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialRecognitionEndedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        16245,
        17395,
        [172, 129, 209, 220, 45, 249, 177, 251],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISpatialRecognitionStartedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        gesture: SpatialGestureSettings,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
unsafe impl ::windows::runtime::Interface for ISpatialTappedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        62532,
        19105,
        [178, 191, 157, 200, 141, 86, 125, 166],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl SpatialGestureRecognizer {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveRecognitionStarted<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveManipulationCanceled<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveNavigationStarted<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveNavigationUpdated<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveNavigationCanceled<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn CaptureInteraction<'a, Param0: ::windows::runtime::IntoParam<'a, SpatialInteraction>>(
        &self,
        interaction: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn GestureSettings(&self) -> ::windows::runtime::Result<SpatialGestureSettings> {
        ...
        unsafe {
            ...
            .from_abi::<SpatialGestureSettings>(result__)
        }
    }
    pub fn Create(
        settings: SpatialGestureSettings,
    ) -> ::windows::runtime::Result<SpatialGestureRecognizer> {
        Self::ISpatialGestureRecognizerFactory(|this| unsafe {
            ...
            .from_abi::<SpatialGestureRecognizer>(result__)
        })
    }
    pub fn ISpatialGestureRecognizerFactory<
        R,
        F: FnOnce(&ISpatialGestureRecognizerFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialGestureRecognizer
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl SpatialHoldCanceledEventArgs {
    pub fn InteractionSourceKind(
        &self,
    ) -> ::windows::runtime::Result<SpatialInteractionSourceKind> {
        let this = self;
        unsafe {
            ...
            .from_abi::<SpatialInteractionSourceKind>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialHoldCanceledEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialHoldCanceledEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialHoldCompletedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialHoldCompletedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialHoldStartedEventArgs {
    ...
    ) -> ::windows::runtime::Result<SpatialPointerPose> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<SpatialPointerPose>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialHoldStartedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialInteraction {
    pub fn SourceState(&self) -> ::windows::runtime::Result<SpatialInteractionSourceState> {
        ...
        unsafe {
            ...
            .from_abi::<SpatialInteractionSourceState>(result__)
        }
    }
}
...
impl SpatialInteractionController {
    ...
    pub fn SimpleHapticsController(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Devices::Haptics::SimpleHapticsController>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Devices::Haptics::SimpleHapticsController>(result__)
        }
    }
    ...
    pub fn TryGetBatteryReport(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Devices::Power::BatteryReport> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Devices::Power::BatteryReport>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialInteractionController
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialInteractionController
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<&SpatialInteractionControllerProperties>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialInteractionControllerProperties
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialInteractionControllerProperties
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialInteractionDetectedEventArgs {
    ...
    pub fn Interaction(&self) -> ::windows::runtime::Result<SpatialInteraction> {
        ...
        unsafe {
            ...
            .from_abi::<SpatialInteraction>(result__)
        }
    }
    pub fn InteractionSource(&self) -> ::windows::runtime::Result<SpatialInteractionSource> {
        let this =
            &::windows::runtime::Interface::cast::<ISpatialInteractionDetectedEventArgs2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<SpatialInteractionSource>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialInteractionDetectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<SpatialInteractionDetectedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: SpatialInteractionDetectedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialInteractionDetectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialInteractionManager {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveInteractionDetected<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(all(feature = "Foundation_Collections", feature = "Perception"))]
    pub fn GetDetectedSourcesAtTimestamp<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Perception::PerceptionTimestamp>,
    >(
        &self,
        timestamp: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::Collections::IVectorView<SpatialInteractionSourceState>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<SpatialInteractionManager> {
        Self::ISpatialInteractionManagerStatics(|this| unsafe {
            ...
            .from_abi::<SpatialInteractionManager>(result__)
        })
    }
    pub fn IsSourceKindSupported(
        kind: SpatialInteractionSourceKind,
    ) -> ::windows::runtime::Result<bool> {
    ...
    pub fn ISpatialInteractionManagerStatics<
        R,
        F: FnOnce(&ISpatialInteractionManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ISpatialInteractionManagerStatics2<
        R,
        F: FnOnce(&ISpatialInteractionManagerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialInteractionManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialInteractionSource {
    ...
    pub fn Controller(&self) -> ::windows::runtime::Result<SpatialInteractionController> {
        ...
        unsafe {
            ...
            .from_abi::<SpatialInteractionController>(result__)
        }
    }
    #[cfg(feature = "Perception")]
    pub fn TryGetStateAtTimestamp<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Perception::PerceptionTimestamp>,
    >(
        &self,
        timestamp: Param0,
    ) -> ::windows::runtime::Result<SpatialInteractionSourceState> {
        let this = &::windows::runtime::Interface::cast::<ISpatialInteractionSource2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
    ...
    pub fn Handedness(&self) -> ::windows::runtime::Result<SpatialInteractionSourceHandedness> {
        ...
        unsafe {
            ...
            .from_abi::<SpatialInteractionSourceHandedness>(result__)
        }
    }
    #[cfg(feature = "Perception_People")]
    pub fn TryCreateHandMeshObserver(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Perception::People::HandMeshObserver> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Perception::People::HandMeshObserver>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Perception_People"))]
    pub fn TryCreateHandMeshObserverAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Perception::People::HandMeshObserver,
        >,
    > {
        let this = &::windows::runtime::Interface::cast::<ISpatialInteractionSource4>(self)?;
        unsafe {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialInteractionSource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialInteractionSourceEventArgs {
    ...
    pub fn PressKind(&self) -> ::windows::runtime::Result<SpatialInteractionPressKind> {
        let this =
            &::windows::runtime::Interface::cast::<ISpatialInteractionSourceEventArgs2>(self)?;
        unsafe {
            ...
            .from_abi::<SpatialInteractionPressKind>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialInteractionSourceEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialInteractionSourceEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialInteractionSourceHandedness {
    pub const Unspecified: SpatialInteractionSourceHandedness =
        SpatialInteractionSourceHandedness(0i32);
...
impl SpatialInteractionSourceLocation {
    ...
    > {
        let this =
            &::windows::runtime::Interface::cast::<ISpatialInteractionSourceLocation2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn PositionAccuracy(
        &self,
    ) -> ::windows::runtime::Result<SpatialInteractionSourcePositionAccuracy> {
        let this =
            &::windows::runtime::Interface::cast::<ISpatialInteractionSourceLocation3>(self)?;
        unsafe {
            ...
            .from_abi::<SpatialInteractionSourcePositionAccuracy>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Numerics"))]
    ...
    pub fn SourcePointerPose(
        &self,
    ) -> ::windows::runtime::Result<SpatialPointerInteractionSourcePose> {
        let this =
            &::windows::runtime::Interface::cast::<ISpatialInteractionSourceLocation3>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<SpatialPointerInteractionSourcePose>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialInteractionSourceLocation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialInteractionSourcePositionAccuracy {
    pub const High: SpatialInteractionSourcePositionAccuracy =
        SpatialInteractionSourcePositionAccuracy(0i32);
    pub const Approximate: SpatialInteractionSourcePositionAccuracy =
        SpatialInteractionSourcePositionAccuracy(1i32);
}
...
impl SpatialInteractionSourceProperties {
    ...
    pub fn TryGetSourceLossMitigationDirection<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Perception::Spatial::SpatialCoordinateSystem,
    ...
    >(
        &self,
        coordinatesystem: Param0,
    ) -> ::windows::runtime::Result<SpatialInteractionSourceLocation> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<SpatialInteractionSourceLocation>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialInteractionSourceProperties
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&SpatialInteractionSourceProperties>
    for ::windows::runtime::IInspectable
{
    fn from(value: &SpatialInteractionSourceProperties) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialInteractionSourceProperties
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialInteractionSourceState {
    ...
    pub fn Properties(&self) -> ::windows::runtime::Result<SpatialInteractionSourceProperties> {
        ...
        unsafe {
            ...
            .from_abi::<SpatialInteractionSourceProperties>(result__)
        }
    }
    ...
    pub fn Timestamp(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Perception::PerceptionTimestamp> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
            ...
            .from_abi::<super::super::super::Perception::PerceptionTimestamp>(result__)
        }
    }
    #[cfg(feature = "Perception_Spatial")]
    pub fn TryGetPointerPose<
    ...
    pub fn ControllerProperties(
        &self,
    ) -> ::windows::runtime::Result<SpatialInteractionControllerProperties> {
        let this = &::windows::runtime::Interface::cast::<ISpatialInteractionSourceState2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
            ...
            .from_abi::<SpatialInteractionControllerProperties>(result__)
        }
    }
    #[cfg(feature = "Perception_People")]
    pub fn TryGetHandPose(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Perception::People::HandPose> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Perception::People::HandPose>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialInteractionSourceState
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialInteractionSourceState
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialManipulationCanceledEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<SpatialManipulationCanceledEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: SpatialManipulationCanceledEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialManipulationCanceledEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialManipulationCompletedEventArgs {
    ...
    >(
        &self,
        coordinatesystem: Param0,
    ) -> ::windows::runtime::Result<SpatialManipulationDelta> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<SpatialManipulationDelta>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialManipulationCompletedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<SpatialManipulationCompletedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: SpatialManipulationCompletedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialManipulationCompletedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialManipulationDelta
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialManipulationStartedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<SpatialManipulationStartedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: SpatialManipulationStartedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialManipulationStartedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialManipulationUpdatedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<SpatialManipulationUpdatedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: SpatialManipulationUpdatedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialManipulationUpdatedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialNavigationCanceledEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&SpatialNavigationCanceledEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: &SpatialNavigationCanceledEventArgs) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialNavigationCanceledEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<SpatialNavigationCompletedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: SpatialNavigationCompletedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialNavigationCompletedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialNavigationStartedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialNavigationStartedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialNavigationUpdatedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialPointerInteractionSourcePose {
    ...
    pub fn Orientation(
        ...
        let this =
            &::windows::runtime::Interface::cast::<ISpatialPointerInteractionSourcePose2>(self)?;
        unsafe {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialPointerInteractionSourcePose
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<SpatialPointerInteractionSourcePose>
    for ::windows::runtime::IInspectable
{
    fn from(value: SpatialPointerInteractionSourcePose) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialPointerInteractionSourcePose
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialPointerPose {
    ...
    pub fn Head(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Perception::People::HeadPose> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::super::Perception::People::HeadPose>(result__)
        }
    }
    #[cfg(all(feature = "Perception", feature = "Perception_Spatial"))]
    pub fn TryGetAtTimestamp<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Perception::Spatial::SpatialCoordinateSystem,
        >,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Perception::PerceptionTimestamp>,
    >(
        coordinatesystem: Param0,
        timestamp: Param1,
    ) -> ::windows::runtime::Result<SpatialPointerPose> {
    ...
    pub fn TryGetInteractionSourcePose<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, SpatialInteractionSource>,
    >(
        &self,
        source: Param0,
    ) -> ::windows::runtime::Result<SpatialPointerInteractionSourcePose> {
    ...
    pub fn Eyes(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Perception::People::EyesPose> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Perception::People::EyesPose>(result__)
        }
    }
    ...
    pub fn ISpatialPointerPoseStatics<
        R,
        F: FnOnce(&ISpatialPointerPoseStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for SpatialPointerPose {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Input.Spatial.SpatialPointerPose;{6953a42e-c17e-357d-97a1-7269d0ed2d10})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialRecognitionEndedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialRecognitionEndedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SpatialRecognitionStartedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&SpatialRecognitionStartedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: &SpatialRecognitionStartedEventArgs) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialRecognitionStartedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
