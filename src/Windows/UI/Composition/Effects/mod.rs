...
impl ::std::convert::TryFrom<SceneLightingEffect>
    for super::super::super::Graphics::Effects::IGraphicsEffect
{
...
#[cfg(feature = "Graphics_Effects")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::super::Graphics::Effects::IGraphicsEffect>
    for SceneLightingEffect
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::super::Graphics::Effects::IGraphicsEffect>
    {
...
#[cfg(feature = "Graphics_Effects")]
impl ::std::convert::TryFrom<SceneLightingEffect>
    for super::super::super::Graphics::Effects::IGraphicsEffectSource
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: SceneLightingEffect) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
#[cfg(feature = "Graphics_Effects")]
impl<'a>
    ::windows::runtime::IntoParam<'a, super::super::super::Graphics::Effects::IGraphicsEffectSource>
    for SceneLightingEffect
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::super::Graphics::Effects::IGraphicsEffectSource>
    {
        ::windows::runtime::IntoParam::into_param(&self)
    }
}
