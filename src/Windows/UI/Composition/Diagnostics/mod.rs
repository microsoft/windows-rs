...
impl CompositionDebugHeatMaps {
    pub fn Hide<'a, Param0: ::windows::runtime::IntoParam<'a, super::Visual>>(
        &self,
        subtree: Param0,
    ...
    pub fn ShowMemoryUsage<'a, Param0: ::windows::runtime::IntoParam<'a, super::Visual>>(
        &self,
        subtree: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn ShowOverdraw<'a, Param0: ::windows::runtime::IntoParam<'a, super::Visual>>(
        &self,
        subtree: Param0,
    ...
    pub fn ShowRedraw<'a, Param0: ::windows::runtime::IntoParam<'a, super::Visual>>(
        &self,
        subtree: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CompositionDebugHeatMaps
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl CompositionDebugOverdrawContentKinds {
    pub const None: CompositionDebugOverdrawContentKinds =
        CompositionDebugOverdrawContentKinds(0u32);
    pub const OffscreenRendered: CompositionDebugOverdrawContentKinds =
        CompositionDebugOverdrawContentKinds(1u32);
    pub const Colors: CompositionDebugOverdrawContentKinds =
        CompositionDebugOverdrawContentKinds(2u32);
    pub const Effects: CompositionDebugOverdrawContentKinds =
        CompositionDebugOverdrawContentKinds(4u32);
    pub const Shadows: CompositionDebugOverdrawContentKinds =
        CompositionDebugOverdrawContentKinds(8u32);
    pub const Lights: CompositionDebugOverdrawContentKinds =
        CompositionDebugOverdrawContentKinds(16u32);
    pub const Surfaces: CompositionDebugOverdrawContentKinds =
        CompositionDebugOverdrawContentKinds(32u32);
    pub const SwapChains: CompositionDebugOverdrawContentKinds =
        CompositionDebugOverdrawContentKinds(64u32);
    pub const All: CompositionDebugOverdrawContentKinds =
        CompositionDebugOverdrawContentKinds(4294967295u32);
}
...
unsafe impl ::windows::runtime::RuntimeType for CompositionDebugOverdrawContentKinds {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.Composition.Diagnostics.CompositionDebugOverdrawContentKinds;u4)",
    );
}
...
impl CompositionDebugSettings {
    ...
    pub fn TryGetSettings<'a, Param0: ::windows::runtime::IntoParam<'a, super::Compositor>>(
        compositor: Param0,
    ) -> ::windows::runtime::Result<CompositionDebugSettings> {
    ...
    pub fn ICompositionDebugSettingsStatics<
        R,
        F: FnOnce(&ICompositionDebugSettingsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::Interface for CompositionDebugSettings {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        7554,
        19768,
        [183, 183, 239, 209, 28, 123, 195, 209],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CompositionDebugSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
