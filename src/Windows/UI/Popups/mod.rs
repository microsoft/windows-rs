...
pub struct IMessageDialog_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MessageDialogOptions,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: MessageDialogOptions,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IUICommand {
    ...
    pub fn Invoked(&self) -> ::windows::runtime::Result<UICommandInvokedHandler> {
        ...
        unsafe {
            ...
            .from_abi::<UICommandInvokedHandler>(result__)
        }
    }
    pub fn SetInvoked<'a, Param0: ::windows::runtime::IntoParam<'a, UICommandInvokedHandler>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for IUICommand {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{4ff93a75-4145-47ff-ac7f-dff1c1fa5b0f}");
}
...
pub struct IUICommandFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        label: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        action: ::windows::runtime::RawPtr,
        commandid: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
impl MessageDialog {
    ...
    pub fn Commands(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<IUICommand>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<IUICommand>>(result__)
        }
    }
    ...
    pub fn ShowAsync(
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<IUICommand>>(result__)
        }
    }
    pub fn Options(&self) -> ::windows::runtime::Result<MessageDialogOptions> {
        ...
        unsafe {
            ...
            .from_abi::<MessageDialogOptions>(result__)
        }
    }
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        content: Param0,
    ) -> ::windows::runtime::Result<MessageDialog> {
    ...
    pub fn IMessageDialogFactory<
        R,
        F: FnOnce(&IMessageDialogFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MessageDialog, IMessageDialogFactory> =
...
unsafe impl ::windows::runtime::RuntimeType for MessageDialog {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Popups.MessageDialog;{33f59b01-5325-43ab-9ab3-bdae440e4121})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for Placement {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.UI.Popups.Placement;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for PopupMenu {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Popups.PopupMenu;{4e9bc6dc-880d-47fc-a0a1-72b639e62559})",
    );
}
...
impl UICommand {
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        label: Param0,
    ) -> ::windows::runtime::Result<UICommand> {
        Self::IUICommandFactory(|this| unsafe {
            ...
            .from_abi::<UICommand>(result__)
        })
    }
    pub fn CreateWithHandler<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, UICommandInvokedHandler>,
    >(
        label: Param0,
        action: Param1,
    ) -> ::windows::runtime::Result<UICommand> {
    ...
    pub fn IUICommandFactory<R, F: FnOnce(&IUICommandFactory) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<UICommand, IUICommandFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for UICommand {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Popups.UICommand;{4ff93a75-4145-47ff-ac7f-dff1c1fa5b0f})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IUICommand> for &UICommand {
    fn into_param(self) -> ::windows::runtime::Param<'a, IUICommand> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IUICommand>::into(
...
impl UICommandInvokedHandler {
    pub fn new<
        F: FnMut(&::std::option::Option<IUICommand>) -> ::windows::runtime::Result<()> + 'static,
    >(
        invoke: F,
    ) -> Self {
    ...
    pub fn Invoke<'a, Param0: ::windows::runtime::IntoParam<'a, IUICommand>>(
        &self,
        command: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for UICommandInvokedHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({daf77a4f-c27a-4298-9ac6-2922c45e7da6})",
    );
}
...
#[repr(C)]
struct UICommandInvokedHandler_box<
    F: FnMut(&::std::option::Option<IUICommand>) -> ::windows::runtime::Result<()> + 'static,
> {
...
impl<F: FnMut(&::std::option::Option<IUICommand>) -> ::windows::runtime::Result<()> + 'static>
    UICommandInvokedHandler_box<F>
{
    const VTABLE: UICommandInvokedHandler_abi = UICommandInvokedHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid == &<UICommandInvokedHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&command as *const <IUICommand as ::windows::runtime::Abi>::Abi
                as *const <IUICommand as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for UICommandSeparator {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Popups.UICommandSeparator;{4ff93a75-4145-47ff-ac7f-dff1c1fa5b0f})",
    );
}
