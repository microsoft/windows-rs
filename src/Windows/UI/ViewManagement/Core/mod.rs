...
impl CoreFrameworkInputView {
    ...
    pub fn PrimaryViewAnimationStarting<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemovePrimaryViewAnimationStarting<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveOcclusionsChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn GetForUIContext<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UIContext>,
    >(
        context: Param0,
    ) -> ::windows::runtime::Result<CoreFrameworkInputView> {
        Self::ICoreFrameworkInputViewStatics(|this| unsafe {
            ...
            .from_abi::<CoreFrameworkInputView>(result__)
        })
    }
    ...
    pub fn ICoreFrameworkInputViewStatics<
        R,
        F: FnOnce(&ICoreFrameworkInputViewStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::Interface for CoreFrameworkInputView {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        18104,
        23882,
        [148, 137, 141, 222, 195, 214, 57, 166],
    );
}
...
impl CoreFrameworkInputViewAnimationStartingEventArgs {
    ...
    pub fn Occlusions(
        ...
        super::super::super::Foundation::Collections::IVectorView<CoreInputViewOcclusion>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl ::std::convert::From<CoreFrameworkInputViewAnimationStartingEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreFrameworkInputViewAnimationStartingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<CoreFrameworkInputViewOcclusionsChangedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreFrameworkInputViewOcclusionsChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreFrameworkInputViewOcclusionsChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreInputView {
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<CoreInputView> {
        Self::ICoreInputViewStatics(|this| unsafe {
            ...
            .from_abi::<CoreInputView>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn XYFocusTransferringFromPrimaryView<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveXYFocusTransferringFromPrimaryView<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn XYFocusTransferredToPrimaryView<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveXYFocusTransferredToPrimaryView<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    >(
        context: Param0,
    ) -> ::windows::runtime::Result<CoreInputView> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemovePrimaryViewShowing<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemovePrimaryViewHiding<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveSupportedKindsChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn ICoreInputViewStatics<
        R,
        F: FnOnce(&ICoreInputViewStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<CoreInputView, ICoreInputViewStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn ICoreInputViewStatics2<
        R,
        F: FnOnce(&ICoreInputViewStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<CoreInputView, ICoreInputViewStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for CoreInputView {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.ViewManagement.Core.CoreInputView;{c770cd7a-7001-4c32-bf94-25c1f554cbf1})",
    );
}
...
impl ::std::convert::From<CoreInputViewAnimationStartingEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreInputViewAnimationStartingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreInputViewHidingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreInputViewHidingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreInputViewOcclusion {
    ...
    pub fn OcclusionKind(&self) -> ::windows::runtime::Result<CoreInputViewOcclusionKind> {
        ...
        unsafe {
            ...
            .from_abi::<CoreInputViewOcclusionKind>(result__)
        }
    }
}
...
unsafe impl ::windows::runtime::Interface for CoreInputViewOcclusion {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        14437,
        16759,
        [181, 245, 139, 101, 224, 185, 206, 132],
    );
}
...
impl ::std::convert::From<CoreInputViewOcclusionsChangedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreInputViewOcclusionsChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreInputViewShowingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreInputViewShowingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreInputViewTransferringXYFocusEventArgs {
    ...
    pub fn Direction(&self) -> ::windows::runtime::Result<CoreInputViewXYFocusTransferDirection> {
        ...
        unsafe {
            ...
            .from_abi::<CoreInputViewXYFocusTransferDirection>(result__)
        }
    }
...
impl ::std::convert::From<CoreInputViewTransferringXYFocusEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreInputViewTransferringXYFocusEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreInputViewTransferringXYFocusEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreInputViewXYFocusTransferDirection {
    pub const Up: CoreInputViewXYFocusTransferDirection =
        CoreInputViewXYFocusTransferDirection(0i32);
    pub const Right: CoreInputViewXYFocusTransferDirection =
        CoreInputViewXYFocusTransferDirection(1i32);
    pub const Down: CoreInputViewXYFocusTransferDirection =
        CoreInputViewXYFocusTransferDirection(2i32);
    pub const Left: CoreInputViewXYFocusTransferDirection =
        CoreInputViewXYFocusTransferDirection(3i32);
}
...
unsafe impl ::windows::runtime::Interface for ICoreInputView4 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        55791,
        22507,
        [140, 239, 119, 246, 206, 27, 126, 231],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ICoreInputViewOcclusion_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreInputViewOcclusionKind,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct ICoreInputViewTransferringXYFocusEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreInputViewXYFocusTransferDirection,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: bool,
...
unsafe impl ::windows::runtime::Interface for IUISettingsController {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        5568,
        23067,
        [167, 91, 172, 191, 156, 184, 187, 158],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl UISettingsController {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RequestDefaultAsync() -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<UISettingsController>,
    > {
        Self::IUISettingsControllerStatics(|this| unsafe {
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<UISettingsController>>(
                result__,
            )
        })
    }
    pub fn IUISettingsControllerStatics<
        R,
        F: FnOnce(&IUISettingsControllerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
