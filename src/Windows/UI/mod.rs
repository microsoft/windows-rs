...
unsafe impl ::windows::runtime::RuntimeType for Color {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"struct(Windows.UI.Color;u1;u1;u1;u1)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl ColorHelper {
    pub fn FromArgb(a: u8, r: u8, g: u8, b: u8) -> ::windows::runtime::Result<Color> {
        Self::IColorHelperStatics(|this| unsafe {
            ...
            .from_abi::<Color>(result__)
        })
    }
    pub fn ToDisplayName<'a, Param0: ::windows::runtime::IntoParam<'a, Color>>(
        color: Param0,
    ...
    pub fn IColorHelperStatics2<
        R,
        F: FnOnce(&IColorHelperStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<ColorHelper, IColorHelperStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ColorHelper {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.ColorHelper;{193cfbe7-65c7-4540-ad08-6283ba76879a})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for Colors {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Colors;{9b8c9326-4ca6-4ce5-8994-9eff65cabdcc})",
    );
}
unsafe impl ::windows::runtime::Interface for Colors {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        19622,
        19685,
        [137, 148, 158, 255, 101, 202, 189, 204],
    );
}
...
impl UIContentRoot {
    pub fn UIContext(&self) -> ::windows::runtime::Result<UIContext> {
        ...
        unsafe {
            ...
            .from_abi::<UIContext>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for UIContentRoot {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.UIContentRoot;{1dfcbac6-b36b-5cb9-9bc5-2b7a0eddc378})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for UIContext {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.UIContext;{bb5cfacd-5bd8-59d0-a59e-1c17a4d6d243})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for WindowId {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"struct(Windows.UI.WindowId;u8)");
}
