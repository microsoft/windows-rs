...
pub struct IWebUICommandBar_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WebUICommandBarClosedDisplayMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: super::super::super::Foundation::EventRegistrationToken,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
...
unsafe impl ::windows::runtime::RuntimeType for IWebUICommandBarElement {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{c9069ec2-284a-4633-8aad-637a27e282c3}");
}
impl ::std::convert::From<IWebUICommandBarElement> for ::windows::runtime::IUnknown {
...
impl ::std::convert::From<IWebUICommandBarElement> for ::windows::runtime::IInspectable {
    fn from(value: IWebUICommandBarElement) -> Self {
        value.0
    }
}
...
unsafe impl ::windows::runtime::Interface for IWebUICommandBarIcon {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        8212,
        17086,
        [150, 154, 125, 20, 202, 108, 138, 73],
    );
}
impl IWebUICommandBarIcon {}
unsafe impl ::windows::runtime::RuntimeType for IWebUICommandBarIcon {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{d587655d-2014-42be-969a-7d14ca6c8a49}");
}
impl ::std::convert::From<IWebUICommandBarIcon> for ::windows::runtime::IUnknown {
...
impl ::std::convert::From<IWebUICommandBarIcon> for ::windows::runtime::IInspectable {
    fn from(value: IWebUICommandBarIcon) -> Self {
        value.0
    }
}
...
unsafe impl ::windows::runtime::Interface for IWebUICommandBarIconButton {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        14972,
        18498,
        [160, 207, 175, 246, 234, 48, 133, 134],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IWebUICommandBarSymbolIconFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        symbol: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
unsafe impl ::windows::runtime::RuntimeType for MenuClosedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({435387c8-4dd0-4c52-9489-d390ce7721d2})",
    );
}
unsafe impl ::windows::runtime::Interface for MenuClosedEventHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        19920,
        19538,
        [148, 137, 211, 144, 206, 119, 33, 210],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl<F: FnMut() -> ::windows::runtime::Result<()> + 'static> MenuClosedEventHandler_box<F> {
    const VTABLE: MenuClosedEventHandler_abi = MenuClosedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid == &<MenuClosedEventHandler as ::windows::runtime::Interface>::IID
...
unsafe impl ::windows::runtime::RuntimeType for MenuOpenedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({18dc0ad3-678f-4c19-8963-cc1c49a5ef9e})",
    );
}
...
impl<F: FnMut() -> ::windows::runtime::Result<()> + 'static> MenuOpenedEventHandler_box<F> {
    const VTABLE: MenuOpenedEventHandler_abi = MenuOpenedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid == &<MenuOpenedEventHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
...
impl SizeChangedEventHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<WebUICommandBarSizeChangedEventArgs>,
    ...
    pub fn Invoke<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, WebUICommandBarSizeChangedEventArgs>,
    >(
        &self,
        eventargs: Param0,
    ) -> ::windows::runtime::Result<()> {
...
unsafe impl ::windows::runtime::RuntimeType for SizeChangedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({d49cfe3c-dd2e-4c28-b627-303a7f911af5})",
    );
}
...
impl WebUICommandBar {
    ...
    pub fn ClosedDisplayMode(
        &self,
    ) -> ::windows::runtime::Result<WebUICommandBarClosedDisplayMode> {
        let this = self;
        unsafe {
            ...
            .from_abi::<WebUICommandBarClosedDisplayMode>(result__)
        }
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn MenuOpened<'a, Param0: ::windows::runtime::IntoParam<'a, MenuOpenedEventHandler>>(
        &self,
        handler: Param0,
    ...
    #[cfg(feature = "Foundation")]
    pub fn MenuClosed<'a, Param0: ::windows::runtime::IntoParam<'a, MenuClosedEventHandler>>(
        &self,
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::EventRegistrationToken> {
        let this = self;
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<WebUICommandBar> {
        Self::IWebUICommandBarStatics(|this| unsafe {
            ...
            .from_abi::<WebUICommandBar>(result__)
        })
    }
    pub fn IWebUICommandBarStatics<
        R,
        F: FnOnce(&IWebUICommandBarStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for WebUICommandBar {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.WebUI.Core.WebUICommandBar;{a4fc0016-dbe5-41ad-8d7b-14698bd6911d})",
    );
}
...
impl WebUICommandBarBitmapIcon {
    ...
    >(
        uri: Param0,
    ) -> ::windows::runtime::Result<WebUICommandBarBitmapIcon> {
        Self::IWebUICommandBarBitmapIconFactory(|this| unsafe {
            ...
            .from_abi::<WebUICommandBarBitmapIcon>(result__)
        })
    }
    pub fn IWebUICommandBarBitmapIconFactory<
        R,
        F: FnOnce(&IWebUICommandBarBitmapIconFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebUICommandBarBitmapIcon
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, IWebUICommandBarIcon> for &WebUICommandBarBitmapIcon {
    fn into_param(self) -> ::windows::runtime::Param<'a, IWebUICommandBarIcon> {
        ::std::convert::TryInto::<IWebUICommandBarIcon>::try_into(self)
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebUICommandBarConfirmationButton
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, IWebUICommandBarElement>
    for WebUICommandBarConfirmationButton
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IWebUICommandBarElement> {
        ::std::convert::TryInto::<IWebUICommandBarElement>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl WebUICommandBarIconButton {
    ...
    pub fn Icon(&self) -> ::windows::runtime::Result<IWebUICommandBarIcon> {
        ...
        unsafe {
            ...
            .from_abi::<IWebUICommandBarIcon>(result__)
        }
    }
    pub fn SetIcon<'a, Param0: ::windows::runtime::IntoParam<'a, IWebUICommandBarIcon>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebUICommandBarIconButton
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<WebUICommandBarItemInvokedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebUICommandBarItemInvokedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<WebUICommandBarSizeChangedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: WebUICommandBarSizeChangedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebUICommandBarSizeChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WebUICommandBarSymbolIcon {
    ...
    pub fn SetSymbol<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        symbol: Param0,
    ) -> ::windows::runtime::Result<WebUICommandBarSymbolIcon> {
        Self::IWebUICommandBarSymbolIconFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                symbol.into_param().abi(),
                &mut result__,
            )
            .from_abi::<WebUICommandBarSymbolIcon>(result__)
        })
    }
    pub fn IWebUICommandBarSymbolIconFactory<
        R,
        F: FnOnce(&IWebUICommandBarSymbolIconFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WebUICommandBarSymbolIcon
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
