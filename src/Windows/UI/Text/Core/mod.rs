...
impl CoreTextCompositionCompletedEventArgs {
    ...
    pub fn CompositionSegments(
        ...
        super::super::super::Foundation::Collections::IVectorView<CoreTextCompositionSegment>,
    > {
        let this = self;
        unsafe {
...
impl ::std::convert::From<CoreTextCompositionCompletedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextCompositionCompletedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl CoreTextCompositionSegment {
    ...
    pub fn Range(&self) -> ::windows::runtime::Result<CoreTextRange> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextRange>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreTextCompositionSegment
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextCompositionSegment
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreTextCompositionStartedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<CoreTextCompositionStartedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: CoreTextCompositionStartedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextCompositionStartedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreTextEditContext {
    ...
    pub fn InputScope(&self) -> ::windows::runtime::Result<CoreTextInputScope> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextInputScope>(result__)
        }
    }
    ...
    pub fn InputPaneDisplayPolicy(
        &self,
    ) -> ::windows::runtime::Result<CoreTextInputPaneDisplayPolicy> {
        let this = self;
        unsafe {
            ...
            .from_abi::<CoreTextInputPaneDisplayPolicy>(result__)
        }
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveSelectionRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveSelectionUpdating<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveCompositionStarted<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveCompositionCompleted<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn NotifyTextChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, CoreTextRange>,
        Param2: ::windows::runtime::IntoParam<'a, CoreTextRange>,
    >(
        &self,
        modifiedrange: Param0,
        newlength: i32,
        newselection: Param2,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).34)(
                ::std::mem::transmute_copy(this),
                modifiedrange.into_param().abi(),
                newlength,
                newselection.into_param().abi(),
            )
            .ok()
        }
    }
    pub fn NotifySelectionChanged<'a, Param0: ::windows::runtime::IntoParam<'a, CoreTextRange>>(
        &self,
        selection: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Foundation")]
    pub fn NotifyFocusLeaveCompleted<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveNotifyFocusLeaveCompleted<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
...
unsafe impl ::windows::runtime::RuntimeType for CoreTextEditContext {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Text.Core.CoreTextEditContext;{bf6608af-4041-47c3-b263-a918eb5eaef2})",
    );
}
...
impl CoreTextFormatUpdatingEventArgs {
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Foundation::IReference<
                super::super::ViewManagement::UIElementType,
            >>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "UI_ViewManagement"))]
    ...
    pub fn UnderlineType(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IReference<super::UnderlineType>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IReference<super::UnderlineType>>(result__)
        }
    }
    pub fn Reason(&self) -> ::windows::runtime::Result<CoreTextFormatUpdatingReason> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextFormatUpdatingReason>(result__)
        }
    }
    pub fn Result(&self) -> ::windows::runtime::Result<CoreTextFormatUpdatingResult> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextFormatUpdatingResult>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreTextFormatUpdatingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextFormatUpdatingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreTextFormatUpdatingReason {
    ...
    pub const CompositionUnconverted: CoreTextFormatUpdatingReason =
        CoreTextFormatUpdatingReason(1i32);
    pub const CompositionConverted: CoreTextFormatUpdatingReason =
        CoreTextFormatUpdatingReason(2i32);
    pub const CompositionTargetUnconverted: CoreTextFormatUpdatingReason =
        CoreTextFormatUpdatingReason(3i32);
    pub const CompositionTargetConverted: CoreTextFormatUpdatingReason =
        CoreTextFormatUpdatingReason(4i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for CoreTextLayoutBounds {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Text.Core.CoreTextLayoutBounds;{e972c974-4436-4917-80d0-a525e4ca6780})",
    );
}
unsafe impl ::windows::runtime::Interface for CoreTextLayoutBounds {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        17462,
        18711,
        [128, 208, 165, 37, 228, 202, 103, 128],
    );
}
...
impl CoreTextLayoutRequest {
    ...
    pub fn LayoutBounds(&self) -> ::windows::runtime::Result<CoreTextLayoutBounds> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextLayoutBounds>(result__)
        }
    }
    pub fn IsCanceled(&self) -> ::windows::runtime::Result<bool> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for CoreTextLayoutRequest {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Text.Core.CoreTextLayoutRequest;{2555a8cc-51fd-4f03-98bf-ac78174d68e0})",
    );
}
...
impl CoreTextLayoutRequestedEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<CoreTextLayoutRequest> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextLayoutRequest>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreTextLayoutRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextLayoutRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::fmt::Debug for CoreTextRange {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("CoreTextRange")
            .field("StartCaretPosition", &self.StartCaretPosition)
            .field("EndCaretPosition", &self.EndCaretPosition)
            .finish()
    }
}
impl ::std::cmp::PartialEq for CoreTextRange {
    fn eq(&self, other: &Self) -> bool {
        self.StartCaretPosition == other.StartCaretPosition
            && self.EndCaretPosition == other.EndCaretPosition
    }
}
...
impl CoreTextSelectionRequest {
    ...
    pub fn SetSelection<'a, Param0: ::windows::runtime::IntoParam<'a, CoreTextRange>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for CoreTextSelectionRequest {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Text.Core.CoreTextSelectionRequest;{f0a70403-208b-4301-883c-74ca7485fd8d})",
    );
}
unsafe impl ::windows::runtime::Interface for CoreTextSelectionRequest {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        8331,
        17153,
        [136, 60, 116, 202, 116, 133, 253, 141],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextSelectionRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreTextSelectionRequestedEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<CoreTextSelectionRequest> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextSelectionRequest>(result__)
        }
    }
}
...
unsafe impl ::windows::runtime::Interface for CoreTextSelectionRequestedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        62996,
        16922,
        [143, 75, 158, 200, 165, 163, 127, 205],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreTextSelectionRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<CoreTextSelectionRequestedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: CoreTextSelectionRequestedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextSelectionRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreTextSelectionUpdatingEventArgs {
    ...
    pub fn Result(&self) -> ::windows::runtime::Result<CoreTextSelectionUpdatingResult> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextSelectionUpdatingResult>(result__)
        }
    }
    pub fn SetResult(
        &self,
        value: CoreTextSelectionUpdatingResult,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreTextSelectionUpdatingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&CoreTextSelectionUpdatingEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: &CoreTextSelectionUpdatingEventArgs) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextSelectionUpdatingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreTextServicesConstants {
    ...
    pub fn ICoreTextServicesStatics<
        R,
        F: FnOnce(&ICoreTextServicesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl CoreTextServicesManager {
    ...
    pub fn InputLanguage(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Globalization::Language> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::Globalization::Language>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn InputLanguageChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveInputLanguageChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn CreateEditContext(&self) -> ::windows::runtime::Result<CoreTextEditContext> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextEditContext>(result__)
        }
    }
    pub fn GetForCurrentView() -> ::windows::runtime::Result<CoreTextServicesManager> {
        Self::ICoreTextServicesManagerStatics(|this| unsafe {
            ...
            .from_abi::<CoreTextServicesManager>(result__)
        })
    }
    pub fn ICoreTextServicesManagerStatics<
        R,
        F: FnOnce(&ICoreTextServicesManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for CoreTextServicesManager {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Text.Core.CoreTextServicesManager;{c2507d83-6e0a-4a8a-bdf8-1948874854ba})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for CoreTextTextRequest {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Text.Core.CoreTextTextRequest;{50d950a9-f51e-4cc1-8ca1-e6346d1a61be})",
    );
}
...
impl CoreTextTextRequestedEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<CoreTextTextRequest> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextTextRequest>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreTextTextRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextTextRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CoreTextTextUpdatingEventArgs {
    ...
    pub fn Result(&self) -> ::windows::runtime::Result<CoreTextTextUpdatingResult> {
        ...
        unsafe {
            ...
            .from_abi::<CoreTextTextUpdatingResult>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreTextTextUpdatingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct ICoreTextEditContext_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreTextInputScope,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: CoreTextInputScope,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreTextInputPaneDisplayPolicy,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: CoreTextInputPaneDisplayPolicy,
...
pub struct ICoreTextFormatUpdatingEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreTextFormatUpdatingReason,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreTextFormatUpdatingResult,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: CoreTextFormatUpdatingResult,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
...
pub struct ICoreTextSelectionUpdatingEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreTextSelectionUpdatingResult,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: CoreTextSelectionUpdatingResult,
...
pub struct ICoreTextTextUpdatingEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreTextTextUpdatingResult,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: CoreTextTextUpdatingResult,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
