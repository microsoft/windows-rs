...
pub struct IUserNotificationListener_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UserNotificationListenerAccessStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl UserNotificationListener {
    ...
    pub fn RequestAccessAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<UserNotificationListenerAccessStatus>,
    > {
        let this = self;
        unsafe {
    ...
    pub fn GetAccessStatus(
        &self,
    ) -> ::windows::runtime::Result<UserNotificationListenerAccessStatus> {
        let this = self;
        unsafe {
            ...
            .from_abi::<UserNotificationListenerAccessStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn NotificationChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
                UserNotificationListener,
                super::UserNotificationChangedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveNotificationChanged<
        'a,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetNotificationsAsync(
        &self,
        kinds: super::NotificationKinds,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Foundation::Collections::IVectorView<super::UserNotification>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn GetNotification(
        &self,
        notificationid: u32,
    ) -> ::windows::runtime::Result<super::UserNotification> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::UserNotification>(result__)
        }
    }
    ...
    pub fn Current() -> ::windows::runtime::Result<UserNotificationListener> {
        Self::IUserNotificationListenerStatics(|this| unsafe {
            ...
            .from_abi::<UserNotificationListener>(result__)
        })
    }
    pub fn IUserNotificationListenerStatics<
        R,
        F: FnOnce(&IUserNotificationListenerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserNotificationListener
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl UserNotificationListenerAccessStatus {
    pub const Unspecified: UserNotificationListenerAccessStatus =
        UserNotificationListenerAccessStatus(0i32);
    pub const Allowed: UserNotificationListenerAccessStatus =
        UserNotificationListenerAccessStatus(1i32);
    pub const Denied: UserNotificationListenerAccessStatus =
        UserNotificationListenerAccessStatus(2i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for UserNotificationListenerAccessStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.Notifications.Management.UserNotificationListenerAccessStatus;i4)",
    );
}
