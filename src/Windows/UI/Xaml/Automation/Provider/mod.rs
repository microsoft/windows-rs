...
unsafe impl ::windows::runtime::RuntimeType for IAnnotationProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{95ba1417-4437-451b-9461-050a49b59d06}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ICustomNavigationProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{2bd8a6d0-2fa3-4717-b28c-4917ce54928d}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IDockProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{48c243f8-78b1-44a0-ac5f-750757bcde3c}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IDragProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{2e7786a9-7ffc-4f57-b965-1ef1f373f546}");
}
...
unsafe impl ::windows::runtime::Interface for IDropTargetProvider {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        46168,
        20448,
        [152, 200, 170, 200, 157, 245, 109, 97],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for IDropTargetProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{7a245bdd-b458-4fe0-98c8-aac89df56d61}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IExpandCollapseProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{49ac8399-d626-4543-94b9-a6d9a9593af6}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IGridItemProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{fff3683c-7407-45bb-a936-df3ed6d3837d}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IGridProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{8b62b7a0-932c-4490-9a13-02fdb39a8f5b}");
}
...
unsafe impl ::windows::runtime::Interface for IInvokeProvider {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        45372,
        17728,
        [176, 158, 103, 120, 226, 220, 155, 165],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for IInvokeProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{f7d1a187-b13c-4540-b09e-6778e2dc9ba5}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IItemContainerProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{ef5cd845-e1d4-40f4-bad5-c7fad44a703e}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IMultipleViewProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{d014e196-0e50-4843-a5d2-c22897c8845a}");
}
...
unsafe impl ::windows::runtime::Interface for IObjectModelProvider {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        1939,
        20176,
        [187, 244, 159, 244, 224, 249, 143, 128],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for IObjectModelProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{c3ca36b9-0793-4ed0-bbf4-9ff4e0f98f80}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IRangeValueProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{838a34a8-7d5f-4079-af03-c3d015e93413}");
}
...
impl IRawElementProviderSimple {
    ...
    pub fn Dispatcher(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Core::CoreDispatcher> {
        let this = &::windows::runtime::Interface::cast::<super::super::IDependencyObject>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(
            ...
            .from_abi::<super::super::super::Core::CoreDispatcher>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for IScrollItemProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{9a3ec090-5d2c-4e42-9ee6-9d58db100b55}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IScrollProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{374bf581-7716-4bbc-82eb-d997006ea999}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ISelectionItemProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{6a4977c1-830d-42d2-bf62-042ebddecc19}");
}
...
unsafe impl ::windows::runtime::Interface for ISelectionProvider {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        47428,
        17301,
        [141, 225, 136, 246, 116, 175, 81, 211],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for ISelectionProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{1f018fca-b944-4395-8de1-88f674af51d3}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ISpreadsheetItemProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{ebde8f92-6015-4826-b719-47521a81c67e}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ISpreadsheetProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{15359093-bd99-4cfd-9f07-3b14b315e23d}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IStylesProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{1a5b7a17-7c01-4bec-9cd4-2dfa7dc246cd}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ISynchronizedInputProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{3d60cecb-da54-4aa3-b915-e3244427d4ac}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ITableItemProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{3b2c49cd-1de2-4ee2-a3e1-fb553559d15d}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ITableProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{7a8ed399-6824-4595-bab3-464bc9a04417}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ITextChildProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{1133c336-a89b-4130-9be6-55e33334f557}");
}
...
impl ITextEditProvider {
    ...
    pub fn RangeFromPoint<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::Point>,
    >(
        &self,
...
unsafe impl ::windows::runtime::RuntimeType for ITextEditProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{ea3605b4-3a05-400e-b5f9-4e91b40f6176}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ITextProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{db5bbc9f-4807-4f2a-8678-1b13f3c60e22}");
}
...
pub struct ITextProvider_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        screenlocation: super::super::super::super::Foundation::Point,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::RuntimeType for ITextProvider2 {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{df1d48bc-0487-4e7f-9d5e-f09e77e41246}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ITextRangeProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{0274688d-06e9-4f66-9446-28a5be98fbd0}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ITextRangeProvider2 {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{d3be3dfb-9f54-4642-a7a5-5c18d5ee2a3f}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IToggleProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{93b88290-656f-44f7-aeaf-78b8f944d062}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ITransformProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{79670fdd-f6a9-4a65-af17-861db799a2da}");
}
...
unsafe impl ::windows::runtime::Interface for ITransformProvider2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        41887,
        20119,
        [140, 125, 193, 234, 141, 214, 51, 197],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for ITransformProvider2 {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{a8b11756-a39f-4e97-8c7d-c1ea8dd633c5}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IValueProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{2086b7a7-ac0e-47d1-ab9b-2a64292afdf8}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IVirtualizedItemProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{17d4a04b-d658-48e0-a574-5a516c58dfa7}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IWindowProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{1baa8b3d-38cf-415a-85d3-20e43a0ec1b1}");
}
