...
impl AddPagesEventArgs {
    ...
    pub fn PrintTaskOptions(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Graphics::Printing::PrintTaskOptions> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::super::Graphics::Printing::PrintTaskOptions>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for AddPagesEventArgs {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Printing.AddPagesEventArgs;{e2e52be5-056c-4420-9795-cb3526ce0c20})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for AddPagesEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({d4b57970-57a0-4209-847c-c093b54bc729})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for GetPreviewPageEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({ccb3e9ed-9c11-4e50-ab49-e98086bbfdef})",
    );
}
unsafe impl ::windows::runtime::Interface for GetPreviewPageEventHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        39953,
        20048,
        [171, 73, 233, 128, 134, 187, 253, 239],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IPrintDocumentFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        9734,
        18991,
        [153, 212, 167, 205, 188, 53, 215, 199],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::RuntimeType for PaginateEventArgs {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Printing.PaginateEventArgs;{ed945fd6-79ab-42b7-930a-3d6e09011d21})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for PaginateEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({0cc05b61-811b-4a32-9965-13eb78dbb01b})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for PreviewPageCountType {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.Xaml.Printing.PreviewPageCountType;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl PrintDocument {
    ...
    pub fn DocumentSource(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Graphics::Printing::IPrintDocumentSource>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Graphics::Printing::IPrintDocumentSource>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
...
unsafe impl ::windows::runtime::RuntimeType for PrintDocument {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Printing.PrintDocument;{e44327c3-a999-485b-b1d8-72dc517821e6})",
    );
}
