...
unsafe impl ::windows::runtime::RuntimeType for Binding {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.Binding;{3f7a0c6b-d00f-4730-8c1d-48e16c46f9ca})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for BindingBase {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.BindingBase;{1589a2ab-3d15-49bc-a447-8a5448e58870})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for BindingExpression {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.BindingExpression;{516a19a5-c2fd-4a9e-9fd3-9aa42f995a3c})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for BindingExpressionBase {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.BindingExpressionBase;{fded3154-e954-4f67-8fb6-6ed79b3a1cb3})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for BindingMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.UI.Xaml.Data.BindingMode;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for BindingOperations {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.BindingOperations;{6fffd738-9839-419c-a17a-4b3604e1524e})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for CollectionViewSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.CollectionViewSource;{a66a1146-d2fb-4ead-be9f-3578a466dcfe})",
    );
}
unsafe impl ::windows::runtime::Interface for CollectionViewSource {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        54011,
        20141,
        [190, 159, 53, 120, 164, 102, 220, 254],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for CurrentChangingEventArgs {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.CurrentChangingEventArgs;{f9891e29-51cc-47dd-a5b9-35dc4914af69})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for CurrentChangingEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({f3888db8-139f-4dce-8dc9-f7f1444d1185})",
    );
}
...
unsafe impl ::windows::runtime::Interface for IBindingExpressionBaseFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        49881,
        17269,
        [180, 113, 102, 185, 196, 140, 121, 48],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl ICollectionView {
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Foundation::Collections::IObservableVector<
                ::windows::runtime::IInspectable,
            >>(result__)
        }
    }
    ...
    pub fn LoadMoreItemsAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<LoadMoreItemsResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<LoadMoreItemsResult>>(
                result__,
            )
        }
    }
    ...
    pub fn First(
        ...
        super::super::super::Foundation::Collections::IIterator<::windows::runtime::IInspectable>,
    > {
    ...
    pub fn VectorChanged<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::Collections::VectorChangedEventHandler<
                ::windows::runtime::IInspectable,
            >,
        >,
    >(
    ...
    pub fn GetAt(
        ...
        let this = &::windows::runtime::Interface::cast::<
            super::super::super::Foundation::Collections::IVector<::windows::runtime::IInspectable>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
...
unsafe impl ::windows::runtime::RuntimeType for ICollectionView {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{8be8bfe4-dbef-44df-8126-a31a89121ddc}");
}
...
impl ::std::convert::TryFrom<ICollectionView>
    for super::super::super::Foundation::Collections::IIterable<::windows::runtime::IInspectable>
{
...
impl<'a>
    ::windows::runtime::IntoParam<
        'a,
        super::super::super::Foundation::Collections::IIterable<::windows::runtime::IInspectable>,
    > for ICollectionView
{
    fn into_param(
        self,
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<ICollectionView>
    for super::super::super::Foundation::Collections::IObservableVector<
        ::windows::runtime::IInspectable,
    >
{
    type Error = ::windows::runtime::Error;
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<ICollectionView>
    for super::super::super::Foundation::Collections::IVector<::windows::runtime::IInspectable>
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: ICollectionView) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
unsafe impl ::windows::runtime::RuntimeType for ICollectionViewFactory {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{34d4aaf4-8e72-4950-9192-ecd07d399d0a}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ICollectionViewGroup {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{7e01b9d8-d7b5-48b6-b31c-5bb5bdf5f09b}");
}
...
unsafe impl ::windows::runtime::Interface for ICollectionViewSourceStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        18095,
        19468,
        [129, 139, 33, 182, 239, 129, 191, 101],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ICurrentChangingEventArgsFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        25331,
        18639,
        [129, 131, 139, 226, 109, 227, 166, 110],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl ICustomPropertyProvider {
    ...
    pub fn GetIndexedProperty<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::Interop::TypeName>,
    >(
        &self,
        name: Param0,
        r#type: Param1,
...
unsafe impl ::windows::runtime::Interface for IItemIndexRangeFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        11898,
        19581,
        [166, 100, 232, 171, 240, 123, 252, 126],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IItemsRangeInfo {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        29181,
        17826,
        [190, 19, 160, 129, 210, 148, 166, 141],
    );
}
impl IItemsRangeInfo {
    ...
    pub fn RangesChanged<
        ...
        Param1: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::Collections::IVectorView<ItemIndexRange>,
        >,
    >(
        &self,
        visiblerange: Param0,
...
unsafe impl ::windows::runtime::RuntimeType for IItemsRangeInfo {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{f05f5665-71fd-45a2-be13-a081d294a68d}");
}
...
unsafe impl ::windows::runtime::RuntimeType for INotifyPropertyChanged {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{cf75d69c-f2f4-486b-b302-bb4c09baebfa}");
}
...
unsafe impl ::windows::runtime::Interface for IRelativeSource {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        10274,
        18490,
        [180, 153, 208, 240, 49, 224, 108, 107],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl ISelectionInfo {
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Foundation::Collections::IVectorView<ItemIndexRange>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for ISelectionInfo {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{2e12ca86-e1ed-4245-be49-207e42aec524}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ISupportIncrementalLoading {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{7f5ee992-7694-4e6c-a51b-e34bf43de743}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IValueConverter {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{e6f2fef0-0712-487f-b313-f300b8d79aa1}");
}
...
pub struct IValueConverter_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: ::windows::runtime::RawPtr,
        targettype: ::std::mem::ManuallyDrop<super::Interop::TypeName>,
...
unsafe impl ::windows::runtime::RuntimeType for ItemIndexRange {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.ItemIndexRange;{83b834be-0583-4a26-9b64-8bf4a2f65704})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for LoadMoreItemsResult {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"struct(Windows.UI.Xaml.Data.LoadMoreItemsResult;u4)",
    );
}
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::RuntimeType for PropertyChangedEventArgs {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.PropertyChangedEventArgs;{4f33a9a0-5cf4-47a4-b16f-d7faaf17457e})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for PropertyChangedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({50f19c16-0a22-4d8e-a089-1ea9951657d2})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for RelativeSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Data.RelativeSource;{2397ce84-2822-483a-b499-d0f031e06c6b})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for RelativeSourceMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.Xaml.Data.RelativeSourceMode;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for UpdateSourceTrigger {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.Xaml.Data.UpdateSourceTrigger;i4)",
    );
}
