...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DesignerAppExitedEventArgs
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DesignerAppExitedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl DesignerAppManager {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDesignerAppExited<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateNewViewAsync<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Size>,
    >(
        &self,
        initialviewstate: DesignerAppViewState,
        initialviewsize: Param1,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncOperation<DesignerAppView>>
    {
        let this = self;
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
                initialviewstate,
                initialviewsize.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<DesignerAppView>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn LoadObjectIntoAppAsync<
        'a,
    ...
    >(
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).10)(
                ::std::mem::transmute_copy(this),
                dllname.into_param().abi(),
                classid.into_param().abi(),
                initializationdata.into_param().abi(),
                &mut result__,
            )
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
    ...
    ) -> ::windows::runtime::Result<DesignerAppManager> {
        Self::IDesignerAppManagerFactory(|this| unsafe {
            ...
            .from_abi::<DesignerAppManager>(result__)
        })
    }
    pub fn IDesignerAppManagerFactory<
        R,
        F: FnOnce(&IDesignerAppManagerFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl DesignerAppView {
    ...
    pub fn ViewState(&self) -> ::windows::runtime::Result<DesignerAppViewState> {
        ...
        unsafe {
            ...
            .from_abi::<DesignerAppViewState>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
...
impl DesktopWindowXamlSource {
    ...
    pub fn SetContent<'a, Param0: ::windows::runtime::IntoParam<'a, super::UIElement>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn NavigateFocus<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, XamlSourceFocusNavigationRequest>,
    >(
        &self,
        request: Param0,
    ) -> ::windows::runtime::Result<XamlSourceFocusNavigationResult> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<XamlSourceFocusNavigationResult>(result__)
        }
    }
    pub fn new() -> ::windows::runtime::Result<DesktopWindowXamlSource> {
        Self::IDesktopWindowXamlSourceFactory(|this| unsafe {
            ...
            .from_abi::<DesktopWindowXamlSource>(result__)
        })
    }
    pub fn IDesktopWindowXamlSourceFactory<
        R,
        F: FnOnce(&IDesktopWindowXamlSourceFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<DesktopWindowXamlSource>
...
impl DesktopWindowXamlSourceGotFocusEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<XamlSourceFocusNavigationRequest> {
        ...
        unsafe {
            ...
            .from_abi::<XamlSourceFocusNavigationRequest>(result__)
        }
    }
}
...
impl ::std::convert::From<DesktopWindowXamlSourceGotFocusEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DesktopWindowXamlSourceGotFocusEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DesktopWindowXamlSourceGotFocusEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<DesktopWindowXamlSourceTakeFocusRequestedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DesktopWindowXamlSourceTakeFocusRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ElementCompositionPreview {
    ...
    >(
        ...
        Self::IElementCompositionPreviewStatics3(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                xamlcontent.into_param().abi(),
            )
            .ok()
        })
    }
    #[cfg(feature = "UI_WindowManagement")]
    pub fn GetAppWindowContent<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::WindowManagement::AppWindow>,
    >(
        appwindow: Param0,
    ...
    pub fn IElementCompositionPreviewStatics2<
        R,
        F: FnOnce(&IElementCompositionPreviewStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IElementCompositionPreviewStatics3<
        R,
        F: FnOnce(&IElementCompositionPreviewStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
pub struct IDesignerAppManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        dllname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        classid: ::windows::runtime::GUID,
        initializationdata: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
...
pub struct IDesignerAppManagerFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appusermodelid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
unsafe impl ::windows::runtime::Interface for IElementCompositionPreviewStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        60569,
        19541,
        [188, 133, 161, 193, 128, 178, 118, 70],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IElementCompositionPreviewStatics3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appwindow: ::windows::runtime::RawPtr,
        xamlcontent: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IWindowsXamlManager {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        6816,
        21128,
        [136, 24, 110, 116, 162, 220, 175, 245],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IXamlUIPresenterHost {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        40813,
        20352,
        [172, 44, 14, 108, 185, 243, 22, 89],
    );
}
impl IXamlUIPresenterHost {
    pub fn ResolveFileResource<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
...
unsafe impl ::windows::runtime::RuntimeType for IXamlUIPresenterHost {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{aafb84cd-9f6d-4f80-ac2c-0e6cb9f31659}");
}
...
unsafe impl ::windows::runtime::Interface for IXamlUIPresenterHost2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        31908,
        18977,
        [181, 106, 136, 244, 129, 35, 136, 202],
    );
}
impl IXamlUIPresenterHost2 {
    pub fn GetGenericXamlFilePath(
        &self,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        let this = self;
        unsafe {
...
unsafe impl ::windows::runtime::RuntimeType for IXamlUIPresenterHost2 {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{61595672-7ca4-4a21-b56a-88f4812388ca}");
}
...
unsafe impl ::windows::runtime::Interface for IXamlUIPresenterHost3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        29472,
        16827,
        [159, 38, 77, 111, 211, 77, 180, 90],
    );
}
impl IXamlUIPresenterHost3 {
    pub fn ResolveDictionaryResource<
        'a,
    ...
    >(
        &self,
        dictionary: Param0,
        dictionarykey: Param1,
        suggestedvalue: Param2,
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                dictionary.into_param().abi(),
                dictionarykey.into_param().abi(),
                suggestedvalue.into_param().abi(),
                &mut result__,
            )
...
unsafe impl ::windows::runtime::RuntimeType for IXamlUIPresenterHost3 {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{b14292bf-7320-41bb-9f26-4d6fd34db45a}");
}
...
pub struct IXamlUIPresenterHost3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        dictionary: ::windows::runtime::RawPtr,
        dictionarykey: ::windows::runtime::RawPtr,
        suggestedvalue: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct IXamlUIPresenterStatics2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        placementtarget: ::windows::runtime::RawPtr,
...
impl WindowsXamlManager {
    ...
    pub fn InitializeForCurrentThread() -> ::windows::runtime::Result<WindowsXamlManager> {
        Self::IWindowsXamlManagerStatics(|this| unsafe {
            ...
            .from_abi::<WindowsXamlManager>(result__)
        })
    }
    pub fn IWindowsXamlManagerStatics<
        R,
        F: FnOnce(&IWindowsXamlManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl XamlSourceFocusNavigationRequest {
    pub fn Reason(&self) -> ::windows::runtime::Result<XamlSourceFocusNavigationReason> {
        ...
        unsafe {
            ...
            .from_abi::<XamlSourceFocusNavigationReason>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn CreateInstance(
        reason: XamlSourceFocusNavigationReason,
    ) -> ::windows::runtime::Result<XamlSourceFocusNavigationRequest> {
    ...
    pub fn IXamlSourceFocusNavigationRequestFactory<
        R,
        F: FnOnce(&IXamlSourceFocusNavigationRequestFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for XamlSourceFocusNavigationRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a XamlSourceFocusNavigationRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl XamlSourceFocusNavigationResult {
    ...
    pub fn IXamlSourceFocusNavigationResultFactory<
        R,
        F: FnOnce(&IXamlSourceFocusNavigationResultFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for XamlSourceFocusNavigationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a XamlSourceFocusNavigationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl XamlUIPresenter {
    ...
    pub fn SetRootElement<'a, Param0: ::windows::runtime::IntoParam<'a, super::UIElement>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn SetHost<'a, Param0: ::windows::runtime::IntoParam<'a, IXamlUIPresenterHost>>(
        host: Param0,
    ) -> ::windows::runtime::Result<()> {
        Self::IXamlUIPresenterStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).8)(
    ...
    #[cfg(all(feature = "Foundation", feature = "UI_Xaml_Controls_Primitives"))]
    pub fn GetFlyoutPlacementTargetInfo<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::FrameworkElement>,
    >(
        placementtarget: Param0,
        preferredplacement: super::Controls::Primitives::FlyoutPlacementMode,
        targetpreferredplacement: &mut super::Controls::Primitives::FlyoutPlacementMode,
        allowfallbacks: &mut bool,
        ...
        Self::IXamlUIPresenterStatics2(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                placementtarget.into_param().abi(),
                preferredplacement,
    ...
    pub fn GetFlyoutPlacement<
        ...
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Size>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Size>,
        Param3: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Rect>,
    >(
        ...
        Self::IXamlUIPresenterStatics2(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                placementtargetbounds.into_param().abi(),
                controlsize.into_param().abi(),
                mincontrolsize.into_param().abi(),
                containerrect.into_param().abi(),
                targetpreferredplacement,
                allowfallbacks,
                chosenplacement,
                &mut result__,
    ...
    pub fn IXamlUIPresenterStatics<
        R,
        F: FnOnce(&IXamlUIPresenterStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IXamlUIPresenterStatics2<
        R,
        F: FnOnce(&IXamlUIPresenterStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
