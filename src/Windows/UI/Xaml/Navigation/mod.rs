...
unsafe impl ::windows::runtime::Interface for IFrameNavigationOptionsFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        32365,
        23676,
        [172, 160, 71, 134, 129, 204, 111, 206],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for INavigationEventArgs2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        38810,
        19246,
        [164, 155, 59, 177, 127, 222, 245, 116],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPageStackEntryFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        sourcepagetype: ::std::mem::ManuallyDrop<super::Interop::TypeName>,
...
unsafe impl ::windows::runtime::RuntimeType for LoadCompletedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({aebaf785-43fc-4e2c-95c3-97ae84eabc8e})",
    );
}
unsafe impl ::windows::runtime::Interface for LoadCompletedEventHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        17404,
        20012,
        [149, 195, 151, 174, 132, 234, 188, 142],
    );
}
#[repr(C)]
#[doc(hidden)]
...
#[repr(C)]
struct LoadCompletedEventHandler_box<
    F: FnMut(
            &::std::option::Option<::windows::runtime::IInspectable>,
            &::std::option::Option<NavigationEventArgs>,
        ) -> ::windows::runtime::Result<()>
...
impl<
        F: FnMut(
            ...
            + 'static,
    > LoadCompletedEventHandler_box<F>
{
    const VTABLE: LoadCompletedEventHandler_abi = LoadCompletedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid == &<LoadCompletedEventHandler as ::windows::runtime::Interface>::IID
...
unsafe impl ::windows::runtime::RuntimeType for NavigatedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({7bd1cf54-23cf-4cce-b2f5-4ce78d96896e})",
    );
}
unsafe impl ::windows::runtime::Interface for NavigatedEventHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        9167,
        19662,
        [178, 245, 76, 231, 141, 150, 137, 110],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::RuntimeType for NavigatingCancelEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({75d6a78f-a302-4489-9898-24ea49182910})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for NavigationCacheMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.Xaml.Navigation.NavigationCacheMode;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::RuntimeType for NavigationFailedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({4dab4671-12b2-43c7-b892-9be2dcd3e88d})",
    );
}
unsafe impl ::windows::runtime::Interface for NavigationFailedEventHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        4786,
        17351,
        [184, 146, 155, 226, 220, 211, 232, 141],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::RuntimeType for NavigationMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.UI.Xaml.Navigation.NavigationMode;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::RuntimeType for NavigationStoppedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({f0117ddb-12fa-4d8d-8b26-b383d09c2b3c})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for PageStackEntry {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.UI.Xaml.Navigation.PageStackEntry;{ef8814a6-9388-4aca-8572-405194069080})",
    );
}
