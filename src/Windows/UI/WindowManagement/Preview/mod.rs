...
impl WindowManagementPreview {
    ...
    pub fn SetPreferredMinSize<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::AppWindow>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Size>,
    >(
        window: Param0,
        preferredframeminsize: Param1,
    ) -> ::windows::runtime::Result<()> {
        Self::IWindowManagementPreviewStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                window.into_param().abi(),
                preferredframeminsize.into_param().abi(),
            )
            .ok()
        })
    }
    pub fn IWindowManagementPreviewStatics<
        R,
        F: FnOnce(&IWindowManagementPreviewStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
