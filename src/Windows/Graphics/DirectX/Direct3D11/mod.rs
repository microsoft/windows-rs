...
impl ::std::fmt::Debug for Direct3DMultisampleDescription {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("Direct3DMultisampleDescription")
...
impl ::std::fmt::Debug for Direct3DSurfaceDescription {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("Direct3DSurfaceDescription")
            .field("Width", &self.Width)
            .field("Height", &self.Height)
            .field("Format", &self.Format)
            .field("MultisampleDescription", &self.MultisampleDescription)
            .finish()
    }
}
impl ::std::cmp::PartialEq for Direct3DSurfaceDescription {
    fn eq(&self, other: &Self) -> bool {
        self.Width == other.Width
            ...
            && self.MultisampleDescription == other.MultisampleDescription
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for IDirect3DDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{a37624ab-8d5f-4650-9d3e-9eae3d9bc670}");
}
...
unsafe impl ::windows::runtime::Interface for IDirect3DSurface {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        5057,
        18068,
        [190, 227, 122, 191, 21, 234, 245, 134],
    );
}
impl IDirect3DSurface {
    pub fn Description(&self) -> ::windows::runtime::Result<Direct3DSurfaceDescription> {
        ...
        unsafe {
            ...
            .from_abi::<Direct3DSurfaceDescription>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Close(&self) -> ::windows::runtime::Result<()> {
...
unsafe impl ::windows::runtime::RuntimeType for IDirect3DSurface {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{0bf4a146-13c1-4694-bee3-7abf15eaf586}");
}
