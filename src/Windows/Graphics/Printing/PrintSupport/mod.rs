...
unsafe impl ::windows::runtime::Interface for IPrintSupportExtensionSession {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        62662,
        21683,
        [160, 184, 165, 89, 131, 154, 164, 195],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPrintSupportPrintDeviceCapabilitiesChangedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        updatedpdc: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Data_Xml_Dom"))] usize,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
...
unsafe impl ::windows::runtime::Interface for IPrintSupportSessionInfo {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        30589,
        21481,
        [158, 233, 69, 211, 244, 181, 190, 156],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IPrintSupportSettingsActivatedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        40979,
        21994,
        [155, 140, 238, 163, 157, 159, 182, 193],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPrintSupportSettingsUISession_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SettingsLaunchKind,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Graphics_Printing_PrintTicket")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl PrintSupportExtensionSession {
    ...
    #[cfg(feature = "Foundation")]
    pub fn PrintTicketValidationRequested<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemovePrintTicketValidationRequested<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn PrintDeviceCapabilitiesChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemovePrintDeviceCapabilitiesChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PrintSupportExtensionSession
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PrintSupportExtensionSession
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl PrintSupportExtensionTriggerDetails {
    pub fn Session(&self) -> ::windows::runtime::Result<PrintSupportExtensionSession> {
        ...
        unsafe {
            ...
            .from_abi::<PrintSupportExtensionSession>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PrintSupportExtensionTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<PrintSupportExtensionTriggerDetails>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PrintSupportExtensionTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PrintSupportPrintDeviceCapabilitiesChangedEventArgs {
    ...
    pub fn GetCurrentPrintDeviceCapabilities(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Data::Xml::Dom::XmlDocument> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::Data::Xml::Dom::XmlDocument>(result__)
        }
    }
    #[cfg(feature = "Data_Xml_Dom")]
    pub fn UpdatePrintDeviceCapabilities<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Data::Xml::Dom::XmlDocument>,
    >(
        &self,
        updatedpdc: Param0,
    ) -> ::windows::runtime::Result<()> {
...
impl ::std::convert::From<PrintSupportPrintDeviceCapabilitiesChangedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PrintSupportPrintDeviceCapabilitiesChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<PrintSupportPrintTicketValidationRequestedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PrintSupportPrintTicketValidationRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PrintSupportSessionInfo {
    ...
    pub fn SourceAppInfo(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::ApplicationModel::AppInfo> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::ApplicationModel::AppInfo>(result__)
        }
    }
    #[cfg(feature = "Devices_Printers")]
    pub fn Printer(
...
impl PrintSupportSettingsActivatedEventArgs {
    ...
    pub fn Session(&self) -> ::windows::runtime::Result<PrintSupportSettingsUISession> {
        ...
        unsafe {
            ...
            .from_abi::<PrintSupportSettingsUISession>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(
...
impl ::std::convert::From<&PrintSupportSettingsActivatedEventArgs>
    for ::windows::runtime::IUnknown
{
    fn from(value: &PrintSupportSettingsActivatedEventArgs) -> Self {
        ::std::convert::From::from(::std::clone::Clone::clone(value))
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PrintSupportSettingsActivatedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PrintSupportSettingsActivatedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "ApplicationModel_Activation")]
impl ::std::convert::TryFrom<PrintSupportSettingsActivatedEventArgs>
    ...
    for super::super::super::ApplicationModel::Activation::IActivatedEventArgs
{
    type Error = ::windows::runtime::Error;
    fn try_from(
        value: &PrintSupportSettingsActivatedEventArgs,
...
impl PrintSupportSettingsUISession {
    ...
    pub fn LaunchKind(&self) -> ::windows::runtime::Result<SettingsLaunchKind> {
        ...
        unsafe {
            ...
            .from_abi::<SettingsLaunchKind>(result__)
        }
    }
    #[cfg(feature = "Graphics_Printing_PrintTicket")]
    pub fn UpdatePrintTicket<
        'a,
    ...
    pub fn SessionInfo(&self) -> ::windows::runtime::Result<PrintSupportSessionInfo> {
        ...
        unsafe {
            ...
            .from_abi::<PrintSupportSessionInfo>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PrintSupportSettingsUISession
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PrintSupportSettingsUISession
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WorkflowPrintTicketValidationStatus {
    pub const Resolved: WorkflowPrintTicketValidationStatus =
        WorkflowPrintTicketValidationStatus(0i32);
    pub const Conflicting: WorkflowPrintTicketValidationStatus =
        WorkflowPrintTicketValidationStatus(1i32);
    pub const Invalid: WorkflowPrintTicketValidationStatus =
        WorkflowPrintTicketValidationStatus(2i32);
}
