...
pub struct IPrintTicketCapabilities_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        xmlnamespace: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IPrintTicketFeature_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PrintTicketFeatureSelectionType,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IPrintTicketParameterDefinition {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        10594,
        19457,
        [183, 243, 154, 146, 148, 235, 131, 53],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IPrintTicketParameterDefinition_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PrintTicketParameterDataType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
unsafe impl ::windows::runtime::Interface for IPrintTicketValue {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        9293,
        20002,
        [169, 139, 187, 60, 241, 242, 221, 145],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IPrintTicketValue_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PrintTicketValueType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut i32,
...
unsafe impl ::windows::runtime::Interface for IWorkflowPrintTicket {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        13800,
        17550,
        [168, 197, 228, 182, 162, 207, 130, 108],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IWorkflowPrintTicket_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        name: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        xmlnamespace: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        stringvalue: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        deltashematicket: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
impl PrintTicketCapabilities {
    ...
    pub fn XmlNode(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Data::Xml::Dom::IXmlNode> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::super::Data::Xml::Dom::IXmlNode>(result__)
        }
    }
    pub fn DocumentBindingFeature(&self) -> ::windows::runtime::Result<PrintTicketFeature> {
        ...
        unsafe {
            ...
            .from_abi::<PrintTicketFeature>(result__)
        }
    }
    ...
    >(
        ...
        name: Param0,
        xmlnamespace: Param1,
    ) -> ::windows::runtime::Result<PrintTicketFeature> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    >(
        ...
        name: Param0,
        xmlnamespace: Param1,
    ) -> ::windows::runtime::Result<PrintTicketParameterDefinition> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<PrintTicketParameterDefinition>(result__)
        }
    }
}
...
impl PrintTicketFeature {
    ...
    >(
        ...
        name: Param0,
        xmlnamespace: Param1,
    ) -> ::windows::runtime::Result<PrintTicketOption> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
            ...
            .from_abi::<PrintTicketOption>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Options(
        ...
        super::super::super::Foundation::Collections::IVectorView<PrintTicketOption>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn SetSelectedOption<'a, Param0: ::windows::runtime::IntoParam<'a, PrintTicketOption>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn SelectionType(&self) -> ::windows::runtime::Result<PrintTicketFeatureSelectionType> {
        ...
        unsafe {
            ...
            .from_abi::<PrintTicketFeatureSelectionType>(result__)
        }
    }
}
...
impl PrintTicketOption {
    ...
    >(
        ...
        name: Param0,
        xmlnamespace: Param1,
    ) -> ::windows::runtime::Result<PrintTicketValue> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).12)(
            ...
            .from_abi::<PrintTicketValue>(result__)
        }
    }
...
impl PrintTicketParameterDefinition {
    ...
    pub fn DataType(&self) -> ::windows::runtime::Result<PrintTicketParameterDataType> {
        ...
        unsafe {
            ...
            .from_abi::<PrintTicketParameterDataType>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PrintTicketParameterDefinition
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PrintTicketParameterInitializer {
    ...
    pub fn SetValue<'a, Param0: ::windows::runtime::IntoParam<'a, PrintTicketValue>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PrintTicketParameterInitializer
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PrintTicketValue {
    pub fn Type(&self) -> ::windows::runtime::Result<PrintTicketValueType> {
        ...
        unsafe {
            ...
            .from_abi::<PrintTicketValueType>(result__)
        }
    }
...
impl WorkflowPrintTicket {
    ...
    pub fn GetCapabilities(&self) -> ::windows::runtime::Result<PrintTicketCapabilities> {
        ...
        unsafe {
            ...
            .from_abi::<PrintTicketCapabilities>(result__)
        }
    }
    pub fn DocumentBindingFeature(&self) -> ::windows::runtime::Result<PrintTicketFeature> {
        let this = self;
    ...
    pub fn ValidateAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<WorkflowPrintTicketValidationResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    >(
        ...
        name: Param0,
        xmlnamespace: Param1,
    ) -> ::windows::runtime::Result<PrintTicketParameterInitializer> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<PrintTicketParameterInitializer>(result__)
        }
    }
    ...
    pub fn MergeAndValidateTicket<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, WorkflowPrintTicket>,
    >(
        &self,
        deltashematicket: Param0,
    ) -> ::windows::runtime::Result<WorkflowPrintTicket> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).31)(
                ::std::mem::transmute_copy(this),
                deltashematicket.into_param().abi(),
                &mut result__,
            )
            .from_abi::<WorkflowPrintTicket>(result__)
        }
    }
}
...
impl ::std::convert::From<WorkflowPrintTicketValidationResult>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WorkflowPrintTicketValidationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
