...
impl AdvancedColorInfo {
    pub fn CurrentAdvancedColorKind(&self) -> ::windows::runtime::Result<AdvancedColorKind> {
        ...
        unsafe {
            ...
            .from_abi::<AdvancedColorKind>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for AdvancedColorInfo {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Graphics.Display.AdvancedColorInfo;{8797dcfb-b229-4081-ae9a-2cc85e34ad6a})",
    );
}
...
impl BrightnessOverride {
    ...
    #[cfg(feature = "Foundation")]
    pub fn IsOverrideActiveChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveIsOverrideActiveChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveBrightnessLevelChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn GetDefaultForSystem() -> ::windows::runtime::Result<BrightnessOverride> {
        Self::IBrightnessOverrideStatics(|this| unsafe {
            ...
            .from_abi::<BrightnessOverride>(result__)
        })
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn SaveForSystemAsync<'a, Param0: ::windows::runtime::IntoParam<'a, BrightnessOverride>>(
        value: Param0,
    ...
    pub fn IBrightnessOverrideStatics<
        R,
        F: FnOnce(&IBrightnessOverrideStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for BrightnessOverride {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Graphics.Display.BrightnessOverride;{96c9621a-c143-4392-bedd-4a7e9574c8fd})",
    );
}
unsafe impl ::windows::runtime::Interface for BrightnessOverride {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        49475,
        17298,
        [190, 221, 74, 126, 149, 116, 200, 253],
    );
}
...
impl BrightnessOverrideSettings {
    ...
    pub fn CreateFromLevel(level: f64) -> ::windows::runtime::Result<BrightnessOverrideSettings> {
        Self::IBrightnessOverrideSettingsStatics(|this| unsafe {
            ...
            .from_abi::<BrightnessOverrideSettings>(result__)
        })
    }
    ...
    ) -> ::windows::runtime::Result<BrightnessOverrideSettings> {
        Self::IBrightnessOverrideSettingsStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn IBrightnessOverrideSettingsStatics<
        R,
        F: FnOnce(&IBrightnessOverrideSettingsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BrightnessOverrideSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ColorOverrideSettings {
    pub fn DesiredDisplayColorOverrideScenario(
        &self,
    ) -> ::windows::runtime::Result<DisplayColorOverrideScenario> {
        let this = self;
        unsafe {
            ...
            .from_abi::<DisplayColorOverrideScenario>(result__)
        }
    }
    pub fn CreateFromDisplayColorOverrideScenario(
        overridescenario: DisplayColorOverrideScenario,
    ) -> ::windows::runtime::Result<ColorOverrideSettings> {
        Self::IColorOverrideSettingsStatics(|this| unsafe {
            ...
            .from_abi::<ColorOverrideSettings>(result__)
        })
    }
    pub fn IColorOverrideSettingsStatics<
        R,
        F: FnOnce(&IColorOverrideSettingsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl DisplayBrightnessOverrideOptions {
    ...
    pub const UseDimmedPolicyWhenBatteryIsLow: DisplayBrightnessOverrideOptions =
        DisplayBrightnessOverrideOptions(1u32);
}
...
impl DisplayBrightnessOverrideScenario {
    pub const IdleBrightness: DisplayBrightnessOverrideScenario =
        DisplayBrightnessOverrideScenario(0i32);
    pub const BarcodeReadingBrightness: DisplayBrightnessOverrideScenario =
        DisplayBrightnessOverrideScenario(1i32);
    pub const FullBrightness: DisplayBrightnessOverrideScenario =
        DisplayBrightnessOverrideScenario(2i32);
}
...
impl DisplayEnhancementOverride {
    ...
    pub fn SetColorOverrideSettings<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ColorOverrideSettings>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn BrightnessOverrideSettings(
        &self,
    ) -> ::windows::runtime::Result<BrightnessOverrideSettings> {
        let this = self;
        unsafe {
    ...
    pub fn SetBrightnessOverrideSettings<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BrightnessOverrideSettings>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn GetCurrentDisplayEnhancementOverrideCapabilities(
        &self,
    ) -> ::windows::runtime::Result<DisplayEnhancementOverrideCapabilities> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).12)(
            ...
            .from_abi::<DisplayEnhancementOverrideCapabilities>(result__)
        }
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveCanOverrideChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn DisplayEnhancementOverrideCapabilitiesChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<DisplayEnhancementOverride> {
        Self::IDisplayEnhancementOverrideStatics(|this| unsafe {
            ...
            .from_abi::<DisplayEnhancementOverride>(result__)
        })
    }
    pub fn IDisplayEnhancementOverrideStatics<
        R,
        F: FnOnce(&IDisplayEnhancementOverrideStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DisplayEnhancementOverride
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl DisplayEnhancementOverrideCapabilities {
    ...
    pub fn GetSupportedNitRanges(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<NitRange>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<NitRange>>(result__)
        }
    }
}
...
impl ::std::convert::From<&DisplayEnhancementOverrideCapabilities>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DisplayEnhancementOverrideCapabilities
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<DisplayEnhancementOverrideCapabilitiesChangedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DisplayEnhancementOverrideCapabilitiesChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl DisplayInformation {
    pub fn CurrentOrientation(&self) -> ::windows::runtime::Result<DisplayOrientations> {
        ...
        unsafe {
            ...
            .from_abi::<DisplayOrientations>(result__)
        }
    }
    ...
    pub fn ResolutionScale(&self) -> ::windows::runtime::Result<ResolutionScale> {
        ...
        unsafe {
            ...
            .from_abi::<ResolutionScale>(result__)
        }
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveStereoEnabledChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn SetAutoRotationPreferences(
    ...
    #[cfg(feature = "Foundation")]
    pub fn DisplayContentsInvalidated<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDisplayContentsInvalidated<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        token: Param0,
    ...
    pub fn GetAdvancedColorInfo(&self) -> ::windows::runtime::Result<AdvancedColorInfo> {
        ...
        unsafe {
            ...
            .from_abi::<AdvancedColorInfo>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn IDisplayInformationStatics<
        R,
        F: FnOnce(&IDisplayInformationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for DisplayInformation {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Graphics.Display.DisplayInformation;{bed112ae-adc3-4dc9-ae65-851f4d7d4799})",
    );
}
...
impl DisplayProperties {
    ...
    pub fn OrientationChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, DisplayPropertiesEventHandler>,
    >(
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
        Self::IDisplayPropertiesStatics(|this| unsafe {
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn RemoveLogicalDpiChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        token: Param0,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn GetColorProfileAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Storage::Streams::IRandomAccessStream,
        >,
    > {
    ...
    pub fn IDisplayPropertiesStatics<
        R,
        F: FnOnce(&IDisplayPropertiesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for DisplayPropertiesEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({dbdd8b01-f1a1-46d1-9ee3-543bcc995980})",
    );
}
...
#[repr(C)]
struct DisplayPropertiesEventHandler_box<
    F: FnMut(
            &::std::option::Option<::windows::runtime::IInspectable>,
        ) -> ::windows::runtime::Result<()>
        + 'static,
...
impl<
        F: FnMut(
            ...
            + 'static,
    > DisplayPropertiesEventHandler_box<F>
{
    const VTABLE: DisplayPropertiesEventHandler_abi = DisplayPropertiesEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid
            == &<DisplayPropertiesEventHandler as ::windows::runtime::Interface>::IID
...
impl DisplayServices {
    pub fn FindAll() -> ::windows::runtime::Result<::windows::runtime::Array<super::DisplayId>> {
        Self::IDisplayServicesStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                ::windows::runtime::Array::<super::DisplayId>::set_abi_len(&mut result__),
                &mut result__ as *mut _ as _,
            )
            .and_then(|| result__)
        })
    }
    pub fn IDisplayServicesStatics<
        R,
        F: FnOnce(&IDisplayServicesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for DisplayServices {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Graphics.Display.DisplayServices;{1b54f32b-890d-5747-bd26-fdbdeb0c8a71})",
    );
}
...
pub struct IAdvancedColorInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AdvancedColorKind,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IColorOverrideSettings_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DisplayColorOverrideScenario,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IColorOverrideSettingsStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        50207,
        19145,
        [175, 171, 130, 122, 182, 36, 143, 154],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IDisplayInformation_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DisplayOrientations,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DisplayOrientations,
...
unsafe impl ::windows::runtime::Interface for IDisplayInformation4 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        4674,
        18110,
        [181, 54, 225, 170, 254, 158, 122, 207],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IDisplayServicesStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        result__: *mut *mut super::DisplayId,
    ) -> ::windows::runtime::HRESULT,
);
...
impl ::std::fmt::Debug for NitRange {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("NitRange")
            .field("MinNits", &self.MinNits)
...
impl ::std::cmp::PartialEq for NitRange {
    fn eq(&self, other: &Self) -> bool {
        self.MinNits == other.MinNits
            && self.MaxNits == other.MaxNits
            && self.StepSizeNits == other.StepSizeNits
    }
}
