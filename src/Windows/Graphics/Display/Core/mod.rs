...
impl HdmiDisplayInformation {
    ...
    pub fn GetSupportedDisplayModes(
        ...
        super::super::super::Foundation::Collections::IVectorView<HdmiDisplayMode>,
    > {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::super::Foundation::Collections::IVectorView<HdmiDisplayMode>>(
                result__,
            )
        }
    }
    pub fn GetCurrentDisplayMode(&self) -> ::windows::runtime::Result<HdmiDisplayMode> {
        ...
        unsafe {
            ...
            .from_abi::<HdmiDisplayMode>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn SetDefaultDisplayModeAsync(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RequestSetCurrentDisplayModeAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, HdmiDisplayMode>,
    >(
        &self,
        mode: Param0,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RequestSetCurrentDisplayModeWithHdrAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, HdmiDisplayMode>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RequestSetCurrentDisplayModeWithHdrAndMetadataAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, HdmiDisplayMode>,
        Param2: ::windows::runtime::IntoParam<'a, HdmiDisplayHdr2086Metadata>,
    >(
        &self,
        mode: Param0,
        hdroption: HdmiDisplayHdrOption,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDisplayModesChanged<
        'a,
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<HdmiDisplayInformation> {
        Self::IHdmiDisplayInformationStatics(|this| unsafe {
            ...
            .from_abi::<HdmiDisplayInformation>(result__)
        })
    }
    pub fn IHdmiDisplayInformationStatics<
        R,
        F: FnOnce(&IHdmiDisplayInformationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl HdmiDisplayMode {
    ...
    pub fn IsEqual<'a, Param0: ::windows::runtime::IntoParam<'a, HdmiDisplayMode>>(
        &self,
        mode: Param0,
    ...
    pub fn ColorSpace(&self) -> ::windows::runtime::Result<HdmiDisplayColorSpace> {
        ...
        unsafe {
            ...
            .from_abi::<HdmiDisplayColorSpace>(result__)
        }
    }
    pub fn PixelEncoding(&self) -> ::windows::runtime::Result<HdmiDisplayPixelEncoding> {
        ...
        unsafe {
            ...
            .from_abi::<HdmiDisplayPixelEncoding>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for HdmiDisplayMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Graphics.Display.Core.HdmiDisplayMode;{0c06d5ad-1b90-4f51-9981-ef5a1c0ddf66})",
    );
}
...
pub struct IHdmiDisplayMode_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut HdmiDisplayColorSpace,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut HdmiDisplayPixelEncoding,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
...
unsafe impl ::windows::runtime::Interface for IHdmiDisplayMode2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        19260,
        17080,
        [132, 231, 137, 83, 104, 113, 138, 242],
    );
}
#[repr(C)]
#[doc(hidden)]
