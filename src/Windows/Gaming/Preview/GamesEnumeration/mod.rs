...
impl GameList {
    ...
    pub fn FindAllAsync() -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Foundation::Collections::IVectorView<GameListEntry>,
        >,
    > {
    ...
    pub fn GameAdded<'a, Param0: ::windows::runtime::IntoParam<'a, GameListChangedEventHandler>>(
        handler: Param0,
    ...
    pub fn GameRemoved<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, GameListRemovedEventHandler>,
    >(
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::EventRegistrationToken> {
        Self::IGameListStatics(|this| unsafe {
    ...
    pub fn GameUpdated<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, GameListChangedEventHandler>,
    >(
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::EventRegistrationToken> {
        Self::IGameListStatics(|this| unsafe {
    ...
    pub fn MergeEntriesAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, GameListEntry>,
        Param1: ::windows::runtime::IntoParam<'a, GameListEntry>,
    >(
        left: Param0,
        right: Param1,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncOperation<GameListEntry>>
    {
        Self::IGameListStatics2(|this| unsafe {
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<GameListEntry>>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn UnmergeEntryAsync<'a, Param0: ::windows::runtime::IntoParam<'a, GameListEntry>>(
        mergedentry: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Foundation::Collections::IVectorView<GameListEntry>,
    ...
    pub fn IGameListStatics<R, F: FnOnce(&IGameListStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<GameList, IGameListStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IGameListStatics2<R, F: FnOnce(&IGameListStatics2) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<GameList, IGameListStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl GameListChangedEventHandler {
    pub fn new<
        F: FnMut(&::std::option::Option<GameListEntry>) -> ::windows::runtime::Result<()> + 'static,
    >(
        invoke: F,
    ) -> Self {
    ...
    pub fn Invoke<'a, Param0: ::windows::runtime::IntoParam<'a, GameListEntry>>(
        &self,
        game: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    > GameListChangedEventHandler_box<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid == &<GameListChangedEventHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&game as *const <GameListEntry as ::windows::runtime::Abi>::Abi
                as *const <GameListEntry as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
impl GameListEntry {
    ...
    pub fn DisplayInfo(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::ApplicationModel::AppDisplayInfo> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::ApplicationModel::AppDisplayInfo>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn LaunchAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncOperation<bool>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<bool>>(result__)
        }
    }
    ...
    #[cfg(feature = "Storage")]
    pub fn LauncherExecutable(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Storage::IStorageFile> {
        let this = &::windows::runtime::Interface::cast::<IGameListEntry2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::super::Storage::IStorageFile>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, IGameListEntry> for &GameListEntry {
    fn into_param(self) -> ::windows::runtime::Param<'a, IGameListEntry> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IGameListEntry>::into(
...
impl GameListRemovedEventHandler {
    pub fn new<
        F: FnMut(&::windows::runtime::HSTRING) -> ::windows::runtime::Result<()> + 'static,
    >(
        invoke: F,
    ) -> Self {
    ...
    pub fn Invoke<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        identifier: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
pub struct GameListRemovedEventHandler_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        identifier: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(C)]
...
impl<F: FnMut(&::windows::runtime::HSTRING) -> ::windows::runtime::Result<()> + 'static>
    GameListRemovedEventHandler_box<F>
{
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid == &<GameListRemovedEventHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&identifier as *const <::windows::runtime::HSTRING as ::windows::runtime::Abi>::Abi
                as *const <::windows::runtime::HSTRING as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
impl GameModeConfiguration {
    ...
    pub fn PercentGpuTimeAllocatedToGame(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IReference<i32>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
            ...
            .from_abi::<super::super::super::Foundation::IReference<i32>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn SetPercentGpuTimeAllocatedToGame<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::IReference<i32>>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
...
impl GameModeUserConfiguration {
    ...
    pub fn IGameModeUserConfigurationStatics<
        R,
        F: FnOnce(&IGameModeUserConfigurationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GameModeUserConfiguration
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for IGameListEntry {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{735924d3-811f-4494-b69c-c641a0c61543}");
}
impl ::std::convert::From<IGameListEntry> for ::windows::runtime::IUnknown {
...
impl ::std::convert::From<IGameListEntry> for ::windows::runtime::IInspectable {
    fn from(value: IGameListEntry) -> Self {
        value.0
    }
}
...
pub struct IGameListEntry2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        executablefile: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        executablefile: ::windows::runtime::RawPtr,
        launchparams: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Storage")))] usize,
    pub  unsafe extern "system" fn(
...
pub struct IGameListStatics2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        left: ::windows::runtime::RawPtr,
        right: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        mergedentry: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
);
