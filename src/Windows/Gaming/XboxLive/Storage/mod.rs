...
impl GameSaveBlobInfoGetResult {
    ...
    pub fn Value(
        ...
        super::super::super::Foundation::Collections::IVectorView<GameSaveBlobInfo>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GameSaveBlobInfoGetResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl GameSaveBlobInfoQuery {
    ...
    pub fn GetBlobInfoAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<GameSaveBlobInfoGetResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn GetItemCountAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncOperation<u32>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<u32>>(result__)
        }
    }
}
...
impl GameSaveContainer {
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<GameSaveOperationResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<GameSaveOperationResult>>(
                result__,
            )
        }
    }
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<GameSaveBlobGetResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    ) -> ::windows::runtime::Result<GameSaveBlobInfoQuery> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl GameSaveContainerInfoGetResult {
    ...
    pub fn Value(
        ...
        super::super::super::Foundation::Collections::IVectorView<GameSaveContainerInfo>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for GameSaveContainerInfoGetResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GameSaveContainerInfoGetResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl GameSaveContainerInfoQuery {
    ...
    pub fn GetContainerInfoAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<GameSaveContainerInfoGetResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for GameSaveContainerInfoQuery
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GameSaveContainerInfoQuery
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl GameSaveProvider {
    ...
    >(
        &self,
        name: Param0,
    ) -> ::windows::runtime::Result<GameSaveContainer> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    pub fn CreateContainerInfoQuery(
        &self,
    ) -> ::windows::runtime::Result<GameSaveContainerInfoQuery> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
    ...
    pub fn GetRemainingBytesInQuotaAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncOperation<i64>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<i64>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<GameSaveProviderGetResult>,
    > {
    ...
    pub fn IGameSaveProviderStatics<
        R,
        F: FnOnce(&IGameSaveProviderStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GameSaveProviderGetResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IGameSaveContainer_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        blobstowrite: ::windows::runtime::RawPtr,
        blobstodelete: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        blobstoread: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Foundation",
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        blobnameprefix: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct IGameSaveProvider_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        containernameprefix: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
...
pub struct IGameSaveProviderStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        serviceconfigid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
