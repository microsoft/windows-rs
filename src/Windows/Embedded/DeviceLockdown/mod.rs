...
impl DeviceLockdownProfile {
    ...
    pub fn GetSupportedLockdownProfiles() -> ::windows::runtime::Result<
    ...
    >(
        profileid: Param0,
    ) -> ::windows::runtime::Result<DeviceLockdownProfileInformation> {
        Self::IDeviceLockdownProfileStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<DeviceLockdownProfileInformation>(result__)
        })
    }
    pub fn IDeviceLockdownProfileStatics<
        R,
        F: FnOnce(&IDeviceLockdownProfileStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::Interface for DeviceLockdownProfileInformation {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        17841,
        19094,
        [146, 252, 98, 117, 107, 115, 150, 120],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeviceLockdownProfileInformation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
unsafe impl ::windows::runtime::Interface for IDeviceLockdownProfileStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63912,
        16801,
        [166, 145, 136, 205, 128, 199, 160, 105],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IDeviceLockdownProfileStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        profileid: ::windows::runtime::GUID,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
