...
pub struct ILampArray_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        key: super::super::System::VirtualKey,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        desiredcolor: super::super::UI::Color,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "UI"))] usize,
    #[cfg(feature = "UI")]
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        desiredcolor: super::super::UI::Color,
        lampIndexes_array_size: u32,
        lampindexes: *const i32,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "UI"))] usize,
    #[cfg(feature = "UI")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        desiredColors_array_size: u32,
        desiredcolors: *const super::super::UI::Color,
        lampIndexes_array_size: u32,
        lampindexes: *const i32,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "UI"))] usize,
    ...
    pub  unsafe extern "system" fn(
        ...
        desiredcolors: *const super::super::UI::Color,
        keys_array_size: u32,
        keys: *const super::super::System::VirtualKey,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "System", feature = "UI")))] usize,
    #[cfg(feature = "UI")]
    pub  unsafe extern "system" fn(
...
impl Lamp {
    ...
    #[cfg(feature = "UI")]
    pub fn SetColor<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Color>>(
        &self,
        value: Param0,
    ...
    pub fn AvailabilityChanged<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<Lamp, LampAvailabilityChangedEventArgs>,
        >,
    >(
        &self,
        handler: Param0,
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<Lamp>> {
        Self::ILampStatics(|this| unsafe {
    ...
    pub fn ILampStatics<R, F: FnOnce(&ILampStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<Lamp, ILampStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for Lamp {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Lights.Lamp;{047d5b9a-ea45-4b2b-b1a2-14dff00bde7b})",
    );
}
...
impl LampArray {
    ...
    pub fn LampArrayKind(&self) -> ::windows::runtime::Result<LampArrayKind> {
        ...
        unsafe {
            ...
            .from_abi::<LampArrayKind>(result__)
        }
    }
    ...
    pub fn GetLampInfo(&self, lampindex: i32) -> ::windows::runtime::Result<LampInfo> {
        ...
        unsafe {
            ...
            .from_abi::<LampInfo>(result__)
        }
    }
    #[cfg(feature = "System")]
    pub fn GetIndicesForKey(
        &self,
        key: super::super::System::VirtualKey,
    ) -> ::windows::runtime::Result<::windows::runtime::Array<i32>> {
        let this = self;
        unsafe {
    ...
    pub fn SetColor<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Color>>(
        ...
        unsafe {
            (::windows::runtime::Interface::vtable(this).23)(
                ::std::mem::transmute_copy(this),
                desiredcolor.into_param().abi(),
            )
            .ok()
        }
    }
    #[cfg(feature = "UI")]
    pub fn SetColorForIndex<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::UI::Color>,
    >(
        &self,
        lampindex: i32,
        desiredcolor: Param1,
    ...
    #[cfg(feature = "UI")]
    pub fn SetSingleColorForIndices<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Color>,
    >(
        &self,
        desiredcolor: Param0,
        lampindexes: &[<i32 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).25)(
                ::std::mem::transmute_copy(this),
                desiredcolor.into_param().abi(),
                lampindexes.len() as u32,
                ::std::mem::transmute(lampindexes.as_ptr()),
            )
            .ok()
        }
    }
    #[cfg(feature = "UI")]
    pub fn SetColorsForIndices(
        &self,
        desiredcolors: &[<super::super::UI::Color as ::windows::runtime::Abi>::DefaultType],
        lampindexes: &[<i32 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).26)(
                ::std::mem::transmute_copy(this),
                desiredcolors.len() as u32,
                ::std::mem::transmute(desiredcolors.as_ptr()),
                lampindexes.len() as u32,
                ::std::mem::transmute(lampindexes.as_ptr()),
            )
            .ok()
    ...
    #[cfg(all(feature = "System", feature = "UI"))]
    pub fn SetColorsForKeys(
        &self,
        desiredcolors: &[<super::super::UI::Color as ::windows::runtime::Abi>::DefaultType],
        keys: &[<super::super::System::VirtualKey as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<LampArray>> {
        Self::ILampArrayStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<LampArray>>(result__)
        })
    }
    pub fn ILampArrayStatics<R, F: FnOnce(&ILampArrayStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<LampArray, ILampArrayStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for LampArray {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Lights.LampArray;{7ace9787-c8a0-4e95-a1e0-d58676538649})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for LampArrayKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Lights.LampArrayKind;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LampAvailabilityChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LampAvailabilityChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl LampInfo {
    ...
    pub fn Purposes(&self) -> ::windows::runtime::Result<LampPurposes> {
        ...
        unsafe {
            ...
            .from_abi::<LampPurposes>(result__)
        }
    }
    #[cfg(feature = "Foundation_Numerics")]
    pub fn Position(
    ...
    #[cfg(feature = "UI")]
    pub fn GetNearestSupportedColor<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Color>,
    >(
        &self,
        desiredcolor: Param0,
    ) -> ::windows::runtime::Result<super::super::UI::Color> {
        let this = self;
        unsafe {
            let mut result__: super::super::UI::Color = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).14)(
...
unsafe impl ::windows::runtime::RuntimeType for LampInfo {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Lights.LampInfo;{30bb521c-0acf-49da-8c10-150b9cf62713})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for LampPurposes {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Lights.LampPurposes;u4)",
    );
}
