...
pub struct ILampArrayBitmapEffectFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        lamparray: ::windows::runtime::RawPtr,
...
pub struct ILampArrayBlinkEffect_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::UI::Color,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut LampArrayRepetitionMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: LampArrayRepetitionMode,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct ILampArrayColorRampEffect_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut LampArrayEffectCompletionBehavior,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::RuntimeType for ILampArrayEffect {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{11d45590-57fb-4546-b1ce-863107f740df}");
}
...
pub struct ILampArrayEffectPlaylist_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut LampArrayEffectStartMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: LampArrayEffectStartMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut i32,
...
unsafe impl ::windows::runtime::Interface for ILampArrayEffectPlaylistStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        59957,
        19583,
        [160, 22, 243, 191, 198, 166, 196, 125],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ILampArraySolidEffect {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        17356,
        19251,
        [128, 235, 198, 221, 222, 125, 200, 237],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ILampArrayUpdateRequestedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        desiredcolors: *const super::super::super::UI::Color,
        lampIndexes_array_size: u32,
        lampindexes: *const i32,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "UI"))] usize,
...
impl LampArrayBitmapEffect {
    ...
    pub fn SuggestedBitmapSize(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::Size> {
        let this = self;
        unsafe {
    ...
    pub fn CreateInstance<'a, Param0: ::windows::runtime::IntoParam<'a, super::LampArray>>(
        lamparray: Param0,
        lampindexes: &[<i32 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<LampArrayBitmapEffect> {
        Self::ILampArrayBitmapEffectFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                lamparray.into_param().abi(),
                lampindexes.len() as u32,
                ::std::mem::transmute(lampindexes.as_ptr()),
                &mut result__,
            )
            .from_abi::<LampArrayBitmapEffect>(result__)
        })
    }
    pub fn ILampArrayBitmapEffectFactory<
        R,
        F: FnOnce(&ILampArrayBitmapEffectFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ILampArrayEffect> for &LampArrayBitmapEffect {
    fn into_param(self) -> ::windows::runtime::Param<'a, ILampArrayEffect> {
        ::std::convert::TryInto::<ILampArrayEffect>::try_into(self)
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LampArrayBitmapRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl LampArrayBlinkEffect {
    ...
    pub fn RepetitionMode(&self) -> ::windows::runtime::Result<LampArrayRepetitionMode> {
        ...
        unsafe {
            ...
            .from_abi::<LampArrayRepetitionMode>(result__)
        }
    }
    pub fn SetRepetitionMode(
        &self,
        value: LampArrayRepetitionMode,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn CreateInstance<'a, Param0: ::windows::runtime::IntoParam<'a, super::LampArray>>(
        lamparray: Param0,
        lampindexes: &[<i32 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<LampArrayBlinkEffect> {
        Self::ILampArrayBlinkEffectFactory(|this| unsafe {
            ...
            .from_abi::<LampArrayBlinkEffect>(result__)
        })
    }
    pub fn ILampArrayBlinkEffectFactory<
        R,
        F: FnOnce(&ILampArrayBlinkEffectFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl LampArrayColorRampEffect {
    ...
    pub fn CompletionBehavior(
        &self,
    ) -> ::windows::runtime::Result<LampArrayEffectCompletionBehavior> {
        let this = self;
        unsafe {
            ...
            .from_abi::<LampArrayEffectCompletionBehavior>(result__)
        }
    }
    ...
    pub fn CreateInstance<'a, Param0: ::windows::runtime::IntoParam<'a, super::LampArray>>(
        lamparray: Param0,
        lampindexes: &[<i32 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<LampArrayColorRampEffect> {
        Self::ILampArrayColorRampEffectFactory(|this| unsafe {
            ...
            .from_abi::<LampArrayColorRampEffect>(result__)
        })
    }
    pub fn ILampArrayColorRampEffectFactory<
        R,
        F: FnOnce(&ILampArrayColorRampEffectFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LampArrayColorRampEffect
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl LampArrayCustomEffect {
    ...
    pub fn CreateInstance<'a, Param0: ::windows::runtime::IntoParam<'a, super::LampArray>>(
        lamparray: Param0,
        lampindexes: &[<i32 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<LampArrayCustomEffect> {
        Self::ILampArrayCustomEffectFactory(|this| unsafe {
            ...
            .from_abi::<LampArrayCustomEffect>(result__)
        })
    }
    pub fn ILampArrayCustomEffectFactory<
        R,
        F: FnOnce(&ILampArrayCustomEffectFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl LampArrayEffectCompletionBehavior {
    pub const ClearState: LampArrayEffectCompletionBehavior =
        LampArrayEffectCompletionBehavior(0i32);
    pub const KeepState: LampArrayEffectCompletionBehavior =
        LampArrayEffectCompletionBehavior(1i32);
}
...
impl LampArrayEffectPlaylist {
    ...
    pub fn First(
        ...
        super::super::super::Foundation::Collections::IIterator<ILampArrayEffect>,
    > {
        let this = &::windows::runtime::Interface::cast::<
            super::super::super::Foundation::Collections::IIterable<ILampArrayEffect>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::Foundation::Collections::IIterator<ILampArrayEffect>>(
                result__,
            )
        }
    }
    ...
    pub fn GetAt(&self, index: u32) -> ::windows::runtime::Result<ILampArrayEffect> {
        let this = &::windows::runtime::Interface::cast::<
            super::super::super::Foundation::Collections::IVectorView<ILampArrayEffect>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<ILampArrayEffect>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn IndexOf<'a, Param0: ::windows::runtime::IntoParam<'a, ILampArrayEffect>>(
        &self,
        value: Param0,
        index: &mut u32,
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [<ILampArrayEffect as ::windows::runtime::Abi>::DefaultType],
    ...
    pub fn Append<'a, Param0: ::windows::runtime::IntoParam<'a, ILampArrayEffect>>(
        &self,
        effect: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn EffectStartMode(&self) -> ::windows::runtime::Result<LampArrayEffectStartMode> {
        ...
        unsafe {
            ...
            .from_abi::<LampArrayEffectStartMode>(result__)
        }
    }
    pub fn SetEffectStartMode(
        &self,
        value: LampArrayEffectStartMode,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn StartAll<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::Collections::IIterable<LampArrayEffectPlaylist>,
        >,
    >(
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn ILampArrayEffectPlaylistStatics<
        R,
        F: FnOnce(&ILampArrayEffectPlaylistStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<LampArrayEffectPlaylist>
    for super::super::super::Foundation::Collections::IIterable<ILampArrayEffect>
{
    type Error = ::windows::runtime::Error;
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<LampArrayEffectPlaylist>
    for super::super::super::Foundation::Collections::IVectorView<ILampArrayEffect>
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: LampArrayEffectPlaylist) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
impl LampArraySolidEffect {
    ...
    pub fn CreateInstance<'a, Param0: ::windows::runtime::IntoParam<'a, super::LampArray>>(
        lamparray: Param0,
        lampindexes: &[<i32 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<LampArraySolidEffect> {
        Self::ILampArraySolidEffectFactory(|this| unsafe {
            ...
            .from_abi::<LampArraySolidEffect>(result__)
        })
    }
    pub fn ILampArraySolidEffectFactory<
        R,
        F: FnOnce(&ILampArraySolidEffectFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl LampArrayUpdateRequestedEventArgs {
    ...
    pub fn SetColorForIndex<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::UI::Color>,
    >(
        &self,
        lampindex: i32,
        desiredcolor: Param1,
    ...
    pub fn SetColorsForIndices(
        &self,
        desiredcolors : & [ < super::super::super::UI:: Color as :: windows :: runtime :: Abi > :: DefaultType ],
        lampindexes: &[<i32 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LampArrayUpdateRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LampArrayUpdateRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
