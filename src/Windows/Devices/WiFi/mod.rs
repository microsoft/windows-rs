...
pub struct IWiFiAdapter_abi(
    ...
    #[cfg(all(feature = "Foundation", feature = "Security_Credentials"))] pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, availablenetwork: ::windows::runtime::RawPtr, reconnectionkind: WiFiReconnectionKind, passwordcredential: ::windows::runtime::RawPtr, ssid: ::core::mem::ManuallyDrop<::windows::runtime::HSTRING>, result__: *mut ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Security_Credentials")))] usize,
...
pub struct IWiFiAdapter2_abi(
    ...
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(all(feature = "Foundation", feature = "Security_Credentials"))] pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, availablenetwork: ::windows::runtime::RawPtr, reconnectionkind: WiFiReconnectionKind, passwordcredential: ::windows::runtime::RawPtr, ssid: ::core::mem::ManuallyDrop<::windows::runtime::HSTRING>, connectionmethod: WiFiConnectionMethod, result__: *mut ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Security_Credentials")))] usize,
);
#[repr(transparent)]
#[doc(hidden)]
...
impl WiFiAdapter {
    ...
    pub fn NetworkAdapter(&self) -> ::windows::runtime::Result<super::super::Networking::Connectivity::NetworkAdapter> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), &mut result__).from_abi::<super::super::Networking::Connectivity::NetworkAdapter>(result__)
        }
    }
    ...
    pub fn NetworkReport(&self) -> ::windows::runtime::Result<WiFiNetworkReport> {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(::core::mem::transmute_copy(this), &mut result__).from_abi::<WiFiNetworkReport>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    #[doc = "*Required features: `Devices_WiFi`, `Foundation`*"]
    pub fn AvailableNetworksChanged<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::TypedEventHandler<WiFiAdapter, ::windows::runtime::IInspectable>>>(&self, args: Param0) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).9)(::core::mem::transmute_copy(this), args.into_param().abi(), &mut result__).from_abi::<super::super::Foundation::EventRegistrationToken>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    #[doc = "*Required features: `Devices_WiFi`, `Foundation`*"]
    ...
    pub fn ConnectAsync<'a, Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>>(&self, availablenetwork: Param0, reconnectionkind: WiFiReconnectionKind) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<WiFiConnectionResult>> {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(::core::mem::transmute_copy(this), availablenetwork.into_param().abi(), reconnectionkind, &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<WiFiConnectionResult>>(result__)
        }
    }
    ...
    pub fn ConnectWithPasswordCredentialAsync<'a, Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>, Param2: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::PasswordCredential>>(&self, availablenetwork: Param0, reconnectionkind: WiFiReconnectionKind, passwordcredential: Param2) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<WiFiConnectionResult>> {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).12)(::core::mem::transmute_copy(this), availablenetwork.into_param().abi(), reconnectionkind, passwordcredential.into_param().abi(), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<WiFiConnectionResult>>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Security_Credentials"))]
    #[doc = "*Required features: `Devices_WiFi`, `Foundation`, `Security_Credentials`*"]
    pub fn ConnectWithPasswordCredentialAndSsidAsync<'a, Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>, Param2: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::PasswordCredential>, Param3: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).13)(::core::mem::transmute_copy(this), availablenetwork.into_param().abi(), reconnectionkind, passwordcredential.into_param().abi(), ssid.into_param().abi(), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<WiFiConnectionResult>>(result__)
        }
    }
    #[doc = "*Required features: `Devices_WiFi`*"]
    ...
    pub fn FindAllAdaptersAsync() -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<WiFiAdapter>>> {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<WiFiAdapter>>>(result__)
        })
    }
    #[doc = "*Required features: `Devices_WiFi`*"]
    ...
    pub fn FromIdAsync<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(deviceid: Param0) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<WiFiAdapter>> {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(::core::mem::transmute_copy(this), deviceid.into_param().abi(), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<WiFiAdapter>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    #[doc = "*Required features: `Devices_WiFi`, `Foundation`*"]
    pub fn RequestAccessAsync() -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<WiFiAccessStatus>> {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(::core::mem::transmute_copy(this), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<WiFiAccessStatus>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    #[doc = "*Required features: `Devices_WiFi`, `Foundation`*"]
    pub fn GetWpsConfigurationAsync<'a, Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>>(&self, availablenetwork: Param0) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<WiFiWpsConfigurationResult>> {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), availablenetwork.into_param().abi(), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<WiFiWpsConfigurationResult>>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Security_Credentials"))]
    #[doc = "*Required features: `Devices_WiFi`, `Foundation`, `Security_Credentials`*"]
    pub fn ConnectWithPasswordCredentialAndSsidAndConnectionMethodAsync<'a, Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>, Param2: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::PasswordCredential>, Param3: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(::core::mem::transmute_copy(this), availablenetwork.into_param().abi(), reconnectionkind, passwordcredential.into_param().abi(), ssid.into_param().abi(), connectionmethod, &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<WiFiConnectionResult>>(result__)
        }
    }
...
impl ::core::convert::From<WiFiAdapter> for ::windows::runtime::IUnknown {
...
impl ::core::convert::From<WiFiAdapter> for ::windows::runtime::IInspectable {
    fn from(value: WiFiAdapter) -> Self {
        value.0
    }
}
...
impl WiFiAvailableNetwork {
    ...
    pub fn NetworkKind(&self) -> ::windows::runtime::Result<WiFiNetworkKind> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).12)(::core::mem::transmute_copy(this), &mut result__).from_abi::<WiFiNetworkKind>(result__)
        }
    }
    #[doc = "*Required features: `Devices_WiFi`*"]
    pub fn PhyKind(&self) -> ::windows::runtime::Result<WiFiPhyKind> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).13)(::core::mem::transmute_copy(this), &mut result__).from_abi::<WiFiPhyKind>(result__)
        }
    }
    #[cfg(feature = "Networking_Connectivity")]
    #[doc = "*Required features: `Devices_WiFi`, `Networking_Connectivity`*"]
    pub fn SecuritySettings(&self) -> ::windows::runtime::Result<super::super::Networking::Connectivity::NetworkSecuritySettings> {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).14)(::core::mem::transmute_copy(this), &mut result__).from_abi::<super::super::Networking::Connectivity::NetworkSecuritySettings>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    #[doc = "*Required features: `Devices_WiFi`, `Foundation`*"]
...
impl ::core::convert::From<WiFiAvailableNetwork> for ::windows::runtime::IUnknown {
...
impl ::core::convert::From<WiFiAvailableNetwork> for ::windows::runtime::IInspectable {
    fn from(value: WiFiAvailableNetwork) -> Self {
        value.0
    }
}
...
impl WiFiConnectionResult {
    ...
    pub fn ConnectionStatus(&self) -> ::windows::runtime::Result<WiFiConnectionStatus> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), &mut result__).from_abi::<WiFiConnectionStatus>(result__)
        }
    }
}
...
impl ::core::convert::From<WiFiConnectionResult> for ::windows::runtime::IUnknown {
...
impl ::core::convert::From<WiFiConnectionResult> for ::windows::runtime::IInspectable {
    fn from(value: WiFiConnectionResult) -> Self {
        value.0
    }
}
...
impl WiFiNetworkReport {
    ...
    pub fn AvailableNetworks(&self) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<WiFiAvailableNetwork>> {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(::core::mem::transmute_copy(this), &mut result__).from_abi::<super::super::Foundation::Collections::IVectorView<WiFiAvailableNetwork>>(result__)
        }
    }
}
...
impl ::core::convert::From<WiFiNetworkReport> for ::windows::runtime::IUnknown {
...
impl ::core::convert::From<WiFiNetworkReport> for ::windows::runtime::IInspectable {
    fn from(value: WiFiNetworkReport) -> Self {
        value.0
    }
}
...
impl WiFiWpsConfigurationResult {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<WiFiWpsConfigurationStatus> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), &mut result__).from_abi::<WiFiWpsConfigurationStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    #[doc = "*Required features: `Devices_WiFi`, `Foundation_Collections`*"]
    pub fn SupportedWpsKinds(&self) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<WiFiWpsKind>> {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(::core::mem::transmute_copy(this), &mut result__).from_abi::<super::super::Foundation::Collections::IVectorView<WiFiWpsKind>>(result__)
        }
    }
}
...
impl ::core::convert::From<WiFiWpsConfigurationResult> for ::windows::runtime::IUnknown {
...
impl ::core::convert::From<WiFiWpsConfigurationResult> for ::windows::runtime::IInspectable {
    fn from(value: WiFiWpsConfigurationResult) -> Self {
        value.0
    }
}
