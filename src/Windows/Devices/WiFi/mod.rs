...
unsafe impl ::windows::runtime::Interface for IWiFiAdapter {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        15733,
        17316,
        [185, 222, 17, 226, 107, 114, 217, 176],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IWiFiAdapter_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        availablenetwork: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        ...
        reconnectionkind: WiFiReconnectionKind,
        passwordcredential: ::windows::runtime::RawPtr,
        ssid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Security_Credentials")))] usize,
...
unsafe impl ::windows::runtime::Interface for IWiFiAdapterStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        53836,
        17379,
        [170, 189, 196, 101, 159, 115, 15, 153],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IWiFiAvailableNetwork {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        6206,
        18180,
        [152, 38, 113, 180, 162, 240, 246, 104],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IWiFiAvailableNetwork_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiNetworkKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiPhyKind,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Networking_Connectivity")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IWiFiConnectionResult {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        50045,
        16574,
        [165, 200, 133, 123, 206, 133, 169, 49],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IWiFiConnectionResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiConnectionStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IWiFiWpsConfigurationResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiWpsConfigurationStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation_Collections")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl WiFiAdapter {
    #[cfg(feature = "Networking_Connectivity")]
    pub fn NetworkAdapter(
        &self,
    ) -> ::windows::runtime::Result<super::super::Networking::Connectivity::NetworkAdapter> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Networking::Connectivity::NetworkAdapter>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn NetworkReport(&self) -> ::windows::runtime::Result<WiFiNetworkReport> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiNetworkReport>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn AvailableNetworksChanged<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveAvailableNetworksChanged<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn ConnectAsync<'a, Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>>(
        &self,
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<WiFiConnectionResult>>
    {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).11)(
                ::std::mem::transmute_copy(this),
                availablenetwork.into_param().abi(),
                reconnectionkind,
                &mut result__,
            )
    ...
    #[cfg(all(feature = "Foundation", feature = "Security_Credentials"))]
    pub fn ConnectWithPasswordCredentialAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::PasswordCredential>,
    >(
        &self,
        availablenetwork: Param0,
        reconnectionkind: WiFiReconnectionKind,
    ...
    #[cfg(all(feature = "Foundation", feature = "Security_Credentials"))]
    pub fn ConnectWithPasswordCredentialAndSsidAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::PasswordCredential>,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn FindAllAdaptersAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<WiFiAdapter>,
        >,
    > {
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<WiFiAdapter>> {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<WiFiAdapter>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn RequestAccessAsync(
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<WiFiAccessStatus>>
    {
        Self::IWiFiAdapterStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<WiFiAccessStatus>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn GetWpsConfigurationAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>,
    >(
        &self,
        ...
        super::super::Foundation::IAsyncOperation<WiFiWpsConfigurationResult>,
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<WiFiWpsConfigurationResult>>(
                result__,
            )
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Security_Credentials"))]
    pub fn ConnectWithPasswordCredentialAndSsidAndConnectionMethodAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, WiFiAvailableNetwork>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Security::Credentials::PasswordCredential>,
        Param3: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    ...
    pub fn IWiFiAdapterStatics<
        R,
        F: FnOnce(&IWiFiAdapterStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<WiFiAdapter, IWiFiAdapterStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for WiFiAdapter {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.WiFi.WiFiAdapter;{a6c4e423-3d75-43a4-b9de-11e26b72d9b0})",
    );
}
...
impl WiFiAvailableNetwork {
    ...
    pub fn NetworkKind(&self) -> ::windows::runtime::Result<WiFiNetworkKind> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiNetworkKind>(result__)
        }
    }
    pub fn PhyKind(&self) -> ::windows::runtime::Result<WiFiPhyKind> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiPhyKind>(result__)
        }
    }
    #[cfg(feature = "Networking_Connectivity")]
    pub fn SecuritySettings(
        &self,
    ) -> ::windows::runtime::Result<super::super::Networking::Connectivity::NetworkSecuritySettings>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Networking::Connectivity::NetworkSecuritySettings>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
...
unsafe impl ::windows::runtime::RuntimeType for WiFiAvailableNetwork {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.WiFi.WiFiAvailableNetwork;{26e96246-183e-4704-9826-71b4a2f0f668})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for WiFiConnectionMethod {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.WiFi.WiFiConnectionMethod;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl WiFiConnectionResult {
    pub fn ConnectionStatus(&self) -> ::windows::runtime::Result<WiFiConnectionStatus> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiConnectionStatus>(result__)
        }
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for WiFiConnectionStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.WiFi.WiFiConnectionStatus;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for WiFiNetworkKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.WiFi.WiFiNetworkKind;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl WiFiNetworkReport {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AvailableNetworks(
        &self,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<WiFiAvailableNetwork>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<WiFiAvailableNetwork>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for WiFiNetworkReport {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.WiFi.WiFiNetworkReport;{9524ded2-5911-445e-8194-be4f1a704895})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for WiFiPhyKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.WiFi.WiFiPhyKind;i4)");
}
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
unsafe impl ::windows::runtime::RuntimeType for WiFiReconnectionKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.WiFi.WiFiReconnectionKind;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl WiFiWpsConfigurationResult {
    pub fn Status(&self) -> ::windows::runtime::Result<WiFiWpsConfigurationStatus> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiWpsConfigurationStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn SupportedWpsKinds(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<WiFiWpsKind>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<WiFiWpsKind>>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for WiFiWpsConfigurationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WiFiWpsConfigurationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for WiFiWpsConfigurationStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.WiFi.WiFiWpsConfigurationStatus;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for WiFiWpsKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.WiFi.WiFiWpsKind;i4)");
}
