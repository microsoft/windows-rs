...
unsafe impl ::windows::runtime::RuntimeType for CellularClass {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.CellularClass;i4)");
}
...
impl DeleteSmsMessageOperation {
    ...
    pub fn SetCompleted<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::AsyncActionCompletedHandler>,
    >(
        &self,
        handler: Param0,
    ...
    pub fn Completed(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::AsyncActionCompletedHandler> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::AsyncActionCompletedHandler>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn get(&self) -> ::windows::runtime::Result<()> {
        if self.Status()? == super::super::Foundation::AsyncStatus::Started {
            ...
            self.SetCompleted(super::super::Foundation::AsyncActionCompletedHandler::new(
                move |_sender, _args| {
                    unsafe {
                        signaler.signal();
                    }
...
unsafe impl ::windows::runtime::RuntimeType for DeleteSmsMessageOperation {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.DeleteSmsMessageOperation;{5a648006-843a-4da9-865b-9d26e5dfad7b})",
    );
}
#[cfg(feature = "Foundation")]
...
impl ::std::future::Future for DeleteSmsMessageOperation {
    ...
    fn poll(
        ...
        if self.Status()? == super::super::Foundation::AsyncStatus::Started {
            ...
            let _ = self.SetCompleted(super::super::Foundation::AsyncActionCompletedHandler::new(
                move |_sender, _args| {
                    waker.wake_by_ref();
                    Ok(())
                },
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeleteSmsMessageOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Foundation::IAsyncAction>
    for DeleteSmsMessageOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::super::Foundation::IAsyncAction> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<
            super::super::Foundation::IAsyncAction,
        >::into(self))
    }
}
#[cfg(feature = "Foundation")]
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DeleteSmsMessagesOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeleteSmsMessagesOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl GetSmsDeviceOperation {
    ...
    pub fn SetCompleted<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::AsyncOperationCompletedHandler<SmsDevice>,
        >,
    >(
        &self,
        handler: Param0,
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::AsyncOperationCompletedHandler<SmsDevice>>(
                result__,
            )
        }
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::From<GetSmsDeviceOperation>
    for super::super::Foundation::IAsyncOperation<SmsDevice>
{
    fn from(value: GetSmsDeviceOperation) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Foundation::IAsyncOperation<SmsDevice>>
    for GetSmsDeviceOperation
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::Foundation::IAsyncOperation<SmsDevice>> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<
            super::super::Foundation::IAsyncOperation<SmsDevice>,
        >::into(self))
    }
}
#[cfg(feature = "Foundation")]
...
impl GetSmsMessageOperation {
    ...
    pub fn SetCompleted<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::AsyncOperationCompletedHandler<ISmsMessage>,
        >,
    >(
        &self,
        handler: Param0,
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::AsyncOperationCompletedHandler<ISmsMessage>>(
                result__,
            )
        }
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::From<GetSmsMessageOperation>
    for super::super::Foundation::IAsyncOperation<ISmsMessage>
{
    fn from(value: GetSmsMessageOperation) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Foundation::IAsyncOperation<ISmsMessage>>
    for GetSmsMessageOperation
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::Foundation::IAsyncOperation<ISmsMessage>> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<
            super::super::Foundation::IAsyncOperation<ISmsMessage>,
        >::into(self))
    }
}
#[cfg(feature = "Foundation")]
...
impl GetSmsMessagesOperation {
    ...
    pub fn SetProgress<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::AsyncOperationProgressHandler<
                super::super::Foundation::Collections::IVectorView<ISmsMessage>,
                i32,
            >,
        >,
    >(
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::AsyncOperationProgressHandler<
                super::super::Foundation::Collections::IVectorView<ISmsMessage>,
                i32,
            >>(result__)
        }
    ...
    pub fn SetCompleted<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::AsyncOperationWithProgressCompletedHandler<
                super::super::Foundation::Collections::IVectorView<ISmsMessage>,
                i32,
            >,
        >,
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::AsyncOperationWithProgressCompletedHandler<
                super::super::Foundation::Collections::IVectorView<ISmsMessage>,
                i32,
            >>(result__)
        }
    ...
    pub fn GetResults(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<ISmsMessage>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<ISmsMessage>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Id(&self) -> ::windows::runtime::Result<u32> {
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<ISmsMessage>>
    {
        if self.Status()? == super::super::Foundation::AsyncStatus::Started {
            let (waiter, signaler) = ::windows::runtime::Waiter::new();
            self.SetCompleted(
                super::super::Foundation::AsyncOperationWithProgressCompletedHandler::new(
                    move |_sender, _args| {
                        unsafe {
                            signaler.signal();
                        }
...
unsafe impl ::windows::runtime::Interface for GetSmsMessagesOperation {
    type Vtable = super::super::Foundation::IAsyncOperationWithProgress_abi<
        super::super::Foundation::Collections::IVectorView<ISmsMessage>,
        i32,
    >;
...
#[cfg(feature = "Foundation")]
impl ::std::convert::From<GetSmsMessagesOperation>
    for super::super::Foundation::IAsyncOperationWithProgress<
        super::super::Foundation::Collections::IVectorView<ISmsMessage>,
        i32,
    >
{
...
impl ISmsBinaryMessage {
    ...
    pub fn Format(&self) -> ::windows::runtime::Result<SmsDataFormat> {
        ...
        unsafe {
            ...
            .from_abi::<SmsDataFormat>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    ...
    pub fn MessageClass(&self) -> ::windows::runtime::Result<SmsMessageClass> {
        ...
        unsafe {
            ...
            .from_abi::<SmsMessageClass>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ISmsBinaryMessage {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{5bf4e813-3b53-4c6e-b61a-d86a63755650}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ISmsMessage> for &ISmsBinaryMessage {
    fn into_param(self) -> ::windows::runtime::Param<'a, ISmsMessage> {
        ::std::convert::TryInto::<ISmsMessage>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
pub struct ISmsBroadcastMessage_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SmsGeographicalScope,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut i32,
...
unsafe impl ::windows::runtime::Interface for ISmsDevice {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        34603,
        20204,
        [156, 114, 171, 17, 98, 123, 52, 236],
    );
}
impl ISmsDevice {
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn SendMessageAsync<'a, Param0: ::windows::runtime::IntoParam<'a, ISmsMessage>>(
        &self,
        message: Param0,
    ) -> ::windows::runtime::Result<SendSmsMessageOperation> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<SendSmsMessageOperation>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn CalculateLength<'a, Param0: ::windows::runtime::IntoParam<'a, SmsTextMessage>>(
        &self,
        message: Param0,
    ) -> ::windows::runtime::Result<SmsEncodedLength> {
        let this = self;
        unsafe {
            ...
            .from_abi::<SmsEncodedLength>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    ...
    pub fn CellularClass(&self) -> ::windows::runtime::Result<CellularClass> {
        ...
        unsafe {
            ...
            .from_abi::<CellularClass>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn MessageStore(&self) -> ::windows::runtime::Result<SmsDeviceMessageStore> {
        ...
        unsafe {
            ...
            .from_abi::<SmsDeviceMessageStore>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn DeviceStatus(&self) -> ::windows::runtime::Result<SmsDeviceStatus> {
        ...
        unsafe {
            ...
            .from_abi::<SmsDeviceStatus>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn SmsMessageReceived<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, SmsMessageReceivedEventHandler>,
    >(
        &self,
        eventhandler: Param0,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn RemoveSmsMessageReceived<
        'a,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn SmsDeviceStatusChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, SmsDeviceStatusChangedEventHandler>,
    >(
        &self,
        eventhandler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn RemoveSmsDeviceStatusChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
...
unsafe impl ::windows::runtime::RuntimeType for ISmsDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{091791ed-872b-4eec-9c72-ab11627b34ec}");
}
...
unsafe impl ::windows::runtime::Interface for ISmsDevice2Statics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        4145,
        18718,
        [143, 182, 239, 153, 145, 175, 227, 99],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct ISmsDevice2Statics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        parentdeviceid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct ISmsFilterRules_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SmsFilterActionType,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation_Collections")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::RuntimeType for ISmsMessage {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{ed3c5e28-6984-4b07-811d-8d5906ed3cea}");
}
...
impl ISmsMessageBase {
    pub fn MessageType(&self) -> ::windows::runtime::Result<SmsMessageType> {
        ...
        unsafe {
            ...
            .from_abi::<SmsMessageType>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for ISmsMessageBase {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{2cf0fe30-fe50-4fc6-aa88-4ccfe27a29ea}");
}
...
unsafe impl ::windows::runtime::Interface for ISmsMessageReceivedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        47333,
        16833,
        [163, 216, 211, 171, 250, 226, 38, 117],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISmsSendMessageResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SmsModemErrorCode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
...
unsafe impl ::windows::runtime::Interface for ISmsStatusMessage {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        46859,
        18039,
        [147, 121, 201, 120, 63, 223, 248, 244],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl ISmsTextMessage {
    ...
    pub fn ToBinaryMessages(
        ...
        super::super::Foundation::Collections::IVectorView<ISmsBinaryMessage>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<ISmsBinaryMessage>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for ISmsTextMessage {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{d61c904c-a495-487f-9a6f-971548c5bc9f}");
}
...
unsafe impl ::windows::runtime::Interface for ISmsTextMessage2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        17749,
        18261,
        [181, 161, 231, 253, 132, 149, 95, 141],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISmsTextMessageStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        binarymessage: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for ISmsVoicemailMessage {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        38321,
        17663,
        [188, 184, 184, 253, 215, 224, 139, 195],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::RuntimeType for SendSmsMessageOperation {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SendSmsMessageOperation;{5a648006-843a-4da9-865b-9d26e5dfad7b})",
    );
}
#[cfg(feature = "Foundation")]
...
unsafe impl ::windows::runtime::RuntimeType for SmsAppMessage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsAppMessage;{e8bb8494-d3a0-4a0a-86d7-291033a8cf54})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ISmsMessageBase> for &SmsAppMessage {
    fn into_param(self) -> ::windows::runtime::Param<'a, ISmsMessageBase> {
        ::std::convert::TryInto::<ISmsMessageBase>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for SmsBinaryMessage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsBinaryMessage;{5bf4e813-3b53-4c6e-b61a-d86a63755650})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ISmsBinaryMessage> for &SmsBinaryMessage {
    fn into_param(self) -> ::windows::runtime::Param<'a, ISmsBinaryMessage> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<ISmsBinaryMessage>::into(
...
impl SmsBroadcastMessage {
    ...
    pub fn GeographicalScope(&self) -> ::windows::runtime::Result<SmsGeographicalScope> {
        ...
        unsafe {
            ...
            .from_abi::<SmsGeographicalScope>(result__)
        }
    }
    ...
    pub fn BroadcastType(&self) -> ::windows::runtime::Result<SmsBroadcastType> {
        ...
        unsafe {
            ...
            .from_abi::<SmsBroadcastType>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for SmsBroadcastMessage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsBroadcastMessage;{75aebbf1-e4b7-4874-a09c-2956e592f957})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for SmsDataFormat {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.SmsDataFormat;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl SmsDevice {
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<SmsDevice>> {
        Self::ISmsDeviceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<SmsDevice>>(result__)
        })
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    ...
    pub fn ISmsDeviceStatics<R, F: FnOnce(&ISmsDeviceStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<SmsDevice, ISmsDeviceStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn ISmsDeviceStatics2<
        R,
        F: FnOnce(&ISmsDeviceStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<SmsDevice, ISmsDeviceStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ISmsDevice> for &SmsDevice {
    fn into_param(self) -> ::windows::runtime::Param<'a, ISmsDevice> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<ISmsDevice>::into(
            ::std::clone::Clone::clone(self),
        ))
    }
}
...
impl SmsDevice2 {
    ...
    pub fn CalculateLength<'a, Param0: ::windows::runtime::IntoParam<'a, ISmsMessageBase>>(
        &self,
        message: Param0,
    ) -> ::windows::runtime::Result<SmsEncodedLength> {
        let this = self;
    ...
    #[cfg(feature = "Foundation")]
    pub fn SendMessageAndGetResultAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ISmsMessageBase>,
    >(
        &self,
        message: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<SmsSendMessageResult>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<SmsSendMessageResult>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn DeviceStatusChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDeviceStatusChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn FromId<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<SmsDevice2> {
        Self::ISmsDevice2Statics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn FromParentId<
        ...
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        parentdeviceid: Param0,
    ) -> ::windows::runtime::Result<SmsDevice2> {
        Self::ISmsDevice2Statics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
                parentdeviceid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<SmsDevice2>(result__)
        })
    }
    pub fn ISmsDevice2Statics<
        R,
        F: FnOnce(&ISmsDevice2Statics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<SmsDevice2, ISmsDevice2Statics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for SmsDevice2 {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsDevice2;{bd8a5c13-e522-46cb-b8d5-9ead30fb6c47})",
    );
}
...
impl SmsDeviceMessageStore {
    ...
    pub fn GetMessageAsync(
        &self,
        messageid: u32,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<ISmsMessage>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<ISmsMessage>>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
...
unsafe impl ::windows::runtime::RuntimeType for SmsDeviceMessageStore {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsDeviceMessageStore;{9889f253-f188-4427-8d54-ce0c2423c5c1})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for SmsDeviceStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Sms.SmsDeviceStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl SmsDeviceStatusChangedEventHandler {
    pub fn new<
        F: FnMut(&::std::option::Option<SmsDevice>) -> ::windows::runtime::Result<()> + 'static,
    >(
        invoke: F,
    ) -> Self {
    ...
    pub fn Invoke<'a, Param0: ::windows::runtime::IntoParam<'a, SmsDevice>>(
        &self,
        sender: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for SmsDeviceStatusChangedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({982b1162-3dd7-4618-af89-0c272d5d06d8})",
    );
}
...
#[repr(C)]
struct SmsDeviceStatusChangedEventHandler_box<
    F: FnMut(&::std::option::Option<SmsDevice>) -> ::windows::runtime::Result<()> + 'static,
> {
...
impl<F: FnMut(&::std::option::Option<SmsDevice>) -> ::windows::runtime::Result<()> + 'static>
    SmsDeviceStatusChangedEventHandler_box<F>
{
    const VTABLE: SmsDeviceStatusChangedEventHandler_abi = SmsDeviceStatusChangedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid
            == &<SmsDeviceStatusChangedEventHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&sender as *const <SmsDevice as ::windows::runtime::Abi>::Abi
                as *const <SmsDevice as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
impl ::std::cmp::PartialEq for SmsEncodedLength {
    fn eq(&self, other: &Self) -> bool {
        self.SegmentCount == other.SegmentCount
            && self.CharacterCountLastSegment == other.CharacterCountLastSegment
            && self.CharactersPerSegment == other.CharactersPerSegment
            && self.ByteCountLastSegment == other.ByteCountLastSegment
            && self.BytesPerSegment == other.BytesPerSegment
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for SmsEncoding {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.SmsEncoding;i4)");
}
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
impl SmsFilterRule {
    ...
    pub fn BroadcastTypes(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<SmsBroadcastType>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<SmsBroadcastType>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn BroadcastChannels(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<i32>> {
        let this = self;
        unsafe {
    ...
    pub fn CreateFilterRule(
        messagetype: SmsMessageType,
    ) -> ::windows::runtime::Result<SmsFilterRule> {
        Self::ISmsFilterRuleFactory(|this| unsafe {
            ...
            .from_abi::<SmsFilterRule>(result__)
        })
    }
    pub fn ISmsFilterRuleFactory<
        R,
        F: FnOnce(&ISmsFilterRuleFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<SmsFilterRule, ISmsFilterRuleFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for SmsFilterRule {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsFilterRule;{40e32fae-b049-4fbc-afe9-e2a610eff55c})",
    );
}
...
impl SmsFilterRules {
    pub fn ActionType(&self) -> ::windows::runtime::Result<SmsFilterActionType> {
        ...
        unsafe {
            ...
            .from_abi::<SmsFilterActionType>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Rules(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<SmsFilterRule>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<SmsFilterRule>>(result__)
        }
    }
    pub fn CreateFilterRules(
        actiontype: SmsFilterActionType,
    ) -> ::windows::runtime::Result<SmsFilterRules> {
        Self::ISmsFilterRulesFactory(|this| unsafe {
            ...
            .from_abi::<SmsFilterRules>(result__)
        })
    }
    pub fn ISmsFilterRulesFactory<
        R,
        F: FnOnce(&ISmsFilterRulesFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for SmsFilterRules {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsFilterRules;{4e47eafb-79cd-4881-9894-55a4135b23fa})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for SmsMessageClass {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Sms.SmsMessageClass;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
impl SmsMessageReceivedEventArgs {
    ...
    pub fn TextMessage(&self) -> ::windows::runtime::Result<SmsTextMessage> {
        ...
        unsafe {
            ...
            .from_abi::<SmsTextMessage>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn BinaryMessage(&self) -> ::windows::runtime::Result<SmsBinaryMessage> {
        ...
        unsafe {
            ...
            .from_abi::<SmsBinaryMessage>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SmsMessageReceivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SmsMessageReceivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SmsMessageReceivedEventHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<SmsDevice>,
                &::std::option::Option<SmsMessageReceivedEventArgs>,
            ) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ...
    pub fn Invoke<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, SmsDevice>,
        Param1: ::windows::runtime::IntoParam<'a, SmsMessageReceivedEventArgs>,
    >(
        &self,
        sender: Param0,
        e: Param1,
...
unsafe impl ::windows::runtime::RuntimeType for SmsMessageReceivedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({0b7ad409-ec2d-47ce-a253-732beeebcacd})",
    );
}
...
#[repr(C)]
struct SmsMessageReceivedEventHandler_box<
    F: FnMut(
            &::std::option::Option<SmsDevice>,
            &::std::option::Option<SmsMessageReceivedEventArgs>,
        ) -> ::windows::runtime::Result<()>
...
impl<
        F: FnMut(
            ...
            + 'static,
    > SmsMessageReceivedEventHandler_box<F>
{
    const VTABLE: SmsMessageReceivedEventHandler_abi = SmsMessageReceivedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid
            == &<SmsMessageReceivedEventHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
    ...
    unsafe extern "system" fn Invoke(
        ...
        ((*this).invoke)(
            &*(&sender as *const <SmsDevice as ::windows::runtime::Abi>::Abi
                as *const <SmsDevice as ::windows::runtime::Abi>::DefaultType),
            &*(&e as *const <SmsMessageReceivedEventArgs as ::windows::runtime::Abi>::Abi
                as *const <SmsMessageReceivedEventArgs as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
impl SmsMessageReceivedTriggerDetails {
    ...
    pub fn TextMessage(&self) -> ::windows::runtime::Result<SmsTextMessage2> {
        ...
        unsafe {
            ...
            .from_abi::<SmsTextMessage2>(result__)
        }
    }
    pub fn WapMessage(&self) -> ::windows::runtime::Result<SmsWapMessage> {
        ...
        unsafe {
            ...
            .from_abi::<SmsWapMessage>(result__)
        }
    }
    pub fn AppMessage(&self) -> ::windows::runtime::Result<SmsAppMessage> {
        ...
        unsafe {
            ...
            .from_abi::<SmsAppMessage>(result__)
        }
    }
    pub fn BroadcastMessage(&self) -> ::windows::runtime::Result<SmsBroadcastMessage> {
        ...
        unsafe {
            ...
            .from_abi::<SmsBroadcastMessage>(result__)
        }
    }
    pub fn VoicemailMessage(&self) -> ::windows::runtime::Result<SmsVoicemailMessage> {
        ...
        unsafe {
            ...
            .from_abi::<SmsVoicemailMessage>(result__)
        }
    }
    pub fn StatusMessage(&self) -> ::windows::runtime::Result<SmsStatusMessage> {
        ...
        unsafe {
            ...
            .from_abi::<SmsStatusMessage>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SmsMessageReceivedTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SmsMessageReceivedTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SmsMessageRegistration {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AllRegistrations() -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<SmsMessageRegistration>,
    > {
        Self::ISmsMessageRegistrationStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<SmsMessageRegistration>>(
                result__,
            )
        })
    }
    pub fn Register<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, SmsFilterRules>,
    >(
        id: Param0,
        filterrules: Param1,
    ) -> ::windows::runtime::Result<SmsMessageRegistration> {
        Self::ISmsMessageRegistrationStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<SmsMessageRegistration>(result__)
        })
    }
    pub fn ISmsMessageRegistrationStatics<
        R,
        F: FnOnce(&ISmsMessageRegistrationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for SmsMessageRegistration {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsMessageRegistration;{1720503e-f34f-446b-83b3-0ff19923b409})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for SmsMessageType {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.Sms.SmsMessageType;i4)");
}
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
unsafe impl ::windows::runtime::RuntimeType for SmsReceivedEventDetails {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsReceivedEventDetails;{5bb50f15-e46d-4c82-847d-5a0304c1d53d})",
    );
}
...
impl SmsSendMessageResult {
    ...
    pub fn ModemErrorCode(&self) -> ::windows::runtime::Result<SmsModemErrorCode> {
        ...
        unsafe {
            ...
            .from_abi::<SmsModemErrorCode>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for SmsSendMessageResult {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsSendMessageResult;{db139af2-78c9-4feb-9622-452328088d62})",
    );
}
...
impl SmsTextMessage {
    ...
    #[cfg(feature = "deprecated")]
    pub fn FromBinaryMessage<'a, Param0: ::windows::runtime::IntoParam<'a, SmsBinaryMessage>>(
        binarymessage: Param0,
    ) -> ::windows::runtime::Result<SmsTextMessage> {
        Self::ISmsTextMessageStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                binarymessage.into_param().abi(),
                &mut result__,
            )
            .from_abi::<SmsTextMessage>(result__)
        })
    ...
    pub fn ISmsTextMessageStatics<
        R,
        F: FnOnce(&ISmsTextMessageStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ISmsTextMessage> for &SmsTextMessage {
    fn into_param(self) -> ::windows::runtime::Param<'a, ISmsTextMessage> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<ISmsTextMessage>::into(
            ::std::clone::Clone::clone(self),
        ))
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for SmsTextMessage2 {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsTextMessage2;{22a0d893-4555-4755-b5a1-e7fd84955f8d})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for SmsVoicemailMessage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsVoicemailMessage;{271aa0a6-95b1-44ff-bcb8-b8fdd7e08bc3})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for SmsWapMessage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Sms.SmsWapMessage;{cd937743-7a55-4d3b-9021-f22e022d09c5})",
    );
}
