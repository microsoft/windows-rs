...
impl IAdcControllerProvider {
    ...
    pub fn ChannelMode(&self) -> ::windows::runtime::Result<ProviderAdcChannelMode> {
        ...
        unsafe {
            ...
            .from_abi::<ProviderAdcChannelMode>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for IAdcControllerProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{be545828-816d-4de5-a048-aba06958aaa8}");
}
...
impl IAdcProvider {
    ...
    pub fn GetControllers(
        ...
        super::super::super::Foundation::Collections::IVectorView<IAdcControllerProvider>,
    > {
        let this = self;
        unsafe {
...
unsafe impl ::windows::runtime::RuntimeType for IAdcProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{28953668-9359-4c57-bc88-e275e81638c9}");
}
