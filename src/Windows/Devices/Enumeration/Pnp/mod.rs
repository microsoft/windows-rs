...
pub struct IPnpObjectStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        requestedproperties: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IPnpObjectWatcher_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::DeviceWatcherStatus,
    ) -> ::windows::runtime::HRESULT,
...
impl PnpObject {
    pub fn Type(&self) -> ::windows::runtime::Result<PnpObjectType> {
        ...
        unsafe {
            ...
            .from_abi::<PnpObjectType>(result__)
        }
    }
    ...
    pub fn Update<'a, Param0: ::windows::runtime::IntoParam<'a, PnpObjectUpdate>>(
        &self,
        updateinfo: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncOperation<PnpObject>>
    {
        Self::IPnpObjectStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                r#type,
                id.into_param().abi(),
                requestedproperties.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<PnpObject>>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn FindAllAsync<
    ...
    >(
        r#type: PnpObjectType,
        requestedproperties: Param1,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<PnpObjectCollection>,
    > {
        Self::IPnpObjectStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<PnpObjectCollection>>(
                result__,
            )
        })
    }
    ...
    >(
        r#type: PnpObjectType,
        requestedproperties: Param1,
    ) -> ::windows::runtime::Result<PnpObjectWatcher> {
        Self::IPnpObjectStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<PnpObjectWatcher>(result__)
        })
    }
    #[cfg(feature = "Foundation_Collections")]
    ...
    pub fn IPnpObjectStatics<R, F: FnOnce(&IPnpObjectStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<PnpObject, IPnpObjectStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for PnpObject {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Enumeration.Pnp.PnpObject;{95c66258-733b-4a8f-93a3-db078ac870c1})",
    );
}
...
impl PnpObjectCollection {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn IndexOf<'a, Param0: ::windows::runtime::IntoParam<'a, PnpObject>>(
        &self,
        value: Param0,
        index: &mut u32,
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [<PnpObject as ::windows::runtime::Abi>::DefaultType],
    ...
    pub fn First(
        ...
        super::super::super::Foundation::Collections::IIterator<PnpObject>,
    > {
        let this = &::windows::runtime::Interface::cast::<
            super::super::super::Foundation::Collections::IIterable<PnpObject>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::Foundation::Collections::IIterator<PnpObject>>(
                result__,
            )
        }
    }
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::From<PnpObjectCollection>
    for super::super::super::Foundation::Collections::IVectorView<PnpObject>
{
    fn from(value: PnpObjectCollection) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
impl<'a>
    ::windows::runtime::IntoParam<
        'a,
        super::super::super::Foundation::Collections::IVectorView<PnpObject>,
    > for PnpObjectCollection
{
    fn into_param(
        self,
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<PnpObjectCollection>
    for super::super::super::Foundation::Collections::IIterable<PnpObject>
{
...
impl PnpObjectWatcher {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<super::DeviceWatcherStatus> {
        ...
        unsafe {
            ...
            .from_abi::<super::DeviceWatcherStatus>(result__)
        }
    }
