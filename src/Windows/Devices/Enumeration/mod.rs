...
impl DeviceAccessChangedEventArgs {
    pub fn Status(&self) -> ::windows::runtime::Result<DeviceAccessStatus> {
        ...
        unsafe {
            ...
            .from_abi::<DeviceAccessStatus>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DeviceAccessChangedEventArgs
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeviceAccessChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl DeviceAccessInformation {
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<DeviceAccessInformation> {
        Self::IDeviceAccessInformationStatics(|this| unsafe {
            ...
            .from_abi::<DeviceAccessInformation>(result__)
        })
    }
    ...
    >(
        deviceclassid: Param0,
    ) -> ::windows::runtime::Result<DeviceAccessInformation> {
        Self::IDeviceAccessInformationStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                deviceclassid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<DeviceAccessInformation>(result__)
        })
    ...
    pub fn IDeviceAccessInformationStatics<
        R,
        F: FnOnce(&IDeviceAccessInformationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DeviceConnectionChangeTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<DeviceConnectionChangeTriggerDetails>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeviceConnectionChangeTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl DeviceDisconnectButtonClickedEventArgs {
    pub fn Device(&self) -> ::windows::runtime::Result<DeviceInformation> {
        ...
        unsafe {
            ...
            .from_abi::<DeviceInformation>(result__)
        }
    }
}
...
unsafe impl ::windows::runtime::Interface for DeviceDisconnectButtonClickedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63746,
        18944,
        [181, 54, 243, 121, 146, 230, 162, 167],
    );
}
...
impl ::std::convert::From<&DeviceDisconnectButtonClickedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DeviceDisconnectButtonClickedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeviceDisconnectButtonClickedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl DeviceInformation {
    ...
    pub fn EnclosureLocation(&self) -> ::windows::runtime::Result<EnclosureLocation> {
        ...
        unsafe {
            ...
            .from_abi::<EnclosureLocation>(result__)
        }
    }
    ...
    pub fn Update<'a, Param0: ::windows::runtime::IntoParam<'a, DeviceInformationUpdate>>(
        &self,
        updateinfo: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn GetThumbnailAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DeviceThumbnail>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DeviceThumbnail>>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    ...
    pub fn Kind(&self) -> ::windows::runtime::Result<DeviceInformationKind> {
        ...
        unsafe {
            ...
            .from_abi::<DeviceInformationKind>(result__)
        }
    }
    pub fn Pairing(&self) -> ::windows::runtime::Result<DeviceInformationPairing> {
        ...
        unsafe {
            ...
            .from_abi::<DeviceInformationPairing>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DeviceInformation>>
    {
        Self::IDeviceInformationStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DeviceInformation>>(result__)
        })
    }
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DeviceInformation>>
    {
        Self::IDeviceInformationStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                deviceid.into_param().abi(),
                additionalproperties.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<DeviceInformation>>(result__)
        })
    ...
    pub fn FindAllAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<DeviceInformationCollection>,
    > {
        Self::IDeviceInformationStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DeviceInformationCollection>>(
                result__,
            )
        })
    }
    ...
    pub fn CreateWatcher() -> ::windows::runtime::Result<DeviceWatcher> {
        Self::IDeviceInformationStatics(|this| unsafe {
            ...
            .from_abi::<DeviceWatcher>(result__)
        })
    }
    pub fn CreateWatcherDeviceClass(
        deviceclass: DeviceClass,
    ) -> ::windows::runtime::Result<DeviceWatcher> {
        Self::IDeviceInformationStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).13)(
                ::std::mem::transmute_copy(this),
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn CreateWatcherAqsFilterAndAdditionalProperties<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<
            'a,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn CreateFromIdAsyncWithKindAndAdditionalProperties<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<
            'a,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn FindAllAsyncWithKindAqsFilterAndAdditionalProperties<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<
            'a,
    ...
    pub fn IDeviceInformationStatics<
        R,
        F: FnOnce(&IDeviceInformationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IDeviceInformationStatics2<
        R,
        F: FnOnce(&IDeviceInformationStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl DeviceInformationCollection {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn IndexOf<'a, Param0: ::windows::runtime::IntoParam<'a, DeviceInformation>>(
        &self,
        value: Param0,
        index: &mut u32,
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [<DeviceInformation as ::windows::runtime::Abi>::DefaultType],
    ...
    pub fn First(
        ...
        super::super::Foundation::Collections::IIterator<DeviceInformation>,
    > {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IIterable<DeviceInformation>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::Foundation::Collections::IIterator<DeviceInformation>>(
                result__,
            )
        }
    }
...
#[cfg(feature = "Foundation_Collections")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DeviceInformationCollection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
#[cfg(feature = "Foundation_Collections")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeviceInformationCollection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::From<DeviceInformationCollection>
    for super::super::Foundation::Collections::IVectorView<DeviceInformation>
{
    fn from(value: DeviceInformationCollection) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
impl<'a>
    ::windows::runtime::IntoParam<
        'a,
        super::super::Foundation::Collections::IVectorView<DeviceInformation>,
    > for DeviceInformationCollection
{
    fn into_param(
        self,
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<DeviceInformationCollection>
    for super::super::Foundation::Collections::IIterable<DeviceInformation>
{
...
impl ::std::iter::IntoIterator for &DeviceInformationCollection {
    ...
    type IntoIter = super::super::Foundation::Collections::VectorViewIterator<Self::Item>;
    fn into_iter(self) -> Self::IntoIter {
        super::super::Foundation::Collections::VectorViewIterator::new(
...
impl DeviceInformationCustomPairing {
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DevicePairingResult>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DevicePairingResult>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    #[cfg(feature = "Foundation")]
    pub fn PairWithProtectionLevelAndSettingsAsync<
        'a,
        Param2: ::windows::runtime::IntoParam<'a, IDevicePairingSettings>,
    >(
        &self,
        pairingkindssupported: DevicePairingKinds,
        minprotectionlevel: DevicePairingProtectionLevel,
        devicepairingsettings: Param2,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DevicePairingResult>>
    {
        let this = self;
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).8)(
                ...
                pairingkindssupported,
                minprotectionlevel,
                devicepairingsettings.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<DevicePairingResult>>(result__)
        }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DeviceInformationCustomPairing
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeviceInformationCustomPairing
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl DeviceInformationPairing {
    ...
    pub fn ProtectionLevel(&self) -> ::windows::runtime::Result<DevicePairingProtectionLevel> {
        ...
        unsafe {
            ...
            .from_abi::<DevicePairingProtectionLevel>(result__)
        }
    }
    pub fn Custom(&self) -> ::windows::runtime::Result<DeviceInformationCustomPairing> {
        ...
        unsafe {
            ...
            .from_abi::<DeviceInformationCustomPairing>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn PairWithProtectionLevelAndSettingsAsync<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, IDevicePairingSettings>,
    >(
        &self,
        minprotectionlevel: DevicePairingProtectionLevel,
        devicepairingsettings: Param1,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DevicePairingResult>>
    {
        let this = &::windows::runtime::Interface::cast::<IDeviceInformationPairing2>(self)?;
        unsafe {
    ...
    pub fn UnpairAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DeviceUnpairingResult>>
    {
        let this = &::windows::runtime::Interface::cast::<IDeviceInformationPairing2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DeviceUnpairingResult>>(result__)
        }
    }
    ...
    pub fn IDeviceInformationPairingStatics<
        R,
        F: FnOnce(&IDeviceInformationPairingStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IDeviceInformationPairingStatics2<
        R,
        F: FnOnce(&IDeviceInformationPairingStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeviceInformationPairing
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl DevicePairingProtectionLevel {
    ...
    pub const EncryptionAndAuthentication: DevicePairingProtectionLevel =
        DevicePairingProtectionLevel(3i32);
}
...
impl DevicePairingRequestedEventArgs {
    ...
    pub fn PairingKind(&self) -> ::windows::runtime::Result<DevicePairingKinds> {
        ...
        unsafe {
            ...
            .from_abi::<DevicePairingKinds>(result__)
        }
    }
    ...
    pub fn AcceptWithPasswordCredential<
        'a,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DevicePairingRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl DevicePairingResult {
    pub fn Status(&self) -> ::windows::runtime::Result<DevicePairingResultStatus> {
        ...
        unsafe {
            ...
            .from_abi::<DevicePairingResultStatus>(result__)
        }
    }
...
impl DevicePairingResultStatus {
    ...
    pub const ProtectionLevelCouldNotBeMet: DevicePairingResultStatus =
        DevicePairingResultStatus(11i32);
    ...
    pub const OperationAlreadyInProgress: DevicePairingResultStatus =
        DevicePairingResultStatus(15i32);
    pub const RequiredHandlerNotRegistered: DevicePairingResultStatus =
        DevicePairingResultStatus(16i32);
    pub const RejectedByHandler: DevicePairingResultStatus = DevicePairingResultStatus(17i32);
    pub const RemoteDeviceHasAssociation: DevicePairingResultStatus =
        DevicePairingResultStatus(18i32);
...
impl DevicePicker {
    ...
    pub fn Filter(&self) -> ::windows::runtime::Result<DevicePickerFilter> {
        ...
        unsafe {
            ...
            .from_abi::<DevicePickerFilter>(result__)
        }
    }
    pub fn Appearance(&self) -> ::windows::runtime::Result<DevicePickerAppearance> {
        ...
        unsafe {
            ...
            .from_abi::<DevicePickerAppearance>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    ...
    #[cfg(feature = "Foundation")]
    pub fn DisconnectButtonClicked<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDisconnectButtonClicked<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDevicePickerDismissed<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn SetDisplayStatus<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, DeviceInformation>,
...
unsafe impl ::windows::runtime::RuntimeType for DevicePicker {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Enumeration.DevicePicker;{84997aa2-034a-4440-8813-7d0bd479bf5a})",
    );
}
...
impl DevicePickerDisplayStatusOptions {
    ...
    pub const ShowProgress: DevicePickerDisplayStatusOptions =
        DevicePickerDisplayStatusOptions(1u32);
    pub const ShowDisconnectButton: DevicePickerDisplayStatusOptions =
        DevicePickerDisplayStatusOptions(2u32);
    pub const ShowRetryButton: DevicePickerDisplayStatusOptions =
        DevicePickerDisplayStatusOptions(4u32);
}
...
impl DevicePickerFilter {
    ...
    pub fn SupportedDeviceClasses(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<DeviceClass>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<DeviceClass>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
...
unsafe impl ::windows::runtime::RuntimeType for DeviceThumbnail {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Enumeration.DeviceThumbnail;{cc254827-4b3d-438f-9232-10c76bc7e038})",
    );
}
#[cfg(feature = "Storage_Streams")]
...
#[cfg(feature = "Storage_Streams")]
impl ::std::convert::From<DeviceThumbnail>
    for super::super::Storage::Streams::IRandomAccessStreamWithContentType
{
    fn from(value: DeviceThumbnail) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
#[cfg(feature = "Storage_Streams")]
impl ::std::convert::TryFrom<DeviceThumbnail>
    for super::super::Storage::Streams::IContentTypeProvider
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: DeviceThumbnail) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
#[cfg(feature = "Storage_Streams")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IContentTypeProvider>
    for DeviceThumbnail
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::Storage::Streams::IContentTypeProvider> {
        ::windows::runtime::IntoParam::into_param(&self)
    }
}
#[cfg(feature = "Storage_Streams")]
    ...
    for &DeviceThumbnail
{
    fn into_param(
        ...
        ::std::convert::TryInto::<super::super::Storage::Streams::IContentTypeProvider>::try_into(
            self,
        )
        .map(::windows::runtime::Param::Owned)
        .unwrap_or(::windows::runtime::Param::None)
...
#[cfg(feature = "Storage_Streams")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IInputStream>
    for DeviceThumbnail
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::Storage::Streams::IInputStream> {
        ::windows::runtime::IntoParam::into_param(&self)
    }
}
#[cfg(feature = "Storage_Streams")]
    ...
    for &DeviceThumbnail
{
    fn into_param(
        ...
        ::std::convert::TryInto::<super::super::Storage::Streams::IInputStream>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
#[cfg(feature = "Storage_Streams")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IOutputStream>
    for DeviceThumbnail
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::Storage::Streams::IOutputStream> {
        ::windows::runtime::IntoParam::into_param(&self)
    }
}
#[cfg(feature = "Storage_Streams")]
    ...
    for &DeviceThumbnail
{
    fn into_param(
        ...
        ::std::convert::TryInto::<super::super::Storage::Streams::IOutputStream>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
#[cfg(feature = "Storage_Streams")]
impl ::std::convert::TryFrom<DeviceThumbnail>
    for super::super::Storage::Streams::IRandomAccessStream
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: DeviceThumbnail) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
#[cfg(feature = "Storage_Streams")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IRandomAccessStream>
    for DeviceThumbnail
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::Storage::Streams::IRandomAccessStream> {
        ::windows::runtime::IntoParam::into_param(&self)
    }
}
#[cfg(feature = "Storage_Streams")]
    ...
    for &DeviceThumbnail
{
    fn into_param(
        ...
        ::std::convert::TryInto::<super::super::Storage::Streams::IRandomAccessStream>::try_into(
            self,
        )
        .map(::windows::runtime::Param::Owned)
        .unwrap_or(::windows::runtime::Param::None)
...
impl DeviceUnpairingResult {
    pub fn Status(&self) -> ::windows::runtime::Result<DeviceUnpairingResultStatus> {
        ...
        unsafe {
            ...
            .from_abi::<DeviceUnpairingResultStatus>(result__)
        }
    }
}
...
impl DeviceUnpairingResultStatus {
    ...
    pub const OperationAlreadyInProgress: DeviceUnpairingResultStatus =
        DeviceUnpairingResultStatus(2i32);
...
impl DeviceWatcher {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<DeviceWatcherStatus> {
        ...
        unsafe {
            ...
            .from_abi::<DeviceWatcherStatus>(result__)
        }
    }
    ...
    pub fn GetBackgroundTrigger<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<DeviceWatcherEventKind>,
        >,
    >(
        &self,
        requestedeventkinds: Param0,
    ) -> ::windows::runtime::Result<super::super::ApplicationModel::Background::DeviceWatcherTrigger>
    {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                requestedeventkinds.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::ApplicationModel::Background::DeviceWatcherTrigger>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for DeviceWatcher {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Enumeration.DeviceWatcher;{c9eab97d-8f6b-4f96-a9f4-abc814e22271})",
    );
}
...
impl DeviceWatcherEvent {
    pub fn Kind(&self) -> ::windows::runtime::Result<DeviceWatcherEventKind> {
        ...
        unsafe {
            ...
            .from_abi::<DeviceWatcherEventKind>(result__)
        }
    }
    pub fn DeviceInformation(&self) -> ::windows::runtime::Result<DeviceInformation> {
        let this = self;
    ...
    pub fn DeviceInformationUpdate(&self) -> ::windows::runtime::Result<DeviceInformationUpdate> {
        ...
        unsafe {
            ...
            .from_abi::<DeviceInformationUpdate>(result__)
        }
    }
}
...
impl DeviceWatcherTriggerDetails {
    ...
    pub fn DeviceWatcherEvents(
        ...
        super::super::Foundation::Collections::IVectorView<DeviceWatcherEvent>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<DeviceWatcherEvent>>(
                result__,
            )
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DeviceWatcherTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeviceWatcherTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for EnclosureLocation {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Enumeration.EnclosureLocation;{42340a27-5810-459c-aabb-c65e1f813ecf})",
    );
}
...
pub struct IDeviceAccessChangedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DeviceAccessStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IDeviceAccessInformationStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        deviceclassid: ::windows::runtime::GUID,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IDeviceInformation_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        updateinfo: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IDeviceInformation2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DeviceInformationKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
...
pub struct IDeviceInformationCustomPairing_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        pairingkindssupported: DevicePairingKinds,
        minprotectionlevel: DevicePairingProtectionLevel,
        devicepairingsettings: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
...
pub struct IDeviceInformationPairing2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DevicePairingProtectionLevel,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IDeviceInformationStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        14918,
        19064,
        [128, 19, 118, 157, 201, 185, 115, 144],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IDeviceInformationStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        deviceid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        additionalproperties: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        aqsfilter: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
...
pub struct IDevicePairingRequestedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DevicePairingKinds,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
pub struct IDevicePairingResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DevicePairingResultStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DevicePairingProtectionLevel,
...
unsafe impl ::windows::runtime::RuntimeType for IDevicePairingSettings {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{482cb27c-83bb-420e-be51-6602b222de54}");
}
...
pub struct IDevicePicker_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        status: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        options: DevicePickerDisplayStatusOptions,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct IDeviceUnpairingResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DeviceUnpairingResultStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IDeviceWatcher_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DeviceWatcherStatus,
    ) -> ::windows::runtime::HRESULT,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
);
...
pub struct IDeviceWatcher2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        requestedeventkinds: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "ApplicationModel_Background",
...
pub struct IDeviceWatcherEvent_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DeviceWatcherEventKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IEnclosureLocation2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        57469,
        18525,
        [138, 158, 189, 242, 154, 239, 79, 102],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::RuntimeType for Panel {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.Enumeration.Panel;i4)");
}
