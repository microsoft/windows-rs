...
pub struct IProviderSpiConnectionSettings_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ProviderSpiMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: ProviderSpiMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut i32,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ProviderSpiSharingMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: ProviderSpiSharingMode,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for ISpiControllerProvider {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        718,
        16934,
        [163, 133, 79, 17, 251, 4, 180, 27],
    );
}
impl ISpiControllerProvider {
    pub fn GetDeviceProvider<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ProviderSpiConnectionSettings>,
    >(
        &self,
        settings: Param0,
    ) -> ::windows::runtime::Result<ISpiDeviceProvider> {
        let this = self;
        unsafe {
            ...
            .from_abi::<ISpiDeviceProvider>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ISpiControllerProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{c1686504-02ce-4226-a385-4f11fb04b41b}");
}
...
impl ISpiDeviceProvider {
    ...
    pub fn ConnectionSettings(&self) -> ::windows::runtime::Result<ProviderSpiConnectionSettings> {
        ...
        unsafe {
            ...
            .from_abi::<ProviderSpiConnectionSettings>(result__)
        }
    }
    pub fn Write(
        &self,
...
unsafe impl ::windows::runtime::RuntimeType for ISpiDeviceProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{0d1c3443-304b-405c-b4f7-f5ab1074461e}");
}
...
impl ISpiProvider {
    ...
    pub fn GetControllersAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Foundation::Collections::IVectorView<ISpiControllerProvider>,
        >,
    > {
        let this = self;
        unsafe {
...
unsafe impl ::windows::runtime::RuntimeType for ISpiProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{96b461e2-77d4-48ce-aaa0-75715a8362cf}");
}
...
impl ProviderSpiConnectionSettings {
    ...
    pub fn Mode(&self) -> ::windows::runtime::Result<ProviderSpiMode> {
        ...
        unsafe {
            ...
            .from_abi::<ProviderSpiMode>(result__)
        }
    }
    ...
    pub fn SharingMode(&self) -> ::windows::runtime::Result<ProviderSpiSharingMode> {
        ...
        unsafe {
            ...
            .from_abi::<ProviderSpiSharingMode>(result__)
        }
    }
    ...
    pub fn Create(
        chipselectline: i32,
    ) -> ::windows::runtime::Result<ProviderSpiConnectionSettings> {
    ...
    pub fn IProviderSpiConnectionSettingsFactory<
        R,
        F: FnOnce(&IProviderSpiConnectionSettingsFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ProviderSpiConnectionSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
