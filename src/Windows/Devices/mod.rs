...
impl ILowLevelDevicesAggregateProvider {
    ...
    pub fn AdcControllerProvider(
        &self,
    ) -> ::windows::runtime::Result<Adc::Provider::IAdcControllerProvider> {
        let this = self;
        unsafe {
            ...
            .from_abi::<Adc::Provider::IAdcControllerProvider>(result__)
        }
    }
    #[cfg(feature = "Devices_Pwm_Provider")]
    pub fn PwmControllerProvider(
        &self,
    ) -> ::windows::runtime::Result<Pwm::Provider::IPwmControllerProvider> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<Pwm::Provider::IPwmControllerProvider>(result__)
        }
    }
    #[cfg(feature = "Devices_Gpio_Provider")]
    pub fn GpioControllerProvider(
        &self,
    ) -> ::windows::runtime::Result<Gpio::Provider::IGpioControllerProvider> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<Gpio::Provider::IGpioControllerProvider>(result__)
        }
    }
    #[cfg(feature = "Devices_I2c_Provider")]
    pub fn I2cControllerProvider(
        &self,
    ) -> ::windows::runtime::Result<I2c::Provider::II2cControllerProvider> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<I2c::Provider::II2cControllerProvider>(result__)
        }
    }
    #[cfg(feature = "Devices_Spi_Provider")]
    pub fn SpiControllerProvider(
        &self,
    ) -> ::windows::runtime::Result<Spi::Provider::ISpiControllerProvider> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<Spi::Provider::ISpiControllerProvider>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ILowLevelDevicesAggregateProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{a73e561c-aac1-4ec7-a852-479f7060d01f}");
}
...
pub struct ILowLevelDevicesAggregateProviderFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        adc: ::windows::runtime::RawPtr,
        pwm: ::windows::runtime::RawPtr,
        gpio: ::windows::runtime::RawPtr,
        i2c: ::windows::runtime::RawPtr,
        spi: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Devices_Adc_Provider",
...
impl LowLevelDevicesAggregateProvider {
    ...
    pub fn Create<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Adc::Provider::IAdcControllerProvider>,
        Param1: ::windows::runtime::IntoParam<'a, Pwm::Provider::IPwmControllerProvider>,
        Param2: ::windows::runtime::IntoParam<'a, Gpio::Provider::IGpioControllerProvider>,
        Param3: ::windows::runtime::IntoParam<'a, I2c::Provider::II2cControllerProvider>,
        Param4: ::windows::runtime::IntoParam<'a, Spi::Provider::ISpiControllerProvider>,
    >(
        adc: Param0,
        pwm: Param1,
        gpio: Param2,
        ...
        Self::ILowLevelDevicesAggregateProviderFactory(|this| unsafe {
            ...
            .from_abi::<LowLevelDevicesAggregateProvider>(result__)
        })
    }
    pub fn ILowLevelDevicesAggregateProviderFactory<
        R,
        F: FnOnce(&ILowLevelDevicesAggregateProviderFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LowLevelDevicesAggregateProvider
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ILowLevelDevicesAggregateProvider>
    for LowLevelDevicesAggregateProvider
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ILowLevelDevicesAggregateProvider> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<ILowLevelDevicesAggregateProvider>::into(self),
        )
    }
}
impl<'a> ::windows::runtime::IntoParam<'a, ILowLevelDevicesAggregateProvider>
    for &LowLevelDevicesAggregateProvider
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ILowLevelDevicesAggregateProvider> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<ILowLevelDevicesAggregateProvider>::into(
...
impl LowLevelDevicesController {
    pub fn DefaultProvider() -> ::windows::runtime::Result<ILowLevelDevicesAggregateProvider> {
        Self::ILowLevelDevicesControllerStatics(|this| unsafe {
            ...
            .from_abi::<ILowLevelDevicesAggregateProvider>(result__)
        })
    }
    pub fn SetDefaultProvider<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ILowLevelDevicesAggregateProvider>,
    >(
        value: Param0,
    ...
    pub fn ILowLevelDevicesControllerStatics<
        R,
        F: FnOnce(&ILowLevelDevicesControllerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for LowLevelDevicesController {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.LowLevelDevicesController;{2ec23dd4-179b-45de-9b39-3ae02527de52})",
    );
}
