...
pub struct ISimpleHapticsController_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        feedback: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        feedback: ::windows::runtime::RawPtr,
...
impl KnownSimpleHapticsControllerWaveforms {
    ...
    pub fn IKnownSimpleHapticsControllerWaveformsStatics<
        R,
        F: FnOnce(&IKnownSimpleHapticsControllerWaveformsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IKnownSimpleHapticsControllerWaveformsStatics2<
        R,
        F: FnOnce(&IKnownSimpleHapticsControllerWaveformsStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl SimpleHapticsController {
    ...
    pub fn SupportedFeedback(
        ...
        super::super::Foundation::Collections::IVectorView<SimpleHapticsControllerFeedback>,
    > {
        let this = self;
        unsafe {
    ...
    pub fn SendHapticFeedback<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, SimpleHapticsControllerFeedback>,
    >(
        &self,
        feedback: Param0,
    ) -> ::windows::runtime::Result<()> {
        ...
        unsafe {
            (::windows::runtime::Interface::vtable(this).13)(
                ::std::mem::transmute_copy(this),
                feedback.into_param().abi(),
            )
            .ok()
        }
    }
    pub fn SendHapticFeedbackWithIntensity<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, SimpleHapticsControllerFeedback>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn SendHapticFeedbackForDuration<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, SimpleHapticsControllerFeedback>,
    ...
    >(
        ...
        unsafe {
            (::windows::runtime::Interface::vtable(this).15)(
                ...
                feedback.into_param().abi(),
                intensity,
                playduration.into_param().abi(),
            )
            .ok()
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn SendHapticFeedbackForPlayCount<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, SimpleHapticsControllerFeedback>,
        Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::TimeSpan>,
    >(
        &self,
        feedback: Param0,
        intensity: f64,
        playcount: i32,
        replaypauseinterval: Param3,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).16)(
                ...
                intensity,
                playcount,
                replaypauseinterval.into_param().abi(),
            )
            .ok()
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SimpleHapticsControllerFeedback
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl VibrationDevice {
    ...
    pub fn SimpleHapticsController(&self) -> ::windows::runtime::Result<SimpleHapticsController> {
        ...
        unsafe {
            ...
            .from_abi::<SimpleHapticsController>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn RequestAccessAsync(
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<VibrationAccessStatus>>
    {
        Self::IVibrationDeviceStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<VibrationAccessStatus>>(result__)
        })
    }
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<VibrationDevice>>
    {
        Self::IVibrationDeviceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<VibrationDevice>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn FindAllAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<VibrationDevice>,
        >,
    > {
        Self::IVibrationDeviceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn IVibrationDeviceStatics<
        R,
        F: FnOnce(&IVibrationDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for VibrationDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Haptics.VibrationDevice;{40f21a3e-8844-47ff-b312-06185a3844da})",
    );
}
