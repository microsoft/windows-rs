...
unsafe impl ::windows::runtime::RuntimeType for I2cBusSpeed {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.I2c.I2cBusSpeed;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl I2cConnectionSettings {
    ...
    pub fn SharingMode(&self) -> ::windows::runtime::Result<I2cSharingMode> {
        ...
        unsafe {
            ...
            .from_abi::<I2cSharingMode>(result__)
        }
    }
    ...
    pub fn Create(slaveaddress: i32) -> ::windows::runtime::Result<I2cConnectionSettings> {
        Self::II2cConnectionSettingsFactory(|this| unsafe {
            ...
            .from_abi::<I2cConnectionSettings>(result__)
        })
    }
    pub fn II2cConnectionSettingsFactory<
        R,
        F: FnOnce(&II2cConnectionSettingsFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for I2cConnectionSettings {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.I2c.I2cConnectionSettings;{f2db1307-ab6f-4639-a767-54536dc3460f})",
    );
}
...
impl I2cController {
    pub fn GetDevice<'a, Param0: ::windows::runtime::IntoParam<'a, I2cConnectionSettings>>(
        &self,
        settings: Param0,
    ) -> ::windows::runtime::Result<I2cDevice> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
    ...
    pub fn GetControllersAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Provider::II2cProvider>,
    >(
        provider: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<I2cController>,
        >,
    > {
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<I2cController>> {
        Self::II2cControllerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<I2cController>>(result__)
        })
    }
    pub fn II2cControllerStatics<
        R,
        F: FnOnce(&II2cControllerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<I2cController, II2cControllerStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl I2cDevice {
    ...
    pub fn WritePartial(
        &self,
        buffer: &[<u8 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<I2cTransferResult> {
        let this = self;
        unsafe {
            ...
            .from_abi::<I2cTransferResult>(result__)
        }
    }
    pub fn Read(
        &self,
    ...
    pub fn FromIdAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, I2cConnectionSettings>,
    >(
        deviceid: Param0,
        settings: Param1,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<I2cDevice>> {
        Self::II2cDeviceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<I2cDevice>>(result__)
        })
    }
    pub fn II2cDeviceStatics<R, F: FnOnce(&II2cDeviceStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<I2cDevice, II2cDeviceStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for I2cDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.I2c.I2cDevice;{8636c136-b9c5-4f70-9449-cc46dc6f57eb})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for I2cSharingMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.I2c.I2cSharingMode;i4)");
}
...
impl ::std::fmt::Debug for I2cTransferResult {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("I2cTransferResult")
...
pub struct II2cConnectionSettings_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut I2cSharingMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: I2cSharingMode,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct II2cDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        buffer_array_size: u32,
        buffer: *const u8,
        result__: *mut I2cTransferResult,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        buffer_array_size: u32,
...
pub struct II2cDeviceStatics(::windows::runtime::IInspectable);
unsafe impl ::windows::runtime::Interface for II2cDeviceStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        29492,
        17682,
        [150, 188, 251, 174, 148, 89, 245, 246],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for II2cDeviceStatics {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{91a33be3-7334-4512-96bc-fbae9459f5f6}");
}
