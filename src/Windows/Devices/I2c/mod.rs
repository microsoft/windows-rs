...
impl I2cConnectionSettings {
    ...
    pub fn BusSpeed(&self) -> ::windows::runtime::Result<I2cBusSpeed> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).8)(::core::mem::transmute_copy(this), &mut result__).from_abi::<I2cBusSpeed>(result__)
        }
    }
    #[doc = "*Required features: `Devices_I2c`*"]
    ...
    pub fn SharingMode(&self) -> ::windows::runtime::Result<I2cSharingMode> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).10)(::core::mem::transmute_copy(this), &mut result__).from_abi::<I2cSharingMode>(result__)
        }
    }
    #[doc = "*Required features: `Devices_I2c`*"]
    ...
    pub fn Create(slaveaddress: i32) -> ::windows::runtime::Result<I2cConnectionSettings> {
        Self::II2cConnectionSettingsFactory(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), slaveaddress, &mut result__).from_abi::<I2cConnectionSettings>(result__)
        })
    }
...
impl ::core::convert::From<I2cConnectionSettings> for ::windows::runtime::IUnknown {
...
impl ::core::convert::From<I2cConnectionSettings> for ::windows::runtime::IInspectable {
    fn from(value: I2cConnectionSettings) -> Self {
        value.0
    }
}
...
impl I2cController {
    ...
    pub fn GetDevice<'a, Param0: ::windows::runtime::IntoParam<'a, I2cConnectionSettings>>(&self, settings: Param0) -> ::windows::runtime::Result<I2cDevice> {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), settings.into_param().abi(), &mut result__).from_abi::<I2cDevice>(result__)
        }
    }
    ...
    pub fn GetControllersAsync<'a, Param0: ::windows::runtime::IntoParam<'a, Provider::II2cProvider>>(provider: Param0) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<I2cController>>> {
        Self::II2cControllerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), provider.into_param().abi(), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<super::super::Foundation::Collections::IVectorView<I2cController>>>(result__)
        })
    }
    ...
    pub fn GetDefaultAsync() -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<I2cController>> {
        Self::II2cControllerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(::core::mem::transmute_copy(this), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<I2cController>>(result__)
        })
    }
...
impl ::core::convert::From<I2cController> for ::windows::runtime::IUnknown {
...
impl ::core::convert::From<I2cController> for ::windows::runtime::IInspectable {
    fn from(value: I2cController) -> Self {
        value.0
    }
}
...
impl I2cDevice {
    ...
    pub fn ConnectionSettings(&self) -> ::windows::runtime::Result<I2cConnectionSettings> {
        ...
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(::core::mem::transmute_copy(this), &mut result__).from_abi::<I2cConnectionSettings>(result__)
        }
    }
    #[doc = "*Required features: `Devices_I2c`*"]
    ...
    pub fn WritePartial(&self, buffer: &[<u8 as ::windows::runtime::DefaultType>::DefaultType]) -> ::windows::runtime::Result<I2cTransferResult> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).9)(::core::mem::transmute_copy(this), buffer.len() as u32, ::core::mem::transmute(buffer.as_ptr()), &mut result__).from_abi::<I2cTransferResult>(result__)
        }
    }
    #[doc = "*Required features: `Devices_I2c`*"]
    pub fn Read(&self, buffer: &mut [<u8 as ::windows::runtime::DefaultType>::DefaultType]) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe { (::windows::runtime::Interface::vtable(this).10)(::core::mem::transmute_copy(this), buffer.len() as u32, ::core::mem::transmute_copy(&buffer)).ok() }
    }
    #[doc = "*Required features: `Devices_I2c`*"]
    pub fn ReadPartial(&self, buffer: &mut [<u8 as ::windows::runtime::DefaultType>::DefaultType]) -> ::windows::runtime::Result<I2cTransferResult> {
        ...
        unsafe {
            let mut result__: I2cTransferResult = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(::core::mem::transmute_copy(this), buffer.len() as u32, ::core::mem::transmute_copy(&buffer), &mut result__).from_abi::<I2cTransferResult>(result__)
        }
    }
    #[doc = "*Required features: `Devices_I2c`*"]
    pub fn WriteRead(&self, writebuffer: &[<u8 as ::windows::runtime::DefaultType>::DefaultType], readbuffer: &mut [<u8 as ::windows::runtime::DefaultType>::DefaultType]) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe { (::windows::runtime::Interface::vtable(this).12)(::core::mem::transmute_copy(this), writebuffer.len() as u32, ::core::mem::transmute(writebuffer.as_ptr()), readbuffer.len() as u32, ::core::mem::transmute_copy(&readbuffer)).ok() }
    }
    #[doc = "*Required features: `Devices_I2c`*"]
    pub fn WriteReadPartial(&self, writebuffer: &[<u8 as ::windows::runtime::DefaultType>::DefaultType], readbuffer: &mut [<u8 as ::windows::runtime::DefaultType>::DefaultType]) -> ::windows::runtime::Result<I2cTransferResult> {
        ...
        unsafe {
            let mut result__: I2cTransferResult = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).13)(::core::mem::transmute_copy(this), writebuffer.len() as u32, ::core::mem::transmute(writebuffer.as_ptr()), readbuffer.len() as u32, ::core::mem::transmute_copy(&readbuffer), &mut result__).from_abi::<I2cTransferResult>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    #[doc = "*Required features: `Devices_I2c`, `Foundation`*"]
    ...
    pub fn FromIdAsync<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>, Param1: ::windows::runtime::IntoParam<'a, I2cConnectionSettings>>(deviceid: Param0, settings: Param1) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<I2cDevice>> {
        Self::II2cDeviceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::core::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(::core::mem::transmute_copy(this), deviceid.into_param().abi(), settings.into_param().abi(), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<I2cDevice>>(result__)
        })
    }
...
impl ::core::convert::From<I2cDevice> for ::windows::runtime::IUnknown {
...
impl ::core::convert::From<I2cDevice> for ::windows::runtime::IInspectable {
    fn from(value: I2cDevice) -> Self {
        value.0
    }
}
...
impl ::core::convert::From<II2cDeviceStatics> for ::windows::runtime::IUnknown {
...
impl ::core::convert::From<II2cDeviceStatics> for ::windows::runtime::IInspectable {
    fn from(value: II2cDeviceStatics) -> Self {
        value.0
    }
}
...
pub struct II2cDeviceStatics_abi(
    ...
    #[cfg(feature = "Foundation")] pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, deviceid: ::core::mem::ManuallyDrop<::windows::runtime::HSTRING>, settings: ::windows::runtime::RawPtr, result__: *mut ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
