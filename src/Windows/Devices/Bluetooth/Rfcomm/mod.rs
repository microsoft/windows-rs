...
pub struct IRfcommDeviceService_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::Networking::Sockets::SocketProtectionLevel,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        cachemode: super::BluetoothCacheMode,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Foundation",
...
unsafe impl ::windows::runtime::Interface for IRfcommDeviceService3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        56644,
        19747,
        [134, 109, 143, 52, 134, 238, 100, 144],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IRfcommDeviceServiceStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        serviceid: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct IRfcommDeviceServiceStatics2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bluetoothdevice: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IRfcommServiceProvider_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        listener: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Networking_Sockets"))] usize,
...
impl RfcommDeviceService {
    #[cfg(feature = "Networking")]
    pub fn ConnectionHostName(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Networking::HostName> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::super::Networking::HostName>(result__)
        }
    }
    ...
    pub fn ServiceId(&self) -> ::windows::runtime::Result<RfcommServiceId> {
        ...
        unsafe {
            ...
            .from_abi::<RfcommServiceId>(result__)
        }
    }
    #[cfg(feature = "Networking_Sockets")]
    pub fn ProtectionLevel(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Networking::Sockets::SocketProtectionLevel>
    {
        let this = self;
        unsafe {
            let mut result__: super::super::super::Networking::Sockets::SocketProtectionLevel =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::super::Networking::Sockets::SocketProtectionLevel>(result__)
        }
    }
    #[cfg(feature = "Networking_Sockets")]
    pub fn MaxProtectionLevel(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Networking::Sockets::SocketProtectionLevel>
    {
        let this = self;
    ...
    pub fn GetSdpRawAttributesAsync(
        &self,
    ...
    pub fn GetSdpRawAttributesWithCacheModeAsync(
        &self,
        cachemode: super::BluetoothCacheMode,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<RfcommDeviceService>,
    > {
        Self::IRfcommDeviceServiceStatics(|this| unsafe {
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<RfcommDeviceService>>(
                result__,
            )
        })
    }
    pub fn GetDeviceSelector<'a, Param0: ::windows::runtime::IntoParam<'a, RfcommServiceId>>(
        serviceid: Param0,
    ...
    #[cfg(feature = "Devices_Enumeration")]
    pub fn DeviceAccessInformation(
        &self,
    ) -> ::windows::runtime::Result<super::super::Enumeration::DeviceAccessInformation> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Enumeration::DeviceAccessInformation>(result__)
        }
    }
    #[cfg(all(feature = "Devices_Enumeration", feature = "Foundation"))]
    pub fn RequestAccessAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<
            super::super::Enumeration::DeviceAccessStatus,
        >,
    > {
        let this = &::windows::runtime::Interface::cast::<IRfcommDeviceService3>(self)?;
        unsafe {
    ...
    pub fn GetDeviceSelectorForBluetoothDevice<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::BluetoothDevice>,
    >(
        bluetoothdevice: Param0,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        Self::IRfcommDeviceServiceStatics2(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                bluetoothdevice.into_param().abi(),
                &mut result__,
            )
            .from_abi::<::windows::runtime::HSTRING>(result__)
        })
    }
    pub fn GetDeviceSelectorForBluetoothDeviceWithCacheMode<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::BluetoothDevice>,
    >(
        bluetoothdevice: Param0,
    ...
    pub fn GetDeviceSelectorForBluetoothDeviceAndServiceId<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::BluetoothDevice>,
        Param1: ::windows::runtime::IntoParam<'a, RfcommServiceId>,
    >(
        bluetoothdevice: Param0,
        serviceid: Param1,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
    ...
    pub fn GetDeviceSelectorForBluetoothDeviceAndServiceIdWithCacheMode<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::BluetoothDevice>,
        Param1: ::windows::runtime::IntoParam<'a, RfcommServiceId>,
    >(
    ...
    pub fn IRfcommDeviceServiceStatics<
        R,
        F: FnOnce(&IRfcommDeviceServiceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IRfcommDeviceServiceStatics2<
        R,
        F: FnOnce(&IRfcommDeviceServiceStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl RfcommDeviceServicesResult {
    ...
    pub fn Services(
        ...
        super::super::super::Foundation::Collections::IVectorView<RfcommDeviceService>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for RfcommDeviceServicesResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a RfcommDeviceServicesResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl RfcommServiceId {
    ...
    pub fn FromUuid<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::GUID>>(
        uuid: Param0,
    ) -> ::windows::runtime::Result<RfcommServiceId> {
    ...
    pub fn IRfcommServiceIdStatics<
        R,
        F: FnOnce(&IRfcommServiceIdStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl RfcommServiceProvider {
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Foundation::Collections::IMap<
                u32,
                super::super::super::Storage::Streams::IBuffer,
            >>(result__)
        }
    ...
    pub fn StartAdvertising<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Networking::Sockets::StreamSocketListener,
        >,
    >(
        &self,
        listener: Param0,
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateAsync<'a, Param0: ::windows::runtime::IntoParam<'a, RfcommServiceId>>(
        serviceid: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<RfcommServiceProvider>,
    > {
    ...
    #[cfg(feature = "Networking_Sockets")]
    pub fn StartAdvertisingWithRadioDiscoverability<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Networking::Sockets::StreamSocketListener,
    ...
    pub fn IRfcommServiceProviderStatics<
        R,
        F: FnOnce(&IRfcommServiceProviderStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
