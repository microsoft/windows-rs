...
unsafe impl ::windows::runtime::RuntimeType for BluetoothEventTriggeringMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Bluetooth.Background.BluetoothEventTriggeringMode;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl BluetoothLEAdvertisementPublisherTriggerDetails {
    ...
    pub fn Status(
        &self,
    ) -> ::windows::runtime::Result<super::Advertisement::BluetoothLEAdvertisementPublisherStatus>
    {
        let this = self;
        unsafe {
            let mut result__: super::Advertisement::BluetoothLEAdvertisementPublisherStatus =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::Advertisement::BluetoothLEAdvertisementPublisherStatus>(result__)
        }
    }
    pub fn Error(&self) -> ::windows::runtime::Result<super::BluetoothError> {
        ...
        unsafe {
            ...
            .from_abi::<super::BluetoothError>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn SelectedTransmitPowerLevelInDBm(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IReference<i16>> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Foundation::IReference<i16>>(result__)
        }
    }
}
...
impl ::std::convert::From<BluetoothLEAdvertisementPublisherTriggerDetails>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BluetoothLEAdvertisementPublisherTriggerDetails
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BluetoothLEAdvertisementPublisherTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl BluetoothLEAdvertisementWatcherTriggerDetails {
    ...
    #[cfg(all(
        feature = "Devices_Bluetooth_Advertisement",
    ...
    pub fn Advertisements(
        ...
        super::super::super::Foundation::Collections::IVectorView<
            super::Advertisement::BluetoothLEAdvertisementReceivedEventArgs,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn SignalStrengthFilter(
        &self,
    ) -> ::windows::runtime::Result<super::BluetoothSignalStrengthFilter> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::BluetoothSignalStrengthFilter>(result__)
        }
    }
}
...
unsafe impl ::windows::runtime::Interface for BluetoothLEAdvertisementWatcherTriggerDetails {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        8791,
        20073,
        [151, 132, 254, 230, 69, 193, 220, 224],
    );
}
...
impl ::std::convert::From<BluetoothLEAdvertisementWatcherTriggerDetails>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BluetoothLEAdvertisementWatcherTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl GattCharacteristicNotificationTriggerDetails {
    ...
    pub fn Characteristic(
        &self,
    ) -> ::windows::runtime::Result<super::GenericAttributeProfile::GattCharacteristic> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::GenericAttributeProfile::GattCharacteristic>(result__)
        }
    }
    ...
    pub fn EventTriggeringMode(&self) -> ::windows::runtime::Result<BluetoothEventTriggeringMode> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothEventTriggeringMode>(result__)
        }
    }
    #[cfg(all(
    ...
    pub fn ValueChangedEvents(
        ...
        super::super::super::Foundation::Collections::IVectorView<
            super::GenericAttributeProfile::GattValueChangedEventArgs,
        >,
    > {
        let this = &::windows::runtime::Interface::cast::<
            IGattCharacteristicNotificationTriggerDetails2,
...
unsafe impl ::windows::runtime::Interface for GattCharacteristicNotificationTriggerDetails {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        4076,
        17258,
        [147, 177, 244, 108, 105, 117, 50, 162],
    );
}
...
impl ::std::convert::From<GattCharacteristicNotificationTriggerDetails>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for GattCharacteristicNotificationTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GattCharacteristicNotificationTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl GattServiceProviderConnection {
    ...
    pub fn Service(
        &self,
    ) -> ::windows::runtime::Result<super::GenericAttributeProfile::GattLocalService> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::GenericAttributeProfile::GattLocalService>(result__)
        }
    }
    ...
    pub fn AllServices() -> ::windows::runtime::Result<
    ...
    pub fn IGattServiceProviderConnectionStatics<
        R,
        F: FnOnce(&IGattServiceProviderConnectionStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::Interface for GattServiceProviderConnection {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        12051,
        16565,
        [149, 130, 142, 183, 142, 152, 239, 19],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GattServiceProviderConnection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl GattServiceProviderTriggerDetails {
    pub fn Connection(&self) -> ::windows::runtime::Result<GattServiceProviderConnection> {
        ...
        unsafe {
            ...
            .from_abi::<GattServiceProviderConnection>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for GattServiceProviderTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GattServiceProviderTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IBluetoothLEAdvertisementPublisherTriggerDetails_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::Advertisement::BluetoothLEAdvertisementPublisherStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Devices_Bluetooth_Advertisement"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::BluetoothError,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IGattCharacteristicNotificationTriggerDetails2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BluetoothEventTriggeringMode,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(all(
        feature = "Devices_Bluetooth_GenericAttributeProfile",
        feature = "Foundation_Collections"
...
unsafe impl ::windows::runtime::Interface for IGattServiceProviderConnectionStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        2830,
        17510,
        [184, 205, 110, 189, 218, 31, 161, 125],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IRfcommInboundConnectionInformation_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::BluetoothServiceCapabilities,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: super::BluetoothServiceCapabilities,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IRfcommOutboundConnectionInformation {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        62516,
        19632,
        [153, 177, 74, 184, 206, 218, 237, 215],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl RfcommConnectionTriggerDetails {
    ...
    pub fn Socket(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Networking::Sockets::StreamSocket> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::Networking::Sockets::StreamSocket>(result__)
        }
    }
    ...
    pub fn RemoteDevice(&self) -> ::windows::runtime::Result<super::BluetoothDevice> {
        ...
        unsafe {
            ...
            .from_abi::<super::BluetoothDevice>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a RfcommConnectionTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl RfcommInboundConnectionInformation {
    ...
    pub fn LocalServiceId(&self) -> ::windows::runtime::Result<super::Rfcomm::RfcommServiceId> {
        ...
        unsafe {
            ...
            .from_abi::<super::Rfcomm::RfcommServiceId>(result__)
        }
    }
    #[cfg(feature = "Devices_Bluetooth_Rfcomm")]
    pub fn SetLocalServiceId<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Rfcomm::RfcommServiceId>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn ServiceCapabilities(
        &self,
    ) -> ::windows::runtime::Result<super::BluetoothServiceCapabilities> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::BluetoothServiceCapabilities>(result__)
        }
    }
    pub fn SetServiceCapabilities(
        &self,
        value: super::BluetoothServiceCapabilities,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for RfcommInboundConnectionInformation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&RfcommInboundConnectionInformation>
    for ::windows::runtime::IInspectable
{
    fn from(value: &RfcommInboundConnectionInformation) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a RfcommInboundConnectionInformation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<RfcommOutboundConnectionInformation>
    for ::windows::runtime::IInspectable
{
    fn from(value: RfcommOutboundConnectionInformation) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a RfcommOutboundConnectionInformation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
