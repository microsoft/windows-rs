...
impl BluetoothAdapter {
    ...
    pub fn GetRadioAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<super::Radios::Radio>>
    {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<super::Radios::Radio>>(result__)
        }
    }
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<BluetoothAdapter>>
    {
        Self::IBluetoothAdapterStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<BluetoothAdapter>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn IBluetoothAdapterStatics<
        R,
        F: FnOnce(&IBluetoothAdapterStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for BluetoothAdapter {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Bluetooth.BluetoothAdapter;{7974f04c-5f7a-4a34-9225-a855f84b1a8b})",
    );
}
...
impl BluetoothClassOfDevice {
    ...
    pub fn MajorClass(&self) -> ::windows::runtime::Result<BluetoothMajorClass> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothMajorClass>(result__)
        }
    }
    pub fn MinorClass(&self) -> ::windows::runtime::Result<BluetoothMinorClass> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothMinorClass>(result__)
        }
    }
    pub fn ServiceCapabilities(&self) -> ::windows::runtime::Result<BluetoothServiceCapabilities> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothServiceCapabilities>(result__)
        }
    }
    pub fn FromRawValue(rawvalue: u32) -> ::windows::runtime::Result<BluetoothClassOfDevice> {
        Self::IBluetoothClassOfDeviceStatics(|this| unsafe {
            ...
            .from_abi::<BluetoothClassOfDevice>(result__)
        })
    }
    pub fn FromParts(
    ...
    ) -> ::windows::runtime::Result<BluetoothClassOfDevice> {
        Self::IBluetoothClassOfDeviceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn IBluetoothClassOfDeviceStatics<
        R,
        F: FnOnce(&IBluetoothClassOfDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl BluetoothDevice {
    ...
    pub fn SdpRecords(
        ...
        super::super::Foundation::Collections::IVectorView<super::super::Storage::Streams::IBuffer>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(all(
        feature = "Devices_Bluetooth_Rfcomm",
        feature = "Foundation_Collections"
    ))]
    pub fn RfcommServices(
        &self,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<Rfcomm::RfcommDeviceService>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn ConnectionStatus(&self) -> ::windows::runtime::Result<BluetoothConnectionStatus> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothConnectionStatus>(result__)
        }
    }
    pub fn BluetoothAddress(&self) -> ::windows::runtime::Result<u64> {
        let this = self;
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveSdpRecordsChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<BluetoothDevice>>
    {
        Self::IBluetoothDeviceStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<BluetoothDevice>>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Networking"))]
    pub fn FromHostNameAsync<
        'a,
    ...
    pub fn GetDeviceSelectorFromClassOfDevice<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BluetoothClassOfDevice>,
    >(
        classofdevice: Param0,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        Self::IBluetoothDeviceStatics2(|this| unsafe {
            let mut result__: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING> =
                ::std::mem::zeroed();
    ...
    pub fn DeviceAccessInformation(
        &self,
    ) -> ::windows::runtime::Result<super::Enumeration::DeviceAccessInformation> {
        ...
        unsafe {
            ...
            .from_abi::<super::Enumeration::DeviceAccessInformation>(result__)
        }
    }
    ...
    pub fn RequestAccessAsync(
        ...
        super::super::Foundation::IAsyncOperation<super::Enumeration::DeviceAccessStatus>,
    > {
        let this = &::windows::runtime::Interface::cast::<IBluetoothDevice3>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<
                super::Enumeration::DeviceAccessStatus,
            >>(result__)
        }
    }
    ...
    pub fn GetRfcommServicesAsync(
        ...
        super::super::Foundation::IAsyncOperation<Rfcomm::RfcommDeviceServicesResult>,
    > {
        let this = &::windows::runtime::Interface::cast::<IBluetoothDevice3>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<
                Rfcomm::RfcommDeviceServicesResult,
            >>(result__)
        }
    }
    #[cfg(all(feature = "Devices_Bluetooth_Rfcomm", feature = "Foundation"))]
    ...
    #[cfg(all(feature = "Devices_Bluetooth_Rfcomm", feature = "Foundation"))]
    pub fn GetRfcommServicesForIdAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Rfcomm::RfcommServiceId>,
    >(
        &self,
        serviceid: Param0,
    ) -> ::windows::runtime::Result<
    ...
    #[cfg(all(feature = "Devices_Bluetooth_Rfcomm", feature = "Foundation"))]
    pub fn GetRfcommServicesForIdWithCacheModeAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Rfcomm::RfcommServiceId>,
    >(
        &self,
    ...
    pub fn BluetoothDeviceId(&self) -> ::windows::runtime::Result<BluetoothDeviceId> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothDeviceId>(result__)
        }
    }
    ...
    pub fn IBluetoothDeviceStatics<
        R,
        F: FnOnce(&IBluetoothDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IBluetoothDeviceStatics2<
        R,
        F: FnOnce(&IBluetoothDeviceStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for BluetoothDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Bluetooth.BluetoothDevice;{2335b156-90d2-4a04-aef5-0e20b9e6b707})",
    );
}
...
impl BluetoothDeviceId {
    ...
    pub fn FromId<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<BluetoothDeviceId> {
    ...
    pub fn IBluetoothDeviceIdStatics<
        R,
        F: FnOnce(&IBluetoothDeviceIdStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for BluetoothDeviceId {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Bluetooth.BluetoothDeviceId;{c17949af-57c1-4642-bcce-e6c06b20ae76})",
    );
}
unsafe impl ::windows::runtime::Interface for BluetoothDeviceId {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        22465,
        17986,
        [188, 206, 230, 192, 107, 32, 174, 118],
    );
}
...
impl BluetoothLEAppearance {
    ...
    pub fn FromRawValue(rawvalue: u16) -> ::windows::runtime::Result<BluetoothLEAppearance> {
        Self::IBluetoothLEAppearanceStatics(|this| unsafe {
            ...
            .from_abi::<BluetoothLEAppearance>(result__)
        })
    }
    pub fn FromParts(
        appearancecategory: u16,
        appearancesubcategory: u16,
    ) -> ::windows::runtime::Result<BluetoothLEAppearance> {
        Self::IBluetoothLEAppearanceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn IBluetoothLEAppearanceStatics<
        R,
        F: FnOnce(&IBluetoothLEAppearanceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl BluetoothLEAppearanceCategories {
    ...
    pub fn IBluetoothLEAppearanceCategoriesStatics<
        R,
        F: FnOnce(&IBluetoothLEAppearanceCategoriesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl BluetoothLEAppearanceSubcategories {
    ...
    pub fn IBluetoothLEAppearanceSubcategoriesStatics<
        R,
        F: FnOnce(&IBluetoothLEAppearanceSubcategoriesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BluetoothLEConnectionParameters
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BluetoothLEConnectionParameters
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BluetoothLEConnectionPhy {
    pub fn TransmitInfo(&self) -> ::windows::runtime::Result<BluetoothLEConnectionPhyInfo> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothLEConnectionPhyInfo>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BluetoothLEConnectionPhy
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BluetoothLEConnectionPhyInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BluetoothLEConnectionPhyInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BluetoothLEDevice {
    ...
    >(
        &self,
        serviceuuid: Param0,
    ) -> ::windows::runtime::Result<GenericAttributeProfile::GattDeviceService> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(
            ...
            .from_abi::<GenericAttributeProfile::GattDeviceService>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn NameChanged<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveGattServicesChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<BluetoothLEDevice>>
    {
        Self::IBluetoothLEDeviceStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<BluetoothLEDevice>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn FromBluetoothAddressAsync(
    ...
    pub fn BluetoothAddressType(&self) -> ::windows::runtime::Result<BluetoothAddressType> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothAddressType>(result__)
        }
    }
    pub fn GetDeviceSelectorFromPairingState(
        pairingstate: bool,
    ...
    pub fn GetDeviceSelectorFromAppearance<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BluetoothLEAppearance>,
    >(
        appearance: Param0,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        Self::IBluetoothLEDeviceStatics2(|this| unsafe {
    ...
    pub fn GetConnectionParameters(
        &self,
    ) -> ::windows::runtime::Result<BluetoothLEConnectionParameters> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothLEConnectionParameters>(result__)
        }
    }
    pub fn GetConnectionPhy(&self) -> ::windows::runtime::Result<BluetoothLEConnectionPhy> {
        ...
        unsafe {
            ...
            .from_abi::<BluetoothLEConnectionPhy>(result__)
        }
    }
    pub fn RequestPreferredConnectionParameters<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BluetoothLEPreferredConnectionParameters>,
    >(
        &self,
        preferredconnectionparameters: Param0,
    ) -> ::windows::runtime::Result<BluetoothLEPreferredConnectionParametersRequest> {
        let this = &::windows::runtime::Interface::cast::<IBluetoothLEDevice6>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                preferredconnectionparameters.into_param().abi(),
                &mut result__,
            )
            .from_abi::<BluetoothLEPreferredConnectionParametersRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ConnectionParametersChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveConnectionParametersChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveConnectionPhyChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn IBluetoothLEDeviceStatics<
        R,
        F: FnOnce(&IBluetoothLEDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IBluetoothLEDeviceStatics2<
        R,
        F: FnOnce(&IBluetoothLEDeviceStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for BluetoothLEDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Bluetooth.BluetoothLEDevice;{b5ee2f7b-4ad8-4642-ac48-80a0b500e887})",
    );
}
...
impl BluetoothLEPreferredConnectionParameters {
    ...
    pub fn Balanced() -> ::windows::runtime::Result<BluetoothLEPreferredConnectionParameters> {
        Self::IBluetoothLEPreferredConnectionParametersStatics(|this| unsafe {
            ...
            .from_abi::<BluetoothLEPreferredConnectionParameters>(result__)
        })
    }
    pub fn ThroughputOptimized(
    ) -> ::windows::runtime::Result<BluetoothLEPreferredConnectionParameters> {
        Self::IBluetoothLEPreferredConnectionParametersStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn IBluetoothLEPreferredConnectionParametersStatics<
        R,
        F: FnOnce(&IBluetoothLEPreferredConnectionParametersStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl ::std::convert::From<BluetoothLEPreferredConnectionParameters>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BluetoothLEPreferredConnectionParameters
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BluetoothLEPreferredConnectionParameters
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BluetoothLEPreferredConnectionParametersRequest {
    ...
    pub fn Status(
        &self,
    ) -> ::windows::runtime::Result<BluetoothLEPreferredConnectionParametersRequestStatus> {
        let this = self;
        unsafe {
            let mut result__: BluetoothLEPreferredConnectionParametersRequestStatus =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<BluetoothLEPreferredConnectionParametersRequestStatus>(result__)
        }
    }
}
...
impl ::std::convert::From<BluetoothLEPreferredConnectionParametersRequest>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BluetoothLEPreferredConnectionParametersRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BluetoothLEPreferredConnectionParametersRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<BluetoothLEPreferredConnectionParametersRequest>
    for super::super::Foundation::IClosable
{
    type Error = ::windows::runtime::Error;
    fn try_from(
        value: BluetoothLEPreferredConnectionParametersRequest,
...
impl BluetoothLEPreferredConnectionParametersRequestStatus {
    pub const Unspecified: BluetoothLEPreferredConnectionParametersRequestStatus =
        BluetoothLEPreferredConnectionParametersRequestStatus(0i32);
    pub const Success: BluetoothLEPreferredConnectionParametersRequestStatus =
        BluetoothLEPreferredConnectionParametersRequestStatus(1i32);
    pub const DeviceNotAvailable: BluetoothLEPreferredConnectionParametersRequestStatus =
        BluetoothLEPreferredConnectionParametersRequestStatus(2i32);
    pub const AccessDenied: BluetoothLEPreferredConnectionParametersRequestStatus =
        BluetoothLEPreferredConnectionParametersRequestStatus(3i32);
}
...
unsafe impl ::windows::runtime::RuntimeType
    for BluetoothLEPreferredConnectionParametersRequestStatus
{
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
...
impl BluetoothMinorClass {
    ...
    pub const AudioVideoVideoDisplayAndLoudspeaker: BluetoothMinorClass =
        BluetoothMinorClass(15i32);
...
impl BluetoothServiceCapabilities {
    ...
    pub const LimitedDiscoverableMode: BluetoothServiceCapabilities =
        BluetoothServiceCapabilities(1u32);
    ...
    pub const ObjectTransferService: BluetoothServiceCapabilities =
        BluetoothServiceCapabilities(128u32);
    ...
    pub const InformationService: BluetoothServiceCapabilities =
        BluetoothServiceCapabilities(1024u32);
}
...
impl BluetoothSignalStrengthFilter {
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetInRangeThresholdInDBm<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetOutOfRangeThresholdInDBm<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::IReference<i16>>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BluetoothSignalStrengthFilter
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BluetoothSignalStrengthFilter
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BluetoothUuidHelper {
    ...
    pub fn IBluetoothUuidHelperStatics<
        R,
        F: FnOnce(&IBluetoothUuidHelperStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
pub struct IBluetoothClassOfDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BluetoothMajorClass,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BluetoothMinorClass,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BluetoothServiceCapabilities,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IBluetoothClassOfDeviceStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        4002,
        16748,
        [145, 180, 193, 228, 140, 160, 97, 193],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IBluetoothDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BluetoothConnectionStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u64,
...
pub struct IBluetoothDeviceStatics2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        classofdevice: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
unsafe impl ::windows::runtime::Interface for IBluetoothLEAppearanceSubcategoriesStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        8516,
        16730,
        [131, 18, 113, 204, 242, 145, 248, 209],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IBluetoothLEDevice2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BluetoothAddressType,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IBluetoothLEDevice6_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        preferredconnectionparameters: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
...
pub struct IBluetoothLEDeviceStatics2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appearance: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
...
pub struct IBluetoothLEPreferredConnectionParametersRequest_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BluetoothLEPreferredConnectionParametersRequestStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IBluetoothLEPreferredConnectionParametersStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        10065,
        21930,
        [168, 56, 143, 174, 238, 129, 141, 114],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IBluetoothUuidHelperStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        53108,
        19233,
        [175, 230, 245, 122, 17, 188, 222, 160],
    );
}
#[repr(C)]
#[doc(hidden)]
