...
unsafe impl ::windows::runtime::Interface for IWiFiDirectService {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        24433,
        17900,
        [132, 241, 161, 228, 252, 120, 121, 163],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IWiFiDirectService_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiDirectServiceError,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IWiFiDirectServiceAdvertiser {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        40335,
        20303,
        [147, 238, 125, 222, 162, 227, 127, 70],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IWiFiDirectServiceAdvertiser_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiDirectServiceStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: WiFiDirectServiceStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u32,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiDirectServiceAdvertisementStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiDirectServiceError,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        deviceinfo: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface
    for IWiFiDirectServiceAutoAcceptSessionConnectedEventArgs
{
...
pub struct IWiFiDirectServiceProvisioningInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiDirectServiceConfigurationMethod,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
...
pub struct IWiFiDirectServiceRemotePortAddedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiDirectServiceIPProtocol,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IWiFiDirectServiceSession_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiDirectServiceSessionStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WiFiDirectServiceSessionErrorStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u32,
...
unsafe impl ::windows::runtime::Interface for IWiFiDirectServiceSessionRequestedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        21462,
        18841,
        [180, 248, 108, 142, 204, 23, 113, 231],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IWiFiDirectServiceStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        servicename: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        serviceinfofilter: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))] usize,
    #[cfg(feature = "Foundation")]
...
impl WiFiDirectService {
    ...
    pub fn ServiceError(&self) -> ::windows::runtime::Result<WiFiDirectServiceError> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiDirectServiceError>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn SessionDeferred<
        'a,
    ...
    pub fn GetProvisioningInfoAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<WiFiDirectServiceProvisioningInfo>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn ConnectAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<WiFiDirectServiceSession>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<WiFiDirectServiceSession>>(
                result__,
            )
        }
    }
    ...
    >(
        ...
        Self::IWiFiDirectServiceStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                servicename.into_param().abi(),
                serviceinfofilter.into_param().abi(),
                &mut result__,
            )
            .from_abi::<::windows::runtime::HSTRING>(result__)
        })
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<WiFiDirectService>,
    > {
        Self::IWiFiDirectServiceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<WiFiDirectService>>(
                result__,
            )
        })
    }
    pub fn IWiFiDirectServiceStatics<
        R,
        F: FnOnce(&IWiFiDirectServiceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl WiFiDirectServiceAdvertisementStatus {
    pub const Created: WiFiDirectServiceAdvertisementStatus =
        WiFiDirectServiceAdvertisementStatus(0i32);
    pub const Started: WiFiDirectServiceAdvertisementStatus =
        WiFiDirectServiceAdvertisementStatus(1i32);
    pub const Stopped: WiFiDirectServiceAdvertisementStatus =
        WiFiDirectServiceAdvertisementStatus(2i32);
    pub const Aborted: WiFiDirectServiceAdvertisementStatus =
        WiFiDirectServiceAdvertisementStatus(3i32);
}
...
impl WiFiDirectServiceAdvertiser {
    ...
    pub fn PreferredConfigurationMethods(
        ...
        super::super::super::Foundation::Collections::IVector<WiFiDirectServiceConfigurationMethod>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn ServiceStatus(&self) -> ::windows::runtime::Result<WiFiDirectServiceStatus> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiDirectServiceStatus>(result__)
        }
    }
    ...
    pub fn AdvertisementStatus(
        &self,
    ) -> ::windows::runtime::Result<WiFiDirectServiceAdvertisementStatus> {
        let this = self;
        unsafe {
            ...
            .from_abi::<WiFiDirectServiceAdvertisementStatus>(result__)
        }
    }
    pub fn ServiceError(&self) -> ::windows::runtime::Result<WiFiDirectServiceError> {
        let this = self;
    ...
    #[cfg(feature = "Foundation")]
    pub fn AutoAcceptSessionConnected<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveAutoAcceptSessionConnected<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn ConnectAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Enumeration::DeviceInformation>,
    >(
        &self,
        deviceinfo: Param0,
    ) -> ::windows::runtime::Result<
    ...
    >(
        servicename: Param0,
    ) -> ::windows::runtime::Result<WiFiDirectServiceAdvertiser> {
        Self::IWiFiDirectServiceAdvertiserFactory(|this| unsafe {
            ...
            .from_abi::<WiFiDirectServiceAdvertiser>(result__)
        })
    }
    pub fn IWiFiDirectServiceAdvertiserFactory<
        R,
        F: FnOnce(&IWiFiDirectServiceAdvertiserFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WiFiDirectServiceAdvertiser
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WiFiDirectServiceAutoAcceptSessionConnectedEventArgs {
    pub fn Session(&self) -> ::windows::runtime::Result<WiFiDirectServiceSession> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiDirectServiceSession>(result__)
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn SessionInfo(
...
unsafe impl ::windows::runtime::RuntimeType
    for WiFiDirectServiceAutoAcceptSessionConnectedEventArgs
{
...
impl ::std::convert::From<WiFiDirectServiceAutoAcceptSessionConnectedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WiFiDirectServiceAutoAcceptSessionConnectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WiFiDirectServiceConfigurationMethod {
    pub const Default: WiFiDirectServiceConfigurationMethod =
        WiFiDirectServiceConfigurationMethod(0i32);
    pub const PinDisplay: WiFiDirectServiceConfigurationMethod =
        WiFiDirectServiceConfigurationMethod(1i32);
    pub const PinEntry: WiFiDirectServiceConfigurationMethod =
        WiFiDirectServiceConfigurationMethod(2i32);
}
...
impl WiFiDirectServiceProvisioningInfo {
    pub fn SelectedConfigurationMethod(
        &self,
    ) -> ::windows::runtime::Result<WiFiDirectServiceConfigurationMethod> {
        let this = self;
        unsafe {
            ...
            .from_abi::<WiFiDirectServiceConfigurationMethod>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for WiFiDirectServiceProvisioningInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WiFiDirectServiceProvisioningInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WiFiDirectServiceRemotePortAddedEventArgs {
    ...
    pub fn EndpointPairs(
        ...
        super::super::super::Foundation::Collections::IVectorView<
            super::super::super::Networking::EndpointPair,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn Protocol(&self) -> ::windows::runtime::Result<WiFiDirectServiceIPProtocol> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiDirectServiceIPProtocol>(result__)
        }
    }
}
...
impl ::std::convert::From<WiFiDirectServiceRemotePortAddedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for WiFiDirectServiceRemotePortAddedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WiFiDirectServiceRemotePortAddedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WiFiDirectServiceSession {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<WiFiDirectServiceSessionStatus> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiDirectServiceSessionStatus>(result__)
        }
    }
    pub fn ErrorStatus(&self) -> ::windows::runtime::Result<WiFiDirectServiceSessionErrorStatus> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiDirectServiceSessionErrorStatus>(result__)
        }
    }
    ...
    #[cfg(all(feature = "Foundation", feature = "Networking_Sockets"))]
    pub fn AddStreamSocketListenerAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
    ...
    #[cfg(all(feature = "Foundation", feature = "Networking_Sockets"))]
    pub fn AddDatagramSocketAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Networking::Sockets::DatagramSocket>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncAction> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WiFiDirectServiceSession
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<WiFiDirectServiceSession>
...
impl ::std::convert::From<WiFiDirectServiceSessionDeferredEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for WiFiDirectServiceSessionDeferredEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WiFiDirectServiceSessionDeferredEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WiFiDirectServiceSessionErrorStatus {
    ...
    pub const Disassociated: WiFiDirectServiceSessionErrorStatus =
        WiFiDirectServiceSessionErrorStatus(1i32);
    pub const LocalClose: WiFiDirectServiceSessionErrorStatus =
        WiFiDirectServiceSessionErrorStatus(2i32);
    pub const RemoteClose: WiFiDirectServiceSessionErrorStatus =
        WiFiDirectServiceSessionErrorStatus(3i32);
    pub const SystemFailure: WiFiDirectServiceSessionErrorStatus =
        WiFiDirectServiceSessionErrorStatus(4i32);
    pub const NoResponseFromRemote: WiFiDirectServiceSessionErrorStatus =
        WiFiDirectServiceSessionErrorStatus(5i32);
}
...
impl WiFiDirectServiceSessionRequest {
    ...
    pub fn DeviceInformation(
        &self,
    ) -> ::windows::runtime::Result<super::super::Enumeration::DeviceInformation> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::Enumeration::DeviceInformation>(result__)
        }
    }
    pub fn ProvisioningInfo(
        &self,
    ) -> ::windows::runtime::Result<WiFiDirectServiceProvisioningInfo> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<WiFiDirectServiceProvisioningInfo>(result__)
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn SessionInfo(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for WiFiDirectServiceSessionRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WiFiDirectServiceSessionRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<WiFiDirectServiceSessionRequest>
    for super::super::super::Foundation::IClosable
{
    type Error = ::windows::runtime::Error;
...
impl WiFiDirectServiceSessionRequestedEventArgs {
    pub fn GetSessionRequest(&self) -> ::windows::runtime::Result<WiFiDirectServiceSessionRequest> {
        ...
        unsafe {
            ...
            .from_abi::<WiFiDirectServiceSessionRequest>(result__)
        }
    }
}
...
impl ::std::convert::From<WiFiDirectServiceSessionRequestedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a WiFiDirectServiceSessionRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
