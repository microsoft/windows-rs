...
pub struct IPerceptionCorrelationFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        position: super::super::super::Foundation::Numerics::Vector3,
        orientation: super::super::super::Foundation::Numerics::Quaternion,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Numerics"))] usize,
);
...
unsafe impl ::windows::runtime::Interface for IPerceptionCorrelationGroup {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        13991,
        18363,
        [155, 121, 86, 204, 107, 116, 103, 112],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPerceptionCorrelationGroupFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        relativelocations: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))] usize,
);
...
pub struct IPerceptionFaceAuthenticationGroupFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ids: ::windows::runtime::RawPtr,
        starthandler: ::windows::runtime::RawPtr,
        stophandler: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))] usize,
);
...
impl IPerceptionFrameProvider {
    ...
    pub fn SetProperty<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, PerceptionPropertyChangeRequest>,
    >(
        &self,
        value: Param0,
...
unsafe impl ::windows::runtime::RuntimeType for IPerceptionFrameProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{794f7ab9-b37d-3b33-a10d-30626419ce65}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IPerceptionFrameProvider
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<IPerceptionFrameProvider>
...
unsafe impl ::windows::runtime::Interface for IPerceptionFrameProviderManager {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        60115,
        13279,
        [142, 193, 185, 36, 171, 224, 25, 196],
    );
}
impl IPerceptionFrameProviderManager {
    #[cfg(feature = "deprecated")]
    pub fn GetFrameProvider<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, PerceptionFrameProviderInfo>,
    >(
        &self,
        frameproviderinfo: Param0,
    ) -> ::windows::runtime::Result<IPerceptionFrameProvider> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                frameproviderinfo.into_param().abi(),
                &mut result__,
            )
            .from_abi::<IPerceptionFrameProvider>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Close(&self) -> ::windows::runtime::Result<()> {
...
unsafe impl ::windows::runtime::RuntimeType for IPerceptionFrameProviderManager {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{a959ce07-ead3-33df-8ec1-b924abe019c4}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IPerceptionFrameProviderManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IPerceptionFrameProviderManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<IPerceptionFrameProviderManager>
    for super::super::super::Foundation::IClosable
{
    type Error = ::windows::runtime::Error;
...
pub struct IPerceptionFrameProviderManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        frameproviderinfo: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct IPerceptionFrameProviderManagerServiceStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        manager: ::windows::runtime::RawPtr,
        frameproviderinfo: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        manager: ::windows::runtime::RawPtr,
        faceauthenticationgroup: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        manager: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        manager: ::windows::runtime::RawPtr,
        controlgroup: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        manager: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        manager: ::windows::runtime::RawPtr,
        correlationgroup: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        manager: ::windows::runtime::RawPtr,
...
pub struct IPerceptionPropertyChangeRequest_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::PerceptionFrameSourcePropertyChangeStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: super::PerceptionFrameSourcePropertyChangeStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IPerceptionVideoFrameAllocatorFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        maxoutstandingframecountforwrite: u32,
        format: super::super::super::Graphics::Imaging::BitmapPixelFormat,
        resolution: super::super::super::Foundation::Size,
        alpha: super::super::super::Graphics::Imaging::BitmapAlphaMode,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
impl KnownPerceptionFrameKind {
    ...
    pub fn IKnownPerceptionFrameKindStatics<
        R,
        F: FnOnce(&IKnownPerceptionFrameKindStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl PerceptionControlGroup {
    ...
    >(
        ids: Param0,
    ) -> ::windows::runtime::Result<PerceptionControlGroup> {
        Self::IPerceptionControlGroupFactory(|this| unsafe {
            ...
            .from_abi::<PerceptionControlGroup>(result__)
        })
    }
    pub fn IPerceptionControlGroupFactory<
        R,
        F: FnOnce(&IPerceptionControlGroupFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl PerceptionCorrelation {
    ...
    >(
        ...
        position: Param1,
        orientation: Param2,
    ) -> ::windows::runtime::Result<PerceptionCorrelation> {
        Self::IPerceptionCorrelationFactory(|this| unsafe {
            ...
            .from_abi::<PerceptionCorrelation>(result__)
        })
    }
    pub fn IPerceptionCorrelationFactory<
        R,
        F: FnOnce(&IPerceptionCorrelationFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl PerceptionCorrelationGroup {
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation_Collections")]
    pub fn RelativeLocations(
        &self,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::Collections::IVectorView<PerceptionCorrelation>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn Create<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::Collections::IIterable<PerceptionCorrelation>,
        >,
    >(
        relativelocations: Param0,
    ) -> ::windows::runtime::Result<PerceptionCorrelationGroup> {
        Self::IPerceptionCorrelationGroupFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                relativelocations.into_param().abi(),
                &mut result__,
            )
            .from_abi::<PerceptionCorrelationGroup>(result__)
        })
    }
    pub fn IPerceptionCorrelationGroupFactory<
        R,
        F: FnOnce(&IPerceptionCorrelationGroupFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PerceptionCorrelationGroup
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PerceptionCorrelationGroup
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PerceptionFaceAuthenticationGroup {
    ...
    pub fn Create<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::super::Foundation::Collections::IIterable<::windows::runtime::HSTRING>,
        >,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionStartFaceAuthenticationHandler>,
        Param2: ::windows::runtime::IntoParam<'a, PerceptionStopFaceAuthenticationHandler>,
    >(
        ids: Param0,
        starthandler: Param1,
        stophandler: Param2,
    ) -> ::windows::runtime::Result<PerceptionFaceAuthenticationGroup> {
        Self::IPerceptionFaceAuthenticationGroupFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                ids.into_param().abi(),
                starthandler.into_param().abi(),
                stophandler.into_param().abi(),
                &mut result__,
            )
            .from_abi::<PerceptionFaceAuthenticationGroup>(result__)
        })
    }
    pub fn IPerceptionFaceAuthenticationGroupFactory<
        R,
        F: FnOnce(&IPerceptionFaceAuthenticationGroupFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PerceptionFaceAuthenticationGroup
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PerceptionFaceAuthenticationGroup
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PerceptionFrame {
    ...
    pub fn Properties(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::Collections::ValueSet> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::super::Foundation::Collections::ValueSet>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn FrameData(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IMemoryBuffer> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IMemoryBuffer>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PerceptionFrameProviderInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PerceptionFrameProviderInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PerceptionFrameProviderManagerService {
    #[cfg(feature = "deprecated")]
    pub fn RegisterFrameProviderInfo<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProviderManager>,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionFrameProviderInfo>,
    >(
        manager: Param0,
        frameproviderinfo: Param1,
    ) -> ::windows::runtime::Result<()> {
        Self::IPerceptionFrameProviderManagerServiceStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                manager.into_param().abi(),
                frameproviderinfo.into_param().abi(),
            )
            .ok()
        })
    ...
    #[cfg(feature = "deprecated")]
    pub fn UnregisterFrameProviderInfo<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProviderManager>,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionFrameProviderInfo>,
    >(
    ...
    #[cfg(feature = "deprecated")]
    pub fn RegisterFaceAuthenticationGroup<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProviderManager>,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionFaceAuthenticationGroup>,
    >(
        manager: Param0,
        faceauthenticationgroup: Param1,
    ) -> ::windows::runtime::Result<()> {
        Self::IPerceptionFrameProviderManagerServiceStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                manager.into_param().abi(),
                faceauthenticationgroup.into_param().abi(),
            )
            .ok()
        })
    }
    #[cfg(feature = "deprecated")]
    pub fn UnregisterFaceAuthenticationGroup<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProviderManager>,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionFaceAuthenticationGroup>,
    >(
    ...
    #[cfg(feature = "deprecated")]
    pub fn RegisterControlGroup<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProviderManager>,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionControlGroup>,
    >(
        manager: Param0,
        controlgroup: Param1,
    ) -> ::windows::runtime::Result<()> {
        Self::IPerceptionFrameProviderManagerServiceStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).10)(
                ::std::mem::transmute_copy(this),
                manager.into_param().abi(),
                controlgroup.into_param().abi(),
            )
            .ok()
        })
    }
    #[cfg(feature = "deprecated")]
    pub fn UnregisterControlGroup<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProviderManager>,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionControlGroup>,
    >(
    ...
    #[cfg(feature = "deprecated")]
    pub fn RegisterCorrelationGroup<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProviderManager>,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionCorrelationGroup>,
    >(
        manager: Param0,
        correlationgroup: Param1,
    ) -> ::windows::runtime::Result<()> {
        Self::IPerceptionFrameProviderManagerServiceStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).12)(
                ::std::mem::transmute_copy(this),
                manager.into_param().abi(),
                correlationgroup.into_param().abi(),
            )
            .ok()
        })
    }
    #[cfg(feature = "deprecated")]
    pub fn UnregisterCorrelationGroup<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProviderManager>,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionCorrelationGroup>,
    >(
    ...
    #[cfg(feature = "deprecated")]
    pub fn UpdateAvailabilityForProvider<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProvider>,
    >(
        provider: Param0,
        available: bool,
    ) -> ::windows::runtime::Result<()> {
    ...
    #[cfg(feature = "deprecated")]
    pub fn PublishFrameForProvider<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPerceptionFrameProvider>,
        Param1: ::windows::runtime::IntoParam<'a, PerceptionFrame>,
    >(
        provider: Param0,
        frame: Param1,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn IPerceptionFrameProviderManagerServiceStatics<
        R,
        F: FnOnce(&IPerceptionFrameProviderManagerServiceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl PerceptionPropertyChangeRequest {
    ...
    pub fn Status(
        &self,
    ) -> ::windows::runtime::Result<super::PerceptionFrameSourcePropertyChangeStatus> {
        let this = self;
        unsafe {
            let mut result__: super::PerceptionFrameSourcePropertyChangeStatus =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::PerceptionFrameSourcePropertyChangeStatus>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn SetStatus(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PerceptionPropertyChangeRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PerceptionPropertyChangeRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PerceptionStartFaceAuthenticationHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<PerceptionFaceAuthenticationGroup>,
    ...
    pub fn Invoke<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, PerceptionFaceAuthenticationGroup>,
    >(
        &self,
        sender: Param0,
    ) -> ::windows::runtime::Result<bool> {
...
unsafe impl ::windows::runtime::RuntimeType for PerceptionStartFaceAuthenticationHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({74816d2a-2090-4670-8c48-ef39e7ff7c26})",
    );
}
...
#[repr(C)]
struct PerceptionStartFaceAuthenticationHandler_box<
    F: FnMut(
            &::std::option::Option<PerceptionFaceAuthenticationGroup>,
        ) -> ::windows::runtime::Result<bool>
        + 'static,
...
impl<
        F: FnMut(
            ...
            + 'static,
    > PerceptionStartFaceAuthenticationHandler_box<F>
{
    const VTABLE: PerceptionStartFaceAuthenticationHandler_abi =
        PerceptionStartFaceAuthenticationHandler_abi(
            Self::QueryInterface,
            Self::AddRef,
            Self::Release,
            Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid
            == &<PerceptionStartFaceAuthenticationHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        match ( ( * this ) . invoke ) ( & * ( & sender as * const < PerceptionFaceAuthenticationGroup as :: windows :: runtime :: Abi > :: Abi as * const < PerceptionFaceAuthenticationGroup as :: windows :: runtime :: Abi > :: DefaultType ) , ) { :: std :: result :: Result :: Ok ( ok__ ) => { * result__ = :: std :: mem :: transmute_copy ( & ok__ ) ; :: std :: mem :: forget ( ok__ ) ; :: windows :: runtime :: HRESULT ( 0 ) } :: std :: result :: Result :: Err ( err ) => err . into ( ) }
    }
}
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::RuntimeType for PerceptionStopFaceAuthenticationHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({387ee6aa-89cd-481e-aade-dd92f70b2ad7})",
    );
}
...
#[repr(C)]
struct PerceptionStopFaceAuthenticationHandler_box<
    F: FnMut(
            &::std::option::Option<PerceptionFaceAuthenticationGroup>,
        ) -> ::windows::runtime::Result<()>
        + 'static,
...
impl<
        F: FnMut(
            ...
            + 'static,
    > PerceptionStopFaceAuthenticationHandler_box<F>
{
    const VTABLE: PerceptionStopFaceAuthenticationHandler_abi =
        PerceptionStopFaceAuthenticationHandler_abi(
            Self::QueryInterface,
            Self::AddRef,
            Self::Release,
            Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid
            == &<PerceptionStopFaceAuthenticationHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
...
impl PerceptionVideoFrameAllocator {
    ...
    pub fn AllocateFrame(&self) -> ::windows::runtime::Result<PerceptionFrame> {
        ...
        unsafe {
            ...
            .from_abi::<PerceptionFrame>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Media")]
    pub fn CopyFromVideoFrame<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Media::VideoFrame>,
    >(
        &self,
        frame: Param0,
    ) -> ::windows::runtime::Result<PerceptionFrame> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    >(
        ...
        resolution: Param2,
        alpha: super::super::super::Graphics::Imaging::BitmapAlphaMode,
    ) -> ::windows::runtime::Result<PerceptionVideoFrameAllocator> {
        Self::IPerceptionVideoFrameAllocatorFactory(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                format,
                resolution.into_param().abi(),
                alpha,
                &mut result__,
            )
            .from_abi::<PerceptionVideoFrameAllocator>(result__)
        })
    }
    pub fn IPerceptionVideoFrameAllocatorFactory<
        R,
        F: FnOnce(&IPerceptionVideoFrameAllocatorFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PerceptionVideoFrameAllocator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PerceptionVideoFrameAllocator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<PerceptionVideoFrameAllocator>
    for super::super::super::Foundation::IClosable
{
    type Error = ::windows::runtime::Error;
