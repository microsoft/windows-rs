...
pub struct IServiceDeviceStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        serviceid: ::windows::runtime::GUID,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
impl ServiceDevice {
    ...
    pub fn IServiceDeviceStatics<
        R,
        F: FnOnce(&IServiceDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<ServiceDevice, IServiceDeviceStatics> =
...
impl StorageDevice {
    ...
    pub fn IStorageDeviceStatics<
        R,
        F: FnOnce(&IStorageDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<StorageDevice, IStorageDeviceStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
