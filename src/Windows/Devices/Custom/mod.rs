...
impl CustomDevice {
    ...
    pub fn SendIOControlAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IIOControlCode>,
    ...
    >(
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                iocontrolcode.into_param().abi(),
                inputbuffer.into_param().abi(),
                outputbuffer.into_param().abi(),
                &mut result__,
            )
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<CustomDevice>> {
        Self::ICustomDeviceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<CustomDevice>>(result__)
        })
    }
    pub fn ICustomDeviceStatics<
        R,
        F: FnOnce(&ICustomDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<CustomDevice, ICustomDeviceStatics> =
...
pub struct ICustomDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        iocontrolcode: ::windows::runtime::RawPtr,
        inputbuffer: ::windows::runtime::RawPtr,
        outputbuffer: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct ICustomDeviceStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        classguid: ::windows::runtime::GUID,
...
impl IIOControlCode {
    pub fn AccessMode(&self) -> ::windows::runtime::Result<IOControlAccessMode> {
        ...
        unsafe {
            ...
            .from_abi::<IOControlAccessMode>(result__)
        }
    }
    pub fn BufferingMethod(&self) -> ::windows::runtime::Result<IOControlBufferingMethod> {
        ...
        unsafe {
            ...
            .from_abi::<IOControlBufferingMethod>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for IIOControlCode {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{0e9559e7-60c8-4375-a761-7f8808066c60}");
}
...
unsafe impl ::windows::runtime::Interface for IIOControlCodeFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        19473,
        17582,
        [175, 198, 184, 212, 162, 18, 120, 143],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl IOControlCode {
    ...
    pub fn CreateIOControlCode(
        ...
        accessmode: IOControlAccessMode,
        bufferingmethod: IOControlBufferingMethod,
    ) -> ::windows::runtime::Result<IOControlCode> {
        Self::IIOControlCodeFactory(|this| unsafe {
            ...
            .from_abi::<IOControlCode>(result__)
        })
    }
    pub fn IIOControlCodeFactory<
        R,
        F: FnOnce(&IIOControlCodeFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<IOControlCode, IIOControlCodeFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for IOControlCode {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Custom.IOControlCode;{0e9559e7-60c8-4375-a761-7f8808066c60})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IIOControlCode> for &IOControlCode {
    fn into_param(self) -> ::windows::runtime::Param<'a, IIOControlCode> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IIOControlCode>::into(
...
impl KnownDeviceTypes {
    ...
    pub fn IKnownDeviceTypesStatics<
        R,
        F: FnOnce(&IKnownDeviceTypesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
