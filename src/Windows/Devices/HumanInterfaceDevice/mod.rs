...
impl HidBooleanControl {
    ...
    pub fn ControlDescription(&self) -> ::windows::runtime::Result<HidBooleanControlDescription> {
        ...
        unsafe {
            ...
            .from_abi::<HidBooleanControlDescription>(result__)
        }
    }
}
...
impl HidBooleanControlDescription {
    ...
    pub fn ReportType(&self) -> ::windows::runtime::Result<HidReportType> {
        ...
        unsafe {
            ...
            .from_abi::<HidReportType>(result__)
        }
    }
    pub fn UsagePage(&self) -> ::windows::runtime::Result<u16> {
        let this = self;
    ...
    pub fn ParentCollections(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<HidCollection>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<HidCollection>>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for HidBooleanControlDescription
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a HidBooleanControlDescription
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl HidCollection {
    ...
    pub fn Type(&self) -> ::windows::runtime::Result<HidCollectionType> {
        ...
        unsafe {
            ...
            .from_abi::<HidCollectionType>(result__)
        }
    }
...
impl HidDevice {
    ...
    pub fn GetInputReportAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<HidInputReport>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<HidInputReport>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn GetFeatureReportAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<HidFeatureReport>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<HidFeatureReport>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn CreateOutputReport(&self) -> ::windows::runtime::Result<HidOutputReport> {
        ...
        unsafe {
            ...
            .from_abi::<HidOutputReport>(result__)
        }
    }
    pub fn CreateOutputReportById(
        &self,
        reportid: u16,
    ) -> ::windows::runtime::Result<HidOutputReport> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn CreateFeatureReport(&self) -> ::windows::runtime::Result<HidFeatureReport> {
        ...
        unsafe {
            ...
            .from_abi::<HidFeatureReport>(result__)
        }
    }
    pub fn CreateFeatureReportById(
        &self,
        reportid: u16,
    ) -> ::windows::runtime::Result<HidFeatureReport> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(feature = "Foundation")]
    pub fn SendOutputReportAsync<'a, Param0: ::windows::runtime::IntoParam<'a, HidOutputReport>>(
        &self,
        outputreport: Param0,
    ...
    #[cfg(feature = "Foundation")]
    pub fn SendFeatureReportAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, HidFeatureReport>,
    >(
        &self,
        featurereport: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<u32>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn GetBooleanControlDescriptions(
        ...
        super::super::Foundation::Collections::IVectorView<HidBooleanControlDescription>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn GetNumericControlDescriptions(
        ...
        super::super::Foundation::Collections::IVectorView<HidNumericControlDescription>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveInputReportReceived<
        'a,
    ...
    >(
        ...
        Self::IHidDeviceStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<HidDevice>>(result__)
        })
    }
    pub fn IHidDeviceStatics<R, F: FnOnce(&IHidDeviceStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<HidDevice, IHidDeviceStatics> =
...
unsafe impl ::windows::runtime::Interface for HidDevice {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        8704,
        17198,
        [149, 218, 208, 155, 135, 213, 116, 168],
    );
}
...
impl HidFeatureReport {
    ...
    pub fn GetBooleanControl(
        ...
        usagepage: u16,
        usageid: u16,
    ) -> ::windows::runtime::Result<HidBooleanControl> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
            ...
            .from_abi::<HidBooleanControl>(result__)
        }
    }
    pub fn GetBooleanControlByDescription<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, HidBooleanControlDescription>,
    >(
        &self,
        controldescription: Param0,
    ) -> ::windows::runtime::Result<HidBooleanControl> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
                ::std::mem::transmute_copy(this),
                controldescription.into_param().abi(),
                &mut result__,
            )
            .from_abi::<HidBooleanControl>(result__)
        }
    ...
    pub fn GetNumericControl(
        ...
        usagepage: u16,
        usageid: u16,
    ) -> ::windows::runtime::Result<HidNumericControl> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(
            ...
            .from_abi::<HidNumericControl>(result__)
        }
    }
    pub fn GetNumericControlByDescription<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, HidNumericControlDescription>,
    >(
        &self,
        controldescription: Param0,
    ) -> ::windows::runtime::Result<HidNumericControl> {
...
impl HidInputReport {
    ...
    pub fn ActivatedBooleanControls(
        ...
        super::super::Foundation::Collections::IVectorView<HidBooleanControl>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<HidBooleanControl>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::Interface for HidInputReport {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63463,
        20109,
        [178, 62, 202, 187, 229, 107, 144, 233],
    );
}
...
impl HidInputReportReceivedEventArgs {
    pub fn Report(&self) -> ::windows::runtime::Result<HidInputReport> {
        ...
        unsafe {
            ...
            .from_abi::<HidInputReport>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a HidInputReportReceivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl HidNumericControl {
    ...
    pub fn ControlDescription(&self) -> ::windows::runtime::Result<HidNumericControlDescription> {
        ...
        unsafe {
            ...
            .from_abi::<HidNumericControlDescription>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for HidNumericControlDescription
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a HidNumericControlDescription
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IHidCollection_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut HidCollectionType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u32,
...
pub struct IHidDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        outputreport: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        featurereport: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation_Collections")]
...
pub struct IHidFeatureReport_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        controldescription: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
