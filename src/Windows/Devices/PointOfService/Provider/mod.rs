...
impl BarcodeScannerDisableScannerRequest {
    ...
    pub fn ReportFailedWithFailedReasonAsync(
        ...
        let this =
            &::windows::runtime::Interface::cast::<IBarcodeScannerDisableScannerRequest2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
    ...
    >(
        &self,
        reason: i32,
        failedreasondescription: Param1,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncAction> {
        let this =
            &::windows::runtime::Interface::cast::<IBarcodeScannerDisableScannerRequest2>(self)?;
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                reason,
                failedreasondescription.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncAction>(result__)
        }
...
unsafe impl ::windows::runtime::Interface for BarcodeScannerDisableScannerRequest {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        14265,
        17013,
        [142, 119, 200, 229, 42, 229, 169, 200],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerDisableScannerRequest
{
...
impl ::std::convert::From<BarcodeScannerDisableScannerRequest>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerDisableScannerRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl BarcodeScannerDisableScannerRequestEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<BarcodeScannerDisableScannerRequest> {
        ...
        unsafe {
            ...
            .from_abi::<BarcodeScannerDisableScannerRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(
...
impl ::std::convert::From<BarcodeScannerDisableScannerRequestEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerDisableScannerRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerEnableScannerRequest {
    ...
    pub fn ReportFailedWithFailedReasonAsync(
        ...
        let this =
            &::windows::runtime::Interface::cast::<IBarcodeScannerEnableScannerRequest2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerEnableScannerRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&BarcodeScannerEnableScannerRequest>
    for ::windows::runtime::IInspectable
{
    fn from(value: &BarcodeScannerEnableScannerRequest) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerEnableScannerRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerEnableScannerRequestEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<BarcodeScannerEnableScannerRequest> {
        ...
        unsafe {
            ...
            .from_abi::<BarcodeScannerEnableScannerRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(
...
impl ::std::convert::From<BarcodeScannerEnableScannerRequestEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerEnableScannerRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerFrameReader {
    ...
    pub fn TryAcquireLatestFrameAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<BarcodeScannerVideoFrame>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<BarcodeScannerVideoFrame>>(
                result__,
            )
        }
    }
    pub fn Connection(&self) -> ::windows::runtime::Result<BarcodeScannerProviderConnection> {
        ...
        unsafe {
            ...
            .from_abi::<BarcodeScannerProviderConnection>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn FrameArrived<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerFrameReader
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<BarcodeScannerFrameReader>
...
impl ::std::convert::From<BarcodeScannerFrameReaderFrameArrivedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerFrameReaderFrameArrivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerGetSymbologyAttributesRequest {
    ...
    pub fn ReportCompletedAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::BarcodeSymbologyAttributes>,
    >(
        &self,
        attributes: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncAction> {
...
impl ::std::convert::From<BarcodeScannerGetSymbologyAttributesRequest>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerGetSymbologyAttributesRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerGetSymbologyAttributesRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerGetSymbologyAttributesRequestEventArgs {
    pub fn Request(
        &self,
    ) -> ::windows::runtime::Result<BarcodeScannerGetSymbologyAttributesRequest> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<BarcodeScannerGetSymbologyAttributesRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(
...
impl ::std::convert::From<BarcodeScannerGetSymbologyAttributesRequestEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerGetSymbologyAttributesRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerHideVideoPreviewRequest {
    ...
    pub fn ReportFailedWithFailedReasonAsync(
        ...
        let this =
            &::windows::runtime::Interface::cast::<IBarcodeScannerHideVideoPreviewRequest2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
...
impl ::std::convert::From<BarcodeScannerHideVideoPreviewRequest>
    for ::windows::runtime::IInspectable
{
    fn from(value: BarcodeScannerHideVideoPreviewRequest) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerHideVideoPreviewRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerHideVideoPreviewRequestEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<BarcodeScannerHideVideoPreviewRequest> {
        ...
        unsafe {
            ...
            .from_abi::<BarcodeScannerHideVideoPreviewRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(
...
impl ::std::convert::From<BarcodeScannerHideVideoPreviewRequestEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerHideVideoPreviewRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerHideVideoPreviewRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerProviderConnection {
    ...
    pub fn SupportedSymbologies(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::Collections::IVector<u32>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::Collections::IVector<u32>>(result__)
        }
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn ReportScannedDataAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::BarcodeScannerReport>,
    >(
        &self,
        report: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncAction> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn ReportErrorAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::UnifiedPosErrorData>,
    >(
        &self,
        errordata: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncAction> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn ReportErrorAsyncWithScanReport<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::UnifiedPosErrorData>,
        Param2: ::windows::runtime::IntoParam<'a, super::BarcodeScannerReport>,
    >(
        &self,
        errordata: Param0,
        isretriable: bool,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveEnableScannerRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn DisableScannerRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDisableScannerRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetActiveSymbologiesRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveSetActiveSymbologiesRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn StartSoftwareTriggerRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveStartSoftwareTriggerRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn StopSoftwareTriggerRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveStopSoftwareTriggerRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn GetBarcodeSymbologyAttributesRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetBarcodeSymbologyAttributesRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn HideVideoPreviewRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveHideVideoPreviewRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn CreateFrameReaderAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<BarcodeScannerFrameReader>,
    > {
        let this =
            &::windows::runtime::Interface::cast::<IBarcodeScannerProviderConnection2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn CreateFrameReaderWithFormatAndSizeAsync<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Graphics::Imaging::BitmapSize>,
    >(
        &self,
        preferredformat: super::super::super::Graphics::Imaging::BitmapPixelFormat,
        preferredsize: Param1,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<BarcodeScannerFrameReader>,
    > {
        let this =
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerProviderConnection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerProviderConnection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<BarcodeScannerProviderConnection>
    for super::super::super::Foundation::IClosable
{
    type Error = ::windows::runtime::Error;
...
unsafe impl ::windows::runtime::Interface for BarcodeScannerProviderTriggerDetails {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        9443,
        18638,
        [153, 199, 112, 170, 193, 203, 201, 247],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerProviderTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<BarcodeScannerProviderTriggerDetails>
    for ::windows::runtime::IInspectable
{
    fn from(value: BarcodeScannerProviderTriggerDetails) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerProviderTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerSetActiveSymbologiesRequest {
    ...
    pub fn Symbologies(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::Collections::IVectorView<u32>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::Collections::IVectorView<u32>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ReportCompletedAsync(
...
impl ::std::convert::From<BarcodeScannerSetActiveSymbologiesRequest>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerSetActiveSymbologiesRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerSetActiveSymbologiesRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerSetActiveSymbologiesRequestEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<BarcodeScannerSetActiveSymbologiesRequest> {
        ...
        unsafe {
            ...
            .from_abi::<BarcodeScannerSetActiveSymbologiesRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(
...
impl ::std::convert::From<BarcodeScannerSetActiveSymbologiesRequestEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerSetActiveSymbologiesRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerSetActiveSymbologiesRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerSetSymbologyAttributesRequest {
    ...
    pub fn Attributes(&self) -> ::windows::runtime::Result<super::BarcodeSymbologyAttributes> {
        ...
        unsafe {
            ...
            .from_abi::<super::BarcodeSymbologyAttributes>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ReportCompletedAsync(
...
impl ::std::convert::From<BarcodeScannerSetSymbologyAttributesRequest>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerSetSymbologyAttributesRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerSetSymbologyAttributesRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerSetSymbologyAttributesRequestEventArgs {
    pub fn Request(
        &self,
    ) -> ::windows::runtime::Result<BarcodeScannerSetSymbologyAttributesRequest> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<BarcodeScannerSetSymbologyAttributesRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(
...
unsafe impl ::windows::runtime::RuntimeType
    for BarcodeScannerSetSymbologyAttributesRequestEventArgs
{
...
impl ::std::convert::From<BarcodeScannerSetSymbologyAttributesRequestEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerSetSymbologyAttributesRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<BarcodeScannerStartSoftwareTriggerRequest>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BarcodeScannerStartSoftwareTriggerRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerStartSoftwareTriggerRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerStartSoftwareTriggerRequestEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<BarcodeScannerStartSoftwareTriggerRequest> {
        ...
        unsafe {
            ...
            .from_abi::<BarcodeScannerStartSoftwareTriggerRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(
...
impl ::std::convert::From<BarcodeScannerStartSoftwareTriggerRequestEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerStartSoftwareTriggerRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<BarcodeScannerStopSoftwareTriggerRequest>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerStopSoftwareTriggerRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BarcodeScannerStopSoftwareTriggerRequestEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<BarcodeScannerStopSoftwareTriggerRequest> {
        ...
        unsafe {
            ...
            .from_abi::<BarcodeScannerStopSoftwareTriggerRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(
...
impl ::std::convert::From<BarcodeScannerStopSoftwareTriggerRequestEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerStopSoftwareTriggerRequestEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeScannerVideoFrame
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<BarcodeScannerVideoFrame>
    for super::super::super::Foundation::IClosable
{
    type Error = ::windows::runtime::Error;
...
impl BarcodeSymbologyAttributesBuilder {
    ...
    pub fn SetIsCheckDigitValidationSupported(
        &self,
        value: bool,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn SetIsCheckDigitTransmissionSupported(
        &self,
        value: bool,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn CreateAttributes(
        &self,
    ) -> ::windows::runtime::Result<super::BarcodeSymbologyAttributes> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).12)(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BarcodeSymbologyAttributesBuilder
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IBarcodeScannerDisableScannerRequest2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        reason: i32,
        failedreasondescription: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
...
pub struct IBarcodeScannerProviderConnection_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        errordata: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        ...
        errordata: ::windows::runtime::RawPtr,
        isretriable: bool,
        scanreport: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
...
unsafe impl ::windows::runtime::Interface for IBarcodeScannerSetActiveSymbologiesRequest2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        64154,
        18249,
        [177, 27, 232, 252, 203, 117, 188, 107],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface
    for IBarcodeScannerSetSymbologyAttributesRequestEventArgs
{
    type Vtable = IBarcodeScannerSetSymbologyAttributesRequestEventArgs_abi;
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        2998441993,
