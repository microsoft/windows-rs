...
impl Geofence {
    ...
    pub fn MonitoredStates(&self) -> ::windows::runtime::Result<MonitoredGeofenceStates> {
        ...
        unsafe {
            ...
            .from_abi::<MonitoredGeofenceStates>(result__)
        }
    }
    pub fn Geoshape(&self) -> ::windows::runtime::Result<super::IGeoshape> {
        ...
        unsafe {
            ...
            .from_abi::<super::IGeoshape>(result__)
        }
    }
    ...
    pub fn Create<
        ...
        Param1: ::windows::runtime::IntoParam<'a, super::IGeoshape>,
    >(
        id: Param0,
        geoshape: Param1,
        ...
        Self::IGeofenceFactory(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                id.into_param().abi(),
                geoshape.into_param().abi(),
                &mut result__,
            )
            .from_abi::<Geofence>(result__)
        })
    }
    pub fn CreateWithMonitorStates<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::IGeoshape>,
    >(
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateWithMonitorStatesAndDwellTime<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::IGeoshape>,
        Param4: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::TimeSpan>,
    >(
        id: Param0,
        geoshape: Param1,
        monitoredstates: MonitoredGeofenceStates,
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateWithMonitorStatesDwellTimeStartTimeAndDuration<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::IGeoshape>,
        Param4: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::TimeSpan>,
    ...
    pub fn IGeofenceFactory<R, F: FnOnce(&IGeofenceFactory) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<Geofence, IGeofenceFactory> =
...
impl GeofenceMonitor {
    pub fn Status(&self) -> ::windows::runtime::Result<GeofenceMonitorStatus> {
        ...
        unsafe {
            ...
            .from_abi::<GeofenceMonitorStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Geofences(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::Collections::IVector<Geofence>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::Collections::IVector<Geofence>>(result__)
        }
    }
    pub fn LastKnownGeoposition(&self) -> ::windows::runtime::Result<super::Geoposition> {
        ...
        unsafe {
            ...
            .from_abi::<super::Geoposition>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveGeofenceStateChanged<
        'a,
    ...
    pub fn ReadReports(
        ...
        super::super::super::Foundation::Collections::IVectorView<GeofenceStateChangeReport>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn Current() -> ::windows::runtime::Result<GeofenceMonitor> {
        Self::IGeofenceMonitorStatics(|this| unsafe {
            ...
            .from_abi::<GeofenceMonitor>(result__)
        })
    }
    pub fn IGeofenceMonitorStatics<
        R,
        F: FnOnce(&IGeofenceMonitorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
...
unsafe impl ::windows::runtime::RuntimeType for GeofenceMonitorStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for GeofenceRemovalReason {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.Geofencing.GeofenceRemovalReason;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for GeofenceState {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.Geofencing.GeofenceState;u4)",
    );
}
...
impl GeofenceStateChangeReport {
    pub fn NewState(&self) -> ::windows::runtime::Result<GeofenceState> {
        ...
        unsafe {
            ...
            .from_abi::<GeofenceState>(result__)
        }
    }
    ...
    pub fn RemovalReason(&self) -> ::windows::runtime::Result<GeofenceRemovalReason> {
        ...
        unsafe {
            ...
            .from_abi::<GeofenceRemovalReason>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GeofenceStateChangeReport
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IGeofence_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MonitoredGeofenceStates,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IGeofenceFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        geoshape: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        ...
        monitoredstates: MonitoredGeofenceStates,
        singleuse: bool,
        dwelltime: super::super::super::Foundation::TimeSpan,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        ...
        singleuse: bool,
        dwelltime: super::super::super::Foundation::TimeSpan,
        starttime: super::super::super::Foundation::DateTime,
...
pub struct IGeofenceMonitor_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut GeofenceMonitorStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation_Collections")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IGeofenceStateChangeReport_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut GeofenceRemovalReason,
    ) -> ::windows::runtime::HRESULT,
);
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for MonitoredGeofenceStates {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.Geofencing.MonitoredGeofenceStates;u4)",
    );
}
