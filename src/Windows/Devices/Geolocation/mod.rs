...
unsafe impl ::windows::runtime::RuntimeType for AltitudeReferenceSystem {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.AltitudeReferenceSystem;i4)",
    );
}
...
impl ::std::fmt::Debug for BasicGeoposition {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("BasicGeoposition")
...
unsafe impl ::windows::runtime::RuntimeType for BasicGeoposition {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"struct(Windows.Devices.Geolocation.BasicGeoposition;f8;f8;f8)",
    );
}
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::RuntimeType for CivicAddress {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.CivicAddress;{a8567a1a-64f4-4d48-bcea-f6b008eca34c})",
    );
}
...
impl GeoboundingBox {
    pub fn NorthwestCorner(&self) -> ::windows::runtime::Result<BasicGeoposition> {
        ...
        unsafe {
            ...
            .from_abi::<BasicGeoposition>(result__)
        }
    }
    ...
    pub fn GeoshapeType(&self) -> ::windows::runtime::Result<GeoshapeType> {
        ...
        unsafe {
            ...
            .from_abi::<GeoshapeType>(result__)
        }
    }
    ...
    pub fn AltitudeReferenceSystem(&self) -> ::windows::runtime::Result<AltitudeReferenceSystem> {
        ...
        unsafe {
            ...
            .from_abi::<AltitudeReferenceSystem>(result__)
        }
    }
    pub fn Create<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BasicGeoposition>,
        Param1: ::windows::runtime::IntoParam<'a, BasicGeoposition>,
    >(
        northwestcorner: Param0,
        southeastcorner: Param1,
    ) -> ::windows::runtime::Result<GeoboundingBox> {
        Self::IGeoboundingBoxFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                northwestcorner.into_param().abi(),
                southeastcorner.into_param().abi(),
                &mut result__,
            )
            .from_abi::<GeoboundingBox>(result__)
        })
    }
    pub fn CreateWithAltitudeReference<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BasicGeoposition>,
        Param1: ::windows::runtime::IntoParam<'a, BasicGeoposition>,
    >(
    ...
    pub fn TryCompute<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<BasicGeoposition>,
        >,
    >(
        positions: Param0,
    ) -> ::windows::runtime::Result<GeoboundingBox> {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn TryComputeWithAltitudeReference<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<BasicGeoposition>,
    ...
    pub fn IGeoboundingBoxFactory<
        R,
        F: FnOnce(&IGeoboundingBoxFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IGeoboundingBoxStatics<
        R,
        F: FnOnce(&IGeoboundingBoxStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for GeoboundingBox {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.GeoboundingBox;{0896c80b-274f-43da-9a06-cbfcdaeb4ec2})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IGeoshape> for &GeoboundingBox {
    fn into_param(self) -> ::windows::runtime::Param<'a, IGeoshape> {
        ::std::convert::TryInto::<IGeoshape>::try_into(self)
...
impl Geocircle {
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, BasicGeoposition>>(
        position: Param0,
        radius: f64,
        ...
        Self::IGeocircleFactory(|this| unsafe {
            ...
            .from_abi::<Geocircle>(result__)
        })
    }
    pub fn CreateWithAltitudeReferenceSystem<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BasicGeoposition>,
    >(
        position: Param0,
    ...
    pub fn CreateWithAltitudeReferenceSystemAndSpatialReferenceId<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BasicGeoposition>,
    >(
        position: Param0,
    ...
    pub fn IGeocircleFactory<R, F: FnOnce(&IGeocircleFactory) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<Geocircle, IGeocircleFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for Geocircle {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.Geocircle;{39e45843-a7f9-4e63-92a7-ba0c28d124b1})",
    );
}
...
impl Geocoordinate {
    ...
    pub fn PositionSource(&self) -> ::windows::runtime::Result<PositionSource> {
        ...
        unsafe {
            ...
            .from_abi::<PositionSource>(result__)
        }
    }
    pub fn SatelliteData(&self) -> ::windows::runtime::Result<GeocoordinateSatelliteData> {
        ...
        unsafe {
            ...
            .from_abi::<GeocoordinateSatelliteData>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn PositionSourceTimestamp(
        &self,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IReference<super::super::Foundation::DateTime>,
    > {
        let this = &::windows::runtime::Interface::cast::<IGeocoordinateWithPositionSourceTimestamp>(
            self,
        )?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
unsafe impl ::windows::runtime::RuntimeType for Geocoordinate {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.Geocoordinate;{ee21a3aa-976a-4c70-803d-083ea55bcbc4})",
    );
}
...
impl GeocoordinateSatelliteData {
    #[cfg(feature = "Foundation")]
    pub fn PositionDilutionOfPrecision(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IReference<f64>> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "Foundation")]
    pub fn HorizontalDilutionOfPrecision(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IReference<f64>> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "Foundation")]
    pub fn VerticalDilutionOfPrecision(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IReference<f64>> {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "Foundation")]
    pub fn GeometricDilutionOfPrecision(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IReference<f64>> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn TimeDilutionOfPrecision(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IReference<f64>> {
        let this = &::windows::runtime::Interface::cast::<IGeocoordinateSatelliteData2>(self)?;
        unsafe {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for GeocoordinateSatelliteData
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GeocoordinateSatelliteData
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for GeolocationAccessStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.GeolocationAccessStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl Geolocator {
    ...
    pub fn DesiredAccuracy(&self) -> ::windows::runtime::Result<PositionAccuracy> {
        ...
        unsafe {
            ...
            .from_abi::<PositionAccuracy>(result__)
        }
    }
    ...
    pub fn LocationStatus(&self) -> ::windows::runtime::Result<PositionStatus> {
        ...
        unsafe {
            ...
            .from_abi::<PositionStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetGeopositionAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<Geoposition>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).13)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<Geoposition>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetGeopositionAsyncWithAgeAndTimeout<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn PositionChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<Geolocator, PositionChangedEventArgs>,
        >,
    >(
        &self,
        handler: Param0,
    ...
    pub fn StatusChanged<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<Geolocator, StatusChangedEventArgs>,
        >,
    >(
        &self,
        handler: Param0,
    ...
    #[cfg(feature = "Foundation")]
    pub fn DesiredAccuracyInMeters(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetDesiredAccuracyInMeters<
        'a,
    ...
    pub fn RequestAccessAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<GeolocationAccessStatus>,
    > {
        Self::IGeolocatorStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<GeolocationAccessStatus>>(
                result__,
            )
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetGeopositionHistoryAsync<
        'a,
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<Geoposition>,
        >,
    > {
        Self::IGeolocatorStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetGeopositionHistoryWithDurationAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::DateTime>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::TimeSpan>,
    >(
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetDefaultGeoposition<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::IReference<BasicGeoposition>>,
    >(
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        Self::IGeolocatorStatics2(|this| unsafe {
    ...
    #[cfg(feature = "Foundation")]
    pub fn DefaultGeoposition(
    ) -> ::windows::runtime::Result<super::super::Foundation::IReference<BasicGeoposition>> {
        Self::IGeolocatorStatics2(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IReference<BasicGeoposition>>(result__)
        })
    }
    pub fn IGeolocatorStatics<
        R,
        F: FnOnce(&IGeolocatorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<Geolocator, IGeolocatorStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IGeolocatorStatics2<
        R,
        F: FnOnce(&IGeolocatorStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<Geolocator, IGeolocatorStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for Geolocator {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.Geolocator;{a9c3bf62-4524-4989-8aa9-de019d2e551f})",
    );
}
...
impl Geopath {
    ...
    pub fn IGeopathFactory<R, F: FnOnce(&IGeopathFactory) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<Geopath, IGeopathFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for Geopath {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.Geopath;{e53fd7b9-2da4-4714-a652-de8593289898})",
    );
}
...
impl Geopoint {
    ...
    pub fn IGeopointFactory<R, F: FnOnce(&IGeopointFactory) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<Geopoint, IGeopointFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for Geopoint {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.Geopoint;{6bfa00eb-e56e-49bb-9caf-cbaa78a8bcef})",
    );
}
unsafe impl ::windows::runtime::Interface for Geopoint {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        58734,
        18875,
        [156, 175, 203, 170, 120, 168, 188, 239],
    );
}
...
impl Geoposition {
    pub fn Coordinate(&self) -> ::windows::runtime::Result<Geocoordinate> {
        ...
        unsafe {
            ...
            .from_abi::<Geocoordinate>(result__)
        }
    }
    pub fn CivicAddress(&self) -> ::windows::runtime::Result<CivicAddress> {
        ...
        unsafe {
            ...
            .from_abi::<CivicAddress>(result__)
        }
    }
    pub fn VenueData(&self) -> ::windows::runtime::Result<VenueData> {
        ...
        unsafe {
            ...
            .from_abi::<VenueData>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for Geoposition {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.Geoposition;{c18d0454-7d41-4ff7-a957-9dffb4ef7f5b})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for GeoshapeType {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.GeoshapeType;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl Geovisit {
    ...
    pub fn StateChange(&self) -> ::windows::runtime::Result<VisitStateChange> {
        ...
        unsafe {
            ...
            .from_abi::<VisitStateChange>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Timestamp(&self) -> ::windows::runtime::Result<super::super::Foundation::DateTime> {
...
unsafe impl ::windows::runtime::RuntimeType for Geovisit {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.Geovisit;{b1877a76-9ef6-41ab-a0dd-793ece76e2de})",
    );
}
unsafe impl ::windows::runtime::Interface for Geovisit {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        40694,
        16811,
        [160, 221, 121, 62, 206, 118, 226, 222],
    );
}
...
impl GeovisitMonitor {
    ...
    pub fn MonitoringScope(&self) -> ::windows::runtime::Result<VisitMonitoringScope> {
        ...
        unsafe {
            ...
            .from_abi::<VisitMonitoringScope>(result__)
        }
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveVisitStateChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn GetLastReportAsync(
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<Geovisit>> {
        Self::IGeovisitMonitorStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<Geovisit>>(result__)
        })
    }
    pub fn IGeovisitMonitorStatics<
        R,
        F: FnOnce(&IGeovisitMonitorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for GeovisitMonitor {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.GeovisitMonitor;{80118aaf-5944-4591-83c1-396647f54f2c})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for GeovisitStateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GeovisitStateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl GeovisitTriggerDetails {
    ...
    pub fn ReadReports(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<Geovisit>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<Geovisit>>(result__)
        }
    }
}
...
pub struct IGeoboundingBoxStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        positions: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IGeocoordinateWithPositionSourceTimestamp {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        51697,
        17936,
        [175, 224, 139, 195, 166, 168, 112, 54],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IGeolocator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        maximumage: super::super::Foundation::TimeSpan,
...
unsafe impl ::windows::runtime::Interface for IGeolocatorStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        11765,
        17809,
        [159, 135, 235, 95, 216, 148, 233, 183],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IGeopathFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        51175,
        17241,
        [155, 155, 252, 163, 224, 94, 245, 147],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IGeoshape {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        50985,
        17345,
        [143, 171, 214, 222, 201, 20, 223, 126],
    );
}
impl IGeoshape {
    pub fn GeoshapeType(&self) -> ::windows::runtime::Result<GeoshapeType> {
...
unsafe impl ::windows::runtime::RuntimeType for IGeoshape {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{c99ca2af-c729-43c1-8fab-d6dec914df7e}");
}
...
pub struct IGeoshape_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AltitudeReferenceSystem,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IGeovisitMonitor_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut VisitMonitoringScope,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: VisitMonitoringScope,
    ) -> ::windows::runtime::HRESULT,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
...
unsafe impl ::windows::runtime::Interface for IPositionChangedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        40222,
        18117,
        [191, 59, 106, 216, 202, 193, 160, 147],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::RuntimeType for PositionAccuracy {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.PositionAccuracy;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PositionChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for PositionSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.PositionSource;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for PositionStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.PositionStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::RuntimeType for VenueData {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Geolocation.VenueData;{66f39187-60e3-4b2f-b527-4f53f1c3c677})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for VisitMonitoringScope {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.VisitMonitoringScope;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for VisitStateChange {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Geolocation.VisitStateChange;i4)",
    );
}
