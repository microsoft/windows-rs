...
pub struct IUsbBulkInPipe_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: UsbReadOptions,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UsbReadOptions,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IUsbBulkOutEndpointDescriptor {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        65518,
        20320,
        [155, 225, 149, 108, 172, 62, 203, 101],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IUsbBulkOutPipe_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: UsbWriteOptions,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UsbWriteOptions,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IUsbConfigurationDescriptorStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        parsed: *mut ::windows::runtime::RawPtr,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IUsbControlRequestType_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UsbTransferDirection,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: UsbTransferDirection,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UsbControlTransferType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UsbControlRecipient,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: UsbControlRecipient,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u8,
...
pub struct IUsbDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        setuppacket: ::windows::runtime::RawPtr,
        buffer: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IUsbDeviceStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        vendorid: u32,
        productid: u32,
        winusbinterfaceclass: ::windows::runtime::GUID,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        usbclass: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
...
pub struct IUsbSetupPacketFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        eightbytebuffer: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Storage_Streams"))] usize,
);
...
impl UsbBulkInEndpointDescriptor {
    ...
    pub fn Pipe(&self) -> ::windows::runtime::Result<UsbBulkInPipe> {
        ...
        unsafe {
            ...
            .from_abi::<UsbBulkInPipe>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UsbBulkInEndpointDescriptor
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl UsbBulkInPipe {
    ...
    pub fn EndpointDescriptor(&self) -> ::windows::runtime::Result<UsbBulkInEndpointDescriptor> {
        ...
        unsafe {
            ...
            .from_abi::<UsbBulkInEndpointDescriptor>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ClearStallAsync(
        &self,
    ...
    pub fn ReadOptions(&self) -> ::windows::runtime::Result<UsbReadOptions> {
        ...
        unsafe {
            ...
            .from_abi::<UsbReadOptions>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for UsbBulkInPipe {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbBulkInPipe;{f01d2d3b-4548-4d50-b326-d82cdabe1220})",
    );
}
...
impl UsbBulkOutEndpointDescriptor {
    ...
    pub fn Pipe(&self) -> ::windows::runtime::Result<UsbBulkOutPipe> {
        ...
        unsafe {
            ...
            .from_abi::<UsbBulkOutPipe>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for UsbBulkOutEndpointDescriptor
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UsbBulkOutEndpointDescriptor
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl UsbBulkOutPipe {
    pub fn EndpointDescriptor(&self) -> ::windows::runtime::Result<UsbBulkOutEndpointDescriptor> {
        ...
        unsafe {
            ...
            .from_abi::<UsbBulkOutEndpointDescriptor>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ClearStallAsync(
    ...
    pub fn WriteOptions(&self) -> ::windows::runtime::Result<UsbWriteOptions> {
        ...
        unsafe {
            ...
            .from_abi::<UsbWriteOptions>(result__)
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn OutputStream(
...
unsafe impl ::windows::runtime::RuntimeType for UsbBulkOutPipe {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbBulkOutPipe;{a8e9ee6e-0115-45aa-8b21-37b225bccee7})",
    );
}
...
impl UsbConfiguration {
    ...
    pub fn UsbInterfaces(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<UsbInterface>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<UsbInterface>>(result__)
        }
    }
    pub fn ConfigurationDescriptor(
        &self,
    ) -> ::windows::runtime::Result<UsbConfigurationDescriptor> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<UsbConfigurationDescriptor>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Descriptors(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<UsbDescriptor>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<UsbDescriptor>>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for UsbConfiguration {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbConfiguration;{68177429-36a9-46d7-b873-fc689251ec30})",
    );
}
...
impl UsbConfigurationDescriptor {
    ...
    pub fn TryParse<'a, Param0: ::windows::runtime::IntoParam<'a, UsbDescriptor>>(
        descriptor: Param0,
        parsed: &mut ::std::option::Option<UsbConfigurationDescriptor>,
    ...
    pub fn Parse<'a, Param0: ::windows::runtime::IntoParam<'a, UsbDescriptor>>(
        descriptor: Param0,
    ) -> ::windows::runtime::Result<UsbConfigurationDescriptor> {
        Self::IUsbConfigurationDescriptorStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn IUsbConfigurationDescriptorStatics<
        R,
        F: FnOnce(&IUsbConfigurationDescriptorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for UsbConfigurationDescriptor
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UsbConfigurationDescriptor
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl UsbControlRequestType {
    ...
    pub fn Direction(&self) -> ::windows::runtime::Result<UsbTransferDirection> {
        ...
        unsafe {
            ...
            .from_abi::<UsbTransferDirection>(result__)
        }
    }
    ...
    pub fn ControlTransferType(&self) -> ::windows::runtime::Result<UsbControlTransferType> {
        ...
        unsafe {
            ...
            .from_abi::<UsbControlTransferType>(result__)
        }
    }
    ...
    pub fn Recipient(&self) -> ::windows::runtime::Result<UsbControlRecipient> {
        ...
        unsafe {
            ...
            .from_abi::<UsbControlRecipient>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for UsbDescriptor {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbDescriptor;{0a89f216-5f9d-4874-8904-da9ad3f5528f})",
    );
}
...
impl UsbDevice {
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn SendControlOutTransferAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, UsbSetupPacket>,
    ...
    #[cfg(feature = "Foundation")]
    pub fn SendControlOutTransferAsyncNoBuffer<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, UsbSetupPacket>,
    >(
        &self,
    ...
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn SendControlInTransferAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, UsbSetupPacket>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IBuffer>,
    >(
    ...
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn SendControlInTransferAsyncNoBuffer<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, UsbSetupPacket>,
    >(
        &self,
    ...
    pub fn DefaultInterface(&self) -> ::windows::runtime::Result<UsbInterface> {
        ...
        unsafe {
            ...
            .from_abi::<UsbInterface>(result__)
        }
    }
    pub fn DeviceDescriptor(&self) -> ::windows::runtime::Result<UsbDeviceDescriptor> {
        ...
        unsafe {
            ...
            .from_abi::<UsbDeviceDescriptor>(result__)
        }
    }
    pub fn Configuration(&self) -> ::windows::runtime::Result<UsbConfiguration> {
        ...
        unsafe {
            ...
            .from_abi::<UsbConfiguration>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    >(
        ...
        Self::IUsbDeviceStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                vendorid,
                productid,
                winusbinterfaceclass.into_param().abi(),
                &mut result__,
            )
    ...
    pub fn GetDeviceClassSelector<'a, Param0: ::windows::runtime::IntoParam<'a, UsbDeviceClass>>(
        usbclass: Param0,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        Self::IUsbDeviceStatics(|this| unsafe {
            let mut result__: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING> =
    ...
    >(
        ...
        Self::IUsbDeviceStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<UsbDevice>>(result__)
        })
    }
    pub fn IUsbDeviceStatics<R, F: FnOnce(&IUsbDeviceStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<UsbDevice, IUsbDeviceStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for UsbDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbDevice;{5249b992-c456-44d5-ad5e-24f5a089f63b})",
    );
}
...
impl UsbDeviceClass {
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetSubclassCode<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::IReference<u8>>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
...
unsafe impl ::windows::runtime::RuntimeType for UsbDeviceClass {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbDeviceClass;{051942f9-845e-47eb-b12a-38f2f617afe7})",
    );
}
...
impl UsbDeviceClasses {
    pub fn CdcControl() -> ::windows::runtime::Result<UsbDeviceClass> {
        Self::IUsbDeviceClassesStatics(|this| unsafe {
            ...
            .from_abi::<UsbDeviceClass>(result__)
        })
    }
    ...
    pub fn IUsbDeviceClassesStatics<
        R,
        F: FnOnce(&IUsbDeviceClassesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for UsbDeviceClasses {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbDeviceClasses;{686f955d-9b92-4b30-9781-c22c55ac35cb})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for UsbDeviceDescriptor {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbDeviceDescriptor;{1f48d1f6-ba97-4322-b92c-b5b189216588})",
    );
}
...
impl UsbEndpointDescriptor {
    ...
    pub fn EndpointType(&self) -> ::windows::runtime::Result<UsbEndpointType> {
        ...
        unsafe {
            ...
            .from_abi::<UsbEndpointType>(result__)
        }
    }
    pub fn AsBulkInEndpointDescriptor(
        &self,
    ) -> ::windows::runtime::Result<UsbBulkInEndpointDescriptor> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
    ...
    pub fn AsInterruptInEndpointDescriptor(
        &self,
    ) -> ::windows::runtime::Result<UsbInterruptInEndpointDescriptor> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
            ...
            .from_abi::<UsbInterruptInEndpointDescriptor>(result__)
        }
    }
    pub fn AsBulkOutEndpointDescriptor(
        &self,
    ) -> ::windows::runtime::Result<UsbBulkOutEndpointDescriptor> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(
    ...
    pub fn AsInterruptOutEndpointDescriptor(
        &self,
    ) -> ::windows::runtime::Result<UsbInterruptOutEndpointDescriptor> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).12)(
            ...
            .from_abi::<UsbInterruptOutEndpointDescriptor>(result__)
        }
    }
    pub fn TryParse<'a, Param0: ::windows::runtime::IntoParam<'a, UsbDescriptor>>(
        descriptor: Param0,
        parsed: &mut ::std::option::Option<UsbEndpointDescriptor>,
    ) -> ::windows::runtime::Result<bool> {
    ...
    pub fn Parse<'a, Param0: ::windows::runtime::IntoParam<'a, UsbDescriptor>>(
        descriptor: Param0,
    ) -> ::windows::runtime::Result<UsbEndpointDescriptor> {
        Self::IUsbEndpointDescriptorStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<UsbEndpointDescriptor>(result__)
        })
    }
    pub fn IUsbEndpointDescriptorStatics<
        R,
        F: FnOnce(&IUsbEndpointDescriptorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for UsbEndpointType {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Usb.UsbEndpointType;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl UsbInterface {
    ...
    pub fn BulkInPipes(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<UsbBulkInPipe>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<UsbBulkInPipe>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn InterruptInPipes(
        ...
        super::super::Foundation::Collections::IVectorView<UsbInterruptInPipe>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<UsbInterruptInPipe>>(
                result__,
            )
        }
    }
    ...
    pub fn BulkOutPipes(
        ...
        super::super::Foundation::Collections::IVectorView<UsbBulkOutPipe>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<UsbBulkOutPipe>>(
                result__,
            )
        }
    }
    ...
    pub fn InterruptOutPipes(
        ...
        super::super::Foundation::Collections::IVectorView<UsbInterruptOutPipe>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<UsbInterruptOutPipe>>(
                result__,
            )
        }
    }
    ...
    pub fn InterfaceSettings(
        ...
        super::super::Foundation::Collections::IVectorView<UsbInterfaceSetting>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<UsbInterfaceSetting>>(
                result__,
            )
        }
    }
...
impl UsbInterfaceDescriptor {
    ...
    pub fn TryParse<'a, Param0: ::windows::runtime::IntoParam<'a, UsbDescriptor>>(
        descriptor: Param0,
        parsed: &mut ::std::option::Option<UsbInterfaceDescriptor>,
    ) -> ::windows::runtime::Result<bool> {
    ...
    pub fn Parse<'a, Param0: ::windows::runtime::IntoParam<'a, UsbDescriptor>>(
        descriptor: Param0,
    ) -> ::windows::runtime::Result<UsbInterfaceDescriptor> {
        Self::IUsbInterfaceDescriptorStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<UsbInterfaceDescriptor>(result__)
        })
    }
    pub fn IUsbInterfaceDescriptorStatics<
        R,
        F: FnOnce(&IUsbInterfaceDescriptorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for UsbInterfaceDescriptor {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbInterfaceDescriptor;{199670c7-b7ee-4f90-8cd5-94a2e257598a})",
    );
}
...
impl UsbInterfaceSetting {
    ...
    pub fn BulkInEndpoints(
        ...
        super::super::Foundation::Collections::IVectorView<UsbBulkInEndpointDescriptor>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn InterruptInEndpoints(
        ...
        super::super::Foundation::Collections::IVectorView<UsbInterruptInEndpointDescriptor>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn BulkOutEndpoints(
        ...
        super::super::Foundation::Collections::IVectorView<UsbBulkOutEndpointDescriptor>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn InterruptOutEndpoints(
        ...
        super::super::Foundation::Collections::IVectorView<UsbInterruptOutEndpointDescriptor>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
unsafe impl ::windows::runtime::RuntimeType for UsbInterfaceSetting {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbInterfaceSetting;{1827bba7-8da7-4af7-8f4c-7f3032e781f5})",
    );
}
...
impl UsbInterruptInEndpointDescriptor {
    ...
    pub fn Pipe(&self) -> ::windows::runtime::Result<UsbInterruptInPipe> {
        ...
        unsafe {
            ...
            .from_abi::<UsbInterruptInPipe>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for UsbInterruptInEndpointDescriptor
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UsbInterruptInEndpointDescriptor
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for UsbInterruptInEventArgs {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbInterruptInEventArgs;{b7b04092-1418-4936-8209-299cf5605583})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for UsbInterruptInPipe {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbInterruptInPipe;{fa007116-84d7-48c7-8a3f-4c0b235f2ea6})",
    );
}
...
impl UsbInterruptOutEndpointDescriptor {
    ...
    pub fn Pipe(&self) -> ::windows::runtime::Result<UsbInterruptOutPipe> {
        ...
        unsafe {
            ...
            .from_abi::<UsbInterruptOutPipe>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for UsbInterruptOutEndpointDescriptor
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UsbInterruptOutEndpointDescriptor
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for UsbInterruptOutPipe {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbInterruptOutPipe;{e984c8a9-aaf9-49d0-b96c-f661ab4a7f95})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for UsbReadOptions {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.Usb.UsbReadOptions;u4)");
}
...
impl UsbSetupPacket {
    ...
    pub fn RequestType(&self) -> ::windows::runtime::Result<UsbControlRequestType> {
        ...
        unsafe {
            ...
            .from_abi::<UsbControlRequestType>(result__)
        }
    }
    pub fn SetRequestType<'a, Param0: ::windows::runtime::IntoParam<'a, UsbControlRequestType>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn CreateWithEightByteBuffer<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IBuffer>,
    >(
        eightbytebuffer: Param0,
    ) -> ::windows::runtime::Result<UsbSetupPacket> {
        Self::IUsbSetupPacketFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                eightbytebuffer.into_param().abi(),
                &mut result__,
            )
            .from_abi::<UsbSetupPacket>(result__)
        })
    }
    pub fn IUsbSetupPacketFactory<
        R,
        F: FnOnce(&IUsbSetupPacketFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for UsbSetupPacket {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Usb.UsbSetupPacket;{104ba132-c78f-4c51-b654-e49d02f2cb03})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for UsbWriteOptions {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Usb.UsbWriteOptions;u4)",
    );
}
