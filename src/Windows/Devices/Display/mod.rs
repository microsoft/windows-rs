...
impl DisplayMonitor {
    ...
    pub fn ConnectionKind(&self) -> ::windows::runtime::Result<DisplayMonitorConnectionKind> {
        ...
        unsafe {
            ...
            .from_abi::<DisplayMonitorConnectionKind>(result__)
        }
    }
    pub fn PhysicalConnector(
        &self,
    ) -> ::windows::runtime::Result<DisplayMonitorPhysicalConnectorKind> {
        let this = self;
        unsafe {
            ...
            .from_abi::<DisplayMonitorPhysicalConnectorKind>(result__)
        }
    }
    pub fn DisplayAdapterDeviceId(
        &self,
    ...
    pub fn UsageKind(&self) -> ::windows::runtime::Result<DisplayMonitorUsageKind> {
        ...
        unsafe {
            ...
            .from_abi::<DisplayMonitorUsageKind>(result__)
        }
    }
    #[cfg(feature = "Graphics")]
    pub fn NativeResolutionInRawPixels(
        &self,
    ) -> ::windows::runtime::Result<super::super::Graphics::SizeInt32> {
        let this = self;
        unsafe {
    ...
    pub fn PhysicalSizeInInches(
        ...
        super::super::Foundation::IReference<super::super::Foundation::Size>,
    > {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IReference<super::super::Foundation::Size>>(
                result__,
            )
        }
    }
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DisplayMonitor>> {
        Self::IDisplayMonitorStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DisplayMonitor>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn FromInterfaceIdAsync<
        ...
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        deviceinterfaceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DisplayMonitor>> {
        Self::IDisplayMonitorStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                deviceinterfaceid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<DisplayMonitor>>(result__)
        })
    ...
    pub fn IDisplayMonitorStatics<
        R,
        F: FnOnce(&IDisplayMonitorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for DisplayMonitor {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Display.DisplayMonitor;{1f6b15d4-1d01-4c51-87e2-6f954a772b59})",
    );
}
...
impl DisplayMonitorPhysicalConnectorKind {
    pub const Unknown: DisplayMonitorPhysicalConnectorKind =
        DisplayMonitorPhysicalConnectorKind(0i32);
    pub const HD15: DisplayMonitorPhysicalConnectorKind = DisplayMonitorPhysicalConnectorKind(1i32);
    pub const AnalogTV: DisplayMonitorPhysicalConnectorKind =
        DisplayMonitorPhysicalConnectorKind(2i32);
    ...
    pub const DisplayPort: DisplayMonitorPhysicalConnectorKind =
        DisplayMonitorPhysicalConnectorKind(7i32);
}
...
pub struct IDisplayMonitor_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DisplayMonitorConnectionKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DisplayMonitorPhysicalConnectorKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DisplayMonitorUsageKind,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Graphics")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IDisplayMonitorStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        41512,
        19461,
        [130, 29, 182, 149, 214, 103, 222, 142],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IDisplayMonitorStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        deviceinterfaceid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
