...
unsafe impl ::windows::runtime::Interface for IRadioStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        26571,
        18094,
        [170, 233, 101, 145, 159, 134, 239, 244],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl Radio {
    #[cfg(feature = "Foundation")]
    pub fn SetStateAsync(
        &self,
        value: RadioState,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<RadioAccessStatus>>
    {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<RadioAccessStatus>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn StateChanged<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<Radio, ::windows::runtime::IInspectable>,
        >,
    >(
        &self,
        handler: Param0,
    ...
    pub fn Kind(&self) -> ::windows::runtime::Result<RadioKind> {
        ...
        unsafe {
            ...
            .from_abi::<RadioKind>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetRadiosAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<Radio>,
        >,
    > {
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<Radio>> {
        Self::IRadioStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<Radio>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn IRadioStatics<R, F: FnOnce(&IRadioStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<Radio, IRadioStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for Radio {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Radios.Radio;{252118df-b33e-416a-875f-1cf38ae2d83e})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for RadioAccessStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Devices.Radios.RadioAccessStatus;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for RadioKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.Radios.RadioKind;i4)");
}
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
unsafe impl ::windows::runtime::RuntimeType for RadioState {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Devices.Radios.RadioState;i4)");
}
