...
impl Battery {
    ...
    pub fn GetReport(&self) -> ::windows::runtime::Result<BatteryReport> {
        ...
        unsafe {
            ...
            .from_abi::<BatteryReport>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ReportUpdated<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<Battery, ::windows::runtime::IInspectable>,
        >,
    >(
        &self,
        handler: Param0,
    ...
    >(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<Battery>> {
        Self::IBatteryStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<Battery>>(result__)
        })
    }
...
unsafe impl ::windows::runtime::RuntimeType for Battery {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Power.Battery;{bc894fc6-0072-47c8-8b5d-614aaa7a437e})",
    );
}
...
impl BatteryReport {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<super::super::System::Power::BatteryStatus> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::System::Power::BatteryStatus>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for BatteryReport {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Power.BatteryReport;{c9858c3a-4e13-420a-a8d0-24f18f395401})",
    );
}
...
pub struct IBatteryReport_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::System::Power::BatteryStatus,
    ) -> ::windows::runtime::HRESULT,
