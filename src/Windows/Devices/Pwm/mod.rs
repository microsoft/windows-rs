...
unsafe impl ::windows::runtime::Interface for IPwmControllerStatics2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        61721,
        19421,
        [151, 173, 247, 110, 249, 134, 115, 109],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IPwmControllerStatics3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        553,
        17220,
        [174, 63, 155, 124, 208, 230, 107, 148],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPwmPin_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PwmPulsePolarity,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: PwmPulsePolarity,
    ) -> ::windows::runtime::HRESULT,
...
impl PwmController {
    ...
    pub fn GetControllersAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Provider::IPwmProvider>,
    >(
        provider: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<PwmController>,
        >,
    > {
    ...
    pub fn GetDefaultAsync(
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<PwmController>> {
        Self::IPwmControllerStatics2(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<PwmController>>(result__)
        })
    }
    ...
    pub fn IPwmControllerStatics<
        R,
        F: FnOnce(&IPwmControllerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<PwmController, IPwmControllerStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IPwmControllerStatics2<
        R,
        F: FnOnce(&IPwmControllerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<PwmController, IPwmControllerStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IPwmControllerStatics3<
        R,
        F: FnOnce(&IPwmControllerStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<PwmController, IPwmControllerStatics3> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for PwmController {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Pwm.PwmController;{c45f5c85-d2e8-42cf-9bd6-cf5ed029e6a7})",
    );
}
...
impl PwmPin {
    pub fn Controller(&self) -> ::windows::runtime::Result<PwmController> {
        ...
        unsafe {
            ...
            .from_abi::<PwmController>(result__)
        }
    }
    ...
    pub fn Polarity(&self) -> ::windows::runtime::Result<PwmPulsePolarity> {
        ...
        unsafe {
            ...
            .from_abi::<PwmPulsePolarity>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for PwmPin {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Devices.Pwm.PwmPin;{22972dc8-c6cf-4821-b7f9-c6454fb6af79})",
    );
}
