...
impl IPwmControllerProvider {
    ...
    pub fn AcquirePin(&self, pin: i32) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).11)(::std::mem::transmute_copy(this), pin)
                .ok()
        }
    }
    pub fn ReleasePin(&self, pin: i32) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).12)(::std::mem::transmute_copy(this), pin)
                .ok()
        }
    }
    pub fn EnablePin(&self, pin: i32) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).13)(::std::mem::transmute_copy(this), pin)
                .ok()
        }
    }
    pub fn DisablePin(&self, pin: i32) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).14)(::std::mem::transmute_copy(this), pin)
                .ok()
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for IPwmControllerProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{1300593b-e2e3-40a4-b7d9-48dff0377a52}");
}
...
impl IPwmProvider {
    ...
    pub fn GetControllers(
        ...
        super::super::super::Foundation::Collections::IVectorView<IPwmControllerProvider>,
    > {
        let this = self;
        unsafe {
...
unsafe impl ::windows::runtime::RuntimeType for IPwmProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{a3301228-52f1-47b0-9349-66ba43d25902}");
}
