...
impl ::std::fmt::Debug for AccessListEntry {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("AccessListEntry")
...
impl AccessListEntryView {
    ...
    pub fn GetAt(&self, index: u32) -> ::windows::runtime::Result<AccessListEntry> {
        ...
        unsafe {
            ...
            .from_abi::<AccessListEntry>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn IndexOf<'a, Param0: ::windows::runtime::IntoParam<'a, AccessListEntry>>(
        &self,
        value: Param0,
        index: &mut u32,
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [<AccessListEntry as ::windows::runtime::Abi>::DefaultType],
    ...
    pub fn First(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IIterator<AccessListEntry>>
    {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IIterable<AccessListEntry>,
        >(self)?;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IIterator<AccessListEntry>>(result__)
        }
    }
}
#[cfg(feature = "Foundation_Collections")]
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::From<AccessListEntryView>
    for super::super::Foundation::Collections::IVectorView<AccessListEntry>
{
    fn from(value: AccessListEntryView) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
impl<'a>
    ::windows::runtime::IntoParam<
        'a,
        super::super::Foundation::Collections::IVectorView<AccessListEntry>,
    > for AccessListEntryView
{
    fn into_param(
        self,
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<AccessListEntryView>
    for super::super::Foundation::Collections::IIterable<AccessListEntry>
{
...
pub struct IItemRemovedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<AccessListEntry>,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IStorageItemAccessList(::windows::runtime::IInspectable);
unsafe impl ::windows::runtime::Interface for IStorageItemAccessList {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        56976,
        18421,
        [178, 195, 221, 54, 201, 253, 212, 83],
    );
}
impl IStorageItemAccessList {
    pub fn AddOverloadDefaultMetadata<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::IStorageItem>,
    >(
        &self,
        file: Param0,
    ...
    pub fn AddOrReplaceOverloadDefaultMetadata<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::IStorageItem>,
    >(
        &self,
        token: Param0,
        file: Param1,
    ...
    >(
        &self,
        token: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<super::IStorageItem>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<super::IStorageItem>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetFileAsync<
    ...
    >(
        &self,
        token: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<super::StorageFile>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<super::StorageFile>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    >(
        &self,
        token: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<super::StorageFolder>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<super::StorageFolder>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn CheckAccess<'a, Param0: ::windows::runtime::IntoParam<'a, super::IStorageItem>>(
        &self,
        file: Param0,
    ) -> ::windows::runtime::Result<bool> {
        let this = self;
    ...
    pub fn Entries(&self) -> ::windows::runtime::Result<AccessListEntryView> {
        ...
        unsafe {
            ...
            .from_abi::<AccessListEntryView>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for IStorageItemAccessList {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{2caff6ad-de90-47f5-b2c3-dd36c9fdd453}");
}
...
pub struct IStorageItemAccessList_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        file: ::windows::runtime::RawPtr,
        metadata: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        token: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        file: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl StorageApplicationPermissions {
    pub fn FutureAccessList() -> ::windows::runtime::Result<StorageItemAccessList> {
        Self::IStorageApplicationPermissionsStatics(|this| unsafe {
            ...
            .from_abi::<StorageItemAccessList>(result__)
        })
    }
    pub fn MostRecentlyUsedList() -> ::windows::runtime::Result<StorageItemMostRecentlyUsedList> {
        Self::IStorageApplicationPermissionsStatics(|this| unsafe {
            ...
            .from_abi::<StorageItemMostRecentlyUsedList>(result__)
        })
    }
    #[cfg(feature = "System")]
    pub fn GetFutureAccessListForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::System::User>,
    >(
        user: Param0,
    ) -> ::windows::runtime::Result<StorageItemAccessList> {
    ...
    #[cfg(feature = "System")]
    pub fn GetMostRecentlyUsedListForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::System::User>,
    >(
        user: Param0,
    ) -> ::windows::runtime::Result<StorageItemMostRecentlyUsedList> {
        Self::IStorageApplicationPermissionsStatics2(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn IStorageApplicationPermissionsStatics<
        R,
        F: FnOnce(&IStorageApplicationPermissionsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IStorageApplicationPermissionsStatics2<
        R,
        F: FnOnce(&IStorageApplicationPermissionsStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, IStorageItemAccessList> for &StorageItemAccessList {
    fn into_param(self) -> ::windows::runtime::Param<'a, IStorageItemAccessList> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IStorageItemAccessList>::into(
...
impl StorageItemMostRecentlyUsedList {
    ...
    pub fn AddWithMetadataAndVisibility<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::IStorageItem>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
    ...
    pub fn AddOrReplaceWithMetadataAndVisibility<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::IStorageItem>,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StorageItemMostRecentlyUsedList
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, IStorageItemAccessList>
    for StorageItemMostRecentlyUsedList
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IStorageItemAccessList> {
        ::windows::runtime::IntoParam::into_param(&self)
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IStorageItemAccessList> {
        ::std::convert::TryInto::<IStorageItemAccessList>::try_into(self)
