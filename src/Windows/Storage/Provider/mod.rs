...
impl CachedFileUpdater {
    ...
    pub fn ICachedFileUpdaterStatics<
        R,
        F: FnOnce(&ICachedFileUpdaterStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl CachedFileUpdaterUI {
    ...
    pub fn UpdateTarget(&self) -> ::windows::runtime::Result<CachedFileTarget> {
        ...
        unsafe {
            ...
            .from_abi::<CachedFileTarget>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn FileUpdateRequested<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveFileUpdateRequested<
        'a,
    ...
    pub fn UpdateRequest(&self) -> ::windows::runtime::Result<FileUpdateRequest> {
        ...
        unsafe {
            ...
            .from_abi::<FileUpdateRequest>(result__)
        }
    }
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<FileUpdateRequestDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<FileUpdateRequestDeferral>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for CachedFileUpdaterUI {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Storage.Provider.CachedFileUpdaterUI;{9e6f41e6-baf2-4a97-b600-9333f5df80fd})",
    );
}
...
impl FileUpdateRequest {
    ...
    pub fn File(&self) -> ::windows::runtime::Result<super::StorageFile> {
        ...
        unsafe {
            ...
            .from_abi::<super::StorageFile>(result__)
        }
    }
    pub fn Status(&self) -> ::windows::runtime::Result<FileUpdateStatus> {
        ...
        unsafe {
            ...
            .from_abi::<FileUpdateStatus>(result__)
        }
    }
    ...
    pub fn UpdateLocalFile<'a, Param0: ::windows::runtime::IntoParam<'a, super::IStorageFile>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for FileUpdateRequest {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Storage.Provider.FileUpdateRequest;{40c82536-c1fe-4d93-a792-1e736bc70837})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a FileUpdateRequestDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for FileUpdateRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a FileUpdateRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct ICachedFileUpdaterStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        contentid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        readmode: ReadActivationMode,
        writemode: WriteActivationMode,
        options: CachedFileOptions,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for ICachedFileUpdaterUI2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        34457,
        17216,
        [159, 73, 247, 202, 215, 254, 137, 145],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IFileUpdateRequest_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut FileUpdateStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: FileUpdateStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
...
pub struct IStorageProviderErrorCommandFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        actionuri: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
...
pub struct IStorageProviderFileTypeInfoFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        iconresource: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct IStorageProviderGetContentInfoForPathResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StorageProviderUriSourceStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IStorageProviderHandlerFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        64541,
        23214,
        [158, 35, 232, 101, 154, 34, 197, 246],
    );
}
impl IStorageProviderHandlerFactory {
    pub fn GetStatusSource<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
        syncrootid: Param0,
    ) -> ::windows::runtime::Result<IStorageProviderStatusSource> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<IStorageProviderStatusSource>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for IStorageProviderHandlerFactory {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{6154dc3a-fc1d-5aae-9e23-e8659a22c5f6}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IStorageProviderHandlerFactory
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IStorageProviderHandlerFactory
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IStorageProviderItemPropertiesStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        itemproperties: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IStorageProviderItemPropertySource {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63026,
        19099,
        [141, 153, 210, 215, 161, 29, 245, 106],
    );
}
impl IStorageProviderItemPropertySource {
    ...
    >(
        ...
        super::super::Foundation::Collections::IIterable<StorageProviderItemProperty>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
unsafe impl ::windows::runtime::RuntimeType for IStorageProviderItemPropertySource {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{8f6f9c3e-f632-4a9b-8d99-d2d7a11df56a}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IStorageProviderItemPropertySource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&IStorageProviderItemPropertySource>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IStorageProviderItemPropertySource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IStorageProviderItemPropertySource_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        itempath: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::RuntimeType for IStorageProviderPropertyCapabilities {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{658d2f0e-63b7-4567-acf9-51abe301dda5}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IStorageProviderPropertyCapabilities
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<IStorageProviderPropertyCapabilities>
    for ::windows::runtime::IInspectable
{
    fn from(value: IStorageProviderPropertyCapabilities) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IStorageProviderPropertyCapabilities
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IStorageProviderStatus_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StorageProviderState,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation_Collections")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IStorageProviderStatusFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        state: StorageProviderState,
        message: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        errormessages: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))] usize,
);
...
impl IStorageProviderStatusSource {
    pub fn GetStatus(&self) -> ::windows::runtime::Result<StorageProviderStatus> {
        ...
        unsafe {
            ...
            .from_abi::<StorageProviderStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Changed<
...
unsafe impl ::windows::runtime::RuntimeType for IStorageProviderStatusSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{2e316bb2-fd43-5335-b3c4-a962ee31d17e}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IStorageProviderStatusSource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IStorageProviderStatusSource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IStorageProviderSyncRootInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StorageProviderHydrationPolicy,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StorageProviderHydrationPolicyModifier,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StorageProviderPopulationPolicy,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StorageProviderInSyncPolicy,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StorageProviderHardlinkPolicy,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StorageProviderProtectionMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IStorageProviderSyncRootManagerStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        36835,
        19264,
        [171, 199, 246, 252, 61, 116, 201, 142],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IStorageProviderSyncRootManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        syncrootinformation: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        id: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
unsafe impl ::windows::runtime::Interface for IStorageProviderSyncRootManagerStatics2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        4980,
        21582,
        [157, 241, 85, 152, 210, 233, 207, 221],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IStorageProviderUriSource {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        35808,
        18786,
        [139, 182, 13, 76, 46, 20, 212, 122],
    );
}
impl IStorageProviderUriSource {
    pub fn GetPathForContentUri<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, StorageProviderGetPathForContentUriResult>,
    >(
        &self,
        contenturi: Param0,
        result: Param1,
        ...
        unsafe {
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                contenturi.into_param().abi(),
                result.into_param().abi(),
            )
            .ok()
        }
    }
    pub fn GetContentInfoForPath<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, StorageProviderGetContentInfoForPathResult>,
    >(
        &self,
        path: Param0,
        result: Param1,
...
unsafe impl ::windows::runtime::RuntimeType for IStorageProviderUriSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{b29806d1-8be0-4962-8bb6-0d4c2e14d47a}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IStorageProviderUriSource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IStorageProviderUriSource_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        contenturi: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
impl StorageProviderError {
    ...
    pub fn PrimaryAction(&self) -> ::windows::runtime::Result<StorageProviderErrorCommand> {
        ...
        unsafe {
            ...
            .from_abi::<StorageProviderErrorCommand>(result__)
        }
    }
    pub fn SetPrimaryAction<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, StorageProviderErrorCommand>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    >(
        ...
        Self::IStorageProviderErrorFactory(|this| unsafe {
            ...
            .from_abi::<StorageProviderError>(result__)
        })
    }
    pub fn IStorageProviderErrorFactory<
        R,
        F: FnOnce(&IStorageProviderErrorFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for StorageProviderError {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Storage.Provider.StorageProviderError;{47f2780b-ef7f-5910-bf83-331d89256615})",
    );
}
...
impl StorageProviderErrorCommand {
    ...
    pub fn CreateInstance<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
    >(
        label: Param0,
        actionuri: Param1,
    ) -> ::windows::runtime::Result<StorageProviderErrorCommand> {
    ...
    pub fn IStorageProviderErrorCommandFactory<
        R,
        F: FnOnce(&IStorageProviderErrorCommandFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for StorageProviderErrorCommand
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StorageProviderErrorCommand
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
    ...
    >(
        ...
        Self::IStorageProviderFileTypeInfoFactory(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                iconresource.into_param().abi(),
                &mut result__,
            )
            .from_abi::<StorageProviderFileTypeInfo>(result__)
        })
    }
    pub fn IStorageProviderFileTypeInfoFactory<
        R,
        F: FnOnce(&IStorageProviderFileTypeInfoFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StorageProviderFileTypeInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl StorageProviderGetContentInfoForPathResult {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<StorageProviderUriSourceStatus> {
        ...
        unsafe {
            ...
            .from_abi::<StorageProviderUriSourceStatus>(result__)
        }
    }
    pub fn SetStatus(
        &self,
...
impl ::std::convert::From<StorageProviderGetContentInfoForPathResult>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StorageProviderGetContentInfoForPathResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl StorageProviderGetPathForContentUriResult {
    ...
    pub fn SetPath<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl ::std::convert::From<StorageProviderGetPathForContentUriResult>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for StorageProviderGetPathForContentUriResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StorageProviderGetPathForContentUriResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl StorageProviderHydrationPolicyModifier {
    pub const None: StorageProviderHydrationPolicyModifier =
        StorageProviderHydrationPolicyModifier(0u32);
    pub const ValidationRequired: StorageProviderHydrationPolicyModifier =
        StorageProviderHydrationPolicyModifier(1u32);
    pub const StreamingAllowed: StorageProviderHydrationPolicyModifier =
        StorageProviderHydrationPolicyModifier(2u32);
    pub const AutoDehydrationAllowed: StorageProviderHydrationPolicyModifier =
        StorageProviderHydrationPolicyModifier(4u32);
    pub const AllowFullRestartHydration: StorageProviderHydrationPolicyModifier =
        StorageProviderHydrationPolicyModifier(8u32);
}
...
impl StorageProviderInSyncPolicy {
    ...
    pub const FileReadOnlyAttribute: StorageProviderInSyncPolicy =
        StorageProviderInSyncPolicy(2u32);
    ...
    pub const DirectoryCreationTime: StorageProviderInSyncPolicy =
        StorageProviderInSyncPolicy(16u32);
    pub const DirectoryReadOnlyAttribute: StorageProviderInSyncPolicy =
        StorageProviderInSyncPolicy(32u32);
    pub const DirectoryHiddenAttribute: StorageProviderInSyncPolicy =
        StorageProviderInSyncPolicy(64u32);
    pub const DirectorySystemAttribute: StorageProviderInSyncPolicy =
        StorageProviderInSyncPolicy(128u32);
    pub const FileLastWriteTime: StorageProviderInSyncPolicy = StorageProviderInSyncPolicy(256u32);
    pub const DirectoryLastWriteTime: StorageProviderInSyncPolicy =
        StorageProviderInSyncPolicy(512u32);
    pub const PreserveInsyncForSyncEngine: StorageProviderInSyncPolicy =
        StorageProviderInSyncPolicy(2147483648u32);
}
    ...
    >(
        ...
        Self::IStorageProviderItemPropertiesStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                item.into_param().abi(),
                itemproperties.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncAction>(result__)
        })
    }
    pub fn IStorageProviderItemPropertiesStatics<
        R,
        F: FnOnce(&IStorageProviderItemPropertiesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for StorageProviderItemProperty
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StorageProviderItemProperty
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for StorageProviderItemPropertyDefinition
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<StorageProviderItemPropertyDefinition>
    for ::windows::runtime::IInspectable
{
    fn from(value: StorageProviderItemPropertyDefinition) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StorageProviderItemPropertyDefinition
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl StorageProviderStatus {
    ...
    pub fn State(&self) -> ::windows::runtime::Result<StorageProviderState> {
        ...
        unsafe {
            ...
            .from_abi::<StorageProviderState>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn ErrorMessages(
        ...
        super::super::Foundation::Collections::IVectorView<StorageProviderError>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<StorageProviderError>>(
                result__,
            )
        }
    }
    ...
    >(
        state: StorageProviderState,
        message: Param1,
    ) -> ::windows::runtime::Result<StorageProviderStatus> {
    ...
    pub fn CreateInstance2<
        ...
        Param2: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<StorageProviderError>,
        >,
    >(
        state: StorageProviderState,
        message: Param1,
        errormessages: Param2,
    ) -> ::windows::runtime::Result<StorageProviderStatus> {
        Self::IStorageProviderStatusFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ...
                state,
                message.into_param().abi(),
                errormessages.into_param().abi(),
                &mut result__,
            )
            .from_abi::<StorageProviderStatus>(result__)
        })
    }
    pub fn IStorageProviderStatusFactory<
        R,
        F: FnOnce(&IStorageProviderStatusFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl StorageProviderSyncRootInfo {
    ...
    pub fn Context(&self) -> ::windows::runtime::Result<super::Streams::IBuffer> {
        ...
        unsafe {
            ...
            .from_abi::<super::Streams::IBuffer>(result__)
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn SetContext<'a, Param0: ::windows::runtime::IntoParam<'a, super::Streams::IBuffer>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn Path(&self) -> ::windows::runtime::Result<super::IStorageFolder> {
        ...
        unsafe {
            ...
            .from_abi::<super::IStorageFolder>(result__)
        }
    }
    pub fn SetPath<'a, Param0: ::windows::runtime::IntoParam<'a, super::IStorageFolder>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn HydrationPolicy(&self) -> ::windows::runtime::Result<StorageProviderHydrationPolicy> {
        ...
        unsafe {
            ...
            .from_abi::<StorageProviderHydrationPolicy>(result__)
        }
    }
    ...
    pub fn HydrationPolicyModifier(
        &self,
    ) -> ::windows::runtime::Result<StorageProviderHydrationPolicyModifier> {
        let this = self;
        unsafe {
            ...
            .from_abi::<StorageProviderHydrationPolicyModifier>(result__)
        }
    }
    ...
    pub fn PopulationPolicy(&self) -> ::windows::runtime::Result<StorageProviderPopulationPolicy> {
        ...
        unsafe {
            ...
            .from_abi::<StorageProviderPopulationPolicy>(result__)
        }
    }
    ...
    pub fn InSyncPolicy(&self) -> ::windows::runtime::Result<StorageProviderInSyncPolicy> {
        ...
        unsafe {
            ...
            .from_abi::<StorageProviderInSyncPolicy>(result__)
        }
    }
    pub fn SetInSyncPolicy(
        &self,
        value: StorageProviderInSyncPolicy,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn HardlinkPolicy(&self) -> ::windows::runtime::Result<StorageProviderHardlinkPolicy> {
        ...
        unsafe {
            ...
            .from_abi::<StorageProviderHardlinkPolicy>(result__)
        }
    }
    ...
    pub fn ProtectionMode(&self) -> ::windows::runtime::Result<StorageProviderProtectionMode> {
        ...
        unsafe {
            ...
            .from_abi::<StorageProviderProtectionMode>(result__)
        }
    }
    ...
    pub fn StorageProviderItemPropertyDefinitions(
        ...
        super::super::Foundation::Collections::IVector<StorageProviderItemPropertyDefinition>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn FallbackFileTypeInfo(
        ...
        super::super::Foundation::Collections::IVector<StorageProviderFileTypeInfo>,
    > {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StorageProviderSyncRootInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl StorageProviderSyncRootManager {
    pub fn Register<'a, Param0: ::windows::runtime::IntoParam<'a, StorageProviderSyncRootInfo>>(
        syncrootinformation: Param0,
    ) -> ::windows::runtime::Result<()> {
        Self::IStorageProviderSyncRootManagerStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                syncrootinformation.into_param().abi(),
            )
            .ok()
        })
    }
    ...
    pub fn GetSyncRootInformationForFolder<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::IStorageFolder>,
    >(
        folder: Param0,
    ) -> ::windows::runtime::Result<StorageProviderSyncRootInfo> {
        Self::IStorageProviderSyncRootManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<StorageProviderSyncRootInfo>(result__)
        })
    }
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetCurrentSyncRoots() -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<StorageProviderSyncRootInfo>,
    > {
        Self::IStorageProviderSyncRootManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
    ...
    pub fn IStorageProviderSyncRootManagerStatics<
        R,
        F: FnOnce(&IStorageProviderSyncRootManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IStorageProviderSyncRootManagerStatics2<
        R,
        F: FnOnce(&IStorageProviderSyncRootManagerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for UIStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Storage.Provider.UIStatus;i4)");
}
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
