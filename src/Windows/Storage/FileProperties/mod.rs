...
impl BasicProperties {
    ...
    pub fn RetrievePropertiesAsync<
        'a,
    ...
    >(
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                propertiestosave.into_param().abi(),
                &mut result__,
            )
...
impl<'a> ::windows::runtime::IntoParam<'a, IStorageItemExtraProperties> for &BasicProperties {
    fn into_param(self) -> ::windows::runtime::Param<'a, IStorageItemExtraProperties> {
        ::std::convert::TryInto::<IStorageItemExtraProperties>::try_into(self)
...
impl GeotagHelper {
    ...
    pub fn GetGeotagAsync<'a, Param0: ::windows::runtime::IntoParam<'a, super::IStorageFile>>(
        file: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<super::super::Devices::Geolocation::Geopoint>,
    > {
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn SetGeotagFromGeolocatorAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::IStorageFile>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geolocator>,
    >(
        file: Param0,
        geolocator: Param1,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncAction> {
    ...
    >(
        ...
        Self::IGeotagHelperStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                file.into_param().abi(),
                geopoint.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncAction>(result__)
        })
    }
    pub fn IGeotagHelperStatics<
        R,
        F: FnOnce(&IGeotagHelperStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<GeotagHelper, IGeotagHelperStatics> =
...
unsafe impl ::windows::runtime::Interface for IGeotagHelperStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        9508,
        18005,
        [134, 166, 237, 22, 245, 252, 113, 107],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IGeotagHelperStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        file: ::windows::runtime::RawPtr,
        geolocator: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Devices_Geolocation", feature = "Foundation")))] usize,
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        file: ::windows::runtime::RawPtr,
        geopoint: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Devices_Geolocation", feature = "Foundation")))] usize,
);
...
unsafe impl ::windows::runtime::RuntimeType for IStorageItemExtraProperties {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{c54361b2-54cd-432b-bdbc-4b19c4b470d7}");
}
impl ::std::convert::From<IStorageItemExtraProperties> for ::windows::runtime::IUnknown {
...
impl ::std::convert::From<IStorageItemExtraProperties> for ::windows::runtime::IInspectable {
    fn from(value: IStorageItemExtraProperties) -> Self {
        value.0
    }
}
...
pub struct IStorageItemExtraProperties_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        propertiestosave: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
    #[cfg(feature = "Foundation")]
...
impl MusicProperties {
    ...
    pub fn SetAlbum<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl StorageItemContentProperties {
    ...
    pub fn GetMusicPropertiesAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<MusicProperties>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<MusicProperties>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetVideoPropertiesAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<VideoProperties>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<VideoProperties>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetImagePropertiesAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<ImageProperties>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<ImageProperties>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDocumentPropertiesAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DocumentProperties>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DocumentProperties>>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn RetrievePropertiesAsync<
...
impl<'a> ::windows::runtime::IntoParam<'a, IStorageItemExtraProperties>
    for StorageItemContentProperties
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IStorageItemExtraProperties> {
        ::windows::runtime::IntoParam::into_param(&self)
...
impl StorageItemThumbnail {
    ...
    pub fn ContentType(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        let this =
            &::windows::runtime::Interface::cast::<super::Streams::IContentTypeProvider>(self)?;
        unsafe {
            let mut result__: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING> =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
    ...
    pub fn Size(&self) -> ::windows::runtime::Result<u64> {
        let this =
            &::windows::runtime::Interface::cast::<super::Streams::IRandomAccessStream>(self)?;
        unsafe {
            let mut result__: u64 = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn GetInputStreamAt(
        &self,
        position: u64,
    ) -> ::windows::runtime::Result<super::Streams::IInputStream> {
        let this =
            &::windows::runtime::Interface::cast::<super::Streams::IRandomAccessStream>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn GetOutputStreamAt(
        &self,
        position: u64,
    ) -> ::windows::runtime::Result<super::Streams::IOutputStream> {
        let this =
            &::windows::runtime::Interface::cast::<super::Streams::IRandomAccessStream>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
#[cfg(feature = "Storage_Streams")]
impl<'a> ::windows::runtime::IntoParam<'a, super::Streams::IRandomAccessStreamWithContentType>
    for StorageItemThumbnail
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::Streams::IRandomAccessStreamWithContentType> {
...
#[cfg(feature = "Storage_Streams")]
impl<'a> ::windows::runtime::IntoParam<'a, super::Streams::IContentTypeProvider>
    for StorageItemThumbnail
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Streams::IContentTypeProvider> {
        ::std::convert::TryInto::<super::Streams::IContentTypeProvider>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
#[cfg(feature = "Storage_Streams")]
impl<'a> ::windows::runtime::IntoParam<'a, super::Streams::IOutputStream>
    for &StorageItemThumbnail
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Streams::IOutputStream> {
...
#[cfg(feature = "Storage_Streams")]
impl<'a> ::windows::runtime::IntoParam<'a, super::Streams::IRandomAccessStream>
    for StorageItemThumbnail
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Streams::IRandomAccessStream> {
        ::std::convert::TryInto::<super::Streams::IRandomAccessStream>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
