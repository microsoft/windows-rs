...
impl FileOpenPickerUI {
    pub fn AddFile<
        ...
        Param1: ::windows::runtime::IntoParam<'a, super::super::IStorageFile>,
    >(
        &self,
        id: Param0,
        file: Param1,
    ) -> ::windows::runtime::Result<AddFileResult> {
        let this = self;
        unsafe {
            ...
            .from_abi::<AddFileResult>(result__)
        }
    }
    pub fn RemoveFile<
        'a,
    ...
    pub fn CanAddFile<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::IStorageFile>>(
        &self,
        file: Param0,
    ) -> ::windows::runtime::Result<bool> {
        let this = self;
    ...
    pub fn SelectionMode(&self) -> ::windows::runtime::Result<FileSelectionMode> {
        ...
        unsafe {
            ...
            .from_abi::<FileSelectionMode>(result__)
        }
    }
...
impl FileSavePickerUI {
    ...
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<SetFileNameResult> {
        let this = self;
        unsafe {
            ...
            .from_abi::<SetFileNameResult>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn FileNameChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveTargetFileRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
...
pub struct IFileOpenPickerUI_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut FileSelectionMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IFileSavePickerUI_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut SetFileNameResult,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IPickerClosingEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        45874,
        20242,
        [139, 159, 168, 194, 240, 107, 50, 205],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl PickerClosingEventArgs {
    pub fn ClosingOperation(&self) -> ::windows::runtime::Result<PickerClosingOperation> {
        ...
        unsafe {
            ...
            .from_abi::<PickerClosingOperation>(result__)
        }
    }
...
impl PickerClosingOperation {
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<PickerClosingDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<PickerClosingDeferral>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Deadline(
...
impl TargetFileRequest {
    pub fn TargetFile(&self) -> ::windows::runtime::Result<super::super::IStorageFile> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::IStorageFile>(result__)
        }
    }
    pub fn SetTargetFile<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::IStorageFile>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<TargetFileRequestDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<TargetFileRequestDeferral>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a TargetFileRequestDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl TargetFileRequestedEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<TargetFileRequest> {
        ...
        unsafe {
            ...
            .from_abi::<TargetFileRequest>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for TargetFileRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a TargetFileRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
