...
impl ClosedCaptionProperties {
    pub fn FontColor() -> ::windows::runtime::Result<ClosedCaptionColor> {
        Self::IClosedCaptionPropertiesStatics(|this| unsafe {
            ...
            .from_abi::<ClosedCaptionColor>(result__)
        })
    }
    #[cfg(feature = "UI")]
    ...
    pub fn FontOpacity() -> ::windows::runtime::Result<ClosedCaptionOpacity> {
        Self::IClosedCaptionPropertiesStatics(|this| unsafe {
            ...
            .from_abi::<ClosedCaptionOpacity>(result__)
        })
    }
    pub fn FontSize() -> ::windows::runtime::Result<ClosedCaptionSize> {
        Self::IClosedCaptionPropertiesStatics(|this| unsafe {
            ...
            .from_abi::<ClosedCaptionSize>(result__)
        })
    }
    pub fn FontStyle() -> ::windows::runtime::Result<ClosedCaptionStyle> {
        Self::IClosedCaptionPropertiesStatics(|this| unsafe {
            ...
            .from_abi::<ClosedCaptionStyle>(result__)
        })
    }
    pub fn FontEffect() -> ::windows::runtime::Result<ClosedCaptionEdgeEffect> {
        Self::IClosedCaptionPropertiesStatics(|this| unsafe {
            ...
            .from_abi::<ClosedCaptionEdgeEffect>(result__)
        })
    }
    ...
    pub fn IClosedCaptionPropertiesStatics<
        R,
        F: FnOnce(&IClosedCaptionPropertiesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
pub struct IClosedCaptionPropertiesStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ClosedCaptionColor,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "UI")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ClosedCaptionOpacity,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ClosedCaptionSize,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ClosedCaptionStyle,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ClosedCaptionEdgeEffect,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ClosedCaptionColor,
