...
unsafe impl ::windows::runtime::Interface for IVariablePhotoCapturedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        6995,
        20042,
        [139, 92, 219, 120, 135, 172, 148, 155],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IVariablePhotoSequenceCapture {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        798,
        16449,
        [166, 214, 189, 116, 36, 118, 168, 238],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl VariablePhotoCapturedEventArgs {
    pub fn Frame(&self) -> ::windows::runtime::Result<super::CapturedFrame> {
        ...
        unsafe {
            ...
            .from_abi::<super::CapturedFrame>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn CapturedFrameControlValues(
        &self,
    ) -> ::windows::runtime::Result<super::CapturedFrameControlValues> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::CapturedFrameControlValues>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for VariablePhotoCapturedEventArgs
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a VariablePhotoCapturedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a VariablePhotoSequenceCapture
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
