...
impl AudioMediaFrame {
    pub fn FrameReference(&self) -> ::windows::runtime::Result<MediaFrameReference> {
        ...
        unsafe {
            ...
            .from_abi::<MediaFrameReference>(result__)
        }
    }
    #[cfg(feature = "Media_MediaProperties")]
    pub fn AudioEncodingProperties(
        &self,
    ) -> ::windows::runtime::Result<super::super::MediaProperties::AudioEncodingProperties> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::MediaProperties::AudioEncodingProperties>(result__)
        }
    }
    pub fn GetAudioFrame(&self) -> ::windows::runtime::Result<super::super::AudioFrame> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::AudioFrame>(result__)
        }
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for BufferMediaFrame {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Capture.Frames.BufferMediaFrame;{b5b153c7-9b84-4062-b79c-a365b2596854})",
    );
}
...
impl DepthMediaFrame {
    ...
    pub fn VideoMediaFrame(&self) -> ::windows::runtime::Result<VideoMediaFrame> {
        ...
        unsafe {
            ...
            .from_abi::<VideoMediaFrame>(result__)
        }
    }
    pub fn DepthFormat(&self) -> ::windows::runtime::Result<DepthMediaFrameFormat> {
        ...
        unsafe {
            ...
            .from_abi::<DepthMediaFrameFormat>(result__)
        }
    }
    #[cfg(all(feature = "Media_Devices_Core", feature = "Perception_Spatial"))]
    pub fn TryCreateCoordinateMapper<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Core::CameraIntrinsics>,
    ...
    >(
        &self,
        cameraintrinsics: Param0,
        coordinatesystem: Param1,
    ) -> ::windows::runtime::Result<super::super::Devices::Core::DepthCorrelatedCoordinateMapper>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
                cameraintrinsics.into_param().abi(),
                coordinatesystem.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Devices::Core::DepthCorrelatedCoordinateMapper>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for DepthMediaFrame {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Capture.Frames.DepthMediaFrame;{47135e4f-8549-45c0-925b-80d35efdb10a})",
    );
}
...
impl DepthMediaFrameFormat {
    pub fn VideoFormat(&self) -> ::windows::runtime::Result<VideoMediaFrameFormat> {
        ...
        unsafe {
            ...
            .from_abi::<VideoMediaFrameFormat>(result__)
        }
    }
...
pub struct IDepthMediaFrame_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        cameraintrinsics: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IMediaFrameFormat2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        24199,
        19472,
        [134, 209, 109, 240, 151, 166, 198, 168],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IMediaFrameReader2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MediaFrameReaderAcquisitionMode,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IMediaFrameReference_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MediaFrameSourceKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IMediaFrameReference2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        54706,
        18927,
        [131, 106, 148, 125, 152, 155, 128, 193],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IMediaFrameSourceController_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        propertyid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        propertyid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        propertyvalue: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
...
unsafe impl ::windows::runtime::Interface for IMediaFrameSourceController2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        64754,
        18947,
        [180, 228, 172, 150, 40, 115, 155, 238],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IMediaFrameSourceController2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        extendedPropertyId_array_size: u32,
        extendedpropertyid: *const u8,
        maxpropertyvaluesize: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        ...
        extendedPropertyId_array_size: u32,
        extendedpropertyid: *const u8,
        propertyValue_array_size: u32,
        propertyvalue: *const u8,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
...
unsafe impl ::windows::runtime::Interface for IMediaFrameSourceGetPropertyResult {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        14948,
        19413,
        [189, 43, 231, 200, 152, 210, 243, 122],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IMediaFrameSourceGetPropertyResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MediaFrameSourceGetPropertyStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
...
pub struct IMediaFrameSourceInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::MediaStreamType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MediaFrameSourceKind,
...
pub struct IMediaFrameSourceInfo3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        displayregion: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::Devices::Enumeration::Panel,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IMultiSourceMediaFrameReader {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63331,
        18573,
        [152, 242, 180, 55, 188, 240, 117, 231],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IMultiSourceMediaFrameReference_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        sourceid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MediaFrameArrivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MediaFrameArrivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for MediaFrameFormat {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Capture.Frames.MediaFrameFormat;{71902b4e-b279-4a97-a9db-bd5a2fb78f39})",
    );
}
...
impl MediaFrameReader {
    ...
    pub fn StartAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<MediaFrameReaderStartStatus>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn AcquisitionMode(&self) -> ::windows::runtime::Result<MediaFrameReaderAcquisitionMode> {
        ...
        unsafe {
            ...
            .from_abi::<MediaFrameReaderAcquisitionMode>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for MediaFrameReader {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Capture.Frames.MediaFrameReader;{e4c94395-2028-48ed-90b0-d1c1b162e24c})",
    );
}
...
impl MediaFrameReaderStartStatus {
    ...
    pub const OutputFormatNotSupported: MediaFrameReaderStartStatus =
        MediaFrameReaderStartStatus(3i32);
    pub const ExclusiveControlNotAvailable: MediaFrameReaderStartStatus =
        MediaFrameReaderStartStatus(4i32);
}
...
impl MediaFrameReference {
    ...
    pub fn SourceKind(&self) -> ::windows::runtime::Result<MediaFrameSourceKind> {
        ...
        unsafe {
            ...
            .from_abi::<MediaFrameSourceKind>(result__)
        }
    }
    pub fn Format(&self) -> ::windows::runtime::Result<MediaFrameFormat> {
        ...
        unsafe {
            ...
            .from_abi::<MediaFrameFormat>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn BufferMediaFrame(&self) -> ::windows::runtime::Result<BufferMediaFrame> {
        ...
        unsafe {
            ...
            .from_abi::<BufferMediaFrame>(result__)
        }
    }
    pub fn VideoMediaFrame(&self) -> ::windows::runtime::Result<VideoMediaFrame> {
        let this = self;
    ...
    pub fn CoordinateSystem(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Perception::Spatial::SpatialCoordinateSystem>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Perception::Spatial::SpatialCoordinateSystem>(result__)
        }
    }
    pub fn AudioMediaFrame(&self) -> ::windows::runtime::Result<AudioMediaFrame> {
        ...
        unsafe {
            ...
            .from_abi::<AudioMediaFrame>(result__)
        }
    }
}
...
impl MediaFrameSource {
    pub fn Info(&self) -> ::windows::runtime::Result<MediaFrameSourceInfo> {
        ...
        unsafe {
            ...
            .from_abi::<MediaFrameSourceInfo>(result__)
        }
    }
    pub fn Controller(&self) -> ::windows::runtime::Result<MediaFrameSourceController> {
        ...
        unsafe {
            ...
            .from_abi::<MediaFrameSourceController>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn SupportedFormats(
        ...
        super::super::super::Foundation::Collections::IVectorView<MediaFrameFormat>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetFormatAsync<'a, Param0: ::windows::runtime::IntoParam<'a, MediaFrameFormat>>(
        &self,
        format: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncAction> {
        let this = self;
    ...
    #[cfg(feature = "Media_Devices_Core")]
    pub fn TryGetCameraIntrinsics<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, MediaFrameFormat>,
    >(
        &self,
        format: Param0,
    ) -> ::windows::runtime::Result<super::super::Devices::Core::CameraIntrinsics> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).13)(
            ...
            .from_abi::<super::super::Devices::Core::CameraIntrinsics>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for MediaFrameSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Capture.Frames.MediaFrameSource;{d6782953-90db-46a8-8add-2aa884a8d253})",
    );
}
...
impl MediaFrameSourceController {
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<MediaFrameSourceGetPropertyResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<MediaFrameSourceSetPropertyStatus>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn VideoDeviceController(
        &self,
    ) -> ::windows::runtime::Result<super::super::Devices::VideoDeviceController> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::Devices::VideoDeviceController>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetPropertyByExtendedIdAsync<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::IReference<u32>>,
    >(
        &self,
        extendedpropertyid: &[<u8 as ::windows::runtime::Abi>::DefaultType],
        maxpropertyvaluesize: Param1,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<MediaFrameSourceGetPropertyResult>,
    > {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                extendedpropertyid.len() as u32,
                ::std::mem::transmute(extendedpropertyid.as_ptr()),
                maxpropertyvaluesize.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<
                MediaFrameSourceGetPropertyResult,
    ...
    pub fn SetPropertyByExtendedIdAsync(
        &self,
        extendedpropertyid: &[<u8 as ::windows::runtime::Abi>::DefaultType],
        propertyvalue: &[<u8 as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<MediaFrameSourceSetPropertyStatus>,
    > {
        let this = &::windows::runtime::Interface::cast::<IMediaFrameSourceController2>(self)?;
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ...
                extendedpropertyid.len() as u32,
                ::std::mem::transmute(extendedpropertyid.as_ptr()),
                propertyvalue.len() as u32,
                ::std::mem::transmute(propertyvalue.as_ptr()),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<
                MediaFrameSourceSetPropertyStatus,
    ...
    pub fn AudioDeviceController(
        &self,
    ) -> ::windows::runtime::Result<super::super::Devices::AudioDeviceController> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Devices::AudioDeviceController>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MediaFrameSourceController
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MediaFrameSourceGetPropertyResult {
    pub fn Status(&self) -> ::windows::runtime::Result<MediaFrameSourceGetPropertyStatus> {
        ...
        unsafe {
            ...
            .from_abi::<MediaFrameSourceGetPropertyStatus>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MediaFrameSourceGetPropertyResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MediaFrameSourceGetPropertyResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MediaFrameSourceGetPropertyStatus {
    ...
    pub const UnknownFailure: MediaFrameSourceGetPropertyStatus =
        MediaFrameSourceGetPropertyStatus(1i32);
    pub const NotSupported: MediaFrameSourceGetPropertyStatus =
        MediaFrameSourceGetPropertyStatus(2i32);
    pub const DeviceNotAvailable: MediaFrameSourceGetPropertyStatus =
        MediaFrameSourceGetPropertyStatus(3i32);
    pub const MaxPropertyValueSizeTooSmall: MediaFrameSourceGetPropertyStatus =
        MediaFrameSourceGetPropertyStatus(4i32);
    pub const MaxPropertyValueSizeRequired: MediaFrameSourceGetPropertyStatus =
        MediaFrameSourceGetPropertyStatus(5i32);
}
...
impl MediaFrameSourceGroup {
    ...
    pub fn SourceInfos(
        ...
        super::super::super::Foundation::Collections::IVectorView<MediaFrameSourceInfo>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn FindAllAsync() -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Foundation::Collections::IVectorView<MediaFrameSourceGroup>,
        >,
    > {
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<MediaFrameSourceGroup>,
    > {
        Self::IMediaFrameSourceGroupStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<MediaFrameSourceGroup>>(
                result__,
            )
        })
    }
    ...
    pub fn IMediaFrameSourceGroupStatics<
        R,
        F: FnOnce(&IMediaFrameSourceGroupStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl MediaFrameSourceInfo {
    ...
    pub fn MediaStreamType(&self) -> ::windows::runtime::Result<super::MediaStreamType> {
        ...
        unsafe {
            ...
            .from_abi::<super::MediaStreamType>(result__)
        }
    }
    pub fn SourceKind(&self) -> ::windows::runtime::Result<MediaFrameSourceKind> {
        let this = self;
    ...
    pub fn SourceGroup(&self) -> ::windows::runtime::Result<MediaFrameSourceGroup> {
        ...
        unsafe {
            ...
            .from_abi::<MediaFrameSourceGroup>(result__)
        }
    }
    #[cfg(feature = "Devices_Enumeration")]
    pub fn DeviceInformation(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Devices::Enumeration::DeviceInformation>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Devices::Enumeration::DeviceInformation>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Properties(
    ...
    pub fn VideoProfileMediaDescription(
        ...
        super::super::super::Foundation::Collections::IVectorView<
            super::MediaCaptureVideoProfileMediaDescription,
        >,
    > {
        let this = &::windows::runtime::Interface::cast::<IMediaFrameSourceInfo2>(self)?;
        unsafe {
    ...
    #[cfg(all(feature = "Devices_Enumeration", feature = "UI_WindowManagement"))]
    pub fn GetRelativePanel<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::UI::WindowManagement::DisplayRegion>,
    >(
        &self,
        displayregion: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Devices::Enumeration::Panel> {
        let this = &::windows::runtime::Interface::cast::<IMediaFrameSourceInfo3>(self)?;
        unsafe {
            let mut result__: super::super::super::Devices::Enumeration::Panel =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                displayregion.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Devices::Enumeration::Panel>(result__)
        }
    }
}
...
impl MediaFrameSourceSetPropertyStatus {
    ...
    pub const UnknownFailure: MediaFrameSourceSetPropertyStatus =
        MediaFrameSourceSetPropertyStatus(1i32);
    pub const NotSupported: MediaFrameSourceSetPropertyStatus =
        MediaFrameSourceSetPropertyStatus(2i32);
    pub const InvalidValue: MediaFrameSourceSetPropertyStatus =
        MediaFrameSourceSetPropertyStatus(3i32);
    pub const DeviceNotAvailable: MediaFrameSourceSetPropertyStatus =
        MediaFrameSourceSetPropertyStatus(4i32);
    pub const NotInControl: MediaFrameSourceSetPropertyStatus =
        MediaFrameSourceSetPropertyStatus(5i32);
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MultiSourceMediaFrameArrivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<MultiSourceMediaFrameArrivedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MultiSourceMediaFrameArrivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MultiSourceMediaFrameReader {
    ...
    pub fn TryAcquireLatestFrame(
        &self,
    ) -> ::windows::runtime::Result<MultiSourceMediaFrameReference> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<MultiSourceMediaFrameReference>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn StartAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<MultiSourceMediaFrameReaderStartStatus>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MultiSourceMediaFrameReader
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MultiSourceMediaFrameReader
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<MultiSourceMediaFrameReader>
...
impl MultiSourceMediaFrameReaderStartStatus {
    pub const Success: MultiSourceMediaFrameReaderStartStatus =
        MultiSourceMediaFrameReaderStartStatus(0i32);
    pub const NotSupported: MultiSourceMediaFrameReaderStartStatus =
        MultiSourceMediaFrameReaderStartStatus(1i32);
    pub const InsufficientResources: MultiSourceMediaFrameReaderStartStatus =
        MultiSourceMediaFrameReaderStartStatus(2i32);
    pub const DeviceNotAvailable: MultiSourceMediaFrameReaderStartStatus =
        MultiSourceMediaFrameReaderStartStatus(3i32);
    pub const UnknownFailure: MultiSourceMediaFrameReaderStartStatus =
        MultiSourceMediaFrameReaderStartStatus(4i32);
}
...
impl MultiSourceMediaFrameReference {
    ...
    >(
        &self,
        sourceid: Param0,
    ) -> ::windows::runtime::Result<MediaFrameReference> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                sourceid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<MediaFrameReference>(result__)
        }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MultiSourceMediaFrameReference
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<MultiSourceMediaFrameReference>
    for super::super::super::Foundation::IClosable
{
    type Error = ::windows::runtime::Error;
...
impl VideoMediaFrame {
    ...
    pub fn SoftwareBitmap(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Graphics::Imaging::SoftwareBitmap> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::super::Graphics::Imaging::SoftwareBitmap>(result__)
        }
    }
    #[cfg(feature = "Graphics_DirectX_Direct3D11")]
    pub fn Direct3DSurface(
        ...
        super::super::super::Graphics::DirectX::Direct3D11::IDirect3DSurface,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Graphics::DirectX::Direct3D11::IDirect3DSurface>(
                result__,
            )
        }
    }
    ...
    pub fn InfraredMediaFrame(&self) -> ::windows::runtime::Result<InfraredMediaFrame> {
        ...
        unsafe {
            ...
            .from_abi::<InfraredMediaFrame>(result__)
        }
    }
    pub fn DepthMediaFrame(&self) -> ::windows::runtime::Result<DepthMediaFrame> {
        ...
        unsafe {
            ...
            .from_abi::<DepthMediaFrame>(result__)
        }
    }
    pub fn GetVideoFrame(&self) -> ::windows::runtime::Result<super::super::VideoFrame> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::VideoFrame>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for VideoMediaFrame {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Capture.Frames.VideoMediaFrame;{00dd4ccb-32bd-4fe1-a013-7cc13cf5dbcf})",
    );
}
