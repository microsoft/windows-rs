...
unsafe impl ::windows::runtime::Interface for IMediaTranscoder2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        13792,
        20228,
        [133, 116, 202, 139, 196, 229, 160, 130],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IMediaTranscoder2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MediaVideoProcessingAlgorithm,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IPrepareTranscodeResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut TranscodeFailureReason,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl MediaTranscoder {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AddAudioEffectWithSettings<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AddVideoEffectWithSettings<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::Collections::IPropertySet>,
    >(
    ...
    pub fn PrepareFileTranscodeAsync<
        'a,
    ...
    >(
        ...
        destination: Param1,
        profile: Param2,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<PrepareTranscodeResult>>
    {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<PrepareTranscodeResult>>(result__)
        }
    }
    #[cfg(all(
        feature = "Foundation",
    ...
    pub fn PrepareStreamTranscodeAsync<
        'a,
    ...
    pub fn PrepareMediaStreamSourceTranscodeAsync<
        'a,
    ...
    pub fn VideoProcessingAlgorithm(
        &self,
    ) -> ::windows::runtime::Result<MediaVideoProcessingAlgorithm> {
        let this = &::windows::runtime::Interface::cast::<IMediaTranscoder2>(self)?;
        unsafe {
            ...
            .from_abi::<MediaVideoProcessingAlgorithm>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for MediaTranscoder {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Transcoding.MediaTranscoder;{190c99d2-a0aa-4d34-86bc-eed1b12c2f5b})",
    );
}
...
impl PrepareTranscodeResult {
    ...
    pub fn FailureReason(&self) -> ::windows::runtime::Result<TranscodeFailureReason> {
        ...
        unsafe {
            ...
            .from_abi::<TranscodeFailureReason>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn TranscodeAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncActionWithProgress<f64>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::Foundation::IAsyncActionWithProgress<f64>>(result__)
        }
    }
}
