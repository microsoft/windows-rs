...
unsafe impl ::windows::runtime::Interface for IInstalledVoicesStatic {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        30003,
        19519,
        [133, 190, 136, 140, 43, 174, 235, 220],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISpeechSynthesizer_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ssml: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    pub  unsafe extern "system" fn(
...
unsafe impl ::windows::runtime::Interface for ISpeechSynthesizerOptions3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        36908,
        18452,
        [165, 130, 165, 208, 192, 118, 159, 168],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct ISpeechSynthesizerOptions3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SpeechAppendedSilence,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: SpeechAppendedSilence,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SpeechPunctuationSilence,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl SpeechSynthesisStream {
    ...
    pub fn Markers(
        ...
        super::super::Foundation::Collections::IVectorView<super::IMediaMarker>,
    > {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<super::IMediaMarker>>(
                result__,
            )
        }
    }
    ...
    pub fn TimedMetadataTracks(
        ...
        super::super::Foundation::Collections::IVectorView<super::Core::TimedMetadataTrack>,
    > {
        let this =
            &::windows::runtime::Interface::cast::<super::Core::ITimedMetadataTrackProvider>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
...
#[cfg(feature = "Storage_Streams")]
impl ::std::convert::TryFrom<SpeechSynthesisStream>
...
#[cfg(feature = "Storage_Streams")]
impl ::std::convert::TryFrom<SpeechSynthesisStream>
    for super::super::Storage::Streams::IInputStream
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: SpeechSynthesisStream) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
#[cfg(feature = "Storage_Streams")]
impl ::std::convert::TryFrom<SpeechSynthesisStream>
    for super::super::Storage::Streams::IOutputStream
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: SpeechSynthesisStream) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
#[cfg(feature = "Media_Core")]
impl<'a> ::windows::runtime::IntoParam<'a, super::Core::ITimedMetadataTrackProvider>
    for SpeechSynthesisStream
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Core::ITimedMetadataTrackProvider> {
        ::std::convert::TryInto::<super::Core::ITimedMetadataTrackProvider>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl SpeechSynthesizer {
    ...
    >(
        &self,
        text: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<SpeechSynthesisStream>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<SpeechSynthesisStream>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn SetVoice<'a, Param0: ::windows::runtime::IntoParam<'a, VoiceInformation>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn Voice(&self) -> ::windows::runtime::Result<VoiceInformation> {
        ...
        unsafe {
            ...
            .from_abi::<VoiceInformation>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Close(&self) -> ::windows::runtime::Result<()> {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn AllVoices() -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<VoiceInformation>,
    > {
        Self::IInstalledVoicesStatic(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<VoiceInformation>>(
                result__,
            )
        })
    }
    ...
    pub fn Options(&self) -> ::windows::runtime::Result<SpeechSynthesizerOptions> {
        ...
        unsafe {
            ...
            .from_abi::<SpeechSynthesizerOptions>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn TrySetDefaultVoiceAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, VoiceInformation>,
    >(
        voice: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<bool>> {
        Self::IInstalledVoicesStatic2(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                voice.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<bool>>(result__)
        })
    }
    pub fn IInstalledVoicesStatic<
        R,
        F: FnOnce(&IInstalledVoicesStatic) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IInstalledVoicesStatic2<
        R,
        F: FnOnce(&IInstalledVoicesStatic2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl SpeechSynthesizerOptions {
    ...
    pub fn SetIncludeSentenceBoundaryMetadata(
        &self,
        value: bool,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn AppendedSilence(&self) -> ::windows::runtime::Result<SpeechAppendedSilence> {
        ...
        unsafe {
            ...
            .from_abi::<SpeechAppendedSilence>(result__)
        }
    }
    pub fn SetAppendedSilence(
        &self,
        value: SpeechAppendedSilence,
    ) -> ::windows::runtime::Result<()> {
        let this = &::windows::runtime::Interface::cast::<ISpeechSynthesizerOptions3>(self)?;
    ...
    pub fn PunctuationSilence(&self) -> ::windows::runtime::Result<SpeechPunctuationSilence> {
        ...
        unsafe {
            ...
            .from_abi::<SpeechPunctuationSilence>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpeechSynthesizerOptions
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
