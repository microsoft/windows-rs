...
impl AppBroadcastingMonitor {
    ...
    pub fn IsCurrentAppBroadcastingChanged<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveIsCurrentAppBroadcastingChanged<
        'a,
...
impl AppBroadcastingStatus {
    ...
    pub fn Details(&self) -> ::windows::runtime::Result<AppBroadcastingStatusDetails> {
        ...
        unsafe {
            ...
            .from_abi::<AppBroadcastingStatusDetails>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AppBroadcastingStatusDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppBroadcastingStatusDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AppBroadcastingUI {
    pub fn GetStatus(&self) -> ::windows::runtime::Result<AppBroadcastingStatus> {
        ...
        unsafe {
            ...
            .from_abi::<AppBroadcastingStatus>(result__)
        }
    }
    ...
    pub fn IAppBroadcastingUIStatics<
        R,
        F: FnOnce(&IAppBroadcastingUIStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
