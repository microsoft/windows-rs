...
impl DialApp {
    ...
    >(
        &self,
        appargument: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DialAppLaunchResult>>
    {
        let this = self;
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                appargument.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<DialAppLaunchResult>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn StopAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DialAppStopResult>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DialAppStopResult>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetAppStateAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DialAppStateDetails>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DialAppStateDetails>>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for DialApp {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.DialProtocol.DialApp;{555ffbd3-45b7-49f3-bbd7-302db6084646})",
    );
}
...
impl DialAppStateDetails {
    pub fn State(&self) -> ::windows::runtime::Result<DialAppState> {
        ...
        unsafe {
            ...
            .from_abi::<DialAppState>(result__)
        }
    }
...
impl DialDevice {
    ...
    >(
        &self,
        appname: Param0,
    ) -> ::windows::runtime::Result<DialApp> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    >(
        value: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DialDevice>> {
        Self::IDialDeviceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<DialDevice>>(result__)
        })
    }
    #[cfg(all(feature = "Devices_Enumeration", feature = "Foundation"))]
    pub fn DeviceInfoSupportsDialAsync<
        'a,
    ...
    pub fn IDialDeviceStatics<
        R,
        F: FnOnce(&IDialDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<DialDevice, IDialDeviceStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for DialDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.DialProtocol.DialDevice;{fff0edaf-759f-41d2-a20a-7f29ce0b3784})",
    );
}
...
impl DialDevicePicker {
    ...
    pub fn Filter(&self) -> ::windows::runtime::Result<DialDevicePickerFilter> {
        ...
        unsafe {
            ...
            .from_abi::<DialDevicePickerFilter>(result__)
        }
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDialDeviceSelected<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn DialDevicePickerDismissed<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDialDevicePickerDismissed<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn SetDisplayStatus<'a, Param0: ::windows::runtime::IntoParam<'a, DialDevice>>(
        &self,
        device: Param0,
...
unsafe impl ::windows::runtime::RuntimeType for DialDevicePicker {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.DialProtocol.DialDevicePicker;{ba7e520a-ff59-4f4b-bdac-d89f495ad6e1})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DialDeviceSelectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DialDeviceSelectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::Interface for DialDisconnectButtonClickedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        40065,
        20053,
        [173, 194, 14, 190, 153, 205, 227, 182],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DialDisconnectButtonClickedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<DialDisconnectButtonClickedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DialDisconnectButtonClickedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl DialReceiverApp {
    ...
    pub fn Current() -> ::windows::runtime::Result<DialReceiverApp> {
        Self::IDialReceiverAppStatics(|this| unsafe {
            ...
            .from_abi::<DialReceiverApp>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn IDialReceiverAppStatics<
        R,
        F: FnOnce(&IDialReceiverAppStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for DialReceiverApp {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.DialProtocol.DialReceiverApp;{fd3e7c57-5045-470e-b304-4dd9b13e7d11})",
    );
}
...
pub struct IDialApp_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appargument: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
pub struct IDialDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct IDialReceiverApp_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        additionaldata: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
);
