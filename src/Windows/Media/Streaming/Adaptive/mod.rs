...
impl AdaptiveMediaSource {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDownloadRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDownloadCompleted<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateFromUriAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
    >(
        uri: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<AdaptiveMediaSourceCreationResult>,
    > {
        Self::IAdaptiveMediaSourceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    pub fn CreateFromUriWithDownloaderAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Web::Http::HttpClient>,
    >(
        uri: Param0,
        httpclient: Param1,
    ) -> ::windows::runtime::Result<
    ...
    pub fn CreateFromStreamWithDownloaderAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Storage::Streams::IInputStream>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param3: ::windows::runtime::IntoParam<'a, super::super::super::Web::Http::HttpClient>,
    >(
        stream: Param0,
        uri: Param1,
        contenttype: Param2,
    ...
    pub fn AdvancedSettings(
        &self,
    ) -> ::windows::runtime::Result<AdaptiveMediaSourceAdvancedSettings> {
        ...
        unsafe {
            ...
            .from_abi::<AdaptiveMediaSourceAdvancedSettings>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetDesiredSeekableWindowSize<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::IReference<super::super::super::Foundation::TimeSpan>,
    ...
    pub fn Diagnostics(&self) -> ::windows::runtime::Result<AdaptiveMediaSourceDiagnostics> {
        ...
        unsafe {
            ...
            .from_abi::<AdaptiveMediaSourceDiagnostics>(result__)
        }
    }
    pub fn GetCorrelatedTimes(
        &self,
    ) -> ::windows::runtime::Result<AdaptiveMediaSourceCorrelatedTimes> {
        let this = &::windows::runtime::Interface::cast::<IAdaptiveMediaSource3>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(
            ...
            .from_abi::<AdaptiveMediaSourceCorrelatedTimes>(result__)
        }
    }
    pub fn IAdaptiveMediaSourceStatics<
        R,
        F: FnOnce(&IAdaptiveMediaSourceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
#[cfg(feature = "Media_Core")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Core::IMediaSource>
    for AdaptiveMediaSource
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::super::Core::IMediaSource> {
        ::std::convert::TryInto::<super::super::Core::IMediaSource>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl AdaptiveMediaSourceAdvancedSettings {
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetDesiredBitrateHeadroomRatio<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetBitrateDowngradeTriggerRatio<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::IReference<f64>>,
    >(
        &self,
...
impl ::std::convert::From<AdaptiveMediaSourceAdvancedSettings>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceAdvancedSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdaptiveMediaSourceCorrelatedTimes
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&AdaptiveMediaSourceCorrelatedTimes>
    for ::windows::runtime::IInspectable
{
    fn from(value: &AdaptiveMediaSourceCorrelatedTimes) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceCorrelatedTimes
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AdaptiveMediaSourceCreationResult {
    pub fn Status(&self) -> ::windows::runtime::Result<AdaptiveMediaSourceCreationStatus> {
        ...
        unsafe {
            ...
            .from_abi::<AdaptiveMediaSourceCreationStatus>(result__)
        }
    }
    pub fn MediaSource(&self) -> ::windows::runtime::Result<AdaptiveMediaSource> {
        ...
        unsafe {
            ...
            .from_abi::<AdaptiveMediaSource>(result__)
        }
    }
    ...
    pub fn ExtendedError(&self) -> ::windows::runtime::Result<::windows::runtime::HRESULT> {
        let this =
            &::windows::runtime::Interface::cast::<IAdaptiveMediaSourceCreationResult2>(self)?;
        unsafe {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdaptiveMediaSourceCreationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceCreationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AdaptiveMediaSourceCreationStatus {
    ...
    pub const ManifestDownloadFailure: AdaptiveMediaSourceCreationStatus =
        AdaptiveMediaSourceCreationStatus(1i32);
    pub const ManifestParseFailure: AdaptiveMediaSourceCreationStatus =
        AdaptiveMediaSourceCreationStatus(2i32);
    pub const UnsupportedManifestContentType: AdaptiveMediaSourceCreationStatus =
        AdaptiveMediaSourceCreationStatus(3i32);
    pub const UnsupportedManifestVersion: AdaptiveMediaSourceCreationStatus =
        AdaptiveMediaSourceCreationStatus(4i32);
    pub const UnsupportedManifestProfile: AdaptiveMediaSourceCreationStatus =
        AdaptiveMediaSourceCreationStatus(5i32);
    pub const UnknownFailure: AdaptiveMediaSourceCreationStatus =
        AdaptiveMediaSourceCreationStatus(6i32);
}
...
impl AdaptiveMediaSourceDiagnosticAvailableEventArgs {
    pub fn DiagnosticType(&self) -> ::windows::runtime::Result<AdaptiveMediaSourceDiagnosticType> {
        ...
        unsafe {
            ...
            .from_abi::<AdaptiveMediaSourceDiagnosticType>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn RequestId(
...
unsafe impl ::windows::runtime::Interface for AdaptiveMediaSourceDiagnosticAvailableEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        28060,
        18762,
        [183, 169, 179, 165, 222, 230, 173, 104],
    );
}
...
impl ::std::convert::From<AdaptiveMediaSourceDiagnosticAvailableEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceDiagnosticAvailableEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AdaptiveMediaSourceDiagnosticType {
    pub const ManifestUnchangedUponReload: AdaptiveMediaSourceDiagnosticType =
        AdaptiveMediaSourceDiagnosticType(0i32);
    pub const ManifestMismatchUponReload: AdaptiveMediaSourceDiagnosticType =
        AdaptiveMediaSourceDiagnosticType(1i32);
    pub const ManifestSignaledEndOfLiveEventUponReload: AdaptiveMediaSourceDiagnosticType =
        AdaptiveMediaSourceDiagnosticType(2i32);
    pub const MediaSegmentSkipped: AdaptiveMediaSourceDiagnosticType =
        AdaptiveMediaSourceDiagnosticType(3i32);
    pub const ResourceNotFound: AdaptiveMediaSourceDiagnosticType =
        AdaptiveMediaSourceDiagnosticType(4i32);
    pub const ResourceTimedOut: AdaptiveMediaSourceDiagnosticType =
        AdaptiveMediaSourceDiagnosticType(5i32);
    pub const ResourceParsingError: AdaptiveMediaSourceDiagnosticType =
        AdaptiveMediaSourceDiagnosticType(6i32);
    pub const BitrateDisabled: AdaptiveMediaSourceDiagnosticType =
        AdaptiveMediaSourceDiagnosticType(7i32);
    pub const FatalMediaSourceError: AdaptiveMediaSourceDiagnosticType =
        AdaptiveMediaSourceDiagnosticType(8i32);
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdaptiveMediaSourceDiagnostics
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceDiagnostics
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AdaptiveMediaSourceDownloadBitrateChangedEventArgs {
    ...
    pub fn Reason(
        &self,
    ) -> ::windows::runtime::Result<AdaptiveMediaSourceDownloadBitrateChangedReason> {
        let this = &::windows::runtime::Interface::cast::<
            IAdaptiveMediaSourceDownloadBitrateChangedEventArgs2,
        >(self)?;
        unsafe {
            let mut result__: AdaptiveMediaSourceDownloadBitrateChangedReason =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<AdaptiveMediaSourceDownloadBitrateChangedReason>(result__)
        }
    }
}
...
impl ::std::convert::From<AdaptiveMediaSourceDownloadBitrateChangedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdaptiveMediaSourceDownloadBitrateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceDownloadBitrateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AdaptiveMediaSourceDownloadBitrateChangedReason {
    pub const SufficientInboundBitsPerSecond: AdaptiveMediaSourceDownloadBitrateChangedReason =
        AdaptiveMediaSourceDownloadBitrateChangedReason(0i32);
    pub const InsufficientInboundBitsPerSecond: AdaptiveMediaSourceDownloadBitrateChangedReason =
        AdaptiveMediaSourceDownloadBitrateChangedReason(1i32);
    pub const LowBufferLevel: AdaptiveMediaSourceDownloadBitrateChangedReason =
        AdaptiveMediaSourceDownloadBitrateChangedReason(2i32);
    pub const PositionChanged: AdaptiveMediaSourceDownloadBitrateChangedReason =
        AdaptiveMediaSourceDownloadBitrateChangedReason(3i32);
    pub const TrackSelectionChanged: AdaptiveMediaSourceDownloadBitrateChangedReason =
        AdaptiveMediaSourceDownloadBitrateChangedReason(4i32);
    pub const DesiredBitratesChanged: AdaptiveMediaSourceDownloadBitrateChangedReason =
        AdaptiveMediaSourceDownloadBitrateChangedReason(5i32);
    pub const ErrorInPreviousBitrate: AdaptiveMediaSourceDownloadBitrateChangedReason =
        AdaptiveMediaSourceDownloadBitrateChangedReason(6i32);
}
...
impl AdaptiveMediaSourceDownloadCompletedEventArgs {
    pub fn ResourceType(&self) -> ::windows::runtime::Result<AdaptiveMediaSourceResourceType> {
        ...
        unsafe {
            ...
            .from_abi::<AdaptiveMediaSourceResourceType>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ResourceUri(&self) -> ::windows::runtime::Result<super::super::super::Foundation::Uri> {
    ...
    pub fn Statistics(&self) -> ::windows::runtime::Result<AdaptiveMediaSourceDownloadStatistics> {
        ...
        unsafe {
            ...
            .from_abi::<AdaptiveMediaSourceDownloadStatistics>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Position(
...
impl ::std::convert::From<AdaptiveMediaSourceDownloadCompletedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdaptiveMediaSourceDownloadCompletedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceDownloadCompletedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::Interface for AdaptiveMediaSourceDownloadFailedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        62635,
        16548,
        [177, 53, 198, 223, 216, 189, 127, 241],
    );
}
...
impl ::std::convert::From<AdaptiveMediaSourceDownloadFailedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceDownloadFailedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<AdaptiveMediaSourceDownloadRequestedDeferral>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceDownloadRequestedDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AdaptiveMediaSourceDownloadRequestedEventArgs {
    ...
    pub fn Result(&self) -> ::windows::runtime::Result<AdaptiveMediaSourceDownloadResult> {
        ...
        unsafe {
            ...
            .from_abi::<AdaptiveMediaSourceDownloadResult>(result__)
        }
    }
    pub fn GetDeferral(
        &self,
    ) -> ::windows::runtime::Result<AdaptiveMediaSourceDownloadRequestedDeferral> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(
            ...
            .from_abi::<AdaptiveMediaSourceDownloadRequestedDeferral>(result__)
        }
    }
    pub fn RequestId(&self) -> ::windows::runtime::Result<i32> {
        let this = &::windows::runtime::Interface::cast::<
...
impl ::std::convert::From<AdaptiveMediaSourceDownloadRequestedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdaptiveMediaSourceDownloadRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceDownloadRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AdaptiveMediaSourceDownloadResult {
    ...
    pub fn InputStream(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Storage::Streams::IInputStream> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::super::Storage::Streams::IInputStream>(result__)
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn SetInputStream<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Storage::Streams::IInputStream>,
    >(
        &self,
    ...
    pub fn ResourceByteRangeOffset(
        ...
        let this =
            &::windows::runtime::Interface::cast::<IAdaptiveMediaSourceDownloadResult2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetResourceByteRangeOffset<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetResourceByteRangeLength<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::IReference<u64>>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdaptiveMediaSourceDownloadResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceDownloadResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdaptiveMediaSourceDownloadStatistics
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<AdaptiveMediaSourceDownloadStatistics>
    for ::windows::runtime::IInspectable
{
    fn from(value: AdaptiveMediaSourceDownloadStatistics) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourceDownloadStatistics
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::Interface for AdaptiveMediaSourcePlaybackBitrateChangedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        32218,
        19025,
        [135, 169, 111, 168, 197, 178, 146, 190],
    );
}
...
impl ::std::convert::From<AdaptiveMediaSourcePlaybackBitrateChangedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdaptiveMediaSourcePlaybackBitrateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdaptiveMediaSourcePlaybackBitrateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AdaptiveMediaSourceResourceType {
    ...
    pub const InitializationSegment: AdaptiveMediaSourceResourceType =
        AdaptiveMediaSourceResourceType(1i32);
    ...
    pub const InitializationVector: AdaptiveMediaSourceResourceType =
        AdaptiveMediaSourceResourceType(4i32);
    pub const MediaSegmentIndex: AdaptiveMediaSourceResourceType =
        AdaptiveMediaSourceResourceType(5i32);
}
...
unsafe impl ::windows::runtime::Interface for IAdaptiveMediaSource2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        26464,
        19385,
        [165, 138, 247, 170, 152, 176, 140, 14],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IAdaptiveMediaSourceCreationResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AdaptiveMediaSourceCreationStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
...
pub struct IAdaptiveMediaSourceDiagnosticAvailableEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AdaptiveMediaSourceDiagnosticType,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IAdaptiveMediaSourceDiagnosticAvailableEventArgs3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        56043,
        16643,
        [132, 218, 104, 118, 154, 213, 19, 255],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IAdaptiveMediaSourceDownloadBitrateChangedEventArgs2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AdaptiveMediaSourceDownloadBitrateChangedReason,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IAdaptiveMediaSourceDownloadCompletedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AdaptiveMediaSourceResourceType,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IAdaptiveMediaSourceDownloadCompletedEventArgs3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        37810,
        18374,
        [186, 220, 139, 226, 200, 247, 246, 232],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IAdaptiveMediaSourceDownloadResult2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        31616,
        19140,
        [134, 96, 164, 185, 127, 124, 112, 240],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IAdaptiveMediaSourceStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        contenttype: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        uri: ::windows::runtime::RawPtr,
        httpclient: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
