...
pub struct IMiracastReceiver_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        transmitter: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IMiracastReceiverApplySettingsResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MiracastReceiverApplySettingsStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IMiracastReceiverConnectionCreatedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        12410,
        23567,
        [148, 189, 208, 198, 157, 22, 153, 130],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IMiracastReceiverCursorImageChannel_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::Graphics::PointInt32,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Graphics"))] usize,
...
pub struct IMiracastReceiverGameControllerDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MiracastReceiverGameControllerDeviceUsageMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IMiracastReceiverSessionStartResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MiracastReceiverSessionStartStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::HRESULT,
...
pub struct IMiracastReceiverSettings_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MiracastReceiverAuthorizationMethod,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IMiracastReceiverStatus_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MiracastReceiverListeningStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MiracastReceiverWiFiStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
...
pub struct IMiracastTransmitter_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MiracastTransmitterAuthorizationStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl MiracastReceiver {
    ...
    pub fn GetDefaultSettings(&self) -> ::windows::runtime::Result<MiracastReceiverSettings> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverSettings>(result__)
        }
    }
    ...
    pub fn GetCurrentSettingsAsync(
        ...
        super::super::Foundation::IAsyncOperation<MiracastReceiverSettings>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<MiracastReceiverSettings>>(
                result__,
            )
        }
    }
    pub fn DisconnectAllAndApplySettings<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, MiracastReceiverSettings>,
    >(
        &self,
        settings: Param0,
    ) -> ::windows::runtime::Result<MiracastReceiverApplySettingsResult> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<MiracastReceiverApplySettingsResult>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn DisconnectAllAndApplySettingsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, MiracastReceiverSettings>,
    >(
        &self,
        ...
        super::super::Foundation::IAsyncOperation<MiracastReceiverApplySettingsResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn GetStatus(&self) -> ::windows::runtime::Result<MiracastReceiverStatus> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetStatusAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<MiracastReceiverStatus>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<MiracastReceiverStatus>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn CreateSession<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::ApplicationModel::Core::CoreApplicationView,
        >,
    >(
        &self,
        view: Param0,
    ) -> ::windows::runtime::Result<MiracastReceiverSession> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<MiracastReceiverSession>(result__)
        }
    }
    #[cfg(all(feature = "ApplicationModel_Core", feature = "Foundation"))]
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<MiracastReceiverSession>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<MiracastReceiverSession>>(
                result__,
            )
        }
    }
    ...
    pub fn RemoveKnownTransmitter<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, MiracastTransmitter>,
    >(
        &self,
        transmitter: Param0,
    ) -> ::windows::runtime::Result<()> {
...
impl MiracastReceiverApplySettingsResult {
    pub fn Status(&self) -> ::windows::runtime::Result<MiracastReceiverApplySettingsStatus> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverApplySettingsStatus>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverApplySettingsResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<MiracastReceiverApplySettingsResult>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverApplySettingsResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverApplySettingsStatus {
    pub const Success: MiracastReceiverApplySettingsStatus =
        MiracastReceiverApplySettingsStatus(0i32);
    pub const UnknownFailure: MiracastReceiverApplySettingsStatus =
        MiracastReceiverApplySettingsStatus(1i32);
    pub const MiracastNotSupported: MiracastReceiverApplySettingsStatus =
        MiracastReceiverApplySettingsStatus(2i32);
    pub const AccessDenied: MiracastReceiverApplySettingsStatus =
        MiracastReceiverApplySettingsStatus(3i32);
    pub const FriendlyNameTooLong: MiracastReceiverApplySettingsStatus =
        MiracastReceiverApplySettingsStatus(4i32);
    pub const ModelNameTooLong: MiracastReceiverApplySettingsStatus =
        MiracastReceiverApplySettingsStatus(5i32);
    pub const ModelNumberTooLong: MiracastReceiverApplySettingsStatus =
        MiracastReceiverApplySettingsStatus(6i32);
    pub const InvalidSettings: MiracastReceiverApplySettingsStatus =
        MiracastReceiverApplySettingsStatus(7i32);
}
...
impl MiracastReceiverAuthorizationMethod {
    ...
    pub const ConfirmConnection: MiracastReceiverAuthorizationMethod =
        MiracastReceiverAuthorizationMethod(1i32);
    pub const PinDisplayIfRequested: MiracastReceiverAuthorizationMethod =
        MiracastReceiverAuthorizationMethod(2i32);
    pub const PinDisplayRequired: MiracastReceiverAuthorizationMethod =
        MiracastReceiverAuthorizationMethod(3i32);
}
...
impl MiracastReceiverConnection {
    ...
    pub fn Transmitter(&self) -> ::windows::runtime::Result<MiracastTransmitter> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastTransmitter>(result__)
        }
    }
    pub fn InputDevices(&self) -> ::windows::runtime::Result<MiracastReceiverInputDevices> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverInputDevices>(result__)
        }
    }
    pub fn CursorImageChannel(
        &self,
    ) -> ::windows::runtime::Result<MiracastReceiverCursorImageChannel> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).14)(
            ...
            .from_abi::<MiracastReceiverCursorImageChannel>(result__)
        }
    }
    pub fn StreamControl(&self) -> ::windows::runtime::Result<MiracastReceiverStreamControl> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverStreamControl>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverConnection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverConnection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverConnectionCreatedEventArgs {
    pub fn Connection(&self) -> ::windows::runtime::Result<MiracastReceiverConnection> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverConnection>(result__)
        }
    }
...
impl ::std::convert::From<MiracastReceiverConnectionCreatedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverConnectionCreatedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverConnectionCreatedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverCursorImageChannel {
    ...
    pub fn Position(&self) -> ::windows::runtime::Result<super::super::Graphics::PointInt32> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Graphics::PointInt32>(result__)
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn ImageStream(
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveImageStreamChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverCursorImageChannel
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&MiracastReceiverCursorImageChannel>
    for ::windows::runtime::IInspectable
{
    fn from(value: &MiracastReceiverCursorImageChannel) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverCursorImageChannel
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<MiracastReceiverCursorImageChannelSettings>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverCursorImageChannelSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverCursorImageChannelSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverDisconnectReason {
    ...
    pub const AppSpecificError: MiracastReceiverDisconnectReason =
        MiracastReceiverDisconnectReason(1i32);
    pub const ConnectionNotAccepted: MiracastReceiverDisconnectReason =
        MiracastReceiverDisconnectReason(2i32);
    pub const DisconnectedByUser: MiracastReceiverDisconnectReason =
        MiracastReceiverDisconnectReason(3i32);
    pub const FailedToStartStreaming: MiracastReceiverDisconnectReason =
        MiracastReceiverDisconnectReason(4i32);
    pub const MediaDecodingError: MiracastReceiverDisconnectReason =
        MiracastReceiverDisconnectReason(5i32);
    pub const MediaStreamingError: MiracastReceiverDisconnectReason =
        MiracastReceiverDisconnectReason(6i32);
    pub const MediaDecryptionError: MiracastReceiverDisconnectReason =
        MiracastReceiverDisconnectReason(7i32);
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverDisconnectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<MiracastReceiverDisconnectedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: MiracastReceiverDisconnectedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverDisconnectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverGameControllerDevice {
    ...
    pub fn Mode(
        &self,
    ) -> ::windows::runtime::Result<MiracastReceiverGameControllerDeviceUsageMode> {
        let this = self;
        unsafe {
            ...
            .from_abi::<MiracastReceiverGameControllerDeviceUsageMode>(result__)
        }
    }
    pub fn SetMode(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverGameControllerDevice
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<MiracastReceiverGameControllerDevice>
    for ::windows::runtime::IInspectable
{
    fn from(value: MiracastReceiverGameControllerDevice) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverGameControllerDevice
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverGameControllerDeviceUsageMode {
    pub const AsGameController: MiracastReceiverGameControllerDeviceUsageMode =
        MiracastReceiverGameControllerDeviceUsageMode(0i32);
    pub const AsMouseAndKeyboard: MiracastReceiverGameControllerDeviceUsageMode =
        MiracastReceiverGameControllerDeviceUsageMode(1i32);
}
...
impl MiracastReceiverInputDevices {
    pub fn Keyboard(&self) -> ::windows::runtime::Result<MiracastReceiverKeyboardDevice> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverKeyboardDevice>(result__)
        }
    }
    pub fn GameController(
        &self,
    ) -> ::windows::runtime::Result<MiracastReceiverGameControllerDevice> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<MiracastReceiverGameControllerDevice>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverInputDevices
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverInputDevices
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverKeyboardDevice
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverKeyboardDevice
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverListeningStatus {
    ...
    pub const ConnectionPending: MiracastReceiverListeningStatus =
        MiracastReceiverListeningStatus(2i32);
    pub const Connected: MiracastReceiverListeningStatus = MiracastReceiverListeningStatus(3i32);
    pub const DisabledByPolicy: MiracastReceiverListeningStatus =
        MiracastReceiverListeningStatus(4i32);
    pub const TemporarilyDisabled: MiracastReceiverListeningStatus =
        MiracastReceiverListeningStatus(5i32);
}
...
impl MiracastReceiverMediaSourceCreatedEventArgs {
    ...
    pub fn CursorImageChannelSettings(
        &self,
    ) -> ::windows::runtime::Result<MiracastReceiverCursorImageChannelSettings> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<MiracastReceiverCursorImageChannelSettings>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<super::super::Foundation::Deferral> {
...
impl ::std::convert::From<MiracastReceiverMediaSourceCreatedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverMediaSourceCreatedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverMediaSourceCreatedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverSession {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveConnectionCreated<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveMediaSourceCreated<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn Start(&self) -> ::windows::runtime::Result<MiracastReceiverSessionStartResult> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverSessionStartResult>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn StartAsync(
        ...
        super::super::Foundation::IAsyncOperation<MiracastReceiverSessionStartResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl MiracastReceiverSessionStartResult {
    pub fn Status(&self) -> ::windows::runtime::Result<MiracastReceiverSessionStartStatus> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverSessionStartStatus>(result__)
        }
    }
    pub fn ExtendedError(&self) -> ::windows::runtime::Result<::windows::runtime::HRESULT> {
        let this = self;
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverSessionStartResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&MiracastReceiverSessionStartResult>
    for ::windows::runtime::IInspectable
{
    fn from(value: &MiracastReceiverSessionStartResult) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverSessionStartResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverSessionStartStatus {
    pub const Success: MiracastReceiverSessionStartStatus =
        MiracastReceiverSessionStartStatus(0i32);
    pub const UnknownFailure: MiracastReceiverSessionStartStatus =
        MiracastReceiverSessionStartStatus(1i32);
    pub const MiracastNotSupported: MiracastReceiverSessionStartStatus =
        MiracastReceiverSessionStartStatus(2i32);
    pub const AccessDenied: MiracastReceiverSessionStartStatus =
        MiracastReceiverSessionStartStatus(3i32);
}
...
impl MiracastReceiverSettings {
    ...
    pub fn AuthorizationMethod(
        &self,
    ) -> ::windows::runtime::Result<MiracastReceiverAuthorizationMethod> {
        let this = self;
        unsafe {
            ...
            .from_abi::<MiracastReceiverAuthorizationMethod>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverStatus {
    pub fn ListeningStatus(&self) -> ::windows::runtime::Result<MiracastReceiverListeningStatus> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverListeningStatus>(result__)
        }
    }
    pub fn WiFiStatus(&self) -> ::windows::runtime::Result<MiracastReceiverWiFiStatus> {
        ...
        unsafe {
            ...
            .from_abi::<MiracastReceiverWiFiStatus>(result__)
        }
    }
    ...
    pub fn KnownTransmitters(
        ...
        super::super::Foundation::Collections::IVectorView<MiracastTransmitter>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<MiracastTransmitter>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for MiracastReceiverStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Miracast.MiracastReceiverStatus;{c28a5591-23ab-519e-ad09-90bff6dcc87e})",
    );
}
...
impl MiracastReceiverStreamControl {
    pub fn GetVideoStreamSettings(
        &self,
    ) -> ::windows::runtime::Result<MiracastReceiverVideoStreamSettings> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<MiracastReceiverVideoStreamSettings>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn GetVideoStreamSettingsAsync(
        ...
        super::super::Foundation::IAsyncOperation<MiracastReceiverVideoStreamSettings>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn SuggestVideoStreamSettings<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, MiracastReceiverVideoStreamSettings>,
    >(
        &self,
        settings: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn SuggestVideoStreamSettingsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, MiracastReceiverVideoStreamSettings>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MiracastReceiverStreamControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverStreamControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<MiracastReceiverVideoStreamSettings>
    for ::windows::runtime::IInspectable
{
    fn from(value: MiracastReceiverVideoStreamSettings) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MiracastReceiverVideoStreamSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MiracastReceiverWiFiStatus {
    pub const MiracastSupportUndetermined: MiracastReceiverWiFiStatus =
        MiracastReceiverWiFiStatus(0i32);
    pub const MiracastNotSupported: MiracastReceiverWiFiStatus = MiracastReceiverWiFiStatus(1i32);
    pub const MiracastSupportNotOptimized: MiracastReceiverWiFiStatus =
        MiracastReceiverWiFiStatus(2i32);
...
impl MiracastTransmitter {
    ...
    pub fn AuthorizationStatus(
        &self,
    ) -> ::windows::runtime::Result<MiracastTransmitterAuthorizationStatus> {
        let this = self;
        unsafe {
            ...
            .from_abi::<MiracastTransmitterAuthorizationStatus>(result__)
        }
    }
    ...
    pub fn GetConnections(
        ...
        super::super::Foundation::Collections::IVectorView<MiracastReceiverConnection>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
unsafe impl ::windows::runtime::RuntimeType for MiracastTransmitter {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Miracast.MiracastTransmitter;{342d79fd-2e64-5508-8a30-833d1eac70d0})",
    );
}
...
impl MiracastTransmitterAuthorizationStatus {
    pub const Undecided: MiracastTransmitterAuthorizationStatus =
        MiracastTransmitterAuthorizationStatus(0i32);
    pub const Allowed: MiracastTransmitterAuthorizationStatus =
        MiracastTransmitterAuthorizationStatus(1i32);
    pub const AlwaysPrompt: MiracastTransmitterAuthorizationStatus =
        MiracastTransmitterAuthorizationStatus(2i32);
    pub const Blocked: MiracastTransmitterAuthorizationStatus =
        MiracastTransmitterAuthorizationStatus(3i32);
}
