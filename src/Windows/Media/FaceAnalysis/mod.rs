...
impl DetectedFace {
    ...
    pub fn FaceBox(
        &self,
    ) -> ::windows::runtime::Result<super::super::Graphics::Imaging::BitmapBounds> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Graphics::Imaging::BitmapBounds>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for DetectedFace {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.FaceAnalysis.DetectedFace;{8200d454-66bc-34df-9410-e89400195414})",
    );
}
...
impl FaceDetector {
    ...
    pub fn DetectFacesAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Graphics::Imaging::SoftwareBitmap>,
    >(
        &self,
        image: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVector<DetectedFace>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn DetectFacesWithSearchAreaAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Graphics::Imaging::SoftwareBitmap>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Graphics::Imaging::BitmapBounds>,
    >(
        &self,
        image: Param0,
        searcharea: Param1,
    ...
    pub fn CreateAsync(
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<FaceDetector>> {
        Self::IFaceDetectorStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<FaceDetector>>(result__)
        })
    }
    #[cfg(all(feature = "Foundation_Collections", feature = "Graphics_Imaging"))]
    pub fn GetSupportedBitmapPixelFormats() -> ::windows::runtime::Result<
    ...
    pub fn IFaceDetectorStatics<
        R,
        F: FnOnce(&IFaceDetectorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<FaceDetector, IFaceDetectorStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for FaceDetector {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.FaceAnalysis.FaceDetector;{16b672dc-fe6f-3117-8d95-c3f04d51630c})",
    );
}
...
impl FaceTracker {
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateAsync(
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<FaceTracker>> {
        Self::IFaceTrackerStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<FaceTracker>>(result__)
        })
    }
    #[cfg(all(feature = "Foundation_Collections", feature = "Graphics_Imaging"))]
    pub fn GetSupportedBitmapPixelFormats() -> ::windows::runtime::Result<
    ...
    pub fn IFaceTrackerStatics<
        R,
        F: FnOnce(&IFaceTrackerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<FaceTracker, IFaceTrackerStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for FaceTracker {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.FaceAnalysis.FaceTracker;{6ba67d8c-a841-4420-93e6-2420a1884fcf})",
    );
}
...
pub struct IDetectedFace_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::Graphics::Imaging::BitmapBounds,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IFaceTracker_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        videoframe: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
