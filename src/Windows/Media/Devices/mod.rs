...
impl AdvancedPhotoCaptureSettings {
    ...
    pub fn Mode(&self) -> ::windows::runtime::Result<AdvancedPhotoMode> {
        ...
        unsafe {
            ...
            .from_abi::<AdvancedPhotoMode>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AdvancedPhotoCaptureSettings
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AdvancedPhotoCaptureSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl AdvancedPhotoControl {
    ...
    pub fn SupportedModes(
        ...
        super::super::Foundation::Collections::IVectorView<AdvancedPhotoMode>,
    > {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<AdvancedPhotoMode>>(
                result__,
            )
        }
    }
    ...
    pub fn Configure<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, AdvancedPhotoCaptureSettings>,
    >(
        &self,
        settings: Param0,
    ) -> ::windows::runtime::Result<()> {
...
unsafe impl ::windows::runtime::RuntimeType for AdvancedPhotoControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.AdvancedPhotoControl;{c5b15486-9001-4682-9309-68eae0080eec})",
    );
}
...
impl AudioDeviceController {
    ...
    pub fn GetMediaStreamProperties(
        &self,
        mediastreamtype: super::Capture::MediaStreamType,
    ) -> ::windows::runtime::Result<super::MediaProperties::IMediaEncodingProperties> {
        let this = &::windows::runtime::Interface::cast::<IMediaDeviceController>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::MediaProperties::IMediaEncodingProperties>(result__)
        }
    }
    #[cfg(all(
        feature = "Foundation",
    ...
    pub fn SetMediaStreamPropertiesAsync<
        'a,
...
unsafe impl ::windows::runtime::RuntimeType for AudioDeviceController {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.AudioDeviceController;{edd4a388-79c7-4f7c-90e8-ef934b21580a})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IMediaDeviceController> for &AudioDeviceController {
    fn into_param(self) -> ::windows::runtime::Param<'a, IMediaDeviceController> {
        ::std::convert::TryInto::<IMediaDeviceController>::try_into(self)
...
impl AudioDeviceModule {
    ...
    >(
        &self,
        command: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<ModuleCommandResult>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<ModuleCommandResult>>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for AudioDeviceModule {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.AudioDeviceModule;{86cfac36-47c1-4b33-9852-8773ec4be123})",
    );
}
...
impl AudioDeviceModuleNotificationEventArgs {
    pub fn Module(&self) -> ::windows::runtime::Result<AudioDeviceModule> {
        ...
        unsafe {
            ...
            .from_abi::<AudioDeviceModule>(result__)
        }
    }
...
impl ::std::convert::From<&AudioDeviceModuleNotificationEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AudioDeviceModuleNotificationEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AudioDeviceModulesManager {
    ...
    pub fn ModuleNotificationReceived<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveModuleNotificationReceived<
        'a,
    ...
    >(
        ...
        super::super::Foundation::Collections::IVectorView<AudioDeviceModule>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                moduleid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::Collections::IVectorView<AudioDeviceModule>>(
                result__,
            )
        }
    }
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        deviceid: Param0,
    ) -> ::windows::runtime::Result<AudioDeviceModulesManager> {
        Self::IAudioDeviceModulesManagerFactory(|this| unsafe {
            ...
            .from_abi::<AudioDeviceModulesManager>(result__)
        })
    }
    pub fn IAudioDeviceModulesManagerFactory<
        R,
        F: FnOnce(&IAudioDeviceModulesManagerFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AudioDeviceModulesManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CallControl {
    ...
    #[cfg(feature = "Foundation")]
    pub fn AnswerRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, CallControlEventHandler>,
    >(
        &self,
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn DialRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, DialRequestedEventHandler>,
    >(
        &self,
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RedialRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, RedialRequestedEventHandler>,
    >(
        &self,
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn KeypadPressed<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, KeypadPressedEventHandler>,
    >(
        &self,
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveAudioTransferRequested<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn ICallControlStatics<
        R,
        F: FnOnce(&ICallControlStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<CallControl, ICallControlStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for CallControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.CallControl;{a520d0d6-ae8d-45db-8011-ca49d3b3e578})",
    );
}
...
impl CallControlEventHandler {
    pub fn new<
        F: FnMut(&::std::option::Option<CallControl>) -> ::windows::runtime::Result<()> + 'static,
    >(
        invoke: F,
    ) -> Self {
    ...
    pub fn Invoke<'a, Param0: ::windows::runtime::IntoParam<'a, CallControl>>(
        &self,
        sender: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for CallControlEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({596f759f-50df-4454-bc63-4d3d01b61958})",
    );
}
...
#[repr(C)]
struct CallControlEventHandler_box<
    F: FnMut(&::std::option::Option<CallControl>) -> ::windows::runtime::Result<()> + 'static,
> {
...
impl<F: FnMut(&::std::option::Option<CallControl>) -> ::windows::runtime::Result<()> + 'static>
    CallControlEventHandler_box<F>
{
    const VTABLE: CallControlEventHandler_abi = CallControlEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid == &<CallControlEventHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&sender as *const <CallControl as ::windows::runtime::Abi>::Abi
                as *const <CallControl as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
impl CameraOcclusionInfo {
    pub fn GetState(&self) -> ::windows::runtime::Result<CameraOcclusionState> {
        ...
        unsafe {
            ...
            .from_abi::<CameraOcclusionState>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for CameraOcclusionInfo {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.CameraOcclusionInfo;{af6c4ad0-a84d-5db6-be58-a5da21cfe011})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for CameraOcclusionState {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.CameraOcclusionState;{430adeb8-6842-5e55-9bde-04b4ef3a8a57})",
    );
}
...
impl ::std::convert::From<CameraOcclusionStateChangedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: CameraOcclusionStateChangedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CameraOcclusionStateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for CaptureUse {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Media.Devices.CaptureUse;i4)");
}
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
impl DefaultAudioCaptureDeviceChangedEventArgs {
    ...
    pub fn Role(&self) -> ::windows::runtime::Result<AudioDeviceRole> {
        ...
        unsafe {
            ...
            .from_abi::<AudioDeviceRole>(result__)
        }
    }
}
...
impl ::std::convert::From<DefaultAudioCaptureDeviceChangedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DefaultAudioCaptureDeviceChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DefaultAudioCaptureDeviceChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<DefaultAudioCaptureDeviceChangedEventArgs>
    for IDefaultAudioDeviceChangedEventArgs
{
    fn from(value: DefaultAudioCaptureDeviceChangedEventArgs) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, IDefaultAudioDeviceChangedEventArgs>
    for DefaultAudioCaptureDeviceChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IDefaultAudioDeviceChangedEventArgs> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<IDefaultAudioDeviceChangedEventArgs>::into(self),
        )
    }
}
impl<'a> ::windows::runtime::IntoParam<'a, IDefaultAudioDeviceChangedEventArgs>
    for &DefaultAudioCaptureDeviceChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IDefaultAudioDeviceChangedEventArgs> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<IDefaultAudioDeviceChangedEventArgs>::into(
...
impl ::std::convert::From<DefaultAudioRenderDeviceChangedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DefaultAudioRenderDeviceChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DefaultAudioRenderDeviceChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for DialRequestedEventArgs {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.DialRequestedEventArgs;{037b929e-953c-4286-8866-4f0f376c855a})",
    );
}
...
impl DialRequestedEventHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<CallControl>,
                &::std::option::Option<DialRequestedEventArgs>,
            ) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ...
    pub fn Invoke<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, CallControl>,
        Param1: ::windows::runtime::IntoParam<'a, DialRequestedEventArgs>,
    >(
        &self,
        sender: Param0,
        e: Param1,
...
unsafe impl ::windows::runtime::RuntimeType for DialRequestedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({5abbffdb-c21f-4bc4-891b-257e28c1b1a4})",
    );
}
...
#[repr(C)]
struct DialRequestedEventHandler_box<
    F: FnMut(
            &::std::option::Option<CallControl>,
            &::std::option::Option<DialRequestedEventArgs>,
        ) -> ::windows::runtime::Result<()>
...
impl<
        F: FnMut(
            ...
            + 'static,
    > DialRequestedEventHandler_box<F>
{
    const VTABLE: DialRequestedEventHandler_abi = DialRequestedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid == &<DialRequestedEventHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
    ...
    unsafe extern "system" fn Invoke(
        ...
        ((*this).invoke)(
            &*(&sender as *const <CallControl as ::windows::runtime::Abi>::Abi
                as *const <CallControl as ::windows::runtime::Abi>::DefaultType),
            &*(&e as *const <DialRequestedEventArgs as ::windows::runtime::Abi>::Abi
                as *const <DialRequestedEventArgs as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for DigitalWindowCapability {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.DigitalWindowCapability;{d78bad2c-f721-5244-a196-b56ccbec606c})",
    );
}
unsafe impl ::windows::runtime::Interface for DigitalWindowCapability {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63265,
        21060,
        [161, 150, 181, 108, 203, 236, 96, 108],
    );
}
...
impl DigitalWindowControl {
    ...
    pub fn SupportedModes(
        &self,
    ) -> ::windows::runtime::Result<::windows::runtime::Array<DigitalWindowMode>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::Array<DigitalWindowMode> = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                ::windows::runtime::Array::<DigitalWindowMode>::set_abi_len(&mut result__),
    ...
    pub fn CurrentMode(&self) -> ::windows::runtime::Result<DigitalWindowMode> {
        ...
        unsafe {
            ...
            .from_abi::<DigitalWindowMode>(result__)
        }
    }
    pub fn GetBounds(&self) -> ::windows::runtime::Result<DigitalWindowBounds> {
        ...
        unsafe {
            ...
            .from_abi::<DigitalWindowBounds>(result__)
        }
    }
    pub fn Configure(
        &self,
    ...
    pub fn ConfigureWithBounds<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, DigitalWindowBounds>,
    >(
        &self,
        digitalwindowmode: DigitalWindowMode,
        digitalwindowbounds: Param1,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).11)(
                ::std::mem::transmute_copy(this),
                digitalwindowmode,
                digitalwindowbounds.into_param().abi(),
            )
            .ok()
        }
    }
    ...
    pub fn SupportedCapabilities(
        ...
        super::super::Foundation::Collections::IVectorView<DigitalWindowCapability>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn GetCapabilityForSize(
        ...
        width: i32,
        height: i32,
    ) -> ::windows::runtime::Result<DigitalWindowCapability> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).13)(
            ...
            .from_abi::<DigitalWindowCapability>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for DigitalWindowControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.DigitalWindowControl;{23b69eff-65d2-53ea-8780-de582b48b544})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ExposureCompensationControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ExposureCompensationControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ExposureControl {
    ...
    >(
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).13)(
                ::std::mem::transmute_copy(this),
                shutterduration.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncAction>(result__)
        }
...
unsafe impl ::windows::runtime::RuntimeType for ExposureControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.ExposureControl;{09e8cbe2-ad96-4f28-a0e0-96ed7e1b5fd2})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ExposurePriorityVideoControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for FlashControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.FlashControl;{def41dbe-7d68-45e3-8c0f-be7bb32837d0})",
    );
}
...
impl FocusControl {
    ...
    pub fn SupportedPresets(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<FocusPreset>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<FocusPreset>>(result__)
        }
    }
    ...
    pub fn SupportedFocusModes(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<FocusMode>>
    {
        let this = &::windows::runtime::Interface::cast::<IFocusControl2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<FocusMode>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn SupportedFocusDistances(
        ...
        super::super::Foundation::Collections::IVectorView<ManualFocusDistance>,
    > {
        let this = &::windows::runtime::Interface::cast::<IFocusControl2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<ManualFocusDistance>>(
                result__,
            )
        }
    }
    ...
    pub fn SupportedFocusRanges(
        ...
        super::super::Foundation::Collections::IVectorView<AutoFocusRange>,
    > {
        let this = &::windows::runtime::Interface::cast::<IFocusControl2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<AutoFocusRange>>(
                result__,
            )
        }
    }
    ...
    pub fn FocusState(&self) -> ::windows::runtime::Result<MediaCaptureFocusState> {
        ...
        unsafe {
            ...
            .from_abi::<MediaCaptureFocusState>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn UnlockAsync(
    ...
    pub fn Configure<'a, Param0: ::windows::runtime::IntoParam<'a, FocusSettings>>(
        &self,
        settings: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = &::windows::runtime::Interface::cast::<IFocusControl2>(self)?;
...
unsafe impl ::windows::runtime::RuntimeType for FocusControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.FocusControl;{c0d889f6-5228-4453-b153-85606592b238})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for FocusMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Media.Devices.FocusMode;i4)");
}
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
unsafe impl ::windows::runtime::RuntimeType for FocusPreset {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Media.Devices.FocusPreset;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl FocusSettings {
    ...
    pub fn AutoFocusRange(&self) -> ::windows::runtime::Result<AutoFocusRange> {
        ...
        unsafe {
            ...
            .from_abi::<AutoFocusRange>(result__)
        }
    }
    ...
    pub fn Distance(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IReference<ManualFocusDistance>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).12)(
            ...
            .from_abi::<super::super::Foundation::IReference<ManualFocusDistance>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn SetDistance<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::IReference<ManualFocusDistance>,
        >,
    >(
        &self,
        value: Param0,
...
unsafe impl ::windows::runtime::RuntimeType for FocusSettings {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.FocusSettings;{79958f6b-3263-4275-85d6-aeae891c96ee})",
    );
}
unsafe impl ::windows::runtime::Interface for FocusSettings {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        12899,
        17013,
        [133, 214, 174, 174, 137, 28, 150, 238],
    );
}
...
impl HdrVideoControl {
    ...
    pub fn SupportedModes(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<HdrVideoMode>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<HdrVideoMode>>(result__)
        }
    }
    pub fn Mode(&self) -> ::windows::runtime::Result<HdrVideoMode> {
        ...
        unsafe {
            ...
            .from_abi::<HdrVideoMode>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for HdrVideoControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.HdrVideoControl;{55d8e2d0-30c0-43bf-9b9a-9799d70ced94})",
    );
}
unsafe impl ::windows::runtime::Interface for HdrVideoControl {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        12480,
        17343,
        [155, 154, 151, 153, 215, 12, 237, 148],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for HdrVideoMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Media.Devices.HdrVideoMode;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
pub struct IAdvancedPhotoCaptureSettings_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AdvancedPhotoMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AdvancedPhotoMode,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IAdvancedVideoCaptureDeviceController {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        11158,
        17795,
        [128, 171, 181, 176, 29, 198, 168, 215],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IAdvancedVideoCaptureDeviceController4_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MediaCaptureOptimization,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IAdvancedVideoCaptureDeviceController5_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        propertyid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        propertyvalue: ::windows::runtime::RawPtr,
        result__: *mut VideoDeviceControllerSetDevicePropertyStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IAdvancedVideoCaptureDeviceController6 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        26785,
        17591,
        [159, 137, 181, 250, 151, 172, 12, 190],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IAudioDeviceModulesManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        moduleid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))] usize,
    #[cfg(feature = "Foundation_Collections")]
...
pub struct ICallControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        enableringer: bool,
        callerid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut u64,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::RuntimeType for IDefaultAudioDeviceChangedEventArgs {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{110f882f-1c05-4657-a18e-47c9b69f07ab}");
}
...
impl ::std::convert::From<IDefaultAudioDeviceChangedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: IDefaultAudioDeviceChangedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IDefaultAudioDeviceChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IDigitalWindowControl_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        result__: *mut *mut DigitalWindowMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DigitalWindowMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        digitalwindowmode: DigitalWindowMode,
        digitalwindowbounds: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation_Collections")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IFocusControl2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut FocusMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MediaCaptureFocusState,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IInfraredTorchControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut InfraredTorchMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: InfraredTorchMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut i32,
...
pub struct ILowLagPhotoControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::MediaProperties::MediaThumbnailFormat,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Media_MediaProperties"))] usize,
    #[cfg(feature = "Media_MediaProperties")]
    pub  unsafe extern "system" fn(
...
unsafe impl ::windows::runtime::Interface for ILowLagPhotoSequenceControl {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        27926,
        16540,
        [186, 254, 185, 165, 148, 198, 253, 230],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::RuntimeType for IMediaDeviceController {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{f6f8f5ce-209a-48fb-86fc-d44578f317e6}");
}
...
pub struct IModuleCommandResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SendCommandStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IOpticalImageStabilizationControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut OpticalImageStabilizationMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: OpticalImageStabilizationMode,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IPhotoConfirmationControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::MediaProperties::MediaPixelFormat,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Media_MediaProperties"))] usize,
    #[cfg(feature = "Media_MediaProperties")]
    pub  unsafe extern "system" fn(
...
pub struct IRegionOfInterest2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut RegionOfInterestType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: RegionOfInterestType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
...
pub struct IRegionsOfInterestControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        regions: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IVideoDeviceControllerGetDevicePropertyResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut VideoDeviceControllerGetDevicePropertyStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
...
pub struct IVideoTemporalDenoisingControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut VideoTemporalDenoisingMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: VideoTemporalDenoisingMode,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IWhiteBalanceControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ColorTemperaturePreset,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IZoomControl {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        13018,
        19479,
        [191, 215, 141, 12, 115, 200, 245, 165],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IZoomControl2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ZoomTransitionMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        settings: ::windows::runtime::RawPtr,
...
impl InfraredTorchControl {
    ...
    pub fn SupportedModes(
        ...
        super::super::Foundation::Collections::IVectorView<InfraredTorchMode>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<InfraredTorchMode>>(
                result__,
            )
        }
    }
    pub fn CurrentMode(&self) -> ::windows::runtime::Result<InfraredTorchMode> {
        ...
        unsafe {
            ...
            .from_abi::<InfraredTorchMode>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for InfraredTorchControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.InfraredTorchControl;{1cba2c83-6cb6-5a04-a6fc-3be7b33ff056})",
    );
}
...
impl IsoSpeedControl {
    ...
    pub fn SupportedPresets(
        ...
        super::super::Foundation::Collections::IVectorView<IsoSpeedPreset>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<IsoSpeedPreset>>(
                result__,
            )
        }
    }
    ...
    pub fn Preset(&self) -> ::windows::runtime::Result<IsoSpeedPreset> {
        ...
        unsafe {
            ...
            .from_abi::<IsoSpeedPreset>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
...
unsafe impl ::windows::runtime::RuntimeType for IsoSpeedControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.IsoSpeedControl;{27b6c322-25ad-4f1b-aaab-524ab376ca33})",
    );
}
...
impl KeypadPressedEventArgs {
    pub fn TelephonyKey(&self) -> ::windows::runtime::Result<TelephonyKey> {
        ...
        unsafe {
            ...
            .from_abi::<TelephonyKey>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for KeypadPressedEventArgs {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.KeypadPressedEventArgs;{d3a43900-b4fa-49cd-9442-89af6568f601})",
    );
}
...
impl KeypadPressedEventHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<CallControl>,
                &::std::option::Option<KeypadPressedEventArgs>,
            ) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ...
    pub fn Invoke<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, CallControl>,
        Param1: ::windows::runtime::IntoParam<'a, KeypadPressedEventArgs>,
    >(
        &self,
        sender: Param0,
        e: Param1,
...
unsafe impl ::windows::runtime::RuntimeType for KeypadPressedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({e637a454-c527-422c-8926-c9af83b559a0})",
    );
}
...
#[repr(C)]
struct KeypadPressedEventHandler_box<
    F: FnMut(
            &::std::option::Option<CallControl>,
            &::std::option::Option<KeypadPressedEventArgs>,
        ) -> ::windows::runtime::Result<()>
...
impl<
        F: FnMut(
            ...
            + 'static,
    > KeypadPressedEventHandler_box<F>
{
    const VTABLE: KeypadPressedEventHandler_abi = KeypadPressedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid == &<KeypadPressedEventHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
    ...
    unsafe extern "system" fn Invoke(
        ...
        ((*this).invoke)(
            &*(&sender as *const <CallControl as ::windows::runtime::Abi>::Abi
                as *const <CallControl as ::windows::runtime::Abi>::DefaultType),
            &*(&e as *const <KeypadPressedEventArgs as ::windows::runtime::Abi>::Abi
                as *const <KeypadPressedEventArgs as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
impl LowLagPhotoControl {
    ...
    pub fn GetHighestConcurrentFrameRate<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::MediaProperties::IMediaEncodingProperties>,
    >(
        &self,
    ...
    pub fn ThumbnailFormat(
        &self,
    ) -> ::windows::runtime::Result<super::MediaProperties::MediaThumbnailFormat> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::MediaProperties::MediaThumbnailFormat>(result__)
        }
    }
    #[cfg(feature = "Media_MediaProperties")]
...
unsafe impl ::windows::runtime::RuntimeType for LowLagPhotoControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.LowLagPhotoControl;{6d5c4dd0-fadf-415d-aee6-3baa529300c9})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LowLagPhotoSequenceControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LowLagPhotoSequenceControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MediaDevice {
    ...
    #[cfg(feature = "Foundation")]
    pub fn DefaultAudioCaptureDeviceChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn DefaultAudioRenderDeviceChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    pub fn IMediaDeviceStatics<
        R,
        F: FnOnce(&IMediaDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MediaDevice, IMediaDeviceStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl MediaDeviceControl {
    pub fn Capabilities(&self) -> ::windows::runtime::Result<MediaDeviceControlCapabilities> {
        ...
        unsafe {
            ...
            .from_abi::<MediaDeviceControlCapabilities>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for MediaDeviceControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.MediaDeviceControl;{efa8dfa9-6f75-4863-ba0b-583f3036b4de})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MediaDeviceControlCapabilities
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MediaDeviceControlCapabilities
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ModuleCommandResult {
    pub fn Status(&self) -> ::windows::runtime::Result<SendCommandStatus> {
        ...
        unsafe {
            ...
            .from_abi::<SendCommandStatus>(result__)
        }
    }
    #[cfg(feature = "Storage_Streams")]
...
unsafe impl ::windows::runtime::RuntimeType for ModuleCommandResult {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.ModuleCommandResult;{520d1eb4-1374-4c7d-b1e4-39dcdf3eae4e})",
    );
}
...
impl OpticalImageStabilizationControl {
    ...
    pub fn SupportedModes(
        ...
        super::super::Foundation::Collections::IVectorView<OpticalImageStabilizationMode>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn Mode(&self) -> ::windows::runtime::Result<OpticalImageStabilizationMode> {
        ...
        unsafe {
            ...
            .from_abi::<OpticalImageStabilizationMode>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a OpticalImageStabilizationControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PanelBasedOptimizationControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PhotoConfirmationControl {
    ...
    pub fn PixelFormat(
        &self,
    ) -> ::windows::runtime::Result<super::MediaProperties::MediaPixelFormat> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::MediaProperties::MediaPixelFormat>(result__)
        }
    }
    #[cfg(feature = "Media_MediaProperties")]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PhotoConfirmationControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a RedialRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl RedialRequestedEventHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<CallControl>,
                &::std::option::Option<RedialRequestedEventArgs>,
            ) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ...
    pub fn Invoke<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, CallControl>,
        Param1: ::windows::runtime::IntoParam<'a, RedialRequestedEventArgs>,
    >(
        &self,
        sender: Param0,
        e: Param1,
...
unsafe impl ::windows::runtime::RuntimeType for RedialRequestedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({baf257d1-4ebd-4b84-9f47-6ec43d75d8b1})",
    );
}
...
#[repr(C)]
struct RedialRequestedEventHandler_box<
    F: FnMut(
            &::std::option::Option<CallControl>,
            &::std::option::Option<RedialRequestedEventArgs>,
        ) -> ::windows::runtime::Result<()>
...
impl<
        F: FnMut(
            ...
            + 'static,
    > RedialRequestedEventHandler_box<F>
{
    const VTABLE: RedialRequestedEventHandler_abi = RedialRequestedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid == &<RedialRequestedEventHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
    ...
    unsafe extern "system" fn Invoke(
        ...
        ((*this).invoke)(
            &*(&sender as *const <CallControl as ::windows::runtime::Abi>::Abi
                as *const <CallControl as ::windows::runtime::Abi>::DefaultType),
            &*(&e as *const <RedialRequestedEventArgs as ::windows::runtime::Abi>::Abi
                as *const <RedialRequestedEventArgs as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
impl RegionOfInterest {
    ...
    pub fn Type(&self) -> ::windows::runtime::Result<RegionOfInterestType> {
        ...
        unsafe {
            ...
            .from_abi::<RegionOfInterestType>(result__)
        }
    }
...
impl RegionsOfInterestControl {
    ...
    pub fn SetRegionsAsync<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<RegionOfInterest>,
        >,
    >(
        &self,
        regions: Param0,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn SetRegionsWithLockAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<RegionOfInterest>,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a RegionsOfInterestControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SceneModeControl {
    ...
    pub fn SupportedModes(
        ...
        super::super::Foundation::Collections::IVectorView<CaptureSceneMode>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<CaptureSceneMode>>(
                result__,
            )
        }
    }
    pub fn Value(&self) -> ::windows::runtime::Result<CaptureSceneMode> {
        ...
        unsafe {
            ...
            .from_abi::<CaptureSceneMode>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn SetValueAsync(
...
unsafe impl ::windows::runtime::RuntimeType for SceneModeControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.SceneModeControl;{d48e5af7-8d59-4854-8c62-12c70ba89b7c})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for TelephonyKey {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Media.Devices.TelephonyKey;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for TorchControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.TorchControl;{a6053665-8250-416c-919a-724296afa306})",
    );
}
...
impl VideoDeviceController {
    pub fn Brightness(&self) -> ::windows::runtime::Result<MediaDeviceControl> {
        ...
        unsafe {
            ...
            .from_abi::<MediaDeviceControl>(result__)
        }
    }
    ...
    >(
        ...
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController>(self)?;
        unsafe {
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn LowLagPhotoSequence(&self) -> ::windows::runtime::Result<LowLagPhotoSequenceControl> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<LowLagPhotoSequenceControl>(result__)
        }
    }
    pub fn LowLagPhoto(&self) -> ::windows::runtime::Result<LowLagPhotoControl> {
        ...
        unsafe {
            ...
            .from_abi::<LowLagPhotoControl>(result__)
        }
    }
    pub fn SceneModeControl(&self) -> ::windows::runtime::Result<SceneModeControl> {
        ...
        unsafe {
            ...
            .from_abi::<SceneModeControl>(result__)
        }
    }
    pub fn TorchControl(&self) -> ::windows::runtime::Result<TorchControl> {
        ...
        unsafe {
            ...
            .from_abi::<TorchControl>(result__)
        }
    }
    pub fn FlashControl(&self) -> ::windows::runtime::Result<FlashControl> {
        ...
        unsafe {
            ...
            .from_abi::<FlashControl>(result__)
        }
    }
    pub fn WhiteBalanceControl(&self) -> ::windows::runtime::Result<WhiteBalanceControl> {
        ...
        unsafe {
            ...
            .from_abi::<WhiteBalanceControl>(result__)
        }
    }
    pub fn ExposureControl(&self) -> ::windows::runtime::Result<ExposureControl> {
        ...
        unsafe {
            ...
            .from_abi::<ExposureControl>(result__)
        }
    }
    pub fn FocusControl(&self) -> ::windows::runtime::Result<FocusControl> {
        ...
        unsafe {
            ...
            .from_abi::<FocusControl>(result__)
        }
    }
    pub fn ExposureCompensationControl(
        &self,
    ) -> ::windows::runtime::Result<ExposureCompensationControl> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<ExposureCompensationControl>(result__)
        }
    }
    pub fn IsoSpeedControl(&self) -> ::windows::runtime::Result<IsoSpeedControl> {
        ...
        unsafe {
            ...
            .from_abi::<IsoSpeedControl>(result__)
        }
    }
    pub fn RegionsOfInterestControl(&self) -> ::windows::runtime::Result<RegionsOfInterestControl> {
        ...
        unsafe {
            ...
            .from_abi::<RegionsOfInterestControl>(result__)
        }
    }
    ...
    pub fn VariablePhotoSequenceController(
        &self,
    ) -> ::windows::runtime::Result<Core::VariablePhotoSequenceController> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController3>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<Core::VariablePhotoSequenceController>(result__)
        }
    }
    pub fn PhotoConfirmationControl(&self) -> ::windows::runtime::Result<PhotoConfirmationControl> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoConfirmationControl>(result__)
        }
    }
    pub fn ZoomControl(&self) -> ::windows::runtime::Result<ZoomControl> {
        ...
        unsafe {
            ...
            .from_abi::<ZoomControl>(result__)
        }
    }
    pub fn ExposurePriorityVideoControl(
        &self,
    ) -> ::windows::runtime::Result<ExposurePriorityVideoControl> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController4>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<ExposurePriorityVideoControl>(result__)
        }
    }
    pub fn DesiredOptimization(&self) -> ::windows::runtime::Result<MediaCaptureOptimization> {
        ...
        unsafe {
            ...
            .from_abi::<MediaCaptureOptimization>(result__)
        }
    }
    ...
    pub fn HdrVideoControl(&self) -> ::windows::runtime::Result<HdrVideoControl> {
        ...
        unsafe {
            ...
            .from_abi::<HdrVideoControl>(result__)
        }
    }
    pub fn OpticalImageStabilizationControl(
        &self,
    ) -> ::windows::runtime::Result<OpticalImageStabilizationControl> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController4>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<OpticalImageStabilizationControl>(result__)
        }
    }
    pub fn AdvancedPhotoControl(&self) -> ::windows::runtime::Result<AdvancedPhotoControl> {
        ...
        unsafe {
            ...
            .from_abi::<AdvancedPhotoControl>(result__)
        }
    }
    #[cfg(all(
        feature = "Foundation_Collections",
    ...
    pub fn Id(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController5>(self)?;
        unsafe {
            let mut result__: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING> =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
    ...
    #[cfg(feature = "Foundation")]
    pub fn GetDevicePropertyById<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::IReference<u32>>,
    >(
        &self,
        propertyid: Param0,
        maxpropertyvaluesize: Param1,
    ) -> ::windows::runtime::Result<VideoDeviceControllerGetDevicePropertyResult> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController5>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<VideoDeviceControllerGetDevicePropertyResult>(result__)
        }
    }
    pub fn SetDevicePropertyById<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>,
    >(
        ...
        propertyid: Param0,
        propertyvalue: Param1,
    ) -> ::windows::runtime::Result<VideoDeviceControllerSetDevicePropertyStatus> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController5>(self)?;
        unsafe {
    ...
    #[cfg(feature = "Foundation")]
    pub fn GetDevicePropertyByExtendedId<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::IReference<u32>>,
    >(
        &self,
    ...
    pub fn VideoTemporalDenoisingControl(
        &self,
    ) -> ::windows::runtime::Result<VideoTemporalDenoisingControl> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController6>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<VideoTemporalDenoisingControl>(result__)
        }
    }
    pub fn InfraredTorchControl(&self) -> ::windows::runtime::Result<InfraredTorchControl> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController7>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<InfraredTorchControl>(result__)
        }
    }
    pub fn PanelBasedOptimizationControl(
        &self,
    ) -> ::windows::runtime::Result<PanelBasedOptimizationControl> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController8>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<PanelBasedOptimizationControl>(result__)
        }
    }
    pub fn DigitalWindowControl(&self) -> ::windows::runtime::Result<DigitalWindowControl> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController9>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<DigitalWindowControl>(result__)
        }
    }
    pub fn CameraOcclusionInfo(&self) -> ::windows::runtime::Result<CameraOcclusionInfo> {
        let this =
            &::windows::runtime::Interface::cast::<IAdvancedVideoCaptureDeviceController10>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<CameraOcclusionInfo>(result__)
        }
    }
}
...
impl VideoDeviceControllerGetDevicePropertyResult {
    pub fn Status(
        &self,
    ) -> ::windows::runtime::Result<VideoDeviceControllerGetDevicePropertyStatus> {
        let this = self;
        unsafe {
            ...
            .from_abi::<VideoDeviceControllerGetDevicePropertyStatus>(result__)
        }
    }
...
impl ::std::convert::From<VideoDeviceControllerGetDevicePropertyResult>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for VideoDeviceControllerGetDevicePropertyResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a VideoDeviceControllerGetDevicePropertyResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl VideoDeviceControllerGetDevicePropertyStatus {
    pub const Success: VideoDeviceControllerGetDevicePropertyStatus =
        VideoDeviceControllerGetDevicePropertyStatus(0i32);
    pub const UnknownFailure: VideoDeviceControllerGetDevicePropertyStatus =
        VideoDeviceControllerGetDevicePropertyStatus(1i32);
    pub const BufferTooSmall: VideoDeviceControllerGetDevicePropertyStatus =
        VideoDeviceControllerGetDevicePropertyStatus(2i32);
    pub const NotSupported: VideoDeviceControllerGetDevicePropertyStatus =
        VideoDeviceControllerGetDevicePropertyStatus(3i32);
    pub const DeviceNotAvailable: VideoDeviceControllerGetDevicePropertyStatus =
        VideoDeviceControllerGetDevicePropertyStatus(4i32);
    pub const MaxPropertyValueSizeTooSmall: VideoDeviceControllerGetDevicePropertyStatus =
        VideoDeviceControllerGetDevicePropertyStatus(5i32);
    pub const MaxPropertyValueSizeRequired: VideoDeviceControllerGetDevicePropertyStatus =
        VideoDeviceControllerGetDevicePropertyStatus(6i32);
}
...
impl VideoDeviceControllerSetDevicePropertyStatus {
    pub const Success: VideoDeviceControllerSetDevicePropertyStatus =
        VideoDeviceControllerSetDevicePropertyStatus(0i32);
    pub const UnknownFailure: VideoDeviceControllerSetDevicePropertyStatus =
        VideoDeviceControllerSetDevicePropertyStatus(1i32);
    pub const NotSupported: VideoDeviceControllerSetDevicePropertyStatus =
        VideoDeviceControllerSetDevicePropertyStatus(2i32);
    pub const InvalidValue: VideoDeviceControllerSetDevicePropertyStatus =
        VideoDeviceControllerSetDevicePropertyStatus(3i32);
    pub const DeviceNotAvailable: VideoDeviceControllerSetDevicePropertyStatus =
        VideoDeviceControllerSetDevicePropertyStatus(4i32);
    pub const NotInControl: VideoDeviceControllerSetDevicePropertyStatus =
        VideoDeviceControllerSetDevicePropertyStatus(5i32);
}
...
impl VideoTemporalDenoisingControl {
    ...
    pub fn SupportedModes(
        ...
        super::super::Foundation::Collections::IVectorView<VideoTemporalDenoisingMode>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn Mode(&self) -> ::windows::runtime::Result<VideoTemporalDenoisingMode> {
        ...
        unsafe {
            ...
            .from_abi::<VideoTemporalDenoisingMode>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a VideoTemporalDenoisingControl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl WhiteBalanceControl {
    ...
    pub fn Preset(&self) -> ::windows::runtime::Result<ColorTemperaturePreset> {
        ...
        unsafe {
            ...
            .from_abi::<ColorTemperaturePreset>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn SetPresetAsync(
...
unsafe impl ::windows::runtime::RuntimeType for WhiteBalanceControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.WhiteBalanceControl;{781f047e-7162-49c8-a8f9-9481c565363e})",
    );
}
...
impl ZoomControl {
    ...
    pub fn SupportedModes(
        ...
        super::super::Foundation::Collections::IVectorView<ZoomTransitionMode>,
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<ZoomTransitionMode>>(
                result__,
            )
        }
    }
    pub fn Mode(&self) -> ::windows::runtime::Result<ZoomTransitionMode> {
        ...
        unsafe {
            ...
            .from_abi::<ZoomTransitionMode>(result__)
        }
    }
    pub fn Configure<'a, Param0: ::windows::runtime::IntoParam<'a, ZoomSettings>>(
        &self,
        settings: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = &::windows::runtime::Interface::cast::<IZoomControl2>(self)?;
...
unsafe impl ::windows::runtime::RuntimeType for ZoomControl {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.ZoomControl;{3a1e0b12-32da-4c17-bfd7-8d0c73c8f5a5})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for ZoomSettings {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Devices.ZoomSettings;{6ad66b24-14b4-4bfd-b18f-88fe24463b52})",
    );
}
