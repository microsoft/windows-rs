...
pub struct IPlaylist_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        savelocation: ::windows::runtime::RawPtr,
...
impl Playlist {
    ...
    pub fn Files(
        ...
        super::super::Foundation::Collections::IVector<super::super::Storage::StorageFile>,
    > {
        let this = self;
        unsafe {
    ...
    >(
        file: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<Playlist>> {
        Self::IPlaylistStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<Playlist>>(result__)
        })
    }
    pub fn IPlaylistStatics<R, F: FnOnce(&IPlaylistStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<Playlist, IPlaylistStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for Playlist {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Playlists.Playlist;{803736f5-cf44-4d97-83b3-7a089e9ab663})",
    );
}
