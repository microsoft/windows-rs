...
unsafe impl ::windows::runtime::Interface for IPhotoImportFindItemsResult {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        27768,
        18731,
        [132, 78, 143, 229, 232, 246, 191, 185],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IPhotoImportFindItemsResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PhotoImportImportMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u32,
...
pub struct IPhotoImportItem_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PhotoImportContentType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u64,
...
pub struct IPhotoImportSession_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PhotoImportSubfolderCreationMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IPhotoImportSession2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PhotoImportSubfolderDateFormat,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: bool,
...
unsafe impl ::windows::runtime::Interface for IPhotoImportSidecar {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63490,
        17607,
        [156, 152, 122, 113, 244, 188, 20, 134],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPhotoImportSource_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PhotoImportConnectionTransport,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PhotoImportSourceType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PhotoImportPowerSource,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IPhotoImportSourceStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        sourcerootfolder: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IPhotoImportStorageMedium_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PhotoImportStorageMediumType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PhotoImportAccessMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u64,
...
impl PhotoImportContentTypeFilter {
    ...
    pub const ImagesAndVideosFromCameraRoll: PhotoImportContentTypeFilter =
        PhotoImportContentTypeFilter(3i32);
}
...
impl PhotoImportDeleteImportedItemsFromSourceResult {
    pub fn Session(&self) -> ::windows::runtime::Result<PhotoImportSession> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportSession>(result__)
        }
    }
    ...
    pub fn DeletedItems(
        ...
        super::super::Foundation::Collections::IVectorView<PhotoImportItem>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<PhotoImportItem>>(
                result__,
            )
        }
    }
...
impl ::std::convert::From<PhotoImportDeleteImportedItemsFromSourceResult>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PhotoImportDeleteImportedItemsFromSourceResult
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PhotoImportDeleteImportedItemsFromSourceResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl PhotoImportFindItemsResult {
    ...
    pub fn ImportMode(&self) -> ::windows::runtime::Result<PhotoImportImportMode> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportImportMode>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PhotoImportFindItemsResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PhotoImportFindItemsResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PhotoImportImportItemsResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PhotoImportImportItemsResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PhotoImportItem {
    ...
    pub fn ContentType(&self) -> ::windows::runtime::Result<PhotoImportContentType> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportContentType>(result__)
        }
    }
    ...
    pub fn Sibling(&self) -> ::windows::runtime::Result<PhotoImportSidecar> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportSidecar>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Sidecars(
        ...
        super::super::Foundation::Collections::IVectorView<PhotoImportSidecar>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<PhotoImportSidecar>>(
                result__,
            )
        }
    }
    ...
    pub fn VideoSegments(
        ...
        super::super::Foundation::Collections::IVectorView<PhotoImportVideoSegment>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
unsafe impl ::windows::runtime::RuntimeType for PhotoImportItem {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Import.PhotoImportItem;{a9d07e76-9bfc-43b8-b356-633b6a988c9e})",
    );
}
...
impl PhotoImportItemImportedEventArgs {
    pub fn ImportedItem(&self) -> ::windows::runtime::Result<PhotoImportItem> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportItem>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PhotoImportItemImportedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PhotoImportManager {
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn FindAllSourcesAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<PhotoImportSource>,
        >,
    > {
        Self::IPhotoImportManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetPendingOperations() -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<PhotoImportOperation>,
    > {
        Self::IPhotoImportManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<PhotoImportOperation>>(
                result__,
            )
        })
    }
    pub fn IPhotoImportManagerStatics<
        R,
        F: FnOnce(&IPhotoImportManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl PhotoImportOperation {
    pub fn Stage(&self) -> ::windows::runtime::Result<PhotoImportStage> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportStage>(result__)
        }
    }
    pub fn Session(&self) -> ::windows::runtime::Result<PhotoImportSession> {
        let this = self;
    ...
    pub fn ContinueFindingItemsAsync(
        ...
        super::super::Foundation::IAsyncOperationWithProgress<PhotoImportFindItemsResult, u32>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
unsafe impl ::windows::runtime::RuntimeType for PhotoImportOperation {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Import.PhotoImportOperation;{d9f797e4-a09a-4ee4-a4b1-20940277a5be})",
    );
}
...
impl ::std::fmt::Debug for PhotoImportProgress {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("PhotoImportProgress")
            .field("ItemsImported", &self.ItemsImported)
            .field("TotalItemsToImport", &self.TotalItemsToImport)
            .field("BytesImported", &self.BytesImported)
            .field("TotalBytesToImport", &self.TotalBytesToImport)
            .field("ImportProgress", &self.ImportProgress)
            .finish()
    }
}
impl ::std::cmp::PartialEq for PhotoImportProgress {
    fn eq(&self, other: &Self) -> bool {
        self.ItemsImported == other.ItemsImported
            && self.TotalItemsToImport == other.TotalItemsToImport
            && self.BytesImported == other.BytesImported
            && self.TotalBytesToImport == other.TotalBytesToImport
            && self.ImportProgress == other.ImportProgress
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PhotoImportSelectionChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<PhotoImportSelectionChangedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: PhotoImportSelectionChangedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PhotoImportSelectionChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PhotoImportSession {
    pub fn Source(&self) -> ::windows::runtime::Result<PhotoImportSource> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportSource>(result__)
        }
    }
    ...
    #[cfg(feature = "Storage")]
    pub fn DestinationFolder(
        &self,
    ) -> ::windows::runtime::Result<super::super::Storage::IStorageFolder> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
            ...
            .from_abi::<super::super::Storage::IStorageFolder>(result__)
        }
    }
    pub fn SetAppendSessionDateToDestinationFolder(
        &self,
        value: bool,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn SubfolderCreationMode(
        &self,
    ) -> ::windows::runtime::Result<PhotoImportSubfolderCreationMode> {
        let this = self;
        unsafe {
            ...
            .from_abi::<PhotoImportSubfolderCreationMode>(result__)
        }
    }
    ...
    pub fn SubfolderDateFormat(
        &self,
    ) -> ::windows::runtime::Result<PhotoImportSubfolderDateFormat> {
        let this = &::windows::runtime::Interface::cast::<IPhotoImportSession2>(self)?;
        unsafe {
            ...
            .from_abi::<PhotoImportSubfolderDateFormat>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for PhotoImportSession {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Import.PhotoImportSession;{aa63916e-ecdb-4efe-94c6-5f5cafe34cfb})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for PhotoImportSidecar {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Import.PhotoImportSidecar;{46d7d757-f802-44c7-9c98-7a71f4bc1486})",
    );
}
...
impl PhotoImportSource {
    ...
    pub fn ConnectionTransport(
        &self,
    ) -> ::windows::runtime::Result<PhotoImportConnectionTransport> {
        let this = self;
        unsafe {
            ...
            .from_abi::<PhotoImportConnectionTransport>(result__)
        }
    }
    pub fn Type(&self) -> ::windows::runtime::Result<PhotoImportSourceType> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportSourceType>(result__)
        }
    }
    pub fn PowerSource(&self) -> ::windows::runtime::Result<PhotoImportPowerSource> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportPowerSource>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn StorageMedia(
        ...
        super::super::Foundation::Collections::IVectorView<PhotoImportStorageMedium>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    >(
        sourceid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<PhotoImportSource>>
    {
        Self::IPhotoImportSourceStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<PhotoImportSource>>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn FromFolderAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::IStorageFolder>,
    >(
        sourcerootfolder: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<PhotoImportSource>>
    {
        Self::IPhotoImportSourceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                sourcerootfolder.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<PhotoImportSource>>(result__)
        })
    }
    pub fn IPhotoImportSourceStatics<
        R,
        F: FnOnce(&IPhotoImportSourceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for PhotoImportSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Import.PhotoImportSource;{1f8ea35e-145b-4cd6-87f1-54965a982fef})",
    );
}
...
impl PhotoImportStorageMedium {
    ...
    pub fn StorageMediumType(&self) -> ::windows::runtime::Result<PhotoImportStorageMediumType> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportStorageMediumType>(result__)
        }
    }
    pub fn SupportedAccessMode(&self) -> ::windows::runtime::Result<PhotoImportAccessMode> {
        ...
        unsafe {
            ...
            .from_abi::<PhotoImportAccessMode>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for PhotoImportStorageMedium {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Import.PhotoImportStorageMedium;{f2b9b093-fc85-487f-87c2-58d675d05b07})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PhotoImportStorageMedium
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PhotoImportSubfolderCreationMode {
    pub const DoNotCreateSubfolders: PhotoImportSubfolderCreationMode =
        PhotoImportSubfolderCreationMode(0i32);
    pub const CreateSubfoldersFromFileDate: PhotoImportSubfolderCreationMode =
        PhotoImportSubfolderCreationMode(1i32);
    pub const CreateSubfoldersFromExifDate: PhotoImportSubfolderCreationMode =
        PhotoImportSubfolderCreationMode(2i32);
    pub const KeepOriginalFolderStructure: PhotoImportSubfolderCreationMode =
        PhotoImportSubfolderCreationMode(3i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for PhotoImportVideoSegment {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Import.PhotoImportVideoSegment;{623c0289-321a-41d8-9166-8c62a333276c})",
    );
}
