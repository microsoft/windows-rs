...
impl BackgroundAudioTrack {
    ...
    pub fn Clone(&self) -> ::windows::runtime::Result<BackgroundAudioTrack> {
        ...
        unsafe {
            ...
            .from_abi::<BackgroundAudioTrack>(result__)
        }
    }
    ...
    pub fn CreateFromEmbeddedAudioTrack<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, EmbeddedAudioTrack>,
    >(
        embeddedaudiotrack: Param0,
    ) -> ::windows::runtime::Result<BackgroundAudioTrack> {
        Self::IBackgroundAudioTrackStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                embeddedaudiotrack.into_param().abi(),
                &mut result__,
            )
            .from_abi::<BackgroundAudioTrack>(result__)
        })
    ...
    >(
        file: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<BackgroundAudioTrack>>
    {
        Self::IBackgroundAudioTrackStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<BackgroundAudioTrack>>(result__)
        })
    }
    pub fn IBackgroundAudioTrackStatics<
        R,
        F: FnOnce(&IBackgroundAudioTrackStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
pub struct IBackgroundAudioTrackStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        embeddedaudiotrack: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub  unsafe extern "system" fn(
...
pub struct IMediaComposition_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        timesfromstart: ::windows::runtime::RawPtr,
        scaledwidth: i32,
        scaledheight: i32,
        frameprecision: VideoFramePrecision,
        result__: *mut ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IMediaOverlayLayer {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        61146,
        18118,
        [187, 229, 227, 152, 200, 65, 104, 172],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IMediaOverlayLayerFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        compositordefinition: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Media_Effects"))] usize,
);
...
impl MediaClip {
    ...
    pub fn EmbeddedAudioTracks(
        ...
        super::super::Foundation::Collections::IVectorView<EmbeddedAudioTrack>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<EmbeddedAudioTrack>>(
                result__,
            )
        }
    }
    ...
    pub fn VideoEffectDefinitions(
        ...
        super::super::Foundation::Collections::IVector<super::Effects::IVideoEffectDefinition>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    >(
        color: Param0,
        originalduration: Param1,
    ) -> ::windows::runtime::Result<MediaClip> {
        Self::IMediaClipStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                color.into_param().abi(),
                originalduration.into_param().abi(),
                &mut result__,
            )
            .from_abi::<MediaClip>(result__)
        })
    ...
    >(
        file: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<MediaClip>> {
        Self::IMediaClipStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<MediaClip>>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn CreateFromImageFileAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::IStorageFile>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::TimeSpan>,
    >(
    ...
    pub fn IMediaClipStatics<R, F: FnOnce(&IMediaClipStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MediaClip, IMediaClipStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IMediaClipStatics2<
        R,
        F: FnOnce(&IMediaClipStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MediaClip, IMediaClipStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl MediaComposition {
    ...
    pub fn Clips(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<MediaClip>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<MediaClip>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn BackgroundAudioTracks(
        ...
        super::super::Foundation::Collections::IVector<BackgroundAudioTrack>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<BackgroundAudioTrack>>(
                result__,
            )
        }
    }
    ...
    pub fn Clone(&self) -> ::windows::runtime::Result<MediaComposition> {
        ...
        unsafe {
            ...
            .from_abi::<MediaComposition>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn SaveAsync<
    ...
    >(
        &self,
        timefromstart: Param0,
        scaledwidth: i32,
        scaledheight: i32,
        frameprecision: VideoFramePrecision,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<super::super::Graphics::Imaging::ImageStream>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<
                super::super::Graphics::Imaging::ImageStream,
            >>(result__)
        }
    }
    #[cfg(all(
    ...
    pub fn GetThumbnailsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<super::super::Foundation::TimeSpan>,
        >,
    >(
        &self,
        timesfromstart: Param0,
        scaledwidth: i32,
        scaledheight: i32,
        frameprecision: VideoFramePrecision,
    ) -> ::windows::runtime::Result<
    ...
    pub fn RenderToFileWithTrimmingPreferenceAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::IStorageFile>,
    >(
        &self,
    ...
    pub fn RenderToFileWithProfileAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::IStorageFile>,
        Param2: ::windows::runtime::IntoParam<'a, super::MediaProperties::MediaEncodingProfile>,
    >(
        &self,
        destination: Param0,
        trimmingpreference: MediaTrimmingPreference,
        encodingprofile: Param2,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperationWithProgress<
            super::Transcoding::TranscodeFailureReason,
            f64,
    ...
    pub fn GenerateMediaStreamSource(
        &self,
    ) -> ::windows::runtime::Result<super::Core::MediaStreamSource> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).18)(
            ...
            .from_abi::<super::Core::MediaStreamSource>(result__)
        }
    }
    #[cfg(all(feature = "Media_Core", feature = "Media_MediaProperties"))]
    ...
    pub fn OverlayLayers(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<MediaOverlayLayer>>
    {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<MediaOverlayLayer>>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn LoadAsync<
    ...
    >(
        file: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<MediaComposition>>
    {
        Self::IMediaCompositionStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<MediaComposition>>(result__)
        })
    }
    pub fn IMediaCompositionStatics<
        R,
        F: FnOnce(&IMediaCompositionStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for MediaComposition {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Editing.MediaComposition;{2e06e605-dc71-41d6-b837-2d2bc14a2947})",
    );
}
...
impl MediaOverlay {
    ...
    pub fn Clone(&self) -> ::windows::runtime::Result<MediaOverlay> {
        ...
        unsafe {
            ...
            .from_abi::<MediaOverlay>(result__)
        }
    }
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, MediaClip>>(
        clip: Param0,
    ) -> ::windows::runtime::Result<MediaOverlay> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateWithPositionAndOpacity<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, MediaClip>,
    ...
    pub fn IMediaOverlayFactory<
        R,
        F: FnOnce(&IMediaOverlayFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MediaOverlay, IMediaOverlayFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for MediaOverlay {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Editing.MediaOverlay;{a902ae5d-7869-4830-8ab1-94dc01c05fa4})",
    );
}
...
impl MediaOverlayLayer {
    ...
    pub fn Clone(&self) -> ::windows::runtime::Result<MediaOverlayLayer> {
        ...
        unsafe {
            ...
            .from_abi::<MediaOverlayLayer>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Overlays(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<MediaOverlay>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<MediaOverlay>>(result__)
        }
    }
    #[cfg(feature = "Media_Effects")]
    pub fn CustomCompositorDefinition(
        &self,
    ) -> ::windows::runtime::Result<super::Effects::IVideoCompositorDefinition> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::Effects::IVideoCompositorDefinition>(result__)
        }
    }
    #[cfg(feature = "Media_Effects")]
    pub fn CreateWithCompositorDefinition<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Effects::IVideoCompositorDefinition>,
    >(
        compositordefinition: Param0,
    ) -> ::windows::runtime::Result<MediaOverlayLayer> {
        Self::IMediaOverlayLayerFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                compositordefinition.into_param().abi(),
                &mut result__,
            )
            .from_abi::<MediaOverlayLayer>(result__)
        })
    }
    pub fn IMediaOverlayLayerFactory<
        R,
        F: FnOnce(&IMediaOverlayLayerFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for MediaOverlayLayer {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Editing.MediaOverlayLayer;{a6d9ba57-eeda-46c6-bbe5-e398c84168ac})",
    );
}
