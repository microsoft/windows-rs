...
impl CastingConnection {
    pub fn State(&self) -> ::windows::runtime::Result<CastingConnectionState> {
        ...
        unsafe {
            ...
            .from_abi::<CastingConnectionState>(result__)
        }
    }
    pub fn Device(&self) -> ::windows::runtime::Result<CastingDevice> {
        ...
        unsafe {
            ...
            .from_abi::<CastingDevice>(result__)
        }
    }
    pub fn Source(&self) -> ::windows::runtime::Result<CastingSource> {
        ...
        unsafe {
            ...
            .from_abi::<CastingSource>(result__)
        }
    }
    pub fn SetSource<'a, Param0: ::windows::runtime::IntoParam<'a, CastingSource>>(
        &self,
        value: Param0,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RequestStartCastingAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, CastingSource>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<CastingConnectionErrorStatus>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<CastingConnectionErrorStatus>>(
                result__,
            )
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn DisconnectAsync(
        &self,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<CastingConnectionErrorStatus>,
    > {
...
unsafe impl ::windows::runtime::RuntimeType for CastingConnection {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Casting.CastingConnection;{cd951653-c2f1-4498-8b78-5fb4cd3640dd})",
    );
}
...
impl CastingConnectionErrorOccurredEventArgs {
    pub fn ErrorStatus(&self) -> ::windows::runtime::Result<CastingConnectionErrorStatus> {
        ...
        unsafe {
            ...
            .from_abi::<CastingConnectionErrorStatus>(result__)
        }
    }
...
impl ::std::convert::From<CastingConnectionErrorOccurredEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CastingConnectionErrorOccurredEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CastingConnectionErrorOccurredEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CastingConnectionErrorStatus {
    ...
    pub const DeviceDidNotRespond: CastingConnectionErrorStatus =
        CastingConnectionErrorStatus(1i32);
    ...
    pub const ProtectedPlaybackFailed: CastingConnectionErrorStatus =
        CastingConnectionErrorStatus(4i32);
    pub const InvalidCastingSource: CastingConnectionErrorStatus =
        CastingConnectionErrorStatus(5i32);
...
unsafe impl ::windows::runtime::RuntimeType for CastingConnectionErrorStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Media.Casting.CastingConnectionErrorStatus;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for CastingConnectionState {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Media.Casting.CastingConnectionState;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl CastingDevice {
    ...
    #[cfg(feature = "Foundation")]
    pub fn GetSupportedCastingPlaybackTypesAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<CastingPlaybackTypes>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<CastingPlaybackTypes>>(result__)
        }
    }
    pub fn CreateCastingConnection(&self) -> ::windows::runtime::Result<CastingConnection> {
        ...
        unsafe {
            ...
            .from_abi::<CastingConnection>(result__)
        }
    }
    pub fn GetDeviceSelector(
        r#type: CastingPlaybackTypes,
    ...
    #[cfg(feature = "Foundation")]
    pub fn GetDeviceSelectorFromCastingSourceAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, CastingSource>,
    >(
        castingsource: Param0,
    ) -> ::windows::runtime::Result<
    ...
    >(
        value: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<CastingDevice>> {
        Self::ICastingDeviceStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<CastingDevice>>(result__)
        })
    }
    #[cfg(all(feature = "Devices_Enumeration", feature = "Foundation"))]
    pub fn DeviceInfoSupportsCastingAsync<
        'a,
    ...
    pub fn ICastingDeviceStatics<
        R,
        F: FnOnce(&ICastingDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<CastingDevice, ICastingDeviceStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for CastingDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Casting.CastingDevice;{de721c83-4a43-4ad1-a6d2-2492a796c3f2})",
    );
}
unsafe impl ::windows::runtime::Interface for CastingDevice {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        19011,
        19153,
        [166, 210, 36, 146, 167, 150, 195, 242],
    );
}
...
impl CastingDevicePicker {
    ...
    pub fn Filter(&self) -> ::windows::runtime::Result<CastingDevicePickerFilter> {
        ...
        unsafe {
            ...
            .from_abi::<CastingDevicePickerFilter>(result__)
        }
    }
    #[cfg(feature = "Devices_Enumeration")]
    pub fn Appearance(
        &self,
    ) -> ::windows::runtime::Result<super::super::Devices::Enumeration::DevicePickerAppearance>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Devices::Enumeration::DevicePickerAppearance>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn CastingDeviceSelected<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveCastingDeviceSelected<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn CastingDevicePickerDismissed<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveCastingDevicePickerDismissed<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn Show<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Rect>>(
        &self,
        selection: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for CastingDevicePicker {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Casting.CastingDevicePicker;{dcd39924-0591-49be-aacb-4b82ee756a95})",
    );
}
unsafe impl ::windows::runtime::Interface for CastingDevicePicker {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        1425,
        18878,
        [170, 203, 75, 130, 238, 117, 106, 149],
    );
}
...
impl CastingDevicePickerFilter {
    ...
    pub fn SupportedCastingSources(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<CastingSource>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<CastingSource>>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CastingDevicePickerFilter
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CastingDeviceSelectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CastingDeviceSelectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for CastingPlaybackTypes {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Media.Casting.CastingPlaybackTypes;u4)",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for CastingSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Casting.CastingSource;{f429ea72-3467-47e6-a027-522923e9d727})",
    );
}
...
pub struct ICastingConnection_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CastingConnectionState,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct ICastingConnectionErrorOccurredEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CastingConnectionErrorStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct ICastingDeviceStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        castingsource: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
