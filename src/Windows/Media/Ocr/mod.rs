...
impl OcrEngine {
    ...
    >(
        &self,
        bitmap: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<OcrResult>> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<OcrResult>>(result__)
        }
    }
    #[cfg(feature = "Globalization")]
    ...
    #[cfg(all(feature = "Foundation_Collections", feature = "Globalization"))]
    pub fn AvailableRecognizerLanguages() -> ::windows::runtime::Result<
    ...
    pub fn IsLanguageSupported<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Globalization::Language>,
    >(
        language: Param0,
    ...
    >(
        language: Param0,
    ) -> ::windows::runtime::Result<OcrEngine> {
        Self::IOcrEngineStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn IOcrEngineStatics<R, F: FnOnce(&IOcrEngineStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<OcrEngine, IOcrEngineStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for OcrEngine {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Ocr.OcrEngine;{5a14bc41-5b76-3140-b680-8825562683ac})",
    );
}
...
impl OcrLine {
    ...
    pub fn Words(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<OcrWord>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<OcrWord>>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for OcrLine {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Ocr.OcrLine;{0043a16f-e31f-3a24-899c-d444bd088124})",
    );
}
...
impl OcrResult {
    ...
    pub fn Lines(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<OcrLine>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<OcrLine>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn TextAngle(
...
unsafe impl ::windows::runtime::RuntimeType for OcrWord {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Media.Ocr.OcrWord;{3c2a477a-5cd9-3525-ba2a-23d1e0a68a1d})",
    );
}
