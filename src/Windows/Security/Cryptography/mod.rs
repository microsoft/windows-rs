...
unsafe impl ::windows::runtime::RuntimeType for BinaryStringEncoding {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Security.Cryptography.BinaryStringEncoding;i4)",
    );
}
...
impl CryptographicBuffer {
    ...
    >(
        ...
        Self::ICryptographicBufferStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                object1.into_param().abi(),
                object2.into_param().abi(),
                &mut result__,
            )
    ...
    pub fn ICryptographicBufferStatics<
        R,
        F: FnOnce(&ICryptographicBufferStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
pub struct ICryptographicBufferStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        object1: ::windows::runtime::RawPtr,
        object2: ::windows::runtime::RawPtr,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
