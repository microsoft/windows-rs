...
impl DataProtectionProvider {
    ...
    pub fn ProtectStreamAsync<
        ...
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Storage::Streams::IOutputStream>,
    >(
        &self,
        src: Param0,
        dest: Param1,
    ...
    >(
        protectiondescriptor: Param0,
    ) -> ::windows::runtime::Result<DataProtectionProvider> {
        Self::IDataProtectionProviderFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                protectiondescriptor.into_param().abi(),
                &mut result__,
            )
            .from_abi::<DataProtectionProvider>(result__)
        })
    }
    pub fn IDataProtectionProviderFactory<
        R,
        F: FnOnce(&IDataProtectionProviderFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
pub struct IDataProtectionProvider_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        src: ::windows::runtime::RawPtr,
        dest: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Storage_Streams")))] usize,
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
...
pub struct IDataProtectionProviderFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        protectiondescriptor: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
