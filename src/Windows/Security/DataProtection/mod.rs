...
pub struct IUserDataBufferUnprotectResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UserDataBufferUnprotectStatus,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IUserDataProtectionManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        unprotectedbuffer: ::windows::runtime::RawPtr,
        availability: UserDataAvailability,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        protectedbuffer: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Storage_Streams")))] usize,
    pub  unsafe extern "system" fn(
...
pub struct IUserDataStorageItemProtectionInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UserDataAvailability,
    ) -> ::windows::runtime::HRESULT,
);
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for UserDataAvailability {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Security.DataProtection.UserDataAvailability;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl ::std::convert::From<UserDataAvailabilityStateChangedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserDataAvailabilityStateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl UserDataBufferUnprotectResult {
    pub fn Status(&self) -> ::windows::runtime::Result<UserDataBufferUnprotectStatus> {
        ...
        unsafe {
            ...
            .from_abi::<UserDataBufferUnprotectStatus>(result__)
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn UnprotectedBuffer(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserDataBufferUnprotectResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for UserDataBufferUnprotectStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Security.DataProtection.UserDataBufferUnprotectStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl UserDataProtectionManager {
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn ProtectStorageItemAsync<
        'a,
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<UserDataStorageItemProtectionStatus>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn GetStorageItemProtectionInfoAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::IStorageItem>,
    >(
        &self,
        ...
        super::super::Foundation::IAsyncOperation<UserDataStorageItemProtectionInfo>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    > {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                unprotectedbuffer.into_param().abi(),
                availability,
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<
    ...
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn UnprotectBufferAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IBuffer>,
    >(
        &self,
        protectedbuffer: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<UserDataBufferUnprotectResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
                protectedbuffer.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<UserDataBufferUnprotectResult>>(
                result__,
            )
        }
    }
    pub fn IsContinuedDataAvailabilityExpected(
        &self,
        availability: UserDataAvailability,
    ...
    #[cfg(feature = "Foundation")]
    pub fn DataAvailabilityStateChanged<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDataAvailabilityStateChanged<
        'a,
    ...
    pub fn TryGetDefault() -> ::windows::runtime::Result<UserDataProtectionManager> {
        Self::IUserDataProtectionManagerStatics(|this| unsafe {
            ...
            .from_abi::<UserDataProtectionManager>(result__)
        })
    }
    #[cfg(feature = "System")]
    pub fn TryGetForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::System::User>,
    >(
        user: Param0,
    ) -> ::windows::runtime::Result<UserDataProtectionManager> {
        Self::IUserDataProtectionManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn IUserDataProtectionManagerStatics<
        R,
        F: FnOnce(&IUserDataProtectionManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserDataProtectionManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl UserDataStorageItemProtectionInfo {
    pub fn Availability(&self) -> ::windows::runtime::Result<UserDataAvailability> {
        ...
        unsafe {
            ...
            .from_abi::<UserDataAvailability>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for UserDataStorageItemProtectionInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserDataStorageItemProtectionInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl UserDataStorageItemProtectionStatus {
    pub const Succeeded: UserDataStorageItemProtectionStatus =
        UserDataStorageItemProtectionStatus(0i32);
    pub const NotProtectable: UserDataStorageItemProtectionStatus =
        UserDataStorageItemProtectionStatus(1i32);
    pub const DataUnavailable: UserDataStorageItemProtectionStatus =
        UserDataStorageItemProtectionStatus(2i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for UserDataStorageItemProtectionStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Security.DataProtection.UserDataStorageItemProtectionStatus;i4)",
    );
}
