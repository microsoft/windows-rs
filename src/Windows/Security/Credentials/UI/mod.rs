...
unsafe impl ::windows::runtime::RuntimeType for AuthenticationProtocol {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Security.Credentials.UI.AuthenticationProtocol;i4)",
    );
}
pub struct CredentialPicker {}
impl CredentialPicker {
    #[cfg(feature = "Foundation")]
    pub fn PickWithOptionsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, CredentialPickerOptions>,
    >(
        options: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<CredentialPickerResults>,
    > {
        Self::ICredentialPickerStatics(|this| unsafe {
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<CredentialPickerResults>>(
                result__,
            )
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn PickWithMessageAsync<
        'a,
    ...
    pub fn ICredentialPickerStatics<
        R,
        F: FnOnce(&ICredentialPickerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl CredentialPickerOptions {
    ...
    pub fn SetAuthenticationProtocol(
        &self,
    ...
    pub fn AuthenticationProtocol(&self) -> ::windows::runtime::Result<AuthenticationProtocol> {
        ...
        unsafe {
            ...
            .from_abi::<AuthenticationProtocol>(result__)
        }
    }
    pub fn SetCustomAuthenticationProtocol<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
    ...
    pub fn CustomAuthenticationProtocol(
        &self,
    ...
    pub fn SetCredentialSaveOption(
        &self,
    ...
    pub fn CredentialSaveOption(&self) -> ::windows::runtime::Result<CredentialSaveOption> {
        ...
        unsafe {
            ...
            .from_abi::<CredentialSaveOption>(result__)
        }
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for CredentialSaveOption {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Security.Credentials.UI.CredentialSaveOption;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
pub struct ICredentialPickerOptions_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AuthenticationProtocol,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CredentialSaveOption,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct ICredentialPickerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        targetname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ...
    pub  unsafe extern "system" fn(
        ...
        targetname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        message: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        caption: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
...
impl UserConsentVerificationResult {
    ...
    pub const NotConfiguredForUser: UserConsentVerificationResult =
        UserConsentVerificationResult(2i32);
...
unsafe impl ::windows::runtime::RuntimeType for UserConsentVerificationResult {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Security.Credentials.UI.UserConsentVerificationResult;i4)",
    );
}
pub struct UserConsentVerifier {}
impl UserConsentVerifier {
    #[cfg(feature = "Foundation")]
    pub fn CheckAvailabilityAsync() -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<UserConsentVerifierAvailability>,
    > {
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<UserConsentVerificationResult>,
    > {
        Self::IUserConsentVerifierStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    pub fn IUserConsentVerifierStatics<
        R,
        F: FnOnce(&IUserConsentVerifierStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl UserConsentVerifierAvailability {
    ...
    pub const DeviceNotPresent: UserConsentVerifierAvailability =
        UserConsentVerifierAvailability(1i32);
    pub const NotConfiguredForUser: UserConsentVerifierAvailability =
        UserConsentVerifierAvailability(2i32);
    pub const DisabledByPolicy: UserConsentVerifierAvailability =
        UserConsentVerifierAvailability(3i32);
...
unsafe impl ::windows::runtime::RuntimeType for UserConsentVerifierAvailability {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Security.Credentials.UI.UserConsentVerifierAvailability;i4)",
    );
}
