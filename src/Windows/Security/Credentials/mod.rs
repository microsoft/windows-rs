...
unsafe impl ::windows::runtime::Interface for IWebAccount {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        32817,
        18878,
        [128, 187, 150, 203, 70, 217, 154, 186],
    );
}
impl IWebAccount {
    pub fn WebAccountProvider(&self) -> ::windows::runtime::Result<WebAccountProvider> {
        ...
        unsafe {
            ...
            .from_abi::<WebAccountProvider>(result__)
        }
    }
    ...
    pub fn State(&self) -> ::windows::runtime::Result<WebAccountState> {
        ...
        unsafe {
            ...
            .from_abi::<WebAccountState>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for IWebAccount {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{69473eb2-8031-49be-80bb-96cb46d99aba}");
}
...
unsafe impl ::windows::runtime::Interface for IWebAccountProvider3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        38669,
        19785,
        [130, 92, 242, 112, 111, 140, 167, 254],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IWebAccountProvider4 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        59286,
        16912,
        [183, 78, 132, 210, 152, 148, 176, 128],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl KeyCredential {
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<KeyCredentialOperationResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<KeyCredentialOperationResult>>(
                result__,
            )
        }
    }
    ...
    pub fn GetAttestationAsync(
        ...
        super::super::Foundation::IAsyncOperation<KeyCredentialAttestationResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<KeyCredentialAttestationResult>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for KeyCredential {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Security.Credentials.KeyCredential;{9585ef8d-457b-4847-b11a-fa960bbdb138})",
    );
}
...
impl KeyCredentialAttestationResult {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<KeyCredentialAttestationStatus> {
        ...
        unsafe {
            ...
            .from_abi::<KeyCredentialAttestationStatus>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for KeyCredentialAttestationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a KeyCredentialAttestationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl KeyCredentialAttestationStatus {
    ...
    pub const TemporaryFailure: KeyCredentialAttestationStatus =
        KeyCredentialAttestationStatus(3i32);
}
...
impl KeyCredentialManager {
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<KeyCredentialRetrievalResult>,
    > {
        Self::IKeyCredentialManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<KeyCredentialRetrievalResult>>(
                result__,
            )
        })
    }
    ...
    pub fn IKeyCredentialManagerStatics<
        R,
        F: FnOnce(&IKeyCredentialManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl KeyCredentialOperationResult {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<KeyCredentialStatus> {
        ...
        unsafe {
            ...
            .from_abi::<KeyCredentialStatus>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for KeyCredentialOperationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a KeyCredentialOperationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl KeyCredentialRetrievalResult {
    pub fn Credential(&self) -> ::windows::runtime::Result<KeyCredential> {
        ...
        unsafe {
            ...
            .from_abi::<KeyCredential>(result__)
        }
    }
    pub fn Status(&self) -> ::windows::runtime::Result<KeyCredentialStatus> {
        let this = self;
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for KeyCredentialRetrievalResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a KeyCredentialRetrievalResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PasswordCredential {
    ...
    >(
        ...
        username: Param1,
        password: Param2,
    ) -> ::windows::runtime::Result<PasswordCredential> {
        Self::ICredentialFactory(|this| unsafe {
            ...
            .from_abi::<PasswordCredential>(result__)
        })
    }
    pub fn ICredentialFactory<
        R,
        F: FnOnce(&ICredentialFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
#[cfg(feature = "Foundation_Collections")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PasswordCredentialPropertyStore
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
#[cfg(feature = "Foundation_Collections")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PasswordCredentialPropertyStore
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::From<PasswordCredentialPropertyStore>
    for super::super::Foundation::Collections::IPropertySet
{
    fn from(value: PasswordCredentialPropertyStore) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
#[cfg(feature = "Foundation_Collections")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Foundation::Collections::IPropertySet>
    for PasswordCredentialPropertyStore
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::Foundation::Collections::IPropertySet> {
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<PasswordCredentialPropertyStore>
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<PasswordCredentialPropertyStore>
    for super::super::Foundation::Collections::IObservableMap<
        ::windows::runtime::HSTRING,
        ::windows::runtime::IInspectable,
    >
{
...
impl PasswordVault {
    ...
    pub fn Add<'a, Param0: ::windows::runtime::IntoParam<'a, PasswordCredential>>(
        &self,
        credential: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn Remove<'a, Param0: ::windows::runtime::IntoParam<'a, PasswordCredential>>(
        &self,
        credential: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    >(
        ...
        super::super::Foundation::Collections::IVectorView<PasswordCredential>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<PasswordCredential>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for PasswordVault {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Security.Credentials.PasswordVault;{61fd2c0b-c8d4-48c1-a54f-bc5a64205af2})",
    );
}
...
impl WebAccount {
    ...
    pub fn CreateWebAccount<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, WebAccountProvider>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        webaccountprovider: Param0,
        username: Param1,
        state: WebAccountState,
    ) -> ::windows::runtime::Result<WebAccount> {
        Self::IWebAccountFactory(|this| unsafe {
            ...
            .from_abi::<WebAccount>(result__)
        })
    }
    pub fn IWebAccountFactory<
        R,
        F: FnOnce(&IWebAccountFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<WebAccount, IWebAccountFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for WebAccount {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Security.Credentials.WebAccount;{69473eb2-8031-49be-80bb-96cb46d99aba})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IWebAccount> for &WebAccount {
    fn into_param(self) -> ::windows::runtime::Param<'a, IWebAccount> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IWebAccount>::into(
...
impl WebAccountProvider {
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateWebAccountProvider<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    ...
    >(
        ...
        displayname: Param1,
        iconuri: Param2,
    ) -> ::windows::runtime::Result<WebAccountProvider> {
    ...
    pub fn IWebAccountProviderFactory<
        R,
        F: FnOnce(&IWebAccountProviderFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
