...
pub struct IWebAuthenticationBrokerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        requesturi: ::windows::runtime::RawPtr,
        callbackuri: ::windows::runtime::RawPtr,
...
pub struct IWebAuthenticationBrokerStatics2_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        requesturi: ::windows::runtime::RawPtr,
        callbackuri: ::windows::runtime::RawPtr,
        continuationdata: ::windows::runtime::RawPtr,
        options: WebAuthenticationOptions,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IWebAuthenticationResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut WebAuthenticationStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u32,
...
impl WebAuthenticationBroker {
    #[cfg(feature = "Foundation")]
    pub fn AuthenticateWithCallbackUriAsync<
        'a,
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<WebAuthenticationResult>,
    > {
        Self::IWebAuthenticationBrokerStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                options,
                requesturi.into_param().abi(),
                callbackuri.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<WebAuthenticationResult>>(
                result__,
            )
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn AuthenticateWithoutCallbackUriAsync<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
    >(
        options: WebAuthenticationOptions,
    ...
    #[cfg(feature = "Foundation")]
    pub fn AuthenticateAndContinue<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn AuthenticateWithCallbackUriAndContinue<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
    >(
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn AuthenticateWithCallbackUriContinuationDataAndOptionsAndContinue<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Collections::ValueSet>,
    >(
        requesturi: Param0,
        callbackuri: Param1,
        continuationdata: Param2,
        options: WebAuthenticationOptions,
    ) -> ::windows::runtime::Result<()> {
        Self::IWebAuthenticationBrokerStatics2(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).8)(
                ...
                requesturi.into_param().abi(),
                callbackuri.into_param().abi(),
                continuationdata.into_param().abi(),
                options,
            )
            .ok()
        })
    ...
    #[cfg(feature = "Foundation")]
    pub fn AuthenticateSilentlyAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
    >(
        requesturi: Param0,
    ...
    #[cfg(feature = "Foundation")]
    pub fn AuthenticateSilentlyWithOptionsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
    >(
        requesturi: Param0,
    ...
    pub fn IWebAuthenticationBrokerStatics<
        R,
        F: FnOnce(&IWebAuthenticationBrokerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IWebAuthenticationBrokerStatics2<
        R,
        F: FnOnce(&IWebAuthenticationBrokerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl WebAuthenticationResult {
    ...
    pub fn ResponseStatus(&self) -> ::windows::runtime::Result<WebAuthenticationStatus> {
        ...
        unsafe {
            ...
            .from_abi::<WebAuthenticationStatus>(result__)
        }
    }
