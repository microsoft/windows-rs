...
pub struct IMicrosoftAccountMultiFactorAuthenticationManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        useraccountid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        codelength: u32,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        useraccountid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        authenticationtoken: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        wnschannelid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        useraccountid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        channeluri: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        useraccountidlist: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        ...
        authenticationsessioninfo: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
...
pub struct IMicrosoftAccountMultiFactorGetSessionsResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MicrosoftAccountMultiFactorServiceResponse,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IMicrosoftAccountMultiFactorSessionInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MicrosoftAccountMultiFactorSessionApprovalStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MicrosoftAccountMultiFactorAuthenticationType,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl MicrosoftAccountMultiFactorAuthenticationManager {
    ...
    > {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                useraccountid.into_param().abi(),
                authenticationtoken.into_param().abi(),
                wnschannelid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::super::Foundation::IAsyncOperation<
                MicrosoftAccountMultiFactorServiceResponse,
    ...
    > {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).10)(
                ::std::mem::transmute_copy(this),
                useraccountidlist.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::super::Foundation::IAsyncOperation<
                MicrosoftAccountMultiFactorGetSessionsResult,
    ...
    #[cfg(feature = "Foundation")]
    pub fn ApproveSessionUsingAuthSessionInfoAsync<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, MicrosoftAccountMultiFactorSessionInfo>,
    >(
        &self,
        sessionauthentictionstatus: MicrosoftAccountMultiFactorSessionAuthenticationStatus,
        authenticationsessioninfo: Param1,
    ) -> ::windows::runtime::Result<
        super::super::super::super::Foundation::IAsyncOperation<
            MicrosoftAccountMultiFactorServiceResponse,
        >,
    > {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).12)(
                ...
                authenticationsessioninfo.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::super::Foundation::IAsyncOperation<
                MicrosoftAccountMultiFactorServiceResponse,
    ...
    #[cfg(feature = "Foundation")]
    pub fn DenySessionUsingAuthSessionInfoAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, MicrosoftAccountMultiFactorSessionInfo>,
    >(
        &self,
        authenticationsessioninfo: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::super::Foundation::IAsyncOperation<
            MicrosoftAccountMultiFactorServiceResponse,
        >,
    ...
    pub fn Current() -> ::windows::runtime::Result<MicrosoftAccountMultiFactorAuthenticationManager>
    {
        Self::IMicrosoftAccountMultiFactorAuthenticatorStatics(|this| unsafe {
            ...
            .from_abi::<MicrosoftAccountMultiFactorAuthenticationManager>(result__)
        })
    }
    pub fn IMicrosoftAccountMultiFactorAuthenticatorStatics<
        R,
        F: FnOnce(&IMicrosoftAccountMultiFactorAuthenticatorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl ::std::convert::From<MicrosoftAccountMultiFactorAuthenticationManager>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MicrosoftAccountMultiFactorAuthenticationManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl MicrosoftAccountMultiFactorAuthenticationType {
    pub const User: MicrosoftAccountMultiFactorAuthenticationType =
        MicrosoftAccountMultiFactorAuthenticationType(0i32);
    pub const Device: MicrosoftAccountMultiFactorAuthenticationType =
        MicrosoftAccountMultiFactorAuthenticationType(1i32);
}
...
impl MicrosoftAccountMultiFactorGetSessionsResult {
    ...
    pub fn ServiceResponse(
        &self,
    ) -> ::windows::runtime::Result<MicrosoftAccountMultiFactorServiceResponse> {
        let this = self;
        unsafe {
            ...
            .from_abi::<MicrosoftAccountMultiFactorServiceResponse>(result__)
        }
    }
}
...
impl ::std::convert::From<MicrosoftAccountMultiFactorGetSessionsResult>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MicrosoftAccountMultiFactorGetSessionsResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MicrosoftAccountMultiFactorGetSessionsResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<MicrosoftAccountMultiFactorOneTimeCodedInfo>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MicrosoftAccountMultiFactorOneTimeCodedInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MicrosoftAccountMultiFactorOneTimeCodedInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MicrosoftAccountMultiFactorServiceResponse {
    pub const Success: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(0i32);
    pub const Error: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(1i32);
    pub const NoNetworkConnection: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(2i32);
    pub const ServiceUnavailable: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(3i32);
    pub const TotpSetupDenied: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(4i32);
    pub const NgcNotSetup: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(5i32);
    pub const SessionAlreadyDenied: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(6i32);
    pub const SessionAlreadyApproved: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(7i32);
    pub const SessionExpired: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(8i32);
    pub const NgcNonceExpired: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(9i32);
    pub const InvalidSessionId: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(10i32);
    pub const InvalidSessionType: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(11i32);
    pub const InvalidOperation: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(12i32);
    pub const InvalidStateTransition: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(13i32);
    pub const DeviceNotFound: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(14i32);
    pub const FlowDisabled: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(15i32);
    pub const SessionNotApproved: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(16i32);
    pub const OperationCanceledByUser: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(17i32);
    pub const NgcDisabledByServer: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(18i32);
    pub const NgcKeyNotFoundOnServer: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(19i32);
    pub const UIRequired: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(20i32);
    pub const DeviceIdChanged: MicrosoftAccountMultiFactorServiceResponse =
        MicrosoftAccountMultiFactorServiceResponse(21i32);
}
...
impl MicrosoftAccountMultiFactorSessionApprovalStatus {
    pub const Pending: MicrosoftAccountMultiFactorSessionApprovalStatus =
        MicrosoftAccountMultiFactorSessionApprovalStatus(0i32);
    pub const Approved: MicrosoftAccountMultiFactorSessionApprovalStatus =
        MicrosoftAccountMultiFactorSessionApprovalStatus(1i32);
    pub const Denied: MicrosoftAccountMultiFactorSessionApprovalStatus =
        MicrosoftAccountMultiFactorSessionApprovalStatus(2i32);
}
...
impl MicrosoftAccountMultiFactorSessionAuthenticationStatus {
    pub const Authenticated: MicrosoftAccountMultiFactorSessionAuthenticationStatus =
        MicrosoftAccountMultiFactorSessionAuthenticationStatus(0i32);
    pub const Unauthenticated: MicrosoftAccountMultiFactorSessionAuthenticationStatus =
        MicrosoftAccountMultiFactorSessionAuthenticationStatus(1i32);
}
...
unsafe impl ::windows::runtime::RuntimeType
    for MicrosoftAccountMultiFactorSessionAuthenticationStatus
{
...
impl MicrosoftAccountMultiFactorSessionInfo {
    ...
    pub fn ApprovalStatus(
        &self,
    ) -> ::windows::runtime::Result<MicrosoftAccountMultiFactorSessionApprovalStatus> {
        let this = self;
        unsafe {
            let mut result__: MicrosoftAccountMultiFactorSessionApprovalStatus =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<MicrosoftAccountMultiFactorSessionApprovalStatus>(result__)
        }
    }
    pub fn AuthenticationType(
        &self,
    ) -> ::windows::runtime::Result<MicrosoftAccountMultiFactorAuthenticationType> {
        let this = self;
        unsafe {
            ...
            .from_abi::<MicrosoftAccountMultiFactorAuthenticationType>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn RequestTime(
...
impl ::std::convert::From<&MicrosoftAccountMultiFactorSessionInfo>
    for ::windows::runtime::IUnknown
{
    fn from(value: &MicrosoftAccountMultiFactorSessionInfo) -> Self {
        ::std::convert::From::from(::std::clone::Clone::clone(value))
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MicrosoftAccountMultiFactorSessionInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MicrosoftAccountMultiFactorSessionInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo(
    ::windows::runtime::IInspectable,
);
...
impl ::std::convert::From<MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
