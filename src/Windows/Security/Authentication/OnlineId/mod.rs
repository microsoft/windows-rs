...
pub struct IOnlineIdAuthenticator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        requests: ::windows::runtime::RawPtr,
...
pub struct IOnlineIdSystemTicketResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut OnlineIdSystemTicketStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IUserIdentity {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        1858,
        19427,
        [138, 28, 124, 122, 230, 121, 170, 136],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl OnlineIdAuthenticator {
    ...
    #[cfg(feature = "Foundation")]
    pub fn AuthenticateUserAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, OnlineIdServiceTicketRequest>,
    >(
        &self,
        request: Param0,
    ) -> ::windows::runtime::Result<UserAuthenticationOperation> {
        let this = self;
        unsafe {
            ...
            .from_abi::<UserAuthenticationOperation>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn AuthenticateUserAsyncAdvanced<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::Collections::IIterable<OnlineIdServiceTicketRequest>,
        >,
    >(
        &self,
        requests: Param0,
    ...
    pub fn SignOutUserAsync(&self) -> ::windows::runtime::Result<SignOutUserOperation> {
        ...
        unsafe {
            ...
            .from_abi::<SignOutUserOperation>(result__)
        }
    }
    pub fn SetApplicationId<
        'a,
    ...
    pub fn AuthenticatedSafeCustomerId(
        &self,
...
impl OnlineIdServiceTicket {
    ...
    pub fn Request(&self) -> ::windows::runtime::Result<OnlineIdServiceTicketRequest> {
        ...
        unsafe {
            ...
            .from_abi::<OnlineIdServiceTicketRequest>(result__)
        }
    }
...
impl OnlineIdServiceTicketRequest {
    ...
    >(
        service: Param0,
        policy: Param1,
    ) -> ::windows::runtime::Result<OnlineIdServiceTicketRequest> {
    ...
    pub fn IOnlineIdServiceTicketRequestFactory<
        R,
        F: FnOnce(&IOnlineIdServiceTicketRequestFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for OnlineIdServiceTicketRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a OnlineIdServiceTicketRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl OnlineIdSystemAuthenticator {
    pub fn Default() -> ::windows::runtime::Result<OnlineIdSystemAuthenticatorForUser> {
        Self::IOnlineIdSystemAuthenticatorStatics(|this| unsafe {
            ...
            .from_abi::<OnlineIdSystemAuthenticatorForUser>(result__)
        })
    }
    #[cfg(feature = "System")]
    pub fn GetForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
    >(
        user: Param0,
    ) -> ::windows::runtime::Result<OnlineIdSystemAuthenticatorForUser> {
        Self::IOnlineIdSystemAuthenticatorStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn IOnlineIdSystemAuthenticatorStatics<
        R,
        F: FnOnce(&IOnlineIdSystemAuthenticatorStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl OnlineIdSystemAuthenticatorForUser {
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<OnlineIdSystemTicketResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn User(&self) -> ::windows::runtime::Result<super::super::super::System::User> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::System::User>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for OnlineIdSystemAuthenticatorForUser
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&OnlineIdSystemAuthenticatorForUser>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a OnlineIdSystemAuthenticatorForUser
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl OnlineIdSystemIdentity {
    pub fn Ticket(&self) -> ::windows::runtime::Result<OnlineIdServiceTicket> {
        ...
        unsafe {
            ...
            .from_abi::<OnlineIdServiceTicket>(result__)
        }
    }
...
impl OnlineIdSystemTicketResult {
    pub fn Identity(&self) -> ::windows::runtime::Result<OnlineIdSystemIdentity> {
        ...
        unsafe {
            ...
            .from_abi::<OnlineIdSystemIdentity>(result__)
        }
    }
    pub fn Status(&self) -> ::windows::runtime::Result<OnlineIdSystemTicketStatus> {
        ...
        unsafe {
            ...
            .from_abi::<OnlineIdSystemTicketStatus>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for OnlineIdSystemTicketResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a OnlineIdSystemTicketResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SignOutUserOperation {
    ...
    pub fn SetCompleted<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::AsyncActionCompletedHandler,
        >,
    >(
        &self,
        handler: Param0,
    ...
    pub fn Completed(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::AsyncActionCompletedHandler>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::AsyncActionCompletedHandler>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn Id(&self) -> ::windows::runtime::Result<u32> {
        let this = &::windows::runtime::Interface::cast::<
            super::super::super::Foundation::IAsyncInfo,
        >(self)?;
        unsafe {
    ...
    pub fn Status(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::AsyncStatus> {
        let this = &::windows::runtime::Interface::cast::<
            super::super::super::Foundation::IAsyncInfo,
        >(self)?;
        unsafe {
            ...
            .from_abi::<super::super::super::Foundation::AsyncStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn get(&self) -> ::windows::runtime::Result<()> {
        if self.Status()? == super::super::super::Foundation::AsyncStatus::Started {
            ...
            self.SetCompleted(
                super::super::super::Foundation::AsyncActionCompletedHandler::new(
                    move |_sender, _args| {
                        unsafe {
                            signaler.signal();
                        }
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::super::Foundation::IAsyncAction>
    for SignOutUserOperation
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::super::Foundation::IAsyncAction> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<
            super::super::super::Foundation::IAsyncAction,
        >::into(self))
    }
}
#[cfg(feature = "Foundation")]
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<&SignOutUserOperation>
    for super::super::super::Foundation::IAsyncInfo
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: &SignOutUserOperation) -> ::windows::runtime::Result<Self> {
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::super::Foundation::IAsyncInfo>
    for SignOutUserOperation
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::super::Foundation::IAsyncInfo> {
    ...
    for &SignOutUserOperation
{
    fn into_param(
        ...
        ::std::convert::TryInto::<super::super::super::Foundation::IAsyncInfo>::try_into(self)
...
impl UserAuthenticationOperation {
    ...
    pub fn SetCompleted<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::AsyncOperationCompletedHandler<UserIdentity>,
        >,
    >(
        &self,
        handler: Param0,
    ...
    pub fn GetResults(&self) -> ::windows::runtime::Result<UserIdentity> {
        ...
        unsafe {
            ...
            .from_abi::<UserIdentity>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Id(&self) -> ::windows::runtime::Result<u32> {
    ...
    pub fn get(&self) -> ::windows::runtime::Result<UserIdentity> {
        if self.Status()? == super::super::super::Foundation::AsyncStatus::Started {
            let (waiter, signaler) = ::windows::runtime::Waiter::new();
            self.SetCompleted(
                super::super::super::Foundation::AsyncOperationCompletedHandler::new(
                    move |_sender, _args| {
                        unsafe {
                            signaler.signal();
                        }
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for UserAuthenticationOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserAuthenticationOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::From<UserAuthenticationOperation>
    for super::super::super::Foundation::IAsyncOperation<UserIdentity>
{
    fn from(value: UserAuthenticationOperation) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
impl<'a>
    ::windows::runtime::IntoParam<
        'a,
        super::super::super::Foundation::IAsyncOperation<UserIdentity>,
    > for UserAuthenticationOperation
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::super::Foundation::IAsyncOperation<UserIdentity>>
    {
        ::windows::runtime::Param::Owned(::std::convert::Into::<
            super::super::super::Foundation::IAsyncOperation<UserIdentity>,
        >::into(self))
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<UserAuthenticationOperation>
    for super::super::super::Foundation::IAsyncInfo
{
    type Error = ::windows::runtime::Error;
...
impl UserIdentity {
    ...
    pub fn Tickets(
        ...
        super::super::super::Foundation::Collections::IVectorView<OnlineIdServiceTicket>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
