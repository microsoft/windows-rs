...
impl AppCapability {
    ...
    pub fn RequestAccessAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<AppCapabilityAccessStatus>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn CheckAccess(&self) -> ::windows::runtime::Result<AppCapabilityAccessStatus> {
        ...
        unsafe {
            ...
            .from_abi::<AppCapabilityAccessStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    > {
        Self::IAppCapabilityStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                capabilitynames.into_param().abi(),
                &mut result__,
            )
    ...
    pub fn RequestAccessForCapabilitiesForUserAsync<
        'a,
    ...
    ) -> ::windows::runtime::Result<AppCapability> {
        Self::IAppCapabilityStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<AppCapability>(result__)
        })
    }
    #[cfg(feature = "System")]
    pub fn CreateWithProcessIdForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        user: Param0,
        capabilityname: Param1,
        pid: u32,
    ) -> ::windows::runtime::Result<AppCapability> {
        Self::IAppCapabilityStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn IAppCapabilityStatics<
        R,
        F: FnOnce(&IAppCapabilityStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<AppCapability, IAppCapabilityStatics> =
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AppCapabilityAccessChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<AppCapabilityAccessChangedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppCapabilityAccessChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IAppCapability_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppCapabilityAccessStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IAppCapabilityStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        capabilitynames: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
