...
impl CorePerceptionAutomation {
    ...
    pub fn SetActivationFactoryProvider<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::IGetActivationFactory>,
    >(
        provider: Param0,
    ...
    pub fn ICorePerceptionAutomationStatics<
        R,
        F: FnOnce(&ICorePerceptionAutomationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::Interface for ICorePerceptionAutomationStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        19682,
        18723,
        [154, 118, 129, 135, 236, 197, 145, 18],
    );
}
#[repr(C)]
#[doc(hidden)]
