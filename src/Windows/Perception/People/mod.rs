...
impl EyesPose {
    ...
    pub fn Gaze(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IReference<super::Spatial::SpatialRay>>
    {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IReference<super::Spatial::SpatialRay>>(result__)
        }
    }
    pub fn UpdateTimestamp(&self) -> ::windows::runtime::Result<super::PerceptionTimestamp> {
        ...
        unsafe {
            ...
            .from_abi::<super::PerceptionTimestamp>(result__)
        }
    }
    ...
    pub fn RequestAccessAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<super::super::UI::Input::GazeInputAccessStatus>,
    > {
        Self::IEyesPoseStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<
                super::super::UI::Input::GazeInputAccessStatus,
            >>(result__)
        })
    }
    pub fn IEyesPoseStatics<R, F: FnOnce(&IEyesPoseStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<EyesPose, IEyesPoseStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for EyesPose {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Perception.People.EyesPose;{682a9b23-8a1e-5b86-a060-906ffacb62a4})",
    );
}
...
impl HandMeshObserver {
    ...
    pub fn Source(
        &self,
    ) -> ::windows::runtime::Result<super::super::UI::Input::Spatial::SpatialInteractionSource>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::UI::Input::Spatial::SpatialInteractionSource>(result__)
        }
    }
    ...
    pub fn GetTriangleIndices(
        &self,
        indices: &mut [<u16 as ::windows::runtime::Abi>::DefaultType],
        ...
        unsafe {
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
                indices.len() as u32,
                ::std::mem::transmute_copy(&indices),
            )
            .ok()
        }
    }
    pub fn GetVertexStateForPose<'a, Param0: ::windows::runtime::IntoParam<'a, HandPose>>(
        &self,
        handpose: Param0,
    ) -> ::windows::runtime::Result<HandMeshVertexState> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
                ::std::mem::transmute_copy(this),
                handpose.into_param().abi(),
                &mut result__,
            )
            .from_abi::<HandMeshVertexState>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for HandMeshObserver {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Perception.People.HandMeshObserver;{85ae30cb-6fc3-55c4-a7b4-29e33896ca69})",
    );
}
...
impl ::std::fmt::Debug for HandMeshVertex {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("HandMeshVertex")
...
impl HandMeshVertexState {
    ...
    pub fn CoordinateSystem(
        &self,
    ) -> ::windows::runtime::Result<super::Spatial::SpatialCoordinateSystem> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::Spatial::SpatialCoordinateSystem>(result__)
        }
    }
    #[cfg(feature = "Foundation_Numerics")]
    pub fn GetVertices(
        &self,
        vertices: &mut [<HandMeshVertex as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                vertices.len() as u32,
                ::std::mem::transmute_copy(&vertices),
            )
            .ok()
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for HandMeshVertexState {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Perception.People.HandMeshVertexState;{046c5fef-1d8b-55de-ab2c-1cd424886d8f})",
    );
}
...
impl HandPose {
    ...
    pub fn TryGetJoint<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Spatial::SpatialCoordinateSystem>,
    >(
        &self,
    ...
    >(
        &self,
        coordinatesystem: Param0,
        joints: &[<HandJointKind as ::windows::runtime::Abi>::DefaultType],
        jointposes: &mut [<JointPose as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<bool> {
        let this = self;
        unsafe {
            let mut result__: bool = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ...
                coordinatesystem.into_param().abi(),
                joints.len() as u32,
                ::std::mem::transmute(joints.as_ptr()),
                jointposes.len() as u32,
                ::std::mem::transmute_copy(&jointposes),
                &mut result__,
            )
            .from_abi::<bool>(result__)
        }
    ...
    ) -> ::windows::runtime::Result<JointPose> {
        let this = self;
        unsafe {
    ...
    pub fn GetRelativeJoints(
        &self,
        joints: &[<HandJointKind as ::windows::runtime::Abi>::DefaultType],
        referencejoints: &[<HandJointKind as ::windows::runtime::Abi>::DefaultType],
        jointposes: &mut [<JointPose as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).9)(
                ...
                joints.len() as u32,
                ::std::mem::transmute(joints.as_ptr()),
                referencejoints.len() as u32,
                ::std::mem::transmute(referencejoints.as_ptr()),
                jointposes.len() as u32,
                ::std::mem::transmute_copy(&jointposes),
            )
            .ok()
...
unsafe impl ::windows::runtime::RuntimeType for HandPose {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Perception.People.HandPose;{4d98e79a-bb08-5d09-91de-df0dd3fae46c})",
    );
}
unsafe impl ::windows::runtime::Interface for HandPose {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        47880,
        23817,
        [145, 222, 223, 13, 211, 250, 228, 108],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for HeadPose {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Perception.People.HeadPose;{7f5ac5a5-49db-379f-9429-32a2faf34fa6})",
    );
}
...
pub struct IHandMeshObserver_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        indices_array_size: u32,
        indices: *mut u16,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        handpose: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IHandMeshVertexState_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        vertices_array_size: u32,
        vertices: *mut HandMeshVertex,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IHandPose_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        coordinatesystem: ::windows::runtime::RawPtr,
        joints_array_size: u32,
        joints: *const HandJointKind,
        jointPoses_array_size: u32,
    ...
    pub  unsafe extern "system" fn(
        ...
        joints_array_size: u32,
        joints: *const HandJointKind,
        referenceJoints_array_size: u32,
        referencejoints: *const HandJointKind,
        jointPoses_array_size: u32,
        jointposes: *mut JointPose,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Numerics"))] usize,
