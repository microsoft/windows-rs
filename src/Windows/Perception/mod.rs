...
impl PerceptionTimestamp {
    ...
    #[cfg(feature = "Foundation")]
    pub fn SystemRelativeTargetTime(
        &self,
...
unsafe impl ::windows::runtime::RuntimeType for PerceptionTimestamp {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Perception.PerceptionTimestamp;{87c24804-a22e-4adb-ba26-d78ef639bcf4})",
    );
}
...
impl PerceptionTimestampHelper {
    ...
    >(
        targettime: Param0,
    ) -> ::windows::runtime::Result<PerceptionTimestamp> {
        Self::IPerceptionTimestampHelperStatics(|this| unsafe {
            ...
            .from_abi::<PerceptionTimestamp>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn IPerceptionTimestampHelperStatics<
        R,
        F: FnOnce(&IPerceptionTimestampHelperStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IPerceptionTimestampHelperStatics2<
        R,
        F: FnOnce(&IPerceptionTimestampHelperStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
