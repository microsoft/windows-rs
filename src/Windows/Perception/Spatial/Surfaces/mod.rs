...
unsafe impl ::windows::runtime::Interface for ISpatialSurfaceMesh {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        57101,
        14672,
        [160, 253, 249, 114, 199, 124, 39, 180],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialSurfaceObserver {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        56778,
        13443,
        [172, 58, 116, 143, 232, 200, 109, 245],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialSurfaceObserverStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        8456,
        16744,
        [145, 117, 135, 224, 39, 188, 146, 133],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISpatialSurfaceObserverStatics2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        50525,
        20075,
        [168, 149, 161, 157, 230, 154, 66, 227],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl SpatialSurfaceInfo {
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Foundation::IReference<
                super::SpatialBoundingOrientedBox,
            >>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn TryComputeLatestMeshAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<SpatialSurfaceMesh>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<SpatialSurfaceMesh>>(
                result__,
            )
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn TryComputeLatestMeshWithOptionsAsync<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, SpatialSurfaceMeshOptions>,
    >(
        &self,
        maxtrianglespercubicmeter: f64,
        options: Param1,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialSurfaceMeshBuffer
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialSurfaceMeshOptions {
    ...
    #[cfg(all(feature = "Foundation_Collections", feature = "Graphics_DirectX"))]
    pub fn SupportedVertexPositionFormats() -> ::windows::runtime::Result<
    ...
    #[cfg(all(feature = "Foundation_Collections", feature = "Graphics_DirectX"))]
    pub fn SupportedTriangleIndexFormats() -> ::windows::runtime::Result<
        super::super::super::Foundation::Collections::IVectorView<
            super::super::super::Graphics::DirectX::DirectXPixelFormat,
        >,
    > {
    ...
    #[cfg(all(feature = "Foundation_Collections", feature = "Graphics_DirectX"))]
    pub fn SupportedVertexNormalFormats() -> ::windows::runtime::Result<
        super::super::super::Foundation::Collections::IVectorView<
            super::super::super::Graphics::DirectX::DirectXPixelFormat,
        >,
    > {
    ...
    pub fn ISpatialSurfaceMeshOptionsStatics<
        R,
        F: FnOnce(&ISpatialSurfaceMeshOptionsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialSurfaceMeshOptions
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SpatialSurfaceObserver {
    ...
    pub fn SetBoundingVolume<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::SpatialBoundingVolume>,
    >(
        &self,
        bounds: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn SetBoundingVolumes<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::Collections::IIterable<super::SpatialBoundingVolume>,
        >,
    >(
        &self,
        bounds: Param0,
    ...
    #[cfg(feature = "Foundation")]
    pub fn ObservedSurfacesChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveObservedSurfacesChanged<
        'a,
    ...
    pub fn RequestAccessAsync() -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<super::SpatialPerceptionAccessStatus>,
    > {
        Self::ISpatialSurfaceObserverStatics(|this| unsafe {
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<
                super::SpatialPerceptionAccessStatus,
            >>(result__)
        })
    }
    ...
    pub fn ISpatialSurfaceObserverStatics<
        R,
        F: FnOnce(&ISpatialSurfaceObserverStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ISpatialSurfaceObserverStatics2<
        R,
        F: FnOnce(&ISpatialSurfaceObserverStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
