...
unsafe impl ::windows::runtime::Interface for ISpatialGraphInteropFrameOfReferencePreview {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        29535,
        22313,
        [169, 142, 230, 78, 209, 137, 171, 197],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct ISpatialGraphInteropFrameOfReferencePreview_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::Foundation::Numerics::Matrix4x4,
    ) -> ::windows::runtime::HRESULT,
...
pub struct ISpatialGraphInteropPreviewStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        nodeid: ::windows::runtime::GUID,
        relativeposition: super::super::super::Foundation::Numerics::Vector3,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Numerics"))] usize,
    #[cfg(feature = "Foundation_Numerics")]
    pub  unsafe extern "system" fn(
        ...
        nodeid: ::windows::runtime::GUID,
        relativeposition: super::super::super::Foundation::Numerics::Vector3,
        relativeorientation: super::super::super::Foundation::Numerics::Quaternion,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Numerics"))] usize,
    pub  unsafe extern "system" fn(
...
impl SpatialGraphInteropFrameOfReferencePreview {
    pub fn CoordinateSystem(&self) -> ::windows::runtime::Result<super::SpatialCoordinateSystem> {
        ...
        unsafe {
            ...
            .from_abi::<super::SpatialCoordinateSystem>(result__)
        }
    }
    ...
    pub fn CoordinateSystemToNodeTransform(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::Numerics::Matrix4x4> {
        let this = self;
        unsafe {
            let mut result__: super::super::super::Foundation::Numerics::Matrix4x4 =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::Numerics::Matrix4x4>(result__)
        }
    }
}
...
impl ::std::convert::From<SpatialGraphInteropFrameOfReferencePreview>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SpatialGraphInteropFrameOfReferencePreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl SpatialGraphInteropPreview {
    pub fn CreateCoordinateSystemForNode<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::GUID>,
    >(
        nodeid: Param0,
    ) -> ::windows::runtime::Result<super::SpatialCoordinateSystem> {
        Self::ISpatialGraphInteropPreviewStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                nodeid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::SpatialCoordinateSystem>(result__)
        })
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn CreateCoordinateSystemForNodeWithPositionAndOrientation<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::GUID>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Numerics::Vector3>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Numerics::Quaternion>,
    >(
        nodeid: Param0,
        relativeposition: Param1,
        relativeorientation: Param2,
    ) -> ::windows::runtime::Result<super::SpatialCoordinateSystem> {
        Self::ISpatialGraphInteropPreviewStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
    ...
    pub fn CreateLocatorForNode<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::GUID>,
    >(
        nodeid: Param0,
    ) -> ::windows::runtime::Result<super::SpatialLocator> {
        Self::ISpatialGraphInteropPreviewStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::SpatialLocator>(result__)
        })
    }
    pub fn TryCreateFrameOfReference<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::SpatialCoordinateSystem>,
    >(
        coordinatesystem: Param0,
    ) -> ::windows::runtime::Result<SpatialGraphInteropFrameOfReferencePreview> {
        Self::ISpatialGraphInteropPreviewStatics2(|this| unsafe {
            ...
            .from_abi::<SpatialGraphInteropFrameOfReferencePreview>(result__)
        })
    }
    #[cfg(feature = "Foundation_Numerics")]
    pub fn TryCreateFrameOfReferenceWithPosition<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::SpatialCoordinateSystem>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Numerics::Vector3>,
    >(
    ...
    #[cfg(feature = "Foundation_Numerics")]
    pub fn TryCreateFrameOfReferenceWithPositionAndOrientation<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::SpatialCoordinateSystem>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Numerics::Vector3>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Numerics::Quaternion>,
    ...
    pub fn ISpatialGraphInteropPreviewStatics<
        R,
        F: FnOnce(&ISpatialGraphInteropPreviewStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn ISpatialGraphInteropPreviewStatics2<
        R,
        F: FnOnce(&ISpatialGraphInteropPreviewStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
