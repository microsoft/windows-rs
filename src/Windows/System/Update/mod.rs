...
pub struct ISystemUpdateItem_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SystemUpdateItemState,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct ISystemUpdateLastErrorInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SystemUpdateManagerState,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::HRESULT,
...
pub struct ISystemUpdateManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        lockid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SystemUpdateAttentionRequiredReason,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        flightring: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl SystemUpdateAttentionRequiredReason {
    ...
    pub const NetworkRequired: SystemUpdateAttentionRequiredReason =
        SystemUpdateAttentionRequiredReason(1i32);
    pub const InsufficientDiskSpace: SystemUpdateAttentionRequiredReason =
        SystemUpdateAttentionRequiredReason(2i32);
    pub const InsufficientBattery: SystemUpdateAttentionRequiredReason =
        SystemUpdateAttentionRequiredReason(3i32);
    pub const UpdateBlocked: SystemUpdateAttentionRequiredReason =
        SystemUpdateAttentionRequiredReason(4i32);
}
...
impl SystemUpdateItem {
    pub fn State(&self) -> ::windows::runtime::Result<SystemUpdateItemState> {
        ...
        unsafe {
            ...
            .from_abi::<SystemUpdateItemState>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for SystemUpdateItem {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Update.SystemUpdateItem;{779740eb-5624-519e-a8e2-09e9173b3fb7})",
    );
}
...
impl SystemUpdateLastErrorInfo {
    pub fn State(&self) -> ::windows::runtime::Result<SystemUpdateManagerState> {
        ...
        unsafe {
            ...
            .from_abi::<SystemUpdateManagerState>(result__)
        }
    }
    pub fn ExtendedError(&self) -> ::windows::runtime::Result<::windows::runtime::HRESULT> {
        let this = self;
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SystemUpdateLastErrorInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SystemUpdateManager {
    ...
    pub fn LastErrorInfo() -> ::windows::runtime::Result<SystemUpdateLastErrorInfo> {
        Self::ISystemUpdateManagerStatics(|this| unsafe {
            ...
            .from_abi::<SystemUpdateLastErrorInfo>(result__)
        })
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetAutomaticRebootBlockIds() -> ::windows::runtime::Result<
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetUpdateItems() -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<SystemUpdateItem>,
    > {
        Self::ISystemUpdateManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<SystemUpdateItem>>(
                result__,
            )
        })
    }
    pub fn AttentionRequiredReason(
    ) -> ::windows::runtime::Result<SystemUpdateAttentionRequiredReason> {
        Self::ISystemUpdateManagerStatics(|this| unsafe {
            ...
            .from_abi::<SystemUpdateAttentionRequiredReason>(result__)
        })
    }
    pub fn SetFlightRing<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        flightring: Param0,
    ...
    pub fn ISystemUpdateManagerStatics<
        R,
        F: FnOnce(&ISystemUpdateManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
