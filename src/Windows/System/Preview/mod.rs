...
unsafe impl ::windows::runtime::RuntimeType for HingeState {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.System.Preview.HingeState;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
pub struct ITwoPanelHingedDevicePosturePreviewReading_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut HingeState,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Devices_Sensors")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::Devices::Sensors::SimpleOrientation,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface
    for ITwoPanelHingedDevicePosturePreviewReadingChangedEventArgs
{
...
impl TwoPanelHingedDevicePosturePreview {
    ...
    #[cfg(feature = "Foundation")]
    pub fn GetCurrentPostureAsync(
        &self,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<TwoPanelHingedDevicePosturePreviewReading>,
    > {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn GetDefaultAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<TwoPanelHingedDevicePosturePreview>,
    > {
    ...
    pub fn ITwoPanelHingedDevicePosturePreviewStatics<
        R,
        F: FnOnce(&ITwoPanelHingedDevicePosturePreviewStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for TwoPanelHingedDevicePosturePreview
{
...
impl ::std::convert::From<&TwoPanelHingedDevicePosturePreview>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a TwoPanelHingedDevicePosturePreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl TwoPanelHingedDevicePosturePreviewReading {
    ...
    pub fn HingeState(&self) -> ::windows::runtime::Result<HingeState> {
        ...
        unsafe {
            ...
            .from_abi::<HingeState>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Devices_Sensors")]
    pub fn Panel1Orientation(
        &self,
    ) -> ::windows::runtime::Result<super::super::Devices::Sensors::SimpleOrientation> {
        let this = self;
        unsafe {
            let mut result__: super::super::Devices::Sensors::SimpleOrientation =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::Devices::Sensors::SimpleOrientation>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
...
impl ::std::convert::From<TwoPanelHingedDevicePosturePreviewReading>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for TwoPanelHingedDevicePosturePreviewReading
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a TwoPanelHingedDevicePosturePreviewReading
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct TwoPanelHingedDevicePosturePreviewReadingChangedEventArgs(
    ::windows::runtime::IInspectable,
);
impl TwoPanelHingedDevicePosturePreviewReadingChangedEventArgs {
    ...
    pub fn Reading(&self) -> ::windows::runtime::Result<TwoPanelHingedDevicePosturePreviewReading> {
        ...
        unsafe {
            ...
            .from_abi::<TwoPanelHingedDevicePosturePreviewReading>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType
    for TwoPanelHingedDevicePosturePreviewReadingChangedEventArgs
{
...
impl ::std::convert::From<TwoPanelHingedDevicePosturePreviewReadingChangedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a TwoPanelHingedDevicePosturePreviewReadingChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
