...
pub struct IRemoteTextConnectionFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        pduforwarder: ::windows::runtime::RawPtr,
...
impl RemoteTextConnection {
    ...
    pub fn ReportDataReceived(
        &self,
        pdudata: &[<u8 as ::windows::runtime::Abi>::DefaultType],
        ...
        unsafe {
            (::windows::runtime::Interface::vtable(this).10)(
                ::std::mem::transmute_copy(this),
                pdudata.len() as u32,
                ::std::mem::transmute(pdudata.as_ptr()),
            )
            .ok()
        }
    }
    pub fn CreateInstance<
        ...
        Param1: ::windows::runtime::IntoParam<'a, RemoteTextConnectionDataHandler>,
    >(
        connectionid: Param0,
        pduforwarder: Param1,
    ) -> ::windows::runtime::Result<RemoteTextConnection> {
        Self::IRemoteTextConnectionFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                connectionid.into_param().abi(),
                pduforwarder.into_param().abi(),
                &mut result__,
            )
            .from_abi::<RemoteTextConnection>(result__)
        })
    }
    pub fn IRemoteTextConnectionFactory<
        R,
        F: FnOnce(&IRemoteTextConnectionFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl RemoteTextConnectionDataHandler {
    pub fn new<
        F: FnMut(
                &[<u8 as ::windows::runtime::Abi>::DefaultType],
...
unsafe impl ::windows::runtime::RuntimeType for RemoteTextConnectionDataHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({099ffbc8-8bcb-41b5-b056-57e77021bf1b})",
    );
}
...
#[repr(C)]
struct RemoteTextConnectionDataHandler_box<
    F: FnMut(&[<u8 as ::windows::runtime::Abi>::DefaultType]) -> ::windows::runtime::Result<bool>
        + 'static,
> {
...
impl<
        F: FnMut(
            ...
            + 'static,
    > RemoteTextConnectionDataHandler_box<F>
{
    const VTABLE: RemoteTextConnectionDataHandler_abi = RemoteTextConnectionDataHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid
            == &<RemoteTextConnectionDataHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        match ((*this).invoke)(::std::slice::from_raw_parts(
            ::std::mem::transmute_copy(&pdudata),
            pduData_array_size as _,
        )) {
