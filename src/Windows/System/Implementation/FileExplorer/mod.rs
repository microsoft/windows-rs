...
pub struct ISysStorageProviderEventReceivedEventArgsFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        json: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
unsafe impl ::windows::runtime::Interface for ISysStorageProviderEventSource {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        38214,
        21354,
        [131, 129, 47, 154, 44, 8, 206, 221],
    );
}
impl ISysStorageProviderEventSource {
    #[cfg(feature = "Foundation")]
    pub fn EventReceived<
        'a,
...
unsafe impl ::windows::runtime::RuntimeType for ISysStorageProviderEventSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{1f36c476-9546-536a-8381-2f9a2c08cedd}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ISysStorageProviderEventSource
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ISysStorageProviderEventSource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl ISysStorageProviderHandlerFactory {
    ...
    >(
        &self,
        syncrootid: Param0,
    ) -> ::windows::runtime::Result<ISysStorageProviderHttpRequestProvider> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                syncrootid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<ISysStorageProviderHttpRequestProvider>(result__)
        }
    }
    ...
    >(
        ...
        syncrootid: Param0,
        eventname: Param1,
    ) -> ::windows::runtime::Result<ISysStorageProviderEventSource> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<ISysStorageProviderEventSource>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ISysStorageProviderHandlerFactory {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{ee798431-8213-5e89-a623-14d8c72b8a61}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ISysStorageProviderHandlerFactory
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ISysStorageProviderHandlerFactory
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct ISysStorageProviderHandlerFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        syncrootid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl ISysStorageProviderHttpRequestProvider {
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Web::Http::HttpResponseMessage,
        >,
    > {
        let this = self;
        unsafe {
...
unsafe impl ::windows::runtime::RuntimeType for ISysStorageProviderHttpRequestProvider {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{cb6fefb6-e76a-5c25-a33e-3e78a6e0e0ce}");
}
...
impl ::std::convert::From<&ISysStorageProviderHttpRequestProvider>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ISysStorageProviderHttpRequestProvider
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ISysStorageProviderHttpRequestProvider
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SysStorageProviderEventReceivedEventArgs {
    ...
    >(
        json: Param0,
    ) -> ::windows::runtime::Result<SysStorageProviderEventReceivedEventArgs> {
        Self::ISysStorageProviderEventReceivedEventArgsFactory(|this| unsafe {
            ...
            .from_abi::<SysStorageProviderEventReceivedEventArgs>(result__)
        })
    }
    pub fn ISysStorageProviderEventReceivedEventArgsFactory<
        R,
        F: FnOnce(&ISysStorageProviderEventReceivedEventArgsFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl ::std::convert::From<SysStorageProviderEventReceivedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SysStorageProviderEventReceivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SysStorageProviderEventReceivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
