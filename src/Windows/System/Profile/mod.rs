...
impl AnalyticsInfo {
    pub fn VersionInfo() -> ::windows::runtime::Result<AnalyticsVersionInfo> {
        Self::IAnalyticsInfoStatics(|this| unsafe {
            ...
            .from_abi::<AnalyticsVersionInfo>(result__)
        })
    }
    ...
    pub fn IAnalyticsInfoStatics<
        R,
        F: FnOnce(&IAnalyticsInfoStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<AnalyticsInfo, IAnalyticsInfoStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IAnalyticsInfoStatics2<
        R,
        F: FnOnce(&IAnalyticsInfoStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<AnalyticsInfo, IAnalyticsInfoStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for AnalyticsVersionInfo {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Profile.AnalyticsVersionInfo;{926130b8-9955-4c74-bdc1-7cd0decf9b03})",
    );
}
...
impl AppApplicability {
    ...
    pub fn GetUnsupportedAppRequirements<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<::windows::runtime::HSTRING>,
    ...
    >(
        ...
        super::super::Foundation::Collections::IVectorView<UnsupportedAppRequirement>,
    > {
        Self::IAppApplicabilityStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                capabilities.into_param().abi(),
                &mut result__,
            )
    ...
    pub fn IAppApplicabilityStatics<
        R,
        F: FnOnce(&IAppApplicabilityStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
...
impl EducationSettings {
    ...
    pub fn IEducationSettingsStatics<
        R,
        F: FnOnce(&IEducationSettingsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl HardwareIdentification {
    ...
    >(
        ...
        Self::IHardwareIdentificationStatics(|this| unsafe {
            ...
            .from_abi::<HardwareToken>(result__)
        })
    }
    pub fn IHardwareIdentificationStatics<
        R,
        F: FnOnce(&IHardwareIdentificationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for HardwareToken {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Profile.HardwareToken;{28f6d4c0-fb12-40a4-8167-7f4e03d2724c})",
    );
}
...
pub struct IAppApplicabilityStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        capabilities: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IPlatformDiagnosticsAndUsageDataSettingsStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PlatformDataCollectionLevel,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        level: PlatformDataCollectionLevel,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct ISystemIdentificationInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SystemIdentificationSource,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct ISystemSetupInfoStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SystemOutOfBoxExperienceState,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IUnsupportedAppRequirement {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        35147,
        23740,
        [137, 118, 169, 142, 10, 155, 153, 141],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IUnsupportedAppRequirement_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UnsupportedAppRequirementReasons,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl KnownRetailInfoProperties {
    ...
    pub fn IKnownRetailInfoPropertiesStatics<
        R,
        F: FnOnce(&IKnownRetailInfoPropertiesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl PlatformDiagnosticsAndUsageDataSettings {
    pub fn CollectionLevel() -> ::windows::runtime::Result<PlatformDataCollectionLevel> {
        Self::IPlatformDiagnosticsAndUsageDataSettingsStatics(|this| unsafe {
            ...
            .from_abi::<PlatformDataCollectionLevel>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn CollectionLevelChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveCollectionLevelChanged<
        'a,
    ...
    pub fn IPlatformDiagnosticsAndUsageDataSettingsStatics<
        R,
        F: FnOnce(&IPlatformDiagnosticsAndUsageDataSettingsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl RetailInfo {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn Properties() -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IMapView<
            ::windows::runtime::HSTRING,
    ...
    pub fn IRetailInfoStatics<
        R,
        F: FnOnce(&IRetailInfoStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<RetailInfo, IRetailInfoStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl SharedModeSettings {
    ...
    pub fn ISharedModeSettingsStatics<
        R,
        F: FnOnce(&ISharedModeSettingsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ISharedModeSettingsStatics2<
        R,
        F: FnOnce(&ISharedModeSettingsStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl SystemIdentification {
    pub fn GetSystemIdForPublisher() -> ::windows::runtime::Result<SystemIdentificationInfo> {
        Self::ISystemIdentificationStatics(|this| unsafe {
            ...
            .from_abi::<SystemIdentificationInfo>(result__)
        })
    }
    pub fn GetSystemIdForUser<'a, Param0: ::windows::runtime::IntoParam<'a, super::User>>(
        user: Param0,
    ) -> ::windows::runtime::Result<SystemIdentificationInfo> {
        Self::ISystemIdentificationStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn ISystemIdentificationStatics<
        R,
        F: FnOnce(&ISystemIdentificationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl SystemIdentificationInfo {
    ...
    pub fn Source(&self) -> ::windows::runtime::Result<SystemIdentificationSource> {
        ...
        unsafe {
            ...
            .from_abi::<SystemIdentificationSource>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SystemIdentificationInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SystemSetupInfo {
    pub fn OutOfBoxExperienceState() -> ::windows::runtime::Result<SystemOutOfBoxExperienceState> {
        Self::ISystemSetupInfoStatics(|this| unsafe {
            ...
            .from_abi::<SystemOutOfBoxExperienceState>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn OutOfBoxExperienceStateChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::EventHandler<::windows::runtime::IInspectable>,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveOutOfBoxExperienceStateChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        token: Param0,
    ...
    pub fn ISystemSetupInfoStatics<
        R,
        F: FnOnce(&ISystemSetupInfoStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl UnsupportedAppRequirement {
    ...
    pub fn Reasons(&self) -> ::windows::runtime::Result<UnsupportedAppRequirementReasons> {
        ...
        unsafe {
            ...
            .from_abi::<UnsupportedAppRequirementReasons>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UnsupportedAppRequirement
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl UnsupportedAppRequirementReasons {
    ...
    pub const DeniedBySystem: UnsupportedAppRequirementReasons =
        UnsupportedAppRequirementReasons(1u32);
}
...
impl WindowsIntegrityPolicy {
    ...
    pub fn IWindowsIntegrityPolicyStatics<
        R,
        F: FnOnce(&IWindowsIntegrityPolicyStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
