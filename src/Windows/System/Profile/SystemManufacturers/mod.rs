...
unsafe impl ::windows::runtime::Interface for IOemSupportInfo {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        34799,
        16998,
        [134, 208, 196, 175, 190, 178, 155, 185],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISystemSupportDeviceInfo {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        33351,
        17435,
        [169, 150, 161, 120, 75, 171, 121, 168],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl SmbiosInformation {
    ...
    pub fn ISmbiosInformationStatics<
        R,
        F: FnOnce(&ISmbiosInformationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl SystemSupportInfo {
    ...
    pub fn OemSupportInfo() -> ::windows::runtime::Result<OemSupportInfo> {
        Self::ISystemSupportInfoStatics(|this| unsafe {
            ...
            .from_abi::<OemSupportInfo>(result__)
        })
    }
    pub fn LocalDeviceInfo() -> ::windows::runtime::Result<SystemSupportDeviceInfo> {
        Self::ISystemSupportInfoStatics2(|this| unsafe {
            ...
            .from_abi::<SystemSupportDeviceInfo>(result__)
        })
    }
    pub fn ISystemSupportInfoStatics<
        R,
        F: FnOnce(&ISystemSupportInfoStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ISystemSupportInfoStatics2<
        R,
        F: FnOnce(&ISystemSupportInfoStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
