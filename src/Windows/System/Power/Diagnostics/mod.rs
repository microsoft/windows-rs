...
impl BackgroundEnergyDiagnostics {
    ...
    pub fn IBackgroundEnergyDiagnosticsStatics<
        R,
        F: FnOnce(&IBackgroundEnergyDiagnosticsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl ForegroundEnergyDiagnostics {
    ...
    pub fn IForegroundEnergyDiagnosticsStatics<
        R,
        F: FnOnce(&IForegroundEnergyDiagnosticsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
#[doc(hidden)]
pub struct IBackgroundEnergyDiagnosticsStatics(::windows::runtime::IInspectable);
...
#[doc(hidden)]
pub struct IForegroundEnergyDiagnosticsStatics(::windows::runtime::IInspectable);
