...
impl BackgroundEnergyManager {
    ...
    pub fn RecentEnergyUsageIncreased<
        'a,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn RemoveRecentEnergyUsageIncreased<
        'a,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn RecentEnergyUsageReturnedToLow<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::EventHandler<::windows::runtime::IInspectable>,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn RemoveRecentEnergyUsageReturnedToLow<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        token: Param0,
    ...
    pub fn IBackgroundEnergyManagerStatics<
        R,
        F: FnOnce(&IBackgroundEnergyManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for BatteryStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.System.Power.BatteryStatus;i4)");
}
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
impl ForegroundEnergyManager {
    ...
    pub fn IForegroundEnergyManagerStatics<
        R,
        F: FnOnce(&IForegroundEnergyManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
