...
unsafe impl ::windows::runtime::Interface for IPreallocatedWorkItemFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        57322,
        18075,
        [130, 197, 246, 227, 206, 253, 234, 251],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl PreallocatedWorkItem {
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateWorkItem<'a, Param0: ::windows::runtime::IntoParam<'a, super::WorkItemHandler>>(
        handler: Param0,
    ) -> ::windows::runtime::Result<PreallocatedWorkItem> {
        Self::IPreallocatedWorkItemFactory(|this| unsafe {
            ...
            .from_abi::<PreallocatedWorkItem>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn CreateWorkItemWithPriority<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::WorkItemHandler>,
    >(
        handler: Param0,
        priority: super::WorkItemPriority,
    ) -> ::windows::runtime::Result<PreallocatedWorkItem> {
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateWorkItemWithPriorityAndOptions<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::WorkItemHandler>,
    >(
        handler: Param0,
    ...
    pub fn IPreallocatedWorkItemFactory<
        R,
        F: FnOnce(&IPreallocatedWorkItemFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl SignalHandler {
    pub fn new<
        F: FnMut(&::std::option::Option<SignalNotifier>, bool) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ) -> Self {
    ...
    pub fn Invoke<'a, Param0: ::windows::runtime::IntoParam<'a, SignalNotifier>>(
        &self,
        signalnotifier: Param0,
        timedout: bool,
...
unsafe impl ::windows::runtime::RuntimeType for SignalHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({923c402e-4721-440e-9dda-55b6f2e07710})",
    );
}
...
pub struct SignalHandler_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        signalnotifier: ::windows::runtime::RawPtr,
        timedout: bool,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(C)]
struct SignalHandler_box<
    F: FnMut(&::std::option::Option<SignalNotifier>, bool) -> ::windows::runtime::Result<()> + 'static,
> {
...
impl<
    ...
    > SignalHandler_box<F>
{
    const VTABLE: SignalHandler_abi = SignalHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid == &<SignalHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&signalnotifier as *const <SignalNotifier as ::windows::runtime::Abi>::Abi
                as *const <SignalNotifier as ::windows::runtime::Abi>::DefaultType),
            timedout,
        )
        .into()
    }
...
impl SignalNotifier {
    ...
    pub fn AttachToEvent<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, SignalHandler>,
    >(
        name: Param0,
        handler: Param1,
    ) -> ::windows::runtime::Result<SignalNotifier> {
        Self::ISignalNotifierStatics(|this| unsafe {
            ...
            .from_abi::<SignalNotifier>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn AttachToEventWithTimeout<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, SignalHandler>,
    ...
    #[cfg(feature = "Foundation")]
    pub fn AttachToSemaphoreWithTimeout<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, SignalHandler>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::TimeSpan>,
    ...
    pub fn ISignalNotifierStatics<
        R,
        F: FnOnce(&ISignalNotifierStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for SignalNotifier {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Threading.Core.SignalNotifier;{14285e06-63a7-4713-b6d9-62f64b56fb8b})",
    );
}
