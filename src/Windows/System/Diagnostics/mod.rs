...
impl DiagnosticInvoker {
    ...
    pub fn RunDiagnosticActionAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Data::Json::JsonObject>,
    >(
        &self,
        context: Param0,
    ...
    pub fn GetDefault() -> ::windows::runtime::Result<DiagnosticInvoker> {
        Self::IDiagnosticInvokerStatics(|this| unsafe {
            ...
            .from_abi::<DiagnosticInvoker>(result__)
        })
    }
    pub fn GetForUser<'a, Param0: ::windows::runtime::IntoParam<'a, super::User>>(
        user: Param0,
    ) -> ::windows::runtime::Result<DiagnosticInvoker> {
        Self::IDiagnosticInvokerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn IDiagnosticInvokerStatics<
        R,
        F: FnOnce(&IDiagnosticInvokerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for DiagnosticInvoker {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Diagnostics.DiagnosticInvoker;{187b270a-02e3-4f86-84fc-fdd892b5940f})",
    );
}
...
unsafe impl ::windows::runtime::Interface for IProcessDiskUsage {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        32337,
        20051,
        [191, 170, 90, 110, 225, 170, 187, 248],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IProcessMemoryUsageReport {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        6481,
        18053,
        [133, 50, 126, 116, 158, 207, 142, 235],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISystemDiagnosticInfoStatics2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::ProcessorArchitecture,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl ProcessCpuUsage {
    pub fn GetReport(&self) -> ::windows::runtime::Result<ProcessCpuUsageReport> {
        ...
        unsafe {
            ...
            .from_abi::<ProcessCpuUsageReport>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ProcessCpuUsage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Diagnostics.ProcessCpuUsage;{0bbb2472-c8bf-423a-a810-b559ae4354e2})",
    );
}
...
impl ProcessDiagnosticInfo {
    ...
    pub fn Parent(&self) -> ::windows::runtime::Result<ProcessDiagnosticInfo> {
        ...
        unsafe {
            ...
            .from_abi::<ProcessDiagnosticInfo>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ProcessStartTime(
        &self,
    ...
    pub fn DiskUsage(&self) -> ::windows::runtime::Result<ProcessDiskUsage> {
        ...
        unsafe {
            ...
            .from_abi::<ProcessDiskUsage>(result__)
        }
    }
    pub fn MemoryUsage(&self) -> ::windows::runtime::Result<ProcessMemoryUsage> {
        ...
        unsafe {
            ...
            .from_abi::<ProcessMemoryUsage>(result__)
        }
    }
    pub fn CpuUsage(&self) -> ::windows::runtime::Result<ProcessCpuUsage> {
        ...
        unsafe {
            ...
            .from_abi::<ProcessCpuUsage>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetForProcesses() -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<ProcessDiagnosticInfo>,
    > {
        Self::IProcessDiagnosticInfoStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<ProcessDiagnosticInfo>>(
                result__,
            )
        })
    }
    ...
    pub fn GetAppDiagnosticInfos(
        ...
        super::super::Foundation::Collections::IVector<super::AppDiagnosticInfo>,
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<super::AppDiagnosticInfo>>(
                result__,
            )
        }
    }
    ...
    pub fn IProcessDiagnosticInfoStatics<
        R,
        F: FnOnce(&IProcessDiagnosticInfoStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IProcessDiagnosticInfoStatics2<
        R,
        F: FnOnce(&IProcessDiagnosticInfoStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl ProcessDiskUsage {
    pub fn GetReport(&self) -> ::windows::runtime::Result<ProcessDiskUsageReport> {
        ...
        unsafe {
            ...
            .from_abi::<ProcessDiskUsageReport>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ProcessDiskUsage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Diagnostics.ProcessDiskUsage;{5ad78bfd-7e51-4e53-bfaa-5a6ee1aabbf8})",
    );
}
...
impl ProcessMemoryUsage {
    pub fn GetReport(&self) -> ::windows::runtime::Result<ProcessMemoryUsageReport> {
        ...
        unsafe {
            ...
            .from_abi::<ProcessMemoryUsageReport>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ProcessMemoryUsage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Diagnostics.ProcessMemoryUsage;{f50b229b-827c-42b7-b07c-0e32627e6b3e})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ProcessMemoryUsageReport
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SystemCpuUsage {
    pub fn GetReport(&self) -> ::windows::runtime::Result<SystemCpuUsageReport> {
        ...
        unsafe {
            ...
            .from_abi::<SystemCpuUsageReport>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for SystemCpuUsage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Diagnostics.SystemCpuUsage;{6037b3ac-02d6-4234-8362-7fe3adc81f5f})",
    );
}
...
impl SystemDiagnosticInfo {
    pub fn MemoryUsage(&self) -> ::windows::runtime::Result<SystemMemoryUsage> {
        ...
        unsafe {
            ...
            .from_abi::<SystemMemoryUsage>(result__)
        }
    }
    pub fn CpuUsage(&self) -> ::windows::runtime::Result<SystemCpuUsage> {
        ...
        unsafe {
            ...
            .from_abi::<SystemCpuUsage>(result__)
        }
    }
    pub fn GetForCurrentSystem() -> ::windows::runtime::Result<SystemDiagnosticInfo> {
        Self::ISystemDiagnosticInfoStatics(|this| unsafe {
            ...
            .from_abi::<SystemDiagnosticInfo>(result__)
        })
    }
    ...
    pub fn PreferredArchitecture() -> ::windows::runtime::Result<super::ProcessorArchitecture> {
        Self::ISystemDiagnosticInfoStatics2(|this| unsafe {
            ...
            .from_abi::<super::ProcessorArchitecture>(result__)
        })
    }
    pub fn ISystemDiagnosticInfoStatics<
        R,
        F: FnOnce(&ISystemDiagnosticInfoStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ISystemDiagnosticInfoStatics2<
        R,
        F: FnOnce(&ISystemDiagnosticInfoStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl SystemMemoryUsage {
    pub fn GetReport(&self) -> ::windows::runtime::Result<SystemMemoryUsageReport> {
        ...
        unsafe {
            ...
            .from_abi::<SystemMemoryUsageReport>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for SystemMemoryUsage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.System.Diagnostics.SystemMemoryUsage;{17ffc595-1702-49cf-aa27-2f0a32591404})",
    );
}
