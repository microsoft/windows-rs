...
unsafe impl ::windows::runtime::Interface for IPlatformTelemetryClientStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        54723,
        20202,
        [141, 190, 156, 141, 187, 13, 157, 143],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPlatformTelemetryRegistrationResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PlatformTelemetryRegistrationStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl PlatformTelemetryClient {
    pub fn Register<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        id: Param0,
    ) -> ::windows::runtime::Result<PlatformTelemetryRegistrationResult> {
        Self::IPlatformTelemetryClientStatics(|this| unsafe {
            ...
            .from_abi::<PlatformTelemetryRegistrationResult>(result__)
        })
    }
    pub fn RegisterWithSettings<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, PlatformTelemetryRegistrationSettings>,
    >(
        id: Param0,
        settings: Param1,
    ) -> ::windows::runtime::Result<PlatformTelemetryRegistrationResult> {
    ...
    pub fn IPlatformTelemetryClientStatics<
        R,
        F: FnOnce(&IPlatformTelemetryClientStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl PlatformTelemetryRegistrationResult {
    pub fn Status(&self) -> ::windows::runtime::Result<PlatformTelemetryRegistrationStatus> {
        ...
        unsafe {
            ...
            .from_abi::<PlatformTelemetryRegistrationStatus>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PlatformTelemetryRegistrationResult
{
...
impl ::std::convert::From<PlatformTelemetryRegistrationResult>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PlatformTelemetryRegistrationResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PlatformTelemetryRegistrationSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<PlatformTelemetryRegistrationSettings>
    for ::windows::runtime::IInspectable
{
    fn from(value: PlatformTelemetryRegistrationSettings) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PlatformTelemetryRegistrationSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PlatformTelemetryRegistrationStatus {
    pub const Success: PlatformTelemetryRegistrationStatus =
        PlatformTelemetryRegistrationStatus(0i32);
    pub const SettingsOutOfRange: PlatformTelemetryRegistrationStatus =
        PlatformTelemetryRegistrationStatus(1i32);
    pub const UnknownFailure: PlatformTelemetryRegistrationStatus =
        PlatformTelemetryRegistrationStatus(2i32);
}
