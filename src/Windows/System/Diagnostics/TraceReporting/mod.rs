...
pub struct IPlatformDiagnosticActionsStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        scenarioid: ::windows::runtime::GUID,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        ...
        outputdirectory: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        timestampoutputdirectory: bool,
        forceescalationupload: bool,
        triggers: ::windows::runtime::RawPtr,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        partner: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        feature: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        isscenarionamespace: bool,
        downloadovercostednetwork: bool,
        downloadoverbattery: bool,
        result__: *mut PlatformDiagnosticActionState,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation_Collections")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        ...
        result__: *mut PlatformDiagnosticTraceSlotState,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        slottype: PlatformDiagnosticTraceSlotType,
...
unsafe impl ::windows::runtime::Interface for IPlatformDiagnosticTraceInfo {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        54679,
        19447,
        [136, 220, 207, 92, 125, 194, 161, 210],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IPlatformDiagnosticTraceInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PlatformDiagnosticTracePriority,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl PlatformDiagnosticActionState {
    ...
    pub const FreeNetworkNotAvailable: PlatformDiagnosticActionState =
        PlatformDiagnosticActionState(1i32);
    pub const ACPowerNotAvailable: PlatformDiagnosticActionState =
        PlatformDiagnosticActionState(2i32);
}
...
impl PlatformDiagnosticActions {
    ...
    >(
        ...
        downloadovercostednetwork: bool,
        downloadoverbattery: bool,
    ) -> ::windows::runtime::Result<PlatformDiagnosticActionState> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__: PlatformDiagnosticActionState = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                partner.into_param().abi(),
            ...
            .from_abi::<PlatformDiagnosticActionState>(result__)
        })
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetActiveScenarioList() -> ::windows::runtime::Result<
        super::super::super::Foundation::Collections::IVectorView<::windows::runtime::GUID>,
    > {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
    ...
    >(
        ...
        scenarioid: Param1,
        traceprofilehash: u64,
    ) -> ::windows::runtime::Result<PlatformDiagnosticTraceSlotState> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            ...
            .from_abi::<PlatformDiagnosticTraceSlotState>(result__)
        })
    }
    pub fn GetActiveTraceRuntime(
        slottype: PlatformDiagnosticTraceSlotType,
    ) -> ::windows::runtime::Result<PlatformDiagnosticTraceRuntimeInfo> {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<PlatformDiagnosticTraceRuntimeInfo>(result__)
        })
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetKnownTraceList(
        ...
        super::super::super::Foundation::Collections::IVectorView<PlatformDiagnosticTraceInfo>,
    > {
        Self::IPlatformDiagnosticActionsStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn IPlatformDiagnosticActionsStatics<
        R,
        F: FnOnce(&IPlatformDiagnosticActionsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl PlatformDiagnosticEscalationType {
    pub const OnCompletion: PlatformDiagnosticEscalationType =
        PlatformDiagnosticEscalationType(0i32);
...
impl PlatformDiagnosticEventBufferLatencies {
    pub const Normal: PlatformDiagnosticEventBufferLatencies =
        PlatformDiagnosticEventBufferLatencies(1u32);
    pub const CostDeferred: PlatformDiagnosticEventBufferLatencies =
        PlatformDiagnosticEventBufferLatencies(2u32);
    pub const Realtime: PlatformDiagnosticEventBufferLatencies =
        PlatformDiagnosticEventBufferLatencies(4u32);
}
...
impl PlatformDiagnosticTraceInfo {
    ...
    pub fn Priority(&self) -> ::windows::runtime::Result<PlatformDiagnosticTracePriority> {
        ...
        unsafe {
            ...
            .from_abi::<PlatformDiagnosticTracePriority>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PlatformDiagnosticTraceInfo
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PlatformDiagnosticTraceInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl ::std::convert::From<&PlatformDiagnosticTraceRuntimeInfo>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PlatformDiagnosticTraceRuntimeInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
