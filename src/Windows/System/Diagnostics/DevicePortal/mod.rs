...
impl DevicePortalConnection {
    ...
    pub fn GetForAppServiceConnection<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::ApplicationModel::AppService::AppServiceConnection,
        >,
    >(
        appserviceconnection: Param0,
    ) -> ::windows::runtime::Result<DevicePortalConnection> {
        Self::IDevicePortalConnectionStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                appserviceconnection.into_param().abi(),
                &mut result__,
            )
            .from_abi::<DevicePortalConnection>(result__)
        })
    }
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerMessageWebSocketForRequest<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Web::Http::HttpRequestMessage>,
    >(
        &self,
        request: Param0,
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerMessageWebSocketForRequest2<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Web::Http::HttpRequestMessage>,
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerMessageWebSocketForRequest3<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Web::Http::HttpRequestMessage>,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
    ...
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerStreamWebSocketForRequest<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Web::Http::HttpRequestMessage>,
    >(
        &self,
        request: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Networking::Sockets::ServerStreamWebSocket>
    {
        let this = &::windows::runtime::Interface::cast::<IDevicePortalWebSocketConnection>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Networking::Sockets::ServerStreamWebSocket>(result__)
        }
    }
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
    pub fn GetServerStreamWebSocketForRequest2<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Web::Http::HttpRequestMessage>,
    ...
    pub fn IDevicePortalConnectionStatics<
        R,
        F: FnOnce(&IDevicePortalConnectionStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl DevicePortalConnectionClosedEventArgs {
    pub fn Reason(&self) -> ::windows::runtime::Result<DevicePortalConnectionClosedReason> {
        ...
        unsafe {
            ...
            .from_abi::<DevicePortalConnectionClosedReason>(result__)
        }
    }
}
...
impl ::std::convert::From<DevicePortalConnectionClosedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DevicePortalConnectionClosedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl DevicePortalConnectionClosedReason {
    pub const Unknown: DevicePortalConnectionClosedReason =
        DevicePortalConnectionClosedReason(0i32);
    pub const ResourceLimitsExceeded: DevicePortalConnectionClosedReason =
        DevicePortalConnectionClosedReason(1i32);
    pub const ProtocolError: DevicePortalConnectionClosedReason =
        DevicePortalConnectionClosedReason(2i32);
    pub const NotAuthorized: DevicePortalConnectionClosedReason =
        DevicePortalConnectionClosedReason(3i32);
    pub const UserNotPresent: DevicePortalConnectionClosedReason =
        DevicePortalConnectionClosedReason(4i32);
    pub const ServiceTerminated: DevicePortalConnectionClosedReason =
        DevicePortalConnectionClosedReason(5i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for DevicePortalConnectionClosedReason {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.System.Diagnostics.DevicePortal.DevicePortalConnectionClosedReason;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl DevicePortalConnectionRequestReceivedEventArgs {
    ...
    pub fn RequestMessage(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Web::Http::HttpRequestMessage> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::Web::Http::HttpRequestMessage>(result__)
        }
    }
    #[cfg(feature = "Web_Http")]
    pub fn ResponseMessage(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Web::Http::HttpResponseMessage> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::super::Web::Http::HttpResponseMessage>(result__)
        }
    }
    ...
    pub fn WebSocketProtocolsRequested(
        &self,
    ) -> ::windows::runtime::Result<
...
impl ::std::convert::From<DevicePortalConnectionRequestReceivedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DevicePortalConnectionRequestReceivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IDevicePortalConnectionClosedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DevicePortalConnectionClosedReason,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IDevicePortalConnectionStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appserviceconnection: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IDevicePortalWebSocketConnection_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        request: ::windows::runtime::RawPtr,
        messagetype: super::super::super::Networking::Sockets::SocketMessageType,
        protocol: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Networking_Sockets", feature = "Web_Http")))] usize,
    #[cfg(all(feature = "Networking_Sockets", feature = "Web_Http"))]
