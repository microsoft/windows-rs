...
unsafe impl ::windows::runtime::Interface for INotesWindowManagerPreview {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        18512,
        20243,
        [156, 199, 255, 72, 126, 253, 252, 222],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct INotesWindowManagerPreview_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        noteviewid: i32,
        size: super::super::super::Foundation::Size,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        thumbnail: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for NotePlacementChangedPreviewEventArgs
{
...
impl ::std::convert::From<NotePlacementChangedPreviewEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a NotePlacementChangedPreviewEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for NoteVisibilityChangedPreviewEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<NoteVisibilityChangedPreviewEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: NoteVisibilityChangedPreviewEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a NoteVisibilityChangedPreviewEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl NotesWindowManagerPreview {
    ...
    #[cfg(feature = "Foundation")]
    pub fn TrySetNoteSize<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Size>,
    >(
        &self,
        noteviewid: i32,
        size: Param1,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveSystemLockStateChanged<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveNotePlacementChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveNoteVisibilityChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn GetForCurrentApp() -> ::windows::runtime::Result<NotesWindowManagerPreview> {
        Self::INotesWindowManagerPreviewStatics(|this| unsafe {
            ...
            .from_abi::<NotesWindowManagerPreview>(result__)
        })
    }
    pub fn ShowNoteRelativeToWithOptions<
        'a,
        Param2: ::windows::runtime::IntoParam<'a, NotesWindowManagerPreviewShowNoteOptions>,
    >(
        &self,
        noteviewid: i32,
        anchornoteviewid: i32,
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn ShowNoteWithPlacementWithOptions<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Storage::Streams::IBuffer>,
        Param2: ::windows::runtime::IntoParam<'a, NotesWindowManagerPreviewShowNoteOptions>,
    >(
    ...
    #[cfg(all(feature = "Foundation", feature = "Graphics_Imaging"))]
    pub fn SetThumbnailImageForTaskSwitcherAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Graphics::Imaging::SoftwareBitmap>,
    >(
        &self,
        bitmap: Param0,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IAsyncAction> {
    ...
    pub fn INotesWindowManagerPreviewStatics<
        R,
        F: FnOnce(&INotesWindowManagerPreviewStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a NotesWindowManagerPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<NotesWindowManagerPreviewShowNoteOptions>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for NotesWindowManagerPreviewShowNoteOptions
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a NotesWindowManagerPreviewShowNoteOptions
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
