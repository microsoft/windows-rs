...
pub struct ISocialFeedUpdater_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::SocialFeedKind,
    ) -> ::windows::runtime::HRESULT,
...
pub struct ISocialInfoProviderManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        kind: super::SocialFeedKind,
        mode: super::SocialFeedUpdateMode,
        ownerremoteid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        itemremoteid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        newcount: i32,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl SocialDashboardItemUpdater {
    ...
    pub fn Content(&self) -> ::windows::runtime::Result<super::SocialFeedContent> {
        ...
        unsafe {
            ...
            .from_abi::<super::SocialFeedContent>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    ...
    pub fn SetTimestamp<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::DateTime>,
    >(
        &self,
        value: Param0,
    ...
    pub fn SetThumbnail<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::SocialItemThumbnail>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
...
impl ::std::convert::From<SocialDashboardItemUpdater> for ::windows::runtime::IUnknown {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SocialDashboardItemUpdater
{
...
impl ::std::convert::From<SocialDashboardItemUpdater> for ::windows::runtime::IInspectable {
    fn from(value: SocialDashboardItemUpdater) -> Self {
        value.0
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SocialDashboardItemUpdater
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl SocialFeedUpdater {
    ...
    pub fn Items(
        ...
        super::super::super::Foundation::Collections::IVector<super::SocialFeedItem>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl ::std::convert::From<SocialFeedUpdater> for ::windows::runtime::IUnknown {
...
impl ::std::convert::From<SocialFeedUpdater> for ::windows::runtime::IInspectable {
    fn from(value: SocialFeedUpdater) -> Self {
        value.0
    }
}
...
impl SocialInfoProviderManager {
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn CreateSocialFeedUpdaterAsync<
        'a,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        kind: super::SocialFeedKind,
        mode: super::SocialFeedUpdateMode,
        ownerremoteid: Param2,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<SocialFeedUpdater>,
    > {
        Self::ISocialInfoProviderManagerStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                kind,
                mode,
                ownerremoteid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<SocialFeedUpdater>>(
                result__,
            )
        })
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn CreateDashboardItemUpdaterAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        ownerremoteid: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<SocialDashboardItemUpdater>,
    > {
        Self::ISocialInfoProviderManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    #[cfg(feature = "deprecated")]
    pub fn ReportNewContentAvailable<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        contactremoteid: Param0,
        kind: super::SocialFeedKind,
    ) -> ::windows::runtime::Result<()> {
        Self::ISocialInfoProviderManagerStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).9)(
    ...
    pub fn ISocialInfoProviderManagerStatics<
        R,
        F: FnOnce(&ISocialInfoProviderManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
