...
impl Appointment {
    ...
    pub fn Organizer(&self) -> ::windows::runtime::Result<AppointmentOrganizer> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentOrganizer>(result__)
        }
    }
    pub fn SetOrganizer<'a, Param0: ::windows::runtime::IntoParam<'a, AppointmentOrganizer>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn Invitees(
        ...
        super::super::Foundation::Collections::IVector<AppointmentInvitee>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<AppointmentInvitee>>(
                result__,
            )
        }
    }
    pub fn Recurrence(&self) -> ::windows::runtime::Result<AppointmentRecurrence> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentRecurrence>(result__)
        }
    }
    pub fn SetRecurrence<'a, Param0: ::windows::runtime::IntoParam<'a, AppointmentRecurrence>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn BusyStatus(&self) -> ::windows::runtime::Result<AppointmentBusyStatus> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentBusyStatus>(result__)
        }
    }
    ...
    pub fn Sensitivity(&self) -> ::windows::runtime::Result<AppointmentSensitivity> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentSensitivity>(result__)
        }
    }
    ...
    pub fn UserResponse(&self) -> ::windows::runtime::Result<AppointmentParticipantResponse> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentParticipantResponse>(result__)
        }
    }
    ...
    pub fn DetailsKind(&self) -> ::windows::runtime::Result<AppointmentDetailsKind> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentDetailsKind>(result__)
        }
    }
...
impl AppointmentCalendar {
    ...
    pub fn OtherAppReadAccess(
        &self,
    ) -> ::windows::runtime::Result<AppointmentCalendarOtherAppReadAccess> {
        let this = self;
        unsafe {
            ...
            .from_abi::<AppointmentCalendarOtherAppReadAccess>(result__)
        }
    }
    ...
    pub fn OtherAppWriteAccess(
        &self,
    ) -> ::windows::runtime::Result<AppointmentCalendarOtherAppWriteAccess> {
        let this = self;
        unsafe {
            ...
            .from_abi::<AppointmentCalendarOtherAppWriteAccess>(result__)
        }
    }
    ...
    pub fn SummaryCardView(&self) -> ::windows::runtime::Result<AppointmentSummaryCardView> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentSummaryCardView>(result__)
        }
    }
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<Appointment>,
        >,
    > {
        let this = self;
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).18)(
                ::std::mem::transmute_copy(this),
                rangestart.into_param().abi(),
                rangelength.into_param().abi(),
                &mut result__,
            )
    ...
    pub fn FindAppointmentsAsyncWithOptions<
        ...
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::DateTime>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::TimeSpan>,
        Param2: ::windows::runtime::IntoParam<'a, FindAppointmentsOptions>,
    >(
        &self,
        rangestart: Param0,
        rangelength: Param1,
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<AppointmentException>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn FindAllInstancesAsyncWithOptions<
        ...
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::DateTime>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::TimeSpan>,
        Param3: ::windows::runtime::IntoParam<'a, FindAppointmentsOptions>,
    >(
        &self,
        masterlocalid: Param0,
        rangestart: Param1,
    ...
    >(
        &self,
        localid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<Appointment>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).23)(
                ::std::mem::transmute_copy(this),
                localid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<Appointment>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    >(
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).24)(
                ::std::mem::transmute_copy(this),
                localid.into_param().abi(),
                instancestarttime.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<Appointment>>(result__)
        }
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn FindUnexpandedAppointmentsAsyncWithOptions<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, FindAppointmentsOptions>,
    >(
        &self,
        options: Param0,
    ) -> ::windows::runtime::Result<
    ...
    #[cfg(feature = "Foundation")]
    pub fn SaveAppointmentAsync<'a, Param0: ::windows::runtime::IntoParam<'a, Appointment>>(
        &self,
        pappointment: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncAction> {
        let this = self;
    ...
    pub fn SyncManager(&self) -> ::windows::runtime::Result<AppointmentCalendarSyncManager> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentCalendarSyncManager>(result__)
        }
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn TryCreateOrUpdateAppointmentAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Appointment>,
    >(
        &self,
        appointment: Param0,
        notifyinvitees: bool,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn TryForwardMeetingAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Appointment>,
        Param1: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<AppointmentInvitee>,
        >,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    ...
    >(
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).28)(
                ::std::mem::transmute_copy(this),
                meeting.into_param().abi(),
                invitees.into_param().abi(),
                subject.into_param().abi(),
                forwardheader.into_param().abi(),
                comment.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<bool>>(result__)
    ...
    #[cfg(feature = "Foundation")]
    pub fn TryProposeNewTimeForMeetingAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Appointment>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::DateTime>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::TimeSpan>,
    ...
    >(
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).29)(
                ::std::mem::transmute_copy(this),
                meeting.into_param().abi(),
                newstarttime.into_param().abi(),
                newduration.into_param().abi(),
                subject.into_param().abi(),
                comment.into_param().abi(),
                &mut result__,
            )
    ...
    #[cfg(feature = "Foundation")]
    pub fn TryUpdateMeetingResponseAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Appointment>,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param3: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
...
impl AppointmentCalendarOtherAppReadAccess {
    pub const SystemOnly: AppointmentCalendarOtherAppReadAccess =
        AppointmentCalendarOtherAppReadAccess(0i32);
    pub const Limited: AppointmentCalendarOtherAppReadAccess =
        AppointmentCalendarOtherAppReadAccess(1i32);
    pub const Full: AppointmentCalendarOtherAppReadAccess =
        AppointmentCalendarOtherAppReadAccess(2i32);
    pub const None: AppointmentCalendarOtherAppReadAccess =
        AppointmentCalendarOtherAppReadAccess(3i32);
}
...
impl AppointmentCalendarOtherAppWriteAccess {
    pub const None: AppointmentCalendarOtherAppWriteAccess =
        AppointmentCalendarOtherAppWriteAccess(0i32);
    pub const SystemOnly: AppointmentCalendarOtherAppWriteAccess =
        AppointmentCalendarOtherAppWriteAccess(1i32);
    pub const Limited: AppointmentCalendarOtherAppWriteAccess =
        AppointmentCalendarOtherAppWriteAccess(2i32);
}
...
impl AppointmentCalendarSyncManager {
    pub fn Status(&self) -> ::windows::runtime::Result<AppointmentCalendarSyncStatus> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentCalendarSyncStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn SetStatus(
        &self,
        value: AppointmentCalendarSyncStatus,
    ) -> ::windows::runtime::Result<()> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AppointmentCalendarSyncManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppointmentCalendarSyncManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AppointmentCalendarSyncStatus {
    ...
    pub const AuthenticationError: AppointmentCalendarSyncStatus =
        AppointmentCalendarSyncStatus(3i32);
    ...
    pub const ManualAccountRemovalRequired: AppointmentCalendarSyncStatus =
        AppointmentCalendarSyncStatus(6i32);
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppointmentConflictResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AppointmentInvitee {
    ...
    pub fn Role(&self) -> ::windows::runtime::Result<AppointmentParticipantRole> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentParticipantRole>(result__)
        }
    }
...
unsafe impl ::windows::runtime::Interface for AppointmentInvitee {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        38978,
        18779,
        [176, 231, 239, 143, 121, 192, 112, 29],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IAppointmentParticipant> for &AppointmentInvitee {
    fn into_param(self) -> ::windows::runtime::Param<'a, IAppointmentParticipant> {
        ::std::convert::TryInto::<IAppointmentParticipant>::try_into(self)
...
impl AppointmentManager {
    #[cfg(feature = "Foundation")]
    pub fn ShowAddAppointmentAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Appointment>,
    ...
    pub fn ShowAddAppointmentWithPlacementAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Appointment>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::Rect>,
    >(
    ...
    #[cfg(feature = "Foundation")]
    pub fn ShowReplaceAppointmentAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, Appointment>,
    ...
    #[cfg(all(feature = "Foundation", feature = "UI_Popups"))]
    pub fn ShowReplaceAppointmentWithPlacementAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, Appointment>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::Rect>,
    ...
    #[cfg(all(feature = "Foundation", feature = "UI_Popups"))]
    pub fn ShowReplaceAppointmentWithPlacementAndDateAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, Appointment>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::Rect>,
        Param4: ::windows::runtime::IntoParam<'a, super::super::Foundation::DateTime>,
    >(
        appointmentid: Param0,
        appointment: Param1,
        selection: Param2,
    ...
    > {
        Self::IAppointmentManagerStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).10)(
                ...
                selection.into_param().abi(),
                preferredplacement,
                instancestartdate.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<::windows::runtime::HSTRING>>(
                result__,
    ...
    pub fn ShowRemoveAppointmentWithPlacementAndDateAsync<
        ...
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::Rect>,
        Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::DateTime>,
    >(
        appointmentid: Param0,
        selection: Param1,
        preferredplacement: super::super::UI::Popups::Placement,
    ...
    #[cfg(feature = "Foundation")]
    pub fn ShowEditNewAppointmentAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Appointment>,
    >(
        appointment: Param0,
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<AppointmentStore>>
    {
        Self::IAppointmentManagerStatics2(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<AppointmentStore>>(result__)
        })
    }
    #[cfg(feature = "System")]
    pub fn GetForUser<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::System::User>>(
        user: Param0,
    ) -> ::windows::runtime::Result<AppointmentManagerForUser> {
        Self::IAppointmentManagerStatics3(|this| unsafe {
            ...
            .from_abi::<AppointmentManagerForUser>(result__)
        })
    }
    pub fn IAppointmentManagerStatics<
        R,
        F: FnOnce(&IAppointmentManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IAppointmentManagerStatics2<
        R,
        F: FnOnce(&IAppointmentManagerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IAppointmentManagerStatics3<
        R,
        F: FnOnce(&IAppointmentManagerStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppointmentManagerForUser
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::Interface for AppointmentOrganizer {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        38680,
        18043,
        [131, 251, 178, 147, 161, 145, 33, 222],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IAppointmentParticipant> for AppointmentOrganizer {
    fn into_param(self) -> ::windows::runtime::Param<'a, IAppointmentParticipant> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IAppointmentParticipant>::into(
            self,
        ))
    }
}
...
impl AppointmentProperties {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn DefaultProperties() -> ::windows::runtime::Result<
    ...
    pub fn IAppointmentPropertiesStatics<
        R,
        F: FnOnce(&IAppointmentPropertiesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IAppointmentPropertiesStatics2<
        R,
        F: FnOnce(&IAppointmentPropertiesStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl AppointmentRecurrence {
    ...
    pub fn Unit(&self) -> ::windows::runtime::Result<AppointmentRecurrenceUnit> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentRecurrenceUnit>(result__)
        }
    }
    ...
    pub fn WeekOfMonth(&self) -> ::windows::runtime::Result<AppointmentWeekOfMonth> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentWeekOfMonth>(result__)
        }
    }
    ...
    pub fn RecurrenceType(&self) -> ::windows::runtime::Result<RecurrenceType> {
        ...
        unsafe {
            ...
            .from_abi::<RecurrenceType>(result__)
        }
    }
...
impl AppointmentStore {
    pub fn ChangeTracker(&self) -> ::windows::runtime::Result<AppointmentStoreChangeTracker> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentStoreChangeTracker>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    >(
        &self,
        name: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<AppointmentCalendar>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<AppointmentCalendar>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn FindAppointmentCalendarsAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<AppointmentCalendar>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    #[cfg(feature = "Foundation")]
    pub fn FindConflictAsync<'a, Param0: ::windows::runtime::IntoParam<'a, Appointment>>(
        &self,
        appointment: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<AppointmentConflictResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<AppointmentConflictResult>>(
                result__,
            )
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn FindConflictAsyncWithInstanceStart<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Appointment>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::DateTime>,
    >(
    ...
    #[cfg(feature = "Foundation")]
    pub fn MoveAppointmentAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Appointment>,
        Param1: ::windows::runtime::IntoParam<'a, AppointmentCalendar>,
    >(
        &self,
        appointment: Param0,
        destinationcalendar: Param1,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).17)(
                ::std::mem::transmute_copy(this),
                appointment.into_param().abi(),
                destinationcalendar.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncAction>(result__)
        }
    ...
    >(
        &self,
        identity: Param0,
    ) -> ::windows::runtime::Result<AppointmentStoreChangeTracker> {
...
impl AppointmentStoreChange {
    ...
    pub fn ChangeType(&self) -> ::windows::runtime::Result<AppointmentStoreChangeType> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentStoreChangeType>(result__)
        }
    }
    pub fn AppointmentCalendar(&self) -> ::windows::runtime::Result<AppointmentCalendar> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentCalendar>(result__)
        }
    }
}
...
impl AppointmentStoreChangeReader {
    ...
    pub fn ReadBatchAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<AppointmentStoreChange>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn AcceptChangesThrough<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, AppointmentStoreChange>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppointmentStoreChangeReader
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AppointmentStoreChangeTracker {
    pub fn GetChangeReader(&self) -> ::windows::runtime::Result<AppointmentStoreChangeReader> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentStoreChangeReader>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AppointmentStoreChangeTracker
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppointmentStoreChangeTracker
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::Interface for AppointmentStoreChangedDeferral {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        65243,
        19395,
        [150, 98, 149, 169, 190, 253, 244, 223],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AppointmentStoreChangedDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppointmentStoreChangedDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AppointmentStoreChangedEventArgs {
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<AppointmentStoreChangedDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<AppointmentStoreChangedDeferral>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AppointmentStoreChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppointmentStoreChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<AppointmentStoreNotificationTriggerDetails>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AppointmentStoreNotificationTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppointmentStoreNotificationTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl FindAppointmentCalendarsOptions {
    ...
    pub const IncludeHidden: FindAppointmentCalendarsOptions =
        FindAppointmentCalendarsOptions(1u32);
}
...
unsafe impl ::windows::runtime::Interface for FindAppointmentsOptions {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        39234,
        12422,
        [130, 181, 44, 178, 159, 100, 213, 245],
    );
}
...
pub struct IAppointment_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentBusyStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentBusyStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentSensitivity,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentSensitivity,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IAppointment2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentParticipantResponse,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentParticipantResponse,
...
unsafe impl ::windows::runtime::Interface for IAppointment3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        35169,
        18833,
        [147, 75, 196, 135, 104, 229, 169, 108],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IAppointment3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentDetailsKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentDetailsKind,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IAppointmentCalendar_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentCalendarOtherAppReadAccess,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentCalendarOtherAppReadAccess,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentCalendarOtherAppWriteAccess,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentCalendarOtherAppWriteAccess,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentSummaryCardView,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentSummaryCardView,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        masterlocalid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        localid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pappointment: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
...
pub struct IAppointmentCalendar2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appointment: ::windows::runtime::RawPtr,
        notifyinvitees: bool,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        meeting: ::windows::runtime::RawPtr,
        subject: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        comment: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        notifyinvitees: bool,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        meeting: ::windows::runtime::RawPtr,
        invitees: ::windows::runtime::RawPtr,
        subject: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        forwardheader: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        comment: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
...
pub struct IAppointmentCalendarSyncManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentCalendarSyncStatus,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IAppointmentConflictResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentConflictType,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IAppointmentInvitee_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentParticipantRole,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentParticipantRole,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentParticipantResponse,
...
pub struct IAppointmentManagerForUser_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appointmentid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        appointment: ::windows::runtime::RawPtr,
        selection: super::super::Foundation::Rect,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IAppointmentManagerStatics2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        53327,
        16436,
        [175, 114, 163, 101, 115, 180, 95, 240],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::RuntimeType for IAppointmentParticipant {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{615e2902-9718-467b-83fb-b293a19121de}");
}
...
pub struct IAppointmentRecurrence_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentRecurrenceUnit,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentRecurrenceUnit,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentDaysOfWeek,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentWeekOfMonth,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: AppointmentWeekOfMonth,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u32,
...
unsafe impl ::windows::runtime::Interface for IAppointmentRecurrence3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        55885,
        18967,
        [141, 210, 28, 235, 194, 181, 255, 157],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IAppointmentStore_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        calendarid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appointment: ::windows::runtime::RawPtr,
        destinationcalendar: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        roamingid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
);
...
unsafe impl ::windows::runtime::Interface for IAppointmentStore2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        7233,
        16975,
        [128, 132, 103, 193, 207, 224, 168, 84],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IAppointmentStore2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        phandler: ::windows::runtime::RawPtr,
        result__: *mut super::super::Foundation::EventRegistrationToken,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
...
pub struct IAppointmentStoreChange_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppointmentStoreChangeType,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
