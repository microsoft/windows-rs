...
impl AddAppointmentOperation {
    ...
    pub fn SourcePackageFamilyName(
        &self,
...
impl AppointmentsProviderLaunchActionVerbs {
    ...
    pub fn IAppointmentsProviderLaunchActionVerbsStatics<
        R,
        F: FnOnce(&IAppointmentsProviderLaunchActionVerbsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IAppointmentsProviderLaunchActionVerbsStatics2<
        R,
        F: FnOnce(&IAppointmentsProviderLaunchActionVerbsStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
pub struct IAddAppointmentOperation_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        itemid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IAppointmentsProviderLaunchActionVerbsStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        40494,
        18886,
        [142, 247, 58, 183, 165, 220, 200, 184],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IAppointmentsProviderLaunchActionVerbsStatics2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        44833,
        18236,
        [136, 220, 118, 205, 137, 246, 12, 165],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for RemoveAppointmentOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a RemoveAppointmentOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ReplaceAppointmentOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ReplaceAppointmentOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
