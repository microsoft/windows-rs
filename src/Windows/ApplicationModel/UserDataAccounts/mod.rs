...
unsafe impl ::windows::runtime::Interface for IUserDataAccount {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        45896,
        18704,
        [190, 148, 74, 212, 187, 166, 222, 167],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IUserDataAccount_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UserDataAccountOtherAppReadAccess,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(all(
        feature = "ApplicationModel_Appointments",
        feature = "Foundation",
    ...
    usize,
    #[cfg(all(
        feature = "ApplicationModel_Email",
        feature = "Foundation",
        feature = "Foundation_Collections"
    ))]
    pub  unsafe extern "system" fn(
...
pub struct IUserDataAccount4_abi(
    ...
    #[cfg(not(feature = "Foundation_Collections"))] usize,
    #[cfg(all(
        feature = "ApplicationModel_UserDataTasks",
        feature = "Foundation",
        feature = "Foundation_Collections"
    ))]
    pub  unsafe extern "system" fn(
...
unsafe impl ::windows::runtime::Interface for IUserDataAccountManagerStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        6440,
        18976,
        [134, 213, 60, 115, 127, 125, 195, 176],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IUserDataAccountManagerStatics2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        12651,
        17246,
        [181, 52, 247, 212, 180, 183, 219, 166],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IUserDataAccountStore_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        userdisplayname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
...
unsafe impl ::windows::runtime::Interface for IUserDataAccountStore3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        62409,
        18315,
        [177, 23, 101, 133, 190, 187, 103, 137],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl UserDataAccount {
    ...
    pub fn OtherAppReadAccess(
        &self,
    ) -> ::windows::runtime::Result<UserDataAccountOtherAppReadAccess> {
        let this = self;
        unsafe {
            ...
            .from_abi::<UserDataAccountOtherAppReadAccess>(result__)
        }
    }
    ...
    pub fn FindAppointmentCalendarsAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<
                super::Appointments::AppointmentCalendar,
            >,
        >,
    > {
        let this = self;
    ...
    pub fn FindEmailMailboxesAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<super::Email::EmailMailbox>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn FindContactListsAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<super::Contacts::ContactList>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn FindContactAnnotationListsAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<
                super::Contacts::ContactAnnotationList,
            >,
        >,
    > {
        let this = self;
    ...
    pub fn FindUserDataTaskListsAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<
                super::UserDataTasks::UserDataTaskList,
            >,
        >,
    > {
        let this = &::windows::runtime::Interface::cast::<IUserDataAccount4>(self)?;
    ...
    pub fn FindContactGroupsAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<super::Contacts::ContactGroup>,
        >,
    > {
        let this = &::windows::runtime::Interface::cast::<IUserDataAccount4>(self)?;
        unsafe {
...
impl UserDataAccountManager {
    ...
    pub fn RequestStoreAsync(
        storeaccesstype: UserDataAccountStoreAccessType,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<UserDataAccountStore>>
    {
        Self::IUserDataAccountManagerStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<UserDataAccountStore>>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn GetForUser<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::System::User>>(
        user: Param0,
    ) -> ::windows::runtime::Result<UserDataAccountManagerForUser> {
        Self::IUserDataAccountManagerStatics2(|this| unsafe {
            ...
            .from_abi::<UserDataAccountManagerForUser>(result__)
        })
    }
    pub fn IUserDataAccountManagerStatics<
        R,
        F: FnOnce(&IUserDataAccountManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IUserDataAccountManagerStatics2<
        R,
        F: FnOnce(&IUserDataAccountManagerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for UserDataAccountManagerForUser
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserDataAccountManagerForUser
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl UserDataAccountOtherAppReadAccess {
    pub const SystemOnly: UserDataAccountOtherAppReadAccess =
        UserDataAccountOtherAppReadAccess(0i32);
...
impl UserDataAccountStore {
    ...
    pub fn FindAccountsAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<UserDataAccount>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    >(
        &self,
        id: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<UserDataAccount>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<UserDataAccount>>
    {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                userdisplayname.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<UserDataAccount>>(result__)
        }
...
impl UserDataAccountStoreAccessType {
    pub const AllAccountsReadOnly: UserDataAccountStoreAccessType =
        UserDataAccountStoreAccessType(0i32);
    pub const AppAccountsReadWrite: UserDataAccountStoreAccessType =
        UserDataAccountStoreAccessType(1i32);
}
...
impl ::std::convert::From<UserDataAccountStoreChangedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserDataAccountStoreChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
