...
impl ContactPickerUI {
    ...
    pub fn AddContact<
        ...
        Param1: ::windows::runtime::IntoParam<'a, super::Contact>,
    >(
        &self,
        id: Param0,
        contact: Param1,
    ) -> ::windows::runtime::Result<AddContactResult> {
        let this = self;
        unsafe {
            ...
            .from_abi::<AddContactResult>(result__)
        }
    }
    pub fn RemoveContact<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
    ...
    pub fn SelectionMode(&self) -> ::windows::runtime::Result<super::ContactSelectionMode> {
        ...
        unsafe {
            ...
            .from_abi::<super::ContactSelectionMode>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ContactRemoved<
        'a,
    ...
    pub fn AddContact2<'a, Param0: ::windows::runtime::IntoParam<'a, super::Contact>>(
        &self,
        contact: Param0,
    ) -> ::windows::runtime::Result<AddContactResult> {
    ...
    pub fn DesiredFieldsWithContactFieldType(
        ...
        super::super::super::Foundation::Collections::IVector<super::ContactFieldType>,
    > {
        let this = &::windows::runtime::Interface::cast::<IContactPickerUI2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
unsafe impl ::windows::runtime::Interface for ContactRemovedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        13058,
        19731,
        [173, 141, 173, 204, 15, 249, 228, 124],
    );
}
...
pub struct IContactPickerUI_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::ContactSelectionMode,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
