...
impl CommunicationBlockingAccessManager {
    ...
    pub fn ICommunicationBlockingAccessManagerStatics<
        R,
        F: FnOnce(&ICommunicationBlockingAccessManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl CommunicationBlockingAppManager {
    ...
    pub fn ICommunicationBlockingAppManagerStatics<
        R,
        F: FnOnce(&ICommunicationBlockingAppManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ICommunicationBlockingAppManagerStatics2<
        R,
        F: FnOnce(&ICommunicationBlockingAppManagerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
pub struct ICommunicationBlockingAccessManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        phonenumbers: ::windows::runtime::RawPtr,
        result__: *mut bool,
    ) -> ::windows::runtime::HRESULT,
