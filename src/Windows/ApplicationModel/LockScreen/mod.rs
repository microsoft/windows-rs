...
unsafe impl ::windows::runtime::Interface for ILockScreenInfo {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        38673,
        19913,
        [166, 48, 149, 182, 203, 140, 218, 208],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl LockApplicationHost {
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<LockApplicationHost> {
        Self::ILockApplicationHostStatics(|this| unsafe {
            ...
            .from_abi::<LockApplicationHost>(result__)
        })
    }
    pub fn ILockApplicationHostStatics<
        R,
        F: FnOnce(&ILockApplicationHostStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl LockScreenInfo {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveLockScreenImageChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn Badges(
        ...
        super::super::Foundation::Collections::IVectorView<LockScreenBadge>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<LockScreenBadge>>(
                result__,
            )
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn DetailTextChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveDetailTextChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LockScreenUnlockingDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LockScreenUnlockingDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl LockScreenUnlockingEventArgs {
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<LockScreenUnlockingDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<LockScreenUnlockingDeferral>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LockScreenUnlockingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LockScreenUnlockingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
