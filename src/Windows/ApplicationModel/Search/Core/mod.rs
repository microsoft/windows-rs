...
unsafe impl ::windows::runtime::Interface for IRequestingFocusOnKeyboardInputEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        45479,
        16802,
        [135, 157, 106, 104, 104, 126, 89, 133],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISearchSuggestion_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut SearchSuggestionKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct ISearchSuggestionManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        querytext: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        querytext: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ...
    pub  unsafe extern "system" fn(
        ...
        querytext: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        language: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        linguisticdetails: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
impl ::std::convert::From<RequestingFocusOnKeyboardInputEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for RequestingFocusOnKeyboardInputEventArgs
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a RequestingFocusOnKeyboardInputEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl SearchSuggestion {
    pub fn Kind(&self) -> ::windows::runtime::Result<SearchSuggestionKind> {
        ...
        unsafe {
            ...
            .from_abi::<SearchSuggestionKind>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for SearchSuggestionKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Search.Core.SearchSuggestionKind;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl SearchSuggestionManager {
    ...
    pub fn SetSearchHistoryContext<
        'a,
    ...
    pub fn SetLocalContentSuggestionSettings<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::LocalContentSuggestionSettings>,
    >(
        &self,
        settings: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn SetQuery<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        querytext: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).11)(
                ::std::mem::transmute_copy(this),
                querytext.into_param().abi(),
            )
            .ok()
        }
    }
    pub fn SetQueryWithLanguage<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    ...
    pub fn SetQueryWithSearchQueryLinguisticDetails<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param2: ::windows::runtime::IntoParam<'a, super::SearchQueryLinguisticDetails>,
    >(
        &self,
        querytext: Param0,
        language: Param1,
        linguisticdetails: Param2,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
            (::windows::runtime::Interface::vtable(this).13)(
                ...
                querytext.into_param().abi(),
                language.into_param().abi(),
                linguisticdetails.into_param().abi(),
            )
            .ok()
        }
    }
    ...
    pub fn Suggestions(
        ...
        super::super::super::Foundation::Collections::IObservableVector<SearchSuggestion>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn AddToHistoryWithLanguage<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveSuggestionsRequested<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RequestingFocusOnKeyboardInput<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveRequestingFocusOnKeyboardInput<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
...
impl SearchSuggestionsRequestedEventArgs {
    ...
    pub fn LinguisticDetails(
        &self,
    ) -> ::windows::runtime::Result<super::SearchQueryLinguisticDetails> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::SearchQueryLinguisticDetails>(result__)
        }
    }
    pub fn Request(&self) -> ::windows::runtime::Result<super::SearchSuggestionsRequest> {
        ...
        unsafe {
            ...
            .from_abi::<super::SearchSuggestionsRequest>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchSuggestionsRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<SearchSuggestionsRequestedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: SearchSuggestionsRequestedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchSuggestionsRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
