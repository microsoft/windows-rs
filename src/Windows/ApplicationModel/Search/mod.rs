...
pub struct ISearchPane_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        query: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: bool,
...
impl ISearchPaneQueryChangedEventArgs {
    ...
    pub fn LinguisticDetails(
        &self,
    ) -> ::windows::runtime::Result<SearchPaneQueryLinguisticDetails> {
        let this = self;
        unsafe {
            ...
            .from_abi::<SearchPaneQueryLinguisticDetails>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ISearchPaneQueryChangedEventArgs {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{3c064fe9-2351-4248-a529-7110f464a785}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ISearchPaneQueryChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
unsafe impl ::windows::runtime::Interface for ISearchPaneQuerySubmittedEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        59845,
        18230,
        [145, 178, 232, 235, 156, 184, 131, 86],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface
    for ISearchPaneQuerySubmittedEventArgsWithLinguisticDetails
{
...
unsafe impl ::windows::runtime::Interface for ISearchPaneResultSuggestionChosenEventArgs {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        44754,
        16864,
        [188, 224, 194, 108, 167, 79, 133, 236],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ISearchPaneStaticsWithHideThisApplication {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        20721,
        19715,
        [153, 172, 198, 100, 76, 142, 216, 181],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ISearchQueryLinguisticDetailsFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        querytextalternatives: ::windows::runtime::RawPtr,
...
pub struct ISearchSuggestionCollection_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        suggestions: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))] usize,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        text: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        detailtext: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        tag: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        image: ::windows::runtime::RawPtr,
        imagealternatetext: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
...
impl LocalContentSuggestionSettings {
    ...
    pub fn Locations(
        ...
        super::super::Foundation::Collections::IVector<super::super::Storage::StorageFolder>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LocalContentSuggestionSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LocalContentSuggestionSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SearchPane {
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn RemoveResultSuggestionChosen<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
    ...
    pub fn SetLocalContentSuggestionSettings<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, LocalContentSuggestionSettings>,
    >(
        &self,
        settings: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn ISearchPaneStatics<
        R,
        F: FnOnce(&ISearchPaneStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<SearchPane, ISearchPaneStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn ISearchPaneStaticsWithHideThisApplication<
        R,
        F: FnOnce(&ISearchPaneStaticsWithHideThisApplication) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for SearchPane {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.ApplicationModel.Search.SearchPane;{fdacec38-3700-4d73-91a1-2f998674238a})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchPaneQueryChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchPaneQueryChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ISearchPaneQueryChangedEventArgs>
    for SearchPaneQueryChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ISearchPaneQueryChangedEventArgs> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<ISearchPaneQueryChangedEventArgs>::into(self),
        )
    }
}
impl<'a> ::windows::runtime::IntoParam<'a, ISearchPaneQueryChangedEventArgs>
    for &SearchPaneQueryChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ISearchPaneQueryChangedEventArgs> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<ISearchPaneQueryChangedEventArgs>::into(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchPaneQueryLinguisticDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchPaneQueryLinguisticDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchPaneQuerySubmittedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchPaneQuerySubmittedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<SearchPaneResultSuggestionChosenEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchPaneResultSuggestionChosenEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchPaneResultSuggestionChosenEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SearchPaneSuggestionsRequest {
    ...
    #[cfg(feature = "deprecated")]
    pub fn SearchSuggestionCollection(
        &self,
    ) -> ::windows::runtime::Result<SearchSuggestionCollection> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<SearchSuggestionCollection>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<SearchPaneSuggestionsRequestDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<SearchPaneSuggestionsRequestDeferral>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchPaneSuggestionsRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchPaneSuggestionsRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchPaneSuggestionsRequestDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<SearchPaneSuggestionsRequestDeferral>
    for ::windows::runtime::IInspectable
{
    fn from(value: SearchPaneSuggestionsRequestDeferral) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchPaneSuggestionsRequestDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SearchPaneSuggestionsRequestedEventArgs {
    ...
    pub fn Request(&self) -> ::windows::runtime::Result<SearchPaneSuggestionsRequest> {
        ...
        unsafe {
            ...
            .from_abi::<SearchPaneSuggestionsRequest>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn QueryText(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
...
impl ::std::convert::From<SearchPaneSuggestionsRequestedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchPaneSuggestionsRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchPaneSuggestionsRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
}
impl ::std::convert::TryFrom<SearchPaneSuggestionsRequestedEventArgs>
    for ISearchPaneQueryChangedEventArgs
{
    type Error = ::windows::runtime::Error;
    fn try_from(
        value: SearchPaneSuggestionsRequestedEventArgs,
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ISearchPaneQueryChangedEventArgs> {
        ::std::convert::TryInto::<ISearchPaneQueryChangedEventArgs>::try_into(self)
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchPaneVisibilityChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<SearchPaneVisibilityChangedEventArgs>
    for ::windows::runtime::IInspectable
{
    fn from(value: SearchPaneVisibilityChangedEventArgs) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchPaneVisibilityChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SearchQueryLinguisticDetails {
    ...
    pub fn CreateInstance<
        ...
        >,
    >(
        querytextalternatives: Param0,
        querytextcompositionstart: u32,
        querytextcompositionlength: u32,
    ) -> ::windows::runtime::Result<SearchQueryLinguisticDetails> {
        Self::ISearchQueryLinguisticDetailsFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                querytextalternatives.into_param().abi(),
                querytextcompositionstart,
                querytextcompositionlength,
                &mut result__,
            )
            .from_abi::<SearchQueryLinguisticDetails>(result__)
        })
    }
    pub fn ISearchQueryLinguisticDetailsFactory<
        R,
        F: FnOnce(&ISearchQueryLinguisticDetailsFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchQueryLinguisticDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SearchSuggestionCollection {
    ...
    >(
        ...
        unsafe {
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                suggestions.into_param().abi(),
            )
            .ok()
        }
    }
    #[cfg(feature = "Storage_Streams")]
    pub fn AppendResultSuggestion<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    ...
    >(
        ...
        unsafe {
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
                text.into_param().abi(),
                detailtext.into_param().abi(),
                tag.into_param().abi(),
                image.into_param().abi(),
                imagealternatetext.into_param().abi(),
            )
            .ok()
        }
    }
    pub fn AppendSearchSeparator<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchSuggestionCollection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchSuggestionCollection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SearchSuggestionsRequest {
    ...
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<SearchSuggestionsRequestDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<SearchSuggestionsRequestDeferral>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchSuggestionsRequest
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SearchSuggestionsRequestDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SearchSuggestionsRequestDeferral
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
