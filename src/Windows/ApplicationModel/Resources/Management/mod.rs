...
pub struct IIndexedResourceCandidate_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut IndexedResourceType,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IResourceIndexer_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        filepath: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
...
pub struct IResourceIndexerFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        projectroot: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
...
pub struct IResourceIndexerFactory2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        projectroot: ::windows::runtime::RawPtr,
        extensiondllpath: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
...
impl IndexedResourceCandidate {
    pub fn Type(&self) -> ::windows::runtime::Result<IndexedResourceType> {
        ...
        unsafe {
            ...
            .from_abi::<IndexedResourceType>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn Qualifiers(
        ...
        super::super::super::Foundation::Collections::IVectorView<IndexedResourceQualifier>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IndexedResourceCandidate
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IndexedResourceQualifier
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ResourceIndexer {
    ...
    >(
        &self,
        filepath: Param0,
    ) -> ::windows::runtime::Result<IndexedResourceCandidate> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<IndexedResourceCandidate>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Foundation::Collections::IVectorView<IndexedResourceCandidate>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    >(
        projectroot: Param0,
    ) -> ::windows::runtime::Result<ResourceIndexer> {
        Self::IResourceIndexerFactory(|this| unsafe {
            ...
            .from_abi::<ResourceIndexer>(result__)
        })
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn CreateResourceIndexerWithExtension<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::Uri>,
    ...
    pub fn IResourceIndexerFactory<
        R,
        F: FnOnce(&IResourceIndexerFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IResourceIndexerFactory2<
        R,
        F: FnOnce(&IResourceIndexerFactory2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
