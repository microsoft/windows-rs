...
unsafe impl ::windows::runtime::Interface for IResourceLoaderFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        27100,
        17029,
        [160, 119, 213, 192, 228, 124, 203, 232],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl ResourceLoader {
    ...
    pub fn GetForUIContext<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UI::UIContext>,
    >(
        context: Param0,
    ) -> ::windows::runtime::Result<ResourceLoader> {
    ...
    pub fn IResourceLoaderStatics2<
        R,
        F: FnOnce(&IResourceLoaderStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IResourceLoaderStatics3<
        R,
        F: FnOnce(&IResourceLoaderStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IResourceLoaderStatics4<
        R,
        F: FnOnce(&IResourceLoaderStatics4) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
