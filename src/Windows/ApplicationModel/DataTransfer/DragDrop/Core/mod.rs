...
impl CoreDragDropManager {
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<CoreDragDropManager> {
        Self::ICoreDragDropManagerStatics(|this| unsafe {
            ...
            .from_abi::<CoreDragDropManager>(result__)
        })
    }
    pub fn ICoreDragDropManagerStatics<
        R,
        F: FnOnce(&ICoreDragDropManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl CoreDragInfo {
    pub fn Data(&self) -> ::windows::runtime::Result<super::super::DataPackageView> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::DataPackageView>(result__)
        }
    }
    pub fn Modifiers(&self) -> ::windows::runtime::Result<super::DragDropModifiers> {
        ...
        unsafe {
            ...
            .from_abi::<super::DragDropModifiers>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn Position(
    ...
    pub fn AllowedOperations(
        &self,
    ) -> ::windows::runtime::Result<super::super::DataPackageOperation> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::DataPackageOperation>(result__)
        }
    }
}
...
impl CoreDragOperation {
    ...
    pub fn Data(&self) -> ::windows::runtime::Result<super::super::DataPackage> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::DataPackage>(result__)
        }
    }
    ...
    pub fn SetDragUIContentFromSoftwareBitmap<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Graphics::Imaging::SoftwareBitmap,
        >,
    >(
        &self,
    ...
    pub fn SetDragUIContentFromSoftwareBitmapWithAnchorPoint<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::Graphics::Imaging::SoftwareBitmap,
        >,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::Point>,
    >(
        &self,
        softwarebitmap: Param0,
        anchorpoint: Param1,
    ...
    pub fn DragUIContentMode(&self) -> ::windows::runtime::Result<CoreDragUIContentMode> {
        ...
        unsafe {
            ...
            .from_abi::<CoreDragUIContentMode>(result__)
        }
    }
    pub fn SetDragUIContentMode(
        &self,
        value: CoreDragUIContentMode,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
    ...
    pub fn StartAsync(
        ...
        super::super::super::super::Foundation::IAsyncOperation<super::super::DataPackageOperation>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::super::Foundation::IAsyncOperation<
                super::super::DataPackageOperation,
            >>(result__)
        }
    }
    pub fn AllowedOperations(
    ...
    pub fn SetAllowedOperations(
        &self,
        value: super::super::DataPackageOperation,
    ) -> ::windows::runtime::Result<()> {
        let this = &::windows::runtime::Interface::cast::<ICoreDragOperation2>(self)?;
        unsafe {
...
unsafe impl ::windows::runtime::RuntimeType for CoreDragUIContentMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragUIContentMode;u4)",
    );
}
...
impl CoreDropOperationTargetRequestedEventArgs {
    pub fn SetTarget<'a, Param0: ::windows::runtime::IntoParam<'a, ICoreDropOperationTarget>>(
        &self,
        target: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl ::std::convert::From<CoreDropOperationTargetRequestedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreDropOperationTargetRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct ICoreDragDropManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: super::super::super::super::Foundation::EventRegistrationToken,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct ICoreDragInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::DragDropModifiers,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct ICoreDragInfo2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::DataPackageOperation,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct ICoreDragOperation_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        softwarebitmap: ::windows::runtime::RawPtr,
        anchorpoint: super::super::super::super::Foundation::Point,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Graphics_Imaging")))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CoreDragUIContentMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: CoreDragUIContentMode,
...
impl ICoreDropOperationTarget {
    ...
    pub fn EnterAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, CoreDragInfo>,
        Param1: ::windows::runtime::IntoParam<'a, CoreDragUIOverride>,
    >(
        &self,
        draginfo: Param0,
        draguioverride: Param1,
    ) -> ::windows::runtime::Result<
        super::super::super::super::Foundation::IAsyncOperation<super::super::DataPackageOperation>,
    > {
        let this = self;
    ...
    #[cfg(feature = "Foundation")]
    pub fn LeaveAsync<'a, Param0: ::windows::runtime::IntoParam<'a, CoreDragInfo>>(
        &self,
        draginfo: Param0,
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::super::Foundation::IAsyncAction>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn DropAsync<'a, Param0: ::windows::runtime::IntoParam<'a, CoreDragInfo>>(
        &self,
        draginfo: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::super::Foundation::IAsyncOperation<super::super::DataPackageOperation>,
...
unsafe impl ::windows::runtime::RuntimeType for ICoreDropOperationTarget {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{d9126196-4c5b-417d-bb37-76381def8db4}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ICoreDropOperationTarget
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct ICoreDropOperationTarget_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        draginfo: ::windows::runtime::RawPtr,
        draguioverride: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
