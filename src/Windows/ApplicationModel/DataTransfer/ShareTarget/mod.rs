...
pub struct IShareOperation_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        quicklink: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl QuickLink {
    ...
    pub fn Thumbnail(
        ...
        super::super::super::Storage::Streams::RandomAccessStreamReference,
    > {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::super::Storage::Streams::RandomAccessStreamReference>(
                result__,
            )
        }
    }
...
impl ShareOperation {
    pub fn Data(&self) -> ::windows::runtime::Result<super::DataPackageView> {
        ...
        unsafe {
            ...
            .from_abi::<super::DataPackageView>(result__)
        }
    }
    ...
    pub fn ReportCompletedWithQuickLink<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, QuickLink>,
    >(
        &self,
        quicklink: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn Contacts(
        ...
        super::super::super::Foundation::Collections::IVectorView<super::super::Contacts::Contact>,
    > {
