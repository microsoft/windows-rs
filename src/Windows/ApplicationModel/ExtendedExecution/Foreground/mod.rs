...
impl ExtendedExecutionForegroundReason {
    pub const Unspecified: ExtendedExecutionForegroundReason =
        ExtendedExecutionForegroundReason(0i32);
    pub const SavingData: ExtendedExecutionForegroundReason =
        ExtendedExecutionForegroundReason(1i32);
    pub const BackgroundAudio: ExtendedExecutionForegroundReason =
        ExtendedExecutionForegroundReason(2i32);
    pub const Unconstrained: ExtendedExecutionForegroundReason =
        ExtendedExecutionForegroundReason(3i32);
}
...
impl ExtendedExecutionForegroundRevokedEventArgs {
    pub fn Reason(&self) -> ::windows::runtime::Result<ExtendedExecutionForegroundRevokedReason> {
        ...
        unsafe {
            ...
            .from_abi::<ExtendedExecutionForegroundRevokedReason>(result__)
        }
    }
}
...
impl ::std::convert::From<ExtendedExecutionForegroundRevokedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ExtendedExecutionForegroundRevokedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl ExtendedExecutionForegroundRevokedReason {
    pub const Resumed: ExtendedExecutionForegroundRevokedReason =
        ExtendedExecutionForegroundRevokedReason(0i32);
    pub const SystemPolicy: ExtendedExecutionForegroundRevokedReason =
        ExtendedExecutionForegroundRevokedReason(1i32);
}
...
impl ExtendedExecutionForegroundSession {
    ...
    pub fn RequestExtensionAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<ExtendedExecutionForegroundResult>,
    > {
        let this = self;
        unsafe {
    ...
    pub fn Reason(&self) -> ::windows::runtime::Result<ExtendedExecutionForegroundReason> {
        ...
        unsafe {
            ...
            .from_abi::<ExtendedExecutionForegroundReason>(result__)
        }
    }
    pub fn SetReason(
        &self,
        value: ExtendedExecutionForegroundReason,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
        unsafe {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ExtendedExecutionForegroundSession
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&ExtendedExecutionForegroundSession>
    for ::windows::runtime::IInspectable
{
    fn from(value: &ExtendedExecutionForegroundSession) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ExtendedExecutionForegroundSession
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<ExtendedExecutionForegroundSession>
...
pub struct IExtendedExecutionForegroundRevokedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ExtendedExecutionForegroundRevokedReason,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IExtendedExecutionForegroundSession_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ExtendedExecutionForegroundReason,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: ExtendedExecutionForegroundReason,
