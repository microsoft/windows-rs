...
pub struct ExtendedExecutionRevokedEventArgs(pub ::windows::runtime::IInspectable);
impl ExtendedExecutionRevokedEventArgs {
    ...
    pub fn Reason(&self) -> ::windows::runtime::Result<ExtendedExecutionRevokedReason> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), &mut result__).from_abi::<ExtendedExecutionRevokedReason>(result__)
        }
    }
}
...
impl ::core::convert::From<ExtendedExecutionRevokedEventArgs> for ::windows::runtime::IUnknown {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown> for &'a ExtendedExecutionRevokedEventArgs {
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Borrowed(&self.0 .0)
    }
}
impl ::core::convert::From<ExtendedExecutionRevokedEventArgs> for ::windows::runtime::IInspectable {
    fn from(value: ExtendedExecutionRevokedEventArgs) -> Self {
        value.0
    }
}
...
#[repr(transparent)]
#[derive(:: core :: cmp :: PartialEq, :: core :: cmp :: Eq, :: core :: clone :: Clone, :: core :: fmt :: Debug)]
pub struct ExtendedExecutionSession(pub ::windows::runtime::IInspectable);
impl ExtendedExecutionSession {
    ...
    pub fn Reason(&self) -> ::windows::runtime::Result<ExtendedExecutionReason> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(::core::mem::transmute_copy(this), &mut result__).from_abi::<ExtendedExecutionReason>(result__)
        }
    }
    #[doc = "*Required features: `ApplicationModel_ExtendedExecution`*"]
    ...
    pub fn RequestExtensionAsync(&self) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<ExtendedExecutionResult>> {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).14)(::core::mem::transmute_copy(this), &mut result__).from_abi::<super::super::Foundation::IAsyncOperation<ExtendedExecutionResult>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    #[doc = "*Required features: `ApplicationModel_ExtendedExecution`, `Foundation`*"]
...
impl ::core::convert::From<ExtendedExecutionSession> for ::windows::runtime::IUnknown {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown> for &'a ExtendedExecutionSession {
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Borrowed(&self.0 .0)
    }
}
impl ::core::convert::From<ExtendedExecutionSession> for ::windows::runtime::IInspectable {
    fn from(value: ExtendedExecutionSession) -> Self {
        value.0
    }
}
