...
impl ExtendedExecutionRevokedEventArgs {
    pub fn Reason(&self) -> ::windows::runtime::Result<ExtendedExecutionRevokedReason> {
        ...
        unsafe {
            ...
            .from_abi::<ExtendedExecutionRevokedReason>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ExtendedExecutionRevokedEventArgs
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ExtendedExecutionRevokedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl ExtendedExecutionSession {
    ...
    pub fn Reason(&self) -> ::windows::runtime::Result<ExtendedExecutionReason> {
        ...
        unsafe {
            ...
            .from_abi::<ExtendedExecutionReason>(result__)
        }
    }
    ...
    pub fn RequestExtensionAsync(
        ...
        super::super::Foundation::IAsyncOperation<ExtendedExecutionResult>,
    > {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<ExtendedExecutionResult>>(
                result__,
            )
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ExtendedExecutionSession
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IExtendedExecutionRevokedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ExtendedExecutionRevokedReason,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IExtendedExecutionSession_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ExtendedExecutionReason,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: ExtendedExecutionReason,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
