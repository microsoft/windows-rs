...
pub struct IPaymentAppManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        supportedpaymentmethodids: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IPaymentAppManagerStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        64649,
        17414,
        [180, 217, 52, 231, 254, 121, 223, 182],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPaymentTransaction_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        shippingaddress: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        selectedshippingoption: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        paymenttoken: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
...
pub struct IPaymentTransactionAcceptResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::PaymentRequestCompletionStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl PaymentAppCanMakePaymentTriggerDetails {
    pub fn Request(&self) -> ::windows::runtime::Result<super::PaymentRequest> {
        ...
        unsafe {
            ...
            .from_abi::<super::PaymentRequest>(result__)
        }
    }
    pub fn ReportCanMakePaymentResult<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::PaymentCanMakePaymentResult>,
    >(
        &self,
        value: Param0,
...
impl ::std::convert::From<&PaymentAppCanMakePaymentTriggerDetails>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PaymentAppCanMakePaymentTriggerDetails
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PaymentAppCanMakePaymentTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl PaymentAppManager {
    ...
    >(
        &self,
        supportedpaymentmethodids: Param0,
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                supportedpaymentmethodids.into_param().abi(),
                &mut result__,
            )
    ...
    pub fn Current() -> ::windows::runtime::Result<PaymentAppManager> {
        Self::IPaymentAppManagerStatics(|this| unsafe {
            ...
            .from_abi::<PaymentAppManager>(result__)
        })
    }
    pub fn IPaymentAppManagerStatics<
        R,
        F: FnOnce(&IPaymentAppManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl PaymentTransaction {
    ...
    #[cfg(feature = "Foundation")]
    pub fn UpdateShippingAddressAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::PaymentAddress>,
    >(
        &self,
        shippingaddress: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<super::PaymentRequestChangedResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).13)(
                ::std::mem::transmute_copy(this),
                shippingaddress.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<
                super::PaymentRequestChangedResult,
            >>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn UpdateSelectedShippingOptionAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::PaymentShippingOption>,
    >(
        &self,
        selectedshippingoption: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<super::PaymentRequestChangedResult>,
    > {
        let this = self;
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).14)(
                ::std::mem::transmute_copy(this),
                selectedshippingoption.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<
                super::PaymentRequestChangedResult,
    ...
    #[cfg(feature = "Foundation")]
    pub fn AcceptAsync<'a, Param0: ::windows::runtime::IntoParam<'a, super::PaymentToken>>(
        &self,
        paymenttoken: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<PaymentTransactionAcceptResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<PaymentTransaction>,
    > {
        Self::IPaymentTransactionStatics(|this| unsafe {
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<PaymentTransaction>>(
                result__,
            )
        })
    }
    pub fn IPaymentTransactionStatics<
        R,
        F: FnOnce(&IPaymentTransactionStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl PaymentTransactionAcceptResult {
    pub fn Status(&self) -> ::windows::runtime::Result<super::PaymentRequestCompletionStatus> {
        ...
        unsafe {
            ...
            .from_abi::<super::PaymentRequestCompletionStatus>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for PaymentTransactionAcceptResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PaymentTransactionAcceptResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
