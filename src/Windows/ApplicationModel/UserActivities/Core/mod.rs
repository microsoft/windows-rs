...
impl CoreUserActivityManager {
    pub fn CreateUserActivitySessionInBackground<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::UserActivity>,
    >(
        activity: Param0,
    ) -> ::windows::runtime::Result<super::UserActivitySession> {
        Self::ICoreUserActivityManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                activity.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::UserActivitySession>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn DeleteUserActivitySessionsInTimeRangeAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::UserActivityChannel>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::DateTime>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::DateTime>,
    >(
        channel: Param0,
        starttime: Param1,
        endtime: Param2,
    ...
    pub fn ICoreUserActivityManagerStatics<
        R,
        F: FnOnce(&ICoreUserActivityManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
pub struct ICoreUserActivityManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        activity: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        ...
        endtime: super::super::super::Foundation::DateTime,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
