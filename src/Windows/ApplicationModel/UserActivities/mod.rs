...
pub struct IUserActivity_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut UserActivityState,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IUserActivityChannel_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        activityid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
...
unsafe impl ::windows::runtime::RuntimeType for IUserActivityContentInfo {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{b399e5ad-137f-409d-822d-e1af27ce08dc}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IUserActivityContentInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
unsafe impl ::windows::runtime::Interface for IUserActivityRequestManagerStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        8778,
        17196,
        [129, 229, 12, 118, 180, 196, 206, 250],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IUserActivityStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        activities: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation_Collections"))] usize,
);
...
impl UserActivity {
    pub fn State(&self) -> ::windows::runtime::Result<UserActivityState> {
        ...
        unsafe {
            ...
            .from_abi::<UserActivityState>(result__)
        }
    }
    ...
    pub fn VisualElements(&self) -> ::windows::runtime::Result<UserActivityVisualElements> {
        ...
        unsafe {
            ...
            .from_abi::<UserActivityVisualElements>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn ContentInfo(&self) -> ::windows::runtime::Result<IUserActivityContentInfo> {
        ...
        unsafe {
            ...
            .from_abi::<IUserActivityContentInfo>(result__)
        }
    }
    pub fn SetContentInfo<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IUserActivityContentInfo>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn CreateSession(&self) -> ::windows::runtime::Result<UserActivitySession> {
        ...
        unsafe {
            ...
            .from_abi::<UserActivitySession>(result__)
        }
    }
    pub fn ToJson(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
    ...
    >(
        activityid: Param0,
    ) -> ::windows::runtime::Result<UserActivity> {
        Self::IUserActivityFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                activityid.into_param().abi(),
                &mut result__,
            )
            .from_abi::<UserActivity>(result__)
        })
    }
    pub fn TryParseFromJson<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        json: Param0,
    ...
    >(
        json: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVector<UserActivity>>
    {
        Self::IUserActivityStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<UserActivity>>(result__)
        })
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn ToJsonArray<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<UserActivity>,
        >,
    >(
        activities: Param0,
    ...
    pub fn IUserActivityFactory<
        R,
        F: FnOnce(&IUserActivityFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<UserActivity, IUserActivityFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IUserActivityStatics<
        R,
        F: FnOnce(&IUserActivityStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<UserActivity, IUserActivityStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl UserActivityAttribution {
    ...
    #[cfg(feature = "Foundation")]
    pub fn CreateWithUri<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
    >(
        iconuri: Param0,
    ) -> ::windows::runtime::Result<UserActivityAttribution> {
        Self::IUserActivityAttributionFactory(|this| unsafe {
            ...
            .from_abi::<UserActivityAttribution>(result__)
        })
    }
    pub fn IUserActivityAttributionFactory<
        R,
        F: FnOnce(&IUserActivityAttributionFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl UserActivityChannel {
    ...
    >(
        &self,
        activityid: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<UserActivity>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<UserActivity>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    #[cfg(feature = "Foundation")]
    pub fn DeleteAllActivitiesAsync(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncAction> {
        let this = self;
        unsafe {
    ...
    pub fn GetDefault() -> ::windows::runtime::Result<UserActivityChannel> {
        Self::IUserActivityChannelStatics(|this| unsafe {
            ...
            .from_abi::<UserActivityChannel>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetRecentUserActivitiesAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVector<UserActivitySessionHistoryItem>,
        >,
    > {
    ...
    pub fn IUserActivityChannelStatics<
        R,
        F: FnOnce(&IUserActivityChannelStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IUserActivityChannelStatics2<
        R,
        F: FnOnce(&IUserActivityChannelStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IUserActivityChannelStatics3<
        R,
        F: FnOnce(&IUserActivityChannelStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl UserActivityContentInfo {
    ...
    pub fn FromJson<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        value: Param0,
    ) -> ::windows::runtime::Result<UserActivityContentInfo> {
        Self::IUserActivityContentInfoStatics(|this| unsafe {
            ...
            .from_abi::<UserActivityContentInfo>(result__)
        })
    }
    pub fn IUserActivityContentInfoStatics<
        R,
        F: FnOnce(&IUserActivityContentInfoStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, IUserActivityContentInfo> for UserActivityContentInfo {
    fn into_param(self) -> ::windows::runtime::Param<'a, IUserActivityContentInfo> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IUserActivityContentInfo>::into(
            self,
        ))
    }
}
...
impl UserActivityRequest {
    pub fn SetUserActivity<'a, Param0: ::windows::runtime::IntoParam<'a, UserActivity>>(
        &self,
        activity: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
impl UserActivityRequestManager {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveUserActivityRequested<
        'a,
    ...
    pub fn GetForCurrentView() -> ::windows::runtime::Result<UserActivityRequestManager> {
        Self::IUserActivityRequestManagerStatics(|this| unsafe {
            ...
            .from_abi::<UserActivityRequestManager>(result__)
        })
    }
    pub fn IUserActivityRequestManagerStatics<
        R,
        F: FnOnce(&IUserActivityRequestManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserActivityRequestManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl UserActivityRequestedEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<UserActivityRequest> {
        ...
        unsafe {
            ...
            .from_abi::<UserActivityRequest>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserActivityRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserActivitySessionHistoryItem
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl UserActivityVisualElements {
    ...
    pub fn SetAttribution<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, UserActivityAttribution>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn SetContent<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Shell::IAdaptiveCard>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn Content(&self) -> ::windows::runtime::Result<super::super::UI::Shell::IAdaptiveCard> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::UI::Shell::IAdaptiveCard>(result__)
        }
    }
    pub fn AttributionDisplayText(
        &self,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UserActivityVisualElements
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
