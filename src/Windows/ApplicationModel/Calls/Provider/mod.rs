...
unsafe impl ::windows::runtime::Interface for IPhoneCallOrigin3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        53671,
        17314,
        [174, 238, 192, 123, 109, 186, 240, 104],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPhoneCallOriginManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        requestid: ::windows::runtime::GUID,
        callorigin: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IPhoneCallOriginManagerStatics2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        16628,
        17280,
        [140, 124, 174, 162, 201, 184, 221, 122],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IPhoneCallOriginManagerStatics3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        42723,
        20720,
        [183, 106, 214, 124, 179, 155, 223, 222],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl PhoneCallOrigin {
    ...
    pub fn DisplayPicture(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Storage::StorageFile> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Storage::StorageFile>(result__)
        }
    }
    #[cfg(feature = "Storage")]
    pub fn SetDisplayPicture<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Storage::StorageFile>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
...
impl PhoneCallOriginManager {
    ...
    pub fn SetCallOrigin<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::GUID>,
        Param1: ::windows::runtime::IntoParam<'a, PhoneCallOrigin>,
    >(
        requestid: Param0,
        callorigin: Param1,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn IPhoneCallOriginManagerStatics<
        R,
        F: FnOnce(&IPhoneCallOriginManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IPhoneCallOriginManagerStatics2<
        R,
        F: FnOnce(&IPhoneCallOriginManagerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IPhoneCallOriginManagerStatics3<
        R,
        F: FnOnce(&IPhoneCallOriginManagerStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
