...
unsafe impl ::windows::runtime::RuntimeType for DeliveryOptimizationDownloadMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Store.Preview.DeliveryOptimizationDownloadMode;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
impl DeliveryOptimizationDownloadModeSource {
    pub const Default: DeliveryOptimizationDownloadModeSource =
        DeliveryOptimizationDownloadModeSource(0i32);
    pub const Policy: DeliveryOptimizationDownloadModeSource =
        DeliveryOptimizationDownloadModeSource(1i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for DeliveryOptimizationDownloadModeSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Store.Preview.DeliveryOptimizationDownloadModeSource;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl DeliveryOptimizationSettings {
    pub fn DownloadMode(&self) -> ::windows::runtime::Result<DeliveryOptimizationDownloadMode> {
        ...
        unsafe {
            ...
            .from_abi::<DeliveryOptimizationDownloadMode>(result__)
        }
    }
    pub fn DownloadModeSource(
        &self,
    ) -> ::windows::runtime::Result<DeliveryOptimizationDownloadModeSource> {
        let this = self;
        unsafe {
            ...
            .from_abi::<DeliveryOptimizationDownloadModeSource>(result__)
        }
    }
    pub fn GetCurrentSettings() -> ::windows::runtime::Result<DeliveryOptimizationSettings> {
        Self::IDeliveryOptimizationSettingsStatics(|this| unsafe {
            ...
            .from_abi::<DeliveryOptimizationSettings>(result__)
        })
    }
    pub fn IDeliveryOptimizationSettingsStatics<
        R,
        F: FnOnce(&IDeliveryOptimizationSettingsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl ::std::convert::From<DeliveryOptimizationSettings> for ::windows::runtime::IUnknown {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DeliveryOptimizationSettings
{
...
impl ::std::convert::From<DeliveryOptimizationSettings> for ::windows::runtime::IInspectable {
    fn from(value: DeliveryOptimizationSettings) -> Self {
        value.0
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DeliveryOptimizationSettings
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
pub struct IDeliveryOptimizationSettings_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DeliveryOptimizationDownloadMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DeliveryOptimizationDownloadModeSource,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IDeliveryOptimizationSettingsStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        44757,
        22937,
        [180, 201, 140, 96, 137, 139, 196, 243],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IStoreConfigurationStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        cataloghardwaremanufacturerid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        catalogstorecontentmodifierid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        systemconfigurationexpiration: super::super::super::Foundation::DateTime,
        cataloghardwaredescriptor: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        mobileoperatorid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        appdownloadlimitinmegabytes: u32,
        updatedownloadlimitinmegabytes: u32,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        systemfeatures: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IStorePreviewPurchaseResults_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StorePreviewProductPurchaseStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IWebAuthenticationCoreManagerHelper_abi(
    ...
    #[cfg(all(
        feature = "Foundation",
        feature = "Security_Authentication_Web_Core",
        feature = "UI_Xaml"
    ))]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        request: ::windows::runtime::RawPtr,
        uielement: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Foundation",
...
impl StoreConfiguration {
    ...
    >(
        ...
        Self::IStoreConfigurationStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                cataloghardwaremanufacturerid.into_param().abi(),
                catalogstorecontentmodifierid.into_param().abi(),
                systemconfigurationexpiration.into_param().abi(),
                cataloghardwaredescriptor.into_param().abi(),
            )
            .ok()
        })
    }
    pub fn SetMobileOperatorConfiguration<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        mobileoperatorid: Param0,
        appdownloadlimitinmegabytes: u32,
        updatedownloadlimitinmegabytes: u32,
    ) -> ::windows::runtime::Result<()> {
        Self::IStoreConfigurationStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                mobileoperatorid.into_param().abi(),
    ...
    pub fn HardwareManufacturerInfo() -> ::windows::runtime::Result<StoreHardwareManufacturerInfo> {
        Self::IStoreConfigurationStatics(|this| unsafe {
            ...
            .from_abi::<StoreHardwareManufacturerInfo>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn FilterUnsupportedSystemFeaturesAsync<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::Collections::IIterable<StoreSystemFeature>,
        >,
    >(
        systemfeatures: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Foundation::Collections::IVectorView<StoreSystemFeature>,
        >,
    > {
        Self::IStoreConfigurationStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(feature = "Foundation")]
    pub fn PurchasePromptingPolicy(
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetPurchasePromptingPolicy<
        'a,
    ...
    #[cfg(feature = "System")]
    pub fn HasStoreWebAccountForUser<
        'a,
    ...
    #[cfg(feature = "System")]
    pub fn SetStoreWebAccountIdForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
    ...
    #[cfg(feature = "System")]
    pub fn IsStoreWebAccountIdForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
    ...
    #[cfg(all(feature = "Foundation", feature = "System"))]
    pub fn GetPurchasePromptingPolicyForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
    >(
        user: Param0,
    ...
    #[cfg(all(feature = "Foundation", feature = "System"))]
    pub fn SetPurchasePromptingPolicyForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
    ...
    #[cfg(feature = "System")]
    pub fn GetStoreWebAccountIdForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
    >(
        user: Param0,
    ...
    #[cfg(feature = "System")]
    pub fn SetEnterpriseStoreWebAccountIdForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
    ...
    pub fn GetEnterpriseStoreWebAccountId(
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        Self::IStoreConfigurationStatics4(|this| unsafe {
            let mut result__: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING> =
                ::std::mem::zeroed();
    ...
    #[cfg(feature = "System")]
    pub fn GetEnterpriseStoreWebAccountIdForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
    >(
        user: Param0,
    ...
    #[cfg(feature = "System")]
    pub fn ShouldRestrictToEnterpriseStoreOnlyForUser<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::User>,
    >(
        user: Param0,
    ...
    pub fn IStoreConfigurationStatics<
        R,
        F: FnOnce(&IStoreConfigurationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IStoreConfigurationStatics2<
        R,
        F: FnOnce(&IStoreConfigurationStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IStoreConfigurationStatics3<
        R,
        F: FnOnce(&IStoreConfigurationStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IStoreConfigurationStatics4<
        R,
        F: FnOnce(&IStoreConfigurationStatics4) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IStoreConfigurationStatics5<
        R,
        F: FnOnce(&IStoreConfigurationStatics5) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl ::std::convert::From<StoreHardwareManufacturerInfo> for ::windows::runtime::IUnknown {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for StoreHardwareManufacturerInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<StoreHardwareManufacturerInfo> for ::windows::runtime::IInspectable {
    fn from(value: StoreHardwareManufacturerInfo) -> Self {
        value.0
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StoreHardwareManufacturerInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for StoreLogOptions {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Store.Preview.StoreLogOptions;u4)",
    );
}
...
impl StorePreview {
    #[cfg(feature = "Foundation")]
    pub fn RequestProductPurchaseByProductIdAndSkuIdAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<StorePreviewPurchaseResults>,
    > {
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn LoadAddOnProductInfosAsync() -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Foundation::Collections::IVectorView<StorePreviewProductInfo>,
        >,
    > {
        Self::IStorePreview(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn IStorePreview<R, F: FnOnce(&IStorePreview) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<StorePreview, IStorePreview> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl StorePreviewProductInfo {
    ...
    pub fn SkuInfoList(
        ...
        super::super::super::Foundation::Collections::IVectorView<StorePreviewSkuInfo>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl ::std::convert::From<StorePreviewProductInfo> for ::windows::runtime::IUnknown {
...
impl ::std::convert::From<StorePreviewProductInfo> for ::windows::runtime::IInspectable {
    fn from(value: StorePreviewProductInfo) -> Self {
        value.0
    }
}
...
impl StorePreviewProductPurchaseStatus {
    pub const Succeeded: StorePreviewProductPurchaseStatus =
        StorePreviewProductPurchaseStatus(0i32);
    pub const AlreadyPurchased: StorePreviewProductPurchaseStatus =
        StorePreviewProductPurchaseStatus(1i32);
    pub const NotFulfilled: StorePreviewProductPurchaseStatus =
        StorePreviewProductPurchaseStatus(2i32);
    pub const NotPurchased: StorePreviewProductPurchaseStatus =
        StorePreviewProductPurchaseStatus(3i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for StorePreviewProductPurchaseStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Store.Preview.StorePreviewProductPurchaseStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl StorePreviewPurchaseResults {
    pub fn ProductPurchaseStatus(
        &self,
    ) -> ::windows::runtime::Result<StorePreviewProductPurchaseStatus> {
        let this = self;
        unsafe {
            ...
            .from_abi::<StorePreviewProductPurchaseStatus>(result__)
        }
    }
}
...
impl ::std::convert::From<StorePreviewPurchaseResults> for ::windows::runtime::IUnknown {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for StorePreviewPurchaseResults
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<StorePreviewPurchaseResults> for ::windows::runtime::IInspectable {
    fn from(value: StorePreviewPurchaseResults) -> Self {
        value.0
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StorePreviewPurchaseResults
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::convert::From<StorePreviewSkuInfo> for ::windows::runtime::IUnknown {
...
impl ::std::convert::From<StorePreviewSkuInfo> for ::windows::runtime::IInspectable {
    fn from(value: StorePreviewSkuInfo) -> Self {
        value.0
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for StoreSystemFeature {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Store.Preview.StoreSystemFeature;i4)",
    );
}
...
impl WebAuthenticationCoreManagerHelper {
    ...
    pub fn RequestTokenWithUIElementHostingAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Security::Authentication::Web::Core::WebTokenRequest,
        >,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::UI::Xaml::UIElement>,
    >(
        request: Param0,
        uielement: Param1,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<
            super::super::super::Security::Authentication::Web::Core::WebTokenRequestResult,
        >,
    > {
    ...
    pub fn RequestTokenWithUIElementHostingAndWebAccountAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Security::Authentication::Web::Core::WebTokenRequest,
        >,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Security::Credentials::WebAccount>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::UI::Xaml::UIElement>,
    >(
        request: Param0,
        webaccount: Param1,
        uielement: Param2,
    ...
    pub fn IWebAuthenticationCoreManagerHelper<
        R,
        F: FnOnce(&IWebAuthenticationCoreManagerHelper) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
