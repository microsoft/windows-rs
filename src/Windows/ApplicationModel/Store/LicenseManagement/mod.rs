...
pub struct ILicenseManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        contentids: ::windows::runtime::RawPtr,
        keyids: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct ILicenseManagerStatics2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        refreshoption: LicenseRefreshOption,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
impl LicenseManager {
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetSatisfactionInfosAsync<
        'a,
    ...
    >(
        ...
        super::super::super::Foundation::IAsyncOperation<LicenseSatisfactionResult>,
    > {
        Self::ILicenseManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn ILicenseManagerStatics<
        R,
        F: FnOnce(&ILicenseManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn ILicenseManagerStatics2<
        R,
        F: FnOnce(&ILicenseManagerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for LicenseRefreshOption {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Store.LicenseManagement.LicenseRefreshOption;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LicenseSatisfactionResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
