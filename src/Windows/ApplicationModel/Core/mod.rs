...
pub struct AppListEntry(::windows::runtime::IInspectable);
impl AppListEntry {
    pub fn DisplayInfo(&self) -> ::windows::runtime::Result<super::AppDisplayInfo> {
        ...
        unsafe {
            ...
            .from_abi::<super::AppDisplayInfo>(result__)
        }
    }
    ...
    pub fn AppInfo(&self) -> ::windows::runtime::Result<super::AppInfo> {
        ...
        unsafe {
            ...
            .from_abi::<super::AppInfo>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for AppListEntry {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.ApplicationModel.Core.AppListEntry;{ef00f07f-2108-490a-877a-8a9f17c25fad})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for AppRestartFailureReason {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.ApplicationModel.Core.AppRestartFailureReason;i4)",
    );
}
...
impl CoreApplication {
    ...
    pub fn Suspending<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::EventHandler<super::SuspendingEventArgs>,
        >,
    >(
        handler: Param0,
    ...
    pub fn Run<'a, Param0: ::windows::runtime::IntoParam<'a, IFrameworkViewSource>>(
        viewsource: Param0,
    ) -> ::windows::runtime::Result<()> {
        Self::ICoreApplication(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).13)(
                ::std::mem::transmute_copy(this),
                viewsource.into_param().abi(),
            )
            .ok()
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn RunWithActivationFactories<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::IGetActivationFactory>,
    >(
        activationfactorycallback: Param0,
    ) -> ::windows::runtime::Result<()> {
        Self::ICoreApplication(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).14)(
                ::std::mem::transmute_copy(this),
                activationfactorycallback.into_param().abi(),
            )
            .ok()
        })
    }
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveUnhandledErrorDetected<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        token: Param0,
    ...
    pub fn IncrementApplicationUseCount() -> ::windows::runtime::Result<()> {
        Self::ICoreApplicationUseCount(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).6)(::std::mem::transmute_copy(this)).ok()
        })
    }
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn Views() -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<CoreApplicationView>,
    > {
        Self::ICoreImmersiveApplication(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<CoreApplicationView>>(
                result__,
            )
        })
    }
    pub fn CreateNewView<
        'a,
    ...
    >(
        runtimetype: Param0,
        entrypoint: Param1,
    ) -> ::windows::runtime::Result<CoreApplicationView> {
        Self::ICoreImmersiveApplication(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                runtimetype.into_param().abi(),
    ...
    pub fn CreateNewViewWithViewSource<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IFrameworkViewSource>,
    >(
        viewsource: Param0,
    ) -> ::windows::runtime::Result<CoreApplicationView> {
    ...
    pub fn BackgroundActivated<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::EventHandler<super::Activation::BackgroundActivatedEventArgs>,
        >,
    >(
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
    ...
    pub fn LeavingBackground<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::EventHandler<super::LeavingBackgroundEventArgs>,
        >,
    >(
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
    ...
    pub fn EnteredBackground<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::EventHandler<super::EnteredBackgroundEventArgs>,
        >,
    >(
        handler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<AppRestartFailureReason>,
    > {
        Self::ICoreApplication3(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<AppRestartFailureReason>>(
                result__,
            )
        })
    }
    ...
    pub fn ICoreApplication<R, F: FnOnce(&ICoreApplication) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<CoreApplication, ICoreApplication> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn ICoreApplicationExit<
        R,
        F: FnOnce(&ICoreApplicationExit) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<CoreApplication, ICoreApplicationExit> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn ICoreApplicationUnhandledError<
        R,
        F: FnOnce(&ICoreApplicationUnhandledError) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
    ...
    pub fn ICoreApplicationUseCount<
        R,
        F: FnOnce(&ICoreApplicationUseCount) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ICoreImmersiveApplication<
        R,
        F: FnOnce(&ICoreImmersiveApplication) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ICoreImmersiveApplication2<
        R,
        F: FnOnce(&ICoreImmersiveApplication2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ICoreImmersiveApplication3<
        R,
        F: FnOnce(&ICoreImmersiveApplication3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn ICoreApplication2<R, F: FnOnce(&ICoreApplication2) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<CoreApplication, ICoreApplication2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn ICoreApplication3<R, F: FnOnce(&ICoreApplication3) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<CoreApplication, ICoreApplication3> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
pub struct CoreApplicationView(::windows::runtime::IInspectable);
impl CoreApplicationView {
    ...
    pub fn CoreWindow(&self) -> ::windows::runtime::Result<super::super::UI::Core::CoreWindow> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::UI::Core::CoreWindow>(result__)
        }
    }
    #[cfg(all(feature = "ApplicationModel_Activation", feature = "Foundation"))]
    pub fn Activated<
        ...
        Param0: ::windows::runtime::IntoParam<
            ...
            super::super::Foundation::TypedEventHandler<
                CoreApplicationView,
                super::Activation::IActivatedEventArgs,
            >,
        >,
    >(
        &self,
    ...
    pub fn TitleBar(&self) -> ::windows::runtime::Result<CoreApplicationViewTitleBar> {
        ...
        unsafe {
            ...
            .from_abi::<CoreApplicationViewTitleBar>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn HostedViewClosing<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::TypedEventHandler<
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveHostedViewClosing<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
...
pub struct CoreApplicationViewTitleBar(::windows::runtime::IInspectable);
impl CoreApplicationViewTitleBar {
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveLayoutMetricsChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::EventRegistrationToken>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CoreApplicationViewTitleBar
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CoreApplicationViewTitleBar
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct HostedViewClosingEventArgs(::windows::runtime::IInspectable);
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for HostedViewClosingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a HostedViewClosingEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct ICoreApplication_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        viewsource: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        activationfactorycallback: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
#[repr(transparent)]
...
pub struct ICoreApplicationUnhandledError(::windows::runtime::IInspectable);
unsafe impl ::windows::runtime::Interface for ICoreApplicationUnhandledError {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        56585,
        17121,
        [176, 188, 224, 225, 49, 247, 141, 126],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for ICoreApplicationUnhandledError {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{f0e24ab0-dd09-42e1-b0bc-e0e131f78d7e}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ICoreApplicationUnhandledError
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ICoreApplicationUnhandledError
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct ICoreImmersiveApplication_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        runtimetype: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        entrypoint: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IFrameworkView {
    pub fn Initialize<'a, Param0: ::windows::runtime::IntoParam<'a, CoreApplicationView>>(
        &self,
    ...
    pub fn SetWindow<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Core::CoreWindow>,
    >(
        &self,
        window: Param0,
    ) -> ::windows::runtime::Result<()> {
...
unsafe impl ::windows::runtime::RuntimeType for IFrameworkView {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{faab5cd0-8924-45ac-ad0f-a08fae5d0324}");
}
...
pub struct IFrameworkView_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        applicationview: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "UI_Core")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::RuntimeType for IFrameworkViewSource {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{cd770614-65c4-426c-9494-34fc43554862}");
}
...
pub struct UnhandledError(::windows::runtime::IInspectable);
impl UnhandledError {
...
unsafe impl ::windows::runtime::RuntimeType for UnhandledError {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.ApplicationModel.Core.UnhandledError;{9459b726-53b5-4686-9eaf-fa8162dc3980})",
    );
}
...
pub struct UnhandledErrorDetectedEventArgs(::windows::runtime::IInspectable);
impl UnhandledErrorDetectedEventArgs {
    pub fn UnhandledError(&self) -> ::windows::runtime::Result<UnhandledError> {
        ...
        unsafe {
            ...
            .from_abi::<UnhandledError>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for UnhandledErrorDetectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UnhandledErrorDetectedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
