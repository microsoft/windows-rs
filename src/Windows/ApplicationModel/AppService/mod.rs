...
impl AppServiceCatalog {
    ...
    >(
        appservicename: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<super::AppInfo>,
        >,
    > {
    ...
    pub fn IAppServiceCatalogStatics<
        R,
        F: FnOnce(&IAppServiceCatalogStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl AppServiceClosedEventArgs {
    pub fn Status(&self) -> ::windows::runtime::Result<AppServiceClosedStatus> {
        ...
        unsafe {
            ...
            .from_abi::<AppServiceClosedStatus>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppServiceClosedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl AppServiceConnection {
    ...
    pub fn OpenAsync(
        ...
        super::super::Foundation::IAsyncOperation<AppServiceConnectionStatus>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<AppServiceConnectionStatus>>(
                result__,
            )
        }
    }
    ...
    >(
        &self,
        message: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<AppServiceResponse>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<AppServiceResponse>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    ...
    pub fn OpenRemoteAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::System::RemoteSystems::RemoteSystemConnectionRequest,
        >,
    >(
        &self,
    ...
    > {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                remotesystemconnectionrequest.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<AppServiceConnectionStatus>>(
                result__,
    ...
    #[cfg(feature = "System")]
    pub fn SetUser<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::System::User>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = &::windows::runtime::Interface::cast::<IAppServiceConnection2>(self)?;
    ...
    #[cfg(all(
        ...
        feature = "System_RemoteSystems"
    ))]
    pub fn SendStatelessMessageAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, AppServiceConnection>,
        Param1: ::windows::runtime::IntoParam<
            'a,
            super::super::System::RemoteSystems::RemoteSystemConnectionRequest,
        >,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::Collections::ValueSet>,
    >(
        connection: Param0,
        connectionrequest: Param1,
        message: Param2,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<StatelessAppServiceResponse>,
    > {
        Self::IAppServiceConnectionStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                connectionrequest.into_param().abi(),
                message.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<StatelessAppServiceResponse>>(
                result__,
            )
        })
    }
    pub fn IAppServiceConnectionStatics<
        R,
        F: FnOnce(&IAppServiceConnectionStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl AppServiceConnectionStatus {
    ...
    pub const RemoteSystemUnavailable: AppServiceConnectionStatus =
        AppServiceConnectionStatus(5i32);
    pub const RemoteSystemNotSupportedByApp: AppServiceConnectionStatus =
        AppServiceConnectionStatus(6i32);
...
impl AppServiceRequest {
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<AppServiceResponseStatus>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<AppServiceResponseStatus>>(
                result__,
            )
        }
    }
...
impl AppServiceRequestReceivedEventArgs {
    pub fn Request(&self) -> ::windows::runtime::Result<AppServiceRequest> {
        ...
        unsafe {
            ...
            .from_abi::<AppServiceRequest>(result__)
        }
    }
    pub fn GetDeferral(&self) -> ::windows::runtime::Result<AppServiceDeferral> {
        ...
        unsafe {
            ...
            .from_abi::<AppServiceDeferral>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AppServiceRequestReceivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&AppServiceRequestReceivedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppServiceRequestReceivedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl AppServiceResponse {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<AppServiceResponseStatus> {
        ...
        unsafe {
            ...
            .from_abi::<AppServiceResponseStatus>(result__)
        }
    }
}
...
impl AppServiceTriggerDetails {
    ...
    pub fn AppServiceConnection(&self) -> ::windows::runtime::Result<AppServiceConnection> {
        ...
        unsafe {
            ...
            .from_abi::<AppServiceConnection>(result__)
        }
    }
    ...
    pub fn CallerRemoteConnectionToken(
        &self,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a AppServiceTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IAppServiceCatalogStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appservicename: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
pub struct IAppServiceClosedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppServiceClosedStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IAppServiceConnection2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        remotesystemconnectionrequest: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IAppServiceConnectionStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        connectionrequest: ::windows::runtime::RawPtr,
        message: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
...
pub struct IAppServiceResponse_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AppServiceResponseStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IStatelessAppServiceResponse {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        43500,
        21246,
        [130, 231, 147, 155, 104, 220, 147, 136],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IStatelessAppServiceResponse_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut StatelessAppServiceResponseStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl StatelessAppServiceResponse {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<StatelessAppServiceResponseStatus> {
        ...
        unsafe {
            ...
            .from_abi::<StatelessAppServiceResponseStatus>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for StatelessAppServiceResponse
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a StatelessAppServiceResponse
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl StatelessAppServiceResponseStatus {
    ...
    pub const AppNotInstalled: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(1i32);
    pub const AppUnavailable: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(2i32);
    pub const AppServiceUnavailable: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(3i32);
    pub const RemoteSystemUnavailable: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(4i32);
    pub const RemoteSystemNotSupportedByApp: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(5i32);
    pub const NotAuthorized: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(6i32);
    pub const ResourceLimitsExceeded: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(7i32);
    pub const MessageSizeTooLarge: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(8i32);
    ...
    pub const AuthenticationError: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(11i32);
    pub const NetworkNotAvailable: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(12i32);
    pub const DisabledByPolicy: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(13i32);
    pub const WebServiceUnavailable: StatelessAppServiceResponseStatus =
        StatelessAppServiceResponseStatus(14i32);
}
