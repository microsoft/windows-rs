...
impl HolographicKeyboard {
    ...
    pub fn SetPlacementOverride<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Perception::Spatial::SpatialCoordinateSystem,
        >,
    ...
    pub fn SetPlacementOverrideWithMaxSize<
        ...
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::Numerics::Vector3>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::Numerics::Quaternion>,
        Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::Numerics::Vector2>,
    >(
        &self,
        coordinatesystem: Param0,
        topcenterposition: Param1,
    ...
    pub fn GetDefault() -> ::windows::runtime::Result<HolographicKeyboard> {
        Self::IHolographicKeyboardStatics(|this| unsafe {
            ...
            .from_abi::<HolographicKeyboard>(result__)
        })
    }
    pub fn IHolographicKeyboardStatics<
        R,
        F: FnOnce(&IHolographicKeyboardStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
            HolographicKeyboard,
            IHolographicKeyboardStatics,
...
pub struct IHolographicKeyboard_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        topcenterposition: super::super::Foundation::Numerics::Vector3,
    ...
    pub  unsafe extern "system" fn(
        ...
        topcenterposition: super::super::Foundation::Numerics::Vector3,
        orientation: super::super::Foundation::Numerics::Quaternion,
        maxsize: super::super::Foundation::Numerics::Vector2,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation_Numerics", feature = "Perception_Spatial")))] usize,
