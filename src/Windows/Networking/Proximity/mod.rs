...
impl ConnectionRequestedEventArgs {
    pub fn PeerInformation(&self) -> ::windows::runtime::Result<PeerInformation> {
        ...
        unsafe {
            ...
            .from_abi::<PeerInformation>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ConnectionRequestedEventArgs
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ConnectionRequestedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl DeviceArrivedEventHandler {
    pub fn new<
        F: FnMut(&::std::option::Option<ProximityDevice>) -> ::windows::runtime::Result<()> + 'static,
    >(
        invoke: F,
    ) -> Self {
    ...
    pub fn Invoke<'a, Param0: ::windows::runtime::IntoParam<'a, ProximityDevice>>(
        &self,
        sender: Param0,
...
unsafe impl ::windows::runtime::RuntimeType for DeviceArrivedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({efa9da69-f6e1-49c9-a49e-8e0fc58fb911})",
    );
}
...
#[repr(C)]
struct DeviceArrivedEventHandler_box<
    F: FnMut(&::std::option::Option<ProximityDevice>) -> ::windows::runtime::Result<()> + 'static,
> {
...
impl<
        F: FnMut(&::std::option::Option<ProximityDevice>) -> ::windows::runtime::Result<()> + 'static,
    > DeviceArrivedEventHandler_box<F>
{
    const VTABLE: DeviceArrivedEventHandler_abi = DeviceArrivedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid == &<DeviceArrivedEventHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ((*this).invoke)(
            &*(&sender as *const <ProximityDevice as ::windows::runtime::Abi>::Abi
                as *const <ProximityDevice as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for DeviceDepartedEventHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({efa9da69-f6e2-49c9-a49e-8e0fc58fb911})",
    );
}
...
#[repr(C)]
struct DeviceDepartedEventHandler_box<
    F: FnMut(&::std::option::Option<ProximityDevice>) -> ::windows::runtime::Result<()> + 'static,
> {
...
impl<
        F: FnMut(&::std::option::Option<ProximityDevice>) -> ::windows::runtime::Result<()> + 'static,
    > DeviceDepartedEventHandler_box<F>
{
    const VTABLE: DeviceDepartedEventHandler_abi = DeviceDepartedEventHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid == &<DeviceDepartedEventHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
...
pub struct IPeerFinderStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PeerDiscoveryTypes,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        peermessage: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        peerinformation: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IPeerWatcher_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PeerWatcherStatus,
    ) -> ::windows::runtime::HRESULT,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
);
...
pub struct IProximityDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        messagetype: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        messagereceivedhandler: ::windows::runtime::RawPtr,
        result__: *mut i64,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        ...
        messagetype: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        message: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        messagetransmittedhandler: ::windows::runtime::RawPtr,
        result__: *mut i64,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Storage_Streams")]
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        arrivedhandler: ::windows::runtime::RawPtr,
        result__: *mut super::super::Foundation::EventRegistrationToken,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        departedhandler: ::windows::runtime::RawPtr,
        result__: *mut super::super::Foundation::EventRegistrationToken,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
...
pub struct ITriggeredConnectionStateChangedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut TriggeredConnectState,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut u32,
...
impl MessageReceivedHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<ProximityDevice>,
                &::std::option::Option<ProximityMessage>,
            ) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ...
    pub fn Invoke<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ProximityDevice>,
        Param1: ::windows::runtime::IntoParam<'a, ProximityMessage>,
    >(
        &self,
        sender: Param0,
        message: Param1,
...
unsafe impl ::windows::runtime::RuntimeType for MessageReceivedHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({efab0782-f6e2-4675-a045-d8e320c24808})",
    );
}
...
#[repr(C)]
struct MessageReceivedHandler_box<
    F: FnMut(
            &::std::option::Option<ProximityDevice>,
            &::std::option::Option<ProximityMessage>,
        ) -> ::windows::runtime::Result<()>
...
impl<
        F: FnMut(
            ...
            + 'static,
    > MessageReceivedHandler_box<F>
{
    const VTABLE: MessageReceivedHandler_abi = MessageReceivedHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid == &<MessageReceivedHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
    ...
    unsafe extern "system" fn Invoke(
        ...
        ((*this).invoke)(
            &*(&sender as *const <ProximityDevice as ::windows::runtime::Abi>::Abi
                as *const <ProximityDevice as ::windows::runtime::Abi>::DefaultType),
            &*(&message as *const <ProximityMessage as ::windows::runtime::Abi>::Abi
                as *const <ProximityMessage as ::windows::runtime::Abi>::DefaultType),
        )
        .into()
    }
}
...
impl MessageTransmittedHandler {
    pub fn new<
        F: FnMut(&::std::option::Option<ProximityDevice>, i64) -> ::windows::runtime::Result<()>
            + 'static,
    >(
        invoke: F,
    ) -> Self {
...
unsafe impl ::windows::runtime::RuntimeType for MessageTransmittedHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({efaa0b4a-f6e2-4d7d-856c-78fc8efc021e})",
    );
}
...
#[repr(C)]
struct MessageTransmittedHandler_box<
    F: FnMut(&::std::option::Option<ProximityDevice>, i64) -> ::windows::runtime::Result<()> + 'static,
> {
...
impl<
        F: FnMut(&::std::option::Option<ProximityDevice>, i64) -> ::windows::runtime::Result<()>
            + 'static,
    > MessageTransmittedHandler_box<F>
{
    const VTABLE: MessageTransmittedHandler_abi = MessageTransmittedHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid == &<MessageTransmittedHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
...
impl ::std::convert::From<u32> for PeerDiscoveryTypes {
...
impl ::std::ops::BitAnd for PeerDiscoveryTypes {
    type Output = Self;
    fn bitand(self, rhs: Self) -> Self {
        Self(self.0 & rhs.0)
    }
}
impl ::std::ops::BitOrAssign for PeerDiscoveryTypes {
    fn bitor_assign(&mut self, rhs: Self) {
        self.0.bitor_assign(rhs.0)
    }
}
impl ::std::ops::BitAndAssign for PeerDiscoveryTypes {
    fn bitand_assign(&mut self, rhs: Self) {
        self.0.bitand_assign(rhs.0)
    }
}
impl ::std::ops::Not for PeerDiscoveryTypes {
    type Output = Self;
    fn not(self) -> Self {
        Self(self.0.not())
    }
...
impl PeerFinder {
    ...
    pub fn SupportedDiscoveryTypes() -> ::windows::runtime::Result<PeerDiscoveryTypes> {
        Self::IPeerFinderStatics(|this| unsafe {
            ...
            .from_abi::<PeerDiscoveryTypes>(result__)
        })
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn AlternateIdentities() -> ::windows::runtime::Result<
    ...
    #[cfg(feature = "Foundation")]
    pub fn TriggeredConnectionStateChanged<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemoveTriggeredConnectionStateChanged<
        'a,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn FindAllPeersAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<PeerInformation>,
        >,
    > {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(all(feature = "Foundation", feature = "Networking_Sockets"))]
    pub fn ConnectAsync<'a, Param0: ::windows::runtime::IntoParam<'a, PeerInformation>>(
        peerinformation: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<super::Sockets::StreamSocket>,
    > {
        Self::IPeerFinderStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).24)(
                ::std::mem::transmute_copy(this),
                peerinformation.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<super::Sockets::StreamSocket>>(
                result__,
            )
        })
    }
    ...
    pub fn CreateWatcher() -> ::windows::runtime::Result<PeerWatcher> {
        Self::IPeerFinderStatics2(|this| unsafe {
            ...
            .from_abi::<PeerWatcher>(result__)
        })
    }
    pub fn IPeerFinderStatics<
        R,
        F: FnOnce(&IPeerFinderStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<PeerFinder, IPeerFinderStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IPeerFinderStatics2<
        R,
        F: FnOnce(&IPeerFinderStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<PeerFinder, IPeerFinderStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl PeerInformation {
    ...
    pub fn HostName(&self) -> ::windows::runtime::Result<super::HostName> {
        let this =
            &::windows::runtime::Interface::cast::<IPeerInformationWithHostAndService>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
...
unsafe impl ::windows::runtime::RuntimeType for PeerInformation {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Networking.Proximity.PeerInformation;{20024f08-9fff-45f4-b6e9-408b2ebef373})",
    );
}
...
impl ::std::convert::From<i32> for PeerRole {
...
impl PeerWatcher {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<PeerWatcherStatus> {
        let this = self;
        unsafe {
            let mut result__: PeerWatcherStatus = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).16)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<PeerWatcherStatus>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for PeerWatcher {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Networking.Proximity.PeerWatcher;{3cee21f8-2fa6-4679-9691-03c94a420f34})",
    );
}
...
impl ::std::convert::From<i32> for PeerWatcherStatus {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl ProximityDevice {
    pub fn SubscribeForMessage<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, MessageReceivedHandler>,
    >(
        &self,
        messagetype: Param0,
        messagereceivedhandler: Param1,
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                messagetype.into_param().abi(),
                messagereceivedhandler.into_param().abi(),
                &mut result__,
            )
    ...
    pub fn PublishMessageWithCallback<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param2: ::windows::runtime::IntoParam<'a, MessageTransmittedHandler>,
    >(
        &self,
        messagetype: Param0,
        message: Param1,
        messagetransmittedhandler: Param2,
    ) -> ::windows::runtime::Result<i64> {
        let this = self;
        unsafe {
            let mut result__: i64 = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ...
                messagetype.into_param().abi(),
                message.into_param().abi(),
                messagetransmittedhandler.into_param().abi(),
                &mut result__,
            )
            .from_abi::<i64>(result__)
        }
    ...
    #[cfg(feature = "Storage_Streams")]
    pub fn PublishBinaryMessageWithCallback<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IBuffer>,
        Param2: ::windows::runtime::IntoParam<'a, MessageTransmittedHandler>,
    ...
    #[cfg(feature = "Foundation")]
    pub fn PublishUriMessageWithCallback<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, MessageTransmittedHandler>,
    >(
        &self,
        message: Param0,
        messagetransmittedhandler: Param1,
    ) -> ::windows::runtime::Result<i64> {
        let this = self;
        unsafe {
            let mut result__: i64 = ::std::mem::zeroed();
    ...
    #[cfg(feature = "Foundation")]
    pub fn DeviceArrived<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, DeviceArrivedEventHandler>,
    >(
        &self,
        arrivedhandler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
        let this = self;
        unsafe {
            let mut result__: super::super::Foundation::EventRegistrationToken =
    ...
    #[cfg(feature = "Foundation")]
    pub fn DeviceDeparted<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, DeviceDepartedEventHandler>,
    >(
        &self,
        departedhandler: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::EventRegistrationToken> {
        let this = self;
        unsafe {
            let mut result__: super::super::Foundation::EventRegistrationToken =
            ...
            (::windows::runtime::Interface::vtable(this).17)(
                ::std::mem::transmute_copy(this),
                departedhandler.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::EventRegistrationToken>(result__)
        }
    ...
    pub fn IProximityDeviceStatics<
        R,
        F: FnOnce(&IProximityDeviceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
...
unsafe impl ::windows::runtime::RuntimeType for ProximityDevice {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Networking.Proximity.ProximityDevice;{efa8a552-f6e1-4329-a0fc-ab6b0fd28262})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for ProximityMessage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Networking.Proximity.ProximityMessage;{efab0782-f6e1-4675-a045-d8e320c24808})",
    );
}
...
impl ::std::convert::From<i32> for TriggeredConnectState {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl TriggeredConnectionStateChangedEventArgs {
    pub fn State(&self) -> ::windows::runtime::Result<TriggeredConnectState> {
        let this = self;
        unsafe {
            let mut result__: TriggeredConnectState = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<TriggeredConnectState>(result__)
        }
    }
    ...
    pub fn Socket(&self) -> ::windows::runtime::Result<super::Sockets::StreamSocket> {
        ...
        unsafe {
            ...
            .from_abi::<super::Sockets::StreamSocket>(result__)
        }
    }
}
...
impl ::std::convert::From<TriggeredConnectionStateChangedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for TriggeredConnectionStateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a TriggeredConnectionStateChangedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
