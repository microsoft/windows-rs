...
unsafe impl ::windows::runtime::Interface for IPushNotificationChannel {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        61195,
        20281,
        [155, 138, 163, 193, 148, 222, 112, 129],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPushNotificationChannelManagerForUser2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appserverkey: ::windows::runtime::RawPtr,
...
pub struct IPushNotificationReceivedEventArgs_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PushNotificationType,
    ) -> ::windows::runtime::HRESULT,
...
impl PushNotificationChannel {
    ...
    #[cfg(feature = "Foundation")]
    pub fn PushNotificationReceived<
        'a,
    ...
    #[cfg(feature = "Foundation")]
    pub fn RemovePushNotificationReceived<
        'a,
...
impl PushNotificationChannelManager {
    #[cfg(feature = "Foundation")]
    pub fn CreatePushNotificationChannelForApplicationAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<PushNotificationChannel>,
    > {
        Self::IPushNotificationChannelManagerStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<PushNotificationChannel>>(
                result__,
            )
        })
    }
    ...
    pub fn GetForUser<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::System::User>>(
        user: Param0,
    ) -> ::windows::runtime::Result<PushNotificationChannelManagerForUser> {
        Self::IPushNotificationChannelManagerStatics2(|this| unsafe {
            ...
            .from_abi::<PushNotificationChannelManagerForUser>(result__)
        })
    }
    ...
    pub fn IPushNotificationChannelManagerStatics<
        R,
        F: FnOnce(&IPushNotificationChannelManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IPushNotificationChannelManagerStatics2<
        R,
        F: FnOnce(&IPushNotificationChannelManagerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IPushNotificationChannelManagerStatics3<
        R,
        F: FnOnce(&IPushNotificationChannelManagerStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IPushNotificationChannelManagerStatics4<
        R,
        F: FnOnce(&IPushNotificationChannelManagerStatics4) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
pub struct PushNotificationChannelManagerForUser(::windows::runtime::IInspectable);
impl PushNotificationChannelManagerForUser {
    ...
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsync<
        'a,
    ...
    > {
        let this =
            &::windows::runtime::Interface::cast::<IPushNotificationChannelManagerForUser2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                appserverkey.into_param().abi(),
    ...
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsyncWithId<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IBuffer>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
...
impl ::std::convert::From<PushNotificationChannelManagerForUser>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PushNotificationChannelManagerForUser
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct PushNotificationChannelsRevokedEventArgs(::windows::runtime::IInspectable);
...
impl ::std::convert::From<PushNotificationChannelsRevokedEventArgs>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a PushNotificationChannelsRevokedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl PushNotificationReceivedEventArgs {
    ...
    pub fn NotificationType(&self) -> ::windows::runtime::Result<PushNotificationType> {
        ...
        unsafe {
            ...
            .from_abi::<PushNotificationType>(result__)
        }
    }
    #[cfg(feature = "UI_Notifications")]
    ...
    pub fn BadgeNotification(
        &self,
    ) -> ::windows::runtime::Result<super::super::UI::Notifications::BadgeNotification> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::UI::Notifications::BadgeNotification>(result__)
        }
    }
    pub fn RawNotification(&self) -> ::windows::runtime::Result<RawNotification> {
        ...
        unsafe {
            ...
            .from_abi::<RawNotification>(result__)
        }
    }
}
...
pub struct RawNotification(::windows::runtime::IInspectable);
