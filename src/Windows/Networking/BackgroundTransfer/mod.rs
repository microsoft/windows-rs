...
impl ::std::fmt::Debug for BackgroundDownloadProgress {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("BackgroundDownloadProgress")
...
impl ::std::cmp::PartialEq for BackgroundDownloadProgress {
    fn eq(&self, other: &Self) -> bool {
        self.BytesReceived == other.BytesReceived
            && self.TotalBytesToReceive == other.TotalBytesToReceive
            && self.Status == other.Status
            && self.HasResponseChanged == other.HasResponseChanged
            && self.HasRestarted == other.HasRestarted
    }
}
...
impl BackgroundDownloader {
    ...
    >(
        ...
        uri: Param0,
        resultfile: Param1,
    ) -> ::windows::runtime::Result<DownloadOperation> {
        let this = self;
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                uri.into_param().abi(),
                resultfile.into_param().abi(),
                &mut result__,
            )
            .from_abi::<DownloadOperation>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn CreateDownloadFromFile<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Storage::IStorageFile>,
    ...
    >(
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ...
                uri.into_param().abi(),
                resultfile.into_param().abi(),
                requestbodyfile.into_param().abi(),
                &mut result__,
            )
            .from_abi::<DownloadOperation>(result__)
        }
    ...
    pub fn CreateDownloadAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Storage::IStorageFile>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IInputStream>,
    >(
        &self,
        uri: Param0,
        resultfile: Param1,
        requestbodystream: Param2,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<DownloadOperation>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ...
                uri.into_param().abi(),
                resultfile.into_param().abi(),
                requestbodystream.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<DownloadOperation>>(result__)
        }
    }
    pub fn TransferGroup(&self) -> ::windows::runtime::Result<BackgroundTransferGroup> {
        ...
        unsafe {
            ...
            .from_abi::<BackgroundTransferGroup>(result__)
        }
    }
    pub fn SetTransferGroup<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BackgroundTransferGroup>,
    >(
        &self,
        value: Param0,
    ...
    pub fn SuccessToastNotification(
        &self,
    ) -> ::windows::runtime::Result<super::super::UI::Notifications::ToastNotification> {
        let this = &::windows::runtime::Interface::cast::<IBackgroundDownloader2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
            ...
            .from_abi::<super::super::UI::Notifications::ToastNotification>(result__)
        }
    }
    #[cfg(feature = "UI_Notifications")]
    pub fn SetSuccessToastNotification<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Notifications::ToastNotification>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn SetFailureToastNotification<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Notifications::ToastNotification>,
    >(
        &self,
    ...
    pub fn SuccessTileNotification(
        &self,
    ) -> ::windows::runtime::Result<super::super::UI::Notifications::TileNotification> {
        let this = &::windows::runtime::Interface::cast::<IBackgroundDownloader2>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::UI::Notifications::TileNotification>(result__)
        }
    }
    #[cfg(feature = "UI_Notifications")]
    pub fn SetSuccessTileNotification<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Notifications::TileNotification>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    #[cfg(feature = "UI_Notifications")]
    pub fn SetFailureTileNotification<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::UI::Notifications::TileNotification>,
    >(
        &self,
    ...
    pub fn CompletionGroup(&self) -> ::windows::runtime::Result<BackgroundTransferCompletionGroup> {
        ...
        unsafe {
            ...
            .from_abi::<BackgroundTransferCompletionGroup>(result__)
        }
    }
    ...
    pub fn CostPolicy(&self) -> ::windows::runtime::Result<BackgroundTransferCostPolicy> {
        ...
        unsafe {
            ...
            .from_abi::<BackgroundTransferCostPolicy>(result__)
        }
    }
    pub fn SetCostPolicy(
        &self,
    ...
    pub fn CreateWithCompletionGroup<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BackgroundTransferCompletionGroup>,
    >(
        completiongroup: Param0,
    ) -> ::windows::runtime::Result<BackgroundDownloader> {
        Self::IBackgroundDownloaderFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                completiongroup.into_param().abi(),
                &mut result__,
            )
            .from_abi::<BackgroundDownloader>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetCurrentDownloadsAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<DownloadOperation>,
        >,
    > {
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetCurrentDownloadsForTransferGroupAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BackgroundTransferGroup>,
    >(
        group: Param0,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn RequestUnconstrainedDownloadsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<DownloadOperation>,
        >,
    >(
        operations: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<UnconstrainedTransferRequestResult>,
    > {
        Self::IBackgroundDownloaderUserConsent(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                operations.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<
    ...
    pub fn IBackgroundDownloaderFactory<
        R,
        F: FnOnce(&IBackgroundDownloaderFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IBackgroundDownloaderStaticMethods<
        R,
        F: FnOnce(&IBackgroundDownloaderStaticMethods) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IBackgroundDownloaderStaticMethods2<
        R,
        F: FnOnce(&IBackgroundDownloaderStaticMethods2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IBackgroundDownloaderUserConsent<
        R,
        F: FnOnce(&IBackgroundDownloaderUserConsent) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, IBackgroundTransferBase> for &BackgroundDownloader {
    fn into_param(self) -> ::windows::runtime::Param<'a, IBackgroundTransferBase> {
        ::std::convert::TryInto::<IBackgroundTransferBase>::try_into(self)
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BackgroundTransferCompletionGroup
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BackgroundTransferCompletionGroupTriggerDetails {
    ...
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<DownloadOperation>>(
                result__,
            )
        }
    }
    ...
    pub fn Uploads(
        ...
        super::super::Foundation::Collections::IVectorView<UploadOperation>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<UploadOperation>>(
                result__,
            )
        }
    }
...
impl ::std::convert::From<BackgroundTransferCompletionGroupTriggerDetails>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BackgroundTransferCompletionGroupTriggerDetails
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BackgroundTransferContentPart {
    ...
    >(
        name: Param0,
    ) -> ::windows::runtime::Result<BackgroundTransferContentPart> {
        Self::IBackgroundTransferContentPartFactory(|this| unsafe {
            ...
            .from_abi::<BackgroundTransferContentPart>(result__)
        })
    }
    ...
    pub fn IBackgroundTransferContentPartFactory<
        R,
        F: FnOnce(&IBackgroundTransferContentPartFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for BackgroundTransferContentPart
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BackgroundTransferContentPart
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BackgroundTransferError {
    ...
    pub fn IBackgroundTransferErrorStaticMethods<
        R,
        F: FnOnce(&IBackgroundTransferErrorStaticMethods) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl ::std::fmt::Debug for BackgroundTransferFileRange {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("BackgroundTransferFileRange")
...
impl BackgroundTransferGroup {
    ...
    pub fn TransferBehavior(&self) -> ::windows::runtime::Result<BackgroundTransferBehavior> {
        ...
        unsafe {
            ...
            .from_abi::<BackgroundTransferBehavior>(result__)
        }
    }
    ...
    >(
        name: Param0,
    ) -> ::windows::runtime::Result<BackgroundTransferGroup> {
    ...
    pub fn IBackgroundTransferGroupStatics<
        R,
        F: FnOnce(&IBackgroundTransferGroupStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::Interface for BackgroundTransferGroup {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        25689,
        17728,
        [133, 235, 170, 161, 200, 144, 54, 119],
    );
}
...
impl BackgroundTransferRangesDownloadedEventArgs {
    ...
    pub fn AddedRanges(
        ...
        super::super::Foundation::Collections::IVector<BackgroundTransferFileRange>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl ::std::convert::From<BackgroundTransferRangesDownloadedEventArgs>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a BackgroundTransferRangesDownloadedEventArgs
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl BackgroundTransferStatus {
    ...
    pub const PausedRecoverableWebErrorStatus: BackgroundTransferStatus =
        BackgroundTransferStatus(8i32);
...
impl BackgroundUploader {
    ...
    >(
        ...
        uri: Param0,
        sourcefile: Param1,
    ) -> ::windows::runtime::Result<UploadOperation> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<UploadOperation>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn CreateUploadFromStreamAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<UploadOperation>>
    {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                uri.into_param().abi(),
                sourcestream.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<UploadOperation>>(result__)
        }
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn CreateUploadWithFormDataAndAutoBoundaryAsync<
        ...
        Param1: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<BackgroundTransferContentPart>,
        >,
    >(
        &self,
        uri: Param0,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn CreateUploadWithSubTypeAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<
            'a,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn CreateUploadWithSubTypeAndBoundaryAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::Uri>,
        Param1: ::windows::runtime::IntoParam<
            'a,
    ...
    >(
        completiongroup: Param0,
    ) -> ::windows::runtime::Result<BackgroundUploader> {
        Self::IBackgroundUploaderFactory(|this| unsafe {
            ...
            .from_abi::<BackgroundUploader>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetCurrentUploadsAsync() -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<UploadOperation>,
        >,
    > {
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetCurrentUploadsForTransferGroupAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, BackgroundTransferGroup>,
    >(
        group: Param0,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn RequestUnconstrainedUploadsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<UploadOperation>,
        >,
    >(
        operations: Param0,
    ) -> ::windows::runtime::Result<
    ...
    pub fn IBackgroundUploaderFactory<
        R,
        F: FnOnce(&IBackgroundUploaderFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IBackgroundUploaderStaticMethods<
        R,
        F: FnOnce(&IBackgroundUploaderStaticMethods) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IBackgroundUploaderStaticMethods2<
        R,
        F: FnOnce(&IBackgroundUploaderStaticMethods2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IBackgroundUploaderUserConsent<
        R,
        F: FnOnce(&IBackgroundUploaderUserConsent) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl ContentPrefetcher {
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn ContentUris() -> ::windows::runtime::Result<
    ...
    #[cfg(feature = "Foundation")]
    pub fn LastSuccessfulPrefetchTime() -> ::windows::runtime::Result<
    ...
    pub fn IContentPrefetcher<
        R,
        F: FnOnce(&IContentPrefetcher) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<ContentPrefetcher, IContentPrefetcher> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IContentPrefetcherTime<
        R,
        F: FnOnce(&IContentPrefetcherTime) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl DownloadOperation {
    ...
    pub fn Progress(&self) -> ::windows::runtime::Result<BackgroundDownloadProgress> {
        ...
        unsafe {
            ...
            .from_abi::<BackgroundDownloadProgress>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn StartAsync(
        ...
        super::super::Foundation::IAsyncOperationWithProgress<DownloadOperation, DownloadOperation>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn GetResponseInformation(&self) -> ::windows::runtime::Result<ResponseInformation> {
        ...
        unsafe {
            ...
            .from_abi::<ResponseInformation>(result__)
        }
    }
    pub fn Priority(&self) -> ::windows::runtime::Result<BackgroundTransferPriority> {
        let this =
            &::windows::runtime::Interface::cast::<IBackgroundTransferOperationPriority>(self)?;
        unsafe {
            ...
            .from_abi::<BackgroundTransferPriority>(result__)
        }
    }
    ...
    pub fn RecoverableWebErrorStatuses(
        ...
        super::super::Foundation::Collections::IVector<super::super::Web::WebErrorStatus>,
    > {
        let this = &::windows::runtime::Interface::cast::<IDownloadOperation3>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVector<
                super::super::Web::WebErrorStatus,
            >>(result__)
        }
    }
    ...
    pub fn CurrentWebErrorStatus(
        ...
        super::super::Foundation::IReference<super::super::Web::WebErrorStatus>,
    > {
        let this = &::windows::runtime::Interface::cast::<IDownloadOperation3>(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IReference<super::super::Web::WebErrorStatus>>(
                result__,
            )
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, IBackgroundTransferOperation> for &DownloadOperation {
    fn into_param(self) -> ::windows::runtime::Param<'a, IBackgroundTransferOperation> {
        ::std::convert::TryInto::<IBackgroundTransferOperation>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IBackgroundTransferOperationPriority>
    for DownloadOperation
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IBackgroundTransferOperationPriority> {
        ::std::convert::TryInto::<IBackgroundTransferOperationPriority>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
pub struct IBackgroundDownloader_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        resultfile: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        ...
        uri: ::windows::runtime::RawPtr,
        resultfile: ::windows::runtime::RawPtr,
        requestbodyfile: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Storage")))] usize,
    #[cfg(all(
    ...
    pub  unsafe extern "system" fn(
        ...
        uri: ::windows::runtime::RawPtr,
        resultfile: ::windows::runtime::RawPtr,
        requestbodystream: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Foundation",
...
pub struct IBackgroundDownloaderFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        completiongroup: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct IBackgroundDownloaderUserConsent_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        operations: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
);
...
unsafe impl ::windows::runtime::Interface for IBackgroundTransferBase {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        51049,
        17804,
        [175, 232, 254, 184, 212, 211, 178, 239],
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for IBackgroundTransferBase {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{2a9da250-c769-458c-afe8-feb8d4d3b2ef}");
}
...
pub struct IBackgroundTransferBase_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        credential: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Security_Credentials"))] usize,
    #[cfg(feature = "Security_Credentials")]
    pub  unsafe extern "system" fn(
...
unsafe impl ::windows::runtime::RuntimeType for IBackgroundTransferContentPartFactory {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{90ef98a9-7a01-4a0b-9f80-a0b0bb370f8d}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IBackgroundTransferContentPartFactory
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<IBackgroundTransferContentPartFactory>
    for ::windows::runtime::IInspectable
{
    fn from(value: IBackgroundTransferContentPartFactory) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IBackgroundTransferContentPartFactory
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IBackgroundTransferGroup_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BackgroundTransferBehavior,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: BackgroundTransferBehavior,
...
unsafe impl ::windows::runtime::RuntimeType for IBackgroundTransferOperation {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{ded06846-90ca-44fb-8fb1-124154c0d539}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IBackgroundTransferOperation
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for IBackgroundTransferOperationPriority {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{04854327-5254-4b3a-915e-0aa49275c0f9}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IBackgroundTransferOperationPriority
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<IBackgroundTransferOperationPriority>
    for ::windows::runtime::IInspectable
{
    fn from(value: IBackgroundTransferOperationPriority) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a IBackgroundTransferOperationPriority
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
pub struct IBackgroundUploader_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        uri: ::windows::runtime::RawPtr,
        sourcefile: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Storage")))] usize,
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    ...
    pub  unsafe extern "system" fn(
        ...
        parts: ::windows::runtime::RawPtr,
        subtype: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        boundary: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
);
...
unsafe impl ::windows::runtime::Interface for IContentPrefetcherTime {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        4906,
        20446,
        [167, 204, 252, 176, 230, 101, 35, 175],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IDownloadOperation_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BackgroundDownloadProgress,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IUploadOperation_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut BackgroundUploadProgress,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IUploadOperation4 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        64197,
        16878,
        [176, 48, 220, 119, 202, 238, 159, 170],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for UnconstrainedTransferRequestResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<&UnconstrainedTransferRequestResult>
    for ::windows::runtime::IInspectable
{
    fn from(value: &UnconstrainedTransferRequestResult) -> Self {
        value.0.clone()
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a UnconstrainedTransferRequestResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl UploadOperation {
    ...
    pub fn Progress(&self) -> ::windows::runtime::Result<BackgroundUploadProgress> {
        ...
        unsafe {
            ...
            .from_abi::<BackgroundUploadProgress>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn StartAsync(
        ...
        super::super::Foundation::IAsyncOperationWithProgress<UploadOperation, UploadOperation>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
