...
impl DnssdRegistrationResult {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<DnssdRegistrationStatus> {
        ...
        unsafe {
            ...
            .from_abi::<DnssdRegistrationStatus>(result__)
        }
    }
    pub fn IPAddress(&self) -> ::windows::runtime::Result<super::super::HostName> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::HostName>(result__)
        }
    }
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<DnssdRegistrationResult>
    for super::super::super::Foundation::IStringable
{
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::super::Foundation::IStringable>
    for DnssdRegistrationResult
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::super::Foundation::IStringable> {
    ...
    for &DnssdRegistrationResult
{
    fn into_param(
        ...
        ::std::convert::TryInto::<super::super::super::Foundation::IStringable>::try_into(self)
...
unsafe impl ::windows::runtime::RuntimeType for DnssdRegistrationStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Networking.ServiceDiscovery.Dnssd.DnssdRegistrationStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl DnssdServiceInstance {
    pub fn DnssdServiceInstanceName(
        &self,
    ...
    pub fn SetDnssdServiceInstanceName<
        'a,
    ...
    pub fn SetHostName<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::HostName>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn RegisterStreamSocketListenerAsync1<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Sockets::StreamSocketListener>,
    >(
        &self,
        socket: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<DnssdRegistrationResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::IAsyncOperation<DnssdRegistrationResult>>(
                result__,
            )
        }
    }
    #[cfg(all(
        ...
        feature = "Networking_Sockets"
    ))]
    pub fn RegisterStreamSocketListenerAsync2<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Sockets::StreamSocketListener>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Connectivity::NetworkAdapter>,
    >(
        &self,
        socket: Param0,
        adapter: Param1,
    ...
    #[cfg(all(feature = "Foundation", feature = "Networking_Sockets"))]
    pub fn RegisterDatagramSocketAsync1<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Sockets::DatagramSocket>,
    >(
        &self,
        socket: Param0,
    ) -> ::windows::runtime::Result<
    ...
    pub fn RegisterDatagramSocketAsync2<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Sockets::DatagramSocket>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Connectivity::NetworkAdapter>,
    >(
    ...
    pub fn Create<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::HostName>,
    >(
        dnssdserviceinstancename: Param0,
        hostname: Param1,
        port: u16,
    ) -> ::windows::runtime::Result<DnssdServiceInstance> {
        Self::IDnssdServiceInstanceFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                dnssdserviceinstancename.into_param().abi(),
                hostname.into_param().abi(),
                port,
                &mut result__,
            )
            .from_abi::<DnssdServiceInstance>(result__)
        })
    }
    pub fn IDnssdServiceInstanceFactory<
        R,
        F: FnOnce(&IDnssdServiceInstanceFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
#[cfg(feature = "Foundation")]
impl ::std::convert::TryFrom<DnssdServiceInstance>
    for super::super::super::Foundation::IStringable
{
    type Error = ::windows::runtime::Error;
...
impl DnssdServiceInstanceCollection {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn IndexOf<'a, Param0: ::windows::runtime::IntoParam<'a, DnssdServiceInstance>>(
        &self,
        value: Param0,
        index: &mut u32,
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [<DnssdServiceInstance as ::windows::runtime::Abi>::DefaultType],
    ...
    pub fn First(
        ...
        super::super::super::Foundation::Collections::IIterator<DnssdServiceInstance>,
    > {
        let this = &::windows::runtime::Interface::cast::<
            super::super::super::Foundation::Collections::IIterable<DnssdServiceInstance>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
...
unsafe impl ::windows::runtime::Interface for DnssdServiceInstanceCollection {
    type Vtable =
        super::super::super::Foundation::Collections::IVectorView_abi<DnssdServiceInstance>;
...
#[cfg(feature = "Foundation_Collections")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for DnssdServiceInstanceCollection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
#[cfg(feature = "Foundation_Collections")]
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a DnssdServiceInstanceCollection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::From<DnssdServiceInstanceCollection>
    for super::super::super::Foundation::Collections::IVectorView<DnssdServiceInstance>
{
    fn from(value: DnssdServiceInstanceCollection) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
...
impl<'a>
    ::windows::runtime::IntoParam<
        'a,
        super::super::super::Foundation::Collections::IVectorView<DnssdServiceInstance>,
    > for DnssdServiceInstanceCollection
{
    fn into_param(
        self,
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<DnssdServiceInstanceCollection>
    for super::super::super::Foundation::Collections::IIterable<DnssdServiceInstance>
{
    type Error = ::windows::runtime::Error;
...
impl DnssdServiceWatcher {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<DnssdServiceWatcherStatus> {
        ...
        unsafe {
            ...
            .from_abi::<DnssdServiceWatcherStatus>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for DnssdServiceWatcherStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Networking.ServiceDiscovery.Dnssd.DnssdServiceWatcherStatus;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
pub struct IDnssdRegistrationResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DnssdRegistrationStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IDnssdServiceInstanceFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        dnssdserviceinstancename: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
pub struct IDnssdServiceWatcher_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut DnssdServiceWatcherStatus,
    ) -> ::windows::runtime::HRESULT,
