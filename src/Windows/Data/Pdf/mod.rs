...
unsafe impl ::windows::runtime::Interface for IPdfDocument {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        33018,
        16521,
        [132, 110, 129, 183, 127, 245, 168, 108],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl PdfDocument {
    ...
    >(
        file: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<PdfDocument>> {
        Self::IPdfDocumentStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<PdfDocument>>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn LoadFromFileWithPasswordAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::IStorageFile>,
    ...
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn LoadFromStreamWithPasswordAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IRandomAccessStream>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
    ...
    pub fn IPdfDocumentStatics<
        R,
        F: FnOnce(&IPdfDocumentStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<PdfDocument, IPdfDocumentStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for PdfDocument {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Pdf.PdfDocument;{ac7ebedd-80fa-4089-846e-81b77ff5a86c})",
    );
}
...
impl PdfPage {
    ...
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn RenderWithOptionsToStreamAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Storage::Streams::IRandomAccessStream>,
        Param1: ::windows::runtime::IntoParam<'a, PdfPageRenderOptions>,
    >(
        &self,
        outputstream: Param0,
        options: Param1,
    ...
    pub fn Dimensions(&self) -> ::windows::runtime::Result<PdfPageDimensions> {
        ...
        unsafe {
            ...
            .from_abi::<PdfPageDimensions>(result__)
        }
    }
    pub fn Rotation(&self) -> ::windows::runtime::Result<PdfPageRotation> {
        ...
        unsafe {
            ...
            .from_abi::<PdfPageRotation>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for PdfPage {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Pdf.PdfPage;{9db4b0c8-5320-4cfc-ad76-493fdad0e594})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for PdfPageDimensions {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Pdf.PdfPageDimensions;{22170471-313e-44e8-835d-63a3e7624a10})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for PdfPageRenderOptions {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Pdf.PdfPageRenderOptions;{3c98056f-b7cf-4c29-9a04-52d90267f425})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for PdfPageRotation {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Data.Pdf.PdfPageRotation;i4)");
}
