...
pub struct IXsltProcessor_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        inputnode: ::windows::runtime::RawPtr,
...
impl XsltProcessor {
    #[cfg(feature = "Data_Xml_Dom")]
    pub fn TransformToString<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Dom::IXmlNode>,
    >(
        &self,
        inputnode: Param0,
    ...
    #[cfg(feature = "Data_Xml_Dom")]
    pub fn TransformToDocument<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Dom::IXmlNode>,
    >(
        &self,
        inputnode: Param0,
    ) -> ::windows::runtime::Result<super::Dom::XmlDocument> {
        ...
        unsafe {
            ...
            .from_abi::<super::Dom::XmlDocument>(result__)
        }
    }
    #[cfg(feature = "Data_Xml_Dom")]
    pub fn CreateInstance<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Dom::XmlDocument>,
    >(
        document: Param0,
    ) -> ::windows::runtime::Result<XsltProcessor> {
        Self::IXsltProcessorFactory(|this| unsafe {
            ...
            .from_abi::<XsltProcessor>(result__)
        })
    }
    pub fn IXsltProcessorFactory<
        R,
        F: FnOnce(&IXsltProcessorFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<XsltProcessor, IXsltProcessorFactory> =
...
unsafe impl ::windows::runtime::RuntimeType for XsltProcessor {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Xml.Xsl.XsltProcessor;{7b64703f-550c-48c6-a90f-93a5b964518f})",
    );
}
