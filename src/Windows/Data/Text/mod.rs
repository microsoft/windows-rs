...
impl AlternateWordForm {
    ...
    pub fn NormalizationFormat(&self) -> ::windows::runtime::Result<AlternateNormalizationFormat> {
        ...
        unsafe {
            ...
            .from_abi::<AlternateNormalizationFormat>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for AlternateWordForm {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Text.AlternateWordForm;{47396c1e-51b9-4207-9146-248e636a1d1d})",
    );
}
...
pub struct IAlternateWordForm_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut AlternateNormalizationFormat,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct ISemanticTextQuery_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        propertycontent: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
unsafe impl ::windows::runtime::Interface for ISemanticTextQueryFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63893,
        17799,
        [135, 119, 162, 183, 216, 10, 207, 239],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct ISemanticTextQueryFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        aqsfilter: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        filterlanguage: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
...
pub struct ITextPredictionGenerator2_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        previousstrings: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::UI::Text::Core::CoreTextInputScope,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IUnicodeCharactersStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        37521,
        20369,
        [182, 200, 182, 227, 89, 215, 167, 251],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IUnicodeCharactersStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        codepoint: u32,
        result__: *mut UnicodeNumericType,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        codepoint: u32,
        result__: *mut UnicodeGeneralCategory,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IWordSegment {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        39036,
        19648,
        [182, 189, 212, 154, 17, 179, 143, 154],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::RuntimeType for SelectableWordSegment {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Text.SelectableWordSegment;{916a4cb7-8aa7-4c78-b374-5dedb752e60b})",
    );
}
...
impl SelectableWordSegmentsTokenizingHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<
                    super::super::Foundation::Collections::IIterable<SelectableWordSegment>,
                >,
                &::std::option::Option<
                    super::super::Foundation::Collections::IIterable<SelectableWordSegment>,
                >,
...
unsafe impl ::windows::runtime::RuntimeType for SelectableWordSegmentsTokenizingHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({3a3dfc9c-aede-4dc7-9e6c-41c044bd3592})",
    );
}
#[cfg(feature = "Foundation_Collections")]
...
pub struct SelectableWordSegmentsTokenizingHandler_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        precedingwords: ::windows::runtime::RawPtr,
        words: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[cfg(feature = "Foundation_Collections")]
#[repr(C)]
struct SelectableWordSegmentsTokenizingHandler_box<
    F: FnMut(
            &::std::option::Option<
                super::super::Foundation::Collections::IIterable<SelectableWordSegment>,
            >,
...
impl<
        F: FnMut(
            ...
            + 'static,
    > SelectableWordSegmentsTokenizingHandler_box<F>
{
    const VTABLE: SelectableWordSegmentsTokenizingHandler_abi =
        SelectableWordSegmentsTokenizingHandler_abi(
            Self::QueryInterface,
            Self::AddRef,
            Self::Release,
            Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        *interface = if iid
            == &<SelectableWordSegmentsTokenizingHandler as ::windows::runtime::Interface>::IID
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ( ( * this ) . invoke ) ( & * ( & precedingwords as * const < super::super::Foundation::Collections:: IIterable :: < SelectableWordSegment > as :: windows :: runtime :: Abi > :: Abi as * const < super::super::Foundation::Collections:: IIterable :: < SelectableWordSegment > as :: windows :: runtime :: Abi > :: DefaultType ) , & * ( & words as * const < super::super::Foundation::Collections:: IIterable :: < SelectableWordSegment > as :: windows :: runtime :: Abi > :: Abi as * const < super::super::Foundation::Collections:: IIterable :: < SelectableWordSegment > as :: windows :: runtime :: Abi > :: DefaultType ) , ) . into ( )
    }
}
#[repr(transparent)]
#[derive(
...
impl SelectableWordsSegmenter {
    ...
    >(
        ...
        text: Param0,
        startindex: u32,
    ) -> ::windows::runtime::Result<SelectableWordSegment> {
        let this = self;
        unsafe {
            ...
            .from_abi::<SelectableWordSegment>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetTokens<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        text: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::Collections::IVectorView<SelectableWordSegment>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<SelectableWordSegment>>(
                result__,
            )
        }
    }
    ...
    pub fn Tokenize<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param2: ::windows::runtime::IntoParam<'a, SelectableWordSegmentsTokenizingHandler>,
    >(
        &self,
        text: Param0,
        startindex: u32,
    ...
    >(
        language: Param0,
    ) -> ::windows::runtime::Result<SelectableWordsSegmenter> {
        Self::ISelectableWordsSegmenterFactory(|this| unsafe {
            ...
            .from_abi::<SelectableWordsSegmenter>(result__)
        })
    }
    pub fn ISelectableWordsSegmenterFactory<
        R,
        F: FnOnce(&ISelectableWordsSegmenterFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for SelectableWordsSegmenter {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Text.SelectableWordsSegmenter;{f6dc31e7-4b13-45c5-8897-7d71269e085d})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SelectableWordsSegmenter
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl SemanticTextQuery {
    #[cfg(feature = "Foundation_Collections")]
    pub fn Find<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        content: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<TextSegment>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<TextSegment>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    ...
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<TextSegment>>
    {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                propertycontent.into_param().abi(),
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        aqsfilter: Param0,
    ) -> ::windows::runtime::Result<SemanticTextQuery> {
        Self::ISemanticTextQueryFactory(|this| unsafe {
            ...
            .from_abi::<SemanticTextQuery>(result__)
        })
    }
    pub fn CreateWithLanguage<
        'a,
    ...
    >(
        ...
        Self::ISemanticTextQueryFactory(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                aqsfilter.into_param().abi(),
                filterlanguage.into_param().abi(),
                &mut result__,
            )
            .from_abi::<SemanticTextQuery>(result__)
        })
    }
    pub fn ISemanticTextQueryFactory<
        R,
        F: FnOnce(&ISemanticTextQueryFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for SemanticTextQuery {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Text.SemanticTextQuery;{6a1cab51-1fb2-4909-80b8-35731a2b3e7f})",
    );
}
...
impl TextConversionGenerator {
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        languagetag: Param0,
    ) -> ::windows::runtime::Result<TextConversionGenerator> {
        Self::ITextConversionGeneratorFactory(|this| unsafe {
            ...
            .from_abi::<TextConversionGenerator>(result__)
        })
    }
    pub fn ITextConversionGeneratorFactory<
        R,
        F: FnOnce(&ITextConversionGeneratorFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for TextConversionGenerator {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Text.TextConversionGenerator;{03606a5e-2aa9-4ab6-af8b-a562b63a8992})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for TextPhoneme {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Text.TextPhoneme;{9362a40a-9b7a-4569-94cf-d84f2f38cf9b})",
    );
}
...
impl TextPredictionGenerator {
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        languagetag: Param0,
    ) -> ::windows::runtime::Result<TextPredictionGenerator> {
        Self::ITextPredictionGeneratorFactory(|this| unsafe {
            ...
            .from_abi::<TextPredictionGenerator>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetCandidatesWithParametersAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    ...
    > {
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                maxcandidates,
                predictionoptions,
                previousstrings.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<
                super::super::Foundation::Collections::IVectorView<::windows::runtime::HSTRING>,
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetNextWordCandidatesAsync<
        'a,
        Param1: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<::windows::runtime::HSTRING>,
    ...
    pub fn InputScope(
        &self,
    ) -> ::windows::runtime::Result<super::super::UI::Text::Core::CoreTextInputScope> {
        let this = &::windows::runtime::Interface::cast::<ITextPredictionGenerator2>(self)?;
        unsafe {
            let mut result__: super::super::UI::Text::Core::CoreTextInputScope =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::UI::Text::Core::CoreTextInputScope>(result__)
        }
    }
    #[cfg(feature = "UI_Text_Core")]
    ...
    pub fn ITextPredictionGeneratorFactory<
        R,
        F: FnOnce(&ITextPredictionGeneratorFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for TextPredictionGenerator {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Text.TextPredictionGenerator;{5eacab07-abf1-4cb6-9d9e-326f2b468756})",
    );
}
...
impl TextReverseConversionGenerator {
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        languagetag: Param0,
    ) -> ::windows::runtime::Result<TextReverseConversionGenerator> {
        Self::ITextReverseConversionGeneratorFactory(|this| unsafe {
            ...
            .from_abi::<TextReverseConversionGenerator>(result__)
        })
    }
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<TextPhoneme>,
        >,
    > {
    ...
    pub fn ITextReverseConversionGeneratorFactory<
        R,
        F: FnOnce(&ITextReverseConversionGeneratorFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for TextReverseConversionGenerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a TextReverseConversionGenerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl ::std::fmt::Debug for TextSegment {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("TextSegment")
            .field("StartPosition", &self.StartPosition)
...
unsafe impl ::windows::runtime::RuntimeType for TextSegment {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"struct(Windows.Data.Text.TextSegment;u4;u4)");
}
...
impl UnicodeCharacters {
    ...
    pub fn GetNumericType(codepoint: u32) -> ::windows::runtime::Result<UnicodeNumericType> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            ...
            .from_abi::<UnicodeNumericType>(result__)
        })
    }
    pub fn GetGeneralCategory(
        codepoint: u32,
    ) -> ::windows::runtime::Result<UnicodeGeneralCategory> {
        Self::IUnicodeCharactersStatics(|this| unsafe {
            ...
            .from_abi::<UnicodeGeneralCategory>(result__)
        })
    }
    pub fn IUnicodeCharactersStatics<
        R,
        F: FnOnce(&IUnicodeCharactersStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl WordSegment {
    ...
    pub fn AlternateForms(
        ...
        super::super::Foundation::Collections::IVectorView<AlternateWordForm>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<AlternateWordForm>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for WordSegment {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Text.WordSegment;{d2d4ba6d-987c-4cc0-b6bd-d49a11b38f9a})",
    );
}
...
impl WordSegmentsTokenizingHandler {
    pub fn new<
        F: FnMut(
                &::std::option::Option<
                    super::super::Foundation::Collections::IIterable<WordSegment>,
                >,
                &::std::option::Option<
                    super::super::Foundation::Collections::IIterable<WordSegment>,
                >,
...
unsafe impl ::windows::runtime::RuntimeType for WordSegmentsTokenizingHandler {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"delegate({a5dd6357-bf2a-4c4f-a31f-29e71c6f8b35})",
    );
}
#[cfg(feature = "Foundation_Collections")]
...
#[cfg(feature = "Foundation_Collections")]
#[repr(C)]
struct WordSegmentsTokenizingHandler_box<
    F: FnMut(
            &::std::option::Option<super::super::Foundation::Collections::IIterable<WordSegment>>,
            &::std::option::Option<super::super::Foundation::Collections::IIterable<WordSegment>>,
        ) -> ::windows::runtime::Result<()>
        + 'static,
> {
...
impl<
        F: FnMut(
            ...
            + 'static,
    > WordSegmentsTokenizingHandler_box<F>
{
    const VTABLE: WordSegmentsTokenizingHandler_abi = WordSegmentsTokenizingHandler_abi(
        Self::QueryInterface,
        Self::AddRef,
        Self::Release,
        Self::Invoke,
    ...
    unsafe extern "system" fn QueryInterface(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        *interface = if iid
            == &<WordSegmentsTokenizingHandler as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IUnknown as ::windows::runtime::Interface>::IID
            || iid == &<::windows::runtime::IAgileObject as ::windows::runtime::Interface>::IID
        {
            &mut (*this).vtable as *mut _ as _
    ...
    unsafe extern "system" fn Invoke(
        ...
        let this = this as *mut ::windows::runtime::RawPtr as *mut Self;
        ( ( * this ) . invoke ) ( & * ( & precedingwords as * const < super::super::Foundation::Collections:: IIterable :: < WordSegment > as :: windows :: runtime :: Abi > :: Abi as * const < super::super::Foundation::Collections:: IIterable :: < WordSegment > as :: windows :: runtime :: Abi > :: DefaultType ) , & * ( & words as * const < super::super::Foundation::Collections:: IIterable :: < WordSegment > as :: windows :: runtime :: Abi > :: Abi as * const < super::super::Foundation::Collections:: IIterable :: < WordSegment > as :: windows :: runtime :: Abi > :: DefaultType ) , ) . into ( )
    }
}
#[repr(transparent)]
#[derive(
...
impl WordsSegmenter {
    ...
    >(
        ...
        text: Param0,
        startindex: u32,
    ) -> ::windows::runtime::Result<WordSegment> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    pub fn GetTokens<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        text: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<WordSegment>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<WordSegment>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Tokenize<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param2: ::windows::runtime::IntoParam<'a, WordSegmentsTokenizingHandler>,
    >(
        &self,
        text: Param0,
        startindex: u32,
    ...
    >(
        language: Param0,
    ) -> ::windows::runtime::Result<WordsSegmenter> {
        Self::IWordsSegmenterFactory(|this| unsafe {
            ...
            .from_abi::<WordsSegmenter>(result__)
        })
    }
    pub fn IWordsSegmenterFactory<
        R,
        F: FnOnce(&IWordsSegmenterFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for WordsSegmenter {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Text.WordsSegmenter;{86b4d4d1-b2fe-4e34-a81d-66640300454f})",
    );
}
