...
unsafe impl ::windows::runtime::Interface for IJsonArrayStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        57700,
        18847,
        [147, 226, 138, 143, 73, 187, 144, 186],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IJsonObject {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        10690,
        20355,
        [154, 193, 158, 225, 21, 120, 190, 179],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IJsonObjectWithDefaultValues_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        name: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        defaultvalue: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IJsonValue {
    pub fn ValueType(&self) -> ::windows::runtime::Result<JsonValueType> {
        ...
        unsafe {
            ...
            .from_abi::<JsonValueType>(result__)
        }
    }
    ...
    pub fn GetObject(&self) -> ::windows::runtime::Result<JsonObject> {
        ...
        unsafe {
            ...
            .from_abi::<JsonObject>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for IJsonValue {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{a3219ecb-f0b3-4dcd-beee-19d48cd3ed1e}");
}
...
unsafe impl ::windows::runtime::Interface for IJsonValueStatics2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        16360,
        17205,
        [131, 146, 147, 216, 227, 104, 101, 240],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl JsonArray {
    ...
    pub fn First(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IIterator<IJsonValue>>
    {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IIterable<IJsonValue>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::Foundation::Collections::IIterator<IJsonValue>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn GetAt(&self, index: u32) -> ::windows::runtime::Result<IJsonValue> {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IVector<IJsonValue>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
    ...
    pub fn GetView(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<IJsonValue>>
    {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IVector<IJsonValue>,
        >(self)?;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<IJsonValue>>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn IndexOf<'a, Param0: ::windows::runtime::IntoParam<'a, IJsonValue>>(
        &self,
        value: Param0,
        index: &mut u32,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn SetAt<'a, Param1: ::windows::runtime::IntoParam<'a, IJsonValue>>(
        &self,
        index: u32,
        value: Param1,
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn InsertAt<'a, Param1: ::windows::runtime::IntoParam<'a, IJsonValue>>(
        &self,
        index: u32,
        value: Param1,
    ) -> ::windows::runtime::Result<()> {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn Append<'a, Param0: ::windows::runtime::IntoParam<'a, IJsonValue>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = &::windows::runtime::Interface::cast::<
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [<IJsonValue as ::windows::runtime::Abi>::DefaultType],
    ...
    pub fn ReplaceAll(
        &self,
        items: &[<IJsonValue as ::windows::runtime::Abi>::DefaultType],
    ) -> ::windows::runtime::Result<()> {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IVector<IJsonValue>,
        >(self)?;
    ...
    pub fn Parse<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        input: Param0,
    ) -> ::windows::runtime::Result<JsonArray> {
    ...
    pub fn TryParse<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        input: Param0,
        result: &mut ::std::option::Option<JsonArray>,
    ) -> ::windows::runtime::Result<bool> {
        Self::IJsonArrayStatics(|this| unsafe {
            let mut result__: bool = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    pub fn IJsonArrayStatics<R, F: FnOnce(&IJsonArrayStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<JsonArray, IJsonArrayStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for JsonArray {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Json.JsonArray;{08c1ddb6-0cbd-4a9a-b5d3-2f852dc37e81})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IJsonValue> for &JsonArray {
    fn into_param(self) -> ::windows::runtime::Param<'a, IJsonValue> {
        ::std::convert::TryInto::<IJsonValue>::try_into(self)
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<JsonArray>
    for super::super::Foundation::Collections::IIterable<IJsonValue>
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: JsonArray) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
#[cfg(feature = "Foundation_Collections")]
impl<'a>
    ::windows::runtime::IntoParam<'a, super::super::Foundation::Collections::IIterable<IJsonValue>>
    for JsonArray
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::Foundation::Collections::IIterable<IJsonValue>>
    {
        ::windows::runtime::IntoParam::into_param(&self)
    }
}
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<JsonArray>
    for super::super::Foundation::Collections::IVector<IJsonValue>
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: JsonArray) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
#[cfg(feature = "Foundation_Collections")]
impl<'a>
    ::windows::runtime::IntoParam<'a, super::super::Foundation::Collections::IVector<IJsonValue>>
    for JsonArray
{
    fn into_param(
        self,
    ) -> ::windows::runtime::Param<'a, super::super::Foundation::Collections::IVector<IJsonValue>>
    {
        ::windows::runtime::IntoParam::into_param(&self)
    }
}
...
impl JsonError {
    pub fn GetJsonStatus(hresult: i32) -> ::windows::runtime::Result<JsonErrorStatus> {
        Self::IJsonErrorStatics2(|this| unsafe {
            ...
            .from_abi::<JsonErrorStatus>(result__)
        })
    }
    pub fn IJsonErrorStatics2<
        R,
        F: FnOnce(&IJsonErrorStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<JsonError, IJsonErrorStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for JsonErrorStatus {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Data.Json.JsonErrorStatus;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl JsonObject {
    ...
    pub fn GetNamedValue<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
        name: Param0,
    ) -> ::windows::runtime::Result<JsonValue> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<JsonValue>(result__)
        }
    }
    pub fn SetNamedValue<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, IJsonValue>,
    >(
        &self,
        name: Param0,
        value: Param1,
    ...
    pub fn GetNamedObject<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
        name: Param0,
    ) -> ::windows::runtime::Result<JsonObject> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
    ...
    pub fn GetNamedValueOrDefault<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, JsonValue>,
    >(
        &self,
        name: Param0,
        defaultvalue: Param1,
    ...
    pub fn GetNamedObjectOrDefault<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, JsonObject>,
    >(
        &self,
        name: Param0,
        defaultvalue: Param1,
    ...
    pub fn GetNamedArrayOrDefault<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, JsonArray>,
    >(
        &self,
        name: Param0,
        defaultvalue: Param1,
    ...
    pub fn Lookup<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        key: Param0,
    ) -> ::windows::runtime::Result<IJsonValue> {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IMap<::windows::runtime::HSTRING, IJsonValue>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
    ...
    pub fn GetView(
        ...
        super::super::Foundation::Collections::IMapView<::windows::runtime::HSTRING, IJsonValue>,
    > {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IMap<::windows::runtime::HSTRING, IJsonValue>,
        >(self)?;
    ...
    pub fn TryParse<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        input: Param0,
        result: &mut ::std::option::Option<JsonObject>,
    ) -> ::windows::runtime::Result<bool> {
        Self::IJsonObjectStatics(|this| unsafe {
            let mut result__: bool = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    pub fn IJsonObjectStatics<
        R,
        F: FnOnce(&IJsonObjectStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<JsonObject, IJsonObjectStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for JsonObject {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Json.JsonObject;{064e24dd-29c2-4f83-9ac1-9ee11578beb3})",
    );
}
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<JsonObject>
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<JsonObject>
    for super::super::Foundation::Collections::IMap<::windows::runtime::HSTRING, IJsonValue>
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: JsonObject) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
...
impl JsonValue {
    ...
    pub fn TryParse<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        input: Param0,
        result: &mut ::std::option::Option<JsonValue>,
    ) -> ::windows::runtime::Result<bool> {
        Self::IJsonValueStatics(|this| unsafe {
            let mut result__: bool = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
    ...
    pub fn IJsonValueStatics<R, F: FnOnce(&IJsonValueStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<JsonValue, IJsonValueStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IJsonValueStatics2<
        R,
        F: FnOnce(&IJsonValueStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<JsonValue, IJsonValueStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for JsonValue {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Data.Json.JsonValue;{a3219ecb-f0b3-4dcd-beee-19d48cd3ed1e})",
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IJsonValue> for &JsonValue {
    fn into_param(self) -> ::windows::runtime::Param<'a, IJsonValue> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IJsonValue>::into(
...
unsafe impl ::windows::runtime::RuntimeType for JsonValueType {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Data.Json.JsonValueType;i4)");
}
