...
pub struct IPhoneNumberFormatter_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        number: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IPhoneNumberFormatterStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        regioncode: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        phonenumber: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        regioncode: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
pub struct IPhoneNumberInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut PredictedPhoneNumberKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        othernumber: ::windows::runtime::RawPtr,
        result__: *mut PhoneNumberMatchResult,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IPhoneNumberInfoStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        input: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        phonenumber: *mut ::windows::runtime::RawPtr,
        result__: *mut PhoneNumberParseResult,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        input: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
impl PhoneNumberFormatter {
    ...
    pub fn Format<'a, Param0: ::windows::runtime::IntoParam<'a, PhoneNumberInfo>>(
        &self,
        number: Param0,
        ...
        unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).6)(
                ...
                number.into_param().abi(),
                &mut result__,
            )
            .from_abi::<::windows::runtime::HSTRING>(result__)
        }
    }
    pub fn FormatWithOutputFormat<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, PhoneNumberInfo>,
    >(
        &self,
        number: Param0,
        numberformat: PhoneNumberFormat,
    ...
    pub fn TryCreate<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        regioncode: Param0,
        phonenumber: &mut ::std::option::Option<PhoneNumberFormatter>,
    ) -> ::windows::runtime::Result<()> {
        Self::IPhoneNumberFormatterStatics(|this| unsafe {
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                regioncode.into_param().abi(),
    ...
    pub fn IPhoneNumberFormatterStatics<
        R,
        F: FnOnce(&IPhoneNumberFormatterStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl PhoneNumberInfo {
    ...
    pub fn ToString(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        let this =
            &::windows::runtime::Interface::cast::<super::super::Foundation::IStringable>(self)?;
        unsafe {
            let mut result__: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING> =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
    ...
    pub fn GetNationalSignificantNumber(
        &self,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        let this = self;
        unsafe {
    ...
    pub fn PredictNumberKind(&self) -> ::windows::runtime::Result<PredictedPhoneNumberKind> {
        ...
        unsafe {
            ...
            .from_abi::<PredictedPhoneNumberKind>(result__)
        }
    }
    pub fn GetGeographicRegionCode(
        &self,
    ) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        let this = self;
        unsafe {
    ...
    pub fn CheckNumberMatch<'a, Param0: ::windows::runtime::IntoParam<'a, PhoneNumberInfo>>(
        &self,
        othernumber: Param0,
    ) -> ::windows::runtime::Result<PhoneNumberMatchResult> {
        let this = self;
        unsafe {
            let mut result__: PhoneNumberMatchResult = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).13)(
                ::std::mem::transmute_copy(this),
                othernumber.into_param().abi(),
                &mut result__,
            )
            .from_abi::<PhoneNumberMatchResult>(result__)
        }
    }
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        number: Param0,
    ) -> ::windows::runtime::Result<PhoneNumberInfo> {
        Self::IPhoneNumberInfoFactory(|this| unsafe {
            ...
            .from_abi::<PhoneNumberInfo>(result__)
        })
    }
    pub fn TryParse<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        input: Param0,
        phonenumber: &mut ::std::option::Option<PhoneNumberInfo>,
    ) -> ::windows::runtime::Result<PhoneNumberParseResult> {
        Self::IPhoneNumberInfoStatics(|this| unsafe {
            ...
            .from_abi::<PhoneNumberParseResult>(result__)
        })
    }
    ...
    pub fn IPhoneNumberInfoFactory<
        R,
        F: FnOnce(&IPhoneNumberInfoFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IPhoneNumberInfoStatics<
        R,
        F: FnOnce(&IPhoneNumberInfoStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
#[cfg(feature = "Foundation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::super::Foundation::IStringable>
    for PhoneNumberInfo
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, super::super::Foundation::IStringable> {
        ::std::convert::TryInto::<super::super::Foundation::IStringable>::try_into(self)
...
impl PhoneNumberMatchResult {
    ...
    pub const ShortNationalSignificantNumberMatch: PhoneNumberMatchResult =
        PhoneNumberMatchResult(1i32);
