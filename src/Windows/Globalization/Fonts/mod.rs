...
pub struct ILanguageFont_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::UI::Text::FontWeight,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "UI_Text"))] usize,
    #[cfg(feature = "UI_Text")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::UI::Text::FontStretch,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "UI_Text"))] usize,
    #[cfg(feature = "UI_Text")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::UI::Text::FontStyle,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "UI_Text"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for ILanguageFontGroup {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        14940,
        19178,
        [185, 255, 179, 159, 178, 66, 247, 246],
    );
}
#[repr(C)]
#[doc(hidden)]
...
impl LanguageFont {
    ...
    pub fn FontWeight(&self) -> ::windows::runtime::Result<super::super::UI::Text::FontWeight> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::UI::Text::FontWeight>(result__)
        }
    }
    #[cfg(feature = "UI_Text")]
    pub fn FontStretch(&self) -> ::windows::runtime::Result<super::super::UI::Text::FontStretch> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::UI::Text::FontStretch>(result__)
        }
    }
    #[cfg(feature = "UI_Text")]
    pub fn FontStyle(&self) -> ::windows::runtime::Result<super::super::UI::Text::FontStyle> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::UI::Text::FontStyle>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for LanguageFont {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Globalization.Fonts.LanguageFont;{b12e5c3a-b76d-459b-beeb-901151cd77d1})",
    );
}
...
impl LanguageFontGroup {
    pub fn UITextFont(&self) -> ::windows::runtime::Result<LanguageFont> {
        ...
        unsafe {
            ...
            .from_abi::<LanguageFont>(result__)
        }
    }
    ...
    >(
        languagetag: Param0,
    ) -> ::windows::runtime::Result<LanguageFontGroup> {
        Self::ILanguageFontGroupFactory(|this| unsafe {
            ...
            .from_abi::<LanguageFontGroup>(result__)
        })
    }
    pub fn ILanguageFontGroupFactory<
        R,
        F: FnOnce(&ILanguageFontGroupFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for LanguageFontGroup {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Globalization.Fonts.LanguageFontGroup;{f33a7fc3-3a5c-4aea-b9ff-b39fb242f7f6})",
    );
}
