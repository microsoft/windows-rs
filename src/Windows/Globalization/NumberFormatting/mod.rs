...
impl CurrencyFormatter {
    ...
    pub fn Mode(&self) -> ::windows::runtime::Result<CurrencyFormatterMode> {
        ...
        unsafe {
            ...
            .from_abi::<CurrencyFormatterMode>(result__)
        }
    }
    ...
    pub fn ApplyRoundingForCurrency(
        &self,
    ...
    pub fn ParseInt<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        text: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IReference<i64>> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::IReference<i64>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn ParseUInt<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        text: Param0,
    ...
    pub fn NumberRounder(&self) -> ::windows::runtime::Result<INumberRounder> {
        ...
        unsafe {
            ...
            .from_abi::<INumberRounder>(result__)
        }
    }
    pub fn SetNumberRounder<'a, Param0: ::windows::runtime::IntoParam<'a, INumberRounder>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = &::windows::runtime::Interface::cast::<INumberRounderOption>(self)?;
    ...
    pub fn CreateCurrencyFormatterCode<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        currencycode: Param0,
    ) -> ::windows::runtime::Result<CurrencyFormatter> {
        Self::ICurrencyFormatterFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                currencycode.into_param().abi(),
                &mut result__,
            )
            .from_abi::<CurrencyFormatter>(result__)
        })
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn CreateCurrencyFormatterCodeContext<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    ...
    pub fn ICurrencyFormatterFactory<
        R,
        F: FnOnce(&ICurrencyFormatterFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, INumberFormatter> for &CurrencyFormatter {
    fn into_param(self) -> ::windows::runtime::Param<'a, INumberFormatter> {
        ::std::convert::TryInto::<INumberFormatter>::try_into(self)
...
impl<'a> ::windows::runtime::IntoParam<'a, INumberFormatter2> for &CurrencyFormatter {
    fn into_param(self) -> ::windows::runtime::Param<'a, INumberFormatter2> {
        ::std::convert::TryInto::<INumberFormatter2>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, INumberFormatterOptions> for &CurrencyFormatter {
    fn into_param(self) -> ::windows::runtime::Param<'a, INumberFormatterOptions> {
        ::std::convert::TryInto::<INumberFormatterOptions>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, INumberParser> for &CurrencyFormatter {
    fn into_param(self) -> ::windows::runtime::Param<'a, INumberParser> {
        ::std::convert::TryInto::<INumberParser>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, INumberRounderOption> for &CurrencyFormatter {
    fn into_param(self) -> ::windows::runtime::Param<'a, INumberRounderOption> {
        ::std::convert::TryInto::<INumberRounderOption>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ISignedZeroOption> for &CurrencyFormatter {
    fn into_param(self) -> ::windows::runtime::Param<'a, ISignedZeroOption> {
        ::std::convert::TryInto::<ISignedZeroOption>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ISignificantDigitsOption> for &CurrencyFormatter {
    fn into_param(self) -> ::windows::runtime::Param<'a, ISignificantDigitsOption> {
        ::std::convert::TryInto::<ISignificantDigitsOption>::try_into(self)
            .map(::windows::runtime::Param::Owned)
            .unwrap_or(::windows::runtime::Param::None)
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for CurrencyFormatterMode {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Globalization.NumberFormatting.CurrencyFormatterMode;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl DecimalFormatter {
    ...
    >(
        languages: Param0,
        geographicregion: Param1,
    ) -> ::windows::runtime::Result<DecimalFormatter> {
        Self::IDecimalFormatterFactory(|this| unsafe {
            ...
            .from_abi::<DecimalFormatter>(result__)
        })
    }
    pub fn IDecimalFormatterFactory<
        R,
        F: FnOnce(&IDecimalFormatterFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, INumberFormatter> for &DecimalFormatter {
    fn into_param(self) -> ::windows::runtime::Param<'a, INumberFormatter> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<INumberFormatter>::into(
...
pub struct ICurrencyFormatter2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut CurrencyFormatterMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        value: CurrencyFormatterMode,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        roundingalgorithm: RoundingAlgorithm,
...
pub struct ICurrencyFormatterFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        currencycode: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
unsafe impl ::windows::runtime::Interface for IDecimalFormatterFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        58259,
        18104,
        [184, 48, 122, 105, 200, 248, 159, 187],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IIncrementNumberRounder_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut RoundingAlgorithm,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::RuntimeType for INumberFormatter {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{a5007c49-7676-4db7-8631-1b6ff265caa9}");
}
...
unsafe impl ::windows::runtime::RuntimeType for INumberFormatter2 {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{d4a8c1f0-80d0-4b0d-a89e-882c1e8f8310}");
}
...
unsafe impl ::windows::runtime::RuntimeType for INumberFormatterOptions {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{80332d21-aee1-4a39-baa2-07ed8c96daf6}");
}
...
unsafe impl ::windows::runtime::RuntimeType for INumberParser {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{e6659412-4a13-4a53-83a1-392fbe4cff9f}");
}
...
unsafe impl ::windows::runtime::RuntimeType for INumberRounder {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{5473c375-38ed-4631-b80c-ef34fc48b7f5}");
}
...
unsafe impl ::windows::runtime::RuntimeType for INumberRounderOption {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{3b088433-646f-4efe-8d48-66eb2e49e736}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ISignedZeroOption {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{fd1cdd31-0a3c-49c4-a642-96a1564f4f30}");
}
...
unsafe impl ::windows::runtime::RuntimeType for ISignificantDigitsOption {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{1d4dfcdd-2d43-4ee8-bbf1-c1b26a711a58}");
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ISignificantDigitsOption
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl IncrementNumberRounder {
    ...
    pub fn RoundingAlgorithm(&self) -> ::windows::runtime::Result<RoundingAlgorithm> {
        ...
        unsafe {
            ...
            .from_abi::<RoundingAlgorithm>(result__)
        }
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, INumberRounder> for &IncrementNumberRounder {
    fn into_param(self) -> ::windows::runtime::Param<'a, INumberRounder> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<INumberRounder>::into(
            ::std::clone::Clone::clone(self),
        ))
    }
}
...
impl NumeralSystemTranslator {
    ...
    >(
        languages: Param0,
    ) -> ::windows::runtime::Result<NumeralSystemTranslator> {
        Self::INumeralSystemTranslatorFactory(|this| unsafe {
            ...
            .from_abi::<NumeralSystemTranslator>(result__)
        })
    }
    pub fn INumeralSystemTranslatorFactory<
        R,
        F: FnOnce(&INumeralSystemTranslatorFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl PercentFormatter {
    ...
    >(
        languages: Param0,
        geographicregion: Param1,
    ) -> ::windows::runtime::Result<PercentFormatter> {
        Self::IPercentFormatterFactory(|this| unsafe {
            ...
            .from_abi::<PercentFormatter>(result__)
        })
    }
    pub fn IPercentFormatterFactory<
        R,
        F: FnOnce(&IPercentFormatterFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl PermilleFormatter {
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn CreatePermilleFormatter<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<::windows::runtime::HSTRING>,
    ...
    >(
        languages: Param0,
        geographicregion: Param1,
    ) -> ::windows::runtime::Result<PermilleFormatter> {
        Self::IPermilleFormatterFactory(|this| unsafe {
            ...
            .from_abi::<PermilleFormatter>(result__)
        })
    }
    pub fn IPermilleFormatterFactory<
        R,
        F: FnOnce(&IPermilleFormatterFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for RoundingAlgorithm {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Globalization.NumberFormatting.RoundingAlgorithm;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SignificantDigitsNumberRounder
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
