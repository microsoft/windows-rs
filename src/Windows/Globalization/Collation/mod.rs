...
unsafe impl ::windows::runtime::Interface for CharacterGrouping {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        32861,
        19376,
        [149, 187, 193, 247, 195, 232, 235, 142],
    );
}
...
impl CharacterGroupings {
    ...
    pub fn First(
        ...
        super::super::Foundation::Collections::IIterator<CharacterGrouping>,
    > {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IIterable<CharacterGrouping>,
        >(self)?;
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IIterator<CharacterGrouping>>(
                result__,
            )
        }
    }
    ...
    pub fn GetAt(&self, index: u32) -> ::windows::runtime::Result<CharacterGrouping> {
        let this = &::windows::runtime::Interface::cast::<
            super::super::Foundation::Collections::IVectorView<CharacterGrouping>,
        >(self)?;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<CharacterGrouping>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    ...
    #[cfg(feature = "Foundation_Collections")]
    pub fn IndexOf<'a, Param0: ::windows::runtime::IntoParam<'a, CharacterGrouping>>(
        &self,
        value: Param0,
        index: &mut u32,
    ...
    pub fn GetMany(
        &self,
        startindex: u32,
        items: &mut [<CharacterGrouping as ::windows::runtime::Abi>::DefaultType],
    ...
    pub fn Create<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        language: Param0,
    ) -> ::windows::runtime::Result<CharacterGroupings> {
        Self::ICharacterGroupingsFactory(|this| unsafe {
            ...
            .from_abi::<CharacterGroupings>(result__)
        })
    }
    pub fn ICharacterGroupingsFactory<
        R,
        F: FnOnce(&ICharacterGroupingsFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<CharacterGroupings>
    for super::super::Foundation::Collections::IIterable<CharacterGrouping>
{
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<CharacterGroupings>
    for super::super::Foundation::Collections::IVectorView<CharacterGrouping>
{
    type Error = ::windows::runtime::Error;
    fn try_from(value: CharacterGroupings) -> ::windows::runtime::Result<Self> {
        ::std::convert::TryFrom::try_from(&value)
