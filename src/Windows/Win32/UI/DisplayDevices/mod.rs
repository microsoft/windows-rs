...
pub struct DDHAL_WAITFORVERTICALBLANKDATA {
    ...
    pub hEvent: usize,
    pub ddRVal: ::windows::runtime::HRESULT,
    pub WaitForVerticalBlank: ::core::option::Option<super::super::Graphics::DirectDraw::LPDDHAL_WAITFORVERTICALBLANK>,
}
#[cfg(all(feature = "Win32_Devices_Display", feature = "Win32_Foundation", feature = "Win32_Graphics_DirectDraw", feature = "Win32_Graphics_Gdi"))]
...
pub struct DD_CALLBACKS {
    pub dwSize: u32,
    pub dwFlags: u32,
    pub DestroyDriver: ::core::option::Option<super::super::Graphics::DirectDraw::PDD_DESTROYDRIVER>,
    pub CreateSurface: ::core::option::Option<PDD_CREATESURFACE>,
    pub SetColorKey: ::core::option::Option<super::super::Graphics::DirectDraw::PDD_SETCOLORKEY>,
    pub SetMode: ::core::option::Option<super::super::Graphics::DirectDraw::PDD_SETMODE>,
...
pub struct DD_MISCELLANEOUS2CALLBACKS {
    pub dwSize: u32,
    pub dwFlags: u32,
    pub AlphaBlt: ::core::option::Option<super::super::Graphics::DirectDraw::PDD_ALPHABLT>,
...
pub struct DD_SURFACECALLBACKS {
    ...
    pub SetClipList: ::core::option::Option<super::super::Graphics::DirectDraw::PDD_SURFCB_SETCLIPLIST>,
...
pub struct DRIVEROBJ {
    ...
    pub pFreeProc: ::core::option::Option<super::super::System::SystemServices::FREEOBJPROC>,
...
pub struct DRVFN {
    pub iFunc: u32,
    pub pfn: ::core::option::Option<super::super::System::SystemServices::PFN>,
}
#[cfg(feature = "Win32_System_SystemServices")]
impl DRVFN {}
#[cfg(feature = "Win32_System_SystemServices")]
...
pub unsafe fn EngAcquireSemaphore(hsem: *const super::super::System::SystemServices::HSEMAPHORE__) {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EngAcquireSemaphore(::core::mem::transmute(hsem)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn EngDeleteSemaphore(hsem: *const super::super::System::SystemServices::HSEMAPHORE__) {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EngDeleteSemaphore(::core::mem::transmute(hsem)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn EngReleaseSemaphore(hsem: *const super::super::System::SystemServices::HSEMAPHORE__) {
    #[cfg(windows)]
    {
        ...
        ::core::mem::transmute(EngReleaseSemaphore(::core::mem::transmute(hsem)))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_SystemServices"))]
#[inline]
pub unsafe fn XFORMOBJ_bApplyXform(pxo: *mut super::super::System::SystemServices::XFORMOBJ, imode: u32, cpoints: u32, pvin: *mut ::core::ffi::c_void, pvout: *mut ::core::ffi::c_void) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn XFORMOBJ_bApplyXform(pxo: *mut super::super::System::SystemServices::XFORMOBJ, imode: u32, cpoints: u32, pvin: *mut ::core::ffi::c_void, pvout: *mut ::core::ffi::c_void) -> super::super::Foundation::BOOL;
        }
