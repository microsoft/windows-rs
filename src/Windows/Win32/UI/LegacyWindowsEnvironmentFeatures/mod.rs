...
impl IActiveDesktopP {
    ...
    >(
        &self,
        pwszschemename: Param0,
        dwflags: u32,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            pwszschemename.into_param().abi(),
            ::std::mem::transmute(dwflags),
        )
        .ok()
    }
    ...
    pub unsafe fn GetScheme(
        &self,
        pwszschemename: super::super::Foundation::PWSTR,
        pdwcchbuffer: *mut u32,
        dwflags: u32,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(pwszschemename),
            ::std::mem::transmute(pdwcchbuffer),
            ::std::mem::transmute(dwflags),
        )
        .ok()
    }
...
impl IBriefcaseInitiator {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn IsMonikerInBriefcase<
        'a,
...
impl IEmptyVolumeCache {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            hkregkey.into_param().abi(),
            pcwszvolume.into_param().abi(),
            ::std::mem::transmute(ppwszdisplayname),
            ::std::mem::transmute(ppwszdescription),
            ::std::mem::transmute(pdwflags),
        )
        .ok()
    }
    pub unsafe fn GetSpaceUsed<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, IEmptyVolumeCacheCallBack>,
    >(
        &self,
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(pdwlspaceused),
            picb.into_param().abi(),
        )
        .ok()
    }
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dwlspacetofree),
            picb.into_param().abi(),
        )
        .ok()
    }
...
pub struct IEmptyVolumeCache_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        pcwszvolume: super::super::Foundation::PWSTR,
        ppwszdisplayname: *mut super::super::Foundation::PWSTR,
        ppwszdescription: *mut super::super::Foundation::PWSTR,
        pdwflags: *mut u32,
    ) -> ::windows::runtime::HRESULT,
...
impl IEmptyVolumeCache2 {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).8)(
            ...
            hkregkey.into_param().abi(),
            pcwszvolume.into_param().abi(),
            pcwszkeyname.into_param().abi(),
            ::std::mem::transmute(ppwszdisplayname),
            ::std::mem::transmute(ppwszdescription),
            ::std::mem::transmute(ppwszbtntext),
            ::std::mem::transmute(pdwflags),
        )
        .ok()
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, IEmptyVolumeCache> for IEmptyVolumeCache2 {
    fn into_param(self) -> ::windows::runtime::Param<'a, IEmptyVolumeCache> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IEmptyVolumeCache>::into(self))
    }
}
impl<'a> ::windows::runtime::IntoParam<'a, IEmptyVolumeCache> for &IEmptyVolumeCache2 {
    fn into_param(self) -> ::windows::runtime::Param<'a, IEmptyVolumeCache> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IEmptyVolumeCache>::into(
...
pub struct IEmptyVolumeCache2_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        hkregkey: super::super::System::Registry::HKEY,
        pcwszvolume: super::super::Foundation::PWSTR,
        pcwszkeyname: super::super::Foundation::PWSTR,
        ppwszdisplayname: *mut super::super::Foundation::PWSTR,
        ppwszdescription: *mut super::super::Foundation::PWSTR,
        ppwszbtntext: *mut super::super::Foundation::PWSTR,
        pdwflags: *mut u32,
...
impl IEmptyVolumeCacheCallBack {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dwlspaceused),
            ::std::mem::transmute(dwflags),
            pcwszstatus.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn PurgeProgress<
        'a,
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dwlspacefreed),
            ::std::mem::transmute(dwlspacetofree),
            ::std::mem::transmute(dwflags),
            pcwszstatus.into_param().abi(),
        )
...
pub struct IEmptyVolumeCacheCallBack_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        dwlspaceused: u64,
        dwflags: u32,
        pcwszstatus: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
pub struct IReconcilableObject_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pinitiator: ::windows::runtime::RawPtr,
        dwflags: u32,
        hwndowner: super::super::Foundation::HWND,
        hwndprogressfeedback: super::super::Foundation::HWND,
        ulcinput: u32,
        rgpmkotherinput: *mut ::windows::runtime::RawPtr,
        ploutindex: *mut i32,
        pstgnewresidues: ::windows::runtime::RawPtr,
        pvreserved: *mut ::std::ffi::c_void,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Foundation",
...
impl IReconcileInitiator {
    pub unsafe fn SetAbortCallback<
        'a,
...
pub struct IReconcileInitiator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        punkforabort: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ulprogress: u32,
...
pub const REC_E_ABORTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147217408i32 as _);
pub const REC_E_INEEDTODOTHEUPDATES: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147217404i32 as _);
pub const REC_E_NOCALLBACK: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147217407i32 as _);
pub const REC_E_NORESIDUES: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147217406i32 as _);
pub const REC_E_TOODIFFERENT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147217405i32 as _);
pub const REC_S_IDIDTHEUPDATES: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(266240i32 as _);
pub const REC_S_NOTCOMPLETE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(266241i32 as _);
pub const REC_S_NOTCOMPLETEBUTPROPAGATE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(266242i32 as _);
