...
>(
    ...
    #[cfg(windows)]
    {
        ...
        AddPointerInteractionContext(
            interactioncontext.into_param().abi(),
...
impl ::std::fmt::Debug for CROSS_SLIDE_PARAMETER {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("CROSS_SLIDE_PARAMETER")
...
pub unsafe fn CreateInteractionContext() -> ::windows::runtime::Result<HINTERACTIONCONTEXT> {
    #[cfg(windows)]
    {
        ...
        let mut result__: <HINTERACTIONCONTEXT as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        GetInertiaParameterInteractionContext(
            interactioncontext.into_param().abi(),
            ::std::mem::transmute(inertiaparameter),
            &mut result__,
        )
        .from_abi::<f32>(result__)
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        GetInteractionConfigurationInteractionContext(
            interactioncontext.into_param().abi(),
            ::std::mem::transmute(configurationcount),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        GetPropertyInteractionContext(
            interactioncontext.into_param().abi(),
            ::std::mem::transmute(contextproperty),
            &mut result__,
        )
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        let mut result__: <INTERACTION_STATE as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
impl ::std::fmt::Debug for INTERACTION_ARGUMENTS_CROSS_SLIDE {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("INTERACTION_ARGUMENTS_CROSS_SLIDE")
...
impl ::std::fmt::Debug for INTERACTION_ARGUMENTS_MANIPULATION {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("INTERACTION_ARGUMENTS_MANIPULATION")
            .field("delta", &self.delta)
            .field("cumulative", &self.cumulative)
            .field("velocity", &self.velocity)
            .field("railsState", &self.railsState)
            .finish()
    }
}
impl ::std::cmp::PartialEq for INTERACTION_ARGUMENTS_MANIPULATION {
    fn eq(&self, other: &Self) -> bool {
        self.delta == other.delta
            ...
            && self.railsState == other.railsState
    }
}
...
impl ::std::fmt::Debug for INTERACTION_ARGUMENTS_TAP {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("INTERACTION_ARGUMENTS_TAP")
...
impl ::std::fmt::Debug for INTERACTION_CONTEXT_CONFIGURATION {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("INTERACTION_CONTEXT_CONFIGURATION")
            .field("interactionId", &self.interactionId)
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type INTERACTION_CONTEXT_OUTPUT_CALLBACK = unsafe extern "system" fn(
    clientdata: *const ::std::ffi::c_void,
    output: *const INTERACTION_CONTEXT_OUTPUT,
);
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
pub type INTERACTION_CONTEXT_OUTPUT_CALLBACK2 = unsafe extern "system" fn(
    clientdata: *const ::std::ffi::c_void,
...
impl ::std::fmt::Debug for MANIPULATION_TRANSFORM {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("MANIPULATION_TRANSFORM")
            .field("translationX", &self.translationX)
            .field("translationY", &self.translationY)
...
impl ::std::cmp::PartialEq for MANIPULATION_TRANSFORM {
    fn eq(&self, other: &Self) -> bool {
        self.translationX == other.translationX
            && self.translationY == other.translationY
...
impl ::std::fmt::Debug for MANIPULATION_VELOCITY {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("MANIPULATION_VELOCITY")
            .field("velocityX", &self.velocityX)
            .field("velocityY", &self.velocityY)
            .field("velocityExpansion", &self.velocityExpansion)
            .field("velocityAngular", &self.velocityAngular)
            .finish()
    }
}
impl ::std::cmp::PartialEq for MANIPULATION_VELOCITY {
    fn eq(&self, other: &Self) -> bool {
        self.velocityX == other.velocityX
            ...
            && self.velocityExpansion == other.velocityExpansion
            && self.velocityAngular == other.velocityAngular
    }
}
...
>(
    interactioncontext: Param0,
    outputcallback: ::std::option::Option<INTERACTION_CONTEXT_OUTPUT_CALLBACK>,
    clientdata: *const ::std::ffi::c_void,
) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn RegisterOutputCallbackInteractionContext(
                interactioncontext: HINTERACTIONCONTEXT,
                outputcallback: ::windows::runtime::RawPtr,
                clientdata: *const ::std::ffi::c_void,
            ) -> ::windows::runtime::HRESULT;
        }
        RegisterOutputCallbackInteractionContext(
            interactioncontext.into_param().abi(),
            ::std::mem::transmute(outputcallback),
            ::std::mem::transmute(clientdata),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
>(
    interactioncontext: Param0,
    outputcallback: ::std::option::Option<INTERACTION_CONTEXT_OUTPUT_CALLBACK2>,
    clientdata: *const ::std::ffi::c_void,
) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
...
>(
    interactioncontext: Param0,
    parametercount: u32,
    crossslideparameters: *const CROSS_SLIDE_PARAMETER,
) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        SetCrossSlideParametersInteractionContext(
            ...
            ::std::mem::transmute(crossslideparameters),
        )
        .ok()
    }
    #[cfg(not(windows))]
