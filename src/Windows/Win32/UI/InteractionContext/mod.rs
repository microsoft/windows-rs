...
impl ::core::convert::From<u32> for CROSS_SLIDE_FLAGS {
...
impl ::core::convert::From<i32> for CROSS_SLIDE_THRESHOLD {
...
impl ::core::convert::From<i32> for HOLD_PARAMETER {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for INERTIA_PARAMETER {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<u32> for INTERACTION_CONFIGURATION_FLAGS {
    fn from(value: u32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for INTERACTION_CONTEXT_PROPERTY {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<u32> for INTERACTION_FLAGS {
    fn from(value: u32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for INTERACTION_ID {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for INTERACTION_STATE {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for MANIPULATION_RAILS_STATE {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for MOUSE_WHEEL_PARAMETER {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for TAP_PARAMETER {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for TRANSLATION_PARAMETER {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
