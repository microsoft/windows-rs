...
pub const CLSID_MILBitmapEffectBevel: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        4248182206,
        27803,
        19936,
        [130, 144, 246, 64, 12, 39, 55, 237],
    );
pub const CLSID_MILBitmapEffectBlur: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2837766023,
        8797,
        17267,
        [143, 91, 185, 14, 200, 90, 227, 222],
    );
pub const CLSID_MILBitmapEffectDropShadow: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        1167736766,
        55468,
        18066,
        [135, 75, 122, 38, 87, 21, 170, 22],
    );
pub const CLSID_MILBitmapEffectEmboss: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3442055238,
        33359,
        18412,
        [160, 7, 18, 170, 118, 127, 40, 22],
    );
pub const CLSID_MILBitmapEffectGroup: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2895911578,
        32280,
        20324,
        [172, 126, 71, 207, 127, 5, 30, 149],
    );
pub const CLSID_MILBitmapEffectOuterGlow: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3793099741,
        32438,
        18213,
        [156, 11, 138, 42, 27, 79, 6, 103],
    );
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl IMILBitmapEffect {
    ...
    pub unsafe fn GetOutput<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, IMILBitmapEffectRenderContext>,
    >(
        &self,
        uiindex: u32,
        pcontext: Param1,
    ) -> ::windows::runtime::Result<super::super::Graphics::Imaging::IWICBitmapSource> {
        let mut result__ : < super::super::Graphics::Imaging:: IWICBitmapSource as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(uiindex),
            pcontext.into_param().abi(),
            &mut result__,
        )
        .from_abi::<super::super::Graphics::Imaging::IWICBitmapSource>(result__)
    }
    pub unsafe fn GetParentEffect(&self) -> ::windows::runtime::Result<IMILBitmapEffectGroup> {
        let mut result__: <IMILBitmapEffectGroup as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IMILBitmapEffectGroup>(result__)
    }
    #[cfg(feature = "Win32_Graphics_Imaging")]
    pub unsafe fn SetInputSource<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Graphics::Imaging::IWICBitmapSource>,
    >(
        &self,
        uiindex: u32,
        pbitmapsource: Param1,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(uiindex),
            pbitmapsource.into_param().abi(),
        )
        .ok()
    }
}
...
pub struct IMILBitmapEffect_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        ppbitmapsource: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Graphics_Imaging"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppparenteffect: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Graphics_Imaging")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        uiindex: u32,
        pbitmapsource: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Graphics_Imaging"))] usize,
);
#[repr(transparent)]
...
impl IMILBitmapEffectConnections {
    pub unsafe fn GetInputConnector(
        &self,
        uiindex: u32,
    ) -> ::windows::runtime::Result<IMILBitmapEffectInputConnector> {
        let mut result__: <IMILBitmapEffectInputConnector as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(uiindex),
        ...
        .from_abi::<IMILBitmapEffectInputConnector>(result__)
    }
    pub unsafe fn GetOutputConnector(
        &self,
        uiindex: u32,
    ) -> ::windows::runtime::Result<IMILBitmapEffectOutputConnector> {
        let mut result__: <IMILBitmapEffectOutputConnector as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(uiindex),
        ...
        .from_abi::<IMILBitmapEffectOutputConnector>(result__)
    }
}
unsafe impl ::windows::runtime::Interface for IMILBitmapEffectConnections {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        39706,
        17268,
        [137, 176, 222, 196, 135, 77, 106, 129],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IMILBitmapEffectConnections
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IMILBitmapEffectConnections_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        uiindex: u32,
        ppconnector: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        uiindex: u32,
...
impl IMILBitmapEffectConnectionsInfo {
    ...
    pub unsafe fn GetInputConnectorInfo(
        &self,
        uiindex: u32,
    ) -> ::windows::runtime::Result<IMILBitmapEffectConnectorInfo> {
        let mut result__: <IMILBitmapEffectConnectorInfo as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(uiindex),
        ...
        .from_abi::<IMILBitmapEffectConnectorInfo>(result__)
    }
...
pub struct IMILBitmapEffectConnectionsInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        uiindex: u32,
        ppconnectorinfo: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        uiindex: u32,
...
impl IMILBitmapEffectConnector {
    ...
    pub unsafe fn GetBitmapEffect(&self) -> ::windows::runtime::Result<IMILBitmapEffect> {
        ...
        .from_abi::<IMILBitmapEffect>(result__)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IMILBitmapEffectConnectorInfo>
    for IMILBitmapEffectConnector
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IMILBitmapEffectConnectorInfo> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<IMILBitmapEffectConnectorInfo>::into(self),
        )
    }
}
impl<'a> ::windows::runtime::IntoParam<'a, IMILBitmapEffectConnectorInfo>
    for &IMILBitmapEffectConnector
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IMILBitmapEffectConnectorInfo> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<IMILBitmapEffectConnectorInfo>::into(
...
impl IMILBitmapEffectEvents {
    ...
    pub unsafe fn PropertyChange<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IMILBitmapEffect>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::BSTR>,
    >(
        &self,
        peffect: Param0,
        bstrpropertyname: Param1,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
    ...
    pub unsafe fn DirtyRegion<'a, Param0: ::windows::runtime::IntoParam<'a, IMILBitmapEffect>>(
        &self,
        peffect: Param0,
...
unsafe impl ::windows::runtime::Interface for IMILBitmapEffectEvents {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63694,
        17787,
        [129, 153, 214, 11, 179, 215, 239, 152],
    );
}
...
impl IMILBitmapEffectFactory {
    pub unsafe fn CreateEffect(
        &self,
        pguideffect: *const ::windows::runtime::GUID,
    ) -> ::windows::runtime::Result<IMILBitmapEffect> {
        let mut result__: <IMILBitmapEffect as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(pguideffect),
            &mut result__,
        )
        .from_abi::<IMILBitmapEffect>(result__)
    }
    pub unsafe fn CreateContext(
        &self,
    ) -> ::windows::runtime::Result<IMILBitmapEffectRenderContext> {
        let mut result__: <IMILBitmapEffectRenderContext as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IMILBitmapEffectRenderContext>(result__)
    }
...
impl IMILBitmapEffectGroup {
    ...
    pub unsafe fn Add<'a, Param0: ::windows::runtime::IntoParam<'a, IMILBitmapEffect>>(
        &self,
        peffect: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
...
unsafe impl ::windows::runtime::Interface for IMILBitmapEffectGroup {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        27018,
        19142,
        [129, 161, 188, 253, 240, 142, 184, 232],
    );
}
...
impl IMILBitmapEffectGroupImpl {
    pub unsafe fn Preprocess<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IMILBitmapEffectRenderContext>,
    >(
        &self,
        pcontext: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub unsafe fn GetChildren(&self) -> ::windows::runtime::Result<IMILBitmapEffects> {
        let mut result__: <IMILBitmapEffects as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IMILBitmapEffects>(result__)
    }
}
...
pub struct IMILBitmapEffectGroupImpl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pchildren: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IMILBitmapEffectImpl {
    pub unsafe fn IsInPlaceModificationAllowed<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IMILBitmapEffectOutputConnector>,
    >(
        &self,
        poutputconnector: Param0,
    ) -> ::windows::runtime::Result<i16> {
        let mut result__: <i16 as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            poutputconnector.into_param().abi(),
            &mut result__,
        )
        .from_abi::<i16>(result__)
    }
    pub unsafe fn SetParentEffect<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IMILBitmapEffectGroup>,
    >(
        &self,
        pparenteffect: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            pparenteffect.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Graphics_Imaging")]
    ...
    pub unsafe fn GetInputSourceBounds(
        &self,
        uiindex: u32,
    ) -> ::windows::runtime::Result<MilRectD> {
        ...
        .from_abi::<MilRectD>(result__)
    }
    #[cfg(feature = "Win32_Graphics_Imaging")]
    pub unsafe fn GetInputBitmapSource<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, IMILBitmapEffectRenderContext>,
    >(
        &self,
        uiindex: u32,
        prendercontext: Param1,
        pfmodifyinplace: *mut i16,
        ppbitmapsource: *mut ::std::option::Option<
            super::super::Graphics::Imaging::IWICBitmapSource,
        >,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(uiindex),
            prendercontext.into_param().abi(),
            ::std::mem::transmute(pfmodifyinplace),
            ::std::mem::transmute(ppbitmapsource),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Graphics_Imaging")]
    pub unsafe fn GetOutputBitmapSource<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, IMILBitmapEffectRenderContext>,
    >(
        &self,
...
pub struct IMILBitmapEffectImpl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        poutputconnector: ::windows::runtime::RawPtr,
        pfmodifyinplace: *mut i16,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pparenteffect: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Graphics_Imaging")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        uiindex: u32,
        prendercontext: ::windows::runtime::RawPtr,
        pfmodifyinplace: *mut i16,
        ppbitmapsource: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Graphics_Imaging"))] usize,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IMILBitmapEffectInputConnector
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, IMILBitmapEffectConnector>
    for IMILBitmapEffectInputConnector
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IMILBitmapEffectConnector> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IMILBitmapEffectConnector>::into(
            self,
        ))
    }
}
...
pub struct IMILBitmapEffectInputConnector_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pconnector: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppconnector: *mut ::windows::runtime::RawPtr,
...
impl ::std::convert::From<&IMILBitmapEffectInteriorInputConnector>
...
pub struct IMILBitmapEffectInteriorInputConnector_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pinputconnector: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IMILBitmapEffectInteriorOutputConnector {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        44233,
        19452,
        [179, 68, 139, 238, 56, 61, 254, 250],
    );
}
impl ::std::convert::From<IMILBitmapEffectInteriorOutputConnector>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IMILBitmapEffectInteriorOutputConnector
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IMILBitmapEffectInteriorOutputConnector_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        poutputconnector: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IMILBitmapEffectOutputConnector
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IMILBitmapEffectOutputConnector_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        uiindex: u32,
        ppconnection: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IMILBitmapEffectOutputConnectorImpl {
    pub unsafe fn AddBackLink<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IMILBitmapEffectInputConnector>,
    >(
        &self,
        pconnection: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            pconnection.into_param().abi(),
        )
        .ok()
    }
    pub unsafe fn RemoveBackLink<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IMILBitmapEffectInputConnector>,
    >(
        &self,
...
pub struct IMILBitmapEffectOutputConnectorImpl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pconnection: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pconnection: ::windows::runtime::RawPtr,
...
impl IMILBitmapEffectPrimitive {
    ...
    pub unsafe fn TransformPoint<
        'a,
        Param3: ::windows::runtime::IntoParam<'a, IMILBitmapEffectRenderContext>,
    >(
        &self,
        uiindex: u32,
        p: *mut MilPoint2D,
        ...
        pcontext: Param3,
        pfpointtransformed: *mut i16,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(uiindex),
            ::std::mem::transmute(p),
            ::std::mem::transmute(fforwardtransform),
            pcontext.into_param().abi(),
            ::std::mem::transmute(pfpointtransformed),
        )
        .ok()
    }
    pub unsafe fn TransformRect<
        'a,
        Param3: ::windows::runtime::IntoParam<'a, IMILBitmapEffectRenderContext>,
    >(
        &self,
...
impl IMILBitmapEffectPrimitiveImpl {
    pub unsafe fn IsDirty(&self, uioutputindex: u32) -> ::windows::runtime::Result<i16> {
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(uioutputindex),
            &mut result__,
        )
        .from_abi::<i16>(result__)
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IMILBitmapEffectPrimitiveImpl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IMILBitmapEffectRenderContext {
    ...
    pub unsafe fn GetOutputPixelFormat(
        &self,
    ) -> ::windows::runtime::Result<::windows::runtime::GUID> {
        let mut result__: <::windows::runtime::GUID as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
    ...
    pub unsafe fn GetFinalTransform(&self) -> ::windows::runtime::Result<MILMatrixF> {
        ...
        .from_abi::<MILMatrixF>(result__)
    }
    pub unsafe fn SetOutputDPI(
        &self,
        dbldpix: f64,
        dbldpiy: f64,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dbldpix),
            ::std::mem::transmute(dbldpiy),
        )
        .ok()
    }
    pub unsafe fn GetOutputDPI(
        ...
        (::windows::runtime::Interface::vtable(self).9)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(pdbldpix),
            ::std::mem::transmute(pdbldpiy),
        )
        .ok()
    }
    pub unsafe fn SetRegionOfInterest(
        &self,
        prect: *const MilRectD,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).10)(
...
impl IMILBitmapEffectRenderContextImpl {
    ...
    pub unsafe fn UpdateOutputBounds(
        &self,
        prect: *const MilRectD,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).7)(
...
unsafe impl ::windows::runtime::Interface for IMILBitmapEffectRenderContextImpl {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        31101,
        20434,
        [177, 40, 223, 254, 255, 132, 252, 195],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IMILBitmapEffectRenderContextImpl
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
unsafe impl ::windows::runtime::Interface for IMILBitmapEffects {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        26565,
        17547,
        [145, 128, 173, 62, 171, 221, 213, 221],
    );
}
...
pub struct IMILBitmapEffects_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppiureturn: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppeffect: *mut ::windows::runtime::RawPtr,
