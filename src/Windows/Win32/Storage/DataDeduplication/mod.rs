...
impl ::std::fmt::Debug for DDP_FILE_EXTENT {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("DDP_FILE_EXTENT")
...
impl ::std::fmt::Debug for DEDUP_CHUNK_INFO_HASH32 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("DEDUP_CHUNK_INFO_HASH32")
            .field("ChunkFlags", &self.ChunkFlags)
...
impl ::std::cmp::PartialEq for DEDUP_CHUNK_INFO_HASH32 {
    fn eq(&self, other: &Self) -> bool {
        self.ChunkFlags == other.ChunkFlags
            && self.ChunkOffsetInStream == other.ChunkOffsetInStream
...
impl ::std::fmt::Debug for DEDUP_CONTAINER_EXTENT {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("DEDUP_CONTAINER_EXTENT")
            .field("ContainerIndex", &self.ContainerIndex)
...
impl ::std::cmp::PartialEq for DEDUP_CONTAINER_EXTENT {
    fn eq(&self, other: &Self) -> bool {
        self.ContainerIndex == other.ContainerIndex
...
pub const DedupBackupSupport: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    1943450285,
    10628,
    18197,
    [178, 227, 146, 76, 20, 151, 68, 221],
);
#[derive(:: std :: clone :: Clone, :: std :: marker :: Copy)]
#[repr(C)]
...
impl ::std::cmp::PartialEq for DedupChunk {
    fn eq(&self, other: &Self) -> bool {
        self.Hash == other.Hash
            ...
            && self.LogicalSize == other.LogicalSize
...
pub const DedupDataPort: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2400219655,
    6185,
    18610,
    [166, 75, 230, 31, 142, 13, 154, 203],
);
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
impl ::std::cmp::PartialEq for DedupStream {
    fn eq(&self, other: &Self) -> bool {
        self.Path == other.Path
            ...
            && self.Length == other.Length
            && self.ChunkCount == other.ChunkCount
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for DedupStreamEntry {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("DedupStreamEntry")
            .field("Hash", &self.Hash)
            .field("LogicalSize", &self.LogicalSize)
            .field("Offset", &self.Offset)
            .finish()
...
impl IDedupBackupSupport {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn RestoreFiles<
        'a,
        Param2: ::windows::runtime::IntoParam<'a, IDedupReadFileCallback>,
    >(
        &self,
        numberoffiles: u32,
        filefullpaths: *const super::super::Foundation::BSTR,
        store: Param2,
        flags: u32,
        fileresults: *mut ::windows::runtime::HRESULT,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(numberoffiles),
            ::std::mem::transmute(filefullpaths),
            store.into_param().abi(),
            ::std::mem::transmute(flags),
            ::std::mem::transmute(fileresults),
        )
        .ok()
    }
}
unsafe impl ::windows::runtime::Interface for IDedupBackupSupport {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        11053,
        16734,
        [172, 247, 126, 183, 202, 89, 111, 244],
    );
}
...
pub struct IDedupBackupSupport_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        numberoffiles: u32,
        filefullpaths: *const ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
...
impl IDedupChunkLibrary {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dwparamtype),
            vparamvalue.into_param().abi(),
        )
        .ok()
    }
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            iiditeratorinterfaceid.into_param().abi(),
            &mut result__,
        )
...
pub struct IDedupChunkLibrary_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        iiditeratorinterfaceid: ::windows::runtime::GUID,
        ppchunksenum: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IDedupDataPort {
    pub unsafe fn GetStatus(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ...
            ::std::mem::transmute(pdataheadroommb),
        )
        .ok()
    }
    ...
    pub unsafe fn InsertChunks(
        ...
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(chunkcount),
            ::std::mem::transmute(pchunkmetadata),
            ::std::mem::transmute(databytecount),
            ::std::mem::transmute(pchunkdata),
            &mut result__,
        )
        .from_abi::<::windows::runtime::GUID>(result__)
    }
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).6)(
            ...
            ::std::mem::transmute(pchunkmetadata),
            ::std::mem::transmute(databytecount),
            pchunkdatastream.into_param().abi(),
            &mut result__,
        )
        .from_abi::<::windows::runtime::GUID>(result__)
    }
    ...
    pub unsafe fn GetStreams(
        &self,
        streamcount: u32,
        pstreampaths: *const super::super::Foundation::BSTR,
    ) -> ::windows::runtime::Result<::windows::runtime::GUID> {
        let mut result__: <::windows::runtime::GUID as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).9)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(streamcount),
            ::std::mem::transmute(pstreampaths),
            &mut result__,
        )
        .from_abi::<::windows::runtime::GUID>(result__)
    }
    ...
    >(
        ...
        ppitemresults: *mut *mut ::windows::runtime::HRESULT,
    ) -> ::windows::runtime::Result<()> {
    ...
    >(
        &self,
        requestid: Param0,
    ) -> ::windows::runtime::Result<DedupDataPortRequestStatus> {
        let mut result__: <DedupDataPortRequestStatus as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        ...
        .from_abi::<DedupDataPortRequestStatus>(result__)
    }
    ...
    >(
        ...
        requestid: Param0,
        maxwaitms: u32,
        pbatchresult: *mut ::windows::runtime::HRESULT,
        pbatchcount: *mut u32,
        pstatus: *mut DedupDataPortRequestStatus,
        ppitemresults: *mut *mut ::windows::runtime::HRESULT,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).14)(
            ...
            requestid.into_param().abi(),
            ::std::mem::transmute(maxwaitms),
            ::std::mem::transmute(pbatchresult),
            ::std::mem::transmute(pbatchcount),
            ::std::mem::transmute(pstatus),
            ::std::mem::transmute(ppitemresults),
        )
        .ok()
...
unsafe impl ::windows::runtime::Interface for IDedupDataPort {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        16553,
        20131,
        [187, 246, 90, 137, 210, 111, 122, 232],
    );
}
...
pub struct IDedupDataPort_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        streamcount: u32,
        pstreams: *const ::std::mem::ManuallyDrop<DedupStream>,
        entrycount: u32,
        pentries: *const DedupStreamEntry,
        prequestid: *mut ::windows::runtime::GUID,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        streamcount: u32,
        pstreampaths: *const ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
        prequestid: *mut ::windows::runtime::GUID,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
...
impl IDedupDataPortManager {
    pub unsafe fn GetConfiguration(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(pminchunksize),
            ::std::mem::transmute(pmaxchunksize),
            ::std::mem::transmute(pchunkingalgorithm),
            ::std::mem::transmute(phashingalgorithm),
            ::std::mem::transmute(pcompressionalgorithm),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    >(
        ...
        options: u32,
        path: Param1,
    ) -> ::windows::runtime::Result<DedupDataPortVolumeStatus> {
        let mut result__: <DedupDataPortVolumeStatus as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
        ...
        .from_abi::<DedupDataPortVolumeStatus>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    >(
        ...
        options: u32,
        path: Param1,
    ) -> ::windows::runtime::Result<IDedupDataPort> {
        ...
        .from_abi::<IDedupDataPort>(result__)
    }
}
...
pub struct IDedupDataPortManager_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        options: u32,
        path: ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
        ppdataport: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IDedupIterateChunksHash32 {
    pub unsafe fn PushBuffer(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ...
            ::std::mem::transmute(ulbufferlength),
        )
        .ok()
    }
    pub unsafe fn Next(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(ulmaxchunks),
            ::std::mem::transmute(parrchunks),
            ::std::mem::transmute(pulfetched),
        )
        .ok()
    }
...
unsafe impl ::windows::runtime::Interface for IDedupIterateChunksHash32 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        29354,
        16399,
        [151, 103, 202, 216, 102, 165, 162, 216],
    );
}
...
impl IDedupReadFileCallback {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            filefullpath.into_param().abi(),
            ::std::mem::transmute(fileoffset),
            ::std::mem::transmute(sizetoread),
            ::std::mem::transmute(filebuffer),
            ::std::mem::transmute(returnedsize),
            ::std::mem::transmute(flags),
        )
        .ok()
    }
    ...
    pub unsafe fn OrderContainersRestore(
        ...
        containerpaths: *const super::super::Foundation::BSTR,
        readplanentries: *mut u32,
        readplan: *mut *mut DEDUP_CONTAINER_EXTENT,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(numberofcontainers),
            ::std::mem::transmute(containerpaths),
            ::std::mem::transmute(readplanentries),
            ::std::mem::transmute(readplan),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            filefullpath.into_param().abi(),
            ::std::mem::transmute(numberofreads),
            ::std::mem::transmute(readoffsets),
        )
        .ok()
    }
}
...
pub struct IDedupReadFileCallback_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        filefullpath: ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
        fileoffset: i64,
        sizetoread: u32,
        filebuffer: *mut u8,
        returnedsize: *mut u32,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        numberofcontainers: u32,
        containerpaths: *const ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
        readplanentries: *mut u32,
        readplan: *mut *mut DEDUP_CONTAINER_EXTENT,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
