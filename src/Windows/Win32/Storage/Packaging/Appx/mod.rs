...
impl ::std::fmt::Debug for APPX_ENCRYPTED_EXEMPTIONS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("APPX_ENCRYPTED_EXEMPTIONS")
            .field("count", &self.count)
            .field("plainTextFiles", &self.plainTextFiles)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for APPX_ENCRYPTED_PACKAGE_SETTINGS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("APPX_ENCRYPTED_PACKAGE_SETTINGS")
            .field("keyLength", &self.keyLength)
            .field("encryptionAlgorithm", &self.encryptionAlgorithm)
            .field("useDiffusion", &self.useDiffusion)
            .field("blockMapHashAlgorithm", &self.blockMapHashAlgorithm)
            .finish()
    }
}
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
impl ::std::cmp::PartialEq for APPX_ENCRYPTED_PACKAGE_SETTINGS {
    fn eq(&self, other: &Self) -> bool {
        self.keyLength == other.keyLength
            ...
            && self.useDiffusion == other.useDiffusion
            && self.blockMapHashAlgorithm == other.blockMapHashAlgorithm
    }
}
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
...
impl ::std::fmt::Debug for APPX_ENCRYPTED_PACKAGE_SETTINGS2 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("APPX_ENCRYPTED_PACKAGE_SETTINGS2")
            .field("keyLength", &self.keyLength)
            .field("encryptionAlgorithm", &self.encryptionAlgorithm)
            .field("blockMapHashAlgorithm", &self.blockMapHashAlgorithm)
...
impl ::std::fmt::Debug for APPX_KEY_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("APPX_KEY_INFO")
            .field("keyLength", &self.keyLength)
            .field("keyIdLength", &self.keyIdLength)
            .field("key", &self.key)
...
impl ::std::cmp::PartialEq for APPX_KEY_INFO {
    fn eq(&self, other: &Self) -> bool {
        self.keyLength == other.keyLength
            && self.keyIdLength == other.keyIdLength
            && self.key == other.key
...
pub const APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTION_NONE:
    ...
    APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS(0u32);
pub const APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTION_SKIP_VALIDATION:
    APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS =
    APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS(1u32);
pub const APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTION_LOCALIZED:
    APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS =
    APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS(2u32);
...
impl ::std::fmt::Debug for APPX_PACKAGE_SETTINGS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("APPX_PACKAGE_SETTINGS")
            .field("forceZip32", &self.forceZip32)
            .field("hashMethod", &self.hashMethod)
            .finish()
    }
}
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com"))]
...
impl ::std::fmt::Debug for APPX_PACKAGE_WRITER_PAYLOAD_STREAM {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("APPX_PACKAGE_WRITER_PAYLOAD_STREAM")
            ...
            .field("compressionOption", &self.compressionOption)
            .finish()
    }
}
#[cfg(all(
...
pub unsafe fn ActivatePackageVirtualizationContext(
    ...
    #[cfg(windows)]
    {
        ...
        ActivatePackageVirtualizationContext(::std::mem::transmute(context), &mut result__)
...
>(
    packagedependencyid: Param0,
    rank: i32,
    options: AddPackageDependencyOptions,
    packagedependencycontext: *mut *mut PACKAGEDEPENDENCY_CONTEXT__,
    packagefullname: *mut super::super::super::Foundation::PWSTR,
    ...
    #[cfg(windows)]
    {
        ...
        AddPackageDependency(
            packagedependencyid.into_param().abi(),
            ::std::mem::transmute(rank),
            ::std::mem::transmute(options),
            ::std::mem::transmute(packagedependencycontext),
            ::std::mem::transmute(packagefullname),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AppPolicyGetClrCompat(
            processtoken.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AppPolicyGetCreateFileAccess(
            processtoken.into_param().abi(),
            ::std::mem::transmute(policy),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AppPolicyGetLifecycleManagement(
            processtoken.into_param().abi(),
            ::std::mem::transmute(policy),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AppPolicyGetMediaFoundationCodecLoading(
            processtoken.into_param().abi(),
            ::std::mem::transmute(policy),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AppPolicyGetProcessTerminationMethod(
            processtoken.into_param().abi(),
            ::std::mem::transmute(policy),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AppPolicyGetShowDeveloperDiagnostic(
            processtoken.into_param().abi(),
            ::std::mem::transmute(policy),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AppPolicyGetThreadInitializationType(
            processtoken.into_param().abi(),
            ::std::mem::transmute(policy),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AppPolicyGetWindowingModel(
            processtoken.into_param().abi(),
            ::std::mem::transmute(policy),
        ))
    }
...
pub const AppxBundleFactory: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    932054086,
    21380,
    17335,
    [136, 119, 231, 219, 221, 136, 52, 70],
);
pub const AppxEncryptionFactory: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3697692637,
    55400,
    18158,
    [135, 128, 141, 25, 108, 183, 57, 247],
);
pub const AppxFactory: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    1480761664,
    65439,
    16742,
    [143, 92, 98, 245, 183, 176, 199, 129],
);
pub const AppxPackageEditor: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    4026856138,
    44732,
    19213,
    [191, 88, 229, 22, 213, 188, 192, 171],
);
pub const AppxPackagingDiagnosticEventSinkManager: ::windows::runtime::GUID =
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn CheckIsMSIXPackage(
                ...
                ismsixpackage: *mut super::super::super::Foundation::BOOL,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__: <super::super::super::Foundation::BOOL as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        CheckIsMSIXPackage(packagefullname.into_param().abi(), &mut result__)
...
pub unsafe fn ClosePackageInfo(packageinforeference: *const _PACKAGE_INFO_REFERENCE) -> i32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ClosePackageInfo(::std::mem::transmute(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn CreatePackageVirtualizationContext(
                ...
                context: *mut *mut PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__ : < * mut PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__ as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        CreatePackageVirtualizationContext(packagefamilyname.into_param().abi(), &mut result__)
            .from_abi::<*mut PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn DeactivatePackageVirtualizationContext(cookie: usize) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(DeactivatePackageVirtualizationContext(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn DuplicatePackageVirtualizationContext(
                sourcecontext: *const PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__,
                destcontext: *mut *mut PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__ : < * mut PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__ as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        DuplicatePackageVirtualizationContext(::std::mem::transmute(sourcecontext), &mut result__)
            .from_abi::<*mut PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    packagefilters: u32,
    count: *mut u32,
    packagefullnames: *mut super::super::super::Foundation::PWSTR,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(FindPackagesByPackageFamily(
            packagefamilyname.into_param().abi(),
            ::std::mem::transmute(packagefilters),
            ::std::mem::transmute(count),
            ::std::mem::transmute(packagefullnames),
            ::std::mem::transmute(bufferlength),
            ::std::mem::transmute(buffer),
            ::std::mem::transmute(packageproperties),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    packagefamilyname: Param0,
    packagerelativeapplicationid: Param1,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(FormatApplicationUserModelId(
            packagefamilyname.into_param().abi(),
            packagerelativeapplicationid.into_param().abi(),
            ::std::mem::transmute(applicationusermodelidlength),
            ::std::mem::transmute(applicationusermodelid),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetApplicationUserModelId(
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetApplicationUserModelIdFromToken(
...
pub unsafe fn GetCurrentApplicationUserModelId(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetCurrentApplicationUserModelId(
            ::std::mem::transmute(applicationusermodelidlength),
            ::std::mem::transmute(applicationusermodelid),
        ))
    }
...
pub unsafe fn GetCurrentPackageFamilyName(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetCurrentPackageFamilyName(
            ::std::mem::transmute(packagefamilynamelength),
            ::std::mem::transmute(packagefamilyname),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn GetCurrentPackageFullName(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetCurrentPackageFullName(
            ::std::mem::transmute(packagefullnamelength),
            ::std::mem::transmute(packagefullname),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn GetCurrentPackageId(bufferlength: *mut u32, buffer: *mut u8) -> i32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetCurrentPackageId(
            ::std::mem::transmute(bufferlength),
            ::std::mem::transmute(buffer),
        ))
    }
...
pub unsafe fn GetCurrentPackageInfo(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetCurrentPackageInfo(
...
pub unsafe fn GetCurrentPackageInfo2(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetCurrentPackageInfo2(
            ::std::mem::transmute(flags),
            ::std::mem::transmute(packagepathtype),
            ::std::mem::transmute(bufferlength),
            ::std::mem::transmute(buffer),
            ::std::mem::transmute(count),
        ))
...
pub unsafe fn GetCurrentPackagePath(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetCurrentPackagePath(
            ::std::mem::transmute(pathlength),
...
pub unsafe fn GetCurrentPackagePath2(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetCurrentPackagePath2(
            ::std::mem::transmute(packagepathtype),
            ::std::mem::transmute(pathlength),
            ::std::mem::transmute(path),
        ))
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn GetIdForPackageDependencyContext(
                packagedependencycontext: *const PACKAGEDEPENDENCY_CONTEXT__,
                packagedependencyid: *mut super::super::super::Foundation::PWSTR,
            ) -> ::windows::runtime::HRESULT;
        }
...
pub unsafe fn GetPackageApplicationIds(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackageApplicationIds(
            ::std::mem::transmute(packageinforeference),
            ::std::mem::transmute(bufferlength),
            ::std::mem::transmute(buffer),
            ::std::mem::transmute(count),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackageFamilyName(
            hprocess.into_param().abi(),
            ::std::mem::transmute(packagefamilynamelength),
            ::std::mem::transmute(packagefamilyname),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackageFamilyNameFromToken(
            token.into_param().abi(),
            ::std::mem::transmute(packagefamilynamelength),
            ::std::mem::transmute(packagefamilyname),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackageFullName(
            hprocess.into_param().abi(),
            ::std::mem::transmute(packagefullnamelength),
            ::std::mem::transmute(packagefullname),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackageFullNameFromToken(
            token.into_param().abi(),
            ::std::mem::transmute(packagefullnamelength),
            ::std::mem::transmute(packagefullname),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackageId(
            hprocess.into_param().abi(),
            ::std::mem::transmute(bufferlength),
            ::std::mem::transmute(buffer),
        ))
...
pub unsafe fn GetPackageInfo(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackageInfo(
            ::std::mem::transmute(packageinforeference),
            ::std::mem::transmute(flags),
            ::std::mem::transmute(bufferlength),
            ::std::mem::transmute(buffer),
...
pub unsafe fn GetPackageInfo2(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackageInfo2(
            ::std::mem::transmute(packageinforeference),
            ::std::mem::transmute(flags),
            ::std::mem::transmute(packagepathtype),
            ::std::mem::transmute(bufferlength),
...
pub unsafe fn GetPackagePath(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackagePath(
            ::std::mem::transmute(packageid),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackagePathByFullName(
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackagePathByFullName2(
            packagefullname.into_param().abi(),
            ::std::mem::transmute(packagepathtype),
            ::std::mem::transmute(pathlength),
            ::std::mem::transmute(path),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetPackagesByPackageFamily(
            packagefamilyname.into_param().abi(),
            ::std::mem::transmute(count),
            ::std::mem::transmute(packagefullnames),
            ::std::mem::transmute(bufferlength),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetStagedPackageOrigin(
            packagefullname.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetStagedPackagePathByFullName(
            packagefullname.into_param().abi(),
            ::std::mem::transmute(pathlength),
            ::std::mem::transmute(path),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetStagedPackagePathByFullName2(
            packagefullname.into_param().abi(),
            ::std::mem::transmute(packagepathtype),
            ::std::mem::transmute(pathlength),
            ::std::mem::transmute(path),
...
unsafe impl ::windows::runtime::Interface for IAppxBlockMapBlock {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        12868,
        20448,
        [168, 200, 224, 188, 178, 112, 184, 137],
    );
}
...
impl IAppxBlockMapBlocksEnumerator {
    pub unsafe fn GetCurrent(&self) -> ::windows::runtime::Result<IAppxBlockMapBlock> {
        let mut result__: <IAppxBlockMapBlock as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxBlockMapBlock>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::BOOL> {
        let mut result__: <super::super::super::Foundation::BOOL as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxBlockMapBlocksEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxBlockMapBlocksEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        block: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        hascurrent: *mut super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
...
impl IAppxBlockMapFile {
    pub unsafe fn GetBlocks(&self) -> ::windows::runtime::Result<IAppxBlockMapBlocksEnumerator> {
        let mut result__: <IAppxBlockMapBlocksEnumerator as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxBlockMapBlocksEnumerator>(result__)
    }
...
pub struct IAppxBlockMapFile_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        blocks: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        lfhsize: *mut u32,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        name: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IAppxBlockMapFilesEnumerator {
    pub unsafe fn GetCurrent(&self) -> ::windows::runtime::Result<IAppxBlockMapFile> {
        let mut result__: <IAppxBlockMapFile as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxBlockMapFile>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxBlockMapFilesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxBlockMapFilesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        file: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IAppxBlockMapReader {
    ...
    >(
        &self,
        filename: Param0,
    ) -> ::windows::runtime::Result<IAppxBlockMapFile> {
        let mut result__: <IAppxBlockMapFile as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
    ...
    pub unsafe fn GetFiles(&self) -> ::windows::runtime::Result<IAppxBlockMapFilesEnumerator> {
        let mut result__: <IAppxBlockMapFilesEnumerator as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxBlockMapFilesEnumerator>(result__)
    }
...
impl IAppxBundleFactory {
    ...
    >(
        ...
        outputstream: Param0,
        bundleversion: u64,
    ) -> ::windows::runtime::Result<IAppxBundleWriter> {
        let mut result__: <IAppxBundleWriter as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            outputstream.into_param().abi(),
            ::std::mem::transmute(bundleversion),
            &mut result__,
        )
    ...
    >(
        &self,
        inputstream: Param0,
    ) -> ::windows::runtime::Result<IAppxBundleReader> {
        let mut result__: <IAppxBundleReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
    ...
    >(
        &self,
        inputstream: Param0,
    ) -> ::windows::runtime::Result<IAppxBundleManifestReader> {
        let mut result__: <IAppxBundleManifestReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            inputstream.into_param().abi(),
        ...
        .from_abi::<IAppxBundleManifestReader>(result__)
    }
}
...
impl IAppxBundleManifestOptionalBundleInfo {
    pub unsafe fn GetPackageId(&self) -> ::windows::runtime::Result<IAppxManifestPackageId> {
        let mut result__: <IAppxManifestPackageId as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestPackageId>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub unsafe fn GetPackageInfoItems(
        &self,
    ) -> ::windows::runtime::Result<IAppxBundleManifestPackageInfoEnumerator> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxBundleManifestOptionalBundleInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxBundleManifestOptionalBundleInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        packageid: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        filename: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IAppxBundleManifestOptionalBundleInfoEnumerator {
    pub unsafe fn GetCurrent(
        &self,
    ) -> ::windows::runtime::Result<IAppxBundleManifestOptionalBundleInfo> {
        let mut result__: <IAppxBundleManifestOptionalBundleInfo as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxBundleManifestOptionalBundleInfo>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxBundleManifestOptionalBundleInfoEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63870,
        18092,
        [170, 202, 221, 91, 164, 193, 119, 200],
    );
}
impl ::std::convert::From<IAppxBundleManifestOptionalBundleInfoEnumerator>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxBundleManifestOptionalBundleInfoEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxBundleManifestOptionalBundleInfoEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        optionalbundle: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IAppxBundleManifestPackageInfo {
    pub unsafe fn GetPackageType(
        &self,
    ) -> ::windows::runtime::Result<APPX_BUNDLE_PAYLOAD_PACKAGE_TYPE> {
        let mut result__: <APPX_BUNDLE_PAYLOAD_PACKAGE_TYPE as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<APPX_BUNDLE_PAYLOAD_PACKAGE_TYPE>(result__)
    }
    pub unsafe fn GetPackageId(&self) -> ::windows::runtime::Result<IAppxManifestPackageId> {
        let mut result__: <IAppxManifestPackageId as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
    ...
    pub unsafe fn GetResources(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestQualifiedResourcesEnumerator> {
        let mut result__ : < IAppxManifestQualifiedResourcesEnumerator as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestQualifiedResourcesEnumerator>(result__)
    }
}
unsafe impl ::windows::runtime::Interface for IAppxBundleManifestPackageInfo {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        9871,
        16571,
        [142, 210, 117, 122, 158, 186, 236, 141],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxBundleManifestPackageInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IAppxBundleManifestPackageInfo2 {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetIsPackageReference(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::BOOL> {
        let mut result__: <super::super::super::Foundation::BOOL as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetIsDefaultApplicablePackage(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::BOOL> {
        let mut result__: <super::super::super::Foundation::BOOL as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
unsafe impl ::windows::runtime::Interface for IAppxBundleManifestPackageInfo2 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        45775,
        19659,
        [187, 219, 156, 109, 168, 195, 188, 158],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxBundleManifestPackageInfo2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxBundleManifestPackageInfo2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ispackagereference: *mut super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        isnonqualifiedresourcepackage: *mut super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        isdefaultapplicablepackage: *mut super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IAppxBundleManifestPackageInfo3 {
    pub unsafe fn GetTargetDeviceFamilies(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestTargetDeviceFamiliesEnumerator> {
        let mut result__ : < IAppxManifestTargetDeviceFamiliesEnumerator as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestTargetDeviceFamiliesEnumerator>(result__)
    }
}
...
pub struct IAppxBundleManifestPackageInfo3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        targetdevicefamilies: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxBundleManifestPackageInfo4
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxBundleManifestPackageInfo4_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        isstub: *mut super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IAppxBundleManifestPackageInfoEnumerator {
    pub unsafe fn GetCurrent(&self) -> ::windows::runtime::Result<IAppxBundleManifestPackageInfo> {
        let mut result__: <IAppxBundleManifestPackageInfo as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxBundleManifestPackageInfo>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxBundleManifestPackageInfoEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        18854,
        19993,
        [178, 176, 106, 36, 6, 214, 58, 50],
    );
}
impl ::std::convert::From<IAppxBundleManifestPackageInfoEnumerator>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxBundleManifestPackageInfoEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxBundleManifestPackageInfoEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        packageinfo: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IAppxBundleManifestReader2 {
    pub unsafe fn GetOptionalBundles(
        &self,
    ) -> ::windows::runtime::Result<IAppxBundleManifestOptionalBundleInfoEnumerator> {
        let mut result__ : < IAppxBundleManifestOptionalBundleInfoEnumerator as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxBundleManifestOptionalBundleInfoEnumerator>(result__)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxBundleManifestReader2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxBundleManifestReader2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        optionalbundles: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IAppxBundleReader {
    ...
    ) -> ::windows::runtime::Result<IAppxFile> {
        let mut result__: <IAppxFile as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(filetype),
            &mut result__,
        )
        .from_abi::<IAppxFile>(result__)
    }
    pub unsafe fn GetBlockMap(&self) -> ::windows::runtime::Result<IAppxBlockMapReader> {
        let mut result__: <IAppxBlockMapReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            &mut result__,
    ...
    pub unsafe fn GetPayloadPackages(&self) -> ::windows::runtime::Result<IAppxFilesEnumerator> {
        let mut result__: <IAppxFilesEnumerator as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxFilesEnumerator>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetPayloadPackage<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::PWSTR>,
    >(
        &self,
...
pub struct IAppxBundleReader_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        filetype: APPX_BUNDLE_FOOTPRINT_FILE_TYPE,
        footprintfile: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        payloadpackages: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        filename: super::super::super::Foundation::PWSTR,
        payloadpackage: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IAppxBundleWriter {
    ...
    >(
        &self,
        filename: Param0,
        packagestream: Param1,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            filename.into_param().abi(),
            packagestream.into_param().abi(),
        )
        .ok()
    }
...
impl IAppxBundleWriter3 {
    ...
    >(
        &self,
        hashmethodstring: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            hashmethodstring.into_param().abi(),
        )
        .ok()
    }
}
...
pub struct IAppxBundleWriter3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        hashmethodstring: super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IAppxBundleWriter4 {
    ...
    >(
        ...
        filename: Param0,
        packagestream: Param1,
        isdefaultapplicablepackage: Param2,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            filename.into_param().abi(),
            packagestream.into_param().abi(),
            isdefaultapplicablepackage.into_param().abi(),
        )
        .ok()
    }
    #[cfg(all(
...
impl IAppxContentGroup {
    ...
    pub unsafe fn GetFiles(&self) -> ::windows::runtime::Result<IAppxContentGroupFilesEnumerator> {
        let mut result__: <IAppxContentGroupFilesEnumerator as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxContentGroupFilesEnumerator>(result__)
    }
}
...
pub struct IAppxContentGroup_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        groupname: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxContentGroupFilesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxContentGroupFilesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        file: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl IAppxContentGroupMapReader {
    pub unsafe fn GetRequiredGroup(&self) -> ::windows::runtime::Result<IAppxContentGroup> {
        let mut result__: <IAppxContentGroup as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxContentGroup>(result__)
    }
    pub unsafe fn GetAutomaticGroups(
        &self,
    ) -> ::windows::runtime::Result<IAppxContentGroupsEnumerator> {
        let mut result__: <IAppxContentGroupsEnumerator as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxContentGroupsEnumerator>(result__)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxContentGroupMapReader
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxContentGroupMapReader_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        requiredgroup: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        automaticgroupsenumerator: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IAppxContentGroupMapWriter {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn AddAutomaticGroup<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::PWSTR>,
    >(
        &self,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn AddAutomaticFile<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::PWSTR>,
    >(
        &self,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxContentGroupMapWriter
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxContentGroupMapWriter_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        groupname: super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxContentGroupsEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
unsafe impl ::windows::runtime::Interface for IAppxEncryptedBundleWriter {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        31728,
        16663,
        [184, 198, 66, 121, 239, 129, 238, 119],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxEncryptedBundleWriter
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxEncryptedBundleWriter2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IAppxEncryptedPackageWriter {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            filename.into_param().abi(),
            ::std::mem::transmute(compressionoption),
            inputstream.into_param().abi(),
        )
        .ok()
    }
...
impl IAppxEncryptedPackageWriter2 {
    ...
    pub unsafe fn AddPayloadFilesEncrypted(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(filecount),
            ::std::mem::transmute(payloadfiles),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxEncryptedPackageWriter2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IAppxEncryptionFactory {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ...
            ::std::mem::transmute(exemptedfiles),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Storage_StructuredStorage")]
    ...
    >(
        ...
        let mut result__: <IAppxEncryptedPackageWriter as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            outputstream.into_param().abi(),
            manifeststream.into_param().abi(),
            ::std::mem::transmute(settings),
            ::std::mem::transmute(keyinfo),
            ::std::mem::transmute(exemptedfiles),
            &mut result__,
    ...
    >(
        ...
        inputstream: Param0,
        keyinfo: *const APPX_KEY_INFO,
    ) -> ::windows::runtime::Result<IAppxPackageReader> {
        let mut result__: <IAppxPackageReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            inputstream.into_param().abi(),
    ...
    >(
        ...
        keyinfo: *const APPX_KEY_INFO,
        exemptedfiles: *const APPX_ENCRYPTED_EXEMPTIONS,
    ) -> ::windows::runtime::Result<IAppxEncryptedBundleWriter> {
        let mut result__: <IAppxEncryptedBundleWriter as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
pub struct IAppxEncryptionFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        inputstream: ::windows::runtime::RawPtr,
        outputstream: ::windows::runtime::RawPtr,
        settings: *const ::std::mem::ManuallyDrop<APPX_ENCRYPTED_PACKAGE_SETTINGS>,
        keyinfo: *const APPX_KEY_INFO,
        exemptedfiles: *const APPX_ENCRYPTED_EXEMPTIONS,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        outputstream: ::windows::runtime::RawPtr,
        manifeststream: ::windows::runtime::RawPtr,
        settings: *const ::std::mem::ManuallyDrop<APPX_ENCRYPTED_PACKAGE_SETTINGS>,
        keyinfo: *const APPX_KEY_INFO,
        exemptedfiles: *const APPX_ENCRYPTED_EXEMPTIONS,
...
impl IAppxEncryptionFactory2 {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ...
            outputstream.into_param().abi(),
            manifeststream.into_param().abi(),
            contentgroupmapstream.into_param().abi(),
            ::std::mem::transmute(settings),
            ::std::mem::transmute(keyinfo),
            ::std::mem::transmute(exemptedfiles),
            &mut result__,
...
pub struct IAppxEncryptionFactory2_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        outputstream: ::windows::runtime::RawPtr,
        manifeststream: ::windows::runtime::RawPtr,
        contentgroupmapstream: ::windows::runtime::RawPtr,
        settings: *const ::std::mem::ManuallyDrop<APPX_ENCRYPTED_PACKAGE_SETTINGS>,
        keyinfo: *const APPX_KEY_INFO,
        exemptedfiles: *const APPX_ENCRYPTED_EXEMPTIONS,
        packagewriter: *mut ::windows::runtime::RawPtr,
...
impl IAppxFactory {
    ...
    ) -> ::windows::runtime::Result<IAppxPackageWriter> {
        let mut result__: <IAppxPackageWriter as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            outputstream.into_param().abi(),
    ...
    >(
        &self,
        inputstream: Param0,
    ) -> ::windows::runtime::Result<IAppxManifestReader> {
        let mut result__: <IAppxManifestReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            inputstream.into_param().abi(),
    ...
    >(
        &self,
        inputstream: Param0,
    ) -> ::windows::runtime::Result<IAppxBlockMapReader> {
        let mut result__: <IAppxBlockMapReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
    ...
    >(
        &self,
        blockmapstream: Param0,
        signaturefilename: Param1,
    ) -> ::windows::runtime::Result<IAppxBlockMapReader> {
        let mut result__: <IAppxBlockMapReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            blockmapstream.into_param().abi(),
            signaturefilename.into_param().abi(),
            &mut result__,
        )
        .from_abi::<IAppxBlockMapReader>(result__)
    }
...
unsafe impl ::windows::runtime::Interface for IAppxFactory {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        58449,
        17291,
        [181, 167, 215, 158, 118, 123, 117, 216],
    );
}
...
impl IAppxFactory2 {
    ...
    >(
        &self,
        inputstream: Param0,
    ) -> ::windows::runtime::Result<IAppxContentGroupMapReader> {
        let mut result__: <IAppxContentGroupMapReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            inputstream.into_param().abi(),
    ...
    >(
        &self,
        inputstream: Param0,
    ) -> ::windows::runtime::Result<IAppxSourceContentGroupMapReader> {
        let mut result__: <IAppxSourceContentGroupMapReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            inputstream.into_param().abi(),
    ...
    >(
        &self,
        stream: Param0,
    ) -> ::windows::runtime::Result<IAppxContentGroupMapWriter> {
        let mut result__: <IAppxContentGroupMapWriter as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
        ...
        .from_abi::<IAppxContentGroupMapWriter>(result__)
    }
}
...
impl IAppxFile {
    pub unsafe fn GetCompressionOption(
        &self,
    ) -> ::windows::runtime::Result<APPX_COMPRESSION_OPTION> {
        let mut result__: <APPX_COMPRESSION_OPTION as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<APPX_COMPRESSION_OPTION>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
...
impl IAppxManifestApplication {
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetAppUserModelId(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::PWSTR> {
        let mut result__: <super::super::super::Foundation::PWSTR as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
pub struct IAppxManifestApplication_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        value: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        appusermodelid: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IAppxManifestApplicationsEnumerator {
    pub unsafe fn GetCurrent(&self) -> ::windows::runtime::Result<IAppxManifestApplication> {
        let mut result__: <IAppxManifestApplication as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestApplication>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestApplicationsEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        61515,
        19725,
        [128, 141, 104, 97, 133, 212, 132, 122],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestApplicationsEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestCapabilitiesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestCapabilitiesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        capability: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
unsafe impl ::windows::runtime::Interface for IAppxManifestDeviceCapabilitiesEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        17019,
        18972,
        [186, 207, 101, 91, 244, 99, 165, 64],
    );
}
impl ::std::convert::From<IAppxManifestDeviceCapabilitiesEnumerator>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestDeviceCapabilitiesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestDeviceCapabilitiesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        devicecapability: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestDriverConstraint
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestDriverConstraint_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        mindate: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IAppxManifestDriverConstraintsEnumerator {
    pub unsafe fn GetCurrent(&self) -> ::windows::runtime::Result<IAppxManifestDriverConstraint> {
        let mut result__: <IAppxManifestDriverConstraint as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestDriverConstraint>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestDriverConstraintsEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        62976,
        18912,
        [149, 230, 151, 93, 141, 161, 61, 137],
    );
}
impl ::std::convert::From<IAppxManifestDriverConstraintsEnumerator>
    for ::windows::runtime::IUnknown
{
...
pub struct IAppxManifestDriverConstraintsEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        driverconstraint: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IAppxManifestDriverDependenciesEnumerator {
    pub unsafe fn GetCurrent(&self) -> ::windows::runtime::Result<IAppxManifestDriverDependency> {
        let mut result__: <IAppxManifestDriverDependency as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestDriverDependency>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestDriverDependenciesEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        18047,
        18261,
        [132, 4, 143, 94, 182, 134, 91, 51],
    );
}
impl ::std::convert::From<IAppxManifestDriverDependenciesEnumerator>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestDriverDependenciesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestDriverDependenciesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        driverdependency: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IAppxManifestDriverDependency {
    pub unsafe fn GetDriverConstraints(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestDriverConstraintsEnumerator> {
        let mut result__ : < IAppxManifestDriverConstraintsEnumerator as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestDriverConstraintsEnumerator>(result__)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestDriverDependency
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestDriverDependency_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        driverconstraints: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IAppxManifestHostRuntimeDependenciesEnumerator {
    pub unsafe fn GetCurrent(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestHostRuntimeDependency> {
        let mut result__: <IAppxManifestHostRuntimeDependency as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestHostRuntimeDependency>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestHostRuntimeDependenciesEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        32585,
        17214,
        [177, 166, 13, 163, 9, 246, 136, 90],
    );
}
impl ::std::convert::From<IAppxManifestHostRuntimeDependenciesEnumerator>
    for ::windows::runtime::IUnknown
{
...
pub struct IAppxManifestHostRuntimeDependenciesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        hostruntimedependency: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestHostRuntimeDependency
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestHostRuntimeDependency_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        publisher: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestHostRuntimeDependency2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IAppxManifestMainPackageDependenciesEnumerator {
    pub unsafe fn GetCurrent(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestMainPackageDependency> {
        let mut result__: <IAppxManifestMainPackageDependency as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestMainPackageDependency>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestMainPackageDependenciesEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        20946,
        20239,
        [186, 70, 126, 213, 37, 94, 189, 255],
    );
}
impl ::std::convert::From<IAppxManifestMainPackageDependenciesEnumerator>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestMainPackageDependenciesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestMainPackageDependenciesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        mainpackagedependency: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestMainPackageDependency {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        48169,
        18133,
        [151, 226, 132, 185, 199, 155, 216, 174],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestMainPackageDependency
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IAppxManifestOSPackageDependenciesEnumerator {
    pub unsafe fn GetCurrent(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestOSPackageDependency> {
        let mut result__: <IAppxManifestOSPackageDependency as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestOSPackageDependency>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestOSPackageDependenciesEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63724,
        19393,
        [138, 226, 21, 99, 70, 245, 255, 234],
    );
}
impl ::std::convert::From<IAppxManifestOSPackageDependenciesEnumerator>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestOSPackageDependenciesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestOSPackageDependenciesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ospackagedependency: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestOSPackageDependency
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IAppxManifestOptionalPackageInfo {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetIsOptionalPackage(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::BOOL> {
        let mut result__: <super::super::super::Foundation::BOOL as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetMainPackageName(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::PWSTR> {
        let mut result__: <super::super::super::Foundation::PWSTR as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestOptionalPackageInfo
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestOptionalPackageInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        isoptionalpackage: *mut super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        mainpackagename: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IAppxManifestPackageDependenciesEnumerator {
    pub unsafe fn GetCurrent(&self) -> ::windows::runtime::Result<IAppxManifestPackageDependency> {
        let mut result__: <IAppxManifestPackageDependency as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestPackageDependency>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestPackageDependenciesEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        26022,
        17117,
        [186, 192, 140, 103, 65, 231, 245, 164],
    );
}
impl ::std::convert::From<IAppxManifestPackageDependenciesEnumerator>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestPackageDependenciesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestPackageDependenciesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        dependency: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestPackageDependency
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestPackageDependency2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, IAppxManifestPackageDependency>
    for IAppxManifestPackageDependency2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IAppxManifestPackageDependency> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<IAppxManifestPackageDependency>::into(self),
        )
    }
}
impl<'a> ::windows::runtime::IntoParam<'a, IAppxManifestPackageDependency>
    for &IAppxManifestPackageDependency2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IAppxManifestPackageDependency> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<IAppxManifestPackageDependency>::into(
...
unsafe impl ::windows::runtime::Interface for IAppxManifestPackageDependency3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        24984,
        19819,
        [146, 228, 116, 157, 90, 184, 168, 149],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestPackageDependency3
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestPackageDependency3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        isoptional: *mut super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IAppxManifestPackageId {
    ...
    pub unsafe fn GetArchitecture(&self) -> ::windows::runtime::Result<APPX_PACKAGE_ARCHITECTURE> {
        let mut result__: <APPX_PACKAGE_ARCHITECTURE as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<APPX_PACKAGE_ARCHITECTURE>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetPublisher(
        &self,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ComparePublisher<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::PWSTR>,
    >(
        &self,
...
pub struct IAppxManifestPackageId_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        resourceid: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        other: super::super::super::Foundation::PWSTR,
        issame: *mut super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl IAppxManifestPackageId2 {
    ...
    pub unsafe fn GetArchitecture2(
        &self,
    ) -> ::windows::runtime::Result<APPX_PACKAGE_ARCHITECTURE2> {
        let mut result__: <APPX_PACKAGE_ARCHITECTURE2 as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).11)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<APPX_PACKAGE_ARCHITECTURE2>(result__)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IAppxManifestPackageId> for &IAppxManifestPackageId2 {
    fn into_param(self) -> ::windows::runtime::Param<'a, IAppxManifestPackageId> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IAppxManifestPackageId>::into(
            ::std::clone::Clone::clone(self),
        ))
    }
}
...
unsafe impl ::windows::runtime::Interface for IAppxManifestProperties {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        62063,
        19244,
        [170, 247, 143, 231, 120, 155, 139, 202],
    );
}
...
pub struct IAppxManifestProperties_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        name: super::super::super::Foundation::PWSTR,
        value: *mut super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl IAppxManifestQualifiedResource {
    ...
    pub unsafe fn GetDXFeatureLevel(&self) -> ::windows::runtime::Result<DX_FEATURE_LEVEL> {
        ...
        .from_abi::<DX_FEATURE_LEVEL>(result__)
    }
}
unsafe impl ::windows::runtime::Interface for IAppxManifestQualifiedResource {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        15452,
        18641,
        [158, 163, 187, 126, 172, 140, 215, 212],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestQualifiedResource
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestQualifiedResource_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        language: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IAppxManifestQualifiedResourcesEnumerator {
    pub unsafe fn GetCurrent(&self) -> ::windows::runtime::Result<IAppxManifestQualifiedResource> {
        let mut result__: <IAppxManifestQualifiedResource as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestQualifiedResource>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestQualifiedResourcesEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        14178,
        19087,
        [147, 115, 47, 197, 212, 68, 200, 210],
    );
}
impl ::std::convert::From<IAppxManifestQualifiedResourcesEnumerator>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestQualifiedResourcesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestQualifiedResourcesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        resource: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IAppxManifestReader {
    ...
    pub unsafe fn GetProperties(&self) -> ::windows::runtime::Result<IAppxManifestProperties> {
        let mut result__: <IAppxManifestProperties as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestProperties>(result__)
    }
    pub unsafe fn GetPackageDependencies(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestPackageDependenciesEnumerator> {
        let mut result__ : < IAppxManifestPackageDependenciesEnumerator as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestPackageDependenciesEnumerator>(result__)
    }
    pub unsafe fn GetCapabilities(&self) -> ::windows::runtime::Result<APPX_CAPABILITIES> {
        let mut result__: <APPX_CAPABILITIES as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<APPX_CAPABILITIES>(result__)
    }
    pub unsafe fn GetResources(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestResourcesEnumerator> {
        let mut result__: <IAppxManifestResourcesEnumerator as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestResourcesEnumerator>(result__)
    }
    pub unsafe fn GetDeviceCapabilities(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestDeviceCapabilitiesEnumerator> {
        let mut result__ : < IAppxManifestDeviceCapabilitiesEnumerator as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestDeviceCapabilitiesEnumerator>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetPrerequisite<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::PWSTR>,
    >(
        &self,
    ...
    pub unsafe fn GetApplications(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestApplicationsEnumerator> {
        let mut result__: <IAppxManifestApplicationsEnumerator as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).10)(
            ::std::mem::transmute_copy(self),
            &mut result__,
...
pub struct IAppxManifestReader_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        packageproperties: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        devicecapabilities: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl<'a> ::windows::runtime::IntoParam<'a, IAppxManifestReader> for &IAppxManifestReader2 {
    fn into_param(self) -> ::windows::runtime::Param<'a, IAppxManifestReader> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IAppxManifestReader>::into(
            ::std::clone::Clone::clone(self),
        ))
    }
}
...
impl IAppxManifestReader3 {
    ...
    ) -> ::windows::runtime::Result<IAppxManifestCapabilitiesEnumerator> {
        let mut result__: <IAppxManifestCapabilitiesEnumerator as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).13)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(capabilityclass),
            &mut result__,
        )
        .from_abi::<IAppxManifestCapabilitiesEnumerator>(result__)
    }
    pub unsafe fn GetTargetDeviceFamilies(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestTargetDeviceFamiliesEnumerator> {
...
impl<'a> ::windows::runtime::IntoParam<'a, IAppxManifestReader2> for &IAppxManifestReader3 {
    fn into_param(self) -> ::windows::runtime::Param<'a, IAppxManifestReader2> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IAppxManifestReader2>::into(
            ::std::clone::Clone::clone(self),
        ))
    }
}
...
pub struct IAppxManifestReader3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        capabilityclass: APPX_CAPABILITY_CLASS_TYPE,
        capabilities: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        targetdevicefamilies: *mut ::windows::runtime::RawPtr,
...
impl IAppxManifestReader4 {
    ...
    pub unsafe fn GetOptionalPackageInfo(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestOptionalPackageInfo> {
        let mut result__: <IAppxManifestOptionalPackageInfo as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).15)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestOptionalPackageInfo>(result__)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, IAppxManifestReader3> for &IAppxManifestReader4 {
    fn into_param(self) -> ::windows::runtime::Param<'a, IAppxManifestReader3> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IAppxManifestReader3>::into(
            ::std::clone::Clone::clone(self),
        ))
    }
}
...
pub struct IAppxManifestReader4_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        optionalpackageinfo: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IAppxManifestReader5 {
    pub unsafe fn GetMainPackageDependencies(
        &self,
    ) -> ::windows::runtime::Result<IAppxManifestMainPackageDependenciesEnumerator> {
        let mut result__ : < IAppxManifestMainPackageDependenciesEnumerator as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestMainPackageDependenciesEnumerator>(result__)
    }
}
...
pub struct IAppxManifestReader5_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        mainpackagedependencies: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IAppxManifestReader7_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        driverdependencies: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ospackagedependencies: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        hostruntimedependencies: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IAppxManifestResourcesEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        34842,
        18619,
        [133, 140, 214, 242, 186, 234, 230, 237],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestResourcesEnumerator
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxManifestResourcesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        resource: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl IAppxManifestTargetDeviceFamiliesEnumerator {
    pub unsafe fn GetCurrent(&self) -> ::windows::runtime::Result<IAppxManifestTargetDeviceFamily> {
        let mut result__: <IAppxManifestTargetDeviceFamily as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IAppxManifestTargetDeviceFamily>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetHasCurrent(
        &self,
...
unsafe impl ::windows::runtime::Interface for IAppxManifestTargetDeviceFamiliesEnumerator {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        10148,
        18312,
        [136, 192, 115, 56, 25, 87, 80, 23],
    );
}
impl ::std::convert::From<IAppxManifestTargetDeviceFamiliesEnumerator>
    for ::windows::runtime::IUnknown
{
...
pub struct IAppxManifestTargetDeviceFamiliesEnumerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        targetdevicefamily: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxManifestTargetDeviceFamily
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IAppxPackageEditor {
    ...
    >(
        ...
        baselinepackagestream: Param1,
        deltapackagestream: Param2,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            updatedpackagestream.into_param().abi(),
            baselinepackagestream.into_param().abi(),
            deltapackagestream.into_param().abi(),
        )
        .ok()
    }
    #[cfg(all(
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            updatedpackagestream.into_param().abi(),
            baselineblockmapstream.into_param().abi(),
            baselinepackagefullname.into_param().abi(),
            deltapackagestream.into_param().abi(),
        )
        .ok()
    }
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).6)(
            ...
            baselinepackagestream.into_param().abi(),
            deltapackagestream.into_param().abi(),
            ::std::mem::transmute(updateoption),
        )
        .ok()
    }
    #[cfg(all(
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            baselineencryptedpackagestream.into_param().abi(),
            deltapackagestream.into_param().abi(),
            ::std::mem::transmute(updateoption),
            ::std::mem::transmute(settings),
            ::std::mem::transmute(keyinfo),
    ...
    >(
        &self,
        packagestream: Param0,
        updatedmanifeststream: Param1,
        ispackageencrypted: Param2,
        options: APPX_PACKAGE_EDITOR_UPDATE_PACKAGE_MANIFEST_OPTIONS,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            packagestream.into_param().abi(),
            updatedmanifeststream.into_param().abi(),
            ispackageencrypted.into_param().abi(),
            ::std::mem::transmute(options),
        )
        .ok()
    }
...
pub struct IAppxPackageEditor_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        updatedpackagestream: ::windows::runtime::RawPtr,
        baselineblockmapstream: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        packagestream: ::windows::runtime::RawPtr,
        updatedmanifeststream: ::windows::runtime::RawPtr,
...
pub struct IAppxPackageReader_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        filesenumerator: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        manifestreader: *mut ::windows::runtime::RawPtr,
...
impl IAppxPackageWriter2 {
    ...
    >(
        &self,
        manifest: Param0,
        contentgroupmap: Param1,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            manifest.into_param().abi(),
            contentgroupmap.into_param().abi(),
        )
        .ok()
    }
}
...
impl IAppxPackagingDiagnosticEventSink {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ReportContextChange<
        'a,
    ...
    >(
        ...
        contextid: i32,
        contextname: Param2,
        contextmessage: Param3,
        detailsmessage: Param4,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(changetype),
            ::std::mem::transmute(contextid),
            contextname.into_param().abi(),
            contextmessage.into_param().abi(),
            detailsmessage.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxPackagingDiagnosticEventSink
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IAppxPackagingDiagnosticEventSink_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        changetype: APPX_PACKAGING_CONTEXT_CHANGE_TYPE,
        contextid: i32,
        contextname: super::super::super::Foundation::PSTR,
        contextmessage: super::super::super::Foundation::PWSTR,
        detailsmessage: super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        errormessage: super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IAppxPackagingDiagnosticEventSinkManager {
    pub unsafe fn SetSinkForProcess<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IAppxPackagingDiagnosticEventSink>,
    >(
        &self,
        sink: Param0,
    ) -> ::windows::runtime::Result<()> {
...
unsafe impl ::windows::runtime::Interface for IAppxPackagingDiagnosticEventSinkManager {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        42987,
        18697,
        [161, 93, 105, 84, 160, 120, 241, 138],
    );
}
impl ::std::convert::From<IAppxPackagingDiagnosticEventSinkManager>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxPackagingDiagnosticEventSinkManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IAppxSourceContentGroupMapReader
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(OpenPackageInfoByFullName(
            packagefullname.into_param().abi(),
            ::std::mem::transmute(reserved),
            ::std::mem::transmute(packageinforeference),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(OpenPackageInfoByFullNameForUser(
...
impl ::std::fmt::Debug for PACKAGEDEPENDENCY_CONTEXT__ {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("PACKAGEDEPENDENCY_CONTEXT__")
...
impl ::std::fmt::Debug for PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__ {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("PACKAGE_VIRTUALIZATION_CONTEXT_HANDLE__")
            .field("unused", &self.unused)
            .finish()
    }
}
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(PackageFamilyNameFromFullName(
            packagefullname.into_param().abi(),
            ::std::mem::transmute(packagefamilynamelength),
            ::std::mem::transmute(packagefamilyname),
        ))
...
pub unsafe fn PackageFamilyNameFromId(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(PackageFamilyNameFromId(
            ::std::mem::transmute(packageid),
            ::std::mem::transmute(packagefamilynamelength),
            ::std::mem::transmute(packagefamilyname),
        ))
...
pub unsafe fn PackageFullNameFromId(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(PackageFullNameFromId(
            ::std::mem::transmute(packageid),
            ::std::mem::transmute(packagefullnamelength),
            ::std::mem::transmute(packagefullname),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(PackageIdFromFullName(
            packagefullname.into_param().abi(),
            ::std::mem::transmute(flags),
            ::std::mem::transmute(bufferlength),
            ::std::mem::transmute(buffer),
...
>(
    ...
    packagename: super::super::super::Foundation::PWSTR,
    packagepublisheridlength: *mut u32,
    packagepublisherid: super::super::super::Foundation::PWSTR,
) -> i32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(PackageNameAndPublisherIdFromFamilyName(
            packagefamilyname.into_param().abi(),
            ::std::mem::transmute(packagenamelength),
            ::std::mem::transmute(packagename),
            ::std::mem::transmute(packagepublisheridlength),
            ::std::mem::transmute(packagepublisherid),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ParseApplicationUserModelId(
            applicationusermodelid.into_param().abi(),
            ::std::mem::transmute(packagefamilynamelength),
            ::std::mem::transmute(packagefamilyname),
            ::std::mem::transmute(packagerelativeapplicationidlength),
            ::std::mem::transmute(packagerelativeapplicationid),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn ReleasePackageVirtualizationContext(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ReleasePackageVirtualizationContext(::std::mem::transmute(
            context,
        )))
    }
    #[cfg(not(windows))]
...
pub unsafe fn TryCreatePackageDependency<
    ...
    Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::PSID>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::PWSTR>,
    Param2: ::windows::runtime::IntoParam<'a, PACKAGE_VERSION>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn TryCreatePackageDependency(
                ...
                packagedependencyprocessorarchitectures: PackageDependencyProcessorArchitectures,
                lifetimekind: PackageDependencyLifetimeKind,
                lifetimeartifact: super::super::super::Foundation::PWSTR,
                options: CreatePackageDependencyOptions,
                packagedependencyid: *mut super::super::super::Foundation::PWSTR,
            ) -> ::windows::runtime::HRESULT;
        }
        ...
        TryCreatePackageDependency(
            ...
            ::std::mem::transmute(packagedependencyprocessorarchitectures),
            ::std::mem::transmute(lifetimekind),
            lifetimeartifact.into_param().abi(),
            ::std::mem::transmute(options),
            &mut result__,
        )
        .from_abi::<super::super::super::Foundation::PWSTR>(result__)
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(VerifyApplicationUserModelId(
            applicationusermodelid.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(VerifyPackageFamilyName(
            packagefamilyname.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(VerifyPackageRelativeApplicationId(
            packagerelativeapplicationid.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
impl ::std::fmt::Debug for _PACKAGE_INFO_REFERENCE {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_PACKAGE_INFO_REFERENCE")
