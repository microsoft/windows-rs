...
pub const FHCFG_E_CONFIGURATION_PREVIOUSLY_LOADED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220731i32 as _);
pub const FHCFG_E_CONFIG_ALREADY_EXISTS: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220734i32 as _);
pub const FHCFG_E_CONFIG_FILE_NOT_FOUND: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220735i32 as _);
pub const FHCFG_E_CORRUPT_CONFIG_FILE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220736i32 as _);
pub const FHCFG_E_INVALID_REHYDRATION_STATE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220726i32 as _);
pub const FHCFG_E_LEGACY_BACKUP_NOT_FOUND: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220715i32 as _);
pub const FHCFG_E_LEGACY_BACKUP_USER_EXCLUDED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220716i32 as _);
pub const FHCFG_E_LEGACY_TARGET_UNSUPPORTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220718i32 as _);
pub const FHCFG_E_LEGACY_TARGET_VALIDATION_UNSUPPORTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220717i32 as _);
pub const FHCFG_E_NO_VALID_CONFIGURATION_LOADED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220733i32 as _);
pub const FHCFG_E_RECOMMENDATION_CHANGE_NOT_ALLOWED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220720i32 as _);
pub const FHCFG_E_TARGET_CANNOT_BE_USED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220727i32 as _);
pub const FHCFG_E_TARGET_NOT_CONFIGURED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220729i32 as _);
pub const FHCFG_E_TARGET_NOT_CONNECTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220732i32 as _);
pub const FHCFG_E_TARGET_NOT_ENOUGH_FREE_SPACE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220728i32 as _);
pub const FHCFG_E_TARGET_REHYDRATED_ELSEWHERE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220719i32 as _);
pub const FHCFG_E_TARGET_VERIFICATION_FAILED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220730i32 as _);
pub const FHSVC_E_BACKUP_BLOCKED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147219968i32 as _);
pub const FHSVC_E_CONFIG_DISABLED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147219966i32 as _);
pub const FHSVC_E_CONFIG_DISABLED_GP: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147219965i32 as _);
pub const FHSVC_E_CONFIG_REHYDRATING: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147219963i32 as _);
pub const FHSVC_E_FATAL_CONFIG_ERROR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147219964i32 as _);
pub const FHSVC_E_NOT_CONFIGURED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147219967i32 as _);
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
    :: std :: marker :: Copy,
...
pub const FhConfigMgr: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3980639036,
    2537,
    18826,
    [157, 246, 33, 119, 36, 76, 109, 180],
);
pub const FhReassociation: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    1299353141,
    5882,
    17184,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn FhServiceOpenPipe(
                ...
                pipe: *mut super::super::System::WindowsProgramming::FH_SERVICE_PIPE_HANDLE,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__ : < super::super::System::WindowsProgramming:: FH_SERVICE_PIPE_HANDLE as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        FhServiceOpenPipe(startserviceifstopped.into_param().abi(), &mut result__)
            .from_abi::<super::super::System::WindowsProgramming::FH_SERVICE_PIPE_HANDLE>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
impl IFhConfigMgr {
    ...
    >(
        &self,
        overwriteifexists: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            overwriteifexists.into_param().abi(),
        )
        .ok()
    }
    ...
    >(
        ...
        include: Param0,
        category: FH_PROTECTED_ITEM_CATEGORY,
    ) -> ::windows::runtime::Result<IFhScopeIterator> {
        let mut result__: <IFhScopeIterator as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            include.into_param().abi(),
            ::std::mem::transmute(category),
            &mut result__,
        )
        .from_abi::<IFhScopeIterator>(result__)
    }
    pub unsafe fn GetLocalPolicy(
        ...
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(localpolicytype),
            &mut result__,
        )
    ...
    pub unsafe fn GetBackupStatus(&self) -> ::windows::runtime::Result<FH_BACKUP_STATUS> {
        ...
        .from_abi::<FH_BACKUP_STATUS>(result__)
    }
    pub unsafe fn SetBackupStatus(
        ...
        (::windows::runtime::Interface::vtable(self).11)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(backupstatus),
        )
        .ok()
    }
    ...
    >(
        &self,
        targeturl: Param0,
    ) -> ::windows::runtime::Result<FH_DEVICE_VALIDATION_RESULT> {
        let mut result__: <FH_DEVICE_VALIDATION_RESULT as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        ...
        .from_abi::<FH_DEVICE_VALIDATION_RESULT>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub unsafe fn QueryProtectionStatus(
        ...
        protecteduntiltime: *mut super::super::Foundation::BSTR,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).16)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(protectionstate),
            ::std::mem::transmute(protecteduntiltime),
        )
        .ok()
    }
}
...
pub struct IFhConfigMgr_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        overwriteifexists: super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        ...
        category: FH_PROTECTED_ITEM_CATEGORY,
        item: ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        include: super::super::Foundation::BOOL,
        category: FH_PROTECTED_ITEM_CATEGORY,
        iterator: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        defaulttarget: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        targeturl: ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        recommend: super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        protectionstate: *mut u32,
        protecteduntiltime: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IFhReassociation {
    ...
    pub unsafe fn GetConfigurationDetails(
        &self,
        index: u32,
        username: *mut super::super::Foundation::BSTR,
        pcname: *mut super::super::Foundation::BSTR,
        ...
        (::windows::runtime::Interface::vtable(self).5)(
            ...
            ::std::mem::transmute(pcname),
            ::std::mem::transmute(backuptime),
        )
        .ok()
    }
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn PerformReassociation<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
    >(
        &self,
...
unsafe impl ::windows::runtime::Interface for IFhReassociation {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        63117,
        18348,
        [145, 239, 22, 178, 179, 106, 163, 238],
    );
}
...
pub struct IFhReassociation_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        index: u32,
        username: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
        pcname: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
        backuptime: *mut super::super::Foundation::FILETIME,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
...
pub struct IFhScopeIterator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        item: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
pub struct IFhTarget_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        propertytype: FH_TARGET_PROPERTY_TYPE,
        propertyvalue: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
