...
pub const ID_DOCUMENTPACKAGETARGET_MSXPS: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2628665512,
        57041,
        16841,
        [169, 253, 215, 53, 239, 51, 174, 218],
    );
pub const ID_DOCUMENTPACKAGETARGET_OPENXPS: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        5684082,
        35996,
        17938,
        [189, 15, 147, 1, 42, 135, 9, 157],
    );
pub const ID_DOCUMENTPACKAGETARGET_OPENXPS_WITH_3D: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        1675351840,
        35604,
        17783,
        [176, 116, 123, 177, 27, 89, 109, 40],
    );
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl IPrintDocumentPackageStatusEvent {
    ...
    pub unsafe fn PackageStatusUpdated(
        ...
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(packagestatus),
        )
        .ok()
    }
}
...
impl IPrintDocumentPackageTarget {
    pub unsafe fn GetPackageTargetTypes(
        &self,
        targetcount: *mut u32,
        targettypes: *mut *mut ::windows::runtime::GUID,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(targetcount),
            ::std::mem::transmute(targettypes),
        )
        .ok()
    }
    pub unsafe fn GetPackageTarget<T: ::windows::runtime::Interface>(
        &self,
        guidtargettype: *const ::windows::runtime::GUID,
    ) -> ::windows::runtime::Result<T> {
        let mut result__ = ::std::option::Option::None;
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(guidtargettype),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IPrintDocumentPackageTarget
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IPrintDocumentPackageTarget_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        guidtargettype: *const ::windows::runtime::GUID,
        riid: *const ::windows::runtime::GUID,
        ppvtarget: *mut *mut ::std::ffi::c_void,
    ) -> ::windows::runtime::HRESULT,
...
impl IPrintDocumentPackageTargetFactory {
    ...
    >(
        ...
        let mut result__: <IPrintDocumentPackageTarget as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            printername.into_param().abi(),
            jobname.into_param().abi(),
            joboutputstream.into_param().abi(),
            jobprintticketstream.into_param().abi(),
            &mut result__,
        )
        .from_abi::<IPrintDocumentPackageTarget>(result__)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IPrintDocumentPackageTargetFactory
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IPrintDocumentPackageTargetFactory_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        joboutputstream: ::windows::runtime::RawPtr,
...
impl IXpsPrintJob {
    ...
    pub unsafe fn GetJobStatus(&self) -> ::windows::runtime::Result<XPS_JOB_STATUS> {
        ...
        .from_abi::<XPS_JOB_STATUS>(result__)
    }
}
...
impl ::std::cmp::PartialEq for PrintDocumentPackageStatus {
    fn eq(&self, other: &Self) -> bool {
        self.JobId == other.JobId
            && self.CurrentDocument == other.CurrentDocument
            && self.CurrentPage == other.CurrentPage
            && self.CurrentPageTotal == other.CurrentPageTotal
            && self.Completion == other.Completion
            && self.PackageStatus == other.PackageStatus
    }
}
...
pub const PrintDocumentPackageTarget: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        1212311198,
        39239,
        18154,
        [139, 162, 216, 204, 228, 50, 194, 202],
    );
pub const PrintDocumentPackageTargetFactory: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        881783165,
        27777,
        18818,
...
pub unsafe fn StartXpsPrintJob<
    ...
    Param3: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::HANDLE>,
    Param4: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::HANDLE>,
>(
    printername: Param0,
    jobname: Param1,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn StartXpsPrintJob1(
                ...
                completionevent: super::super::super::Foundation::HANDLE,
                xpsprintjob: *mut ::windows::runtime::RawPtr,
                printcontentreceiver: *mut ::windows::runtime::RawPtr,
            ) -> ::windows::runtime::HRESULT;
        }
        StartXpsPrintJob1(
            printername.into_param().abi(),
            ...
            completionevent.into_param().abi(),
            ::std::mem::transmute(xpsprintjob),
            ::std::mem::transmute(printcontentreceiver),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
impl ::std::fmt::Debug for XPS_JOB_STATUS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("XPS_JOB_STATUS")
            .field("jobId", &self.jobId)
            .field("currentDocument", &self.currentDocument)
            .field("currentPage", &self.currentPage)
            .field("currentPageTotal", &self.currentPageTotal)
            .field("completion", &self.completion)
            .field("jobStatus", &self.jobStatus)
            .finish()
    }
}
impl ::std::cmp::PartialEq for XPS_JOB_STATUS {
    fn eq(&self, other: &Self) -> bool {
        self.jobId == other.jobId
            ...
            && self.currentPageTotal == other.currentPageTotal
            && self.completion == other.completion
            && self.jobStatus == other.jobStatus
    }
}
