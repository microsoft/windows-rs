...
pub const APPX_E_CORRUPT_CONTENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958842i32);
pub const APPX_E_DELTA_APPENDED_PACKAGE_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958832i32);
pub const APPX_E_DELTA_BASELINE_VERSION_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958835i32);
...
pub const APPX_E_INVALID_APPINSTALLER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958836i32);
pub const APPX_E_INVALID_BLOCKMAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958843i32);
pub const APPX_E_INVALID_CONTENTGROUPMAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958837i32);
pub const APPX_E_INVALID_DELTA_PACKAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958833i32);
pub const APPX_E_INVALID_ENCRYPTION_EXCLUSION_FILE_LIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958826i32);
pub const APPX_E_INVALID_KEY_INFO: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958838i32);
pub const APPX_E_INVALID_MANIFEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958844i32);
pub const APPX_E_INVALID_PACKAGESIGNCONFIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958830i32);
pub const APPX_E_INVALID_PACKAGE_FOLDER_ACLS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958825i32);
pub const APPX_E_INVALID_PACKAGING_LAYOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958831i32);
pub const APPX_E_INVALID_PAYLOAD_PACKAGE_EXTENSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958827i32);
pub const APPX_E_INVALID_PUBLISHER_BRIDGING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958824i32);
pub const APPX_E_INVALID_SIP_CLIENT_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958839i32);
pub const APPX_E_MISSING_REQUIRED_FILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958845i32);
pub const APPX_E_PACKAGING_INTERNAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958848i32);
pub const APPX_E_RELATIONSHIPS_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146958846i32);
...
pub const CACHE_E_NOCACHE_UPDATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221136i32);
pub const CACHE_S_FIRST: i32 = 262512i32;
pub const CACHE_S_FORMATETC_NOTSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(262512i32);
pub const CACHE_S_LAST: i32 = 262527i32;
pub const CACHE_S_SAMECACHE: ::windows::core::HRESULT = ::windows::core::HRESULT(262513i32);
pub const CACHE_S_SOMECACHES_NOTUPDATED: ::windows::core::HRESULT = ::windows::core::HRESULT(262514i32);
pub const CAT_E_CATIDNOEXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221152i32);
pub const CAT_E_FIRST: i32 = -2147221152i32;
pub const CAT_E_LAST: i32 = -2147221151i32;
pub const CAT_E_NODESCRIPTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221151i32);
pub const CERTSRV_E_ADMIN_DENIED_REQUEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877420i32);
pub const CERTSRV_E_ALIGNMENT_FAULT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877424i32);
pub const CERTSRV_E_ARCHIVED_KEY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875388i32);
pub const CERTSRV_E_ARCHIVED_KEY_UNEXPECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875376i32);
pub const CERTSRV_E_BAD_RENEWAL_CERT_ATTRIBUTE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877426i32);
pub const CERTSRV_E_BAD_RENEWAL_SUBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875386i32);
pub const CERTSRV_E_BAD_REQUESTSTATUS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877437i32);
pub const CERTSRV_E_BAD_REQUESTSUBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877439i32);
pub const CERTSRV_E_BAD_REQUEST_KEY_ARCHIVAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877428i32);
pub const CERTSRV_E_BAD_TEMPLATE_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875385i32);
pub const CERTSRV_E_CERT_TYPE_OVERLAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875372i32);
pub const CERTSRV_E_CORRUPT_KEY_ATTESTATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875365i32);
pub const CERTSRV_E_DOWNLEVEL_DC_SSL_OR_UPGRADE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877421i32);
pub const CERTSRV_E_ENCODING_LENGTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877433i32);
pub const CERTSRV_E_ENCRYPTION_CERT_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877416i32);
pub const CERTSRV_E_ENROLL_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877423i32);
pub const CERTSRV_E_EXPIRED_CHALLENGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875364i32);
pub const CERTSRV_E_INVALID_ATTESTATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875367i32);
pub const CERTSRV_E_INVALID_CA_CERTIFICATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877435i32);
pub const CERTSRV_E_INVALID_EK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875369i32);
pub const CERTSRV_E_INVALID_IDBINDING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875368i32);
pub const CERTSRV_E_INVALID_REQUESTID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875362i32);
pub const CERTSRV_E_INVALID_RESPONSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875363i32);
pub const CERTSRV_E_ISSUANCE_POLICY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875380i32);
pub const CERTSRV_E_KEY_ARCHIVAL_NOT_CONFIGURED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877430i32);
pub const CERTSRV_E_KEY_ATTESTATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875366i32);
pub const CERTSRV_E_KEY_ATTESTATION_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877417i32);
pub const CERTSRV_E_KEY_LENGTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875375i32);
pub const CERTSRV_E_NO_CAADMIN_DEFINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877427i32);
pub const CERTSRV_E_NO_CERT_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875391i32);
pub const CERTSRV_E_NO_DB_SESSIONS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877425i32);
pub const CERTSRV_E_NO_POLICY_SERVER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877419i32);
pub const CERTSRV_E_NO_REQUEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877438i32);
pub const CERTSRV_E_NO_VALID_KRA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877429i32);
pub const CERTSRV_E_PENDING_CLIENT_RESPONSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875360i32);
pub const CERTSRV_E_PROPERTY_EMPTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877436i32);
pub const CERTSRV_E_RENEWAL_BAD_PUBLIC_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875370i32);
pub const CERTSRV_E_REQUEST_PRECERTIFICATE_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875361i32);
...
pub const CERTSRV_E_SIGNATURE_COUNT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875382i32);
pub const CERTSRV_E_SIGNATURE_POLICY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875383i32);
pub const CERTSRV_E_SIGNATURE_REJECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875381i32);
pub const CERTSRV_E_SMIME_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875387i32);
pub const CERTSRV_E_SUBJECT_ALT_NAME_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875389i32);
pub const CERTSRV_E_SUBJECT_DIRECTORY_GUID_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875378i32);
pub const CERTSRV_E_SUBJECT_DNS_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875377i32);
pub const CERTSRV_E_SUBJECT_EMAIL_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875374i32);
pub const CERTSRV_E_SUBJECT_UPN_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875379i32);
pub const CERTSRV_E_TEMPLATE_CONFLICT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875390i32);
pub const CERTSRV_E_TEMPLATE_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877422i32);
pub const CERTSRV_E_TEMPLATE_POLICY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875384i32);
pub const CERTSRV_E_TOO_MANY_SIGNATURES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875371i32);
pub const CERTSRV_E_UNKNOWN_CERT_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875373i32);
pub const CERTSRV_E_UNSUPPORTED_CERT_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146875392i32);
pub const CERTSRV_E_WEAK_SIGNATURE_OR_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146877418i32);
pub const CERT_E_CHAINING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762486i32);
pub const CERT_E_CN_NO_MATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762481i32);
pub const CERT_E_CRITICAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762491i32);
pub const CERT_E_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762495i32);
pub const CERT_E_INVALID_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762476i32);
pub const CERT_E_INVALID_POLICY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762477i32);
pub const CERT_E_ISSUERCHAINING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762489i32);
pub const CERT_E_MALFORMED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762488i32);
pub const CERT_E_PATHLENCONST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762492i32);
pub const CERT_E_PURPOSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762490i32);
pub const CERT_E_REVOCATION_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762482i32);
pub const CERT_E_REVOKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762484i32);
pub const CERT_E_ROLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762493i32);
pub const CERT_E_UNTRUSTEDCA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762478i32);
pub const CERT_E_UNTRUSTEDROOT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762487i32);
pub const CERT_E_UNTRUSTEDTESTROOT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762483i32);
...
pub const CI_CORRUPT_DATABASE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473536i32);
pub const CI_CORRUPT_FILTER_BUFFER: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473529i32);
pub const CI_E_ALREADY_INITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215350i32);
pub const CI_E_BUFFERTOOSMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215348i32);
pub const CI_E_CARDINALITY_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215321i32);
pub const CI_E_CLIENT_FILTER_ABORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473500i32);
pub const CI_E_CONFIG_DISK_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215320i32);
pub const CI_E_DISK_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215343i32);
pub const CI_E_DISTRIBUTED_GROUPBY_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215319i32);
pub const CI_E_DUPLICATE_NOTIFICATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215337i32);
pub const CI_E_ENUMERATION_STARTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473502i32);
pub const CI_E_FILTERING_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215344i32);
pub const CI_E_INVALID_FLAGS_COMBINATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215335i32);
pub const CI_E_INVALID_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215345i32);
pub const CI_E_LOGON_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215332i32);
pub const CI_E_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215339i32);
pub const CI_E_NOT_INITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215349i32);
pub const CI_E_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215328i32);
pub const CI_E_NO_CATALOG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215331i32);
pub const CI_E_OUTOFSEQ_INCREMENT_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215334i32);
pub const CI_E_PROPERTY_NOT_CACHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215347i32);
pub const CI_E_PROPERTY_TOOLARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473501i32);
pub const CI_E_SHARING_VIOLATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215333i32);
pub const CI_E_SHUTDOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215342i32);
pub const CI_E_STRANGE_PAGEORSECTOR_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215330i32);
pub const CI_E_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215329i32);
pub const CI_E_UPDATES_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215336i32);
pub const CI_E_USE_DEFAULT_PID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215338i32);
pub const CI_E_WORKID_NOTVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215341i32);
pub const CI_INCORRECT_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473503i32);
pub const CI_INVALID_INDEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473528i32);
pub const CI_INVALID_PARTITION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473534i32);
pub const CI_INVALID_PRIORITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473533i32);
pub const CI_NO_CATALOG: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473530i32);
pub const CI_NO_STARTING_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473532i32);
pub const CI_OUT_OF_INDEX_IDS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473531i32);
pub const CI_PROPSTORE_INCONSISTENCY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473527i32);
pub const CI_S_CAT_STOPPED: ::windows::core::HRESULT = ::windows::core::HRESULT(268326i32);
pub const CI_S_END_OF_ENUMERATION: ::windows::core::HRESULT = ::windows::core::HRESULT(268308i32);
pub const CI_S_NO_DOCSTORE: ::windows::core::HRESULT = ::windows::core::HRESULT(268325i32);
pub const CI_S_WORKID_DELETED: ::windows::core::HRESULT = ::windows::core::HRESULT(268302i32);
...
pub const CLASS_E_NOAGGREGATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221232i32);
pub const CLASS_E_NOTLICENSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221230i32);
...
pub const CLIPBRD_E_BAD_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221037i32);
pub const CLIPBRD_E_CANT_CLOSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221036i32);
pub const CLIPBRD_E_CANT_EMPTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221039i32);
pub const CLIPBRD_E_CANT_OPEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221040i32);
pub const CLIPBRD_E_CANT_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221038i32);
...
pub const COMADMIN_E_AMBIGUOUS_APPLICATION_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368420i32);
pub const COMADMIN_E_AMBIGUOUS_PARTITION_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368419i32);
pub const COMADMIN_E_APPDIRNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368481i32);
pub const COMADMIN_E_APPLICATIONEXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368501i32);
pub const COMADMIN_E_APPLID_MATCHES_CLSID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368442i32);
pub const COMADMIN_E_APP_FILE_READFAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368504i32);
pub const COMADMIN_E_APP_FILE_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368503i32);
pub const COMADMIN_E_APP_FILE_WRITEFAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368505i32);
pub const COMADMIN_E_APP_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367478i32);
pub const COMADMIN_E_AUTHENTICATIONLEVEL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368493i32);
pub const COMADMIN_E_BADPATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368502i32);
pub const COMADMIN_E_BADREGISTRYLIBID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368482i32);
pub const COMADMIN_E_BADREGISTRYPROGID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368494i32);
pub const COMADMIN_E_BASEPARTITION_REQUIRED_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367457i32);
pub const COMADMIN_E_BASE_PARTITION_ONLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368432i32);
pub const COMADMIN_E_CANNOT_ALIAS_EVENTCLASS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367456i32);
pub const COMADMIN_E_CANTCOPYFILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368499i32);
pub const COMADMIN_E_CANTMAKEINPROCSERVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367468i32);
pub const COMADMIN_E_CANTRECYCLELIBRARYAPPS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367473i32);
pub const COMADMIN_E_CANTRECYCLESERVICEAPPS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367471i32);
pub const COMADMIN_E_CANT_SUBSCRIBE_TO_COMPONENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368435i32);
pub const COMADMIN_E_CAN_NOT_EXPORT_APP_PROXY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368438i32);
pub const COMADMIN_E_CAN_NOT_EXPORT_SYS_APP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368436i32);
pub const COMADMIN_E_CAN_NOT_START_APP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368437i32);
pub const COMADMIN_E_CAT_BITNESSMISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368382i32);
pub const COMADMIN_E_CAT_DUPLICATE_PARTITION_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368425i32);
pub const COMADMIN_E_CAT_IMPORTED_COMPONENTS_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368421i32);
pub const COMADMIN_E_CAT_INVALID_PARTITION_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368424i32);
pub const COMADMIN_E_CAT_PARTITION_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368423i32);
pub const COMADMIN_E_CAT_PAUSE_RESUME_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368379i32);
pub const COMADMIN_E_CAT_SERVERFAULT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368378i32);
pub const COMADMIN_E_CAT_UNACCEPTABLEBITNESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368381i32);
pub const COMADMIN_E_CAT_WRONGAPPBITNESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368380i32);
pub const COMADMIN_E_CLSIDORIIDMISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368488i32);
pub const COMADMIN_E_COMPFILE_BADTLB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368472i32);
pub const COMADMIN_E_COMPFILE_CLASSNOTAVAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368473i32);
pub const COMADMIN_E_COMPFILE_DOESNOTEXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368476i32);
pub const COMADMIN_E_COMPFILE_GETCLASSOBJ: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368474i32);
pub const COMADMIN_E_COMPFILE_LOADDLLFAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368475i32);
pub const COMADMIN_E_COMPFILE_NOREGISTRAR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368460i32);
pub const COMADMIN_E_COMPFILE_NOTINSTALLABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368471i32);
pub const COMADMIN_E_COMPONENTEXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368455i32);
pub const COMADMIN_E_COMP_MOVE_BAD_DEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368466i32);
pub const COMADMIN_E_COMP_MOVE_DEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367459i32);
pub const COMADMIN_E_COMP_MOVE_LOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368467i32);
pub const COMADMIN_E_COMP_MOVE_PRIVATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367458i32);
pub const COMADMIN_E_COMP_MOVE_SOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367460i32);
pub const COMADMIN_E_COREQCOMPINSTALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368459i32);
pub const COMADMIN_E_DEFAULT_PARTITION_NOT_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367466i32);
pub const COMADMIN_E_DLLLOADFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368483i32);
pub const COMADMIN_E_DLLREGISTERSERVER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368486i32);
pub const COMADMIN_E_EVENTCLASS_CANT_BE_SUBSCRIBER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368434i32);
pub const COMADMIN_E_FILE_PARTITION_DUPLICATE_FILES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368422i32);
pub const COMADMIN_E_INVALIDUSERIDS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368496i32);
pub const COMADMIN_E_INVALID_PARTITION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367477i32);
pub const COMADMIN_E_KEYMISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368509i32);
pub const COMADMIN_E_LEGACYCOMPS_NOT_ALLOWED_IN_1_0_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367462i32);
pub const COMADMIN_E_LEGACYCOMPS_NOT_ALLOWED_IN_NONBASE_PARTITIONS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367461i32);
pub const COMADMIN_E_LIB_APP_PROXY_INCOMPATIBLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368433i32);
pub const COMADMIN_E_MIG_SCHEMANOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368383i32);
pub const COMADMIN_E_MIG_VERSIONNOTSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368384i32);
pub const COMADMIN_E_NOREGISTRYCLSID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368495i32);
pub const COMADMIN_E_NOSERVERSHARE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368485i32);
pub const COMADMIN_E_NOTCHANGEABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368470i32);
pub const COMADMIN_E_NOTDELETEABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368469i32);
pub const COMADMIN_E_NOTINREGISTRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368450i32);
pub const COMADMIN_E_NOUSER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368497i32);
pub const COMADMIN_E_OBJECTERRORS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368511i32);
pub const COMADMIN_E_OBJECTEXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368456i32);
pub const COMADMIN_E_OBJECTINVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368510i32);
pub const COMADMIN_E_OBJECTNOTPOOLABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368449i32);
pub const COMADMIN_E_OBJECT_DOES_NOT_EXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367479i32);
pub const COMADMIN_E_OBJECT_PARENT_MISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367480i32);
pub const COMADMIN_E_PARTITIONS_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367452i32);
pub const COMADMIN_E_PARTITION_ACCESSDENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367464i32);
pub const COMADMIN_E_PARTITION_MSI_ONLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367463i32);
pub const COMADMIN_E_PAUSEDPROCESSMAYNOTBERECYCLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367469i32);
pub const COMADMIN_E_PRIVATE_ACCESSDENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367455i32);
pub const COMADMIN_E_PROCESSALREADYRECYCLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367470i32);
pub const COMADMIN_E_PROGIDINUSEBYCLSID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367467i32);
pub const COMADMIN_E_PROPERTYSAVEFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368457i32);
pub const COMADMIN_E_PROPERTY_OVERFLOW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368452i32);
pub const COMADMIN_E_RECYCLEDPROCESSMAYNOTBEPAUSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367465i32);
pub const COMADMIN_E_REGDB_ALREADYRUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368395i32);
pub const COMADMIN_E_REGDB_NOTINITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368398i32);
pub const COMADMIN_E_REGDB_NOTOPEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368397i32);
pub const COMADMIN_E_REGDB_SYSTEMERR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368396i32);
pub const COMADMIN_E_REGFILE_CORRUPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368453i32);
pub const COMADMIN_E_REGISTERTLB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368464i32);
pub const COMADMIN_E_REGISTRARFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368477i32);
pub const COMADMIN_E_REGISTRY_ACCESSDENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367453i32);
pub const COMADMIN_E_REMOTEINTERFACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368487i32);
pub const COMADMIN_E_REQUIRES_DIFFERENT_PLATFORM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368439i32);
pub const COMADMIN_E_ROLEEXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368500i32);
pub const COMADMIN_E_ROLE_DOES_NOT_EXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368441i32);
pub const COMADMIN_E_SAFERINVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367454i32);
pub const COMADMIN_E_SERVICENOTINSTALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368458i32);
pub const COMADMIN_E_SESSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368468i32);
pub const COMADMIN_E_START_APP_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368431i32);
pub const COMADMIN_E_START_APP_NEEDS_COMPONENTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368440i32);
pub const COMADMIN_E_SVCAPP_NOT_POOLABLE_OR_RECYCLABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367475i32);
pub const COMADMIN_E_SYSTEMAPP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368461i32);
pub const COMADMIN_E_USERPASSWDNOTVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368492i32);
pub const COMADMIN_E_USER_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367474i32);
pub const COMQC_E_APPLICATION_NOT_QUEUED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146368000i32);
pub const COMQC_E_BAD_MESSAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367996i32);
pub const COMQC_E_NO_IPERSISTSTREAM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367997i32);
pub const COMQC_E_NO_QUEUEABLE_INTERFACES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367999i32);
pub const COMQC_E_QUEUING_SERVICE_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367998i32);
pub const COMQC_E_UNAUTHENTICATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367995i32);
pub const COMQC_E_UNTRUSTED_ENQUEUER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367994i32);
pub const CONTEXT_E_ABORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164158i32);
pub const CONTEXT_E_ABORTING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164157i32);
pub const CONTEXT_E_FIRST: i32 = -2147164160i32;
pub const CONTEXT_E_LAST: i32 = -2147164113i32;
pub const CONTEXT_E_NOCONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164156i32);
pub const CONTEXT_E_NOJIT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164122i32);
pub const CONTEXT_E_NOTRANSACTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164121i32);
pub const CONTEXT_E_OLDREF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164153i32);
pub const CONTEXT_E_ROLENOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164148i32);
pub const CONTEXT_E_SYNCH_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164154i32);
pub const CONTEXT_E_TMNOTAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164145i32);
pub const CONTEXT_E_WOULD_DEADLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164155i32);
...
pub const CONVERT10_E_OLESTREAM_BITMAP_TO_DIB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221053i32);
pub const CONVERT10_E_OLESTREAM_FMT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221054i32);
pub const CONVERT10_E_OLESTREAM_GET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221056i32);
pub const CONVERT10_E_OLESTREAM_PUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221055i32);
pub const CONVERT10_E_STG_DIB_TO_BITMAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221050i32);
pub const CONVERT10_E_STG_FMT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221052i32);
pub const CONVERT10_E_STG_NO_STD_STREAM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221051i32);
pub const CONVERT10_S_FIRST: i32 = 262592i32;
pub const CONVERT10_S_LAST: i32 = 262607i32;
pub const CONVERT10_S_NO_PRESENTATION: ::windows::core::HRESULT = ::windows::core::HRESULT(262592i32);
pub const CO_E_ACCESSCHECKFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417814i32);
pub const CO_E_ACESINWRONGORDER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417798i32);
pub const CO_E_ACNOTINITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417793i32);
pub const CO_E_ACTIVATIONFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164127i32);
pub const CO_E_ACTIVATIONFAILED_CATALOGERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164125i32);
pub const CO_E_ACTIVATIONFAILED_EVENTLOGGED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164126i32);
pub const CO_E_ACTIVATIONFAILED_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164124i32);
pub const CO_E_ALREADYINITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221007i32);
pub const CO_E_APPDIDNTREG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220994i32);
pub const CO_E_APPNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221003i32);
pub const CO_E_APPSINGLEUSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221002i32);
pub const CO_E_ASYNC_WORK_REJECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467223i32);
pub const CO_E_ATTEMPT_TO_CREATE_OUTSIDE_CLIENT_CONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467228i32);
pub const CO_E_BAD_PATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959356i32);
pub const CO_E_BAD_SERVER_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467244i32);
pub const CO_E_CALL_OUT_OF_TX_SCOPE_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164112i32);
pub const CO_E_CANCEL_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417792i32);
pub const CO_E_CANTDETERMINECLASS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221006i32);
pub const CO_E_CANT_REMOTE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467245i32);
pub const CO_E_CLASSSTRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221005i32);
pub const CO_E_CLASS_CREATE_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959359i32);
pub const CO_E_CLASS_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467225i32);
pub const CO_E_CLRNOTAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467224i32);
pub const CO_E_CLSREG_INCONSISTENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467233i32);
pub const CO_E_CONVERSIONFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417810i32);
pub const CO_E_CREATEPROCESS_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467240i32);
pub const CO_E_DBERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164117i32);
pub const CO_E_DECODEFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417795i32);
pub const CO_E_DLLNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221000i32);
pub const CO_E_ELEVATION_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959337i32);
pub const CO_E_ERRORINAPP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221001i32);
pub const CO_E_ERRORINDLL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220999i32);
pub const CO_E_EXCEEDSYSACLLIMIT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417799i32);
pub const CO_E_EXIT_TRANSACTION_SCOPE_NOT_CALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164111i32);
pub const CO_E_FAILEDTOCLOSEHANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417800i32);
pub const CO_E_FAILEDTOCREATEFILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417801i32);
pub const CO_E_FAILEDTOGENUUID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417802i32);
pub const CO_E_FAILEDTOGETSECCTX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417820i32);
pub const CO_E_FAILEDTOGETTOKENINFO: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417818i32);
pub const CO_E_FAILEDTOGETWINDIR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417804i32);
pub const CO_E_FAILEDTOIMPERSONATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417821i32);
pub const CO_E_FAILEDTOOPENPROCESSTOKEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417796i32);
pub const CO_E_FAILEDTOOPENTHREADTOKEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417819i32);
pub const CO_E_FAILEDTOQUERYCLIENTBLANKET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417816i32);
pub const CO_E_FAILEDTOSETDACL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417815i32);
pub const CO_E_FIRST: i32 = -2147221008i32;
pub const CO_E_IIDREG_INCONSISTENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467232i32);
pub const CO_E_IIDSTRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221004i32);
pub const CO_E_INCOMPATIBLESTREAMVERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417797i32);
pub const CO_E_INITIALIZATIONFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164123i32);
pub const CO_E_INIT_CLASS_CACHE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467255i32);
pub const CO_E_INIT_MEMORY_ALLOCATOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467256i32);
pub const CO_E_INIT_ONLY_SINGLE_THREADED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467246i32);
pub const CO_E_INIT_RPC_CHANNEL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467254i32);
pub const CO_E_INIT_SCM_EXEC_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467247i32);
pub const CO_E_INIT_SCM_FILE_MAPPING_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467249i32);
pub const CO_E_INIT_SCM_MAP_VIEW_OF_FILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467248i32);
pub const CO_E_INIT_SCM_MUTEX_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467250i32);
pub const CO_E_INIT_SHARED_ALLOCATOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467257i32);
pub const CO_E_INIT_TLS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467258i32);
pub const CO_E_INIT_TLS_CHANNEL_CONTROL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467252i32);
pub const CO_E_INIT_TLS_SET_CHANNEL_CONTROL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467253i32);
pub const CO_E_INIT_UNACCEPTED_USER_ALLOCATOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467251i32);
pub const CO_E_INVALIDSID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417811i32);
pub const CO_E_ISOLEVELMISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164113i32);
pub const CO_E_LAST: i32 = -2147220993i32;
pub const CO_E_LAUNCH_PERMSSION_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467237i32);
pub const CO_E_LOOKUPACCNAMEFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417806i32);
pub const CO_E_LOOKUPACCSIDFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417808i32);
pub const CO_E_MALFORMED_SPN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467213i32);
pub const CO_E_MISSING_DISPLAYNAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959339i32);
pub const CO_E_MSI_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467229i32);
pub const CO_E_NETACCESSAPIFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417813i32);
pub const CO_E_NOCOOKIES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164118i32);
pub const CO_E_NOIISINTRINSICS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164119i32);
pub const CO_E_NOMATCHINGNAMEFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417807i32);
pub const CO_E_NOMATCHINGSIDFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417809i32);
pub const CO_E_NOSYNCHRONIZATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164114i32);
pub const CO_E_NOTCONSTRUCTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164115i32);
pub const CO_E_NOTINITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221008i32);
pub const CO_E_NOTPOOLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164116i32);
pub const CO_E_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467231i32);
pub const CO_E_NO_SECCTX_IN_ACTIVATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467221i32);
pub const CO_E_OBJISREG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220996i32);
pub const CO_E_OBJNOTCONNECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220995i32);
pub const CO_E_OBJNOTREG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220997i32);
pub const CO_E_OBJSRV_RPC_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959354i32);
pub const CO_E_OLE1DDE_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467242i32);
pub const CO_E_PATHTOOLONG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417803i32);
pub const CO_E_PREMATURE_STUB_RUNDOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467211i32);
pub const CO_E_RELEASED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220993i32);
pub const CO_E_RELOAD_DLL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467230i32);
pub const CO_E_REMOTE_COMMUNICATION_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467235i32);
pub const CO_E_RUNAS_CREATEPROCESS_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467239i32);
pub const CO_E_RUNAS_LOGON_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467238i32);
pub const CO_E_RUNAS_SYNTAX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467241i32);
pub const CO_E_RUNAS_VALUE_MUST_BE_AAA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959338i32);
pub const CO_E_SCM_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959358i32);
pub const CO_E_SCM_RPC_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959357i32);
pub const CO_E_SERVER_EXEC_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959355i32);
pub const CO_E_SERVER_INIT_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467222i32);
pub const CO_E_SERVER_NOT_PAUSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467226i32);
pub const CO_E_SERVER_PAUSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467227i32);
pub const CO_E_SERVER_START_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467234i32);
pub const CO_E_SERVER_STOPPING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959352i32);
pub const CO_E_SETSERLHNDLFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417805i32);
pub const CO_E_START_SERVICE_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467236i32);
pub const CO_E_SXS_CONFIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467214i32);
pub const CO_E_THREADINGMODEL_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147164120i32);
pub const CO_E_THREADPOOL_CONFIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467215i32);
pub const CO_E_TRACKER_CONFIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467216i32);
pub const CO_E_TRUSTEEDOESNTMATCHCLIENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417817i32);
pub const CO_E_UNREVOKED_REGISTRATION_ON_APARTMENT_SHUTDOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467212i32);
pub const CO_E_WRONGOSFORAPP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220998i32);
pub const CO_E_WRONGTRUSTEENAMESYNTAX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417812i32);
pub const CO_E_WRONG_SERVER_IDENTITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467243i32);
pub const CO_S_FIRST: i32 = 262640i32;
pub const CO_S_LAST: i32 = 262655i32;
pub const CO_S_MACHINENAMENOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(524307i32);
pub const CO_S_NOTALLINTERFACES: ::windows::core::HRESULT = ::windows::core::HRESULT(524306i32);
pub const CRYPT_E_ALREADY_DECRYPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889719i32);
pub const CRYPT_E_ASN1_BADARGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881271i32);
pub const CRYPT_E_ASN1_BADPDU: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881272i32);
pub const CRYPT_E_ASN1_BADREAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881270i32);
pub const CRYPT_E_ASN1_BADTAG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881269i32);
pub const CRYPT_E_ASN1_CHOICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881268i32);
pub const CRYPT_E_ASN1_CONSTRAINT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881275i32);
pub const CRYPT_E_ASN1_CORRUPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881277i32);
pub const CRYPT_E_ASN1_EOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881278i32);
pub const CRYPT_E_ASN1_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881280i32);
pub const CRYPT_E_ASN1_EXTENDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881023i32);
pub const CRYPT_E_ASN1_INTERNAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881279i32);
pub const CRYPT_E_ASN1_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881276i32);
pub const CRYPT_E_ASN1_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881274i32);
pub const CRYPT_E_ASN1_NOEOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881022i32);
pub const CRYPT_E_ASN1_NYI: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881228i32);
pub const CRYPT_E_ASN1_OVERFLOW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881273i32);
pub const CRYPT_E_ASN1_PDU_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881229i32);
pub const CRYPT_E_ASN1_RULE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881267i32);
pub const CRYPT_E_ASN1_UTF8: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881266i32);
pub const CRYPT_E_ATTRIBUTES_MISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889713i32);
pub const CRYPT_E_AUTH_ATTR_MISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889722i32);
pub const CRYPT_E_BAD_ENCODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885630i32);
pub const CRYPT_E_BAD_LEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885631i32);
pub const CRYPT_E_BAD_MSG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885619i32);
pub const CRYPT_E_CONTROL_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889716i32);
pub const CRYPT_E_DELETED_PREV: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885624i32);
pub const CRYPT_E_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885627i32);
pub const CRYPT_E_FILERESIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885595i32);
pub const CRYPT_E_FILE_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885629i32);
pub const CRYPT_E_HASH_VALUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889721i32);
pub const CRYPT_E_INVALID_IA5_STRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885598i32);
pub const CRYPT_E_INVALID_INDEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889720i32);
pub const CRYPT_E_INVALID_MSG_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889724i32);
pub const CRYPT_E_INVALID_NUMERIC_STRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885600i32);
pub const CRYPT_E_INVALID_PRINTABLE_STRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885599i32);
pub const CRYPT_E_INVALID_X500_STRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885597i32);
pub const CRYPT_E_ISSUER_SERIALNUMBER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889715i32);
pub const CRYPT_E_MISSING_PUBKEY_PARA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885588i32);
pub const CRYPT_E_MSG_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889727i32);
pub const CRYPT_E_NOT_CHAR_STRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885596i32);
pub const CRYPT_E_NOT_DECRYPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889718i32);
pub const CRYPT_E_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885628i32);
pub const CRYPT_E_NOT_IN_CTL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885590i32);
pub const CRYPT_E_NOT_IN_REVOCATION_DATABASE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885612i32);
pub const CRYPT_E_NO_DECRYPT_CERT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885620i32);
pub const CRYPT_E_NO_KEY_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885621i32);
pub const CRYPT_E_NO_MATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885623i32);
pub const CRYPT_E_NO_PROVIDER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885626i32);
pub const CRYPT_E_NO_REVOCATION_CHECK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885614i32);
pub const CRYPT_E_NO_REVOCATION_DLL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885615i32);
pub const CRYPT_E_NO_SIGNER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885618i32);
pub const CRYPT_E_NO_TRUSTED_SIGNER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885589i32);
pub const CRYPT_E_NO_VERIFY_USAGE_CHECK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885592i32);
pub const CRYPT_E_NO_VERIFY_USAGE_DLL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885593i32);
pub const CRYPT_E_OBJECT_LOCATOR_OBJECT_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885587i32);
pub const CRYPT_E_OID_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889725i32);
pub const CRYPT_E_OSS_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881536i32);
pub const CRYPT_E_PENDING_CLOSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885617i32);
pub const CRYPT_E_RECIPIENT_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889717i32);
pub const CRYPT_E_REVOCATION_OFFLINE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885613i32);
pub const CRYPT_E_REVOKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885616i32);
pub const CRYPT_E_SECURITY_SETTINGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885594i32);
pub const CRYPT_E_SELF_SIGNED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885625i32);
pub const CRYPT_E_SIGNER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889714i32);
pub const CRYPT_E_STREAM_INSUFFICIENT_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889711i32);
pub const CRYPT_E_STREAM_MSG_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889712i32);
pub const CRYPT_E_UNEXPECTED_ENCODING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889723i32);
pub const CRYPT_E_UNEXPECTED_MSG_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885622i32);
pub const CRYPT_E_UNKNOWN_ALGO: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146889726i32);
pub const CRYPT_E_VERIFY_USAGE_OFFLINE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146885591i32);
pub const CRYPT_I_NEW_PROTECTION_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(593938i32);
pub const CS_E_ADMIN_LIMIT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221139i32);
pub const CS_E_CLASS_NOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221146i32);
pub const CS_E_FIRST: i32 = -2147221148i32;
pub const CS_E_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221137i32);
pub const CS_E_INVALID_PATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221141i32);
pub const CS_E_INVALID_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221145i32);
pub const CS_E_LAST: i32 = -2147221137i32;
pub const CS_E_NETWORK_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221140i32);
pub const CS_E_NOT_DELETABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221147i32);
pub const CS_E_NO_CLASSSTORE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221144i32);
pub const CS_E_OBJECT_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221142i32);
pub const CS_E_OBJECT_NOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221143i32);
pub const CS_E_PACKAGE_NOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221148i32);
...
pub const D2DERR_BITMAP_CANNOT_DRAW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238879i32);
pub const D2DERR_CYCLIC_GRAPH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238880i32);
pub const D2DERR_DISPLAY_FORMAT_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238903i32);
pub const D2DERR_DISPLAY_STATE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238906i32);
pub const D2DERR_EFFECT_IS_NOT_REGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238872i32);
pub const D2DERR_EXCEEDS_MAX_BITMAP_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238883i32);
pub const D2DERR_INCOMPATIBLE_BRUSH_TYPES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238888i32);
pub const D2DERR_INSUFFICIENT_DEVICE_CAPABILITIES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238874i32);
pub const D2DERR_INTERMEDIATE_TOO_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238873i32);
pub const D2DERR_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238904i32);
pub const D2DERR_INVALID_CALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238902i32);
pub const D2DERR_INVALID_GLYPH_IMAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238866i32);
pub const D2DERR_INVALID_GRAPH_CONFIGURATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238882i32);
pub const D2DERR_INVALID_INTERNAL_GRAPH_CONFIGURATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238881i32);
pub const D2DERR_INVALID_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238871i32);
pub const D2DERR_INVALID_TARGET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238876i32);
pub const D2DERR_LAYER_ALREADY_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238893i32);
pub const D2DERR_MAX_TEXTURE_SIZE_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238897i32);
pub const D2DERR_NOT_INITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238910i32);
pub const D2DERR_NO_HARDWARE_DEVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238901i32);
pub const D2DERR_NO_SUBPROPERTIES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238870i32);
pub const D2DERR_ORIGINAL_TARGET_NOT_BOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238877i32);
pub const D2DERR_OUTSTANDING_BITMAP_REFERENCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238878i32);
pub const D2DERR_POP_CALL_DID_NOT_MATCH_PUSH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238892i32);
pub const D2DERR_PRINT_FORMAT_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238868i32);
pub const D2DERR_PRINT_JOB_CLOSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238869i32);
pub const D2DERR_PUSH_POP_UNBALANCED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238890i32);
pub const D2DERR_RECREATE_TARGET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238900i32);
pub const D2DERR_RENDER_TARGET_HAS_LAYER_OR_CLIPRECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238889i32);
pub const D2DERR_SCANNER_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238908i32);
pub const D2DERR_SCREEN_ACCESS_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238907i32);
pub const D2DERR_SHADER_COMPILE_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238898i32);
pub const D2DERR_TARGET_NOT_GDI_COMPATIBLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238886i32);
pub const D2DERR_TEXT_EFFECT_IS_WRONG_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238885i32);
pub const D2DERR_TEXT_RENDERER_NOT_RELEASED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238884i32);
pub const D2DERR_TOO_MANY_SHADER_ELEMENTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238899i32);
pub const D2DERR_TOO_MANY_TRANSFORM_INPUTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238867i32);
pub const D2DERR_UNSUPPORTED_OPERATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238909i32);
pub const D2DERR_UNSUPPORTED_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238896i32);
pub const D2DERR_WIN32_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238887i32);
pub const D2DERR_WRONG_FACTORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238894i32);
pub const D2DERR_WRONG_RESOURCE_DOMAIN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238891i32);
pub const D2DERR_WRONG_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238911i32);
pub const D2DERR_ZERO_VECTOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003238905i32);
pub const D3D10_ERROR_FILE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005336062i32);
pub const D3D10_ERROR_TOO_MANY_UNIQUE_STATE_OBJECTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005336063i32);
pub const D3D11_ERROR_DEFERRED_CONTEXT_MAP_WITHOUT_INITIAL_DISCARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005139452i32);
pub const D3D11_ERROR_FILE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005139454i32);
pub const D3D11_ERROR_TOO_MANY_UNIQUE_STATE_OBJECTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005139455i32);
pub const D3D11_ERROR_TOO_MANY_UNIQUE_VIEW_OBJECTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005139453i32);
pub const D3D12_ERROR_ADAPTER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005008383i32);
pub const D3D12_ERROR_DRIVER_VERSION_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005008382i32);
pub const D3D12_ERROR_INVALID_REDIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005008381i32);
...
pub const DATA_S_SAMEFORMATETC: ::windows::core::HRESULT = ::windows::core::HRESULT(262448i32);
...
pub const DCOMPOSITION_ERROR_SURFACE_BEING_RENDERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302399i32);
...
pub const DIGSIG_E_DECODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762746i32);
pub const DIGSIG_E_ENCODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762747i32);
pub const DIGSIG_E_EXTENSIBILITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762745i32);
pub const DISP_E_ARRAYISLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352563i32);
pub const DISP_E_BADCALLEE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352560i32);
pub const DISP_E_BADINDEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352565i32);
pub const DISP_E_BADPARAMCOUNT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352562i32);
pub const DISP_E_BADVARTYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352568i32);
pub const DISP_E_BUFFERTOOSMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352557i32);
pub const DISP_E_DIVBYZERO: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352558i32);
pub const DISP_E_EXCEPTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352567i32);
pub const DISP_E_MEMBERNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352573i32);
pub const DISP_E_NONAMEDARGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352569i32);
pub const DISP_E_NOTACOLLECTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352559i32);
pub const DISP_E_OVERFLOW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352566i32);
pub const DISP_E_PARAMNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352572i32);
pub const DISP_E_PARAMNOTOPTIONAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352561i32);
pub const DISP_E_TYPEMISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352571i32);
pub const DISP_E_UNKNOWNINTERFACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352575i32);
pub const DISP_E_UNKNOWNLCID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352564i32);
pub const DISP_E_UNKNOWNNAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352570i32);
...
pub const DRAGDROP_E_ALREADYREGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221247i32);
pub const DRAGDROP_E_CONCURRENT_DRAG_ATTEMPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221245i32);
pub const DRAGDROP_E_FIRST: i32 = -2147221248i32;
pub const DRAGDROP_E_INVALIDHWND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221246i32);
pub const DRAGDROP_E_LAST: i32 = -2147221233i32;
pub const DRAGDROP_E_NOTREGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221248i32);
pub const DRAGDROP_S_CANCEL: ::windows::core::HRESULT = ::windows::core::HRESULT(262401i32);
pub const DRAGDROP_S_DROP: ::windows::core::HRESULT = ::windows::core::HRESULT(262400i32);
...
pub const DV_E_DVTARGETDEVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221403i32);
pub const DV_E_DVTARGETDEVICE_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221396i32);
pub const DV_E_FORMATETC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221404i32);
pub const DV_E_LINDEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221400i32);
pub const DV_E_NOIVIEWOBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221395i32);
pub const DV_E_STATDATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221401i32);
pub const DV_E_STGMEDIUM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221402i32);
pub const DV_E_TYMED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221399i32);
pub const DWMERR_CATASTROPHIC_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302654i32);
pub const DWMERR_STATE_TRANSITION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302656i32);
pub const DWMERR_THEME_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302655i32);
pub const DWM_E_ADAPTER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144980987i32);
pub const DWM_E_COMPOSITIONDISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144980991i32);
pub const DWM_E_NOT_QUEUING_PRESENTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144980988i32);
pub const DWM_E_NO_REDIRECTION_SURFACE_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144980989i32);
pub const DWM_E_REMOTING_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144980990i32);
pub const DWM_E_TEXTURE_TOO_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144980985i32);
pub const DWM_S_GDI_REDIRECTION_SURFACE: ::windows::core::HRESULT = ::windows::core::HRESULT(2502661i32);
pub const DWM_S_GDI_REDIRECTION_SURFACE_BLT_VIA_GDI: ::windows::core::HRESULT = ::windows::core::HRESULT(2502664i32);
pub const DWRITE_E_ALREADYREGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283962i32);
pub const DWRITE_E_CACHEFORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283961i32);
pub const DWRITE_E_CACHEVERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283960i32);
pub const DWRITE_E_FILEACCESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283964i32);
pub const DWRITE_E_FILEFORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283968i32);
pub const DWRITE_E_FILENOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283965i32);
pub const DWRITE_E_FLOWDIRECTIONCONFLICTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283957i32);
pub const DWRITE_E_FONTCOLLECTIONOBSOLETE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283963i32);
pub const DWRITE_E_NOCOLOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283956i32);
pub const DWRITE_E_NOFONT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283966i32);
pub const DWRITE_E_TEXTRENDERERINCOMPATIBLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283958i32);
pub const DWRITE_E_UNEXPECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283967i32);
pub const DWRITE_E_UNSUPPORTEDOPERATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003283959i32);
pub const DXCORE_ERROR_EVENT_NOT_UNREGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2004877311i32);
pub const DXGI_DDI_ERR_NONEXCLUSIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005204989i32);
pub const DXGI_DDI_ERR_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005204990i32);
pub const DXGI_DDI_ERR_WASSTILLDRAWING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2005204991i32);
pub const DXGI_STATUS_CLIPPED: ::windows::core::HRESULT = ::windows::core::HRESULT(142213122i32);
pub const DXGI_STATUS_DDA_WAS_STILL_DRAWING: ::windows::core::HRESULT = ::windows::core::HRESULT(142213130i32);
pub const DXGI_STATUS_GRAPHICS_VIDPN_SOURCE_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(142213126i32);
pub const DXGI_STATUS_MODE_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(142213127i32);
pub const DXGI_STATUS_MODE_CHANGE_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(142213128i32);
pub const DXGI_STATUS_NO_DESKTOP_ACCESS: ::windows::core::HRESULT = ::windows::core::HRESULT(142213125i32);
pub const DXGI_STATUS_NO_REDIRECTION: ::windows::core::HRESULT = ::windows::core::HRESULT(142213124i32);
pub const DXGI_STATUS_OCCLUDED: ::windows::core::HRESULT = ::windows::core::HRESULT(142213121i32);
...
pub const EAS_E_ADMINS_HAVE_BLANK_PASSWORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913081i32);
pub const EAS_E_CONNECTED_ADMINS_NEED_TO_CHANGE_PASSWORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913077i32);
pub const EAS_E_CURRENT_CONNECTED_USER_NEED_TO_CHANGE_PASSWORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913075i32);
pub const EAS_E_CURRENT_USER_HAS_BLANK_PASSWORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913084i32);
pub const EAS_E_LOCAL_CONTROLLED_USERS_CANNOT_CHANGE_PASSWORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913079i32);
pub const EAS_E_PASSWORD_POLICY_NOT_ENFORCEABLE_FOR_CONNECTED_ADMINS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913078i32);
pub const EAS_E_PASSWORD_POLICY_NOT_ENFORCEABLE_FOR_CURRENT_CONNECTED_USER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913076i32);
pub const EAS_E_POLICY_COMPLIANT_WITH_ACTIONS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913086i32);
pub const EAS_E_POLICY_NOT_MANAGED_BY_OS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913087i32);
pub const EAS_E_REQUESTED_POLICY_NOT_ENFORCEABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913085i32);
pub const EAS_E_REQUESTED_POLICY_PASSWORD_EXPIRATION_INCOMPATIBLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913083i32);
pub const EAS_E_USER_CANNOT_CHANGE_PASSWORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141913082i32);
...
pub const ERROR_ALL_SIDS_FILTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073151998i32);
pub const ERROR_ALREADY_CONNECTED: u32 = 901u32;
pub const ERROR_ALREADY_CONNECTING: u32 = 910u32;
pub const ERROR_ATTRIBUTE_NOT_PRESENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898422i32);
pub const ERROR_AUDITING_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073151999i32);
...
pub const ERROR_BIZRULES_NOT_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073151997i32);
pub const ERROR_CLIENT_INTERFACE_ALREADY_EXISTS: u32 = 915u32;
pub const ERROR_CLIP_DEVICE_LICENSE_MISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406397i32);
pub const ERROR_CLIP_KEYHOLDER_LICENSE_MISSING_OR_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406395i32);
pub const ERROR_CLIP_LICENSE_DEVICE_ID_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406390i32);
pub const ERROR_CLIP_LICENSE_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406394i32);
pub const ERROR_CLIP_LICENSE_HARDWARE_ID_OUT_OF_TOLERANCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406391i32);
pub const ERROR_CLIP_LICENSE_INVALID_SIGNATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406396i32);
pub const ERROR_CLIP_LICENSE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406398i32);
pub const ERROR_CLIP_LICENSE_NOT_SIGNED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406392i32);
pub const ERROR_CLIP_LICENSE_SIGNED_BY_UNKNOWN_SOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406393i32);
pub const ERROR_CRED_REQUIRES_CONFIRMATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865127i32);
pub const ERROR_DBG_ATTACH_PROCESS_FAILURE_LOCKDOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2135949310i32);
pub const ERROR_DBG_CONNECT_SERVER_FAILURE_LOCKDOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2135949309i32);
pub const ERROR_DBG_CREATE_PROCESS_FAILURE_LOCKDOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2135949311i32);
pub const ERROR_DBG_START_SERVER_FAILURE_LOCKDOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2135949308i32);
...
pub const ERROR_FLT_CONTEXT_ALLOCATION_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452010i32);
pub const ERROR_FLT_CONTEXT_ALREADY_DEFINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452030i32);
pub const ERROR_FLT_CONTEXT_ALREADY_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452004i32);
pub const ERROR_FLT_DELETING_OBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452021i32);
pub const ERROR_FLT_DISALLOW_FAST_IO: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452028i32);
pub const ERROR_FLT_DO_NOT_ATTACH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452017i32);
pub const ERROR_FLT_DO_NOT_DETACH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452016i32);
pub const ERROR_FLT_DUPLICATE_ENTRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452019i32);
pub const ERROR_FLT_FILTER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452013i32);
pub const ERROR_FLT_FILTER_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452024i32);
pub const ERROR_FLT_INSTANCE_ALTITUDE_COLLISION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452015i32);
pub const ERROR_FLT_INSTANCE_NAME_COLLISION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452014i32);
pub const ERROR_FLT_INSTANCE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452011i32);
pub const ERROR_FLT_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452022i32);
pub const ERROR_FLT_INVALID_ASYNCHRONOUS_REQUEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452029i32);
pub const ERROR_FLT_INVALID_CONTEXT_REGISTRATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452009i32);
pub const ERROR_FLT_INVALID_NAME_REQUEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452027i32);
pub const ERROR_FLT_IO_COMPLETE: ::windows::core::HRESULT = ::windows::core::HRESULT(2031617i32);
pub const ERROR_FLT_MUST_BE_NONPAGED_POOL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452020i32);
pub const ERROR_FLT_NAME_CACHE_MISS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452008i32);
pub const ERROR_FLT_NOT_INITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452025i32);
pub const ERROR_FLT_NOT_SAFE_TO_POST_OPERATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452026i32);
pub const ERROR_FLT_NO_DEVICE_OBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452007i32);
pub const ERROR_FLT_NO_HANDLER_DEFINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452031i32);
pub const ERROR_FLT_NO_WAITER_FOR_REPLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452000i32);
pub const ERROR_FLT_POST_OPERATION_CLEANUP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452023i32);
pub const ERROR_FLT_REGISTRATION_BUSY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145451997i32);
pub const ERROR_FLT_VOLUME_ALREADY_MOUNTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452006i32);
pub const ERROR_FLT_VOLUME_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145452012i32);
pub const ERROR_FLT_WCOS_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145451996i32);
pub const ERROR_GRAPHICS_ADAPTER_ACCESS_NOT_EXCLUDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242181i32);
pub const ERROR_GRAPHICS_ADAPTER_CHAIN_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242189i32);
pub const ERROR_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_SOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242456i32);
pub const ERROR_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_TARGET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242455i32);
pub const ERROR_GRAPHICS_ADAPTER_WAS_RESET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243261i32);
pub const ERROR_GRAPHICS_ALLOCATION_BUSY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243006i32);
pub const ERROR_GRAPHICS_ALLOCATION_CLOSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242990i32);
pub const ERROR_GRAPHICS_ALLOCATION_CONTENT_LOST: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242986i32);
pub const ERROR_GRAPHICS_ALLOCATION_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243002i32);
pub const ERROR_GRAPHICS_CANCEL_VIDPN_TOPOLOGY_AUGMENTATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242406i32);
pub const ERROR_GRAPHICS_CANNOTCOLORCONVERT: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243256i32);
pub const ERROR_GRAPHICS_CANT_ACCESS_ACTIVE_VIDPN: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242429i32);
pub const ERROR_GRAPHICS_CANT_EVICT_PINNED_ALLOCATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242999i32);
pub const ERROR_GRAPHICS_CANT_LOCK_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243007i32);
pub const ERROR_GRAPHICS_CANT_RENDER_LOCKED_ALLOCATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242991i32);
pub const ERROR_GRAPHICS_CHAINLINKS_NOT_ENUMERATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242190i32);
pub const ERROR_GRAPHICS_CHAINLINKS_NOT_POWERED_ON: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242187i32);
pub const ERROR_GRAPHICS_CHAINLINKS_NOT_STARTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242188i32);
pub const ERROR_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242239i32);
pub const ERROR_GRAPHICS_CLIENTVIDPN_NOT_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242404i32);
pub const ERROR_GRAPHICS_COPP_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241983i32);
pub const ERROR_GRAPHICS_DATASET_IS_EMPTY: ::windows::core::HRESULT = ::windows::core::HRESULT(2499403i32);
pub const ERROR_GRAPHICS_DDCCI_CURRENT_CURRENT_VALUE_GREATER_THAN_MAXIMUM_VALUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241768i32);
pub const ERROR_GRAPHICS_DDCCI_INVALID_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241851i32);
pub const ERROR_GRAPHICS_DDCCI_INVALID_MESSAGE_CHECKSUM: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241845i32);
pub const ERROR_GRAPHICS_DDCCI_INVALID_MESSAGE_COMMAND: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241847i32);
pub const ERROR_GRAPHICS_DDCCI_INVALID_MESSAGE_LENGTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241846i32);
pub const ERROR_GRAPHICS_DDCCI_MONITOR_RETURNED_INVALID_TIMING_STATUS_BYTE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241850i32);
pub const ERROR_GRAPHICS_DDCCI_VCP_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241852i32);
pub const ERROR_GRAPHICS_DEPENDABLE_CHILD_STATUS: ::windows::core::HRESULT = ::windows::core::HRESULT(1076241468i32);
pub const ERROR_GRAPHICS_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241758i32);
pub const ERROR_GRAPHICS_DRIVER_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243255i32);
pub const ERROR_GRAPHICS_EMPTY_ADAPTER_MONITOR_MODE_SUPPORT_INTERSECTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242459i32);
pub const ERROR_GRAPHICS_FREQUENCYRANGE_ALREADY_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242465i32);
pub const ERROR_GRAPHICS_FREQUENCYRANGE_NOT_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242467i32);
pub const ERROR_GRAPHICS_GAMMA_RAMP_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242424i32);
pub const ERROR_GRAPHICS_GPU_EXCEPTION_ON_DEVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242752i32);
pub const ERROR_GRAPHICS_I2C_DEVICE_DOES_NOT_EXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241855i32);
pub const ERROR_GRAPHICS_I2C_ERROR_RECEIVING_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241853i32);
pub const ERROR_GRAPHICS_I2C_ERROR_TRANSMITTING_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241854i32);
pub const ERROR_GRAPHICS_I2C_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241856i32);
pub const ERROR_GRAPHICS_INCOMPATIBLE_PRIVATE_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242411i32);
pub const ERROR_GRAPHICS_INCONSISTENT_DEVICE_LINK_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242186i32);
pub const ERROR_GRAPHICS_INDIRECT_DISPLAY_ABANDON_SWAPCHAIN: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243246i32);
pub const ERROR_GRAPHICS_INDIRECT_DISPLAY_DEVICE_STOPPED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243245i32);
pub const ERROR_GRAPHICS_INSUFFICIENT_DMA_BUFFER: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243263i32);
pub const ERROR_GRAPHICS_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241753i32);
pub const ERROR_GRAPHICS_INVALID_ACTIVE_REGION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242485i32);
pub const ERROR_GRAPHICS_INVALID_ALLOCATION_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242988i32);
pub const ERROR_GRAPHICS_INVALID_ALLOCATION_INSTANCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242989i32);
pub const ERROR_GRAPHICS_INVALID_ALLOCATION_USAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242992i32);
pub const ERROR_GRAPHICS_INVALID_CLIENT_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242405i32);
pub const ERROR_GRAPHICS_INVALID_COLORBASIS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242434i32);
pub const ERROR_GRAPHICS_INVALID_COPYPROTECTION_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242417i32);
pub const ERROR_GRAPHICS_INVALID_DISPLAY_ADAPTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243262i32);
pub const ERROR_GRAPHICS_INVALID_DRIVER_MODEL: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243260i32);
pub const ERROR_GRAPHICS_INVALID_FREQUENCY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242486i32);
pub const ERROR_GRAPHICS_INVALID_GAMMA_RAMP: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242425i32);
pub const ERROR_GRAPHICS_INVALID_MODE_PRUNING_ALGORITHM: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242410i32);
pub const ERROR_GRAPHICS_INVALID_MONITORDESCRIPTOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242453i32);
pub const ERROR_GRAPHICS_INVALID_MONITORDESCRIPTORSET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242454i32);
pub const ERROR_GRAPHICS_INVALID_MONITOR_CAPABILITY_ORIGIN: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242409i32);
pub const ERROR_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242468i32);
pub const ERROR_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGESET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242469i32);
pub const ERROR_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE_CONSTRAINT: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242408i32);
pub const ERROR_GRAPHICS_INVALID_MONITOR_SOURCEMODESET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242463i32);
pub const ERROR_GRAPHICS_INVALID_MONITOR_SOURCE_MODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242462i32);
pub const ERROR_GRAPHICS_INVALID_PATH_CONTENT_GEOMETRY_TRANSFORMATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242427i32);
pub const ERROR_GRAPHICS_INVALID_PATH_CONTENT_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242418i32);
pub const ERROR_GRAPHICS_INVALID_PATH_IMPORTANCE_ORDINAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242428i32);
pub const ERROR_GRAPHICS_INVALID_PHYSICAL_MONITOR_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241844i32);
pub const ERROR_GRAPHICS_INVALID_PIXELFORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242435i32);
pub const ERROR_GRAPHICS_INVALID_PIXELVALUEACCESSMODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242433i32);
pub const ERROR_GRAPHICS_INVALID_POINTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241756i32);
pub const ERROR_GRAPHICS_INVALID_PRIMARYSURFACE_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242438i32);
pub const ERROR_GRAPHICS_INVALID_SCANLINE_ORDERING: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242414i32);
pub const ERROR_GRAPHICS_INVALID_STRIDE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242436i32);
pub const ERROR_GRAPHICS_INVALID_TOTAL_REGION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242484i32);
pub const ERROR_GRAPHICS_INVALID_VIDEOPRESENTSOURCESET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242475i32);
pub const ERROR_GRAPHICS_INVALID_VIDEOPRESENTTARGETSET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242474i32);
pub const ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242492i32);
pub const ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE_MODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242480i32);
pub const ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242491i32);
pub const ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET_MODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242479i32);
pub const ERROR_GRAPHICS_INVALID_VIDPN: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242493i32);
pub const ERROR_GRAPHICS_INVALID_VIDPN_PRESENT_PATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242471i32);
pub const ERROR_GRAPHICS_INVALID_VIDPN_SOURCEMODESET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242488i32);
pub const ERROR_GRAPHICS_INVALID_VIDPN_TARGETMODESET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242487i32);
pub const ERROR_GRAPHICS_INVALID_VIDPN_TARGET_SUBSET_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242449i32);
pub const ERROR_GRAPHICS_INVALID_VIDPN_TOPOLOGY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242496i32);
pub const ERROR_GRAPHICS_INVALID_VIDPN_TOPOLOGY_RECOMMENDATION_REASON: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242419i32);
pub const ERROR_GRAPHICS_INVALID_VISIBLEREGION_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242437i32);
pub const ERROR_GRAPHICS_LEADLINK_NOT_ENUMERATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242191i32);
...
pub const ERROR_GRAPHICS_MCA_INVALID_CAPABILITIES_STRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241849i32);
pub const ERROR_GRAPHICS_MCA_INVALID_TECHNOLOGY_TYPE_RETURNED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241762i32);
pub const ERROR_GRAPHICS_MCA_INVALID_VCP_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241767i32);
pub const ERROR_GRAPHICS_MCA_MCCS_VERSION_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241765i32);
pub const ERROR_GRAPHICS_MCA_MONITOR_VIOLATES_MCCS_SPECIFICATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241766i32);
pub const ERROR_GRAPHICS_MCA_UNSUPPORTED_COLOR_TEMPERATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241761i32);
pub const ERROR_GRAPHICS_MCA_UNSUPPORTED_MCCS_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241764i32);
pub const ERROR_GRAPHICS_MIRRORING_DEVICES_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241757i32);
pub const ERROR_GRAPHICS_MODE_ALREADY_IN_MODESET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242476i32);
pub const ERROR_GRAPHICS_MODE_ID_MUST_BE_UNIQUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242460i32);
pub const ERROR_GRAPHICS_MODE_NOT_IN_MODESET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242422i32);
pub const ERROR_GRAPHICS_MODE_NOT_PINNED: ::windows::core::HRESULT = ::windows::core::HRESULT(2499335i32);
pub const ERROR_GRAPHICS_MONITORDESCRIPTOR_ALREADY_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242451i32);
pub const ERROR_GRAPHICS_MONITORDESCRIPTOR_ID_MUST_BE_UNIQUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242450i32);
pub const ERROR_GRAPHICS_MONITORDESCRIPTOR_NOT_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242452i32);
pub const ERROR_GRAPHICS_MONITOR_COULD_NOT_BE_ASSOCIATED_WITH_ADAPTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242444i32);
...
pub const ERROR_GRAPHICS_NOT_A_LINKED_ADAPTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242192i32);
pub const ERROR_GRAPHICS_NOT_EXCLUSIVE_MODE_OWNER: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243264i32);
pub const ERROR_GRAPHICS_NOT_POST_DEVICE_DRIVER: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242184i32);
pub const ERROR_GRAPHICS_NO_ACTIVE_VIDPN: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242442i32);
pub const ERROR_GRAPHICS_NO_AVAILABLE_IMPORTANCE_ORDINALS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242412i32);
pub const ERROR_GRAPHICS_NO_AVAILABLE_VIDPN_TARGET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242445i32);
pub const ERROR_GRAPHICS_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241759i32);
pub const ERROR_GRAPHICS_NO_DISPLAY_MODE_MANAGEMENT_SUPPORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242431i32);
pub const ERROR_GRAPHICS_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241755i32);
pub const ERROR_GRAPHICS_NO_MORE_ELEMENTS_IN_DATASET: ::windows::core::HRESULT = ::windows::core::HRESULT(2499404i32);
pub const ERROR_GRAPHICS_NO_PREFERRED_MODE: ::windows::core::HRESULT = ::windows::core::HRESULT(2499358i32);
pub const ERROR_GRAPHICS_NO_RECOMMENDED_FUNCTIONAL_VIDPN: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242461i32);
pub const ERROR_GRAPHICS_NO_RECOMMENDED_VIDPN_TOPOLOGY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242470i32);
pub const ERROR_GRAPHICS_NO_VIDEO_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243008i32);
pub const ERROR_GRAPHICS_NO_VIDPNMGR: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242443i32);
pub const ERROR_GRAPHICS_ONLY_CONSOLE_SESSION_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241760i32);
pub const ERROR_GRAPHICS_OPM_ALL_HDCP_HARDWARE_ALREADY_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241960i32);
pub const ERROR_GRAPHICS_OPM_DRIVER_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241954i32);
pub const ERROR_GRAPHICS_OPM_HDCP_SRM_NEVER_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241962i32);
pub const ERROR_GRAPHICS_OPM_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241973i32);
pub const ERROR_GRAPHICS_OPM_INVALID_CONFIGURATION_REQUEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241951i32);
pub const ERROR_GRAPHICS_OPM_INVALID_ENCRYPTED_PARAMETERS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241981i32);
pub const ERROR_GRAPHICS_OPM_INVALID_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241972i32);
pub const ERROR_GRAPHICS_OPM_INVALID_INFORMATION_REQUEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241955i32);
pub const ERROR_GRAPHICS_OPM_INVALID_SRM: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241966i32);
pub const ERROR_GRAPHICS_OPM_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241984i32);
pub const ERROR_GRAPHICS_OPM_NO_VIDEO_OUTPUTS_EXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241979i32);
pub const ERROR_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_ACP: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241964i32);
pub const ERROR_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_CGMSA: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241963i32);
pub const ERROR_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_HDCP: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241965i32);
pub const ERROR_GRAPHICS_OPM_RESOLUTION_TOO_HIGH: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241961i32);
pub const ERROR_GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241957i32);
pub const ERROR_GRAPHICS_OPM_SIGNALING_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241952i32);
pub const ERROR_GRAPHICS_OPM_SPANNING_MODE_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241969i32);
pub const ERROR_GRAPHICS_OPM_THEATER_MODE_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241968i32);
pub const ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_DOES_NOT_HAVE_COPP_SEMANTICS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241956i32);
pub const ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_DOES_NOT_HAVE_OPM_SEMANTICS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241953i32);
pub const ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_NO_LONGER_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241958i32);
pub const ERROR_GRAPHICS_PARAMETER_ARRAY_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241754i32);
pub const ERROR_GRAPHICS_PARTIAL_DATA_POPULATED: ::windows::core::HRESULT = ::windows::core::HRESULT(1076240394i32);
pub const ERROR_GRAPHICS_PATH_ALREADY_IN_TOPOLOGY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242477i32);
pub const ERROR_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_PINNED: ::windows::core::HRESULT = ::windows::core::HRESULT(2499409i32);
pub const ERROR_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242426i32);
pub const ERROR_GRAPHICS_PATH_NOT_IN_TOPOLOGY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242457i32);
pub const ERROR_GRAPHICS_PINNED_MODE_MUST_REMAIN_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242478i32);
pub const ERROR_GRAPHICS_POLLING_TOO_FREQUENTLY: ::windows::core::HRESULT = ::windows::core::HRESULT(1076241465i32);
pub const ERROR_GRAPHICS_PRESENT_BUFFER_NOT_BOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243248i32);
pub const ERROR_GRAPHICS_PRESENT_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243257i32);
pub const ERROR_GRAPHICS_PRESENT_INVALID_WINDOW: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243249i32);
pub const ERROR_GRAPHICS_PRESENT_MODE_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243259i32);
pub const ERROR_GRAPHICS_PRESENT_OCCLUDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243258i32);
pub const ERROR_GRAPHICS_PRESENT_REDIRECTION_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243253i32);
pub const ERROR_GRAPHICS_PRESENT_UNOCCLUDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243252i32);
pub const ERROR_GRAPHICS_PVP_HFS_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241967i32);
pub const ERROR_GRAPHICS_PVP_INVALID_CERTIFICATE_LENGTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241970i32);
pub const ERROR_GRAPHICS_RESOURCES_NOT_RELATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242448i32);
pub const ERROR_GRAPHICS_SESSION_TYPE_CHANGE_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071249944i32);
pub const ERROR_GRAPHICS_SKIP_ALLOCATION_PREPARATION: ::windows::core::HRESULT = ::windows::core::HRESULT(1076240897i32);
pub const ERROR_GRAPHICS_SOURCE_ALREADY_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242473i32);
pub const ERROR_GRAPHICS_SOURCE_ID_MUST_BE_UNIQUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242447i32);
pub const ERROR_GRAPHICS_SOURCE_NOT_IN_TOPOLOGY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242439i32);
pub const ERROR_GRAPHICS_SPECIFIED_CHILD_ALREADY_CONNECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242240i32);
pub const ERROR_GRAPHICS_STALE_MODESET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242464i32);
pub const ERROR_GRAPHICS_STALE_VIDPN_TOPOLOGY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242441i32);
pub const ERROR_GRAPHICS_START_DEFERRED: ::windows::core::HRESULT = ::windows::core::HRESULT(1076241466i32);
pub const ERROR_GRAPHICS_TARGET_ALREADY_IN_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242472i32);
pub const ERROR_GRAPHICS_TARGET_ID_MUST_BE_UNIQUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242446i32);
pub const ERROR_GRAPHICS_TARGET_NOT_IN_TOPOLOGY: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242432i32);
pub const ERROR_GRAPHICS_TOO_MANY_REFERENCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243005i32);
pub const ERROR_GRAPHICS_TOPOLOGY_CHANGES_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242413i32);
pub const ERROR_GRAPHICS_TRY_AGAIN_LATER: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243004i32);
pub const ERROR_GRAPHICS_TRY_AGAIN_NOW: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243003i32);
pub const ERROR_GRAPHICS_UAB_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071241982i32);
pub const ERROR_GRAPHICS_UNASSIGNED_MODESET_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242416i32);
pub const ERROR_GRAPHICS_UNKNOWN_CHILD_STATUS: ::windows::core::HRESULT = ::windows::core::HRESULT(1076241455i32);
pub const ERROR_GRAPHICS_UNSWIZZLING_APERTURE_UNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243001i32);
pub const ERROR_GRAPHICS_UNSWIZZLING_APERTURE_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243000i32);
pub const ERROR_GRAPHICS_VAIL_FAILED_TO_SEND_COMPOSITION_WINDOW_DPI_MESSAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243242i32);
pub const ERROR_GRAPHICS_VAIL_FAILED_TO_SEND_CREATE_SUPERWETINK_MESSAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243244i32);
pub const ERROR_GRAPHICS_VAIL_FAILED_TO_SEND_DESTROY_SUPERWETINK_MESSAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243243i32);
pub const ERROR_GRAPHICS_VAIL_STATE_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243247i32);
pub const ERROR_GRAPHICS_VIDEO_PRESENT_TARGETS_LESS_THAN_SOURCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242458i32);
pub const ERROR_GRAPHICS_VIDPN_MODALITY_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242490i32);
pub const ERROR_GRAPHICS_VIDPN_SOURCE_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242430i32);
pub const ERROR_GRAPHICS_VIDPN_TOPOLOGY_CURRENTLY_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242494i32);
pub const ERROR_GRAPHICS_VIDPN_TOPOLOGY_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242495i32);
pub const ERROR_GRAPHICS_WINDOWDC_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243251i32);
pub const ERROR_GRAPHICS_WINDOWLESS_PRESENT_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071243250i32);
pub const ERROR_GRAPHICS_WRONG_ALLOCATION_DEVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071242987i32);
pub const ERROR_HUNG_DISPLAY_DRIVER_THREAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144993279i32);
...
pub const ERROR_IO_PREEMPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1996423167i32);
...
pub const ERROR_MONITOR_INVALID_DESCRIPTOR_CHECKSUM: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071247357i32);
pub const ERROR_MONITOR_INVALID_DETAILED_TIMING_BLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071247351i32);
pub const ERROR_MONITOR_INVALID_MANUFACTURE_DATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071247350i32);
pub const ERROR_MONITOR_INVALID_SERIAL_NUMBER_MONDSC_BLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071247354i32);
pub const ERROR_MONITOR_INVALID_STANDARD_TIMING_BLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071247356i32);
pub const ERROR_MONITOR_INVALID_USER_FRIENDLY_MONDSC_BLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071247353i32);
pub const ERROR_MONITOR_NO_DESCRIPTOR: ::windows::core::HRESULT = ::windows::core::HRESULT(2494465i32);
pub const ERROR_MONITOR_NO_MORE_DESCRIPTOR_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071247352i32);
pub const ERROR_MONITOR_UNKNOWN_DESCRIPTOR_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(2494466i32);
pub const ERROR_MONITOR_WMI_DATABLOCK_REGISTRATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1071247355i32);
pub const ERROR_NOT_A_TIERED_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898423i32);
pub const ERROR_NOT_CLIENT_PORT: u32 = 913u32;
pub const ERROR_NOT_ROUTER_PORT: u32 = 914u32;
pub const ERROR_NO_APPLICABLE_APP_LICENSES_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058406399i32);
...
pub const ERROR_QUIC_ALPN_NEG_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143223801i32);
pub const ERROR_QUIC_CONNECTION_IDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143223803i32);
pub const ERROR_QUIC_CONNECTION_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143223802i32);
pub const ERROR_QUIC_HANDSHAKE_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143223808i32);
pub const ERROR_QUIC_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143223805i32);
pub const ERROR_QUIC_PROTOCOL_VIOLATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143223804i32);
pub const ERROR_QUIC_USER_CANCELED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143223806i32);
pub const ERROR_QUIC_VER_NEG_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143223807i32);
...
pub const ERROR_SECCORE_INVALID_COMMAND: ::windows::core::HRESULT = ::windows::core::HRESULT(-1058537472i32);
pub const ERROR_SERVICE_IS_PAUSED: u32 = 928u32;
pub const ERROR_SMB_BAD_CLUSTER_DIALECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067646975i32);
pub const ERROR_SMB_NO_PREAUTH_INTEGRITY_HASH_OVERLAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067646976i32);
pub const ERROR_SMB_NO_SIGNING_ALGORITHM_OVERLAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067646974i32);
pub const ERROR_SPACES_ALLOCATION_SIZE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344818i32);
pub const ERROR_SPACES_CACHE_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344794i32);
pub const ERROR_SPACES_CORRUPT_METADATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344808i32);
pub const ERROR_SPACES_DRIVE_LOST_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344801i32);
pub const ERROR_SPACES_DRIVE_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344803i32);
pub const ERROR_SPACES_DRIVE_OPERATIONAL_STATE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344814i32);
pub const ERROR_SPACES_DRIVE_REDUNDANCY_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344826i32);
pub const ERROR_SPACES_DRIVE_SECTOR_SIZE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344828i32);
pub const ERROR_SPACES_DRIVE_SPLIT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344802i32);
pub const ERROR_SPACES_DRT_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344807i32);
pub const ERROR_SPACES_ENCLOSURE_AWARE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344817i32);
pub const ERROR_SPACES_ENTRY_INCOMPLETE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344813i32);
pub const ERROR_SPACES_ENTRY_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344812i32);
pub const ERROR_SPACES_EXTENDED_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344820i32);
pub const ERROR_SPACES_FAULT_DOMAIN_TYPE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344831i32);
pub const ERROR_SPACES_FLUSH_METADATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344795i32);
pub const ERROR_SPACES_INCONSISTENCY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344806i32);
pub const ERROR_SPACES_INTERLEAVE_LENGTH_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344823i32);
pub const ERROR_SPACES_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344830i32);
pub const ERROR_SPACES_LOG_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344805i32);
pub const ERROR_SPACES_MAP_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344810i32);
pub const ERROR_SPACES_MARK_DIRTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344800i32);
pub const ERROR_SPACES_NOT_ENOUGH_DRIVES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344821i32);
pub const ERROR_SPACES_NO_REDUNDANCY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344804i32);
pub const ERROR_SPACES_NUMBER_OF_COLUMNS_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344822i32);
pub const ERROR_SPACES_NUMBER_OF_DATA_COPIES_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344825i32);
pub const ERROR_SPACES_NUMBER_OF_GROUPS_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344815i32);
pub const ERROR_SPACES_PARITY_LAYOUT_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344824i32);
...
pub const ERROR_SPACES_UNSUPPORTED_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344809i32);
pub const ERROR_SPACES_UPDATE_COLUMN_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344811i32);
pub const ERROR_SPACES_WRITE_CACHE_SIZE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2132344816i32);
pub const ERROR_SVHDX_ERROR_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647232i32);
pub const ERROR_SVHDX_ERROR_STORED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067712512i32);
pub const ERROR_SVHDX_NO_INITIATOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647221i32);
pub const ERROR_SVHDX_RESERVATION_CONFLICT: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647225i32);
pub const ERROR_SVHDX_UNIT_ATTENTION_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647231i32);
pub const ERROR_SVHDX_UNIT_ATTENTION_CAPACITY_DATA_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647230i32);
pub const ERROR_SVHDX_UNIT_ATTENTION_OPERATING_DEFINITION_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647226i32);
pub const ERROR_SVHDX_UNIT_ATTENTION_REGISTRATIONS_PREEMPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647227i32);
pub const ERROR_SVHDX_UNIT_ATTENTION_RESERVATIONS_PREEMPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647229i32);
pub const ERROR_SVHDX_UNIT_ATTENTION_RESERVATIONS_RELEASED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647228i32);
pub const ERROR_SVHDX_VERSION_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647223i32);
pub const ERROR_SVHDX_WRONG_FILE_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647224i32);
pub const ERROR_TIERING_ALREADY_PROCESSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898426i32);
pub const ERROR_TIERING_CANNOT_PIN_OBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898425i32);
pub const ERROR_TIERING_FILE_IS_NOT_PINNED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898424i32);
pub const ERROR_TIERING_INVALID_FILE_ID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898428i32);
pub const ERROR_TIERING_NOT_SUPPORTED_ON_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898431i32);
pub const ERROR_TIERING_STORAGE_TIER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898429i32);
pub const ERROR_TIERING_VOLUME_DISMOUNT_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898430i32);
pub const ERROR_TIERING_WRONG_CLUSTER_NODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138898427i32);
...
pub const ERROR_VHDSET_BACKING_STORAGE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647220i32);
pub const ERROR_VHD_SHARED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1067647222i32);
pub const ERROR_VOLSNAP_ACTIVATION_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138963966i32);
pub const ERROR_VOLSNAP_BOOTFILE_NOT_VALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138963967i32);
pub const ERROR_VOLSNAP_NO_BYPASSIO_WITH_SNAPSHOT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138963965i32);
pub const EVENT_E_ALL_SUBSCRIBERS_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220991i32);
pub const EVENT_E_CANT_MODIFY_OR_DELETE_CONFIGURED_OBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220978i32);
pub const EVENT_E_CANT_MODIFY_OR_DELETE_UNCONFIGURED_OBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220979i32);
pub const EVENT_E_COMPLUS_NOT_INSTALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220980i32);
pub const EVENT_E_FIRST: i32 = -2147220992i32;
pub const EVENT_E_INTERNALERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220986i32);
pub const EVENT_E_INTERNALEXCEPTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220987i32);
pub const EVENT_E_INVALID_EVENT_CLASS_PARTITION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220977i32);
pub const EVENT_E_INVALID_PER_USER_SID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220985i32);
pub const EVENT_E_LAST: i32 = -2147220961i32;
pub const EVENT_E_MISSING_EVENTCLASS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220982i32);
pub const EVENT_E_NOT_ALL_REMOVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220981i32);
pub const EVENT_E_PER_USER_SID_NOT_LOGGED_ON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220976i32);
pub const EVENT_E_QUERYFIELD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220988i32);
pub const EVENT_E_QUERYSYNTAX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220989i32);
pub const EVENT_E_TOO_MANY_METHODS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220983i32);
pub const EVENT_E_USER_EXCEPTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220984i32);
pub const EVENT_S_FIRST: i32 = 262656i32;
pub const EVENT_S_LAST: i32 = 262687i32;
pub const EVENT_S_NOSUBSCRIBERS: ::windows::core::HRESULT = ::windows::core::HRESULT(262658i32);
pub const EVENT_S_SOME_SUBSCRIBERS_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(262656i32);
pub const E_ABORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467260i32);
pub const E_ACCESSDENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147024891i32);
pub const E_APPLICATION_ACTIVATION_EXEC_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927141i32);
pub const E_APPLICATION_ACTIVATION_TIMED_OUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927142i32);
pub const E_APPLICATION_EXITING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483622i32);
pub const E_APPLICATION_MANAGER_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927145i32);
pub const E_APPLICATION_NOT_REGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927148i32);
pub const E_APPLICATION_TEMPORARY_LICENSE_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927140i32);
pub const E_APPLICATION_TRIAL_LICENSE_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927139i32);
pub const E_APPLICATION_VIEW_EXITING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483621i32);
pub const E_ASYNC_OPERATION_NOT_STARTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483623i32);
pub const E_AUDIO_ENGINE_NODE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140798975i32);
pub const E_BLUETOOTH_ATT_ATTRIBUTE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864502i32);
pub const E_BLUETOOTH_ATT_ATTRIBUTE_NOT_LONG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864501i32);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_AUTHENTICATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864507i32);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_AUTHORIZATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864504i32);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_ENCRYPTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864497i32);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_ENCRYPTION_KEY_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864500i32);
pub const E_BLUETOOTH_ATT_INSUFFICIENT_RESOURCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864495i32);
pub const E_BLUETOOTH_ATT_INVALID_ATTRIBUTE_VALUE_LENGTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864499i32);
pub const E_BLUETOOTH_ATT_INVALID_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864511i32);
pub const E_BLUETOOTH_ATT_INVALID_OFFSET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864505i32);
pub const E_BLUETOOTH_ATT_INVALID_PDU: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864508i32);
pub const E_BLUETOOTH_ATT_PREPARE_QUEUE_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864503i32);
pub const E_BLUETOOTH_ATT_READ_NOT_PERMITTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864510i32);
pub const E_BLUETOOTH_ATT_REQUEST_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864506i32);
pub const E_BLUETOOTH_ATT_UNKNOWN_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140860416i32);
pub const E_BLUETOOTH_ATT_UNLIKELY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864498i32);
pub const E_BLUETOOTH_ATT_UNSUPPORTED_GROUP_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864496i32);
pub const E_BLUETOOTH_ATT_WRITE_NOT_PERMITTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140864509i32);
pub const E_BOUNDS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483637i32);
pub const E_CHANGED_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483636i32);
pub const E_ELEVATED_ACTIVATION_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927151i32);
pub const E_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467259i32);
pub const E_FULL_ADMIN_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927149i32);
pub const E_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147024890i32);
pub const E_HDAUDIO_CONNECTION_LIST_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140798973i32);
pub const E_HDAUDIO_EMPTY_CONNECTION_LIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140798974i32);
pub const E_HDAUDIO_NO_LOGICAL_DEVICES_CREATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140798972i32);
pub const E_HDAUDIO_NULL_LINKED_LIST_ENTRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140798971i32);
pub const E_ILLEGAL_DELEGATE_ASSIGNMENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483624i32);
pub const E_ILLEGAL_METHOD_CALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483634i32);
pub const E_ILLEGAL_STATE_CHANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483635i32);
pub const E_INVALIDARG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147024809i32);
pub const E_INVALID_PROTOCOL_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089418750i32);
pub const E_INVALID_PROTOCOL_OPERATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089418751i32);
pub const E_MBN_BAD_SIM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945342i32);
pub const E_MBN_CONTEXT_NOT_ACTIVATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945343i32);
pub const E_MBN_DATA_CLASS_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945341i32);
pub const E_MBN_DEFAULT_PROFILE_EXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945319i32);
pub const E_MBN_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945326i32);
pub const E_MBN_INVALID_ACCESS_STRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945340i32);
pub const E_MBN_INVALID_CACHE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945332i32);
pub const E_MBN_INVALID_PROFILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945320i32);
pub const E_MBN_MAX_ACTIVATED_CONTEXTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945339i32);
pub const E_MBN_NOT_REGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945331i32);
pub const E_MBN_PACKET_SVC_DETACHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945338i32);
pub const E_MBN_PIN_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945327i32);
pub const E_MBN_PIN_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945329i32);
pub const E_MBN_PIN_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945328i32);
pub const E_MBN_PROVIDERS_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945330i32);
pub const E_MBN_PROVIDER_NOT_VISIBLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945337i32);
pub const E_MBN_RADIO_POWER_OFF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945336i32);
pub const E_MBN_SERVICE_NOT_ACTIVATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945335i32);
pub const E_MBN_SIM_NOT_INSERTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945334i32);
pub const E_MBN_SMS_ENCODING_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945312i32);
pub const E_MBN_SMS_FILTER_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945311i32);
pub const E_MBN_SMS_FORMAT_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945305i32);
pub const E_MBN_SMS_INVALID_MEMORY_INDEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945310i32);
pub const E_MBN_SMS_LANG_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945309i32);
pub const E_MBN_SMS_MEMORY_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945308i32);
pub const E_MBN_SMS_MEMORY_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945303i32);
pub const E_MBN_SMS_NETWORK_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945307i32);
pub const E_MBN_SMS_OPERATION_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945304i32);
pub const E_MBN_SMS_UNKNOWN_SMSC_ADDRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945306i32);
pub const E_MBN_VOICE_CALL_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2141945333i32);
pub const E_MONITOR_RESOLUTION_TOO_LOW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927152i32);
pub const E_MULTIPLE_EXTENSIONS_FOR_APPLICATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927147i32);
pub const E_MULTIPLE_PACKAGES_FOR_FAMILY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927146i32);
pub const E_NOINTERFACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467262i32);
pub const E_NOTIMPL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467263i32);
pub const E_OUTOFMEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147024882i32);
pub const E_POINTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147467261i32);
pub const E_PROTOCOL_EXTENSIONS_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089418749i32);
pub const E_PROTOCOL_VERSION_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089418747i32);
pub const E_SKYDRIVE_FILE_NOT_UPLOADED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927133i32);
pub const E_SKYDRIVE_ROOT_TARGET_CANNOT_INDEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927134i32);
pub const E_SKYDRIVE_ROOT_TARGET_FILE_SYSTEM_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927136i32);
pub const E_SKYDRIVE_ROOT_TARGET_OVERLAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927135i32);
pub const E_SKYDRIVE_ROOT_TARGET_VOLUME_ROOT_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927131i32);
pub const E_SKYDRIVE_UPDATE_AVAILABILITY_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927132i32);
pub const E_STRING_NOT_NULL_TERMINATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483625i32);
pub const E_SUBPROTOCOL_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089418748i32);
pub const E_SYNCENGINE_CLIENT_UPDATE_NEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081594i32);
pub const E_SYNCENGINE_FILE_IDENTIFIER_UNKNOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013085694i32);
pub const E_SYNCENGINE_FILE_SIZE_EXCEEDS_REMAINING_QUOTA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013089790i32);
pub const E_SYNCENGINE_FILE_SIZE_OVER_LIMIT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013089791i32);
pub const E_SYNCENGINE_FILE_SYNC_PARTNER_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013089787i32);
pub const E_SYNCENGINE_FOLDER_INACCESSIBLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081599i32);
pub const E_SYNCENGINE_FOLDER_IN_REDIRECTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081589i32);
pub const E_SYNCENGINE_FOLDER_ITEM_COUNT_LIMIT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013089788i32);
pub const E_SYNCENGINE_PATH_LENGTH_LIMIT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081596i32);
pub const E_SYNCENGINE_PROXY_AUTHENTICATION_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081593i32);
pub const E_SYNCENGINE_REMOTE_PATH_LENGTH_LIMIT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081595i32);
pub const E_SYNCENGINE_REQUEST_BLOCKED_BY_SERVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013085690i32);
pub const E_SYNCENGINE_REQUEST_BLOCKED_DUE_TO_CLIENT_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013085689i32);
pub const E_SYNCENGINE_SERVICE_AUTHENTICATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013085693i32);
pub const E_SYNCENGINE_SERVICE_RETURNED_UNEXPECTED_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013085691i32);
pub const E_SYNCENGINE_STORAGE_SERVICE_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081590i32);
pub const E_SYNCENGINE_STORAGE_SERVICE_PROVISIONING_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081592i32);
pub const E_SYNCENGINE_SYNC_PAUSED_BY_SERVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013089786i32);
pub const E_SYNCENGINE_UNKNOWN_SERVICE_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013085692i32);
pub const E_SYNCENGINE_UNSUPPORTED_FILE_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013089789i32);
pub const E_SYNCENGINE_UNSUPPORTED_FOLDER_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081598i32);
pub const E_SYNCENGINE_UNSUPPORTED_MARKET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081597i32);
pub const E_SYNCENGINE_UNSUPPORTED_REPARSE_POINT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013081591i32);
...
pub const FDAEMON_E_FATALERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215742i32);
pub const FDAEMON_E_LOWRESOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215743i32);
pub const FDAEMON_E_NOWORDLIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215737i32);
pub const FDAEMON_E_PARTITIONDELETED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215741i32);
pub const FDAEMON_E_TOOMANYFILTEREDBLOCKS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215736i32);
pub const FDAEMON_E_WORDLISTCOMMITFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215738i32);
...
pub const FILTER_E_CONTENTINDEXCORRUPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-1073473740i32);
pub const FILTER_E_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215560i32);
pub const FILTER_E_NOT_OPEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215559i32);
pub const FILTER_E_NO_SUCH_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215557i32);
pub const FILTER_E_OFFLINE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215555i32);
pub const FILTER_E_PARTIALLY_FILTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215554i32);
pub const FILTER_E_TOO_BIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215568i32);
pub const FILTER_E_UNREACHABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215561i32);
pub const FILTER_S_CONTENTSCAN_DELAYED: ::windows::core::HRESULT = ::windows::core::HRESULT(268083i32);
pub const FILTER_S_DISK_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(268085i32);
pub const FILTER_S_FULL_CONTENTSCAN_IMMEDIATE: ::windows::core::HRESULT = ::windows::core::HRESULT(268082i32);
pub const FILTER_S_NO_PROPSETS: ::windows::core::HRESULT = ::windows::core::HRESULT(268090i32);
...
pub const FVE_E_AD_ATTR_NOT_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272370i32);
pub const FVE_E_AD_BACKUP_REQUIRED_POLICY_NOT_SET_FIXED_DRIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272165i32);
pub const FVE_E_AD_BACKUP_REQUIRED_POLICY_NOT_SET_OS_DRIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272166i32);
pub const FVE_E_AD_BACKUP_REQUIRED_POLICY_NOT_SET_REMOVABLE_DRIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272164i32);
pub const FVE_E_AD_GUID_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272369i32);
pub const FVE_E_AD_INSUFFICIENT_BUFFER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272358i32);
pub const FVE_E_AD_INVALID_DATASIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272372i32);
pub const FVE_E_AD_INVALID_DATATYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272373i32);
pub const FVE_E_AD_NO_VALUES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272371i32);
pub const FVE_E_AD_SCHEMA_NOT_INSTALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272374i32);
pub const FVE_E_AUTH_INVALID_APPLICATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272316i32);
pub const FVE_E_AUTH_INVALID_CONFIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272315i32);
pub const FVE_E_AUTOUNLOCK_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272343i32);
pub const FVE_E_BAD_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272362i32);
pub const FVE_E_BAD_INFORMATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272368i32);
pub const FVE_E_BAD_PARTITION_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272364i32);
pub const FVE_E_BCD_APPLICATIONS_PATH_INCORRECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272302i32);
pub const FVE_E_BOOTABLE_CDDVD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272336i32);
pub const FVE_E_BUFFER_TOO_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272177i32);
pub const FVE_E_CANNOT_ENCRYPT_NO_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272338i32);
pub const FVE_E_CANNOT_SET_FVEK_ENCRYPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272339i32);
pub const FVE_E_CANT_LOCK_AUTOUNLOCK_ENABLED_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272233i32);
pub const FVE_E_CLUSTERING_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272354i32);
pub const FVE_E_CONV_READ: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272357i32);
...
pub const FVE_E_DEVICELOCKOUT_COUNTER_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272178i32);
pub const FVE_E_DEVICE_LOCKOUT_COUNTER_UNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272179i32);
pub const FVE_E_DEVICE_NOT_JOINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272160i32);
pub const FVE_E_DE_DEVICE_LOCKEDOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272182i32);
pub const FVE_E_DE_FIXED_DATA_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272187i32);
pub const FVE_E_DE_HARDWARE_NOT_COMPLIANT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272186i32);
pub const FVE_E_DE_OS_VOLUME_NOT_PROTECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272183i32);
pub const FVE_E_DE_PREVENTED_FOR_OS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272175i32);
pub const FVE_E_DE_PROTECTION_NOT_YET_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272181i32);
pub const FVE_E_DE_PROTECTION_SUSPENDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272184i32);
pub const FVE_E_DE_VOLUME_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272173i32);
pub const FVE_E_DE_VOLUME_OPTED_OUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272174i32);
pub const FVE_E_DE_WINRE_NOT_CONFIGURED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272185i32);
pub const FVE_E_DRY_RUN_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272307i32);
pub const FVE_E_DV_NOT_ALLOWED_BY_GP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272271i32);
pub const FVE_E_DV_NOT_SUPPORTED_ON_FS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272272i32);
pub const FVE_E_EDRIVE_BAND_ENUMERATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272157i32);
pub const FVE_E_EDRIVE_BAND_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272208i32);
pub const FVE_E_EDRIVE_DISALLOWED_BY_GP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272207i32);
pub const FVE_E_EDRIVE_DRY_RUN_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272196i32);
pub const FVE_E_EDRIVE_DV_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272204i32);
pub const FVE_E_EDRIVE_INCOMPATIBLE_FIRMWARE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272193i32);
pub const FVE_E_EDRIVE_INCOMPATIBLE_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272206i32);
pub const FVE_E_EDRIVE_NO_FAILOVER_TO_SW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272209i32);
pub const FVE_E_EFI_ONLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272228i32);
pub const FVE_E_ENH_PIN_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272231i32);
pub const FVE_E_EOW_NOT_SUPPORTED_IN_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272172i32);
pub const FVE_E_EXECUTE_REQUEST_SENT_TOO_SOON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272162i32);
pub const FVE_E_FAILED_AUTHENTICATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272345i32);
pub const FVE_E_FAILED_SECTOR_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272346i32);
pub const FVE_E_FAILED_WRONG_FS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272365i32);
pub const FVE_E_FIPS_DISABLE_PROTECTION_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272314i32);
pub const FVE_E_FIPS_HASH_KDF_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272232i32);
pub const FVE_E_FIPS_PREVENTS_EXTERNAL_KEY_EXPORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272328i32);
pub const FVE_E_FIPS_PREVENTS_PASSPHRASE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272276i32);
pub const FVE_E_FIPS_PREVENTS_RECOVERY_PASSWORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272329i32);
pub const FVE_E_FIPS_RNG_CHECK_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272330i32);
pub const FVE_E_FIRMWARE_TYPE_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272312i32);
pub const FVE_E_FOREIGN_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272349i32);
pub const FVE_E_FS_MOUNTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272309i32);
pub const FVE_E_FS_NOT_EXTENDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272313i32);
pub const FVE_E_FULL_ENCRYPTION_NOT_ALLOWED_ON_TP_STORAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272219i32);
pub const FVE_E_HIDDEN_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272298i32);
pub const FVE_E_INVALID_BITLOCKER_OID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272274i32);
pub const FVE_E_INVALID_DATUM_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272229i32);
pub const FVE_E_INVALID_KEY_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272332i32);
pub const FVE_E_INVALID_NBP_CERT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272158i32);
pub const FVE_E_INVALID_NKP_CERT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272225i32);
pub const FVE_E_INVALID_PASSWORD_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272331i32);
pub const FVE_E_INVALID_PIN_CHARS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272230i32);
pub const FVE_E_INVALID_PIN_CHARS_DETAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272180i32);
pub const FVE_E_INVALID_PROTECTOR_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272326i32);
pub const FVE_E_INVALID_STARTUP_OPTIONS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272293i32);
pub const FVE_E_KEYFILE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272323i32);
pub const FVE_E_KEYFILE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272324i32);
pub const FVE_E_KEYFILE_NO_VMK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272322i32);
pub const FVE_E_KEY_LENGTH_NOT_SUPPORTED_BY_EDRIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272217i32);
pub const FVE_E_KEY_PROTECTOR_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272279i32);
pub const FVE_E_KEY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272355i32);
pub const FVE_E_KEY_ROTATION_NOT_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272161i32);
pub const FVE_E_KEY_ROTATION_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272163i32);
pub const FVE_E_LIVEID_ACCOUNT_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272189i32);
...
pub const FVE_E_MULTIPLE_NKP_CERTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272227i32);
pub const FVE_E_NON_BITLOCKER_KU: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272237i32);
pub const FVE_E_NON_BITLOCKER_OID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272251i32);
pub const FVE_E_NOT_ACTIVATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272376i32);
pub const FVE_E_NOT_ALLOWED_IN_SAFE_MODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272320i32);
pub const FVE_E_NOT_ALLOWED_IN_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272301i32);
pub const FVE_E_NOT_ALLOWED_ON_CLUSTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272210i32);
pub const FVE_E_NOT_ALLOWED_ON_CSV_STACK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272211i32);
pub const FVE_E_NOT_ALLOWED_TO_UPGRADE_WHILE_CONVERTING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272205i32);
pub const FVE_E_NOT_DATA_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272359i32);
pub const FVE_E_NOT_DECRYPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272327i32);
pub const FVE_E_NOT_DE_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272169i32);
pub const FVE_E_NOT_ENCRYPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272383i32);
pub const FVE_E_NOT_ON_STACK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272310i32);
pub const FVE_E_NOT_OS_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272344i32);
pub const FVE_E_NOT_PROVISIONED_ON_ALL_VOLUMES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272188i32);
pub const FVE_E_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272363i32);
pub const FVE_E_NO_AUTOUNLOCK_MASTER_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272300i32);
pub const FVE_E_NO_BOOTMGR_METRIC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272379i32);
pub const FVE_E_NO_BOOTSECTOR_METRIC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272380i32);
pub const FVE_E_NO_EXISTING_PASSPHRASE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272216i32);
pub const FVE_E_NO_EXISTING_PIN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272224i32);
pub const FVE_E_NO_FEATURE_LICENSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272294i32);
pub const FVE_E_NO_LICENSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272311i32);
pub const FVE_E_NO_MBR_METRIC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272381i32);
pub const FVE_E_NO_PASSPHRASE_WITH_TPM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272213i32);
pub const FVE_E_NO_PREBOOT_KEYBOARD_DETECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272203i32);
pub const FVE_E_NO_PREBOOT_KEYBOARD_OR_WINRE_DETECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272202i32);
pub const FVE_E_NO_PROTECTORS_TO_TEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272325i32);
pub const FVE_E_NO_SUCH_CAPABILITY_ON_TARGET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272176i32);
pub const FVE_E_NO_TPM_BIOS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272382i32);
pub const FVE_E_NO_TPM_WITH_PASSPHRASE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272212i32);
pub const FVE_E_OPERATION_NOT_SUPPORTED_ON_VISTA_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272234i32);
pub const FVE_E_OSV_KSR_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272167i32);
pub const FVE_E_OS_NOT_PROTECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272352i32);
pub const FVE_E_OS_VOLUME_PASSPHRASE_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272275i32);
pub const FVE_E_OVERLAPPED_UPDATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272348i32);
pub const FVE_E_PASSPHRASE_PROTECTOR_CHANGE_BY_STD_USER_DISALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272191i32);
pub const FVE_E_PASSPHRASE_TOO_LONG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272214i32);
pub const FVE_E_PIN_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272317i32);
pub const FVE_E_PIN_PROTECTOR_CHANGE_BY_STD_USER_DISALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272222i32);
pub const FVE_E_POLICY_CONFLICT_FDV_RK_OFF_AUK_ON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272253i32);
pub const FVE_E_POLICY_CONFLICT_FDV_RP_OFF_ADB_ON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272239i32);
pub const FVE_E_POLICY_CONFLICT_OSV_RP_OFF_ADB_ON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272240i32);
pub const FVE_E_POLICY_CONFLICT_RDV_RK_OFF_AUK_ON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272252i32);
pub const FVE_E_POLICY_CONFLICT_RDV_RP_OFF_ADB_ON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272238i32);
pub const FVE_E_POLICY_CONFLICT_RO_AND_STARTUP_KEY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272249i32);
pub const FVE_E_POLICY_INVALID_ENHANCED_BCD_SETTINGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272194i32);
pub const FVE_E_POLICY_INVALID_PASSPHRASE_LENGTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272256i32);
pub const FVE_E_POLICY_INVALID_PIN_LENGTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272280i32);
pub const FVE_E_POLICY_ON_RDV_EXCLUSION_LIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272156i32);
pub const FVE_E_POLICY_PASSPHRASE_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272278i32);
pub const FVE_E_POLICY_PASSPHRASE_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272277i32);
pub const FVE_E_POLICY_PASSPHRASE_REQUIRES_ASCII: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272220i32);
pub const FVE_E_POLICY_PASSPHRASE_TOO_SIMPLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272255i32);
pub const FVE_E_POLICY_PASSWORD_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272340i32);
pub const FVE_E_POLICY_PROHIBITS_SELFSIGNED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272250i32);
pub const FVE_E_POLICY_RECOVERY_KEY_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272290i32);
pub const FVE_E_POLICY_RECOVERY_KEY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272289i32);
pub const FVE_E_POLICY_RECOVERY_PASSWORD_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272292i32);
pub const FVE_E_POLICY_RECOVERY_PASSWORD_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272291i32);
pub const FVE_E_POLICY_REQUIRES_RECOVERY_PASSWORD_ON_TOUCH_DEVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272200i32);
pub const FVE_E_POLICY_REQUIRES_STARTUP_PIN_ON_TOUCH_DEVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272201i32);
pub const FVE_E_POLICY_STARTUP_KEY_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272286i32);
pub const FVE_E_POLICY_STARTUP_KEY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272285i32);
pub const FVE_E_POLICY_STARTUP_PIN_KEY_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272284i32);
pub const FVE_E_POLICY_STARTUP_PIN_KEY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272283i32);
pub const FVE_E_POLICY_STARTUP_PIN_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272288i32);
pub const FVE_E_POLICY_STARTUP_PIN_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272287i32);
pub const FVE_E_POLICY_STARTUP_TPM_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272282i32);
pub const FVE_E_POLICY_STARTUP_TPM_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272281i32);
pub const FVE_E_POLICY_USER_CERTIFICATE_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272270i32);
pub const FVE_E_POLICY_USER_CERTIFICATE_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272269i32);
pub const FVE_E_POLICY_USER_CERT_MUST_BE_HW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272268i32);
pub const FVE_E_POLICY_USER_CONFIGURE_FDV_AUTOUNLOCK_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272267i32);
pub const FVE_E_POLICY_USER_CONFIGURE_RDV_AUTOUNLOCK_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272266i32);
pub const FVE_E_POLICY_USER_CONFIGURE_RDV_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272265i32);
pub const FVE_E_POLICY_USER_DISABLE_RDV_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272263i32);
pub const FVE_E_POLICY_USER_ENABLE_RDV_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272264i32);
pub const FVE_E_PREDICTED_TPM_PROTECTOR_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272155i32);
pub const FVE_E_PRIVATEKEY_AUTH_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272236i32);
pub const FVE_E_PROTECTION_CANNOT_BE_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272168i32);
pub const FVE_E_PROTECTION_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272351i32);
pub const FVE_E_PROTECTOR_CHANGE_MAX_PASSPHRASE_CHANGE_ATTEMPTS_REACHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272192i32);
pub const FVE_E_PROTECTOR_CHANGE_MAX_PIN_CHANGE_ATTEMPTS_REACHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272221i32);
pub const FVE_E_PROTECTOR_CHANGE_PASSPHRASE_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272215i32);
pub const FVE_E_PROTECTOR_CHANGE_PIN_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272223i32);
pub const FVE_E_PROTECTOR_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272335i32);
pub const FVE_E_PROTECTOR_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272333i32);
pub const FVE_E_PUBKEY_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272296i32);
pub const FVE_E_RAW_ACCESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272304i32);
pub const FVE_E_RAW_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272303i32);
pub const FVE_E_REBOOT_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272306i32);
pub const FVE_E_RECOVERY_KEY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272350i32);
pub const FVE_E_RECOVERY_PARTITION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272254i32);
pub const FVE_E_RELATIVE_PATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272334i32);
pub const FVE_E_REMOVAL_OF_DRA_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272235i32);
pub const FVE_E_REMOVAL_OF_NKP_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272226i32);
pub const FVE_E_SECUREBOOT_CONFIGURATION_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272197i32);
pub const FVE_E_SECUREBOOT_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272198i32);
pub const FVE_E_SECURE_KEY_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272377i32);
pub const FVE_E_SETUP_TPM_CALLBACK_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272154i32);
pub const FVE_E_SHADOW_COPY_PRESENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272195i32);
pub const FVE_E_SYSTEM_VOLUME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272366i32);
pub const FVE_E_TOKEN_NOT_IMPERSONATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272308i32);
pub const FVE_E_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272367i32);
pub const FVE_E_TPM_CONTEXT_SETUP_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272153i32);
pub const FVE_E_TPM_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272321i32);
pub const FVE_E_TPM_INVALID_PCR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272319i32);
pub const FVE_E_TPM_NOT_OWNED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272360i32);
pub const FVE_E_TPM_NO_VMK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272318i32);
...
pub const FVE_E_VOLUME_BOUND_ALREADY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272353i32);
pub const FVE_E_VOLUME_EXTEND_PREVENTS_EOW_DECRYPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272170i32);
pub const FVE_E_VOLUME_HANDLE_OPEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272295i32);
pub const FVE_E_VOLUME_NOT_BOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272361i32);
pub const FVE_E_VOLUME_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272273i32);
pub const FVE_E_WIPE_CANCEL_NOT_APPLICABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272199i32);
pub const FVE_E_WIPE_NOT_ALLOWED_ON_TP_STORAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272218i32);
pub const FVE_E_WRONG_BOOTMGR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272378i32);
pub const FVE_E_WRONG_BOOTSECTOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272342i32);
pub const FVE_E_WRONG_SYSTEM_FS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144272341i32);
pub const FWP_E_ACTION_INCOMPATIBLE_WITH_LAYER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206804i32);
pub const FWP_E_ACTION_INCOMPATIBLE_WITH_SUBLAYER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206803i32);
pub const FWP_E_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206839i32);
pub const FWP_E_BUILTIN_OBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206825i32);
pub const FWP_E_CALLOUT_NOTIFICATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206793i32);
pub const FWP_E_CALLOUT_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206847i32);
pub const FWP_E_CONDITION_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206846i32);
pub const FWP_E_CONNECTIONS_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206783i32);
pub const FWP_E_CONTEXT_INCOMPATIBLE_WITH_CALLOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206801i32);
pub const FWP_E_CONTEXT_INCOMPATIBLE_WITH_LAYER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206802i32);
pub const FWP_E_DROP_NOICMP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206588i32);
pub const FWP_E_DUPLICATE_AUTH_METHOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206788i32);
pub const FWP_E_DUPLICATE_CONDITION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206806i32);
pub const FWP_E_DUPLICATE_KEYMOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206805i32);
pub const FWP_E_DYNAMIC_SESSION_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206837i32);
pub const FWP_E_EM_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206798i32);
pub const FWP_E_FILTER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206845i32);
pub const FWP_E_IKEEXT_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206780i32);
pub const FWP_E_INCOMPATIBLE_AUTH_METHOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206800i32);
pub const FWP_E_INCOMPATIBLE_CIPHER_TRANSFORM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206790i32);
pub const FWP_E_INCOMPATIBLE_DH_GROUP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206799i32);
pub const FWP_E_INCOMPATIBLE_LAYER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206828i32);
pub const FWP_E_INCOMPATIBLE_SA_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206821i32);
pub const FWP_E_INCOMPATIBLE_TXN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206831i32);
pub const FWP_E_INVALID_ACTION_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206812i32);
pub const FWP_E_INVALID_AUTH_TRANSFORM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206792i32);
pub const FWP_E_INVALID_CIPHER_TRANSFORM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206791i32);
pub const FWP_E_INVALID_DNS_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206782i32);
pub const FWP_E_INVALID_ENUMERATOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206819i32);
pub const FWP_E_INVALID_FLAGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206818i32);
pub const FWP_E_INVALID_INTERVAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206815i32);
pub const FWP_E_INVALID_NET_MASK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206817i32);
pub const FWP_E_INVALID_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206795i32);
pub const FWP_E_INVALID_RANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206816i32);
pub const FWP_E_INVALID_TRANSFORM_COMBINATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206789i32);
pub const FWP_E_INVALID_TUNNEL_ENDPOINT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206787i32);
pub const FWP_E_INVALID_WEIGHT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206811i32);
pub const FWP_E_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206838i32);
pub const FWP_E_KEY_DICTATION_INVALID_KEYING_MATERIAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206784i32);
pub const FWP_E_KEY_DICTATOR_ALREADY_REGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206785i32);
pub const FWP_E_KM_CLIENTS_ONLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206827i32);
pub const FWP_E_L2_DRIVER_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206786i32);
pub const FWP_E_LAYER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206844i32);
pub const FWP_E_LIFETIME_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206826i32);
pub const FWP_E_MATCH_TYPE_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206810i32);
pub const FWP_E_NET_EVENTS_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206829i32);
pub const FWP_E_NEVER_MATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206797i32);
pub const FWP_E_NOTIFICATION_DROPPED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206823i32);
pub const FWP_E_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206840i32);
pub const FWP_E_NO_TXN_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206835i32);
pub const FWP_E_NULL_DISPLAY_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206813i32);
pub const FWP_E_NULL_POINTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206820i32);
pub const FWP_E_OUT_OF_BOUNDS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206808i32);
pub const FWP_E_PROVIDER_CONTEXT_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206796i32);
pub const FWP_E_PROVIDER_CONTEXT_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206842i32);
pub const FWP_E_PROVIDER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206843i32);
pub const FWP_E_RESERVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206807i32);
pub const FWP_E_SESSION_ABORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206832i32);
pub const FWP_E_STILL_ON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206781i32);
pub const FWP_E_SUBLAYER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206841i32);
pub const FWP_E_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206830i32);
pub const FWP_E_TOO_MANY_CALLOUTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206824i32);
pub const FWP_E_TOO_MANY_SUBLAYERS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206794i32);
pub const FWP_E_TRAFFIC_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206822i32);
pub const FWP_E_TXN_ABORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206833i32);
pub const FWP_E_TXN_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206834i32);
pub const FWP_E_TYPE_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206809i32);
pub const FWP_E_WRONG_SESSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206836i32);
pub const FWP_E_ZERO_LENGTH_ARRAY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144206814i32);
pub const GCN_E_DEFAULTNAMESPACE_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616983i32);
pub const GCN_E_MODULE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616991i32);
pub const GCN_E_NETADAPTER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616986i32);
pub const GCN_E_NETADAPTER_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616987i32);
pub const GCN_E_NETCOMPARTMENT_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616985i32);
pub const GCN_E_NETINTERFACE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616984i32);
pub const GCN_E_NO_REQUEST_HANDLERS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616990i32);
pub const GCN_E_REQUEST_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616989i32);
...
pub const HCN_E_DEGRADED_OPERATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617001i32);
pub const HCN_E_ENDPOINT_ALREADY_ATTACHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617004i32);
pub const HCN_E_ENDPOINT_NAMESPACE_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616981i32);
pub const HCN_E_ENDPOINT_NOT_ATTACHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616972i32);
pub const HCN_E_ENDPOINT_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617022i32);
pub const HCN_E_ENDPOINT_NOT_LOCAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616971i32);
pub const HCN_E_ENDPOINT_SHARING_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616995i32);
pub const HCN_E_ENTITY_HAS_REFERENCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616980i32);
pub const HCN_E_GUID_CONVERSION_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616999i32);
pub const HCN_E_ICS_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616982i32);
pub const HCN_E_INVALID_ENDPOINT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617012i32);
pub const HCN_E_INVALID_INTERNAL_PORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616979i32);
pub const HCN_E_INVALID_IP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616994i32);
pub const HCN_E_INVALID_IP_SUBNET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616973i32);
pub const HCN_E_INVALID_JSON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616997i32);
pub const HCN_E_INVALID_JSON_REFERENCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616996i32);
pub const HCN_E_INVALID_NETWORK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617014i32);
pub const HCN_E_INVALID_NETWORK_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617013i32);
pub const HCN_E_INVALID_POLICY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617011i32);
pub const HCN_E_INVALID_POLICY_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617010i32);
pub const HCN_E_INVALID_PREFIX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616976i32);
pub const HCN_E_INVALID_REMOTE_ENDPOINT_OPERATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617009i32);
pub const HCN_E_INVALID_SUBNET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616974i32);
pub const HCN_E_LAYER_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617007i32);
pub const HCN_E_LAYER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617021i32);
pub const HCN_E_MANAGER_STOPPED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616992i32);
pub const HCN_E_MAPPING_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617002i32);
pub const HCN_E_NAMESPACE_ATTACH_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616978i32);
pub const HCN_E_NETWORK_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617008i32);
pub const HCN_E_NETWORK_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617023i32);
pub const HCN_E_OBJECT_USED_AFTER_UNLOAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616975i32);
pub const HCN_E_POLICY_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617006i32);
pub const HCN_E_POLICY_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617016i32);
pub const HCN_E_PORT_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617005i32);
pub const HCN_E_PORT_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617017i32);
pub const HCN_E_REGKEY_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616998i32);
pub const HCN_E_REQUEST_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617003i32);
pub const HCN_E_SHARED_SWITCH_MODIFICATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617000i32);
pub const HCN_E_SUBNET_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617019i32);
pub const HCN_E_SWITCH_EXTENSION_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616993i32);
pub const HCN_E_SWITCH_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617020i32);
pub const HCN_E_VFP_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616969i32);
pub const HCN_E_VFP_PORTSETTING_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143617015i32);
pub const HCN_INTERFACEPARAMETERS_ALREADY_APPLIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143616970i32);
pub const HCS_E_ACCESS_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878885i32);
pub const HCS_E_CONNECTION_CLOSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878902i32);
pub const HCS_E_CONNECTION_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878903i32);
pub const HCS_E_CONNECT_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878904i32);
pub const HCS_E_GUEST_CRITICAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878884i32);
pub const HCS_E_HYPERV_NOT_INSTALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878910i32);
pub const HCS_E_IMAGE_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878911i32);
pub const HCS_E_INVALID_JSON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878899i32);
pub const HCS_E_INVALID_LAYER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878894i32);
...
pub const HCS_E_OPERATION_PENDING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878889i32);
pub const HCS_E_OPERATION_RESULT_ALLOCATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878886i32);
pub const HCS_E_OPERATION_SYSTEM_CALLBACK_ALREADY_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878887i32);
pub const HCS_E_OPERATION_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878888i32);
pub const HCS_E_PROCESS_ALREADY_STOPPED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878881i32);
pub const HCS_E_PROCESS_INFO_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878883i32);
pub const HCS_E_PROTOCOL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878895i32);
pub const HCS_E_SERVICE_DISCONNECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878882i32);
pub const HCS_E_SERVICE_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878892i32);
pub const HCS_E_SYSTEM_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878897i32);
pub const HCS_E_SYSTEM_ALREADY_STOPPED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878896i32);
pub const HCS_E_SYSTEM_NOT_CONFIGURED_FOR_OPERATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878880i32);
pub const HCS_E_SYSTEM_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878898i32);
pub const HCS_E_TERMINATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878905i32);
pub const HCS_E_TERMINATED_DURING_START: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878912i32);
pub const HCS_E_UNEXPECTED_EXIT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878906i32);
pub const HCS_E_UNKNOWN_MESSAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878901i32);
...
pub const HSP_BASE_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018945i32);
pub const HSP_BS_ERROR_MASK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128080896i32);
pub const HSP_BS_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128080641i32);
pub const HSP_DRV_ERROR_MASK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128019456i32);
pub const HSP_DRV_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128019201i32);
pub const HSP_E_ERROR_MASK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128084992i32);
pub const HSP_E_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128080897i32);
pub const HSP_KSP_ALGORITHM_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018935i32);
pub const HSP_KSP_BUFFER_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018939i32);
pub const HSP_KSP_DEVICE_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018943i32);
pub const HSP_KSP_ERROR_MASK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018944i32);
pub const HSP_KSP_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018689i32);
pub const HSP_KSP_INVALID_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018937i32);
pub const HSP_KSP_INVALID_FLAGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018936i32);
pub const HSP_KSP_INVALID_KEY_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018941i32);
pub const HSP_KSP_INVALID_KEY_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018932i32);
pub const HSP_KSP_INVALID_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018940i32);
pub const HSP_KSP_INVALID_PROVIDER_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018942i32);
pub const HSP_KSP_KEY_ALREADY_FINALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018934i32);
pub const HSP_KSP_KEY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018923i32);
pub const HSP_KSP_KEY_LOAD_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018921i32);
pub const HSP_KSP_KEY_MISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018922i32);
pub const HSP_KSP_KEY_NOT_FINALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018933i32);
pub const HSP_KSP_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018938i32);
pub const HSP_KSP_NO_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2128018928i32);
...
pub const HTTP_E_STATUS_BAD_GATEWAY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844746i32);
pub const HTTP_E_STATUS_BAD_METHOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844843i32);
pub const HTTP_E_STATUS_BAD_REQUEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844848i32);
pub const HTTP_E_STATUS_CONFLICT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844839i32);
pub const HTTP_E_STATUS_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844847i32);
pub const HTTP_E_STATUS_EXPECTATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844831i32);
pub const HTTP_E_STATUS_FORBIDDEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844845i32);
pub const HTTP_E_STATUS_GATEWAY_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844744i32);
pub const HTTP_E_STATUS_GONE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844838i32);
pub const HTTP_E_STATUS_LENGTH_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844837i32);
pub const HTTP_E_STATUS_MOVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844947i32);
pub const HTTP_E_STATUS_NONE_ACCEPTABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844842i32);
pub const HTTP_E_STATUS_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844844i32);
pub const HTTP_E_STATUS_NOT_MODIFIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844944i32);
pub const HTTP_E_STATUS_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844747i32);
pub const HTTP_E_STATUS_PAYMENT_REQ: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844846i32);
pub const HTTP_E_STATUS_PRECOND_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844836i32);
pub const HTTP_E_STATUS_PROXY_AUTH_REQ: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844841i32);
pub const HTTP_E_STATUS_RANGE_NOT_SATISFIABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844832i32);
pub const HTTP_E_STATUS_REDIRECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844946i32);
pub const HTTP_E_STATUS_REDIRECT_KEEP_VERB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844941i32);
pub const HTTP_E_STATUS_REDIRECT_METHOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844945i32);
pub const HTTP_E_STATUS_REQUEST_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844840i32);
pub const HTTP_E_STATUS_REQUEST_TOO_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844835i32);
pub const HTTP_E_STATUS_SERVER_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844748i32);
pub const HTTP_E_STATUS_SERVICE_UNAVAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844745i32);
pub const HTTP_E_STATUS_UNEXPECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145845247i32);
pub const HTTP_E_STATUS_UNEXPECTED_CLIENT_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145845244i32);
pub const HTTP_E_STATUS_UNEXPECTED_REDIRECTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145845245i32);
pub const HTTP_E_STATUS_UNEXPECTED_SERVER_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145845243i32);
pub const HTTP_E_STATUS_UNSUPPORTED_MEDIA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844833i32);
pub const HTTP_E_STATUS_URI_TOO_LONG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145844834i32);
...
pub const INPLACE_E_NOTOOLSPACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221087i32);
pub const INPLACE_E_NOTUNDOABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221088i32);
pub const INPLACE_S_FIRST: i32 = 262560i32;
pub const INPLACE_S_LAST: i32 = 262575i32;
pub const INPLACE_S_TRUNCATED: ::windows::core::HRESULT = ::windows::core::HRESULT(262560i32);
pub const INPUT_E_DEVICE_INFO: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143289338i32);
pub const INPUT_E_DEVICE_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143289336i32);
pub const INPUT_E_FRAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143289340i32);
pub const INPUT_E_HISTORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143289339i32);
pub const INPUT_E_MULTIMODAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143289342i32);
pub const INPUT_E_OUT_OF_ORDER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143289344i32);
pub const INPUT_E_PACKET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143289341i32);
pub const INPUT_E_REENTRANCY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143289343i32);
pub const INPUT_E_TRANSFORM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143289337i32);
...
pub const IORING_E_SUBMISSION_QUEUE_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2142896126i32);
pub const IORING_E_SUBMISSION_QUEUE_TOO_BIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2142896124i32);
pub const IORING_E_SUBMIT_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2142896122i32);
...
pub const MEM_E_INVALID_ROOT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959351i32);
pub const MEM_E_INVALID_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959343i32);
pub const MENROLL_S_ENROLLMENT_SUSPENDED: ::windows::core::HRESULT = ::windows::core::HRESULT(1572881i32);
pub const MILAVERR_INSUFFICIENTVIDEORESOURCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303160i32);
pub const MILAVERR_INVALIDWMPVERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303161i32);
pub const MILAVERR_MEDIAPLAYERCLOSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303155i32);
pub const MILAVERR_MODULENOTLOADED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303163i32);
pub const MILAVERR_NOCLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303168i32);
pub const MILAVERR_NOMEDIATYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303167i32);
pub const MILAVERR_NOREADYFRAMES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303164i32);
pub const MILAVERR_NOVIDEOMIXER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303166i32);
pub const MILAVERR_NOVIDEOPRESENTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303165i32);
pub const MILAVERR_REQUESTEDTEXTURETOOBIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303158i32);
pub const MILAVERR_SEEKFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303157i32);
pub const MILAVERR_UNEXPECTEDWMPFAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303156i32);
pub const MILAVERR_UNKNOWNHARDWAREERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303154i32);
pub const MILAVERR_VIDEOACCELERATIONNOTAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303159i32);
pub const MILAVERR_WMPFACTORYNOTREGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303162i32);
pub const MILEFFECTSERR_ALREADYATTACHEDTOLISTENER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302888i32);
pub const MILEFFECTSERR_CONNECTORNOTASSOCIATEDWITHEFFECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302894i32);
pub const MILEFFECTSERR_CONNECTORNOTCONNECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302895i32);
pub const MILEFFECTSERR_CYCLEDETECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302892i32);
pub const MILEFFECTSERR_EFFECTALREADYINAGRAPH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302890i32);
pub const MILEFFECTSERR_EFFECTHASNOCHILDREN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302889i32);
pub const MILEFFECTSERR_EFFECTINMORETHANONEGRAPH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302891i32);
pub const MILEFFECTSERR_EFFECTNOTPARTOFGROUP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302897i32);
pub const MILEFFECTSERR_EMPTYBOUNDS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302886i32);
pub const MILEFFECTSERR_NOINPUTSOURCEATTACHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302896i32);
pub const MILEFFECTSERR_NOTAFFINETRANSFORM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302887i32);
pub const MILEFFECTSERR_OUTPUTSIZETOOLARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302885i32);
pub const MILEFFECTSERR_RESERVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302893i32);
pub const MILEFFECTSERR_UNKNOWNPROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003302898i32);
pub const MILERR_ADAPTER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304290i32);
pub const MILERR_ALREADYLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304314i32);
pub const MILERR_ALREADY_INITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304305i32);
pub const MILERR_BADNUMBER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304438i32);
pub const MILERR_COLORSPACE_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304289i32);
pub const MILERR_DEVICECANNOTRENDERTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304312i32);
pub const MILERR_DISPLAYFORMATNOTSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304316i32);
pub const MILERR_DISPLAYID_ACCESS_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304287i32);
pub const MILERR_DISPLAYSTATEINVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304442i32);
pub const MILERR_DXGI_ENUMERATION_OUT_OF_SYNC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304291i32);
pub const MILERR_GENERIC_IGNORE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304309i32);
pub const MILERR_GLYPHBITMAPMISSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304311i32);
pub const MILERR_INSUFFICIENTBUFFER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304446i32);
pub const MILERR_INTERNALERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304320i32);
pub const MILERR_INVALIDCALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304315i32);
pub const MILERR_MALFORMEDGLYPHCACHE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304310i32);
pub const MILERR_MALFORMED_GUIDELINE_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304308i32);
pub const MILERR_MAX_TEXTURE_SIZE_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304294i32);
pub const MILERR_MISMATCHED_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304304i32);
pub const MILERR_MROW_READLOCK_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304297i32);
pub const MILERR_MROW_UPDATE_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304296i32);
pub const MILERR_NEED_RECREATE_AND_PRESENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304306i32);
pub const MILERR_NONINVERTIBLEMATRIX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304441i32);
pub const MILERR_NOTLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304313i32);
pub const MILERR_NOT_QUEUING_PRESENTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304300i32);
pub const MILERR_NO_HARDWARE_DEVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304307i32);
pub const MILERR_NO_REDIRECTION_SURFACE_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304303i32);
pub const MILERR_NO_REDIRECTION_SURFACE_RETRY_LATER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304299i32);
pub const MILERR_OBJECTBUSY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304447i32);
pub const MILERR_PREFILTER_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304288i32);
pub const MILERR_QPC_TIME_WENT_BACKWARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304293i32);
pub const MILERR_QUEUED_PRESENT_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304301i32);
pub const MILERR_REMOTING_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304302i32);
pub const MILERR_SCANNER_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304444i32);
pub const MILERR_SCREENACCESSDENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304443i32);
pub const MILERR_SHADER_COMPILE_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304295i32);
pub const MILERR_TERMINATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304439i32);
pub const MILERR_TOOMANYSHADERELEMNTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304298i32);
pub const MILERR_WIN32ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304445i32);
pub const MILERR_ZEROVECTOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003304440i32);
pub const MK_E_CANTOPENFILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221014i32);
pub const MK_E_CONNECTMANUALLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221024i32);
pub const MK_E_ENUMERATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221009i32);
pub const MK_E_EXCEEDEDDEADLINE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221023i32);
pub const MK_E_FIRST: i32 = -2147221024i32;
pub const MK_E_INTERMEDIATEINTERFACENOTSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221017i32);
pub const MK_E_INVALIDEXTENSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221018i32);
pub const MK_E_LAST: i32 = -2147221009i32;
pub const MK_E_MUSTBOTHERUSER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221013i32);
pub const MK_E_NEEDGENERIC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221022i32);
pub const MK_E_NOINVERSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221012i32);
pub const MK_E_NOOBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221019i32);
pub const MK_E_NOPREFIX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221010i32);
pub const MK_E_NOSTORAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221011i32);
pub const MK_E_NOTBINDABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221016i32);
pub const MK_E_NOTBOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221015i32);
pub const MK_E_NO_NORMALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146959353i32);
pub const MK_E_SYNTAX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221020i32);
pub const MK_E_UNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221021i32);
pub const MK_S_FIRST: i32 = 262624i32;
pub const MK_S_HIM: ::windows::core::HRESULT = ::windows::core::HRESULT(262629i32);
pub const MK_S_LAST: i32 = 262639i32;
pub const MK_S_ME: ::windows::core::HRESULT = ::windows::core::HRESULT(262628i32);
pub const MK_S_MONIKERALREADYREGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(262631i32);
pub const MK_S_REDUCED_TO_SELF: ::windows::core::HRESULT = ::windows::core::HRESULT(262626i32);
pub const MK_S_US: ::windows::core::HRESULT = ::windows::core::HRESULT(262630i32);
pub const MSDTC_E_DUPLICATE_RESOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146367743i32);
pub const MSSIPOTF_E_BADVERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865131i32);
pub const MSSIPOTF_E_BAD_FIRST_TABLE_PLACEMENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865144i32);
pub const MSSIPOTF_E_BAD_MAGICNUMBER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865148i32);
pub const MSSIPOTF_E_BAD_OFFSET_TABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865147i32);
pub const MSSIPOTF_E_CANTGETOBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865150i32);
pub const MSSIPOTF_E_CRYPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865132i32);
pub const MSSIPOTF_E_DSIG_STRUCTURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865130i32);
pub const MSSIPOTF_E_FAILED_HINTS_CHECK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865135i32);
pub const MSSIPOTF_E_FAILED_POLICY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865136i32);
pub const MSSIPOTF_E_FILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865133i32);
pub const MSSIPOTF_E_FILETOOSMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865141i32);
pub const MSSIPOTF_E_FILE_CHECKSUM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865139i32);
pub const MSSIPOTF_E_NOHEADTABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865149i32);
pub const MSSIPOTF_E_NOT_OPENTYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865134i32);
pub const MSSIPOTF_E_OUTOFMEMRANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865151i32);
pub const MSSIPOTF_E_PCONST_CHECK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865129i32);
pub const MSSIPOTF_E_STRUCTURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865128i32);
pub const MSSIPOTF_E_TABLES_OVERLAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865143i32);
pub const MSSIPOTF_E_TABLE_CHECKSUM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865140i32);
pub const MSSIPOTF_E_TABLE_LONGWORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865145i32);
pub const MSSIPOTF_E_TABLE_PADBYTES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865142i32);
pub const MSSIPOTF_E_TABLE_TAGORDER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146865146i32);
pub const NAP_E_CONFLICTING_ID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927741i32);
pub const NAP_E_ENTITY_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927730i32);
pub const NAP_E_ID_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927734i32);
pub const NAP_E_INVALID_PACKET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927743i32);
pub const NAP_E_MAXSIZE_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927733i32);
pub const NAP_E_MISMATCHED_ID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927736i32);
pub const NAP_E_MISSING_SOH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927742i32);
pub const NAP_E_NETSH_GROUPPOLICY_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927729i32);
pub const NAP_E_NOT_INITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927737i32);
pub const NAP_E_NOT_PENDING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927735i32);
pub const NAP_E_NOT_REGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927738i32);
pub const NAP_E_NO_CACHED_SOH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927740i32);
pub const NAP_E_SERVICE_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927732i32);
pub const NAP_E_SHV_CONFIG_EXISTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927727i32);
pub const NAP_E_SHV_CONFIG_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927726i32);
pub const NAP_E_SHV_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144927725i32);
...
pub const NTE_AUTHENTICATION_IGNORED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893775i32);
pub const NTE_BAD_ALGID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893816i32);
pub const NTE_BAD_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893819i32);
pub const NTE_BAD_FLAGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893815i32);
pub const NTE_BAD_HASH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893822i32);
pub const NTE_BAD_HASH_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893812i32);
pub const NTE_BAD_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893821i32);
pub const NTE_BAD_KEYSET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893802i32);
pub const NTE_BAD_KEYSET_PARAM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893793i32);
pub const NTE_BAD_KEY_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893813i32);
pub const NTE_BAD_LEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893820i32);
pub const NTE_BAD_PROVIDER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893805i32);
pub const NTE_BAD_PROV_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893804i32);
pub const NTE_BAD_PUBLIC_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893803i32);
pub const NTE_BAD_SIGNATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893818i32);
pub const NTE_BAD_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893814i32);
pub const NTE_BAD_UID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893823i32);
pub const NTE_BAD_VER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893817i32);
pub const NTE_BUFFERS_OVERLAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893781i32);
pub const NTE_BUFFER_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893784i32);
pub const NTE_DECRYPTION_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893780i32);
pub const NTE_DEVICE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893771i32);
pub const NTE_DEVICE_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893776i32);
pub const NTE_DOUBLE_ENCRYPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893806i32);
pub const NTE_ENCRYPTION_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893772i32);
pub const NTE_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893809i32);
pub const NTE_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893792i32);
pub const NTE_FIXEDPARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893787i32);
pub const NTE_HMAC_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893777i32);
pub const NTE_INCORRECT_PASSWORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893773i32);
pub const NTE_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893779i32);
pub const NTE_INVALID_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893786i32);
pub const NTE_INVALID_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893785i32);
pub const NTE_KEYSET_ENTRY_BAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893798i32);
pub const NTE_KEYSET_NOT_DEF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893799i32);
pub const NTE_NOT_ACTIVE_CONSOLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893768i32);
pub const NTE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893807i32);
pub const NTE_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893783i32);
pub const NTE_NO_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893811i32);
pub const NTE_NO_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893810i32);
pub const NTE_NO_MORE_ITEMS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893782i32);
pub const NTE_OP_OK: u32 = 0u32;
pub const NTE_PASSWORD_CHANGE_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893769i32);
pub const NTE_PERM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893808i32);
pub const NTE_PROVIDER_DLL_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893795i32);
pub const NTE_PROV_DLL_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893794i32);
pub const NTE_PROV_TYPE_ENTRY_BAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893800i32);
pub const NTE_PROV_TYPE_NOT_DEF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893801i32);
pub const NTE_PROV_TYPE_NO_MATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893797i32);
pub const NTE_SIGNATURE_FILE_BAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893796i32);
pub const NTE_SILENT_CONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893790i32);
pub const NTE_SYS_ERR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893791i32);
pub const NTE_TEMPORARY_PROFILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893788i32);
pub const NTE_TOKEN_KEYSET_STORAGE_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893789i32);
pub const NTE_UI_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893778i32);
...
pub const OLEOBJ_E_INVALIDVERB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221119i32);
pub const OLEOBJ_E_LAST: i32 = -2147221105i32;
pub const OLEOBJ_E_NOVERBS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221120i32);
pub const OLEOBJ_S_CANNOT_DOVERB_NOW: ::windows::core::HRESULT = ::windows::core::HRESULT(262529i32);
pub const OLEOBJ_S_FIRST: i32 = 262528i32;
pub const OLEOBJ_S_INVALIDHWND: ::windows::core::HRESULT = ::windows::core::HRESULT(262530i32);
pub const OLEOBJ_S_INVALIDVERB: ::windows::core::HRESULT = ::windows::core::HRESULT(262528i32);
pub const OLEOBJ_S_LAST: i32 = 262543i32;
pub const OLE_E_ADVF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221503i32);
pub const OLE_E_ADVISENOTSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221501i32);
pub const OLE_E_BLANK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221497i32);
pub const OLE_E_CANTCONVERT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221487i32);
pub const OLE_E_CANT_BINDTOSOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221494i32);
pub const OLE_E_CANT_GETMONIKER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221495i32);
pub const OLE_E_CLASSDIFF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221496i32);
pub const OLE_E_ENUM_NOMORE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221502i32);
pub const OLE_E_FIRST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221504i32);
pub const OLE_E_INVALIDHWND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221489i32);
pub const OLE_E_INVALIDRECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221491i32);
pub const OLE_E_LAST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221249i32);
pub const OLE_E_NOCACHE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221498i32);
pub const OLE_E_NOCONNECTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221500i32);
pub const OLE_E_NOSTORAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221486i32);
pub const OLE_E_NOTRUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221499i32);
pub const OLE_E_NOT_INPLACEACTIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221488i32);
pub const OLE_E_OLEVERB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221504i32);
pub const OLE_E_PROMPTSAVECANCELLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221492i32);
pub const OLE_E_STATIC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221493i32);
pub const OLE_E_WRONGCOMPOBJ: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221490i32);
pub const OLE_S_FIRST: ::windows::core::HRESULT = ::windows::core::HRESULT(262144i32);
pub const OLE_S_LAST: ::windows::core::HRESULT = ::windows::core::HRESULT(262399i32);
pub const OLE_S_MAC_CLIPFORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(262146i32);
pub const OLE_S_STATIC: ::windows::core::HRESULT = ::windows::core::HRESULT(262145i32);
pub const OLE_S_USEREG: ::windows::core::HRESULT = ::windows::core::HRESULT(262144i32);
pub const ONL_CONNECTION_COUNT_LIMIT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701811i32);
pub const ONL_E_ACCESS_DENIED_BY_TOU: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701822i32);
pub const ONL_E_ACCOUNT_LOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701817i32);
pub const ONL_E_ACCOUNT_SUSPENDED_ABUSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701813i32);
pub const ONL_E_ACCOUNT_SUSPENDED_COMPROIMISE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701814i32);
pub const ONL_E_ACCOUNT_UPDATE_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701819i32);
pub const ONL_E_ACTION_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701812i32);
pub const ONL_E_CONNECTED_ACCOUNT_CAN_NOT_SIGNOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701810i32);
pub const ONL_E_EMAIL_VERIFICATION_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701815i32);
pub const ONL_E_FORCESIGNIN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701818i32);
pub const ONL_E_INVALID_APPLICATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701821i32);
pub const ONL_E_INVALID_AUTHENTICATION_TARGET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701823i32);
pub const ONL_E_PARENTAL_CONSENT_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701816i32);
pub const ONL_E_PASSWORD_UPDATE_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701820i32);
pub const ONL_E_REQUEST_THROTTLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701808i32);
pub const ONL_E_USER_AUTHENTICATION_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2138701809i32);
pub const OR_INVALID_OID: i32 = 1911i32;
pub const OR_INVALID_OXID: i32 = 1910i32;
pub const OR_INVALID_SET: i32 = 1912i32;
pub const OSS_ACCESS_SERIALIZATION_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881517i32);
pub const OSS_API_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881495i32);
pub const OSS_BAD_ARG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881530i32);
pub const OSS_BAD_ENCRULES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881514i32);
pub const OSS_BAD_PTR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881525i32);
pub const OSS_BAD_TABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881521i32);
pub const OSS_BAD_TIME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881524i32);
pub const OSS_BAD_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881529i32);
pub const OSS_BERDER_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881494i32);
pub const OSS_CANT_CLOSE_TRACE_FILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881490i32);
pub const OSS_CANT_OPEN_TRACE_FILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881509i32);
pub const OSS_CANT_OPEN_TRACE_WINDOW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881512i32);
pub const OSS_COMPARATOR_CODE_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881499i32);
pub const OSS_COMPARATOR_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881500i32);
pub const OSS_CONSTRAINT_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881501i32);
pub const OSS_CONSTRAINT_VIOLATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881519i32);
pub const OSS_COPIER_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881502i32);
pub const OSS_DATA_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881531i32);
pub const OSS_FATAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881518i32);
pub const OSS_INDEFINITE_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881523i32);
pub const OSS_LIMITED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881526i32);
pub const OSS_MEM_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881522i32);
pub const OSS_MEM_MGR_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881498i32);
pub const OSS_MORE_BUF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881535i32);
pub const OSS_MORE_INPUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881532i32);
pub const OSS_MUTEX_NOT_CREATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881491i32);
pub const OSS_NEGATIVE_UINTEGER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881534i32);
pub const OSS_NULL_FCN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881515i32);
pub const OSS_NULL_TBL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881516i32);
pub const OSS_OID_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881510i32);
pub const OSS_OPEN_TYPE_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881492i32);
pub const OSS_OUT_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881528i32);
pub const OSS_OUT_OF_RANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881503i32);
pub const OSS_PDU_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881527i32);
pub const OSS_PDU_RANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881533i32);
pub const OSS_PDV_CODE_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881496i32);
pub const OSS_PDV_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881497i32);
pub const OSS_PER_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881493i32);
pub const OSS_REAL_CODE_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881504i32);
pub const OSS_REAL_DLL_NOT_LINKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881505i32);
pub const OSS_TABLE_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881507i32);
pub const OSS_TOO_LONG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881520i32);
pub const OSS_TRACE_FILE_ALREADY_OPEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146881508i32);
...
pub const PEER_E_ALREADY_LISTENING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995321i32);
pub const PEER_E_CANNOT_CONVERT_PEER_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140979199i32);
pub const PEER_E_CANNOT_START_SERVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995581i32);
pub const PEER_E_CERT_STORE_CORRUPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140993535i32);
pub const PEER_E_CHAIN_TOO_LONG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140993789i32);
pub const PEER_E_CIRCULAR_CHAIN_DETECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140993786i32);
pub const PEER_E_CLASSIFIER_TOO_LONG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995071i32);
pub const PEER_E_CLOUD_NAME_AMBIGUOUS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140991483i32);
pub const PEER_E_CONNECTION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995319i32);
pub const PEER_E_CONNECTION_NOT_AUTHENTICATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995318i32);
pub const PEER_E_CONNECTION_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995325i32);
pub const PEER_E_CONNECTION_REFUSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995317i32);
pub const PEER_E_CONNECT_SELF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995322i32);
pub const PEER_E_CONTACT_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140971007i32);
pub const PEER_E_DATABASE_ACCESSDENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994814i32);
pub const PEER_E_DATABASE_ALREADY_PRESENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994811i32);
pub const PEER_E_DATABASE_NOT_PRESENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994810i32);
pub const PEER_E_DBINITIALIZATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994813i32);
pub const PEER_E_DBNAME_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995567i32);
pub const PEER_E_DEFERRED_VALIDATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987344i32);
pub const PEER_E_DUPLICATE_GRAPH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995566i32);
pub const PEER_E_EVENT_HANDLE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994303i32);
pub const PEER_E_FW_BLOCKED_BY_POLICY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966903i32);
pub const PEER_E_FW_BLOCKED_BY_SHIELDS_UP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966902i32);
pub const PEER_E_FW_DECLINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966901i32);
pub const PEER_E_FW_EXCEPTION_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966904i32);
pub const PEER_E_GRAPH_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995563i32);
pub const PEER_E_GRAPH_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995565i32);
pub const PEER_E_GRAPH_SHUTTING_DOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995564i32);
pub const PEER_E_GROUPS_EXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995068i32);
pub const PEER_E_GROUP_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987246i32);
pub const PEER_E_GROUP_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987247i32);
pub const PEER_E_IDENTITY_DELETED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987232i32);
pub const PEER_E_IDENTITY_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994559i32);
pub const PEER_E_INVALID_ADDRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966905i32);
pub const PEER_E_INVALID_ATTRIBUTES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994046i32);
pub const PEER_E_INVALID_CLASSIFIER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987296i32);
pub const PEER_E_INVALID_CLASSIFIER_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987278i32);
pub const PEER_E_INVALID_CREDENTIAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987262i32);
pub const PEER_E_INVALID_CREDENTIAL_INFO: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987263i32);
pub const PEER_E_INVALID_DATABASE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995562i32);
pub const PEER_E_INVALID_FRIENDLY_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987280i32);
pub const PEER_E_INVALID_GRAPH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995568i32);
pub const PEER_E_INVALID_GROUP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987245i32);
pub const PEER_E_INVALID_GROUP_PROPERTIES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987328i32);
pub const PEER_E_INVALID_PEER_HOST_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140979198i32);
pub const PEER_E_INVALID_PEER_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987312i32);
pub const PEER_E_INVALID_RECORD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987376i32);
pub const PEER_E_INVALID_RECORD_EXPIRATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987264i32);
pub const PEER_E_INVALID_RECORD_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987261i32);
pub const PEER_E_INVALID_ROLE_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987279i32);
pub const PEER_E_INVALID_SEARCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994047i32);
pub const PEER_E_INVALID_TIME_PERIOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140993787i32);
pub const PEER_E_INVITATION_NOT_TRUSTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140993791i32);
pub const PEER_E_INVITE_CANCELLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966912i32);
pub const PEER_E_INVITE_RESPONSE_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966911i32);
pub const PEER_E_IPV6_NOT_INSTALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995583i32);
pub const PEER_E_MAX_RECORD_SIZE_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994812i32);
pub const PEER_E_NODE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995320i32);
pub const PEER_E_NOT_AUTHORIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987360i32);
pub const PEER_E_NOT_INITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995582i32);
pub const PEER_E_NOT_LICENSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995580i32);
pub const PEER_E_NOT_SIGNED_IN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966909i32);
pub const PEER_E_NO_CLOUD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140991487i32);
pub const PEER_E_NO_KEY_ACCESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995069i32);
pub const PEER_E_NO_MEMBERS_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987244i32);
pub const PEER_E_NO_MEMBER_CONNECTIONS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987243i32);
pub const PEER_E_NO_MORE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140979197i32);
pub const PEER_E_PASSWORD_DOES_NOT_MEET_POLICY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987359i32);
pub const PEER_E_PNRP_DUPLICATE_PEER_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140979195i32);
pub const PEER_E_PRIVACY_DECLINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966908i32);
pub const PEER_E_RECORD_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140994815i32);
pub const PEER_E_SERVICE_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987231i32);
pub const PEER_E_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140966907i32);
pub const PEER_E_TOO_MANY_ATTRIBUTES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995561i32);
pub const PEER_E_TOO_MANY_IDENTITIES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140995070i32);
pub const PEER_E_UNABLE_TO_LISTEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987242i32);
pub const PEER_E_UNSUPPORTED_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140987248i32);
pub const PEER_S_ALREADY_A_MEMBER: ::windows::core::HRESULT = ::windows::core::HRESULT(6488070i32);
pub const PEER_S_ALREADY_CONNECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(6496256i32);
pub const PEER_S_GRAPH_DATA_CREATED: ::windows::core::HRESULT = ::windows::core::HRESULT(6488065i32);
pub const PEER_S_NO_CONNECTIVITY: ::windows::core::HRESULT = ::windows::core::HRESULT(6488069i32);
pub const PEER_S_NO_EVENT_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(6488066i32);
pub const PEER_S_SUBSCRIPTION_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(6512640i32);
pub const PERSIST_E_NOTSELFSIZING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762741i32);
pub const PERSIST_E_SIZEDEFINITE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762743i32);
pub const PERSIST_E_SIZEINDEFINITE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762742i32);
pub const PLA_E_CABAPI_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337645i32);
pub const PLA_E_CONFLICT_INCL_EXCL_API: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337659i32);
pub const PLA_E_CREDENTIALS_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337661i32);
pub const PLA_E_DCS_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337737i32);
pub const PLA_E_DCS_IN_USE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337750i32);
pub const PLA_E_DCS_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337918i32);
pub const PLA_E_DCS_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337660i32);
pub const PLA_E_DCS_SINGLETON_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337662i32);
pub const PLA_E_DCS_START_WAIT_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337654i32);
pub const PLA_E_DC_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337655i32);
pub const PLA_E_DC_START_WAIT_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337653i32);
pub const PLA_E_EXE_ALREADY_CONFIGURED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337657i32);
pub const PLA_E_EXE_FULL_PATH_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337650i32);
pub const PLA_E_EXE_PATH_NOT_VALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337656i32);
pub const PLA_E_INVALID_SESSION_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337649i32);
pub const PLA_E_NETWORK_EXE_NOT_VALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337658i32);
pub const PLA_E_NO_DUPLICATES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337651i32);
pub const PLA_E_NO_MIN_DISK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337808i32);
pub const PLA_E_PLA_CHANNEL_NOT_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337648i32);
pub const PLA_E_PROPERTY_CONFLICT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337663i32);
pub const PLA_E_REPORT_WAIT_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337652i32);
pub const PLA_E_RULES_MANAGER_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337646i32);
pub const PLA_E_TASKSCHED_CHANNEL_NOT_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144337647i32);
...
pub const QPARSE_E_EXPECTING_COMMA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215759i32);
pub const QPARSE_E_EXPECTING_CURRENCY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215772i32);
pub const QPARSE_E_EXPECTING_DATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215773i32);
pub const QPARSE_E_EXPECTING_EOS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215760i32);
pub const QPARSE_E_EXPECTING_GUID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215771i32);
pub const QPARSE_E_EXPECTING_INTEGER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215775i32);
pub const QPARSE_E_EXPECTING_PAREN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215769i32);
pub const QPARSE_E_EXPECTING_PHRASE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215766i32);
pub const QPARSE_E_EXPECTING_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215768i32);
pub const QPARSE_E_EXPECTING_REAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215774i32);
pub const QPARSE_E_EXPECTING_REGEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215764i32);
pub const QPARSE_E_EXPECTING_REGEX_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215763i32);
pub const QPARSE_E_INVALID_GROUPING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215753i32);
pub const QPARSE_E_INVALID_LITERAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215762i32);
pub const QPARSE_E_INVALID_QUERY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215750i32);
pub const QPARSE_E_INVALID_RANKMETHOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215749i32);
pub const QPARSE_E_INVALID_SORT_ORDER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215755i32);
pub const QPARSE_E_NOT_YET_IMPLEMENTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215767i32);
pub const QPARSE_E_NO_SUCH_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215761i32);
pub const QPARSE_E_NO_SUCH_SORT_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215756i32);
pub const QPARSE_E_UNEXPECTED_EOS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215758i32);
pub const QPARSE_E_UNEXPECTED_NOT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215776i32);
pub const QPARSE_E_UNSUPPORTED_PROPERTY_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215765i32);
pub const QPARSE_E_WEIGHT_OUT_OF_RANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215757i32);
pub const QPLIST_E_BAD_GUID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215783i32);
pub const QPLIST_E_BYREF_USED_WITHOUT_PTRTYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215778i32);
pub const QPLIST_E_CANT_OPEN_FILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215791i32);
pub const QPLIST_E_CANT_SET_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215781i32);
pub const QPLIST_E_DUPLICATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215780i32);
pub const QPLIST_E_EXPECTING_CLOSE_PAREN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215785i32);
pub const QPLIST_E_EXPECTING_GUID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215784i32);
pub const QPLIST_E_EXPECTING_INTEGER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215786i32);
pub const QPLIST_E_EXPECTING_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215789i32);
pub const QPLIST_E_EXPECTING_PROP_SPEC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215782i32);
pub const QPLIST_E_EXPECTING_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215788i32);
pub const QPLIST_E_READ_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215790i32);
pub const QPLIST_E_UNRECOGNIZED_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215787i32);
pub const QPLIST_E_VECTORBYREF_USED_ALONE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215779i32);
pub const QPLIST_S_DUPLICATE: ::windows::core::HRESULT = ::windows::core::HRESULT(267897i32);
pub const QUERY_E_ALLNOISE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215867i32);
pub const QUERY_E_DIR_ON_REMOVABLE_DRIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215861i32);
pub const QUERY_E_DUPLICATE_OUTPUT_COLUMN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215864i32);
pub const QUERY_E_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215872i32);
pub const QUERY_E_INVALIDCATEGORIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215868i32);
pub const QUERY_E_INVALIDQUERY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215871i32);
pub const QUERY_E_INVALIDRESTRICTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215870i32);
pub const QUERY_E_INVALIDSORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215869i32);
pub const QUERY_E_INVALID_DIRECTORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215862i32);
pub const QUERY_E_INVALID_OUTPUT_COLUMN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215863i32);
pub const QUERY_E_TIMEDOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215865i32);
pub const QUERY_E_TOOCOMPLEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215866i32);
pub const QUERY_S_NO_QUERY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215860i32);
...
pub const REGDB_E_CLASSNOTREG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221164i32);
pub const REGDB_E_FIRST: i32 = -2147221168i32;
pub const REGDB_E_IIDNOTREG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221163i32);
pub const REGDB_E_INVALIDVALUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221165i32);
pub const REGDB_E_KEYMISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221166i32);
pub const REGDB_E_LAST: i32 = -2147221153i32;
pub const REGDB_E_PACKAGEPOLICYVIOLATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221161i32);
pub const REGDB_E_READREGDB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221168i32);
pub const REGDB_E_WRITEREGDB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147221167i32);
...
pub const RO_E_BLOCKED_CROSS_ASTA_CALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483617i32);
pub const RO_E_CANNOT_ACTIVATE_FULL_TRUST_SERVER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483616i32);
pub const RO_E_CANNOT_ACTIVATE_UNIVERSAL_APPLICATION_SERVER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483615i32);
pub const RO_E_CHANGE_NOTIFICATION_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483627i32);
pub const RO_E_CLOSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483629i32);
pub const RO_E_COMMITTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483618i32);
pub const RO_E_ERROR_STRING_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483626i32);
pub const RO_E_EXCLUSIVE_WRITE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483628i32);
pub const RO_E_INVALID_METADATA_FILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483630i32);
pub const RO_E_METADATA_INVALID_TYPE_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483631i32);
pub const RO_E_METADATA_NAME_IS_NAMESPACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483632i32);
pub const RO_E_METADATA_NAME_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483633i32);
pub const RO_E_MUST_BE_AGILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483620i32);
pub const RO_E_UNSUPPORTED_FROM_MTA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147483619i32);
pub const RPC_E_ACCESS_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417829i32);
pub const RPC_E_ATTEMPTED_MULTITHREAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417854i32);
pub const RPC_E_CALL_CANCELED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418110i32);
pub const RPC_E_CALL_COMPLETE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417833i32);
pub const RPC_E_CALL_REJECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418111i32);
pub const RPC_E_CANTCALLOUT_AGAIN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418095i32);
pub const RPC_E_CANTCALLOUT_INASYNCCALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418108i32);
pub const RPC_E_CANTCALLOUT_INEXTERNALCALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418107i32);
pub const RPC_E_CANTCALLOUT_ININPUTSYNCCALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417843i32);
pub const RPC_E_CANTPOST_INSENDCALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418109i32);
pub const RPC_E_CANTTRANSMIT_CALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418102i32);
pub const RPC_E_CHANGED_MODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417850i32);
pub const RPC_E_CLIENT_CANTMARSHAL_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418101i32);
pub const RPC_E_CLIENT_CANTUNMARSHAL_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418100i32);
pub const RPC_E_CLIENT_DIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418104i32);
pub const RPC_E_CONNECTION_TERMINATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418106i32);
pub const RPC_E_DISCONNECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417848i32);
pub const RPC_E_FAULT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417852i32);
pub const RPC_E_FULLSIC_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417823i32);
pub const RPC_E_INVALIDMETHOD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417849i32);
pub const RPC_E_INVALID_CALLDATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417844i32);
pub const RPC_E_INVALID_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418097i32);
pub const RPC_E_INVALID_DATAPACKET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418103i32);
pub const RPC_E_INVALID_EXTENSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417838i32);
pub const RPC_E_INVALID_HEADER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417839i32);
pub const RPC_E_INVALID_IPID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417837i32);
pub const RPC_E_INVALID_OBJECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417836i32);
pub const RPC_E_INVALID_OBJREF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417827i32);
pub const RPC_E_INVALID_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418096i32);
pub const RPC_E_INVALID_STD_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417822i32);
pub const RPC_E_NOT_REGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417853i32);
pub const RPC_E_NO_CONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417826i32);
pub const RPC_E_NO_GOOD_SECURITY_PACKAGES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417830i32);
pub const RPC_E_NO_SYNC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417824i32);
pub const RPC_E_OUT_OF_RESOURCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417855i32);
pub const RPC_E_REMOTE_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417828i32);
pub const RPC_E_RETRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417847i32);
pub const RPC_E_SERVERCALL_REJECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417845i32);
pub const RPC_E_SERVERCALL_RETRYLATER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417846i32);
pub const RPC_E_SERVERFAULT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417851i32);
pub const RPC_E_SERVER_CANTMARSHAL_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418099i32);
pub const RPC_E_SERVER_CANTUNMARSHAL_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418098i32);
pub const RPC_E_SERVER_DIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418105i32);
pub const RPC_E_SERVER_DIED_DNE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147418094i32);
pub const RPC_E_SYS_CALL_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417856i32);
pub const RPC_E_THREAD_NOT_INIT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417841i32);
pub const RPC_E_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417825i32);
pub const RPC_E_TOO_LATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417831i32);
pub const RPC_E_UNEXPECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147352577i32);
pub const RPC_E_UNSECURE_CALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417832i32);
pub const RPC_E_VERSION_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417840i32);
pub const RPC_E_WRONG_THREAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417842i32);
...
pub const RPC_S_CALLPENDING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417835i32);
pub const RPC_S_WAITONTIMER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147417834i32);
...
pub const SCARD_E_CANCELLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435070i32);
pub const SCARD_E_CANT_DISPOSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435058i32);
pub const SCARD_E_CARD_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435044i32);
pub const SCARD_E_CERTIFICATE_UNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435027i32);
pub const SCARD_E_COMM_DATA_LOST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435025i32);
pub const SCARD_E_DIR_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435037i32);
pub const SCARD_E_DUPLICATE_READER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435045i32);
pub const SCARD_E_FILE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435036i32);
pub const SCARD_E_ICC_CREATEORDER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435039i32);
pub const SCARD_E_ICC_INSTALLATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435040i32);
pub const SCARD_E_INSUFFICIENT_BUFFER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435064i32);
pub const SCARD_E_INVALID_ATR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435051i32);
pub const SCARD_E_INVALID_CHV: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435030i32);
pub const SCARD_E_INVALID_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435069i32);
pub const SCARD_E_INVALID_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435068i32);
pub const SCARD_E_INVALID_TARGET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435067i32);
pub const SCARD_E_INVALID_VALUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435055i32);
pub const SCARD_E_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435056i32);
pub const SCARD_E_NOT_TRANSACTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435050i32);
pub const SCARD_E_NO_ACCESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435033i32);
pub const SCARD_E_NO_DIR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435035i32);
pub const SCARD_E_NO_FILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435034i32);
pub const SCARD_E_NO_KEY_CONTAINER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435024i32);
pub const SCARD_E_NO_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435066i32);
pub const SCARD_E_NO_PIN_CACHE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435021i32);
pub const SCARD_E_NO_READERS_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435026i32);
pub const SCARD_E_NO_SERVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435043i32);
pub const SCARD_E_NO_SMARTCARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435060i32);
pub const SCARD_E_NO_SUCH_CERTIFICATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435028i32);
pub const SCARD_E_PCI_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435047i32);
pub const SCARD_E_PIN_CACHE_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435022i32);
pub const SCARD_E_PROTO_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435057i32);
pub const SCARD_E_READER_UNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435049i32);
pub const SCARD_E_READER_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435046i32);
pub const SCARD_E_READ_ONLY_CARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435020i32);
pub const SCARD_E_SERVER_TOO_BUSY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435023i32);
pub const SCARD_E_SERVICE_STOPPED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435042i32);
pub const SCARD_E_SHARING_VIOLATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435061i32);
pub const SCARD_E_SYSTEM_CANCELLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435054i32);
pub const SCARD_E_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435062i32);
pub const SCARD_E_UNEXPECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435041i32);
pub const SCARD_E_UNKNOWN_CARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435059i32);
pub const SCARD_E_UNKNOWN_READER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435063i32);
pub const SCARD_E_UNKNOWN_RES_MNG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435029i32);
pub const SCARD_E_UNSUPPORTED_FEATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435038i32);
pub const SCARD_E_WRITE_TOO_MANY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435032i32);
pub const SCARD_F_COMM_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435053i32);
pub const SCARD_F_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435071i32);
pub const SCARD_F_UNKNOWN_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435052i32);
pub const SCARD_F_WAITED_TOO_LONG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435065i32);
pub const SCARD_P_SHUTDOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146435048i32);
pub const SCARD_W_CACHE_ITEM_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434960i32);
pub const SCARD_W_CACHE_ITEM_STALE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434959i32);
pub const SCARD_W_CACHE_ITEM_TOO_BIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434958i32);
pub const SCARD_W_CANCELLED_BY_USER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434962i32);
pub const SCARD_W_CARD_NOT_AUTHENTICATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434961i32);
pub const SCARD_W_CHV_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434964i32);
pub const SCARD_W_EOF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434963i32);
pub const SCARD_W_REMOVED_CARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434967i32);
pub const SCARD_W_RESET_CARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434968i32);
pub const SCARD_W_SECURITY_VIOLATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434966i32);
pub const SCARD_W_UNPOWERED_CARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434969i32);
pub const SCARD_W_UNRESPONSIVE_CARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434970i32);
pub const SCARD_W_UNSUPPORTED_CARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434971i32);
pub const SCARD_W_WRONG_CHV: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146434965i32);
pub const SCHED_E_ACCOUNT_DBASE_CORRUPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216623i32);
pub const SCHED_E_ACCOUNT_INFORMATION_NOT_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216625i32);
pub const SCHED_E_ACCOUNT_NAME_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216624i32);
pub const SCHED_E_ALREADY_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216609i32);
pub const SCHED_E_CANNOT_OPEN_TASK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216627i32);
pub const SCHED_E_DEPRECATED_FEATURE_USED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216592i32);
pub const SCHED_E_INVALIDVALUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216616i32);
pub const SCHED_E_INVALID_TASK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216626i32);
pub const SCHED_E_INVALID_TASK_HASH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216607i32);
pub const SCHED_E_MALFORMEDXML: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216614i32);
pub const SCHED_E_MISSINGNODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216615i32);
pub const SCHED_E_NAMESPACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216617i32);
pub const SCHED_E_NO_SECURITY_SERVICES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216622i32);
pub const SCHED_E_PAST_END_BOUNDARY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216610i32);
pub const SCHED_E_SERVICE_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216606i32);
pub const SCHED_E_SERVICE_NOT_INSTALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216628i32);
pub const SCHED_E_SERVICE_NOT_LOCALSYSTEM: i32 = 6200i32;
pub const SCHED_E_SERVICE_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216619i32);
pub const SCHED_E_SERVICE_TOO_BUSY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216605i32);
pub const SCHED_E_START_ON_DEMAND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216600i32);
pub const SCHED_E_TASK_ATTEMPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216604i32);
pub const SCHED_E_TASK_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216602i32);
pub const SCHED_E_TASK_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216630i32);
pub const SCHED_E_TASK_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216629i32);
pub const SCHED_E_TASK_NOT_UBPM_COMPAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216599i32);
pub const SCHED_E_TASK_NOT_V1_COMPAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216601i32);
pub const SCHED_E_TOO_MANY_NODES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216611i32);
pub const SCHED_E_TRIGGER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216631i32);
pub const SCHED_E_UNEXPECTEDNODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216618i32);
pub const SCHED_E_UNKNOWN_OBJECT_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216621i32);
pub const SCHED_E_UNSUPPORTED_ACCOUNT_OPTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216620i32);
pub const SCHED_E_USER_NOT_LOGGED_ON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147216608i32);
pub const SCHED_S_BATCH_LOGON_PROBLEM: ::windows::core::HRESULT = ::windows::core::HRESULT(267036i32);
pub const SCHED_S_EVENT_TRIGGER: ::windows::core::HRESULT = ::windows::core::HRESULT(267016i32);
pub const SCHED_S_SOME_TRIGGERS_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(267035i32);
pub const SCHED_S_TASK_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(267010i32);
pub const SCHED_S_TASK_HAS_NOT_RUN: ::windows::core::HRESULT = ::windows::core::HRESULT(267011i32);
pub const SCHED_S_TASK_NOT_SCHEDULED: ::windows::core::HRESULT = ::windows::core::HRESULT(267013i32);
pub const SCHED_S_TASK_NO_MORE_RUNS: ::windows::core::HRESULT = ::windows::core::HRESULT(267012i32);
pub const SCHED_S_TASK_NO_VALID_TRIGGERS: ::windows::core::HRESULT = ::windows::core::HRESULT(267015i32);
pub const SCHED_S_TASK_QUEUED: ::windows::core::HRESULT = ::windows::core::HRESULT(267045i32);
pub const SCHED_S_TASK_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(267008i32);
pub const SCHED_S_TASK_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(267009i32);
pub const SCHED_S_TASK_TERMINATED: ::windows::core::HRESULT = ::windows::core::HRESULT(267014i32);
...
pub const SEARCH_E_NOMONIKER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215711i32);
pub const SEARCH_E_NOREGION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215710i32);
pub const SEARCH_S_NOMOREHITS: ::windows::core::HRESULT = ::windows::core::HRESULT(267936i32);
pub const SEC_E_ALGORITHM_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893007i32);
pub const SEC_E_APPLICATION_PROTOCOL_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892953i32);
pub const SEC_E_BAD_BINDINGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892986i32);
pub const SEC_E_BAD_PKGID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893034i32);
pub const SEC_E_BUFFER_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893023i32);
pub const SEC_E_CANNOT_INSTALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893049i32);
pub const SEC_E_CANNOT_PACK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893047i32);
pub const SEC_E_CERT_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893016i32);
pub const SEC_E_CERT_UNKNOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893017i32);
pub const SEC_E_CERT_WRONG_USAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892983i32);
pub const SEC_E_CONTEXT_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893033i32);
pub const SEC_E_CROSSREALM_DELEGATION_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892969i32);
pub const SEC_E_CRYPTO_SYSTEM_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893001i32);
pub const SEC_E_DECRYPT_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893008i32);
pub const SEC_E_DELEGATION_POLICY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892962i32);
pub const SEC_E_DELEGATION_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892987i32);
pub const SEC_E_DOWNGRADE_DETECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892976i32);
pub const SEC_E_ENCRYPT_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893015i32);
pub const SEC_E_EXT_BUFFER_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892950i32);
pub const SEC_E_ILLEGAL_MESSAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893018i32);
pub const SEC_E_INCOMPLETE_CREDENTIALS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893024i32);
pub const SEC_E_INCOMPLETE_MESSAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893032i32);
pub const SEC_E_INSUFFICIENT_BUFFERS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892949i32);
pub const SEC_E_INSUFFICIENT_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893056i32);
pub const SEC_E_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893052i32);
pub const SEC_E_INVALID_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893055i32);
pub const SEC_E_INVALID_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892963i32);
pub const SEC_E_INVALID_TOKEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893048i32);
pub const SEC_E_INVALID_UPN_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892951i32);
pub const SEC_E_ISSUING_CA_UNTRUSTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892974i32);
pub const SEC_E_ISSUING_CA_UNTRUSTED_KDC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892967i32);
pub const SEC_E_KDC_CERT_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892966i32);
pub const SEC_E_KDC_CERT_REVOKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892965i32);
pub const SEC_E_KDC_INVALID_REQUEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892992i32);
pub const SEC_E_KDC_UNABLE_TO_REFER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892991i32);
pub const SEC_E_KDC_UNKNOWN_ETYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892990i32);
pub const SEC_E_LOGON_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893044i32);
pub const SEC_E_MAX_REFERRALS_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893000i32);
pub const SEC_E_MESSAGE_ALTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893041i32);
pub const SEC_E_MULTIPLE_ACCOUNTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892985i32);
pub const SEC_E_MUST_BE_KDC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892999i32);
pub const SEC_E_MUTUAL_AUTH_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892957i32);
pub const SEC_E_NOT_OWNER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893050i32);
pub const SEC_E_NOT_SUPPORTED: i32 = -2146893054i32;
pub const SEC_E_NO_AUTHENTICATING_AUTHORITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893039i32);
pub const SEC_E_NO_CONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892959i32);
pub const SEC_E_NO_CREDENTIALS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893042i32);
pub const SEC_E_NO_IMPERSONATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893045i32);
pub const SEC_E_NO_IP_ADDRESSES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893003i32);
pub const SEC_E_NO_KERB_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892984i32);
pub const SEC_E_NO_PA_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892996i32);
pub const SEC_E_NO_S4U_PROT_SUPPORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892970i32);
pub const SEC_E_NO_SPM: i32 = -2146893052i32;
pub const SEC_E_NO_TGT_REPLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893004i32);
pub const SEC_E_OK: ::windows::core::HRESULT = ::windows::core::HRESULT(0i32);
pub const SEC_E_ONLY_HTTPS_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892955i32);
pub const SEC_E_OUT_OF_SEQUENCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893040i32);
pub const SEC_E_PKINIT_CLIENT_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892972i32);
pub const SEC_E_PKINIT_NAME_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892995i32);
pub const SEC_E_PKU2U_CERT_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892958i32);
pub const SEC_E_POLICY_NLTM_ONLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892961i32);
pub const SEC_E_QOP_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893046i32);
pub const SEC_E_REVOCATION_OFFLINE_C: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892973i32);
pub const SEC_E_REVOCATION_OFFLINE_KDC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892968i32);
pub const SEC_E_SECPKG_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893051i32);
pub const SEC_E_SECURITY_QOS_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893006i32);
pub const SEC_E_SHUTDOWN_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892993i32);
pub const SEC_E_SMARTCARD_CERT_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892971i32);
pub const SEC_E_SMARTCARD_CERT_REVOKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892975i32);
pub const SEC_E_SMARTCARD_LOGON_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892994i32);
pub const SEC_E_STRONG_CRYPTO_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892998i32);
pub const SEC_E_TARGET_UNKNOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893053i32);
pub const SEC_E_TIME_SKEW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893020i32);
pub const SEC_E_TOO_MANY_PRINCIPALS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892997i32);
pub const SEC_E_UNFINISHED_CONTEXT_DELETED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893005i32);
pub const SEC_E_UNKNOWN_CREDENTIALS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893043i32);
pub const SEC_E_UNSUPPORTED_FUNCTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893054i32);
pub const SEC_E_UNSUPPORTED_PREAUTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146892989i32);
pub const SEC_E_UNTRUSTED_ROOT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893019i32);
pub const SEC_E_WRONG_CREDENTIAL_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893002i32);
pub const SEC_E_WRONG_PRINCIPAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146893022i32);
pub const SEC_I_ASYNC_CALL_PENDING: ::windows::core::HRESULT = ::windows::core::HRESULT(590696i32);
pub const SEC_I_COMPLETE_AND_CONTINUE: ::windows::core::HRESULT = ::windows::core::HRESULT(590612i32);
pub const SEC_I_COMPLETE_NEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(590611i32);
pub const SEC_I_CONTEXT_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(590615i32);
pub const SEC_I_CONTINUE_NEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(590610i32);
pub const SEC_I_CONTINUE_NEEDED_MESSAGE_OK: ::windows::core::HRESULT = ::windows::core::HRESULT(590694i32);
pub const SEC_I_GENERIC_EXTENSION_RECEIVED: ::windows::core::HRESULT = ::windows::core::HRESULT(590614i32);
pub const SEC_I_INCOMPLETE_CREDENTIALS: ::windows::core::HRESULT = ::windows::core::HRESULT(590624i32);
pub const SEC_I_LOCAL_LOGON: ::windows::core::HRESULT = ::windows::core::HRESULT(590613i32);
pub const SEC_I_MESSAGE_FRAGMENT: ::windows::core::HRESULT = ::windows::core::HRESULT(590692i32);
pub const SEC_I_NO_LSA_CONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(590627i32);
pub const SEC_I_NO_RENEGOTIATION: ::windows::core::HRESULT = ::windows::core::HRESULT(590688i32);
pub const SEC_I_RENEGOTIATE: ::windows::core::HRESULT = ::windows::core::HRESULT(590625i32);
pub const SEC_I_SIGNATURE_NEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(590684i32);
...
pub const SPAPI_E_AUTHENTICODE_PUBLISHER_NOT_TRUSTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500029i32);
pub const SPAPI_E_AUTHENTICODE_TRUSTED_PUBLISHER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500031i32);
pub const SPAPI_E_AUTHENTICODE_TRUST_NOT_ESTABLISHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500030i32);
pub const SPAPI_E_BAD_INTERFACE_INSTALLSECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500067i32);
pub const SPAPI_E_BAD_SECTION_NAME_LINE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500607i32);
pub const SPAPI_E_BAD_SERVICE_INSTALLSECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500073i32);
pub const SPAPI_E_CANT_LOAD_CLASS_ICON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500084i32);
pub const SPAPI_E_CANT_REMOVE_DEVINST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500046i32);
pub const SPAPI_E_CLASS_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500095i32);
pub const SPAPI_E_DEVICE_INSTALLER_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500026i32);
pub const SPAPI_E_DEVICE_INSTALL_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500024i32);
pub const SPAPI_E_DEVICE_INTERFACE_ACTIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500069i32);
pub const SPAPI_E_DEVICE_INTERFACE_REMOVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500068i32);
pub const SPAPI_E_DEVINFO_DATA_LOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500077i32);
pub const SPAPI_E_DEVINFO_LIST_LOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500078i32);
pub const SPAPI_E_DEVINFO_NOT_REGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500088i32);
pub const SPAPI_E_DEVINSTALL_QUEUE_NONNATIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500048i32);
pub const SPAPI_E_DEVINST_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500089i32);
pub const SPAPI_E_DI_BAD_PATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500076i32);
pub const SPAPI_E_DI_DONT_INSTALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500053i32);
pub const SPAPI_E_DI_DO_DEFAULT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500082i32);
pub const SPAPI_E_DI_FUNCTION_OBSOLETE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500034i32);
pub const SPAPI_E_DI_NOFILECOPY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500081i32);
pub const SPAPI_E_DI_POSTPROCESSING_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500058i32);
pub const SPAPI_E_DRIVER_INSTALL_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500023i32);
pub const SPAPI_E_DRIVER_NONNATIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500044i32);
pub const SPAPI_E_DRIVER_STORE_ADD_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500025i32);
pub const SPAPI_E_DRIVER_STORE_DELETE_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500020i32);
pub const SPAPI_E_DUPLICATE_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500094i32);
pub const SPAPI_E_ERROR_NOT_INSTALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146496512i32);
pub const SPAPI_E_EXPECTED_SECTION_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500608i32);
pub const SPAPI_E_FILEQUEUE_LOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500074i32);
pub const SPAPI_E_FILE_HASH_NOT_IN_CATALOG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500021i32);
pub const SPAPI_E_GENERAL_SYNTAX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500605i32);
pub const SPAPI_E_INCORRECTLY_COPIED_INF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500041i32);
pub const SPAPI_E_INF_IN_USE_BY_DEVICES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500035i32);
pub const SPAPI_E_INVALID_CLASS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500090i32);
pub const SPAPI_E_INVALID_CLASS_INSTALLER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500083i32);
pub const SPAPI_E_INVALID_COINSTALLER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500057i32);
pub const SPAPI_E_INVALID_DEVINST_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500091i32);
pub const SPAPI_E_INVALID_FILTER_DRIVER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500052i32);
pub const SPAPI_E_INVALID_HWPROFILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500080i32);
pub const SPAPI_E_INVALID_INF_LOGCONFIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500054i32);
pub const SPAPI_E_INVALID_MACHINENAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500064i32);
pub const SPAPI_E_INVALID_PROPPAGE_PROVIDER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500060i32);
pub const SPAPI_E_INVALID_REFERENCE_STRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500065i32);
pub const SPAPI_E_INVALID_REG_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500087i32);
pub const SPAPI_E_INVALID_TARGET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500045i32);
pub const SPAPI_E_IN_WOW64: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500043i32);
pub const SPAPI_E_KEY_DOES_NOT_EXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500092i32);
pub const SPAPI_E_LINE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500350i32);
pub const SPAPI_E_MACHINE_UNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500062i32);
pub const SPAPI_E_NON_WINDOWS_DRIVER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500050i32);
pub const SPAPI_E_NON_WINDOWS_NT_DRIVER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500051i32);
pub const SPAPI_E_NOT_AN_INSTALLED_OEM_INF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500036i32);
pub const SPAPI_E_NOT_DISABLEABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500047i32);
pub const SPAPI_E_NO_ASSOCIATED_CLASS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500096i32);
pub const SPAPI_E_NO_ASSOCIATED_SERVICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500071i32);
pub const SPAPI_E_NO_AUTHENTICODE_CATALOG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500033i32);
pub const SPAPI_E_NO_BACKUP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500349i32);
pub const SPAPI_E_NO_CATALOG_FOR_OEM_INF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500049i32);
pub const SPAPI_E_NO_CLASSINSTALL_PARAMS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500075i32);
pub const SPAPI_E_NO_CLASS_DRIVER_LIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500072i32);
pub const SPAPI_E_NO_COMPAT_DRIVERS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500056i32);
pub const SPAPI_E_NO_CONFIGMGR_SERVICES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500061i32);
pub const SPAPI_E_NO_DEFAULT_DEVICE_INTERFACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500070i32);
pub const SPAPI_E_NO_DEVICE_ICON: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500055i32);
pub const SPAPI_E_NO_DEVICE_SELECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500079i32);
pub const SPAPI_E_NO_DRIVER_SELECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500093i32);
pub const SPAPI_E_NO_INF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500086i32);
pub const SPAPI_E_NO_SUCH_DEVICE_INTERFACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500059i32);
pub const SPAPI_E_NO_SUCH_DEVINST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500085i32);
pub const SPAPI_E_NO_SUCH_INTERFACE_CLASS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500066i32);
pub const SPAPI_E_ONLY_VALIDATE_VIA_AUTHENTICODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500027i32);
pub const SPAPI_E_PNP_REGISTRY_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500038i32);
pub const SPAPI_E_REMOTE_COMM_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500063i32);
pub const SPAPI_E_REMOTE_REQUEST_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500037i32);
pub const SPAPI_E_SCE_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500040i32);
pub const SPAPI_E_SECTION_NAME_TOO_LONG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500606i32);
pub const SPAPI_E_SECTION_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500351i32);
pub const SPAPI_E_SET_SYSTEM_RESTORE_POINT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500042i32);
pub const SPAPI_E_SIGNATURE_OSATTRIBUTE_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500028i32);
pub const SPAPI_E_UNKNOWN_EXCEPTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500039i32);
pub const SPAPI_E_UNRECOVERABLE_STACK_OVERFLOW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146499840i32);
pub const SPAPI_E_WRONG_INF_STYLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500352i32);
pub const SPAPI_E_WRONG_INF_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146500022i32);
pub const SQLITE_E_ABORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574332i32);
pub const SQLITE_E_ABORT_ROLLBACK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573820i32);
pub const SQLITE_E_AUTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574313i32);
pub const SQLITE_E_BUSY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574331i32);
pub const SQLITE_E_BUSY_RECOVERY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574075i32);
pub const SQLITE_E_BUSY_SNAPSHOT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573819i32);
pub const SQLITE_E_CANTOPEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574322i32);
pub const SQLITE_E_CANTOPEN_CONVPATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573298i32);
pub const SQLITE_E_CANTOPEN_FULLPATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573554i32);
pub const SQLITE_E_CANTOPEN_ISDIR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573810i32);
pub const SQLITE_E_CANTOPEN_NOTEMPDIR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574066i32);
pub const SQLITE_E_CONSTRAINT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574317i32);
pub const SQLITE_E_CONSTRAINT_CHECK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574061i32);
pub const SQLITE_E_CONSTRAINT_COMMITHOOK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573805i32);
pub const SQLITE_E_CONSTRAINT_FOREIGNKEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573549i32);
pub const SQLITE_E_CONSTRAINT_FUNCTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573293i32);
pub const SQLITE_E_CONSTRAINT_NOTNULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573037i32);
pub const SQLITE_E_CONSTRAINT_PRIMARYKEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018572781i32);
pub const SQLITE_E_CONSTRAINT_ROWID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018571757i32);
pub const SQLITE_E_CONSTRAINT_TRIGGER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018572525i32);
pub const SQLITE_E_CONSTRAINT_UNIQUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018572269i32);
pub const SQLITE_E_CONSTRAINT_VTAB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018572013i32);
pub const SQLITE_E_CORRUPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574325i32);
pub const SQLITE_E_CORRUPT_VTAB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574069i32);
pub const SQLITE_E_DONE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574235i32);
pub const SQLITE_E_EMPTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574320i32);
pub const SQLITE_E_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574335i32);
pub const SQLITE_E_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574312i32);
pub const SQLITE_E_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574323i32);
pub const SQLITE_E_INTERNAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574334i32);
pub const SQLITE_E_INTERRUPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574327i32);
pub const SQLITE_E_IOERR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574326i32);
pub const SQLITE_E_IOERR_ACCESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018570998i32);
pub const SQLITE_E_IOERR_AUTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018567677i32);
pub const SQLITE_E_IOERR_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018571510i32);
pub const SQLITE_E_IOERR_CHECKRESERVEDLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018570742i32);
pub const SQLITE_E_IOERR_CLOSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018570230i32);
pub const SQLITE_E_IOERR_CONVPATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018567670i32);
pub const SQLITE_E_IOERR_DELETE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018571766i32);
pub const SQLITE_E_IOERR_DELETE_NOENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018568438i32);
pub const SQLITE_E_IOERR_DIR_CLOSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018569974i32);
pub const SQLITE_E_IOERR_DIR_FSYNC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573046i32);
pub const SQLITE_E_IOERR_FSTAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018572534i32);
pub const SQLITE_E_IOERR_FSYNC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573302i32);
pub const SQLITE_E_IOERR_GETTEMPPATH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018567926i32);
pub const SQLITE_E_IOERR_LOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018570486i32);
pub const SQLITE_E_IOERR_MMAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018568182i32);
pub const SQLITE_E_IOERR_NOMEM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018571254i32);
pub const SQLITE_E_IOERR_RDLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018572022i32);
pub const SQLITE_E_IOERR_READ: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574070i32);
pub const SQLITE_E_IOERR_SEEK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018568694i32);
pub const SQLITE_E_IOERR_SHMLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018569206i32);
pub const SQLITE_E_IOERR_SHMMAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018568950i32);
pub const SQLITE_E_IOERR_SHMOPEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018569718i32);
pub const SQLITE_E_IOERR_SHMSIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018569462i32);
pub const SQLITE_E_IOERR_SHORT_READ: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573814i32);
pub const SQLITE_E_IOERR_TRUNCATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018572790i32);
pub const SQLITE_E_IOERR_UNLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018572278i32);
pub const SQLITE_E_IOERR_VNODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018567678i32);
pub const SQLITE_E_IOERR_WRITE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573558i32);
pub const SQLITE_E_LOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574330i32);
pub const SQLITE_E_LOCKED_SHAREDCACHE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574074i32);
pub const SQLITE_E_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574316i32);
pub const SQLITE_E_MISUSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574315i32);
pub const SQLITE_E_NOLFS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574314i32);
pub const SQLITE_E_NOMEM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574329i32);
pub const SQLITE_E_NOTADB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574310i32);
pub const SQLITE_E_NOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574324i32);
pub const SQLITE_E_NOTICE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574309i32);
pub const SQLITE_E_NOTICE_RECOVER_ROLLBACK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573797i32);
pub const SQLITE_E_NOTICE_RECOVER_WAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574053i32);
pub const SQLITE_E_PERM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574333i32);
pub const SQLITE_E_PROTOCOL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574321i32);
pub const SQLITE_E_RANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574311i32);
pub const SQLITE_E_READONLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574328i32);
pub const SQLITE_E_READONLY_CANTLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573816i32);
pub const SQLITE_E_READONLY_DBMOVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573304i32);
pub const SQLITE_E_READONLY_RECOVERY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574072i32);
pub const SQLITE_E_READONLY_ROLLBACK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018573560i32);
pub const SQLITE_E_ROW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574236i32);
pub const SQLITE_E_SCHEMA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574319i32);
pub const SQLITE_E_TOOBIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574318i32);
pub const SQLITE_E_WARNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574308i32);
pub const SQLITE_E_WARNING_AUTOINDEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2018574052i32);
pub const STATEREPOSITORY_ERROR_CACHE_CORRUPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733422i32);
pub const STATEREPOSITORY_ERROR_DICTIONARY_CORRUPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733435i32);
pub const STATEREPOSITORY_E_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733434i32);
pub const STATEREPOSITORY_E_BUSY_RECOVERY_RETRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733432i32);
pub const STATEREPOSITORY_E_BUSY_RECOVERY_TIMEOUT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733427i32);
pub const STATEREPOSITORY_E_BUSY_RETRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733433i32);
pub const STATEREPOSITORY_E_BUSY_TIMEOUT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733428i32);
pub const STATEREPOSITORY_E_CACHE_NOT_INIITALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733419i32);
pub const STATEREPOSITORY_E_CONCURRENCY_LOCKING_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733439i32);
pub const STATEREPOSITORY_E_CONFIGURATION_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733437i32);
pub const STATEREPOSITORY_E_DEPENDENCY_NOT_RESOLVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733418i32);
pub const STATEREPOSITORY_E_LOCKED_RETRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733431i32);
pub const STATEREPOSITORY_E_LOCKED_SHAREDCACHE_RETRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733430i32);
pub const STATEREPOSITORY_E_LOCKED_SHAREDCACHE_TIMEOUT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733425i32);
pub const STATEREPOSITORY_E_LOCKED_TIMEOUT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733426i32);
pub const STATEREPOSITORY_E_SERVICE_STOP_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733424i32);
pub const STATEREPOSITORY_E_STATEMENT_INPROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733438i32);
pub const STATEREPOSITORY_E_TRANSACTION_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733429i32);
pub const STATEREPOSITORY_E_UNKNOWN_SCHEMA_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733436i32);
pub const STATEREPOSITORY_TRANSACTION_CALLER_ID_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(6750227i32);
pub const STATEREPOSITORY_TRANSACTION_IN_PROGRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733420i32);
pub const STATEREPOSTORY_E_NESTED_TRANSACTION_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2140733423i32);
...
pub const STG_E_ABNORMALAPIEXIT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286790i32);
pub const STG_E_ACCESSDENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287035i32);
pub const STG_E_BADBASEADDRESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286768i32);
pub const STG_E_CANTSAVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286781i32);
pub const STG_E_CSS_AUTHENTICATION_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286266i32);
pub const STG_E_CSS_KEY_NOT_ESTABLISHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286264i32);
pub const STG_E_CSS_KEY_NOT_PRESENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286265i32);
pub const STG_E_CSS_REGION_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286262i32);
pub const STG_E_CSS_SCRAMBLED_SECTOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286263i32);
pub const STG_E_DEVICE_UNRESPONSIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286518i32);
pub const STG_E_DISKISWRITEPROTECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287021i32);
pub const STG_E_DOCFILECORRUPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286775i32);
pub const STG_E_DOCFILETOOLARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286767i32);
pub const STG_E_EXTANTMARSHALLINGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286776i32);
pub const STG_E_FILEALREADYEXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286960i32);
pub const STG_E_FILENOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287038i32);
pub const STG_E_FIRMWARE_IMAGE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286519i32);
pub const STG_E_FIRMWARE_SLOT_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286520i32);
pub const STG_E_INCOMPLETE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286527i32);
pub const STG_E_INSUFFICIENTMEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287032i32);
pub const STG_E_INUSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286784i32);
pub const STG_E_INVALIDFLAG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286785i32);
pub const STG_E_INVALIDFUNCTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287039i32);
pub const STG_E_INVALIDHANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287034i32);
pub const STG_E_INVALIDHEADER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286789i32);
pub const STG_E_INVALIDNAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286788i32);
pub const STG_E_INVALIDPARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286953i32);
pub const STG_E_INVALIDPOINTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287031i32);
pub const STG_E_LOCKVIOLATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287007i32);
pub const STG_E_MEDIUMFULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286928i32);
pub const STG_E_NOMOREFILES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287022i32);
pub const STG_E_NOTCURRENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286783i32);
pub const STG_E_NOTFILEBASEDSTORAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286777i32);
pub const STG_E_NOTSIMPLEFORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286766i32);
pub const STG_E_OLDDLL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286779i32);
pub const STG_E_OLDFORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286780i32);
pub const STG_E_PATHNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287037i32);
pub const STG_E_PROPSETMISMATCHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286800i32);
pub const STG_E_READFAULT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287010i32);
pub const STG_E_RESETS_EXHAUSTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286261i32);
pub const STG_E_REVERTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286782i32);
pub const STG_E_SEEKERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287015i32);
pub const STG_E_SHAREREQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286778i32);
pub const STG_E_SHAREVIOLATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287008i32);
pub const STG_E_STATUS_COPY_PROTECTION_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286267i32);
pub const STG_E_TERMINATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286526i32);
pub const STG_E_TOOMANYOPENFILES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287036i32);
pub const STG_E_UNIMPLEMENTEDFUNCTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286786i32);
pub const STG_E_UNKNOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147286787i32);
pub const STG_E_WRITEFAULT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147287011i32);
pub const STG_S_BLOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(197121i32);
pub const STG_S_CANNOTCONSOLIDATE: ::windows::core::HRESULT = ::windows::core::HRESULT(197126i32);
pub const STG_S_CONSOLIDATIONFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(197125i32);
pub const STG_S_CONVERTED: ::windows::core::HRESULT = ::windows::core::HRESULT(197120i32);
pub const STG_S_MONITORING: ::windows::core::HRESULT = ::windows::core::HRESULT(197123i32);
pub const STG_S_MULTIPLEOPENS: ::windows::core::HRESULT = ::windows::core::HRESULT(197124i32);
pub const STG_S_POWER_CYCLE_REQUIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(197127i32);
pub const STG_S_RETRYNOW: ::windows::core::HRESULT = ::windows::core::HRESULT(197122i32);
...
pub const S_FALSE: ::windows::core::HRESULT = ::windows::core::HRESULT(1i32);
...
pub const TBSIMP_E_CLEANUP_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796159i32);
pub const TBSIMP_E_COMMAND_CANCELED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796149i32);
pub const TBSIMP_E_COMMAND_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796143i32);
pub const TBSIMP_E_DUPLICATE_VHANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796154i32);
pub const TBSIMP_E_HASH_BAD_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796155i32);
pub const TBSIMP_E_HASH_TABLE_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796138i32);
pub const TBSIMP_E_INVALID_CONTEXT_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796158i32);
pub const TBSIMP_E_INVALID_CONTEXT_PARAM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796157i32);
pub const TBSIMP_E_INVALID_OUTPUT_POINTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796153i32);
pub const TBSIMP_E_INVALID_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796152i32);
pub const TBSIMP_E_INVALID_RESOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796140i32);
pub const TBSIMP_E_LIST_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796146i32);
pub const TBSIMP_E_LIST_NO_MORE_ITEMS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796147i32);
pub const TBSIMP_E_NOTHING_TO_UNLOAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796139i32);
pub const TBSIMP_E_NOT_ENOUGH_SPACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796145i32);
pub const TBSIMP_E_NOT_ENOUGH_TPM_CONTEXTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796144i32);
pub const TBSIMP_E_NO_EVENT_LOG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796133i32);
pub const TBSIMP_E_OUT_OF_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796148i32);
pub const TBSIMP_E_PPI_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796135i32);
pub const TBSIMP_E_RESOURCE_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796141i32);
pub const TBSIMP_E_RPC_INIT_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796151i32);
pub const TBSIMP_E_SCHEDULER_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796150i32);
pub const TBSIMP_E_TOO_MANY_RESOURCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796136i32);
pub const TBSIMP_E_TOO_MANY_TBS_CONTEXTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796137i32);
pub const TBSIMP_E_TPM_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796156i32);
pub const TBSIMP_E_TPM_INCOMPATIBLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796134i32);
pub const TBSIMP_E_UNKNOWN_ORDINAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796142i32);
pub const TBS_E_ACCESS_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845806i32);
pub const TBS_E_BAD_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845822i32);
pub const TBS_E_BUFFER_TOO_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845810i32);
pub const TBS_E_COMMAND_CANCELED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845811i32);
pub const TBS_E_INSUFFICIENT_BUFFER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845819i32);
pub const TBS_E_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845823i32);
pub const TBS_E_INVALID_CONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845820i32);
pub const TBS_E_INVALID_CONTEXT_PARAM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845817i32);
pub const TBS_E_INVALID_OUTPUT_POINTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845821i32);
pub const TBS_E_IOERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845818i32);
pub const TBS_E_NO_EVENT_LOG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845807i32);
pub const TBS_E_OWNERAUTH_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845803i32);
pub const TBS_E_PPI_FUNCTION_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845804i32);
pub const TBS_E_PPI_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845812i32);
pub const TBS_E_PROVISIONING_INCOMPLETE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845802i32);
pub const TBS_E_PROVISIONING_NOT_ALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845805i32);
pub const TBS_E_SERVICE_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845808i32);
pub const TBS_E_SERVICE_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845816i32);
pub const TBS_E_SERVICE_START_PENDING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845813i32);
pub const TBS_E_TOO_MANY_RESOURCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845814i32);
pub const TBS_E_TOO_MANY_TBS_CONTEXTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845815i32);
pub const TBS_E_TPM_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144845809i32);
pub const TPC_E_INITIALIZE_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220957i32);
pub const TPC_E_INVALID_CONFIGURATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220935i32);
pub const TPC_E_INVALID_DATA_FROM_RECOGNIZER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220934i32);
pub const TPC_E_INVALID_INPUT_RECT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220967i32);
pub const TPC_E_INVALID_PACKET_DESCRIPTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220941i32);
pub const TPC_E_INVALID_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220927i32);
pub const TPC_E_INVALID_RIGHTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220938i32);
pub const TPC_E_INVALID_STROKE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220958i32);
pub const TPC_E_NOT_RELEVANT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220942i32);
pub const TPC_E_NO_DEFAULT_TABLET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220974i32);
pub const TPC_E_OUT_OF_ORDER_CALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220937i32);
pub const TPC_E_QUEUE_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220936i32);
pub const TPC_E_RECOGNIZER_NOT_REGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220939i32);
pub const TPC_E_UNKNOWN_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147220965i32);
pub const TPC_S_INTERRUPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(262739i32);
pub const TPC_S_NO_DATA_TO_PROCESS: ::windows::core::HRESULT = ::windows::core::HRESULT(262740i32);
pub const TPC_S_TRUNCATED: ::windows::core::HRESULT = ::windows::core::HRESULT(262738i32);
pub const TPMAPI_E_ACCESS_DENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796408i32);
pub const TPMAPI_E_AUTHORIZATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796407i32);
pub const TPMAPI_E_AUTHORIZATION_REVOKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796378i32);
pub const TPMAPI_E_AUTHORIZING_KEY_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796376i32);
pub const TPMAPI_E_BUFFER_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796410i32);
pub const TPMAPI_E_EMPTY_TCG_LOG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796390i32);
pub const TPMAPI_E_ENCRYPTION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796400i32);
pub const TPMAPI_E_ENDORSEMENT_AUTH_NOT_NULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796379i32);
pub const TPMAPI_E_FIPS_RNG_CHECK_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796391i32);
pub const TPMAPI_E_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796409i32);
pub const TPMAPI_E_INVALID_AUTHORIZATION_SIGNATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796375i32);
pub const TPMAPI_E_INVALID_CONTEXT_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796406i32);
pub const TPMAPI_E_INVALID_CONTEXT_PARAMS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796395i32);
pub const TPMAPI_E_INVALID_DELEGATE_BLOB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796396i32);
pub const TPMAPI_E_INVALID_ENCODING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796402i32);
pub const TPMAPI_E_INVALID_KEY_BLOB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796394i32);
pub const TPMAPI_E_INVALID_KEY_PARAMS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796399i32);
pub const TPMAPI_E_INVALID_KEY_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796401i32);
pub const TPMAPI_E_INVALID_MIGRATION_AUTHORIZATION_BLOB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796398i32);
pub const TPMAPI_E_INVALID_OUTPUT_POINTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796413i32);
pub const TPMAPI_E_INVALID_OWNER_AUTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796392i32);
pub const TPMAPI_E_INVALID_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796412i32);
pub const TPMAPI_E_INVALID_PCR_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796393i32);
pub const TPMAPI_E_INVALID_PCR_INDEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796397i32);
pub const TPMAPI_E_INVALID_POLICYAUTH_BLOB_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796370i32);
pub const TPMAPI_E_INVALID_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796416i32);
pub const TPMAPI_E_INVALID_TCG_LOG_ENTRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796389i32);
pub const TPMAPI_E_INVALID_TPM_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796371i32);
pub const TPMAPI_E_MALFORMED_AUTHORIZATION_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796377i32);
pub const TPMAPI_E_MALFORMED_AUTHORIZATION_OTHER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796373i32);
pub const TPMAPI_E_MALFORMED_AUTHORIZATION_POLICY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796374i32);
pub const TPMAPI_E_MESSAGE_TOO_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796403i32);
pub const TPMAPI_E_NOT_ENOUGH_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796415i32);
pub const TPMAPI_E_NO_AUTHORIZATION_CHAIN_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796382i32);
pub const TPMAPI_E_NV_BITS_NOT_DEFINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796385i32);
pub const TPMAPI_E_NV_BITS_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796384i32);
pub const TPMAPI_E_OUT_OF_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796411i32);
pub const TPMAPI_E_OWNER_AUTH_NOT_NULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796380i32);
pub const TPMAPI_E_POLICY_DENIES_OPERATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796386i32);
pub const TPMAPI_E_SEALING_KEY_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796372i32);
pub const TPMAPI_E_SEALING_KEY_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796383i32);
pub const TPMAPI_E_SVN_COUNTER_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796381i32);
pub const TPMAPI_E_TBS_COMMUNICATION_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796405i32);
pub const TPMAPI_E_TCG_INVALID_DIGEST_ENTRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796387i32);
pub const TPMAPI_E_TCG_SEPARATOR_ABSENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796388i32);
pub const TPMAPI_E_TOO_MUCH_DATA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796414i32);
pub const TPMAPI_E_TPM_COMMAND_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144796404i32);
pub const TPM_20_E_ASYMMETRIC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862079i32);
pub const TPM_20_E_ATTRIBUTES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862078i32);
pub const TPM_20_E_AUTHSIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861884i32);
pub const TPM_20_E_AUTH_CONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861883i32);
pub const TPM_20_E_AUTH_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862066i32);
pub const TPM_20_E_AUTH_MISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861915i32);
pub const TPM_20_E_AUTH_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861916i32);
pub const TPM_20_E_AUTH_UNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861905i32);
pub const TPM_20_E_BAD_AUTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862046i32);
pub const TPM_20_E_BAD_CONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861872i32);
pub const TPM_20_E_BINDING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862043i32);
pub const TPM_20_E_CANCELED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859895i32);
pub const TPM_20_E_COMMAND_CODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861885i32);
pub const TPM_20_E_COMMAND_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861886i32);
pub const TPM_20_E_CONTEXT_GAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859903i32);
pub const TPM_20_E_CPHASH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861871i32);
pub const TPM_20_E_CURVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862042i32);
pub const TPM_20_E_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861920i32);
pub const TPM_20_E_ECC_CURVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861917i32);
pub const TPM_20_E_ECC_POINT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862041i32);
pub const TPM_20_E_EXCLUSIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861919i32);
pub const TPM_20_E_EXPIRED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862045i32);
pub const TPM_20_E_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861951i32);
pub const TPM_20_E_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862069i32);
pub const TPM_20_E_HASH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862077i32);
pub const TPM_20_E_HIERARCHY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862075i32);
pub const TPM_20_E_HMAC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861927i32);
pub const TPM_20_E_INITIALIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861952i32);
pub const TPM_20_E_INSUFFICIENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862054i32);
pub const TPM_20_E_INTEGRITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862049i32);
pub const TPM_20_E_KDF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862068i32);
pub const TPM_20_E_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862052i32);
pub const TPM_20_E_KEY_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862073i32);
pub const TPM_20_E_LOCALITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859897i32);
pub const TPM_20_E_LOCKOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859871i32);
pub const TPM_20_E_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859900i32);
pub const TPM_20_E_MGF: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862072i32);
pub const TPM_20_E_MODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862071i32);
pub const TPM_20_E_NEEDS_TEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861869i32);
pub const TPM_20_E_NONCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862065i32);
pub const TPM_20_E_NO_RESULT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861868i32);
pub const TPM_20_E_NV_AUTHORIZATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861879i32);
pub const TPM_20_E_NV_DEFINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861876i32);
pub const TPM_20_E_NV_LOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861880i32);
pub const TPM_20_E_NV_RANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861882i32);
pub const TPM_20_E_NV_RATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859872i32);
pub const TPM_20_E_NV_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861881i32);
pub const TPM_20_E_NV_SPACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861877i32);
pub const TPM_20_E_NV_UNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859869i32);
pub const TPM_20_E_NV_UNINITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861878i32);
pub const TPM_20_E_OBJECT_HANDLES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859898i32);
pub const TPM_20_E_OBJECT_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859902i32);
pub const TPM_20_E_PARENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861870i32);
pub const TPM_20_E_PCR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861913i32);
pub const TPM_20_E_PCR_CHANGED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861912i32);
pub const TPM_20_E_POLICY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861914i32);
pub const TPM_20_E_POLICY_CC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862044i32);
pub const TPM_20_E_POLICY_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862051i32);
pub const TPM_20_E_PP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862064i32);
pub const TPM_20_E_PRIVATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861941i32);
pub const TPM_20_E_RANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862067i32);
pub const TPM_20_E_REBOOT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861904i32);
pub const TPM_20_E_RESERVED_BITS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862047i32);
pub const TPM_20_E_RETRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859870i32);
pub const TPM_20_E_SCHEME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862062i32);
pub const TPM_20_E_SELECTOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862056i32);
pub const TPM_20_E_SENSITIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861867i32);
pub const TPM_20_E_SEQUENCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861949i32);
pub const TPM_20_E_SESSION_HANDLES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859899i32);
pub const TPM_20_E_SESSION_MEMORY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859901i32);
pub const TPM_20_E_SIGNATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862053i32);
pub const TPM_20_E_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862059i32);
pub const TPM_20_E_SYMMETRIC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862058i32);
pub const TPM_20_E_TAG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862057i32);
pub const TPM_20_E_TESTING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859894i32);
pub const TPM_20_E_TICKET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862048i32);
pub const TPM_20_E_TOO_MANY_CONTEXTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861906i32);
pub const TPM_20_E_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862070i32);
pub const TPM_20_E_UNBALANCED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861903i32);
pub const TPM_20_E_UPGRADE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861907i32);
pub const TPM_20_E_VALUE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862076i32);
pub const TPM_20_E_YIELDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144859896i32);
pub const TPM_E_AREA_LOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862148i32);
pub const TPM_E_ATTESTATION_CHALLENGE_NOT_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795630i32);
pub const TPM_E_AUDITFAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862204i32);
pub const TPM_E_AUDITFAIL_SUCCESSFUL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862159i32);
pub const TPM_E_AUDITFAIL_UNSUCCESSFUL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862160i32);
pub const TPM_E_AUTH2FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862179i32);
pub const TPM_E_AUTHFAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862207i32);
pub const TPM_E_AUTH_CONFLICT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862149i32);
pub const TPM_E_BADCONTEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862118i32);
pub const TPM_E_BADINDEX: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862206i32);
pub const TPM_E_BADTAG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862178i32);
pub const TPM_E_BAD_ATTRIBUTES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862142i32);
pub const TPM_E_BAD_COUNTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862139i32);
pub const TPM_E_BAD_DATASIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862165i32);
pub const TPM_E_BAD_DELEGATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862119i32);
pub const TPM_E_BAD_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862120i32);
pub const TPM_E_BAD_KEY_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862168i32);
pub const TPM_E_BAD_LOCALITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862147i32);
pub const TPM_E_BAD_MIGRATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862167i32);
pub const TPM_E_BAD_MODE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862164i32);
pub const TPM_E_BAD_ORDINAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862198i32);
pub const TPM_E_BAD_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862205i32);
pub const TPM_E_BAD_PARAM_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862183i32);
pub const TPM_E_BAD_PRESENCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862163i32);
pub const TPM_E_BAD_SCHEME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862166i32);
pub const TPM_E_BAD_SIGNATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862110i32);
pub const TPM_E_BAD_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862156i32);
pub const TPM_E_BAD_VERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862162i32);
pub const TPM_E_BUFFER_LENGTH_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795618i32);
pub const TPM_E_CLAIM_TYPE_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795620i32);
pub const TPM_E_CLEAR_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862203i32);
pub const TPM_E_COMMAND_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861184i32);
pub const TPM_E_CONTEXT_GAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862137i32);
pub const TPM_E_DAA_INPUT_DATA0: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862127i32);
pub const TPM_E_DAA_INPUT_DATA1: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862126i32);
pub const TPM_E_DAA_ISSUER_SETTINGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862125i32);
pub const TPM_E_DAA_ISSUER_VALIDITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862122i32);
pub const TPM_E_DAA_RESOURCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862128i32);
pub const TPM_E_DAA_STAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862123i32);
pub const TPM_E_DAA_TPM_SETTINGS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862124i32);
pub const TPM_E_DAA_WRONG_W: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862121i32);
pub const TPM_E_DEACTIVATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862202i32);
pub const TPM_E_DECRYPT_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862175i32);
pub const TPM_E_DEFEND_LOCK_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144860157i32);
pub const TPM_E_DELEGATE_ADMIN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862131i32);
pub const TPM_E_DELEGATE_FAMILY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862132i32);
pub const TPM_E_DELEGATE_LOCK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862133i32);
pub const TPM_E_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862201i32);
pub const TPM_E_DISABLED_CMD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862200i32);
pub const TPM_E_DOING_SELFTEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144860158i32);
pub const TPM_E_DUPLICATE_VHANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861182i32);
pub const TPM_E_EMBEDDED_COMMAND_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861181i32);
pub const TPM_E_EMBEDDED_COMMAND_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861180i32);
pub const TPM_E_ENCRYPT_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862176i32);
pub const TPM_E_ERROR_MASK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862208i32);
pub const TPM_E_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862199i32);
pub const TPM_E_FAILEDSELFTEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862180i32);
pub const TPM_E_FAMILYCOUNT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862144i32);
pub const TPM_E_INAPPROPRIATE_ENC: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862194i32);
pub const TPM_E_INAPPROPRIATE_SIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862169i32);
pub const TPM_E_INSTALL_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862197i32);
pub const TPM_E_INVALID_AUTHHANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862174i32);
pub const TPM_E_INVALID_FAMILY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862153i32);
pub const TPM_E_INVALID_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144861183i32);
pub const TPM_E_INVALID_KEYHANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862196i32);
pub const TPM_E_INVALID_KEYUSAGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862172i32);
pub const TPM_E_INVALID_OWNER_AUTH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795135i32);
pub const TPM_E_INVALID_PCR_INFO: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862192i32);
pub const TPM_E_INVALID_POSTINIT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862170i32);
pub const TPM_E_INVALID_RESOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862155i32);
pub const TPM_E_INVALID_STRUCTURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862141i32);
pub const TPM_E_IOERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862177i32);
pub const TPM_E_KEYNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862195i32);
pub const TPM_E_KEY_ALREADY_FINALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795628i32);
pub const TPM_E_KEY_NOTSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862150i32);
pub const TPM_E_KEY_NOT_AUTHENTICATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795624i32);
pub const TPM_E_KEY_NOT_FINALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795631i32);
pub const TPM_E_KEY_NOT_LOADED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795633i32);
pub const TPM_E_KEY_NOT_SIGNING_KEY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795622i32);
pub const TPM_E_KEY_OWNER_CONTROL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862140i32);
pub const TPM_E_KEY_USAGE_POLICY_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795626i32);
pub const TPM_E_KEY_USAGE_POLICY_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795627i32);
pub const TPM_E_LOCKED_OUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795621i32);
pub const TPM_E_MAXNVWRITES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862136i32);
pub const TPM_E_MA_AUTHORITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862113i32);
pub const TPM_E_MA_DESTINATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862115i32);
pub const TPM_E_MA_SOURCE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862114i32);
pub const TPM_E_MA_TICKET_SIGNATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862116i32);
pub const TPM_E_MIGRATEFAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862193i32);
pub const TPM_E_NEEDS_SELFTEST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144860159i32);
pub const TPM_E_NOCONTEXTSPACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862109i32);
pub const TPM_E_NOOPERATOR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862135i32);
pub const TPM_E_NOSPACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862191i32);
pub const TPM_E_NOSRK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862190i32);
pub const TPM_E_NOTFIPS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862154i32);
pub const TPM_E_NOTLOCAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862157i32);
pub const TPM_E_NOTRESETABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862158i32);
pub const TPM_E_NOTSEALED_BLOB: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862189i32);
pub const TPM_E_NOT_FULLWRITE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862138i32);
pub const TPM_E_NOT_PCR_BOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795629i32);
pub const TPM_E_NO_ENDORSEMENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862173i32);
pub const TPM_E_NO_KEY_CERTIFICATION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795632i32);
pub const TPM_E_NO_NV_PERMISSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862152i32);
pub const TPM_E_NO_WRAP_TRANSPORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862161i32);
pub const TPM_E_OWNER_CONTROL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862129i32);
pub const TPM_E_OWNER_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862188i32);
pub const TPM_E_PCP_AUTHENTICATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795640i32);
pub const TPM_E_PCP_AUTHENTICATION_IGNORED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795639i32);
pub const TPM_E_PCP_BUFFER_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795642i32);
pub const TPM_E_PCP_DEVICE_NOT_READY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795647i32);
pub const TPM_E_PCP_ERROR_MASK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795648i32);
pub const TPM_E_PCP_FLAG_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795644i32);
pub const TPM_E_PCP_IFX_RSA_KEY_CREATION_BLOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795617i32);
pub const TPM_E_PCP_INTERNAL_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795641i32);
pub const TPM_E_PCP_INVALID_HANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795646i32);
pub const TPM_E_PCP_INVALID_PARAMETER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795645i32);
pub const TPM_E_PCP_KEY_HANDLE_INVALIDATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795614i32);
pub const TPM_E_PCP_KEY_NOT_AIK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795623i32);
pub const TPM_E_PCP_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795643i32);
pub const TPM_E_PCP_PLATFORM_CLAIM_MAY_BE_OUTDATED: ::windows::core::HRESULT = ::windows::core::HRESULT(1076429860i32);
pub const TPM_E_PCP_PLATFORM_CLAIM_OUTDATED: ::windows::core::HRESULT = ::windows::core::HRESULT(1076429861i32);
pub const TPM_E_PCP_PLATFORM_CLAIM_REBOOT: ::windows::core::HRESULT = ::windows::core::HRESULT(1076429862i32);
pub const TPM_E_PCP_POLICY_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795638i32);
pub const TPM_E_PCP_PROFILE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795637i32);
pub const TPM_E_PCP_RAW_POLICY_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795615i32);
pub const TPM_E_PCP_TICKET_MISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795616i32);
pub const TPM_E_PCP_UNSUPPORTED_PSS_SALT: ::windows::core::HRESULT = ::windows::core::HRESULT(1076429859i32);
pub const TPM_E_PCP_VALIDATION_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795636i32);
pub const TPM_E_PCP_WRONG_PARENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795634i32);
pub const TPM_E_PERMANENTEK: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862111i32);
pub const TPM_E_PER_NOWRITE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862145i32);
pub const TPM_E_PPI_ACPI_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795904i32);
pub const TPM_E_PPI_BIOS_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795902i32);
pub const TPM_E_PPI_BLOCKED_IN_BIOS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795900i32);
pub const TPM_E_PPI_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795901i32);
pub const TPM_E_PPI_USER_ABORT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795903i32);
pub const TPM_E_PROVISIONING_INCOMPLETE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795136i32);
pub const TPM_E_READ_ONLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862146i32);
pub const TPM_E_REQUIRES_SIGN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862151i32);
pub const TPM_E_RESOURCEMISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862134i32);
pub const TPM_E_RESOURCES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862187i32);
pub const TPM_E_RETRY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144860160i32);
pub const TPM_E_SHA_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862181i32);
pub const TPM_E_SHA_THREAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862182i32);
pub const TPM_E_SHORTRANDOM: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862186i32);
pub const TPM_E_SIZE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862185i32);
pub const TPM_E_SOFT_KEY_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144795625i32);
pub const TPM_E_TOOMANYCONTEXTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862117i32);
...
pub const TPM_E_WRITE_LOCKED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862143i32);
pub const TPM_E_WRONGPCRVAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862184i32);
pub const TPM_E_WRONG_ENTITYTYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144862171i32);
...
pub const TRUST_E_BASIC_CONSTRAINTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146869223i32);
pub const TRUST_E_CERT_SIGNATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146869244i32);
pub const TRUST_E_COUNTER_SIGNER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146869245i32);
pub const TRUST_E_EXPLICIT_DISTRUST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762479i32);
pub const TRUST_E_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762485i32);
pub const TRUST_E_FINANCIAL_CRITERIA: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146869218i32);
pub const TRUST_E_MALFORMED_SIGNATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146869231i32);
pub const TRUST_E_NOSIGNATURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762496i32);
pub const TRUST_E_NO_SIGNER_CERT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146869246i32);
pub const TRUST_E_PROVIDER_UNKNOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762751i32);
pub const TRUST_E_SUBJECT_FORM_UNKNOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762749i32);
pub const TRUST_E_SUBJECT_NOT_TRUSTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146762748i32);
pub const TRUST_E_SYSTEM_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146869247i32);
pub const TRUST_E_TIME_STAMP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2146869243i32);
pub const TYPE_E_AMBIGUOUSNAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319764i32);
pub const TYPE_E_BADMODULEKIND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147317571i32);
pub const TYPE_E_BUFFERTOOSMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319786i32);
pub const TYPE_E_CANTCREATETMPFILE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147316573i32);
pub const TYPE_E_CANTLOADLIBRARY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147312566i32);
pub const TYPE_E_CIRCULARTYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147312508i32);
pub const TYPE_E_DLLFUNCTIONNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319761i32);
pub const TYPE_E_DUPLICATEID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147317562i32);
pub const TYPE_E_ELEMENTNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319765i32);
pub const TYPE_E_FIELDNOTFOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319785i32);
pub const TYPE_E_INCONSISTENTPROPFUNCS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147312509i32);
pub const TYPE_E_INVALIDID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147317553i32);
pub const TYPE_E_INVALIDSTATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319767i32);
pub const TYPE_E_INVDATAREAD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319784i32);
pub const TYPE_E_IOERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147316574i32);
pub const TYPE_E_LIBNOTREGISTERED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319779i32);
pub const TYPE_E_NAMECONFLICT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319763i32);
pub const TYPE_E_OUTOFBOUNDS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147316575i32);
pub const TYPE_E_QUALIFIEDNAMEDISALLOWED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319768i32);
pub const TYPE_E_REGISTRYACCESS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319780i32);
pub const TYPE_E_SIZETOOBIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147317563i32);
pub const TYPE_E_TYPEMISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147316576i32);
pub const TYPE_E_UNDEFINEDTYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319769i32);
pub const TYPE_E_UNKNOWNLCID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319762i32);
pub const TYPE_E_UNSUPFORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319783i32);
pub const TYPE_E_WRONGTYPEKIND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147319766i32);
pub const UCEERR_BLOCKSFULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303415i32);
pub const UCEERR_CHANNELSYNCABANDONED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303404i32);
pub const UCEERR_CHANNELSYNCTIMEDOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303405i32);
pub const UCEERR_COMMANDTRANSPORTDENIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303400i32);
pub const UCEERR_CONNECTIONIDLOOKUPFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303416i32);
pub const UCEERR_CTXSTACKFRSTTARGETNULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303417i32);
pub const UCEERR_FEEDBACK_UNSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303401i32);
pub const UCEERR_GRAPHICSSTREAMALREADYOPEN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303392i32);
pub const UCEERR_GRAPHICSSTREAMUNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303399i32);
pub const UCEERR_HANDLELOOKUPFAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303419i32);
pub const UCEERR_ILLEGALHANDLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303420i32);
pub const UCEERR_ILLEGALPACKET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303422i32);
pub const UCEERR_ILLEGALRECORDTYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303412i32);
pub const UCEERR_INVALIDPACKETHEADER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303424i32);
pub const UCEERR_MALFORMEDPACKET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303421i32);
pub const UCEERR_MEMORYFAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303414i32);
pub const UCEERR_MISSINGBEGINCOMMAND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303406i32);
pub const UCEERR_MISSINGENDCOMMAND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303407i32);
pub const UCEERR_NO_MULTIPLE_WORKER_THREADS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303409i32);
pub const UCEERR_OUTOFHANDLES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303411i32);
pub const UCEERR_PACKETRECORDOUTOFRANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303413i32);
pub const UCEERR_PARTITION_ZOMBIED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303389i32);
pub const UCEERR_REMOTINGNOTSUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303408i32);
pub const UCEERR_RENDERTHREADFAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303418i32);
pub const UCEERR_TRANSPORTDISCONNECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303391i32);
pub const UCEERR_TRANSPORTOVERLOADED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303390i32);
pub const UCEERR_TRANSPORTUNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303402i32);
pub const UCEERR_UNCHANGABLE_UPDATE_ATTEMPTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303410i32);
pub const UCEERR_UNKNOWNPACKET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303423i32);
pub const UCEERR_UNSUPPORTEDTRANSPORTVERSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2003303403i32);
pub const UI_E_AMBIGUOUS_MATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731126i32);
pub const UI_E_BOOLEAN_EXPECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731128i32);
pub const UI_E_CREATE_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731135i32);
pub const UI_E_DIFFERENT_OWNER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731127i32);
pub const UI_E_END_KEYFRAME_NOT_DETERMINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730876i32);
pub const UI_E_FP_OVERFLOW: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731125i32);
pub const UI_E_ILLEGAL_REENTRANCY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731133i32);
pub const UI_E_INVALID_DIMENSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730869i32);
pub const UI_E_INVALID_OUTPUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731129i32);
pub const UI_E_LOOPS_OVERLAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730875i32);
pub const UI_E_OBJECT_SEALED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731132i32);
pub const UI_E_PRIMITIVE_OUT_OF_BOUNDS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730868i32);
pub const UI_E_SHUTDOWN_CALLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731134i32);
pub const UI_E_START_KEYFRAME_AFTER_END: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730877i32);
pub const UI_E_STORYBOARD_ACTIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730879i32);
pub const UI_E_STORYBOARD_NOT_PLAYING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730878i32);
pub const UI_E_TIMER_CLIENT_ALREADY_CONNECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730870i32);
pub const UI_E_TIME_BEFORE_LAST_UPDATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730871i32);
pub const UI_E_TRANSITION_ALREADY_USED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730874i32);
pub const UI_E_TRANSITION_ECLIPSED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730872i32);
pub const UI_E_TRANSITION_NOT_IN_STORYBOARD: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144730873i32);
pub const UI_E_VALUE_NOT_DETERMINED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731130i32);
pub const UI_E_VALUE_NOT_SET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2144731131i32);
...
pub const UTC_E_AGENT_DIAGNOSTICS_TOO_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128363i32);
pub const UTC_E_ALTERNATIVE_TRACE_CANNOT_PREEMPT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128446i32);
pub const UTC_E_AOT_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128445i32);
pub const UTC_E_API_BUSY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128405i32);
pub const UTC_E_API_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128388i32);
pub const UTC_E_API_RESULT_UNAVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128408i32);
pub const UTC_E_BINARY_MISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128396i32);
pub const UTC_E_CANNOT_LOAD_SCENARIO_EDITOR_XML: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128417i32);
pub const UTC_E_CERT_REV_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128385i32);
pub const UTC_E_CHILD_PROCESS_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128419i32);
pub const UTC_E_COMMAND_LINE_NOT_AUTHORIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128418i32);
pub const UTC_E_DELAY_TERMINATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128411i32);
pub const UTC_E_DEVICE_TICKET_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128410i32);
pub const UTC_E_DIAGRULES_SCHEMAVERSION_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128438i32);
pub const UTC_E_ESCALATION_ALREADY_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128433i32);
pub const UTC_E_ESCALATION_CANCELLED_AT_SHUTDOWN: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128358i32);
pub const UTC_E_ESCALATION_DIRECTORY_ALREADY_EXISTS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128401i32);
pub const UTC_E_ESCALATION_NOT_AUTHORIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128421i32);
pub const UTC_E_ESCALATION_TIMED_OUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128416i32);
pub const UTC_E_EVENTLOG_ENTRY_MALFORMED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128439i32);
pub const UTC_E_EXCLUSIVITY_NOT_AVAILABLE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128403i32);
pub const UTC_E_EXE_TERMINATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128422i32);
pub const UTC_E_FAILED_TO_RECEIVE_AGENT_DIAGNOSTICS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128362i32);
pub const UTC_E_FAILED_TO_RESOLVE_CONTAINER_ID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128394i32);
pub const UTC_E_FAILED_TO_START_NDISCAP: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128384i32);
pub const UTC_E_FILTER_FUNCTION_RESTRICTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128376i32);
pub const UTC_E_FILTER_ILLEGAL_EVAL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128365i32);
pub const UTC_E_FILTER_INVALID_COMMAND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128366i32);
pub const UTC_E_FILTER_INVALID_FUNCTION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128368i32);
pub const UTC_E_FILTER_INVALID_FUNCTION_PARAMS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128367i32);
pub const UTC_E_FILTER_INVALID_TYPE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128378i32);
pub const UTC_E_FILTER_MISSING_ATTRIBUTE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128379i32);
pub const UTC_E_FILTER_VARIABLE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128377i32);
pub const UTC_E_FILTER_VERSION_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128375i32);
pub const UTC_E_FORWARDER_ALREADY_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128440i32);
pub const UTC_E_FORWARDER_ALREADY_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128441i32);
pub const UTC_E_FORWARDER_PRODUCER_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128430i32);
pub const UTC_E_GETFILEINFOACTION_FILE_NOT_APPROVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128357i32);
pub const UTC_E_GETFILE_EXTERNAL_PATH_NOT_APPROVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128387i32);
pub const UTC_E_GETFILE_FILE_PATH_NOT_APPROVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128402i32);
pub const UTC_E_INSUFFICIENT_SPACE_TO_START_TRACE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128359i32);
pub const UTC_E_INTENTIONAL_SCRIPT_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128429i32);
pub const UTC_E_INVALID_AGGREGATION_STRUCT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128381i32);
pub const UTC_E_INVALID_CUSTOM_FILTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128436i32);
pub const UTC_E_INVALID_FILTER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128423i32);
pub const UTC_E_KERNELDUMP_LIMIT_REACHED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128383i32);
pub const UTC_E_MISSING_AGGREGATE_EVENT_TAG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128382i32);
pub const UTC_E_MULTIPLE_TIME_TRIGGER_ON_SINGLE_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128397i32);
pub const UTC_E_NO_WER_LOGGER_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128427i32);
pub const UTC_E_PERFTRACK_ALREADY_TRACING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128432i32);
pub const UTC_E_REACHED_MAX_ESCALATIONS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128431i32);
pub const UTC_E_REESCALATED_TOO_QUICKLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128434i32);
pub const UTC_E_RPC_TIMEOUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128407i32);
pub const UTC_E_RPC_WAIT_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128406i32);
pub const UTC_E_SCENARIODEF_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128443i32);
pub const UTC_E_SCENARIODEF_SCHEMAVERSION_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128424i32);
pub const UTC_E_SCENARIO_HAS_NO_ACTIONS: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128361i32);
pub const UTC_E_SCENARIO_THROTTLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128389i32);
pub const UTC_E_SCRIPT_MISSING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128390i32);
pub const UTC_E_SCRIPT_TERMINATED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128437i32);
pub const UTC_E_SCRIPT_TYPE_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128444i32);
pub const UTC_E_SETREGKEYACTION_TYPE_NOT_APPROVED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128356i32);
pub const UTC_E_SETUP_NOT_AUTHORIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128420i32);
pub const UTC_E_SETUP_TIMED_OUT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128415i32);
pub const UTC_E_SIF_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128412i32);
pub const UTC_E_SQM_INIT_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128428i32);
pub const UTC_E_THROTTLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128392i32);
pub const UTC_E_TIME_TRIGGER_INVALID_TIME_RANGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128398i32);
pub const UTC_E_TIME_TRIGGER_ONLY_VALID_ON_SINGLE_TRANSITION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128399i32);
pub const UTC_E_TIME_TRIGGER_ON_START_INVALID: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128400i32);
pub const UTC_E_TOGGLE_TRACE_STARTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128447i32);
pub const UTC_E_TRACEPROFILE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128442i32);
pub const UTC_E_TRACERS_DONT_EXIST: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128426i32);
pub const UTC_E_TRACE_BUFFER_LIMIT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128409i32);
pub const UTC_E_TRACE_MIN_DURATION_REQUIREMENT_NOT_MET: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128404i32);
pub const UTC_E_TRACE_NOT_RUNNING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128435i32);
pub const UTC_E_TRACE_THROTTLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128355i32);
pub const UTC_E_TRIGGER_MISMATCH: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128414i32);
pub const UTC_E_TRIGGER_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128413i32);
pub const UTC_E_TRY_GET_SCENARIO_TIMEOUT_EXCEEDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128386i32);
pub const UTC_E_TTTRACER_RETURNED_ERROR: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128364i32);
pub const UTC_E_TTTRACER_STORAGE_FULL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128360i32);
pub const UTC_E_UNABLE_TO_RESOLVE_SESSION: ::windows::core::HRESULT = ::windows::core::HRESULT(-2017128393i32);
...
pub const VIEW_S_ALREADY_FROZEN: ::windows::core::HRESULT = ::windows::core::HRESULT(262464i32);
pub const VIEW_S_FIRST: i32 = 262464i32;
pub const VIEW_S_LAST: i32 = 262479i32;
pub const VM_SAVED_STATE_DUMP_E_GUEST_MEMORY_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-1070136063i32);
pub const VM_SAVED_STATE_DUMP_E_INVALID_VP_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1070136058i32);
pub const VM_SAVED_STATE_DUMP_E_NESTED_VIRTUALIZATION_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1070136061i32);
pub const VM_SAVED_STATE_DUMP_E_NO_VP_FOUND_IN_PARTITION_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-1070136062i32);
pub const VM_SAVED_STATE_DUMP_E_PARTITION_STATE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-1070136064i32);
pub const VM_SAVED_STATE_DUMP_E_VA_NOT_MAPPED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1070136059i32);
pub const VM_SAVED_STATE_DUMP_E_VP_VTL_NOT_ENABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-1070136055i32);
...
pub const WBREAK_E_BUFFER_TOO_SMALL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215485i32);
pub const WBREAK_E_END_OF_TEXT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215488i32);
pub const WBREAK_E_INIT_FAILED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215483i32);
pub const WBREAK_E_QUERY_ONLY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2147215486i32);
pub const WEB_E_INVALID_JSON_NUMBER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089484280i32);
pub const WEB_E_INVALID_JSON_STRING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089484281i32);
pub const WEB_E_INVALID_XML: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089484286i32);
pub const WEB_E_JSON_VALUE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089484279i32);
pub const WEB_E_MISSING_REQUIRED_ATTRIBUTE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089484284i32);
pub const WEB_E_MISSING_REQUIRED_ELEMENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089484285i32);
pub const WEB_E_RESOURCE_TOO_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089484282i32);
pub const WEB_E_UNEXPECTED_CONTENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089484283i32);
pub const WEB_E_UNSUPPORTED_FORMAT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2089484287i32);
pub const WEP_E_BUFFER_TOO_LARGE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013200375i32);
pub const WEP_E_FIXED_DATA_NOT_SUPPORTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013200382i32);
pub const WEP_E_HARDWARE_NOT_COMPLIANT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013200381i32);
pub const WEP_E_LOCK_NOT_CONFIGURED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013200380i32);
pub const WEP_E_NOT_PROVISIONED_ON_ALL_VOLUMES: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013200383i32);
pub const WEP_E_NO_LICENSE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013200378i32);
pub const WEP_E_OS_NOT_PROTECTED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013200377i32);
pub const WEP_E_PROTECTION_SUSPENDED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013200379i32);
pub const WEP_E_UNEXPECTED_FAIL: ::windows::core::HRESULT = ::windows::core::HRESULT(-2013200376i32);
pub const WER_E_ALREADY_REPORTING: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145681404i32);
pub const WER_E_CANCELED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145681407i32);
pub const WER_E_CRASH_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145681408i32);
pub const WER_E_DUMP_THROTTLED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145681403i32);
pub const WER_E_INSUFFICIENT_CONSENT: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145681402i32);
pub const WER_E_NETWORK_FAILURE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145681406i32);
pub const WER_E_NOT_INITIALIZED: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145681405i32);
pub const WER_E_TOO_HEAVY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2145681401i32);
pub const WER_S_ASSERT_CONTINUE: ::windows::core::HRESULT = ::windows::core::HRESULT(1769482i32);
pub const WER_S_DISABLED: ::windows::core::HRESULT = ::windows::core::HRESULT(1769475i32);
pub const WER_S_DISABLED_ARCHIVE: ::windows::core::HRESULT = ::windows::core::HRESULT(1769478i32);
pub const WER_S_DISABLED_QUEUE: ::windows::core::HRESULT = ::windows::core::HRESULT(1769477i32);
pub const WER_S_IGNORE_ALL_ASSERTS: ::windows::core::HRESULT = ::windows::core::HRESULT(1769481i32);
pub const WER_S_IGNORE_ASSERT_INSTANCE: ::windows::core::HRESULT = ::windows::core::HRESULT(1769480i32);
pub const WER_S_REPORT_ASYNC: ::windows::core::HRESULT = ::windows::core::HRESULT(1769479i32);
pub const WER_S_REPORT_DEBUG: ::windows::core::HRESULT = ::windows::core::HRESULT(1769472i32);
pub const WER_S_REPORT_QUEUED: ::windows::core::HRESULT = ::windows::core::HRESULT(1769474i32);
pub const WER_S_REPORT_UPLOADED: ::windows::core::HRESULT = ::windows::core::HRESULT(1769473i32);
pub const WER_S_REPORT_UPLOADED_CAB: ::windows::core::HRESULT = ::windows::core::HRESULT(1769484i32);
pub const WER_S_SUSPENDED_UPLOAD: ::windows::core::HRESULT = ::windows::core::HRESULT(1769476i32);
pub const WER_S_THROTTLED: ::windows::core::HRESULT = ::windows::core::HRESULT(1769483i32);
pub const WHV_E_GPA_RANGE_NOT_FOUND: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878395i32);
pub const WHV_E_INSUFFICIENT_BUFFER: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878399i32);
pub const WHV_E_INVALID_PARTITION_CONFIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878396i32);
pub const WHV_E_INVALID_VP_REGISTER_NAME: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878391i32);
pub const WHV_E_INVALID_VP_STATE: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878392i32);
pub const WHV_E_UNKNOWN_CAPABILITY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878400i32);
pub const WHV_E_UNKNOWN_PROPERTY: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878398i32);
pub const WHV_E_UNSUPPORTED_HYPERVISOR_CONFIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878397i32);
pub const WHV_E_UNSUPPORTED_PROCESSOR_CONFIG: ::windows::core::HRESULT = ::windows::core::HRESULT(-2143878384i32);
