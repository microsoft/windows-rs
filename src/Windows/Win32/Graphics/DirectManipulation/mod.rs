...
pub const CLSID_AutoScrollBehavior: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        638741073,
        15472,
        19610,
        [174, 194, 148, 136, 73, 238, 176, 147],
    );
pub const CLSID_DeferContactService: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3619060980,
        33979,
        17230,
        [134, 174, 101, 146, 187, 201, 171, 217],
    );
pub const CLSID_DragDropConfigurationBehavior: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        162536254,
        47724,
        17741,
        [130, 232, 149, 227, 82, 50, 159, 35],
    );
pub const CLSID_HorizontalIndicatorContent: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3889270005,
        16071,
        17621,
        [167, 107, 55, 112, 243, 207, 144, 61],
    );
pub const CLSID_VerticalIndicatorContent: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2701877015,
        45024,
        19106,
        [145, 233, 62, 112, 1, 210, 230, 180],
    );
pub const CLSID_VirtualViewportContent: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        839295386,
        34544,
        19636,
        [167, 243, 22, 227, 183, 226, 216, 82],
    );
pub const DCompManipulationCompositor: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2044634663,
        41098,
        17324,
        [142, 245, 105, 0, 185, 41, 145, 38],
    );
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
pub const DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION_STOP:
    DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION = DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION(0i32);
pub const DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION_FORWARD:
    DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION = DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION(1i32);
pub const DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION_REVERSE:
    DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION = DIRECTMANIPULATION_AUTOSCROLL_CONFIGURATION(2i32);
...
pub const DIRECTMANIPULATION_CONFIGURATION_NONE: DIRECTMANIPULATION_CONFIGURATION =
    DIRECTMANIPULATION_CONFIGURATION(0i32);
pub const DIRECTMANIPULATION_CONFIGURATION_INTERACTION: DIRECTMANIPULATION_CONFIGURATION =
    DIRECTMANIPULATION_CONFIGURATION(1i32);
pub const DIRECTMANIPULATION_CONFIGURATION_TRANSLATION_X: DIRECTMANIPULATION_CONFIGURATION =
    DIRECTMANIPULATION_CONFIGURATION(2i32);
pub const DIRECTMANIPULATION_CONFIGURATION_TRANSLATION_Y: DIRECTMANIPULATION_CONFIGURATION =
    DIRECTMANIPULATION_CONFIGURATION(4i32);
pub const DIRECTMANIPULATION_CONFIGURATION_SCALING: DIRECTMANIPULATION_CONFIGURATION =
    DIRECTMANIPULATION_CONFIGURATION(16i32);
pub const DIRECTMANIPULATION_CONFIGURATION_TRANSLATION_INERTIA: DIRECTMANIPULATION_CONFIGURATION =
    DIRECTMANIPULATION_CONFIGURATION(32i32);
pub const DIRECTMANIPULATION_CONFIGURATION_SCALING_INERTIA: DIRECTMANIPULATION_CONFIGURATION =
    DIRECTMANIPULATION_CONFIGURATION(128i32);
pub const DIRECTMANIPULATION_CONFIGURATION_RAILS_X: DIRECTMANIPULATION_CONFIGURATION =
    DIRECTMANIPULATION_CONFIGURATION(256i32);
pub const DIRECTMANIPULATION_CONFIGURATION_RAILS_Y: DIRECTMANIPULATION_CONFIGURATION =
    DIRECTMANIPULATION_CONFIGURATION(512i32);
...
pub const DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION_VERTICAL:
    DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION = DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION(1i32);
pub const DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION_HORIZONTAL:
    DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION = DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION(2i32);
pub const DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION_SELECT_ONLY:
    DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION = DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION(16i32);
pub const DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION_SELECT_DRAG:
    DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION = DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION(32i32);
pub const DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION_HOLD_DRAG:
    DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION = DIRECTMANIPULATION_DRAG_DROP_CONFIGURATION(64i32);
...
pub const DIRECTMANIPULATION_DRAG_DROP_READY: DIRECTMANIPULATION_DRAG_DROP_STATUS =
    DIRECTMANIPULATION_DRAG_DROP_STATUS(0i32);
pub const DIRECTMANIPULATION_DRAG_DROP_PRESELECT: DIRECTMANIPULATION_DRAG_DROP_STATUS =
    DIRECTMANIPULATION_DRAG_DROP_STATUS(1i32);
pub const DIRECTMANIPULATION_DRAG_DROP_SELECTING: DIRECTMANIPULATION_DRAG_DROP_STATUS =
    DIRECTMANIPULATION_DRAG_DROP_STATUS(2i32);
pub const DIRECTMANIPULATION_DRAG_DROP_DRAGGING: DIRECTMANIPULATION_DRAG_DROP_STATUS =
    DIRECTMANIPULATION_DRAG_DROP_STATUS(3i32);
pub const DIRECTMANIPULATION_DRAG_DROP_CANCELLED: DIRECTMANIPULATION_DRAG_DROP_STATUS =
    DIRECTMANIPULATION_DRAG_DROP_STATUS(4i32);
pub const DIRECTMANIPULATION_DRAG_DROP_COMMITTED: DIRECTMANIPULATION_DRAG_DROP_STATUS =
    DIRECTMANIPULATION_DRAG_DROP_STATUS(5i32);
...
pub const DIRECTMANIPULATION_GESTURE_NONE: DIRECTMANIPULATION_GESTURE_CONFIGURATION =
    DIRECTMANIPULATION_GESTURE_CONFIGURATION(0i32);
pub const DIRECTMANIPULATION_GESTURE_DEFAULT: DIRECTMANIPULATION_GESTURE_CONFIGURATION =
    DIRECTMANIPULATION_GESTURE_CONFIGURATION(0i32);
pub const DIRECTMANIPULATION_GESTURE_CROSS_SLIDE_VERTICAL:
    DIRECTMANIPULATION_GESTURE_CONFIGURATION = DIRECTMANIPULATION_GESTURE_CONFIGURATION(8i32);
pub const DIRECTMANIPULATION_GESTURE_CROSS_SLIDE_HORIZONTAL:
    DIRECTMANIPULATION_GESTURE_CONFIGURATION = DIRECTMANIPULATION_GESTURE_CONFIGURATION(16i32);
pub const DIRECTMANIPULATION_GESTURE_PINCH_ZOOM: DIRECTMANIPULATION_GESTURE_CONFIGURATION =
    DIRECTMANIPULATION_GESTURE_CONFIGURATION(32i32);
...
pub const DIRECTMANIPULATION_HITTEST_TYPE_ASYNCHRONOUS: DIRECTMANIPULATION_HITTEST_TYPE =
    DIRECTMANIPULATION_HITTEST_TYPE(0i32);
pub const DIRECTMANIPULATION_HITTEST_TYPE_SYNCHRONOUS: DIRECTMANIPULATION_HITTEST_TYPE =
    DIRECTMANIPULATION_HITTEST_TYPE(1i32);
pub const DIRECTMANIPULATION_HITTEST_TYPE_AUTO_SYNCHRONOUS: DIRECTMANIPULATION_HITTEST_TYPE =
    DIRECTMANIPULATION_HITTEST_TYPE(2i32);
...
pub const DIRECTMANIPULATION_INPUT_MODE_AUTOMATIC: DIRECTMANIPULATION_INPUT_MODE =
    DIRECTMANIPULATION_INPUT_MODE(0i32);
pub const DIRECTMANIPULATION_INPUT_MODE_MANUAL: DIRECTMANIPULATION_INPUT_MODE =
    DIRECTMANIPULATION_INPUT_MODE(1i32);
...
pub const DIRECTMANIPULATION_INTERACTION_BEGIN: DIRECTMANIPULATION_INTERACTION_TYPE =
    DIRECTMANIPULATION_INTERACTION_TYPE(0i32);
pub const DIRECTMANIPULATION_INTERACTION_TYPE_MANIPULATION: DIRECTMANIPULATION_INTERACTION_TYPE =
    DIRECTMANIPULATION_INTERACTION_TYPE(1i32);
pub const DIRECTMANIPULATION_INTERACTION_TYPE_GESTURE_TAP: DIRECTMANIPULATION_INTERACTION_TYPE =
    DIRECTMANIPULATION_INTERACTION_TYPE(2i32);
pub const DIRECTMANIPULATION_INTERACTION_TYPE_GESTURE_HOLD: DIRECTMANIPULATION_INTERACTION_TYPE =
    DIRECTMANIPULATION_INTERACTION_TYPE(3i32);
pub const DIRECTMANIPULATION_INTERACTION_TYPE_GESTURE_CROSS_SLIDE:
    DIRECTMANIPULATION_INTERACTION_TYPE = DIRECTMANIPULATION_INTERACTION_TYPE(4i32);
pub const DIRECTMANIPULATION_INTERACTION_TYPE_GESTURE_PINCH_ZOOM:
    DIRECTMANIPULATION_INTERACTION_TYPE = DIRECTMANIPULATION_INTERACTION_TYPE(5i32);
pub const DIRECTMANIPULATION_INTERACTION_END: DIRECTMANIPULATION_INTERACTION_TYPE =
    DIRECTMANIPULATION_INTERACTION_TYPE(100i32);
...
pub const DIRECTMANIPULATION_MOTION_NONE: DIRECTMANIPULATION_MOTION_TYPES =
    DIRECTMANIPULATION_MOTION_TYPES(0i32);
pub const DIRECTMANIPULATION_MOTION_TRANSLATEX: DIRECTMANIPULATION_MOTION_TYPES =
    DIRECTMANIPULATION_MOTION_TYPES(1i32);
pub const DIRECTMANIPULATION_MOTION_TRANSLATEY: DIRECTMANIPULATION_MOTION_TYPES =
    DIRECTMANIPULATION_MOTION_TYPES(2i32);
pub const DIRECTMANIPULATION_MOTION_ZOOM: DIRECTMANIPULATION_MOTION_TYPES =
    DIRECTMANIPULATION_MOTION_TYPES(4i32);
pub const DIRECTMANIPULATION_MOTION_CENTERX: DIRECTMANIPULATION_MOTION_TYPES =
    DIRECTMANIPULATION_MOTION_TYPES(16i32);
pub const DIRECTMANIPULATION_MOTION_CENTERY: DIRECTMANIPULATION_MOTION_TYPES =
    DIRECTMANIPULATION_MOTION_TYPES(32i32);
pub const DIRECTMANIPULATION_MOTION_ALL: DIRECTMANIPULATION_MOTION_TYPES =
    DIRECTMANIPULATION_MOTION_TYPES(55i32);
...
pub const DIRECTMANIPULATION_COORDINATE_BOUNDARY: DIRECTMANIPULATION_SNAPPOINT_COORDINATE =
    DIRECTMANIPULATION_SNAPPOINT_COORDINATE(0i32);
pub const DIRECTMANIPULATION_COORDINATE_ORIGIN: DIRECTMANIPULATION_SNAPPOINT_COORDINATE =
    DIRECTMANIPULATION_SNAPPOINT_COORDINATE(1i32);
pub const DIRECTMANIPULATION_COORDINATE_MIRRORED: DIRECTMANIPULATION_SNAPPOINT_COORDINATE =
    DIRECTMANIPULATION_SNAPPOINT_COORDINATE(16i32);
...
pub const DIRECTMANIPULATION_SNAPPOINT_MANDATORY: DIRECTMANIPULATION_SNAPPOINT_TYPE =
    DIRECTMANIPULATION_SNAPPOINT_TYPE(0i32);
pub const DIRECTMANIPULATION_SNAPPOINT_OPTIONAL: DIRECTMANIPULATION_SNAPPOINT_TYPE =
    DIRECTMANIPULATION_SNAPPOINT_TYPE(1i32);
pub const DIRECTMANIPULATION_SNAPPOINT_MANDATORY_SINGLE: DIRECTMANIPULATION_SNAPPOINT_TYPE =
    DIRECTMANIPULATION_SNAPPOINT_TYPE(2i32);
pub const DIRECTMANIPULATION_SNAPPOINT_OPTIONAL_SINGLE: DIRECTMANIPULATION_SNAPPOINT_TYPE =
    DIRECTMANIPULATION_SNAPPOINT_TYPE(3i32);
...
pub const DIRECTMANIPULATION_VERTICALALIGNMENT_NONE: DIRECTMANIPULATION_VERTICALALIGNMENT =
    DIRECTMANIPULATION_VERTICALALIGNMENT(0i32);
pub const DIRECTMANIPULATION_VERTICALALIGNMENT_TOP: DIRECTMANIPULATION_VERTICALALIGNMENT =
    DIRECTMANIPULATION_VERTICALALIGNMENT(1i32);
pub const DIRECTMANIPULATION_VERTICALALIGNMENT_CENTER: DIRECTMANIPULATION_VERTICALALIGNMENT =
    DIRECTMANIPULATION_VERTICALALIGNMENT(2i32);
pub const DIRECTMANIPULATION_VERTICALALIGNMENT_BOTTOM: DIRECTMANIPULATION_VERTICALALIGNMENT =
    DIRECTMANIPULATION_VERTICALALIGNMENT(4i32);
pub const DIRECTMANIPULATION_VERTICALALIGNMENT_UNLOCKCENTER: DIRECTMANIPULATION_VERTICALALIGNMENT =
    DIRECTMANIPULATION_VERTICALALIGNMENT(8i32);
...
pub const DIRECTMANIPULATION_VIEWPORT_OPTIONS_DEFAULT: DIRECTMANIPULATION_VIEWPORT_OPTIONS =
    DIRECTMANIPULATION_VIEWPORT_OPTIONS(0i32);
pub const DIRECTMANIPULATION_VIEWPORT_OPTIONS_AUTODISABLE: DIRECTMANIPULATION_VIEWPORT_OPTIONS =
    DIRECTMANIPULATION_VIEWPORT_OPTIONS(1i32);
pub const DIRECTMANIPULATION_VIEWPORT_OPTIONS_MANUALUPDATE: DIRECTMANIPULATION_VIEWPORT_OPTIONS =
    DIRECTMANIPULATION_VIEWPORT_OPTIONS(2i32);
pub const DIRECTMANIPULATION_VIEWPORT_OPTIONS_INPUT: DIRECTMANIPULATION_VIEWPORT_OPTIONS =
    DIRECTMANIPULATION_VIEWPORT_OPTIONS(4i32);
pub const DIRECTMANIPULATION_VIEWPORT_OPTIONS_EXPLICITHITTEST: DIRECTMANIPULATION_VIEWPORT_OPTIONS =
    DIRECTMANIPULATION_VIEWPORT_OPTIONS(8i32);
pub const DIRECTMANIPULATION_VIEWPORT_OPTIONS_DISABLEPIXELSNAPPING:
    DIRECTMANIPULATION_VIEWPORT_OPTIONS = DIRECTMANIPULATION_VIEWPORT_OPTIONS(16i32);
...
pub const DirectManipulationManager: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        1424101814,
        13904,
        20341,
        [131, 52, 250, 53, 149, 152, 225, 197],
    );
pub const DirectManipulationPrimaryContent: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3399493217,
        54686,
        16839,
        [131, 147, 59, 163, 186, 203, 107, 87],
    );
pub const DirectManipulationSharedManager: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2574856838,
        30668,
        19287,
        [150, 219, 59, 53, 79, 111, 159, 181],
    );
pub const DirectManipulationUpdateManager: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2680274901,
        6197,
        17434,
        [179, 177, 182, 204, 116, 183, 39, 208],
    );
pub const DirectManipulationViewport: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        887230902,
        13904,
        20341,
...
impl IDirectManipulationAutoScrollBehavior {
    pub unsafe fn SetConfiguration(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ...
            ::std::mem::transmute(motiontypes),
            ::std::mem::transmute(scrollmotion),
        )
        .ok()
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationAutoScrollBehavior
{
...
impl IDirectManipulationCompositor {
    pub unsafe fn AddContent<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IDirectManipulationContent>,
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ...
            parentvisual.into_param().abi(),
            childvisual.into_param().abi(),
        )
        .ok()
    }
    pub unsafe fn RemoveContent<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IDirectManipulationContent>,
    >(
        &self,
    ...
    pub unsafe fn SetUpdateManager<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IDirectManipulationUpdateManager>,
    >(
        &self,
        updatemanager: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            updatemanager.into_param().abi(),
        )
        .ok()
    }
...
pub struct IDirectManipulationCompositor_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        parentvisual: ::windows::runtime::RawPtr,
        childvisual: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        content: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        updatemanager: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
impl IDirectManipulationCompositor2 {
    ...
    pub unsafe fn AddContentWithCrossProcessChaining<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IDirectManipulationPrimaryContent>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>,
        Param3: ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>,
    >(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationCompositor2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, IDirectManipulationCompositor>
    for IDirectManipulationCompositor2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IDirectManipulationCompositor> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<IDirectManipulationCompositor>::into(self),
        )
    }
}
impl<'a> ::windows::runtime::IntoParam<'a, IDirectManipulationCompositor>
    for &IDirectManipulationCompositor2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IDirectManipulationCompositor> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<IDirectManipulationCompositor>::into(
...
impl IDirectManipulationContent {
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetContentRect(
        &self,
        contentsize: *const super::super::Foundation::RECT,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(contentsize),
        )
        .ok()
    }
    pub unsafe fn GetViewport<T: ::windows::runtime::Interface>(
        &self,
    ...
    pub unsafe fn GetOutputTransform(
        &self,
        matrix: *mut f32,
        pointcount: u32,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub unsafe fn SyncContentTransform(
        &self,
        matrix: *const f32,
        pointcount: u32,
    ) -> ::windows::runtime::Result<()> {
...
pub struct IDirectManipulationContent_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        contentsize: *mut super::super::Foundation::RECT,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IDirectManipulationDeferContactService {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        65120,
        19096,
        [190, 112, 229, 242, 18, 145, 231, 241],
    );
}
...
impl ::std::convert::From<&IDirectManipulationDeferContactService>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationDeferContactService
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IDirectManipulationDragDropBehavior {
    ...
    pub unsafe fn GetStatus(
        &self,
    ) -> ::windows::runtime::Result<DIRECTMANIPULATION_DRAG_DROP_STATUS> {
        let mut result__: <DIRECTMANIPULATION_DRAG_DROP_STATUS as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<DIRECTMANIPULATION_DRAG_DROP_STATUS>(result__)
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationDragDropBehavior
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IDirectManipulationDragDropBehavior_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        status: *mut DIRECTMANIPULATION_DRAG_DROP_STATUS,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IDirectManipulationDragDropEventHandler {
    pub unsafe fn OnDragDropStatusChange<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IDirectManipulationViewport2>,
    >(
        &self,
        viewport: Param0,
...
unsafe impl ::windows::runtime::Interface for IDirectManipulationDragDropEventHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        28699,
        16814,
        [181, 242, 73, 227, 107, 213, 149, 170],
    );
}
impl ::std::convert::From<IDirectManipulationDragDropEventHandler>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationDragDropEventHandler
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IDirectManipulationDragDropEventHandler_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        viewport: ::windows::runtime::RawPtr,
        current: DIRECTMANIPULATION_DRAG_DROP_STATUS,
        previous: DIRECTMANIPULATION_DRAG_DROP_STATUS,
    ) -> ::windows::runtime::HRESULT,
);
...
impl IDirectManipulationFrameInfoProvider {
    pub unsafe fn GetNextFrameInfo(
        &self,
        time: *mut u64,
        processtime: *mut u64,
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(time),
            ::std::mem::transmute(processtime),
            ::std::mem::transmute(compositiontime),
        )
        .ok()
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationFrameInfoProvider
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
unsafe impl ::windows::runtime::Interface for IDirectManipulationInteractionEventHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        17076,
        16446,
        [177, 242, 39, 59, 143, 81, 8, 48],
    );
}
impl ::std::convert::From<IDirectManipulationInteractionEventHandler>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationInteractionEventHandler
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IDirectManipulationManager {
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn RegisterHitTestTarget<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::HWND>,
    ...
    >(
        &self,
        window: Param0,
        hittestwindow: Param1,
        r#type: DIRECTMANIPULATION_HITTEST_TYPE,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            window.into_param().abi(),
            hittestwindow.into_param().abi(),
    ...
    pub unsafe fn ProcessInput(
        &self,
        message: *const super::super::UI::WindowsAndMessaging::MSG,
    ...
    pub unsafe fn GetUpdateManager<T: ::windows::runtime::Interface>(
        &self,
    ) -> ::windows::runtime::Result<T> {
        let mut result__ = ::std::option::Option::None;
        (::windows::runtime::Interface::vtable(self).7)(
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn CreateViewport<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IDirectManipulationFrameInfoProvider>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::HWND>,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IDirectManipulationManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        window: super::super::Foundation::HWND,
        hittestwindow: super::super::Foundation::HWND,
        r#type: DIRECTMANIPULATION_HITTEST_TYPE,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_UI_WindowsAndMessaging"))]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        message: *const super::super::UI::WindowsAndMessaging::MSG,
        handled: *mut super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        frameinfo: ::windows::runtime::RawPtr,
        window: super::super::Foundation::HWND,
        riid: *const ::windows::runtime::GUID,
        object: *mut *mut ::std::ffi::c_void,
    ) -> ::windows::runtime::HRESULT,
...
impl IDirectManipulationManager2 {
    ...
    pub unsafe fn CreateBehavior<T: ::windows::runtime::Interface>(
        &self,
        clsid: *const ::windows::runtime::GUID,
    ) -> ::windows::runtime::Result<T> {
        let mut result__ = ::std::option::Option::None;
...
impl<'a> ::windows::runtime::IntoParam<'a, IDirectManipulationManager>
    for IDirectManipulationManager2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IDirectManipulationManager> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IDirectManipulationManager>::into(
            self,
        ))
    }
}
...
impl IDirectManipulationManager3 {
    ...
    pub unsafe fn GetService<T: ::windows::runtime::Interface>(
        &self,
        clsid: *const ::windows::runtime::GUID,
    ) -> ::windows::runtime::Result<T> {
        let mut result__ = ::std::option::Option::None;
...
unsafe impl ::windows::runtime::Interface for IDirectManipulationManager3 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        65512,
        18572,
        [183, 80, 251, 223, 232, 141, 202, 140],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationManager3
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, IDirectManipulationManager2>
    for IDirectManipulationManager3
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IDirectManipulationManager2> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IDirectManipulationManager2>::into(
            self,
        ))
    }
}
...
impl IDirectManipulationPrimaryContent {
    pub unsafe fn SetSnapInterval(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(motion),
            ::std::mem::transmute(interval),
            ::std::mem::transmute(offset),
        )
        .ok()
    }
    pub unsafe fn SetSnapPoints(
        &self,
        motion: DIRECTMANIPULATION_MOTION_TYPES,
        points: *const f32,
        pointcount: u32,
    ...
    pub unsafe fn SetSnapType(
        &self,
        motion: DIRECTMANIPULATION_MOTION_TYPES,
        r#type: DIRECTMANIPULATION_SNAPPOINT_TYPE,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(motion),
    ...
    pub unsafe fn SetSnapCoordinate(
        &self,
        motion: DIRECTMANIPULATION_MOTION_TYPES,
        ...
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(motion),
            ::std::mem::transmute(coordinate),
            ::std::mem::transmute(origin),
        )
        .ok()
    }
    pub unsafe fn SetZoomBoundaries(
        &self,
        zoomminimum: f32,
        zoommaximum: f32,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(zoomminimum),
            ::std::mem::transmute(zoommaximum),
        )
        .ok()
    }
    ...
    pub unsafe fn GetInertiaEndTransform(
        &self,
        matrix: *mut f32,
        pointcount: u32,
    ) -> ::windows::runtime::Result<()> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationPrimaryContent
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationUpdateHandler
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IDirectManipulationUpdateManager {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn RegisterWaitHandleCallback<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::HANDLE>,
        Param1: ::windows::runtime::IntoParam<'a, IDirectManipulationUpdateHandler>,
    >(
        &self,
        handle: Param0,
        eventhandler: Param1,
...
unsafe impl ::windows::runtime::Interface for IDirectManipulationUpdateManager {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        48692,
        18151,
        [156, 170, 211, 97, 250, 203, 185, 204],
    );
}
...
impl IDirectManipulationViewport {
    ...
    pub unsafe fn GetStatus(&self) -> ::windows::runtime::Result<DIRECTMANIPULATION_STATUS> {
        let mut result__: <DIRECTMANIPULATION_STATUS as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<DIRECTMANIPULATION_STATUS>(result__)
    }
    pub unsafe fn GetTag(
        &self,
        riid: *const ::windows::runtime::GUID,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetViewportRect(
        &self,
        viewport: *const super::super::Foundation::RECT,
    ) -> ::windows::runtime::Result<()> {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).13)(
            ...
            animate.into_param().abi(),
        )
        .ok()
    }
    pub unsafe fn SetViewportTransform(
        &self,
        matrix: *const f32,
        pointcount: u32,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub unsafe fn SyncDisplayTransform(
        &self,
        matrix: *const f32,
        pointcount: u32,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub unsafe fn GetPrimaryContent<T: ::windows::runtime::Interface>(
        &self,
    ) -> ::windows::runtime::Result<T> {
        let mut result__ = ::std::option::Option::None;
    ...
    pub unsafe fn SetManualGesture(
        &self,
    ...
    pub unsafe fn SetChaining(
        &self,
        enabledtypes: DIRECTMANIPULATION_MOTION_TYPES,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).24)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(enabledtypes),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn AddEventHandler<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::HWND>,
        Param1: ::windows::runtime::IntoParam<'a, IDirectManipulationViewportEventHandler>,
    >(
        &self,
        window: Param0,
        eventhandler: Param1,
...
pub struct IDirectManipulationViewport_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        viewport: *mut super::super::Foundation::RECT,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        ...
        right: f32,
        bottom: f32,
        animate: super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationViewport2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, IDirectManipulationViewport>
    for IDirectManipulationViewport2
{
    fn into_param(self) -> ::windows::runtime::Param<'a, IDirectManipulationViewport> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IDirectManipulationViewport>::into(
            self,
        ))
    }
}
...
pub struct IDirectManipulationViewport2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        behavior: ::windows::runtime::RawPtr,
        cookie: *mut u32,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IDirectManipulationViewportEventHandler {
    pub unsafe fn OnViewportStatusChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IDirectManipulationViewport>,
    >(
        &self,
        viewport: Param0,
    ...
    pub unsafe fn OnContentUpdated<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IDirectManipulationViewport>,
        Param1: ::windows::runtime::IntoParam<'a, IDirectManipulationContent>,
    >(
        &self,
        viewport: Param0,
        content: Param1,
...
unsafe impl ::windows::runtime::Interface for IDirectManipulationViewportEventHandler {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        54943,
        17913,
        [176, 249, 242, 57, 68, 50, 26, 109],
    );
}
impl ::std::convert::From<IDirectManipulationViewportEventHandler>
    for ::windows::runtime::IUnknown
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IDirectManipulationViewportEventHandler
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
