...
impl IUPnPAsyncResult {
    pub unsafe fn AsyncOperationComplete(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(ullrequestid),
        )
        .ok()
    }
}
...
impl IUPnPDescriptionDocument {
    ...
    >(
        &self,
        bstrudn: Param0,
    ) -> ::windows::runtime::Result<IUPnPDevice> {
        let mut result__: <IUPnPDevice as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).13)(
            ::std::mem::transmute_copy(self),
            bstrudn.into_param().abi(),
            &mut result__,
        )
        .from_abi::<IUPnPDevice>(result__)
    }
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<IUPnPDescriptionDocument>
...
pub struct IUPnPDescriptionDocument_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrurl: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrurl: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        punkcallback: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppudrootdevice: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrudn: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        ppuddevice: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IUPnPDescriptionDocumentCallback {
    pub unsafe fn LoadComplete(
        &self,
        hrloadresult: ::windows::runtime::HRESULT,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(hrloadresult),
        )
        .ok()
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IUPnPDescriptionDocumentCallback
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IUPnPDevice {
    ...
    pub unsafe fn Children(&self) -> ::windows::runtime::Result<IUPnPDevices> {
        ...
        .from_abi::<IUPnPDevices>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn UniqueDeviceName(
        &self,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ManufacturerName(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::BSTR> {
        let mut result__: <super::super::super::Foundation::BSTR as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).24)(
            ::std::mem::transmute_copy(self),
            bstrencodingformat.into_param().abi(),
            ::std::mem::transmute(lsizex),
            ::std::mem::transmute(lsizey),
            ::std::mem::transmute(lbitdepth),
            &mut result__,
        )
        .from_abi::<super::super::super::Foundation::BSTR>(result__)
    }
    pub unsafe fn Services(&self) -> ::windows::runtime::Result<IUPnPServices> {
        ...
        .from_abi::<IUPnPServices>(result__)
    }
}
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<IUPnPDevice> for super::super::super::System::OleAutomation::IDispatch {
    fn from(value: IUPnPDevice) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
}
...
pub struct IUPnPDevice_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppuddeviceparent: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pvarb: *mut i16,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppudchildren: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrencodingformat: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        lsizex: i32,
        lsizey: i32,
        lbitdepth: i32,
        pbstriconurl: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppusservices: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IUPnPDeviceControl {
    ...
    >(
        &self,
        bstrxmldesc: Param0,
        bstrdeviceidentifier: Param1,
        bstrinitstring: Param2,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            bstrxmldesc.into_param().abi(),
            bstrdeviceidentifier.into_param().abi(),
            bstrinitstring.into_param().abi(),
        )
        .ok()
    }
    ...
    >(
        &self,
        bstrudn: Param0,
        bstrserviceid: Param1,
    ) -> ::windows::runtime::Result<super::super::super::System::OleAutomation::IDispatch> {
        let mut result__ : < super::super::super::System::OleAutomation:: IDispatch as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            bstrudn.into_param().abi(),
            bstrserviceid.into_param().abi(),
            &mut result__,
        )
        .from_abi::<super::super::super::System::OleAutomation::IDispatch>(result__)
    }
}
...
pub struct IUPnPDeviceControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrudn: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        bstrserviceid: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        ppdispservice: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
impl IUPnPDeviceControlHttpHeaders {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetAdditionalResponseHeaders(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::BSTR> {
        let mut result__: <super::super::super::Foundation::BSTR as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IUPnPDeviceControlHttpHeaders
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IUPnPDeviceControlHttpHeaders_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrhttpresponseheaders: *mut ::std::mem::ManuallyDrop<
...
pub struct IUPnPDeviceDocumentAccess_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrdocument: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IUPnPDeviceDocumentAccessEx
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IUPnPDeviceFinder {
    ...
    >(
        ...
        bstrtypeuri: Param0,
        dwflags: u32,
    ) -> ::windows::runtime::Result<IUPnPDevices> {
        let mut result__: <IUPnPDevices as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            bstrtypeuri.into_param().abi(),
            ::std::mem::transmute(dwflags),
            &mut result__,
        )
        .from_abi::<IUPnPDevices>(result__)
    ...
    >(
        ...
        bstrtypeuri: Param0,
        dwflags: u32,
        punkdevicefindercallback: Param2,
        ...
        (::windows::runtime::Interface::vtable(self).8)(
            ...
            bstrtypeuri.into_param().abi(),
            ::std::mem::transmute(dwflags),
            punkdevicefindercallback.into_param().abi(),
            &mut result__,
        )
        .from_abi::<i32>(result__)
    }
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<IUPnPDeviceFinder>
    for super::super::super::System::OleAutomation::IDispatch
{
    fn from(value: IUPnPDeviceFinder) -> Self {
        unsafe { ::std::mem::transmute(value) }
...
pub struct IUPnPDeviceFinder_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrtypeuri: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        dwflags: u32,
        pdevices: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        ...
        bstrtypeuri: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        dwflags: u32,
        punkdevicefindercallback: ::windows::runtime::RawPtr,
        plfinddata: *mut i32,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrudn: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        pdevice: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IUPnPDeviceFinderAddCallbackWithInterface {
    pub unsafe fn DeviceAddedWithInterface<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, IUPnPDevice>,
    >(
        &self,
        lfinddata: i32,
        pdevice: Param1,
        pguidinterface: *const ::windows::runtime::GUID,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(lfinddata),
            pdevice.into_param().abi(),
            ::std::mem::transmute(pguidinterface),
        )
        .ok()
    }
}
unsafe impl ::windows::runtime::Interface for IUPnPDeviceFinderAddCallbackWithInterface {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        6038,
        17631,
        [137, 117, 202, 84, 91, 98, 14, 229],
    );
}
impl ::std::convert::From<IUPnPDeviceFinderAddCallbackWithInterface>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IUPnPDeviceFinderAddCallbackWithInterface
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IUPnPDeviceFinderCallback {
    pub unsafe fn DeviceAdded<'a, Param1: ::windows::runtime::IntoParam<'a, IUPnPDevice>>(
        &self,
        lfinddata: i32,
        pdevice: Param1,
    ) -> ::windows::runtime::Result<()> {
...
unsafe impl ::windows::runtime::Interface for IUPnPDevices {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        48547,
        19558,
        [172, 79, 242, 217, 111, 218, 214, 140],
    );
}
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<IUPnPDevices> for super::super::super::System::OleAutomation::IDispatch {
    fn from(value: IUPnPDevices) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
}
...
impl IUPnPEventSink {
    pub unsafe fn OnStateChanged(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ...
            ::std::mem::transmute(rgdispidchanges),
        )
        .ok()
    }
    #[cfg(all(
    ...
    pub unsafe fn OnStateChangedSafe<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::System::OleAutomation::VARIANT>,
    >(
        &self,
        varsadispidchanges: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            varsadispidchanges.into_param().abi(),
        )
        .ok()
    }
}
...
pub struct IUPnPEventSink_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        varsadispidchanges: ::std::mem::ManuallyDrop<
            super::super::super::System::OleAutomation::VARIANT,
        >,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
...
impl IUPnPEventSource {
    pub unsafe fn Advise<'a, Param0: ::windows::runtime::IntoParam<'a, IUPnPEventSink>>(
        &self,
        pessubscriber: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            pessubscriber.into_param().abi(),
        )
        .ok()
    }
    pub unsafe fn Unadvise<'a, Param0: ::windows::runtime::IntoParam<'a, IUPnPEventSink>>(
        &self,
        pessubscriber: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
...
pub struct IUPnPEventSource_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pessubscriber: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pessubscriber: ::windows::runtime::RawPtr,
...
impl IUPnPHttpHeaderControl {
    ...
    >(
        &self,
        bstrhttpheaders: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            bstrhttpheaders.into_param().abi(),
        )
        .ok()
    }
}
...
pub struct IUPnPHttpHeaderControl_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrhttpheaders: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IUPnPRegistrar {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            bstrxmldesc.into_param().abi(),
            bstrprogiddevicecontrolclass.into_param().abi(),
            bstrinitstring.into_param().abi(),
            bstrcontainerid.into_param().abi(),
            bstrresourcepath.into_param().abi(),
            ::std::mem::transmute(nlifetime),
            &mut result__,
        )
        .from_abi::<super::super::super::Foundation::BSTR>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn RegisterRunningDevice<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BSTR>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BSTR>,
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            bstrxmldesc.into_param().abi(),
            punkdevicecontrol.into_param().abi(),
            bstrinitstring.into_param().abi(),
            bstrresourcepath.into_param().abi(),
            ::std::mem::transmute(nlifetime),
            &mut result__,
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).5)(
            ...
            bstrprogidproviderclass.into_param().abi(),
            bstrinitstring.into_param().abi(),
            bstrcontainerid.into_param().abi(),
        )
        .ok()
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            bstrdeviceidentifier.into_param().abi(),
            bstrtemplateudn.into_param().abi(),
            &mut result__,
        )
        .from_abi::<super::super::super::Foundation::BSTR>(result__)
    }
...
pub struct IUPnPRegistrar_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrxmldesc: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        bstrprogiddevicecontrolclass: ::std::mem::ManuallyDrop<
            super::super::super::Foundation::BSTR,
        >,
        bstrinitstring: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrprovidername: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        bstrprogidproviderclass: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        bstrinitstring: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        bstrcontainerid: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrdeviceidentifier: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        bstrtemplateudn: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        pbstrudn: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrdeviceidentifier: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        fpermanent: super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl IUPnPRemoteEndpointInfo {
    ...
    >(
        &self,
        bstrvaluename: Param0,
    ) -> ::windows::runtime::Result<u32> {
        let mut result__: <u32 as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            bstrvaluename.into_param().abi(),
            &mut result__,
        )
        .from_abi::<u32>(result__)
    }
...
pub struct IUPnPRemoteEndpointInfo_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrvaluename: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        pdwvalue: *mut u32,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrvaluename: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        pbstrvalue: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrvaluename: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        pguidvalue: *mut ::windows::runtime::GUID,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IUPnPReregistrar {
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ReregisterRunningDevice<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BSTR>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BSTR>,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>,
...
impl IUPnPService {
    ...
    >(
        &self,
        bstrvariablename: Param0,
    ) -> ::windows::runtime::Result<super::super::super::System::OleAutomation::VARIANT> {
        let mut result__ : < super::super::super::System::OleAutomation:: VARIANT as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            bstrvariablename.into_param().abi(),
            &mut result__,
        )
        .from_abi::<super::super::super::System::OleAutomation::VARIANT>(result__)
    }
    #[cfg(all(
        feature = "Win32_Foundation",
        feature = "Win32_System_OleAutomation",
    ...
    pub unsafe fn InvokeAction<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BSTR>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::System::OleAutomation::VARIANT>,
    >(
        &self,
        bstractionname: Param0,
        vinactionargs: Param1,
        pvoutactionargs: *mut super::super::super::System::OleAutomation::VARIANT,
        pvretval: *mut super::super::super::System::OleAutomation::VARIANT,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            bstractionname.into_param().abi(),
            vinactionargs.into_param().abi(),
            ::std::mem::transmute(pvoutactionargs),
            ::std::mem::transmute(pvretval),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ServiceTypeIdentifier(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::BSTR> {
        let mut result__: <super::super::super::Foundation::BSTR as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<IUPnPService> for super::super::super::System::OleAutomation::IDispatch {
    fn from(value: IUPnPService) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
}
...
pub struct IUPnPService_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrvariablename: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        pvalue: *mut ::std::mem::ManuallyDrop<super::super::super::System::OleAutomation::VARIANT>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Foundation",
        feature = "Win32_System_OleAutomation",
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstractionname: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        vinactionargs: ::std::mem::ManuallyDrop<super::super::super::System::OleAutomation::VARIANT>,
        pvoutactionargs: *mut ::std::mem::ManuallyDrop<
            super::super::super::System::OleAutomation::VARIANT,
        >,
        pvretval: *mut ::std::mem::ManuallyDrop<super::super::super::System::OleAutomation::VARIANT>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Foundation",
        feature = "Win32_System_OleAutomation",
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pval: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrid: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IUPnPServiceAsync {
    ...
    pub unsafe fn BeginInvokeAction<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BSTR>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::System::OleAutomation::VARIANT>,
        Param2: ::windows::runtime::IntoParam<'a, IUPnPAsyncResult>,
    >(
        &self,
        bstractionname: Param0,
        vinactionargs: Param1,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn BeginQueryStateVariable<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BSTR>,
        Param1: ::windows::runtime::IntoParam<'a, IUPnPAsyncResult>,
    >(
        &self,
        bstrvariablename: Param0,
        pasyncresult: Param1,
    ...
    pub unsafe fn EndQueryStateVariable(
        &self,
        ullrequestid: u64,
        pvalue: *mut super::super::super::System::OleAutomation::VARIANT,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(ullrequestid),
    ...
    pub unsafe fn BeginSCPDDownload<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IUPnPAsyncResult>,
    >(
        &self,
        pasyncresult: Param0,
    ) -> ::windows::runtime::Result<u64> {
...
pub struct IUPnPServiceAsync_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ullrequestid: u64,
        pbstrscpddoc: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IUPnPServiceCallback {
    ...
    pub unsafe fn StateVariableChanged<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IUPnPService>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::PWSTR>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::System::OleAutomation::VARIANT>,
    >(
        &self,
        pus: Param0,
        pcwszstatevarname: Param1,
        vavalue: Param2,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            pus.into_param().abi(),
            pcwszstatevarname.into_param().abi(),
            vavalue.into_param().abi(),
        )
        .ok()
    }
    pub unsafe fn ServiceInstanceDied<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IUPnPService>,
    >(
        &self,
...
pub struct IUPnPServiceCallback_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pus: ::windows::runtime::RawPtr,
        pcwszstatevarname: super::super::super::Foundation::PWSTR,
        vavalue: ::std::mem::ManuallyDrop<super::super::super::System::OleAutomation::VARIANT>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Foundation",
        feature = "Win32_System_OleAutomation",
...
unsafe impl ::windows::runtime::Interface for IUPnPServiceDocumentAccess {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        2654,
        17801,
        [130, 93, 126, 109, 135, 234, 105, 152],
    );
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IUPnPServiceDocumentAccess
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IUPnPServiceDocumentAccess_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrdocurl: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrdoc: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[repr(transparent)]
...
impl IUPnPServices {
    ...
    >(
        &self,
        bstrserviceid: Param0,
    ) -> ::windows::runtime::Result<IUPnPService> {
        ...
        .from_abi::<IUPnPService>(result__)
    }
}
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<IUPnPServices> for super::super::super::System::OleAutomation::IDispatch {
    fn from(value: IUPnPServices) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
}
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<&IUPnPServices>
    for super::super::super::System::OleAutomation::IDispatch
{
    fn from(value: &IUPnPServices) -> Self {
        ::std::convert::From::from(::std::clone::Clone::clone(value))
...
#[cfg(feature = "Win32_Foundation")]
pub type SW_DEVICE_CREATE_CALLBACK = unsafe extern "system" fn(
    hswdevice: HSWDEVICE,
    createresult: ::windows::runtime::HRESULT,
    pcontext: *const ::std::ffi::c_void,
    pszdeviceinstanceid: super::super::super::Foundation::PWSTR,
);
...
impl ::std::cmp::PartialEq for SW_DEVICE_CREATE_INFO {
    fn eq(&self, other: &Self) -> bool {
        self.cbSize == other.cbSize
            && self.pszInstanceId == other.pszInstanceId
            && self.pszzHardwareIds == other.pszzHardwareIds
            && self.pszzCompatibleIds == other.pszzCompatibleIds
            && self.pContainerId == other.pContainerId
            && self.CapabilityFlags == other.CapabilityFlags
            && self.pszDeviceDescription == other.pszDeviceDescription
            && self.pszDeviceLocation == other.pszDeviceLocation
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn SwDeviceCreate(
                ...
                pszparentdeviceinstance: super::super::super::Foundation::PWSTR,
                pcreateinfo: *const SW_DEVICE_CREATE_INFO,
                cpropertycount: u32,
                pproperties: *const super::super::super::System::SystemServices::DEVPROPERTY,
        ...
        SwDeviceCreate(
            pszenumeratorname.into_param().abi(),
            pszparentdeviceinstance.into_param().abi(),
            ::std::mem::transmute(pcreateinfo),
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn SwDeviceGetLifetime(
                hswdevice: HSWDEVICE,
                plifetime: *mut SW_DEVICE_LIFETIME,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__: <SW_DEVICE_LIFETIME as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        SwDeviceGetLifetime(hswdevice.into_param().abi(), &mut result__)
            .from_abi::<SW_DEVICE_LIFETIME>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn SwDeviceInterfacePropertySet(
                hswdevice: HSWDEVICE,
                pszdeviceinterfaceid: super::super::super::Foundation::PWSTR,
                cpropertycount: u32,
                pproperties: *const super::super::super::System::SystemServices::DEVPROPERTY,
            ) -> ::windows::runtime::HRESULT;
        }
        SwDeviceInterfacePropertySet(
            hswdevice.into_param().abi(),
            pszdeviceinterfaceid.into_param().abi(),
            ::std::mem::transmute(cpropertycount),
            ::std::mem::transmute(pproperties),
        )
        .ok()
...
pub unsafe fn SwDeviceInterfaceRegister<
    ...
    Param5: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BOOL>,
>(
    hswdevice: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn SwDeviceInterfaceRegister(
                hswdevice: HSWDEVICE,
                pinterfaceclassguid: *const ::windows::runtime::GUID,
                pszreferencestring: super::super::super::Foundation::PWSTR,
                cpropertycount: u32,
                pproperties: *const super::super::super::System::SystemServices::DEVPROPERTY,
                fenabled: super::super::super::Foundation::BOOL,
                ppszdeviceinterfaceid: *mut super::super::super::Foundation::PWSTR,
            ) -> ::windows::runtime::HRESULT;
        }
        ...
        SwDeviceInterfaceRegister(
            hswdevice.into_param().abi(),
            ::std::mem::transmute(pinterfaceclassguid),
            pszreferencestring.into_param().abi(),
            ::std::mem::transmute(cpropertycount),
            ::std::mem::transmute(pproperties),
...
pub const UPNP_E_ACTION_REQUEST_FAILED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220976i32 as _);
pub const UPNP_E_ACTION_SPECIFIC_BASE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220736i32 as _);
pub const UPNP_E_DEVICE_ELEMENT_EXPECTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220991i32 as _);
pub const UPNP_E_DEVICE_ERROR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220972i32 as _);
pub const UPNP_E_DEVICE_NODE_INCOMPLETE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220988i32 as _);
pub const UPNP_E_DEVICE_NOTREGISTERED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180494i32 as _);
pub const UPNP_E_DEVICE_RUNNING: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180495i32 as _);
pub const UPNP_E_DEVICE_TIMEOUT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220969i32 as _);
pub const UPNP_E_DUPLICATE_NOT_ALLOWED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180511i32 as _);
pub const UPNP_E_DUPLICATE_SERVICE_ID: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180510i32 as _);
pub const UPNP_E_ERROR_PROCESSING_RESPONSE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220970i32 as _);
pub const UPNP_E_EVENT_SUBSCRIPTION_FAILED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220223i32 as _);
pub const UPNP_E_ICON_ELEMENT_EXPECTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220987i32 as _);
pub const UPNP_E_ICON_NODE_INCOMPLETE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220986i32 as _);
pub const UPNP_E_INVALID_ACTION: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220985i32 as _);
pub const UPNP_E_INVALID_ARGUMENTS: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220984i32 as _);
pub const UPNP_E_INVALID_DESCRIPTION: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180509i32 as _);
pub const UPNP_E_INVALID_DOCUMENT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220224i32 as _);
pub const UPNP_E_INVALID_ICON: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180507i32 as _);
pub const UPNP_E_INVALID_ROOT_NAMESPACE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180505i32 as _);
pub const UPNP_E_INVALID_SERVICE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180508i32 as _);
pub const UPNP_E_INVALID_VARIABLE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220973i32 as _);
pub const UPNP_E_INVALID_XML: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180506i32 as _);
pub const UPNP_E_OUT_OF_SYNC: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220983i32 as _);
pub const UPNP_E_PROTOCOL_ERROR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220971i32 as _);
pub const UPNP_E_REQUIRED_ELEMENT_ERROR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180512i32 as _);
pub const UPNP_E_ROOT_ELEMENT_EXPECTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220992i32 as _);
pub const UPNP_E_SERVICE_ELEMENT_EXPECTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220990i32 as _);
pub const UPNP_E_SERVICE_NODE_INCOMPLETE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220989i32 as _);
pub const UPNP_E_SUFFIX_TOO_LONG: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180504i32 as _);
pub const UPNP_E_TRANSPORT_ERROR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220975i32 as _);
pub const UPNP_E_URLBASE_PRESENT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180503i32 as _);
pub const UPNP_E_VALUE_TOO_LONG: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180496i32 as _);
pub const UPNP_E_VARIABLE_VALUE_UNKNOWN: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147220974i32 as _);
pub const UPNP_SERVICE_DELAY_SCPD_AND_SUBSCRIPTION: u32 = 1u32;
pub const UPnPDescriptionDocument: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    495622983,
    14888,
    19682,
    [138, 75, 189, 52, 228, 91, 206, 235],
);
pub const UPnPDescriptionDocumentEx: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        872220003,
        55322,
        17299,
        [131, 204, 1, 149, 177, 218, 47, 145],
    );
pub const UPnPDevice: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2737132229,
    47713,
    17786,
    [181, 154, 162, 86, 30, 18, 94, 51],
);
pub const UPnPDeviceFinder: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3792199464,
    65207,
    16458,
    [184, 231, 230, 89, 189, 234, 170, 2],
);
pub const UPnPDeviceFinderEx: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    404444412,
    14347,
    19061,
    [179, 241, 74, 196, 94, 150, 5, 176],
);
pub const UPnPDevices: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3119009789,
    44348,
    16548,
    [184, 53, 8, 130, 235, 203, 170, 168],
);
pub const UPnPRegistrar: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    541593785,
    29618,
    4564,
    [191, 66, 0, 176, 208, 17, 139, 86],
);
pub const UPnPRemoteEndpointInfo: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    777946345,
    16457,
    16964,
    [183, 40, 45, 36, 34, 113, 87, 199],
);
pub const UPnPService: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3324295829,
    64459,
    17417,
    [140, 3, 140, 206, 236, 83, 62, 241],
);
pub const UPnPServices: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3233565514,
    41990,
    20220,
    [147, 47, 184, 84, 107, 129, 0, 204],
);
