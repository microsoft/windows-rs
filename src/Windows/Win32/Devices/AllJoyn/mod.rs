...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AllJoynAcceptBusConnection(
            serverbushandle.into_param().abi(),
            abortevent.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn AllJoynConnectToBus<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    connectionspec: Param0,
...
pub unsafe fn AllJoynCreateBus(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AllJoynCreateBus(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn AllJoynEnumEvents(
                ...
                eventtoreset: super::super::Foundation::HANDLE,
                eventtypes: *mut u32,
            ) -> super::super::Foundation::BOOL;
        }
        ::std::mem::transmute(AllJoynEnumEvents(
            connectedbushandle.into_param().abi(),
            eventtoreset.into_param().abi(),
            ::std::mem::transmute(eventtypes),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AllJoynEventSelect(
            connectedbushandle.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AllJoynReceiveFromBus(
            connectedbushandle.into_param().abi(),
            ::std::mem::transmute(buffer),
            ::std::mem::transmute(bytestoread),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(AllJoynSendToBus(
            connectedbushandle.into_param().abi(),
            ::std::mem::transmute(buffer),
            ::std::mem::transmute(bytestowrite),
            ::std::mem::transmute(bytestransferred),
            ::std::mem::transmute(reserved),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_about_announced_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    busname: super::super::Foundation::PSTR,
    version: u16,
    port: u16,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_create<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    defaultlanguage: Param0,
) -> alljoyn_aboutdata {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_create_full<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_create_full(
                arg: alljoyn_msgarg,
                language: super::super::Foundation::PSTR,
            ) -> alljoyn_aboutdata;
        }
        ::std::mem::transmute(alljoyn_aboutdata_create_full(
            arg.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_createfrommsgarg<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_createfrommsgarg(
            data.into_param().abi(),
            arg.into_param().abi(),
            language.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_createfromxml<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_createfromxml(
                data: alljoyn_aboutdata,
                aboutdataxml: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_createfromxml(
            data.into_param().abi(),
            aboutdataxml.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_aboutdata_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
>(
    data: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_getaboutdata<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getaboutdata(
            data.into_param().abi(),
            msgarg.into_param().abi(),
            language.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getajsoftwareversion(
            data.into_param().abi(),
            ::std::mem::transmute(ajsoftwareversion),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getannouncedaboutdata(
            data.into_param().abi(),
            msgarg.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getappid(
            data.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_getappname<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getappname(
            data.into_param().abi(),
            ::std::mem::transmute(appname),
            language.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getdateofmanufacture(
            data.into_param().abi(),
            ::std::mem::transmute(dateofmanufacture),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getdefaultlanguage(
            data.into_param().abi(),
            ::std::mem::transmute(defaultlanguage),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_getdescription<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getdescription(
            data.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getdeviceid(
            data.into_param().abi(),
            ::std::mem::transmute(deviceid),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_getdevicename<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getdevicename(
            data.into_param().abi(),
            ::std::mem::transmute(devicename),
            language.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_getfield<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getfield(
            data.into_param().abi(),
            name.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getfields(
            data.into_param().abi(),
            ::std::mem::transmute(fields),
            ::std::mem::transmute(num_fields),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_getfieldsignature(
                data: alljoyn_aboutdata,
                fieldname: super::super::Foundation::PSTR,
            ) -> super::super::Foundation::PSTR;
        }
        ::std::mem::transmute(alljoyn_aboutdata_getfieldsignature(
            data.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_gethardwareversion(
            data.into_param().abi(),
            ::std::mem::transmute(hardwareversion),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_getmanufacturer<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getmanufacturer(
            data.into_param().abi(),
            ::std::mem::transmute(manufacturer),
            language.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getmodelnumber(
            data.into_param().abi(),
            ::std::mem::transmute(modelnumber),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getsoftwareversion(
            data.into_param().abi(),
            ::std::mem::transmute(softwareversion),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getsupportedlanguages(
            data.into_param().abi(),
            ::std::mem::transmute(languagetags),
            ::std::mem::transmute(num),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_getsupporturl(
            data.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_isfieldannounced<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_isfieldannounced(
            data.into_param().abi(),
            fieldname.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_isfieldlocalized<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_isfieldlocalized(
            data.into_param().abi(),
            fieldname.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_isfieldrequired<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_isfieldrequired(
            data.into_param().abi(),
            fieldname.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_isvalid<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_isvalid(
            data.into_param().abi(),
            language.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_setappid(
            data.into_param().abi(),
            ::std::mem::transmute(appid),
            ::std::mem::transmute(num),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setappid_fromstring<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_setappid_fromstring(
                data: alljoyn_aboutdata,
                appid: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_setappid_fromstring(
            data.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setappname<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_setappname(
                data: alljoyn_aboutdata,
                appname: super::super::Foundation::PSTR,
                language: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_setappname(
            data.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setdateofmanufacture<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    data: Param0,
    dateofmanufacture: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn alljoyn_aboutdata_setdateofmanufacture(
                data: alljoyn_aboutdata,
                dateofmanufacture: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_setdateofmanufacture(
            data.into_param().abi(),
            dateofmanufacture.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setdefaultlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    data: Param0,
    defaultlanguage: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(alljoyn_aboutdata_setdefaultlanguage(
            data.into_param().abi(),
            defaultlanguage.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setdescription<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_setdescription(
                data: alljoyn_aboutdata,
                description: super::super::Foundation::PSTR,
                language: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_setdescription(
            data.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setdeviceid<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_setdeviceid(
                data: alljoyn_aboutdata,
                deviceid: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_setdeviceid(
            data.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setdevicename<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_setdevicename(
            data.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setfield<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    data: Param0,
    name: Param1,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_setfield(
            data.into_param().abi(),
            name.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_sethardwareversion<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    data: Param0,
    hardwareversion: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn alljoyn_aboutdata_sethardwareversion(
                data: alljoyn_aboutdata,
                hardwareversion: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_sethardwareversion(
            data.into_param().abi(),
            hardwareversion.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setmanufacturer<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_setmanufacturer(
                data: alljoyn_aboutdata,
                manufacturer: super::super::Foundation::PSTR,
                language: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_setmanufacturer(
            data.into_param().abi(),
            manufacturer.into_param().abi(),
            language.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setmodelnumber<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_setmodelnumber(
                data: alljoyn_aboutdata,
                modelnumber: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_setmodelnumber(
            data.into_param().abi(),
            modelnumber.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setsoftwareversion<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    data: Param0,
    softwareversion: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn alljoyn_aboutdata_setsoftwareversion(
                data: alljoyn_aboutdata,
                softwareversion: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_setsoftwareversion(
            data.into_param().abi(),
            softwareversion.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setsupportedlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdata_setsupportedlanguage(
            data.into_param().abi(),
            language.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutdata_setsupporturl<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_aboutdata_setsupporturl(
                data: alljoyn_aboutdata,
                supporturl: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_aboutdata_setsupporturl(
            data.into_param().abi(),
            supporturl.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub struct alljoyn_aboutdatalistener_callbacks {
    pub about_datalistener_getaboutdata:
        ::std::option::Option<alljoyn_aboutdatalistener_getaboutdata_ptr>,
    pub about_datalistener_getannouncedaboutdata:
        ::std::option::Option<alljoyn_aboutdatalistener_getannouncedaboutdata_ptr>,
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for alljoyn_aboutdatalistener_callbacks {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_aboutdatalistener_callbacks")
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for alljoyn_aboutdatalistener_callbacks {
    fn eq(&self, other: &Self) -> bool {
        self.about_datalistener_getaboutdata.map(|f| f as usize)
            == other.about_datalistener_getaboutdata.map(|f| f as usize)
            && self
...
pub unsafe fn alljoyn_aboutdatalistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdatalistener_create(
...
pub unsafe fn alljoyn_aboutdatalistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutdatalistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutdatalistener_destroy(
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_aboutdatalistener_getaboutdata_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    msgarg: alljoyn_msgarg,
    language: super::super::Foundation::PSTR,
) -> QStatus;
pub type alljoyn_aboutdatalistener_getannouncedaboutdata_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    msgarg: alljoyn_msgarg,
)
    -> QStatus;
...
pub unsafe fn alljoyn_abouticon_getcontent(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_abouticon_getcontent(
            ::std::mem::transmute(icon),
...
pub unsafe fn alljoyn_abouticon_geturl(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_abouticon_geturl(
            ::std::mem::transmute(icon),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_abouticon_setcontent<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    icon: *mut _alljoyn_abouticon_handle,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_abouticon_setcontent(
                icon: *mut _alljoyn_abouticon_handle,
                r#type: super::super::Foundation::PSTR,
                data: *mut u8,
                csize: usize,
                ownsdata: u8,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_abouticon_setcontent(
            ::std::mem::transmute(icon),
            r#type.into_param().abi(),
            ::std::mem::transmute(data),
            ::std::mem::transmute(csize),
            ::std::mem::transmute(ownsdata),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_abouticon_setcontent_frommsgarg(
            ::std::mem::transmute(icon),
            arg.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_abouticon_seturl<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_abouticon_seturl(
                icon: *mut _alljoyn_abouticon_handle,
                r#type: super::super::Foundation::PSTR,
                url: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_abouticon_seturl(
            ::std::mem::transmute(icon),
            r#type.into_param().abi(),
            url.into_param().abi(),
        ))
...
pub unsafe fn alljoyn_abouticonobj_create<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
    icon: *mut _alljoyn_abouticon_handle,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_abouticonobj_create(
            bus.into_param().abi(),
            ::std::mem::transmute(icon),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_abouticonproxy_create<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_abouticonproxy_create(
            bus.into_param().abi(),
            busname.into_param().abi(),
...
pub unsafe fn alljoyn_abouticonproxy_geticon(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_abouticonproxy_geticon(
            ::std::mem::transmute(proxy),
            ::std::mem::transmute(icon),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_abouticonproxy_getversion(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_abouticonproxy_getversion(
            ::std::mem::transmute(proxy),
...
impl ::std::cmp::PartialEq for alljoyn_aboutlistener_callback {
    fn eq(&self, other: &Self) -> bool {
        self.about_listener_announced.map(|f| f as usize)
            == other.about_listener_announced.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_aboutlistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutlistener_create(
...
pub unsafe fn alljoyn_aboutlistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutlistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
...
pub unsafe fn alljoyn_aboutobj_announce<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobj>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_aboutdata>,
>(
    obj: Param0,
    sessionport: u16,
    aboutdata: Param2,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobj_announce(
            obj.into_param().abi(),
            ::std::mem::transmute(sessionport),
            aboutdata.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn alljoyn_aboutobj_announce_using_datalistener<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobj>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_aboutdatalistener>,
>(
    obj: Param0,
    sessionport: u16,
    aboutlistener: Param2,
) -> QStatus {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(alljoyn_aboutobj_announce_using_datalistener(
            obj.into_param().abi(),
            ::std::mem::transmute(sessionport),
            aboutlistener.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobj_create(
            bus.into_param().abi(),
            ::std::mem::transmute(isannounced),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_aboutobj_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobj>,
>(
    obj: Param0,
...
pub unsafe fn alljoyn_aboutobj_unannounce<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobj>,
>(
    obj: Param0,
...
pub unsafe fn alljoyn_aboutobjectdescription_clear<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobjectdescription>,
>(
    description: Param0,
) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_clear(
            description.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_create_full(
            arg.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_createfrommsgarg(
            description.into_param().abi(),
            arg.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_aboutobjectdescription_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobjectdescription>,
>(
    description: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_destroy(
            description.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutobjectdescription_getinterfacepaths<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobjectdescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_getinterfacepaths(
            description.into_param().abi(),
            interfacename.into_param().abi(),
            ::std::mem::transmute(paths),
            ::std::mem::transmute(numpaths),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutobjectdescription_getinterfaces<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobjectdescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_getinterfaces(
            description.into_param().abi(),
            path.into_param().abi(),
            ::std::mem::transmute(interfaces),
            ::std::mem::transmute(numinterfaces),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_getmsgarg(
            description.into_param().abi(),
            msgarg.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_getpaths(
            description.into_param().abi(),
            ::std::mem::transmute(paths),
            ::std::mem::transmute(numpaths),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutobjectdescription_hasinterface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobjectdescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_hasinterface(
            description.into_param().abi(),
            interfacename.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutobjectdescription_hasinterfaceatpath<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobjectdescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_hasinterfaceatpath(
            description.into_param().abi(),
            path.into_param().abi(),
            interfacename.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutobjectdescription_haspath<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutobjectdescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutobjectdescription_haspath(
            description.into_param().abi(),
            path.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutproxy_create(
            bus.into_param().abi(),
            busname.into_param().abi(),
            ::std::mem::transmute(sessionid),
        ))
...
pub unsafe fn alljoyn_aboutproxy_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutproxy>,
>(
    proxy: Param0,
) {
    #[cfg(windows)]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_aboutproxy_getaboutdata<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_aboutproxy>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutproxy_getaboutdata(
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutproxy_getobjectdescription(
            proxy.into_param().abi(),
            objectdesc.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_aboutproxy_getversion(
            proxy.into_param().abi(),
            ::std::mem::transmute(version),
        ))
    }
...
impl ::std::fmt::Debug for alljoyn_applicationstatelistener_callbacks {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_applicationstatelistener_callbacks")
            .finish()
    }
}
...
pub unsafe fn alljoyn_applicationstatelistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_applicationstatelistener_create(
            ::std::mem::transmute(callbacks),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_applicationstatelistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_applicationstatelistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_applicationstatelistener_destroy(
            listener.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub type alljoyn_applicationstatelistener_state_ptr = unsafe extern "system" fn(
    busname: *mut i8,
    publickey: *mut i8,
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_authlistener_authenticationcomplete_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    authmechanism: super::super::Foundation::PSTR,
    peername: super::super::Foundation::PSTR,
    success: i32,
);
#[derive(:: std :: clone :: Clone)]
#[repr(C)]
...
pub struct alljoyn_authlistener_callbacks {
    ...
    pub authentication_complete:
        ::std::option::Option<alljoyn_authlistener_authenticationcomplete_ptr>,
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::cmp::PartialEq for alljoyn_authlistener_callbacks {
    fn eq(&self, other: &Self) -> bool {
        self.request_credentials.map(|f| f as usize)
            == other.request_credentials.map(|f| f as usize)
            && self.verify_credentials.map(|f| f as usize)
                == other.verify_credentials.map(|f| f as usize)
            && self.security_violation.map(|f| f as usize)
                == other.security_violation.map(|f| f as usize)
            && self.authentication_complete.map(|f| f as usize)
                == other.authentication_complete.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_authlistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_authlistener_create(
            ::std::mem::transmute(callbacks),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_authlistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_authlistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_authlistener_requestcredentials_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    authmechanism: super::super::Foundation::PSTR,
    peername: super::super::Foundation::PSTR,
    authcount: u16,
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_authlistener_requestcredentialsasync_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    ...
    username: super::super::Foundation::PSTR,
    credmask: u16,
    authcontext: *mut ::std::ffi::c_void,
) -> QStatus;
pub unsafe fn alljoyn_authlistener_requestcredentialsresponse<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_authlistener>,
    Param3: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    listener: Param0,
    authcontext: *mut ::std::ffi::c_void,
    accept: i32,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_authlistener_requestcredentialsresponse(
            listener.into_param().abi(),
            ::std::mem::transmute(authcontext),
            ::std::mem::transmute(accept),
            credentials.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub type alljoyn_authlistener_securityviolation_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    status: QStatus,
    msg: alljoyn_message,
);
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_authlistener_setsharedsecret(
            listener.into_param().abi(),
            ::std::mem::transmute(sharedsecret),
            ::std::mem::transmute(sharedsecretsize),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_authlistener_verifycredentials_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    authmechanism: super::super::Foundation::PSTR,
    peername: super::super::Foundation::PSTR,
    credentials: alljoyn_credentials,
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_authlistener_verifycredentialsasync_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    listener: alljoyn_authlistener,
    authmechanism: super::super::Foundation::PSTR,
    peername: super::super::Foundation::PSTR,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_authlistener_verifycredentialsresponse(
            listener.into_param().abi(),
            ::std::mem::transmute(authcontext),
            ::std::mem::transmute(accept),
        ))
...
pub struct alljoyn_authlistenerasync_callbacks {
    pub request_credentials:
        ::std::option::Option<alljoyn_authlistener_requestcredentialsasync_ptr>,
...
impl ::std::fmt::Debug for alljoyn_authlistenerasync_callbacks {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_authlistenerasync_callbacks")
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_authlistenerasync_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_authlistenerasync_create(
            ::std::mem::transmute(callbacks),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_authlistenerasync_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_authlistener>,
>(
    listener: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_authlistenerasync_destroy(
            listener.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_autopinger_adddestination<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_autopinger>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    autopinger: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_autopinger_adddestination(
                ...
                group: super::super::Foundation::PSTR,
                destination: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_autopinger_adddestination(
            autopinger.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_autopinger_addpinggroup<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_autopinger>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_pinglistener>,
>(
    autopinger: Param0,
    group: Param1,
    listener: Param2,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_autopinger_addpinggroup(
            autopinger.into_param().abi(),
            group.into_param().abi(),
            listener.into_param().abi(),
            ::std::mem::transmute(pinginterval),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_autopinger_create<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_autopinger_destination_found_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    group: super::super::Foundation::PSTR,
    destination: super::super::Foundation::PSTR,
);
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_autopinger_destination_lost_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    group: super::super::Foundation::PSTR,
    destination: super::super::Foundation::PSTR,
);
pub unsafe fn alljoyn_autopinger_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_autopinger>,
>(
    autopinger: Param0,
...
pub unsafe fn alljoyn_autopinger_pause<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_autopinger>,
>(
    autopinger: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_autopinger_removedestination<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_autopinger>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_autopinger_removedestination(
            autopinger.into_param().abi(),
            group.into_param().abi(),
            destination.into_param().abi(),
            ::std::mem::transmute(removeall),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_autopinger_removepinggroup<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_autopinger>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_autopinger_removepinggroup(
            autopinger.into_param().abi(),
            group.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_autopinger_resume<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_autopinger>,
>(
    autopinger: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_autopinger_setpinginterval<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_autopinger>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_autopinger_setpinginterval(
            autopinger.into_param().abi(),
            group.into_param().abi(),
            ::std::mem::transmute(pinginterval),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_addlogonentry<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_addlogonentry(
                ...
                authmechanism: super::super::Foundation::PSTR,
                username: super::super::Foundation::PSTR,
                password: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_addlogonentry(
            bus.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_addmatch<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_addmatch(
                bus: alljoyn_busattachment,
                rule: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_addmatch(
            bus.into_param().abi(),
            rule.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_advertisename<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_advertisename(
            bus.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(transports),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn alljoyn_busattachment_bindsessionport<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
    Param3: ::windows::runtime::IntoParam<'a, alljoyn_sessionportlistener>,
>(
    bus: Param0,
    sessionport: *mut u16,
    opts: Param2,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_bindsessionport(
            bus.into_param().abi(),
            ::std::mem::transmute(sessionport),
            opts.into_param().abi(),
            listener.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_canceladvertisename<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_canceladvertisename(
            bus.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(transports),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_cancelfindadvertisedname<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_cancelfindadvertisedname(
                bus: alljoyn_busattachment,
                nameprefix: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_cancelfindadvertisedname(
            bus.into_param().abi(),
            nameprefix.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_cancelfindadvertisednamebytransport<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_cancelfindadvertisednamebytransport(
            bus.into_param().abi(),
            nameprefix.into_param().abi(),
            ::std::mem::transmute(transports),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_cancelwhoimplements_interface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    bus: Param0,
    implementsinterface: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn alljoyn_busattachment_cancelwhoimplements_interface(
                bus: alljoyn_busattachment,
                implementsinterface: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_cancelwhoimplements_interface(
            bus.into_param().abi(),
            implementsinterface.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_cancelwhoimplements_interfaces(
            bus.into_param().abi(),
            ::std::mem::transmute(implementsinterfaces),
            ::std::mem::transmute(numberinterfaces),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_clearkeys<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_clearkeys(
                bus: alljoyn_busattachment,
                guid: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_clearkeys(
            bus.into_param().abi(),
            guid.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_busattachment_clearkeystore<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_connect<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_connect(
                bus: alljoyn_busattachment,
                connectspec: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_connect(
            bus.into_param().abi(),
            connectspec.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_create<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    applicationname: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_create(
            applicationname.into_param().abi(),
            ::std::mem::transmute(allowremotemessages),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_create_concurrency<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    applicationname: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_create_concurrency(
            applicationname.into_param().abi(),
            ::std::mem::transmute(allowremotemessages),
            ::std::mem::transmute(concurrency),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_createinterface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_createinterface(
            bus.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(iface),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_createinterface_secure<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_createinterface_secure(
            bus.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(iface),
            ::std::mem::transmute(secpolicy),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_createinterfacesfromxml<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_createinterfacesfromxml(
                bus: alljoyn_busattachment,
                xml: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_createinterfacesfromxml(
            bus.into_param().abi(),
            xml.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_deletedefaultkeystore<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    applicationname: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_deletedefaultkeystore(
            applicationname.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_busattachment_deleteinterface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
>(
    bus: Param0,
    iface: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_deleteinterface(
            bus.into_param().abi(),
            iface.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_busattachment_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_disconnect<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_disconnect(
                bus: alljoyn_busattachment,
                unused: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_disconnect(
            bus.into_param().abi(),
            unused.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_busattachment_enableconcurrentcallbacks<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_enableconcurrentcallbacks(
            bus.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_enablepeersecurity<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_authlistener>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    bus: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_enablepeersecurity(
                bus: alljoyn_busattachment,
                authmechanisms: super::super::Foundation::PSTR,
                listener: alljoyn_authlistener,
                keystorefilename: super::super::Foundation::PSTR,
                isshared: i32,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_enablepeersecurity(
            bus.into_param().abi(),
            authmechanisms.into_param().abi(),
            listener.into_param().abi(),
            keystorefilename.into_param().abi(),
            ::std::mem::transmute(isshared),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn alljoyn_busattachment_enablepeersecuritywithpermissionconfigurationlistener<
    ...
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_authlistener>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param5: ::windows::runtime::IntoParam<'a, alljoyn_permissionconfigurationlistener>,
>(
    bus: Param0,
    authmechanisms: Param1,
    authlistener: Param2,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(
            alljoyn_busattachment_enablepeersecuritywithpermissionconfigurationlistener(
                bus.into_param().abi(),
                authmechanisms.into_param().abi(),
                authlistener.into_param().abi(),
                keystorefilename.into_param().abi(),
                ::std::mem::transmute(isshared),
                permissionconfigurationlistener.into_param().abi(),
            ),
        )
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_findadvertisedname<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_findadvertisedname(
            bus.into_param().abi(),
            nameprefix.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_findadvertisednamebytransport<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_findadvertisednamebytransport(
            bus.into_param().abi(),
            nameprefix.into_param().abi(),
            ::std::mem::transmute(transports),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_getalljoyndebugobj(
            bus.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_getalljoynproxyobj(
            bus.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_busattachment_getconcurrency<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_getdbusproxyobj(
            bus.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_getglobalguidstring(
            bus.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_getinterface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_getinterface(
            bus.into_param().abi(),
            name.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_getinterfaces(
            bus.into_param().abi(),
            ::std::mem::transmute(ifaces),
            ::std::mem::transmute(numifaces),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_getkeyexpiration<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_getkeyexpiration(
            bus.into_param().abi(),
            guid.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_getpeerguid<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_getpeerguid(
            bus.into_param().abi(),
            name.into_param().abi(),
            guid.into_param().abi(),
            ::std::mem::transmute(guidsz),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_getpermissionconfigurator(
            bus.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_busattachment_isconnected<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
pub unsafe fn alljoyn_busattachment_ispeersecurityenabled<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_ispeersecurityenabled(
            bus.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_busattachment_isstarted<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
pub unsafe fn alljoyn_busattachment_isstopping<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
pub unsafe fn alljoyn_busattachment_join<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_joinsession<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, alljoyn_sessionlistener>,
    Param5: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    bus: Param0,
    sessionhost: Param1,
    sessionport: u16,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_joinsession(
                bus: alljoyn_busattachment,
                sessionhost: super::super::Foundation::PSTR,
                sessionport: u16,
        ...
        ::std::mem::transmute(alljoyn_busattachment_joinsession(
            bus.into_param().abi(),
            sessionhost.into_param().abi(),
            ::std::mem::transmute(sessionport),
            listener.into_param().abi(),
            ::std::mem::transmute(sessionid),
            opts.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_joinsessionasync<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, alljoyn_sessionlistener>,
    Param4: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    bus: Param0,
    sessionhost: Param1,
    sessionport: u16,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_joinsessionasync(
            bus.into_param().abi(),
            sessionhost.into_param().abi(),
            ::std::mem::transmute(sessionport),
            listener.into_param().abi(),
...
pub type alljoyn_busattachment_joinsessioncb_ptr = unsafe extern "system" fn(
    status: QStatus,
    sessionid: u32,
    opts: alljoyn_sessionopts,
    context: *mut ::std::ffi::c_void,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_leavesession(
            bus.into_param().abi(),
            ::std::mem::transmute(sessionid),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_namehasowner<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_namehasowner(
            bus.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(hasowner),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_ping<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_ping(
            bus.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(timeout),
        ))
...
pub unsafe fn alljoyn_busattachment_registeraboutlistener<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_aboutlistener>,
>(
    bus: Param0,
    aboutlistener: Param1,
) {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(alljoyn_busattachment_registeraboutlistener(
            bus.into_param().abi(),
            aboutlistener.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_busattachment_registerapplicationstatelistener<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_applicationstatelistener>,
>(
    bus: Param0,
    listener: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_registerapplicationstatelistener(
            bus.into_param().abi(),
            listener.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_busattachment_registerbuslistener<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_buslistener>,
>(
    bus: Param0,
    listener: Param1,
) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_registerbuslistener(
            bus.into_param().abi(),
            listener.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_busattachment_registerbusobject<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
>(
    bus: Param0,
    obj: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_registerbusobject(
            bus.into_param().abi(),
            obj.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_registerbusobject_secure(
            bus.into_param().abi(),
            obj.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_busattachment_registerkeystorelistener<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_keystorelistener>,
>(
    bus: Param0,
    listener: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_registerkeystorelistener(
            bus.into_param().abi(),
            listener.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_registersignalhandler<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    bus: Param0,
    signal_handler: ::std::option::Option<alljoyn_messagereceiver_signalhandler_ptr>,
    member: Param2,
    srcpath: Param3,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_registersignalhandler(
                bus: alljoyn_busattachment,
                signal_handler: ::windows::runtime::RawPtr,
                member: alljoyn_interfacedescription_member,
                srcpath: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_registersignalhandler(
            bus.into_param().abi(),
            ::std::mem::transmute(signal_handler),
            member.into_param().abi(),
            srcpath.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_registersignalhandlerwithrule<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_registersignalhandlerwithrule(
                ...
                signal_handler: ::windows::runtime::RawPtr,
                member: alljoyn_interfacedescription_member,
                matchrule: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_registersignalhandlerwithrule(
            bus.into_param().abi(),
            ::std::mem::transmute(signal_handler),
            member.into_param().abi(),
            matchrule.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_releasename<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_releasename(
            bus.into_param().abi(),
            name.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_busattachment_reloadkeystore<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_removematch<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_removematch(
            bus.into_param().abi(),
            rule.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_removesessionmember<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_removesessionmember(
                bus: alljoyn_busattachment,
                sessionid: u32,
                membername: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_removesessionmember(
            bus.into_param().abi(),
            ::std::mem::transmute(sessionid),
            membername.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_requestname<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    bus: Param0,
    requestedname: Param1,
    flags: u32,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_requestname(
                bus: alljoyn_busattachment,
                requestedname: super::super::Foundation::PSTR,
                flags: u32,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_requestname(
            bus.into_param().abi(),
            requestedname.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_secureconnection<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_secureconnection(
            bus.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(forceauth),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_secureconnectionasync<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_secureconnectionasync(
            bus.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(forceauth),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_setdaemondebug<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busattachment_setdaemondebug(
                bus: alljoyn_busattachment,
                module: super::super::Foundation::PSTR,
                level: u32,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busattachment_setdaemondebug(
            bus.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_setkeyexpiration<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_setkeyexpiration(
            bus.into_param().abi(),
            guid.into_param().abi(),
            ::std::mem::transmute(timeout),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_setlinktimeout(
            bus.into_param().abi(),
            ::std::mem::transmute(sessionid),
            ::std::mem::transmute(linktimeout),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    sessionid: u32,
    linktimeout: u32,
    callback: ::std::option::Option<alljoyn_busattachment_setlinktimeoutcb_ptr>,
    context: *mut ::std::ffi::c_void,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_setlinktimeoutasync(
            bus.into_param().abi(),
            ::std::mem::transmute(sessionid),
            ::std::mem::transmute(linktimeout),
            ::std::mem::transmute(callback),
...
pub type alljoyn_busattachment_setlinktimeoutcb_ptr =
    unsafe extern "system" fn(status: QStatus, timeout: u32, context: *mut ::std::ffi::c_void);
pub unsafe fn alljoyn_busattachment_setsessionlistener<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_sessionlistener>,
>(
    bus: Param0,
    sessionid: u32,
    listener: Param2,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_setsessionlistener(
            bus.into_param().abi(),
            ::std::mem::transmute(sessionid),
            listener.into_param().abi(),
        ))
...
pub unsafe fn alljoyn_busattachment_start<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
pub unsafe fn alljoyn_busattachment_stop<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_unbindsessionport(
            bus.into_param().abi(),
            ::std::mem::transmute(sessionport),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_unregisteraboutlistener(
            bus.into_param().abi(),
            aboutlistener.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_busattachment_unregisterallaboutlisteners<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_unregisterallaboutlisteners(
            bus.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_busattachment_unregisterallhandlers<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_unregisterallhandlers(
            bus.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_unregisterapplicationstatelistener(
            bus.into_param().abi(),
            listener.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_unregisterbuslistener(
            bus.into_param().abi(),
            listener.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_unregisterbusobject(
            bus.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_unregistersignalhandler<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_unregistersignalhandler(
            bus.into_param().abi(),
            ::std::mem::transmute(signal_handler),
            member.into_param().abi(),
            srcpath.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_unregistersignalhandlerwithrule<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_unregistersignalhandlerwithrule(
            bus.into_param().abi(),
            ::std::mem::transmute(signal_handler),
            member.into_param().abi(),
            matchrule.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busattachment_whoimplements_interface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_whoimplements_interface(
            bus.into_param().abi(),
            implementsinterface.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busattachment_whoimplements_interfaces(
            bus.into_param().abi(),
            ::std::mem::transmute(implementsinterfaces),
            ::std::mem::transmute(numberinterfaces),
        ))
...
pub type alljoyn_buslistener_bus_disconnected_ptr =
    unsafe extern "system" fn(context: *const ::std::ffi::c_void);
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_buslistener_bus_prop_changed_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    prop_name: super::super::Foundation::PSTR,
...
impl ::std::cmp::PartialEq for alljoyn_buslistener_callbacks {
    fn eq(&self, other: &Self) -> bool {
        self.listener_registered.map(|f| f as usize)
            == other.listener_registered.map(|f| f as usize)
            && self.listener_unregistered.map(|f| f as usize)
                == other.listener_unregistered.map(|f| f as usize)
            && self.found_advertised_name.map(|f| f as usize)
                == other.found_advertised_name.map(|f| f as usize)
            && self.lost_advertised_name.map(|f| f as usize)
                == other.lost_advertised_name.map(|f| f as usize)
            && self.name_owner_changed.map(|f| f as usize)
                == other.name_owner_changed.map(|f| f as usize)
            && self.bus_stopping.map(|f| f as usize) == other.bus_stopping.map(|f| f as usize)
            && self.bus_disconnected.map(|f| f as usize)
                == other.bus_disconnected.map(|f| f as usize)
            && self.property_changed.map(|f| f as usize)
                == other.property_changed.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_buslistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_buslistener_create(
            ::std::mem::transmute(callbacks),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_buslistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_buslistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_buslistener_found_advertised_name_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    name: super::super::Foundation::PSTR,
    transport: u16,
    nameprefix: super::super::Foundation::PSTR,
);
pub type alljoyn_buslistener_listener_registered_ptr =
    unsafe extern "system" fn(context: *const ::std::ffi::c_void, bus: alljoyn_busattachment);
pub type alljoyn_buslistener_listener_unregistered_ptr =
    unsafe extern "system" fn(context: *const ::std::ffi::c_void);
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_buslistener_lost_advertised_name_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    name: super::super::Foundation::PSTR,
    transport: u16,
    nameprefix: super::super::Foundation::PSTR,
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_buslistener_name_owner_changed_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    busname: super::super::Foundation::PSTR,
    previousowner: super::super::Foundation::PSTR,
    newowner: super::super::Foundation::PSTR,
);
#[derive(
    :: std :: clone :: Clone,
    :: std :: marker :: Copy,
...
pub unsafe fn alljoyn_busobject_addinterface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
>(
    bus: Param0,
    iface: Param1,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_addinterface(
            bus.into_param().abi(),
            iface.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_addinterface_announced(
            bus.into_param().abi(),
            iface.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_busobject_addmethodhandler<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
>(
    bus: Param0,
    member: Param1,
    handler: ::std::option::Option<alljoyn_messagereceiver_methodhandler_ptr>,
    context: *mut ::std::ffi::c_void,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_addmethodhandler(
            bus.into_param().abi(),
            member.into_param().abi(),
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busobject_addmethodhandlers(
                bus: alljoyn_busobject,
                entries: *const ::std::mem::ManuallyDrop<alljoyn_busobject_methodentry>,
                numentries: usize,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busobject_addmethodhandlers(
            bus.into_param().abi(),
...
impl ::std::cmp::PartialEq for alljoyn_busobject_callbacks {
    fn eq(&self, other: &Self) -> bool {
        self.property_get.map(|f| f as usize) == other.property_get.map(|f| f as usize)
            && self.property_set.map(|f| f as usize) == other.property_set.map(|f| f as usize)
            && self.object_registered.map(|f| f as usize)
                == other.object_registered.map(|f| f as usize)
            && self.object_unregistered.map(|f| f as usize)
                == other.object_unregistered.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_busobject_cancelsessionlessmessage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    bus: Param0,
    msg: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_cancelsessionlessmessage(
            bus.into_param().abi(),
            msg.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_cancelsessionlessmessage_serial(
            bus.into_param().abi(),
            ::std::mem::transmute(serialnumber),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busobject_create<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    path: Param0,
    ...
    context_in: *const ::std::ffi::c_void,
) -> alljoyn_busobject {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn alljoyn_busobject_create(
                path: super::super::Foundation::PSTR,
                isplaceholder: i32,
                callbacks_in: *const ::std::mem::ManuallyDrop<alljoyn_busobject_callbacks>,
                context_in: *const ::std::ffi::c_void,
            ) -> alljoyn_busobject;
        }
        ::std::mem::transmute(alljoyn_busobject_create(
            path.into_param().abi(),
            ::std::mem::transmute(isplaceholder),
            ::std::mem::transmute(callbacks_in),
            ::std::mem::transmute(context_in),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_busobject_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
>(
    bus: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busobject_emitpropertieschanged<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busobject_emitpropertieschanged(
                bus: alljoyn_busobject,
                ifcname: super::super::Foundation::PSTR,
                propnames: *const *const i8,
                numprops: usize,
                id: u32,
            );
        }
        ::std::mem::transmute(alljoyn_busobject_emitpropertieschanged(
            bus.into_param().abi(),
            ifcname.into_param().abi(),
            ::std::mem::transmute(propnames),
            ::std::mem::transmute(numprops),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busobject_emitpropertychanged<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    bus: Param0,
    ifcname: Param1,
    propname: Param2,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busobject_emitpropertychanged(
                bus: alljoyn_busobject,
                ifcname: super::super::Foundation::PSTR,
                propname: super::super::Foundation::PSTR,
                val: alljoyn_msgarg,
                id: u32,
            );
        }
        ::std::mem::transmute(alljoyn_busobject_emitpropertychanged(
            bus.into_param().abi(),
            ifcname.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_getannouncedinterfacenames(
            bus.into_param().abi(),
            ::std::mem::transmute(interfaces),
            ::std::mem::transmute(numinterfaces),
        ))
...
pub unsafe fn alljoyn_busobject_getbusattachment<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
>(
    bus: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busobject_getname<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_getname(
            bus.into_param().abi(),
            buffer.into_param().abi(),
            ::std::mem::transmute(buffersz),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busobject_getpath<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
>(
    bus: Param0,
...
pub unsafe fn alljoyn_busobject_issecure<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
>(
    bus: Param0,
...
impl ::std::fmt::Debug for alljoyn_busobject_methodentry {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_busobject_methodentry")
...
impl ::std::cmp::PartialEq for alljoyn_busobject_methodentry {
    fn eq(&self, other: &Self) -> bool {
        self.member == other.member
            && self.method_handler.map(|f| f as usize) == other.method_handler.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_methodreply_args(
            bus.into_param().abi(),
            msg.into_param().abi(),
            args.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busobject_methodreply_err<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_message>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_busobject_methodreply_err(
                bus: alljoyn_busobject,
                msg: alljoyn_message,
                error: super::super::Foundation::PSTR,
                errormessage: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_busobject_methodreply_err(
            bus.into_param().abi(),
            msg.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_methodreply_status(
            bus.into_param().abi(),
            msg.into_param().abi(),
...
pub type alljoyn_busobject_object_registration_ptr =
    unsafe extern "system" fn(context: *const ::std::ffi::c_void);
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_busobject_prop_get_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    ifcname: super::super::Foundation::PSTR,
    propname: super::super::Foundation::PSTR,
    val: alljoyn_msgarg,
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_busobject_prop_set_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    ifcname: super::super::Foundation::PSTR,
    propname: super::super::Foundation::PSTR,
    val: alljoyn_msgarg,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_setannounceflag(
            bus.into_param().abi(),
            iface.into_param().abi(),
            ::std::mem::transmute(isannounced),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_busobject_signal<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param4: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param8: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    bus: Param0,
    destination: Param1,
    sessionid: u32,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_busobject_signal(
            bus.into_param().abi(),
            destination.into_param().abi(),
            ::std::mem::transmute(sessionid),
            signal.into_param().abi(),
            args.into_param().abi(),
            ::std::mem::transmute(numargs),
...
impl ::std::fmt::Debug for alljoyn_certificateid {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_certificateid")
            .field("serial", &self.serial)
            .field("serialLen", &self.serialLen)
            .field("issuerPublicKey", &self.issuerPublicKey)
            .field("issuerAki", &self.issuerAki)
            .field("issuerAkiLen", &self.issuerAkiLen)
            .finish()
    }
}
impl ::std::cmp::PartialEq for alljoyn_certificateid {
    fn eq(&self, other: &Self) -> bool {
        self.serial == other.serial
            && self.serialLen == other.serialLen
            && self.issuerPublicKey == other.issuerPublicKey
            && self.issuerAki == other.issuerAki
            && self.issuerAkiLen == other.issuerAkiLen
    }
}
...
impl ::std::fmt::Debug for alljoyn_certificateidarray {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_certificateidarray")
...
pub unsafe fn alljoyn_credentials_clear<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
) {
    #[cfg(windows)]
...
pub unsafe fn alljoyn_credentials_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_getcertchain<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
...
pub unsafe fn alljoyn_credentials_getexpiration<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_getlogonentry<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_getpassword<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_getprivateKey<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_getusername<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
...
pub unsafe fn alljoyn_credentials_isset<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_credentials_isset(
            cred.into_param().abi(),
            ::std::mem::transmute(creds),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_setcertchain<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_credentials_setcertchain(
                cred: alljoyn_credentials,
                certchain: super::super::Foundation::PSTR,
            );
        }
        ::std::mem::transmute(alljoyn_credentials_setcertchain(
            cred.into_param().abi(),
            certchain.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_credentials_setexpiration<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
>(
    cred: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_credentials_setexpiration(
            cred.into_param().abi(),
            ::std::mem::transmute(expiration),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_setlogonentry<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_credentials_setlogonentry(
                cred: alljoyn_credentials,
                logonentry: super::super::Foundation::PSTR,
            );
        }
        ::std::mem::transmute(alljoyn_credentials_setlogonentry(
            cred.into_param().abi(),
            logonentry.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_setpassword<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_credentials_setpassword(
                cred: alljoyn_credentials,
                pwd: super::super::Foundation::PSTR,
            );
        }
        ::std::mem::transmute(alljoyn_credentials_setpassword(
            cred.into_param().abi(),
            pwd.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_setprivatekey<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_credentials_setprivatekey(
                cred: alljoyn_credentials,
                pk: super::super::Foundation::PSTR,
            );
        }
        ::std::mem::transmute(alljoyn_credentials_setprivatekey(
            cred.into_param().abi(),
            pk.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_credentials_setusername<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_credentials>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_credentials_setusername(
            cred.into_param().abi(),
            username.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_interfacedescription_activate<
    'a,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_activate(
            iface.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_addannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_addannotation(
            iface.into_param().abi(),
            name.into_param().abi(),
            value.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_addargannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_addargannotation(
                iface: alljoyn_interfacedescription,
                member: super::super::Foundation::PSTR,
                argname: super::super::Foundation::PSTR,
                name: super::super::Foundation::PSTR,
                value: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_interfacedescription_addargannotation(
            iface.into_param().abi(),
            member.into_param().abi(),
            argname.into_param().abi(),
            name.into_param().abi(),
            value.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_addmember<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_addmember(
                ...
                r#type: alljoyn_messagetype,
                name: super::super::Foundation::PSTR,
                inputsig: super::super::Foundation::PSTR,
                outsig: super::super::Foundation::PSTR,
                argnames: super::super::Foundation::PSTR,
                annotation: u8,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_interfacedescription_addmember(
            iface.into_param().abi(),
            ::std::mem::transmute(r#type),
            name.into_param().abi(),
            inputsig.into_param().abi(),
            outsig.into_param().abi(),
            argnames.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_addmemberannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_addmemberannotation(
            iface.into_param().abi(),
            member.into_param().abi(),
            name.into_param().abi(),
            value.into_param().abi(),
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_addmethod(
                ...
                argnames: super::super::Foundation::PSTR,
                annotation: u8,
                accessperms: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_interfacedescription_addmethod(
            iface.into_param().abi(),
            name.into_param().abi(),
            inputsig.into_param().abi(),
            outsig.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_addproperty<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_addproperty(
            iface.into_param().abi(),
            name.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_addpropertyannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_addpropertyannotation(
                iface: alljoyn_interfacedescription,
                property: super::super::Foundation::PSTR,
                name: super::super::Foundation::PSTR,
                value: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_interfacedescription_addpropertyannotation(
            iface.into_param().abi(),
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_addsignal(
                iface: alljoyn_interfacedescription,
                name: super::super::Foundation::PSTR,
                sig: super::super::Foundation::PSTR,
                argnames: super::super::Foundation::PSTR,
                annotation: u8,
                accessperms: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_interfacedescription_addsignal(
            iface.into_param().abi(),
            name.into_param().abi(),
            sig.into_param().abi(),
            argnames.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_eql(
            one.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getannotation(
            iface.into_param().abi(),
            name.into_param().abi(),
            value.into_param().abi(),
            ::std::mem::transmute(value_size),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getannotationatindex<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param4: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getannotationatindex(
            iface.into_param().abi(),
            ::std::mem::transmute(index),
            name.into_param().abi(),
            ::std::mem::transmute(name_size),
            value.into_param().abi(),
            ::std::mem::transmute(value_size),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getannotationscount(
            iface.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getargdescriptionforlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_getargdescriptionforlanguage(
                iface: alljoyn_interfacedescription,
                member: super::super::Foundation::PSTR,
                arg: super::super::Foundation::PSTR,
                description: super::super::Foundation::PSTR,
                maxlanguagelength: usize,
                languagetag: super::super::Foundation::PSTR,
            ) -> usize;
        }
        ::std::mem::transmute(alljoyn_interfacedescription_getargdescriptionforlanguage(
            iface.into_param().abi(),
            member.into_param().abi(),
            arg.into_param().abi(),
            description.into_param().abi(),
            ::std::mem::transmute(maxlanguagelength),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getdescriptionforlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getdescriptionforlanguage(
            iface.into_param().abi(),
            description.into_param().abi(),
            ::std::mem::transmute(maxlanguagelength),
            languagetag.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getdescriptionlanguages(
            iface.into_param().abi(),
            ::std::mem::transmute(languages),
            ::std::mem::transmute(size),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getdescriptionlanguages2<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_getdescriptionlanguages2(
                iface: alljoyn_interfacedescription,
                languages: super::super::Foundation::PSTR,
                languagessize: usize,
            ) -> usize;
        }
        ::std::mem::transmute(alljoyn_interfacedescription_getdescriptionlanguages2(
            iface.into_param().abi(),
            languages.into_param().abi(),
            ::std::mem::transmute(languagessize),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getmember<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getmember(
            iface.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(member),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getmemberannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getmemberannotation(
            iface.into_param().abi(),
            member.into_param().abi(),
            name.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getmemberargannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getmemberargannotation(
            iface.into_param().abi(),
            member.into_param().abi(),
            argname.into_param().abi(),
            name.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getmemberdescriptionforlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getmembers(
            iface.into_param().abi(),
            ::std::mem::transmute(members),
            ::std::mem::transmute(nummembers),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getmethod<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getmethod(
            iface.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(member),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getname(
            iface.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getproperties(
            iface.into_param().abi(),
            ::std::mem::transmute(props),
            ::std::mem::transmute(numprops),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getproperty<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getproperty(
            iface.into_param().abi(),
            name.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getpropertyannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getpropertyannotation(
            iface.into_param().abi(),
            property.into_param().abi(),
            name.into_param().abi(),
            value.into_param().abi(),
            ::std::mem::transmute(str_size),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getpropertydescriptionforlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getsecuritypolicy(
            iface.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_getsignal<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_getsignal(
            iface.into_param().abi(),
            name.into_param().abi(),
            ::std::mem::transmute(member),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_hasdescription(
            iface.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_hasmember<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_hasmember(
                iface: alljoyn_interfacedescription,
                name: super::super::Foundation::PSTR,
                insig: super::super::Foundation::PSTR,
                outsig: super::super::Foundation::PSTR,
            ) -> i32;
        }
        ::std::mem::transmute(alljoyn_interfacedescription_hasmember(
            iface.into_param().abi(),
            name.into_param().abi(),
            insig.into_param().abi(),
            outsig.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_hasproperties(
            iface.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_hasproperty<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_hasproperty(
            iface.into_param().abi(),
            name.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_introspect<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_introspect(
                iface: alljoyn_interfacedescription,
                str: super::super::Foundation::PSTR,
                buf: usize,
                indent: usize,
            ) -> usize;
        }
        ::std::mem::transmute(alljoyn_interfacedescription_introspect(
            iface.into_param().abi(),
            str.into_param().abi(),
            ::std::mem::transmute(buf),
            ::std::mem::transmute(indent),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_interfacedescription_issecure<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
>(
    iface: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_issecure(
            iface.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
impl ::std::cmp::PartialEq for alljoyn_interfacedescription_member {
    fn eq(&self, other: &Self) -> bool {
        self.iface == other.iface
            ...
            && self.returnSignature == other.returnSignature
            && self.argNames == other.argNames
            && self.internal_member == other.internal_member
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_interfacedescription_member_eql<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
>(
    one: Param0,
    other: Param1,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_member_eql(
            one.into_param().abi(),
            other.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_member_getannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_member_getannotation(
            member.into_param().abi(),
            name.into_param().abi(),
            value.into_param().abi(),
            ::std::mem::transmute(value_size),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_member_getannotationatindex<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param4: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_member_getannotationatindex(
            member.into_param().abi(),
            ::std::mem::transmute(index),
            name.into_param().abi(),
            ::std::mem::transmute(name_size),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_member_getannotationscount(
            member.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_member_getargannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_member_getargannotation(
            member.into_param().abi(),
            argname.into_param().abi(),
            name.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_member_getargannotationatindex<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_member_getargannotationatindex(
            member.into_param().abi(),
            argname.into_param().abi(),
            ::std::mem::transmute(index),
            name.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_member_getargannotationscount<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_member_getargannotationscount(
            member.into_param().abi(),
            argname.into_param().abi(),
        ))
    }
...
impl ::std::fmt::Debug for alljoyn_interfacedescription_property {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_interfacedescription_property")
            .field("name", &self.name)
            .field("signature", &self.signature)
            .field("access", &self.access)
            .field("internal_property", &self.internal_property)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for alljoyn_interfacedescription_property {
    fn eq(&self, other: &Self) -> bool {
        self.name == other.name
            ...
            && self.internal_property == other.internal_property
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_interfacedescription_property_eql<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_property>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_property>,
>(
    one: Param0,
    other: Param1,
) -> i32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_property_eql(
            one.into_param().abi(),
            other.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_property_getannotation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_property>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_property_getannotation(
            property.into_param().abi(),
            name.into_param().abi(),
            value.into_param().abi(),
            ::std::mem::transmute(value_size),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_property_getannotationatindex<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_property>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param4: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_property_getannotationatindex(
            property.into_param().abi(),
            ::std::mem::transmute(index),
            name.into_param().abi(),
            ::std::mem::transmute(name_size),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_property_getannotationscount(
            property.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_setargdescription<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_setargdescription(
            iface.into_param().abi(),
            member.into_param().abi(),
            argname.into_param().abi(),
            description.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_setargdescriptionforlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_setargdescriptionforlanguage(
            iface.into_param().abi(),
            member.into_param().abi(),
            arg.into_param().abi(),
            description.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_setdescription<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_setdescription(
            iface.into_param().abi(),
            description.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_setdescriptionforlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_setdescriptionforlanguage(
            iface.into_param().abi(),
            description.into_param().abi(),
            languagetag.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_setdescriptionlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_setdescriptionlanguage(
            iface.into_param().abi(),
            language.into_param().abi(),
        ))
    }
...
>(
    iface: Param0,
    translationcallback: ::std::option::Option<
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_interfacedescription_setdescriptiontranslationcallback(
                iface: alljoyn_interfacedescription,
                translationcallback: ::windows::runtime::RawPtr,
            );
        }
        ::std::mem::transmute(
            alljoyn_interfacedescription_setdescriptiontranslationcallback(
                iface.into_param().abi(),
                ::std::mem::transmute(translationcallback),
            ),
        )
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_setmemberdescription<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_setmemberdescription(
            iface.into_param().abi(),
            member.into_param().abi(),
            description.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_setmemberdescriptionforlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_setpropertydescription<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_interfacedescription_setpropertydescription(
            iface.into_param().abi(),
            name.into_param().abi(),
            description.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_interfacedescription_setpropertydescriptionforlanguage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_interfacedescription_translation_callback_ptr =
    unsafe extern "system" fn(
        sourcelanguage: super::super::Foundation::PSTR,
        targetlanguage: super::super::Foundation::PSTR,
        sourcetext: super::super::Foundation::PSTR,
    ) -> super::super::Foundation::PSTR;
#[derive(
    :: std :: clone :: Clone,
    :: std :: marker :: Copy,
...
pub type alljoyn_keystorelistener_acquireexclusivelock_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    listener: alljoyn_keystorelistener,
) -> QStatus;
#[derive(:: std :: clone :: Clone)]
...
impl ::std::fmt::Debug for alljoyn_keystorelistener_callbacks {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_keystorelistener_callbacks")
            .finish()
    }
}
impl ::std::cmp::PartialEq for alljoyn_keystorelistener_callbacks {
    fn eq(&self, other: &Self) -> bool {
        self.load_request.map(|f| f as usize) == other.load_request.map(|f| f as usize)
            && self.store_request.map(|f| f as usize) == other.store_request.map(|f| f as usize)
    }
}
...
pub unsafe fn alljoyn_keystorelistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_keystorelistener_create(
            ::std::mem::transmute(callbacks),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_keystorelistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_keystorelistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_keystorelistener_destroy(
            listener.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_keystorelistener_getkeys<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_keystorelistener>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_keystore>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    listener: Param0,
    keystore: Param1,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_keystorelistener_getkeys(
                ...
                sink: super::super::Foundation::PSTR,
                sink_sz: *mut usize,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_keystorelistener_getkeys(
            listener.into_param().abi(),
            keystore.into_param().abi(),
            sink.into_param().abi(),
            ::std::mem::transmute(sink_sz),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub type alljoyn_keystorelistener_loadrequest_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    listener: alljoyn_keystorelistener,
    keystore: alljoyn_keystore,
) -> QStatus;
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_keystorelistener_putkeys<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_keystorelistener>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_keystore>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_keystorelistener_putkeys(
            listener.into_param().abi(),
            keystore.into_param().abi(),
...
pub type alljoyn_keystorelistener_releaseexclusivelock_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    listener: alljoyn_keystorelistener,
);
pub type alljoyn_keystorelistener_storerequest_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    listener: alljoyn_keystorelistener,
    keystore: alljoyn_keystore,
) -> QStatus;
...
pub struct alljoyn_keystorelistener_with_synchronization_callbacks {
    pub load_request: ::std::option::Option<alljoyn_keystorelistener_loadrequest_ptr>,
    pub store_request: ::std::option::Option<alljoyn_keystorelistener_storerequest_ptr>,
    pub acquire_exclusive_lock:
        ::std::option::Option<alljoyn_keystorelistener_acquireexclusivelock_ptr>,
    pub release_exclusive_lock:
        ::std::option::Option<alljoyn_keystorelistener_releaseexclusivelock_ptr>,
}
...
impl ::std::fmt::Debug for alljoyn_keystorelistener_with_synchronization_callbacks {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_keystorelistener_with_synchronization_callbacks")
            .finish()
    }
}
impl ::std::cmp::PartialEq for alljoyn_keystorelistener_with_synchronization_callbacks {
    fn eq(&self, other: &Self) -> bool {
        self.load_request.map(|f| f as usize) == other.load_request.map(|f| f as usize)
            && self.store_request.map(|f| f as usize) == other.store_request.map(|f| f as usize)
            && self.acquire_exclusive_lock.map(|f| f as usize)
                == other.acquire_exclusive_lock.map(|f| f as usize)
            && self.release_exclusive_lock.map(|f| f as usize)
                == other.release_exclusive_lock.map(|f| f as usize)
    }
}
...
pub unsafe fn alljoyn_keystorelistener_with_synchronization_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_keystorelistener_with_synchronization_create(
            ::std::mem::transmute(callbacks),
            ::std::mem::transmute(context),
        ))
    }
...
impl ::std::fmt::Debug for alljoyn_manifestarray {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_manifestarray")
            .field("count", &self.count)
            .field("xmls", &self.xmls)
            .finish()
    }
}
...
pub unsafe fn alljoyn_message_create<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
>(
    bus: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_description<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    msg: Param0,
    str: Param1,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_message_description(
            msg.into_param().abi(),
            str.into_param().abi(),
            ::std::mem::transmute(buf),
        ))
...
pub unsafe fn alljoyn_message_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_eql<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_message_eql(
            one.into_param().abi(),
            other.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_message_getarg<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_message_getarg(
            msg.into_param().abi(),
            ::std::mem::transmute(argn),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_message_getargs(
            msg.into_param().abi(),
            ::std::mem::transmute(numargs),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_getauthmechanism<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_getcallserial<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_getcompressiontoken<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_getdestination<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_geterrorname<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_message_geterrorname(
            msg.into_param().abi(),
            errormessage.into_param().abi(),
            ::std::mem::transmute(errormessage_size),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_message_getflags<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_getinterface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_getmembername<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_getobjectpath<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_getreceiveendpointname<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_message_getreceiveendpointname(
            msg.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_message_getreplyserial<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_getsender<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_getsessionid<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_getsignature<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_gettimestamp<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_gettype<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_isbroadcastsignal<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_isencrypted<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_isexpired<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_message_isexpired(
            msg.into_param().abi(),
            ::std::mem::transmute(tillexpirems),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_message_isglobalbroadcast<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_issessionless<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
pub unsafe fn alljoyn_message_isunreliable<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    msg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_parseargs<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_message_parseargs(
            msg.into_param().abi(),
            signature.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_message_tostring<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_message>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_message_tostring(
            msg.into_param().abi(),
            str.into_param().abi(),
            ::std::mem::transmute(buf),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_messagereceiver_methodhandler_ptr = unsafe extern "system" fn(
    bus: alljoyn_busobject,
    member: *const alljoyn_interfacedescription_member,
    message: alljoyn_message,
);
pub type alljoyn_messagereceiver_replyhandler_ptr =
    unsafe extern "system" fn(message: alljoyn_message, context: *mut ::std::ffi::c_void);
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_messagereceiver_signalhandler_ptr = unsafe extern "system" fn(
    member: *const alljoyn_interfacedescription_member,
    srcpath: super::super::Foundation::PSTR,
    message: alljoyn_message,
);
...
pub unsafe fn alljoyn_msgarg_array_element<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_array_element(
            arg.into_param().abi(),
            ::std::mem::transmute(index),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_array_get<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_array_get(
            args.into_param().abi(),
            ::std::mem::transmute(numargs),
            signature.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_array_set<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_array_set(
            args.into_param().abi(),
            ::std::mem::transmute(numargs),
            signature.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_array_set_offset<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_array_set_offset(
            args.into_param().abi(),
            ::std::mem::transmute(argoffset),
            ::std::mem::transmute(numargs),
            signature.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_array_signature<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_array_signature(
            values.into_param().abi(),
            ::std::mem::transmute(numvalues),
            str.into_param().abi(),
            ::std::mem::transmute(buf),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_array_tostring<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_array_tostring(
            args.into_param().abi(),
            ::std::mem::transmute(numargs),
            str.into_param().abi(),
            ::std::mem::transmute(buf),
...
pub unsafe fn alljoyn_msgarg_clear<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
...
pub unsafe fn alljoyn_msgarg_clone<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_clone(
            destination.into_param().abi(),
            source.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_msgarg_copy<'a, Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>>(
    source: Param0,
) -> alljoyn_msgarg {
    #[cfg(windows)]
    {
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_create_and_set<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    signature: Param0,
...
pub unsafe fn alljoyn_msgarg_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
...
pub unsafe fn alljoyn_msgarg_equal<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_equal(
            lhv.into_param().abi(),
            rhv.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_get<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get(
            arg.into_param().abi(),
            signature.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_array_element(
            arg.into_param().abi(),
            ::std::mem::transmute(index),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_array_elementsignature(
            arg.into_param().abi(),
            ::std::mem::transmute(index),
        ))
    }
...
pub unsafe fn alljoyn_msgarg_get_array_numberofelements<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_array_numberofelements(
            arg.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_msgarg_get_bool<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_bool(
            arg.into_param().abi(),
            ::std::mem::transmute(b),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_bool_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ab),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_get_double<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_double(
            arg.into_param().abi(),
            ::std::mem::transmute(d),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_double_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ad),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_get_int16<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_int16(
            arg.into_param().abi(),
            ::std::mem::transmute(n),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_int16_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(an),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_get_int32<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_int32(
            arg.into_param().abi(),
            ::std::mem::transmute(i),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_int32_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
...
pub unsafe fn alljoyn_msgarg_get_int64<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_int64(
            arg.into_param().abi(),
            ::std::mem::transmute(x),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_int64_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ax),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_get_objectpath<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_objectpath(
            arg.into_param().abi(),
            ::std::mem::transmute(o),
        ))
    }
...
pub unsafe fn alljoyn_msgarg_get_signature<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_signature(
            arg.into_param().abi(),
            ::std::mem::transmute(g),
        ))
    }
...
pub unsafe fn alljoyn_msgarg_get_string<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_string(
            arg.into_param().abi(),
            ::std::mem::transmute(s),
        ))
    }
...
pub unsafe fn alljoyn_msgarg_get_uint16<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_uint16(
            arg.into_param().abi(),
            ::std::mem::transmute(q),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_uint16_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(aq),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_get_uint32<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_uint32(
            arg.into_param().abi(),
            ::std::mem::transmute(u),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_uint32_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(au),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_get_uint64<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_uint64(
            arg.into_param().abi(),
            ::std::mem::transmute(t),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_uint64_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(at),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_get_uint8<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_uint8(
            arg.into_param().abi(),
            ::std::mem::transmute(y),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_uint8_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ay),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_get_variant<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_variant(
            arg.into_param().abi(),
            v.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_get_variant_array<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_get_variant_array(
            arg.into_param().abi(),
            signature.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(av),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_getdictelement<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_msgarg_getdictelement(
                arg: alljoyn_msgarg,
                elemsig: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_msgarg_getdictelement(
            arg.into_param().abi(),
            elemsig.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_getkey<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
...
pub unsafe fn alljoyn_msgarg_getmember<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_getmember(
            arg.into_param().abi(),
            ::std::mem::transmute(index),
        ))
    }
...
pub unsafe fn alljoyn_msgarg_getnummembers<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
...
pub unsafe fn alljoyn_msgarg_gettype<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
...
pub unsafe fn alljoyn_msgarg_getvalue<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_hassignature<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_hassignature(
            arg.into_param().abi(),
            signature.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_set<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set(
            arg.into_param().abi(),
            signature.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_set_and_stabilize<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_and_stabilize(
            arg.into_param().abi(),
            signature.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_msgarg_set_bool<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_bool(
            arg.into_param().abi(),
            ::std::mem::transmute(b),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_bool_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ab),
        ))
...
pub unsafe fn alljoyn_msgarg_set_double<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_double(
            arg.into_param().abi(),
            ::std::mem::transmute(d),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_double_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ad),
        ))
...
pub unsafe fn alljoyn_msgarg_set_int16<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_int16(
            arg.into_param().abi(),
            ::std::mem::transmute(n),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_int16_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(an),
        ))
...
pub unsafe fn alljoyn_msgarg_set_int32<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_int32(
            arg.into_param().abi(),
            ::std::mem::transmute(i),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_int32_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ai),
        ))
...
pub unsafe fn alljoyn_msgarg_set_int64<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_int64(
            arg.into_param().abi(),
            ::std::mem::transmute(x),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_int64_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ax),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_set_objectpath<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_msgarg_set_objectpath(
                arg: alljoyn_msgarg,
                o: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_msgarg_set_objectpath(
            arg.into_param().abi(),
            o.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_objectpath_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ao),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_msgarg_set_signature(
                arg: alljoyn_msgarg,
                g: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_msgarg_set_signature(
            arg.into_param().abi(),
            g.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_signature_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ag),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_set_string<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_string(
            arg.into_param().abi(),
            s.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_string_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(r#as),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_msgarg_set_uint16<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_uint16(
            arg.into_param().abi(),
            ::std::mem::transmute(q),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_uint16_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(aq),
        ))
...
pub unsafe fn alljoyn_msgarg_set_uint32<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_uint32(
            arg.into_param().abi(),
            ::std::mem::transmute(u),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_uint32_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(au),
        ))
...
pub unsafe fn alljoyn_msgarg_set_uint64<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_uint64(
            arg.into_param().abi(),
            ::std::mem::transmute(t),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_uint64_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(at),
        ))
...
pub unsafe fn alljoyn_msgarg_set_uint8<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_uint8(
            arg.into_param().abi(),
            ::std::mem::transmute(y),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_set_uint8_array(
            arg.into_param().abi(),
            ::std::mem::transmute(length),
            ::std::mem::transmute(ay),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_setdictentry(
            arg.into_param().abi(),
            key.into_param().abi(),
            value.into_param().abi(),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_setstruct(
            arg.into_param().abi(),
            struct_members.into_param().abi(),
            ::std::mem::transmute(num_members),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_signature<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_signature(
            arg.into_param().abi(),
            str.into_param().abi(),
            ::std::mem::transmute(buf),
        ))
...
pub unsafe fn alljoyn_msgarg_stabilize<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
>(
    arg: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_msgarg_tostring<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_msgarg_tostring(
            arg.into_param().abi(),
            str.into_param().abi(),
            ::std::mem::transmute(buf),
            ::std::mem::transmute(indent),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_observer_create(
            bus.into_param().abi(),
            ::std::mem::transmute(mandatoryinterfaces),
            ::std::mem::transmute(nummandatoryinterfaces),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_observer_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_observer>,
>(
    observer: Param0,
) {
    #[cfg(windows)]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_observer_get<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_observer>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_observer_get(
                ...
                uniquebusname: super::super::Foundation::PSTR,
                objectpath: super::super::Foundation::PSTR,
            ) -> alljoyn_proxybusobject_ref;
        }
        ::std::mem::transmute(alljoyn_observer_get(
            observer.into_param().abi(),
            uniquebusname.into_param().abi(),
...
pub unsafe fn alljoyn_observer_getfirst<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_observer>,
>(
    observer: Param0,
...
pub unsafe fn alljoyn_observer_getnext<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_observer>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject_ref>,
>(
    observer: Param0,
    proxyref: Param1,
) -> alljoyn_proxybusobject_ref {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_observer_getnext(
            observer.into_param().abi(),
            proxyref.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub type alljoyn_observer_object_discovered_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    proxyref: alljoyn_proxybusobject_ref,
);
pub type alljoyn_observer_object_lost_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    proxyref: alljoyn_proxybusobject_ref,
);
pub unsafe fn alljoyn_observer_registerlistener<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_observer>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_observerlistener>,
>(
    observer: Param0,
    listener: Param1,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_observer_registerlistener(
            observer.into_param().abi(),
            listener.into_param().abi(),
            ::std::mem::transmute(triggeronexisting),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn alljoyn_observer_unregisteralllisteners<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_observer>,
>(
    observer: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_observer_unregisteralllisteners(
            observer.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_observer_unregisterlistener(
            observer.into_param().abi(),
            listener.into_param().abi(),
        ))
    }
...
impl ::std::fmt::Debug for alljoyn_observerlistener_callback {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_observerlistener_callback")
            .finish()
    }
}
impl ::std::cmp::PartialEq for alljoyn_observerlistener_callback {
    fn eq(&self, other: &Self) -> bool {
        self.object_discovered.map(|f| f as usize) == other.object_discovered.map(|f| f as usize)
            && self.object_lost.map(|f| f as usize) == other.object_lost.map(|f| f as usize)
    }
}
...
pub unsafe fn alljoyn_observerlistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_observerlistener_create(
            ::std::mem::transmute(callback),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_observerlistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_observerlistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_observerlistener_destroy(
            listener.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_passwordmanager_setcredentials<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    authmechanism: Param0,
    password: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_passwordmanager_setcredentials(
            authmechanism.into_param().abi(),
            password.into_param().abi(),
        ))
    }
...
pub struct alljoyn_permissionconfigurationlistener_callbacks {
    pub factory_reset:
        ::std::option::Option<alljoyn_permissionconfigurationlistener_factoryreset_ptr>,
    pub policy_changed:
        ::std::option::Option<alljoyn_permissionconfigurationlistener_policychanged_ptr>,
    pub start_management:
        ::std::option::Option<alljoyn_permissionconfigurationlistener_startmanagement_ptr>,
    pub end_management:
        ::std::option::Option<alljoyn_permissionconfigurationlistener_endmanagement_ptr>,
}
...
impl ::std::fmt::Debug for alljoyn_permissionconfigurationlistener_callbacks {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_permissionconfigurationlistener_callbacks")
            .finish()
    }
}
impl ::std::cmp::PartialEq for alljoyn_permissionconfigurationlistener_callbacks {
    fn eq(&self, other: &Self) -> bool {
        self.factory_reset.map(|f| f as usize) == other.factory_reset.map(|f| f as usize)
            && self.policy_changed.map(|f| f as usize) == other.policy_changed.map(|f| f as usize)
            && self.start_management.map(|f| f as usize)
                == other.start_management.map(|f| f as usize)
            && self.end_management.map(|f| f as usize) == other.end_management.map(|f| f as usize)
    }
}
...
pub unsafe fn alljoyn_permissionconfigurationlistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurationlistener_create(
            ::std::mem::transmute(callbacks),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_permissionconfigurationlistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_permissionconfigurationlistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurationlistener_destroy(
            listener.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub type alljoyn_permissionconfigurationlistener_factoryreset_ptr =
    unsafe extern "system" fn(context: *const ::std::ffi::c_void) -> QStatus;
...
pub unsafe fn alljoyn_permissionconfigurator_certificatechain_destroy(certificatechain: *mut i8) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_certificatechain_destroy(
            ::std::mem::transmute(certificatechain),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn alljoyn_permissionconfigurator_certificateid_cleanup(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_certificateid_cleanup(
            ::std::mem::transmute(certificateid),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn alljoyn_permissionconfigurator_certificateidarray_cleanup(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_certificateidarray_cleanup(
            ::std::mem::transmute(certificateidarray),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn alljoyn_permissionconfigurator_claim<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_permissionconfigurator>,
>(
    configurator: Param0,
    cakey: *mut i8,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_endmanagement(
            configurator.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getapplicationstate(
            configurator.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getclaimcapabilities(
            configurator.into_param().abi(),
            ::std::mem::transmute(claimcapabilities),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(
            alljoyn_permissionconfigurator_getclaimcapabilitiesadditionalinfo(
                configurator.into_param().abi(),
                ::std::mem::transmute(additionalinfo),
            ),
        )
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getdefaultpolicy(
            configurator.into_param().abi(),
            ::std::mem::transmute(policyxml),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getidentity(
            configurator.into_param().abi(),
            ::std::mem::transmute(identitycertificatechain),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getidentitycertificateid(
            configurator.into_param().abi(),
            ::std::mem::transmute(certificateid),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getmanifests(
            configurator.into_param().abi(),
            ::std::mem::transmute(manifestarray),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getmanifesttemplate(
            configurator.into_param().abi(),
            ::std::mem::transmute(manifesttemplatexml),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getmembershipsummaries(
            configurator.into_param().abi(),
            ::std::mem::transmute(certificateids),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getpolicy(
            configurator.into_param().abi(),
            ::std::mem::transmute(policyxml),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_getpublickey(
            configurator.into_param().abi(),
            ::std::mem::transmute(publickey),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_installmanifests(
            configurator.into_param().abi(),
            ::std::mem::transmute(manifestsxmls),
            ::std::mem::transmute(manifestscount),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_installmembership(
            configurator.into_param().abi(),
            ::std::mem::transmute(membershipcertificatechain),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn alljoyn_permissionconfigurator_manifestarray_cleanup(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_manifestarray_cleanup(
            ::std::mem::transmute(manifestarray),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_permissionconfigurator_manifesttemplate_destroy(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_manifesttemplate_destroy(
            ::std::mem::transmute(manifesttemplatexml),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_permissionconfigurator_policy_destroy(policyxml: *mut i8) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_policy_destroy(
            ::std::mem::transmute(policyxml),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_permissionconfigurator_publickey_destroy(publickey: *mut i8) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_publickey_destroy(
            ::std::mem::transmute(publickey),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_removemembership(
            configurator.into_param().abi(),
            ::std::mem::transmute(serial),
            ::std::mem::transmute(seriallen),
            ::std::mem::transmute(issuerpublickey),
            ::std::mem::transmute(issueraki),
            ::std::mem::transmute(issuerakilen),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_reset(
            configurator.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_resetpolicy(
            configurator.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_setapplicationstate(
            configurator.into_param().abi(),
            ::std::mem::transmute(state),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_setclaimcapabilities(
            configurator.into_param().abi(),
            ::std::mem::transmute(claimcapabilities),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_setmanifesttemplatefromxml(
            configurator.into_param().abi(),
            ::std::mem::transmute(manifesttemplatexml),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_startmanagement(
            configurator.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_updateidentity(
            configurator.into_param().abi(),
            ::std::mem::transmute(identitycertificatechain),
            ::std::mem::transmute(manifestsxmls),
            ::std::mem::transmute(manifestscount),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_permissionconfigurator_updatepolicy(
            configurator.into_param().abi(),
            ::std::mem::transmute(policyxml),
        ))
    }
...
impl ::std::cmp::PartialEq for alljoyn_pinglistener_callback {
    fn eq(&self, other: &Self) -> bool {
        self.destination_found.map(|f| f as usize) == other.destination_found.map(|f| f as usize)
            && self.destination_lost.map(|f| f as usize)
                == other.destination_lost.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_pinglistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_pinglistener_create(
            ::std::mem::transmute(callback),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_pinglistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_pinglistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
...
pub unsafe fn alljoyn_proxybusobject_addchild<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
>(
    proxyobj: Param0,
    child: Param1,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_addchild(
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_addinterface(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_addinterface_by_name<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_addinterface_by_name(
            proxyobj.into_param().abi(),
            name.into_param().abi(),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_create<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_proxybusobject_create(
                bus: alljoyn_busattachment,
                service: super::super::Foundation::PSTR,
                path: super::super::Foundation::PSTR,
                sessionid: u32,
            ) -> alljoyn_proxybusobject;
        }
        ::std::mem::transmute(alljoyn_proxybusobject_create(
            bus.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_create_secure<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_busattachment>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_create_secure(
            bus.into_param().abi(),
            service.into_param().abi(),
            path.into_param().abi(),
            ::std::mem::transmute(sessionid),
...
pub unsafe fn alljoyn_proxybusobject_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
>(
    proxyobj: Param0,
...
pub unsafe fn alljoyn_proxybusobject_enablepropertycaching<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
>(
    proxyobj: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_enablepropertycaching(
            proxyobj.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_getallproperties<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_proxybusobject_getallproperties(
                proxyobj: alljoyn_proxybusobject,
                iface: super::super::Foundation::PSTR,
                values: alljoyn_msgarg,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_proxybusobject_getallproperties(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
            values.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_getallpropertiesasync<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    proxyobj: Param0,
    iface: Param1,
    callback: ::std::option::Option<alljoyn_proxybusobject_listener_getallpropertiescb_ptr>,
    timeout: u32,
    context: *mut ::std::ffi::c_void,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getallpropertiesasync(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
            ::std::mem::transmute(callback),
            ::std::mem::transmute(timeout),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_getchild<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getchild(
            proxyobj.into_param().abi(),
            path.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getchildren(
            proxyobj.into_param().abi(),
            ::std::mem::transmute(children),
            ::std::mem::transmute(numchildren),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_getinterface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getinterface(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getinterfaces(
            proxyobj.into_param().abi(),
            ::std::mem::transmute(ifaces),
            ::std::mem::transmute(numifaces),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_getproperty<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getproperty(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
            property.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_getpropertyasync<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    iface: Param1,
    property: Param2,
    callback: ::std::option::Option<alljoyn_proxybusobject_listener_getpropertycb_ptr>,
    timeout: u32,
    context: *mut ::std::ffi::c_void,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getpropertyasync(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
            property.into_param().abi(),
            ::std::mem::transmute(callback),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getservicename(
            proxyobj.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_proxybusobject_getsessionid<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
>(
    proxyobj: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getsessionid(
            proxyobj.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_getuniquename(
            proxyobj.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_implementsinterface<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_implementsinterface(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_introspectremoteobject(
            proxyobj.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    proxyobj: Param0,
    callback: ::std::option::Option<alljoyn_proxybusobject_listener_introspectcb_ptr>,
    context: *mut ::std::ffi::c_void,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_introspectremoteobjectasync(
            proxyobj.into_param().abi(),
            ::std::mem::transmute(callback),
            ::std::mem::transmute(context),
        ))
...
pub unsafe fn alljoyn_proxybusobject_issecure<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
>(
    proxyobj: Param0,
...
pub unsafe fn alljoyn_proxybusobject_isvalid<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
>(
    proxyobj: Param0,
...
pub type alljoyn_proxybusobject_listener_getallpropertiescb_ptr = unsafe extern "system" fn(
    status: QStatus,
    obj: alljoyn_proxybusobject,
    values: alljoyn_msgarg,
    context: *mut ::std::ffi::c_void,
);
pub type alljoyn_proxybusobject_listener_getpropertycb_ptr = unsafe extern "system" fn(
    status: QStatus,
    obj: alljoyn_proxybusobject,
    value: alljoyn_msgarg,
    context: *mut ::std::ffi::c_void,
);
pub type alljoyn_proxybusobject_listener_introspectcb_ptr = unsafe extern "system" fn(
    status: QStatus,
    obj: alljoyn_proxybusobject,
    context: *mut ::std::ffi::c_void,
);
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_proxybusobject_listener_propertieschanged_ptr = unsafe extern "system" fn(
    obj: alljoyn_proxybusobject,
    ifacename: super::super::Foundation::PSTR,
    changed: alljoyn_msgarg,
    invalidated: alljoyn_msgarg,
    context: *mut ::std::ffi::c_void,
);
pub type alljoyn_proxybusobject_listener_setpropertycb_ptr = unsafe extern "system" fn(
    status: QStatus,
    obj: alljoyn_proxybusobject,
    context: *mut ::std::ffi::c_void,
);
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_methodcall<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param5: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    proxyobj: Param0,
    ifacename: Param1,
    methodname: Param2,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_proxybusobject_methodcall(
                proxyobj: alljoyn_proxybusobject,
                ifacename: super::super::Foundation::PSTR,
                methodname: super::super::Foundation::PSTR,
                args: alljoyn_msgarg,
                numargs: usize,
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_methodcall(
            proxyobj.into_param().abi(),
            ifacename.into_param().abi(),
            methodname.into_param().abi(),
            args.into_param().abi(),
            ::std::mem::transmute(numargs),
            replymsg.into_param().abi(),
            ::std::mem::transmute(timeout),
            ::std::mem::transmute(flags),
        ))
    }
...
pub unsafe fn alljoyn_proxybusobject_methodcall_member<
    ...
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_interfacedescription_member>,
    Param2: ::windows::runtime::IntoParam<'a, alljoyn_msgarg>,
    Param4: ::windows::runtime::IntoParam<'a, alljoyn_message>,
>(
    proxyobj: Param0,
    method: Param1,
    args: Param2,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_methodcall_member(
            proxyobj.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_methodcall_member_noreply(
            proxyobj.into_param().abi(),
            method.into_param().abi(),
            args.into_param().abi(),
            ::std::mem::transmute(numargs),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_methodcall_noreply<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_methodcall_noreply(
            proxyobj.into_param().abi(),
            ifacename.into_param().abi(),
            methodname.into_param().abi(),
            args.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_methodcallasync<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_proxybusobject_methodcallasync(
                ...
                ifacename: super::super::Foundation::PSTR,
                methodname: super::super::Foundation::PSTR,
                replyfunc: ::windows::runtime::RawPtr,
                args: alljoyn_msgarg,
                numargs: usize,
                context: *mut ::std::ffi::c_void,
                timeout: u32,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_methodcallasync_member(
            proxyobj.into_param().abi(),
            method.into_param().abi(),
            ::std::mem::transmute(replyfunc),
            args.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_parsexml<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn alljoyn_proxybusobject_parsexml(
                proxyobj: alljoyn_proxybusobject,
                xml: super::super::Foundation::PSTR,
                identifier: super::super::Foundation::PSTR,
            ) -> QStatus;
        }
        ::std::mem::transmute(alljoyn_proxybusobject_parsexml(
            proxyobj.into_param().abi(),
            xml.into_param().abi(),
...
pub unsafe fn alljoyn_proxybusobject_ref_decref<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject_ref>,
>(
    r#ref: Param0,
) {
    #[cfg(windows)]
...
pub unsafe fn alljoyn_proxybusobject_ref_incref<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject_ref>,
>(
    r#ref: Param0,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_registerpropertieschangedlistener<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    numproperties: usize,
    callback: ::std::option::Option<alljoyn_proxybusobject_listener_propertieschanged_ptr>,
    context: *mut ::std::ffi::c_void,
) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_registerpropertieschangedlistener(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
            ::std::mem::transmute(properties),
            ::std::mem::transmute(numproperties),
            ::std::mem::transmute(callback),
            ::std::mem::transmute(context),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_removechild<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_removechild(
            proxyobj.into_param().abi(),
            path.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_secureconnection(
            proxyobj.into_param().abi(),
            ::std::mem::transmute(forceauth),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_secureconnectionasync(
            proxyobj.into_param().abi(),
            ::std::mem::transmute(forceauth),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_setproperty<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_setproperty(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
            property.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_setpropertyasync<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_setpropertyasync(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
            property.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn alljoyn_proxybusobject_unregisterpropertieschangedlistener<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_proxybusobject>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_proxybusobject_unregisterpropertieschangedlistener(
            proxyobj.into_param().abi(),
            iface.into_param().abi(),
            ::std::mem::transmute(callback),
        ))
...
pub unsafe fn alljoyn_routerinitwithconfig(configxml: *mut i8) -> QStatus {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_routerinitwithconfig(::std::mem::transmute(
            configxml,
        )))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_securityapplicationproxy_claim<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_securityapplicationproxy>,
>(
    proxy: Param0,
    cakey: *mut i8,
    identitycertificatechain: *mut i8,
...
pub unsafe fn alljoyn_securityapplicationproxy_computemanifestdigest(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_computemanifestdigest(
            ::std::mem::transmute(unsignedmanifestxml),
            ::std::mem::transmute(identitycertificatepem),
            ::std::mem::transmute(digest),
            ::std::mem::transmute(digestsize),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_create(
            bus.into_param().abi(),
            ::std::mem::transmute(appbusname),
            ::std::mem::transmute(sessionid),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_securityapplicationproxy_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_securityapplicationproxy>,
>(
    proxy: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_destroy(
            proxy.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_securityapplicationproxy_digest_destroy(digest: *mut u8) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_digest_destroy(
            ::std::mem::transmute(digest),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_securityapplicationproxy_eccpublickey_destroy(eccpublickey: *mut i8) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_eccpublickey_destroy(
            ::std::mem::transmute(eccpublickey),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_endmanagement(
            proxy.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_getapplicationstate(
            proxy.into_param().abi(),
            ::std::mem::transmute(applicationstate),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_getclaimcapabilities(
            proxy.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_getdefaultpolicy(
            proxy.into_param().abi(),
            ::std::mem::transmute(policyxml),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_geteccpublickey(
            proxy.into_param().abi(),
            ::std::mem::transmute(eccpublickey),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_getmanifesttemplate(
            proxy.into_param().abi(),
            ::std::mem::transmute(manifesttemplatexml),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_getpolicy(
            proxy.into_param().abi(),
            ::std::mem::transmute(policyxml),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_installmembership(
            proxy.into_param().abi(),
            ::std::mem::transmute(membershipcertificatechain),
        ))
    }
...
pub unsafe fn alljoyn_securityapplicationproxy_manifest_destroy(signedmanifestxml: *mut i8) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_manifest_destroy(
            ::std::mem::transmute(signedmanifestxml),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn alljoyn_securityapplicationproxy_manifesttemplate_destroy(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_manifesttemplate_destroy(
            ::std::mem::transmute(manifesttemplatexml),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_securityapplicationproxy_policy_destroy(policyxml: *mut i8) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_policy_destroy(
            ::std::mem::transmute(policyxml),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_reset(
            proxy.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_resetpolicy(
            proxy.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_securityapplicationproxy_setmanifestsignature(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_setmanifestsignature(
            ::std::mem::transmute(unsignedmanifestxml),
            ::std::mem::transmute(identitycertificatepem),
            ::std::mem::transmute(signature),
            ::std::mem::transmute(signaturesize),
            ::std::mem::transmute(signedmanifestxml),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_securityapplicationproxy_signmanifest(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_signmanifest(
            ::std::mem::transmute(unsignedmanifestxml),
            ::std::mem::transmute(identitycertificatepem),
            ::std::mem::transmute(signingprivatekeypem),
            ::std::mem::transmute(signedmanifestxml),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_startmanagement(
            proxy.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_updateidentity(
            proxy.into_param().abi(),
            ::std::mem::transmute(identitycertificatechain),
            ::std::mem::transmute(manifestsxmls),
            ::std::mem::transmute(manifestscount),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_securityapplicationproxy_updatepolicy(
            proxy.into_param().abi(),
            ::std::mem::transmute(policyxml),
        ))
    }
...
pub struct alljoyn_sessionlistener_callbacks {
    ...
    pub session_member_removed:
        ::std::option::Option<alljoyn_sessionlistener_sessionmemberremoved_ptr>,
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for alljoyn_sessionlistener_callbacks {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_sessionlistener_callbacks")
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for alljoyn_sessionlistener_callbacks {
    fn eq(&self, other: &Self) -> bool {
        self.session_lost.map(|f| f as usize) == other.session_lost.map(|f| f as usize)
            && self.session_member_added.map(|f| f as usize)
                == other.session_member_added.map(|f| f as usize)
            && self.session_member_removed.map(|f| f as usize)
                == other.session_member_removed.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_sessionlistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionlistener_create(
            ::std::mem::transmute(callbacks),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_sessionlistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionlistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
...
pub type alljoyn_sessionlistener_sessionlost_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    sessionid: u32,
    reason: alljoyn_sessionlostreason,
);
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_sessionlistener_sessionmemberadded_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    sessionid: u32,
    uniquename: super::super::Foundation::PSTR,
);
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_sessionlistener_sessionmemberremoved_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    sessionid: u32,
    uniquename: super::super::Foundation::PSTR,
);
...
pub unsafe fn alljoyn_sessionopts_cmp<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
    Param1: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    one: Param0,
    other: Param1,
) -> i32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionopts_cmp(
            one.into_param().abi(),
            other.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_sessionopts_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionopts_create(
            ::std::mem::transmute(traffic),
            ::std::mem::transmute(ismultipoint),
            ::std::mem::transmute(proximity),
            ::std::mem::transmute(transports),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn alljoyn_sessionopts_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    opts: Param0,
...
pub unsafe fn alljoyn_sessionopts_get_multipoint<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    opts: Param0,
...
pub unsafe fn alljoyn_sessionopts_get_proximity<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    opts: Param0,
...
pub unsafe fn alljoyn_sessionopts_get_traffic<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    opts: Param0,
...
pub unsafe fn alljoyn_sessionopts_get_transports<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    opts: Param0,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionopts_iscompatible(
            one.into_param().abi(),
            other.into_param().abi(),
        ))
    }
...
pub unsafe fn alljoyn_sessionopts_set_multipoint<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    opts: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionopts_set_multipoint(
            opts.into_param().abi(),
            ::std::mem::transmute(ismultipoint),
        ))
    }
...
pub unsafe fn alljoyn_sessionopts_set_proximity<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    opts: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionopts_set_proximity(
            opts.into_param().abi(),
            ::std::mem::transmute(proximity),
        ))
    }
...
pub unsafe fn alljoyn_sessionopts_set_traffic<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    opts: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionopts_set_traffic(
            opts.into_param().abi(),
            ::std::mem::transmute(traffic),
        ))
    }
...
pub unsafe fn alljoyn_sessionopts_set_transports<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionopts>,
>(
    opts: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionopts_set_transports(
            opts.into_param().abi(),
            ::std::mem::transmute(transports),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_sessionportlistener_acceptsessionjoiner_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    sessionport: u16,
    joiner: super::super::Foundation::PSTR,
    opts: alljoyn_sessionopts,
) -> i32;
#[derive(:: std :: clone :: Clone)]
#[repr(C)]
...
pub struct alljoyn_sessionportlistener_callbacks {
    pub accept_session_joiner:
        ::std::option::Option<alljoyn_sessionportlistener_acceptsessionjoiner_ptr>,
...
impl ::std::fmt::Debug for alljoyn_sessionportlistener_callbacks {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("alljoyn_sessionportlistener_callbacks")
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for alljoyn_sessionportlistener_callbacks {
    fn eq(&self, other: &Self) -> bool {
        self.accept_session_joiner.map(|f| f as usize)
            == other.accept_session_joiner.map(|f| f as usize)
            && self.session_joined.map(|f| f as usize) == other.session_joined.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub unsafe fn alljoyn_sessionportlistener_create(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionportlistener_create(
            ::std::mem::transmute(callbacks),
            ::std::mem::transmute(context),
        ))
    }
...
pub unsafe fn alljoyn_sessionportlistener_destroy<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, alljoyn_sessionportlistener>,
>(
    listener: Param0,
) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_sessionportlistener_destroy(
            listener.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub type alljoyn_sessionportlistener_sessionjoined_ptr = unsafe extern "system" fn(
    context: *const ::std::ffi::c_void,
    sessionport: u16,
    id: u32,
    joiner: super::super::Foundation::PSTR,
...
pub unsafe fn alljoyn_unity_set_deferred_callback_mainthread_only(mainthread_only: i32) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(alljoyn_unity_set_deferred_callback_mainthread_only(
            ::std::mem::transmute(mainthread_only),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
