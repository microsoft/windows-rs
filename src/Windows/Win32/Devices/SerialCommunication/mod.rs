...
pub unsafe fn ComDBClaimNextFreePort<'a, Param0: ::windows::runtime::IntoParam<'a, HCOMDB>>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ComDBClaimNextFreePort(
            hcomdb.into_param().abi(),
            ::std::mem::transmute(comnumber),
        ))
    }
    #[cfg(not(windows))]
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ComDBClaimPort(
                hcomdb: HCOMDB,
                comnumber: u32,
                forceclaim: super::super::Foundation::BOOL,
                forced: *mut super::super::Foundation::BOOL,
            ) -> i32;
        }
        ::std::mem::transmute(ComDBClaimPort(
            hcomdb.into_param().abi(),
            ::std::mem::transmute(comnumber),
            forceclaim.into_param().abi(),
            ::std::mem::transmute(forced),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn ComDBGetCurrentPortUsage<'a, Param0: ::windows::runtime::IntoParam<'a, HCOMDB>>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ComDBGetCurrentPortUsage(
            hcomdb.into_param().abi(),
            ::std::mem::transmute(buffer),
            ::std::mem::transmute(buffersize),
            ::std::mem::transmute(reporttype),
            ::std::mem::transmute(maxportsreported),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn ComDBReleasePort<'a, Param0: ::windows::runtime::IntoParam<'a, HCOMDB>>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ComDBReleasePort(
            hcomdb.into_param().abi(),
            ::std::mem::transmute(comnumber),
        ))
    }
...
pub unsafe fn ComDBResizeDatabase<'a, Param0: ::windows::runtime::IntoParam<'a, HCOMDB>>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ComDBResizeDatabase(
            hcomdb.into_param().abi(),
