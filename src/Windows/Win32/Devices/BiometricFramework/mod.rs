...
pub const GUID_DEVINTERFACE_BIOMETRIC_READER: ::windows::runtime::GUID =
...
pub type PIBIO_ENGINE_SELECT_CALIBRATION_FORMAT_FN =
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        formatarray: *const ::windows::runtime::GUID,
        formatcount: usize,
...
pub type PIBIO_FRAMEWORK_GET_PROPERTY_FN = unsafe extern "system" fn(
    ...
    identity: *const WINBIO_IDENTITY,
    subfactor: u8,
    propertybuffer: *mut *mut ::std::ffi::c_void,
...
pub type PIBIO_SENSOR_QUERY_CALIBRATION_FORMATS_FN =
    unsafe extern "system" fn(
        pipeline: *mut WINBIO_PIPELINE,
        formatarray: *mut ::windows::runtime::GUID,
...
pub type PWINBIO_CAPTURE_CALLBACK = unsafe extern "system" fn(
    capturecallbackcontext: *const ::std::ffi::c_void,
...
pub type PWINBIO_ENROLL_CAPTURE_CALLBACK = unsafe extern "system" fn(
    enrollcallbackcontext: *const ::std::ffi::c_void,
    operationstatus: ::windows::runtime::HRESULT,
    rejectdetail: u32,
);
pub type PWINBIO_EVENT_CALLBACK = unsafe extern "system" fn(
    eventcallbackcontext: *const ::std::ffi::c_void,
    operationstatus: ::windows::runtime::HRESULT,
    event: *const WINBIO_EVENT,
);
pub type PWINBIO_IDENTIFY_CALLBACK = unsafe extern "system" fn(
    identifycallbackcontext: *const ::std::ffi::c_void,
    operationstatus: ::windows::runtime::HRESULT,
    unitid: u32,
    identity: *const WINBIO_IDENTITY,
    subfactor: u8,
...
pub type PWINBIO_LOCATE_SENSOR_CALLBACK = unsafe extern "system" fn(
    locatecallbackcontext: *const ::std::ffi::c_void,
    operationstatus: ::windows::runtime::HRESULT,
    unitid: u32,
);
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_SystemServices"))]
...
#[cfg(feature = "Win32_Foundation")]
pub type PWINBIO_VERIFY_CALLBACK = unsafe extern "system" fn(
    verifycallbackcontext: *const ::std::ffi::c_void,
    operationstatus: ::windows::runtime::HRESULT,
    unitid: u32,
...
impl ::std::fmt::Debug for WINBIO_ADAPTER_INTERFACE_VERSION {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_ADAPTER_INTERFACE_VERSION")
...
impl ::std::fmt::Debug for WINBIO_ANTI_SPOOF_POLICY {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_ANTI_SPOOF_POLICY")
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_CaptureSample_e__Struct")
            .field("Sample", &self.Sample)
            .field("SampleSize", &self.SampleSize)
            .field("RejectDetail", &self.RejectDetail)
            .finish()
    }
}
...
impl ::std::cmp::PartialEq for WINBIO_ASYNC_RESULT_0_1 {
    fn eq(&self, other: &Self) -> bool {
        self.Component == other.Component
            ...
            && self.SendBuffer == other.SendBuffer
            && self.SendBufferSize == other.SendBufferSize
            && self.ReceiveBuffer == other.ReceiveBuffer
            && self.ReceiveBufferSize == other.ReceiveBufferSize
            && self.ReceiveDataSize == other.ReceiveDataSize
    }
}
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_3 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_EnrollBegin_e__Struct")
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_4 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_EnrollCapture_e__Struct")
            .field("RejectDetail", &self.RejectDetail)
            .finish()
    }
}
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_6 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_EnrollSelect_e__Struct")
            .field("SelectorValue", &self.SelectorValue)
            .finish()
    }
}
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_7 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_EnumBiometricUnits_e__Struct")
            .field("UnitCount", &self.UnitCount)
            .field("UnitSchemaArray", &self.UnitSchemaArray)
            .finish()
    }
}
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_8 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_EnumDatabases_e__Struct")
            .field("StorageCount", &self.StorageCount)
            .field("StorageSchemaArray", &self.StorageSchemaArray)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_ASYNC_RESULT_0_8 {
    fn eq(&self, other: &Self) -> bool {
        self.StorageCount == other.StorageCount
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_10 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_EnumServiceProviders_e__Struct")
            .field("BspCount", &self.BspCount)
            .field("BspSchemaArray", &self.BspSchemaArray)
            .finish()
    }
}
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_16 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_MonitorPresence_e__Struct")
            .field("ChangeType", &self.ChangeType)
            .field("PresenceCount", &self.PresenceCount)
            .field("PresenceArray", &self.PresenceArray)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for WINBIO_ASYNC_RESULT_0_16 {
    fn eq(&self, other: &Self) -> bool {
        self.ChangeType == other.ChangeType
            && self.PresenceCount == other.PresenceCount
            && self.PresenceArray == other.PresenceArray
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_17 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_NotifyUnitStatusChange_e__Struct")
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_19 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_VerifyAndReleaseTicket_e__Struct")
            .field("Match", &self.Match)
            .field("RejectDetail", &self.RejectDetail)
...
impl ::std::fmt::Debug for WINBIO_ASYNC_RESULT_0_20 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_Verify_e__Struct")
            .field("Match", &self.Match)
            .field("RejectDetail", &self.RejectDetail)
            .finish()
    }
...
impl ::std::cmp::PartialEq for WINBIO_BDB_ANSI_381_RECORD {
    fn eq(&self, other: &Self) -> bool {
        self.BlockLength == other.BlockLength
            && self.HorizontalLineLength == other.HorizontalLineLength
            && self.VerticalLineLength == other.VerticalLineLength
            && self.Position == other.Position
            && self.CountOfViews == other.CountOfViews
            && self.ViewNumber == other.ViewNumber
            && self.ImageQuality == other.ImageQuality
            && self.ImpressionType == other.ImpressionType
            && self.Reserved == other.Reserved
    }
}
...
impl ::std::fmt::Debug for WINBIO_BIR {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_BIR")
            .field("HeaderBlock", &self.HeaderBlock)
            .field("StandardDataBlock", &self.StandardDataBlock)
            .field("VendorDataBlock", &self.VendorDataBlock)
            .field("SignatureBlock", &self.SignatureBlock)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_BIR {
    fn eq(&self, other: &Self) -> bool {
        self.HeaderBlock == other.HeaderBlock
            && self.StandardDataBlock == other.StandardDataBlock
            && self.VendorDataBlock == other.VendorDataBlock
            && self.SignatureBlock == other.SignatureBlock
    }
}
...
impl ::std::fmt::Debug for WINBIO_BIR_DATA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_BIR_DATA")
...
impl ::std::fmt::Debug for WINBIO_BIR_HEADER_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_ValidityPeriod_e__Struct")
            .field("BeginDate", &self.BeginDate)
...
impl ::std::fmt::Debug for WINBIO_BLANK_PAYLOAD {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_BLANK_PAYLOAD")
...
impl ::std::fmt::Debug for WINBIO_BSP_SCHEMA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_BSP_SCHEMA")
            .field("BiometricFactor", &self.BiometricFactor)
            .field("BspId", &self.BspId)
...
impl ::std::cmp::PartialEq for WINBIO_BSP_SCHEMA {
    fn eq(&self, other: &Self) -> bool {
        self.BiometricFactor == other.BiometricFactor
            && self.BspId == other.BspId
...
impl ::std::fmt::Debug for WINBIO_CALIBRATION_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_CALIBRATION_INFO")
            .field("PayloadSize", &self.PayloadSize)
            .field("WinBioHresult", &self.WinBioHresult)
            .field("CalibrationData", &self.CalibrationData)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_CALIBRATION_INFO {
    fn eq(&self, other: &Self) -> bool {
        self.PayloadSize == other.PayloadSize
            ...
            && self.CalibrationData == other.CalibrationData
    }
}
...
impl ::std::fmt::Debug for WINBIO_CAPTURE_DATA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_CAPTURE_DATA")
            .field("PayloadSize", &self.PayloadSize)
            .field("WinBioHresult", &self.WinBioHresult)
            .field("SensorStatus", &self.SensorStatus)
            .field("RejectDetail", &self.RejectDetail)
            .field("CaptureData", &self.CaptureData)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_CAPTURE_DATA {
    fn eq(&self, other: &Self) -> bool {
        self.PayloadSize == other.PayloadSize
            && self.WinBioHresult == other.WinBioHresult
            && self.SensorStatus == other.SensorStatus
            && self.RejectDetail == other.RejectDetail
            && self.CaptureData == other.CaptureData
    }
}
...
impl ::std::fmt::Debug for WINBIO_CAPTURE_PARAMETERS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_CAPTURE_PARAMETERS")
            .field("PayloadSize", &self.PayloadSize)
            .field("Purpose", &self.Purpose)
            .field("Format", &self.Format)
            .field("VendorFormat", &self.VendorFormat)
...
impl ::std::cmp::PartialEq for WINBIO_CAPTURE_PARAMETERS {
    fn eq(&self, other: &Self) -> bool {
        self.PayloadSize == other.PayloadSize
            ...
            && self.VendorFormat == other.VendorFormat
...
impl ::std::fmt::Debug for WINBIO_DIAGNOSTICS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_DIAGNOSTICS")
            .field("PayloadSize", &self.PayloadSize)
            .field("WinBioHresult", &self.WinBioHresult)
            .field("SensorStatus", &self.SensorStatus)
            .field("VendorDiagnostics", &self.VendorDiagnostics)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_DIAGNOSTICS {
    fn eq(&self, other: &Self) -> bool {
        self.PayloadSize == other.PayloadSize
            && self.WinBioHresult == other.WinBioHresult
            && self.SensorStatus == other.SensorStatus
            && self.VendorDiagnostics == other.VendorDiagnostics
    }
}
...
impl ::std::fmt::Debug for WINBIO_ENCRYPTED_CAPTURE_PARAMS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_ENCRYPTED_CAPTURE_PARAMS")
            .field("PayloadSize", &self.PayloadSize)
            .field("Purpose", &self.Purpose)
            .field("Format", &self.Format)
            .field("VendorFormat", &self.VendorFormat)
            .field("Flags", &self.Flags)
            .field("NonceSize", &self.NonceSize)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_ENCRYPTED_CAPTURE_PARAMS {
    fn eq(&self, other: &Self) -> bool {
        self.PayloadSize == other.PayloadSize
            ...
            && self.VendorFormat == other.VendorFormat
            && self.Flags == other.Flags
            && self.NonceSize == other.NonceSize
    }
}
...
pub struct WINBIO_ENGINE_INTERFACE {
    ...
    pub QueryExtendedEnrollmentStatus:
        ::std::option::Option<PIBIO_ENGINE_QUERY_EXTENDED_ENROLLMENT_STATUS_FN>,
    ...
    pub IdentifyFeatureSetSecure:
        ::std::option::Option<PIBIO_ENGINE_IDENTIFY_FEATURE_SET_SECURE_FN>,
    pub AcceptPrivateSensorTypeInfo:
        ::std::option::Option<PIBIO_ENGINE_ACCEPT_PRIVATE_SENSOR_TYPE_INFO_FN>,
    pub CreateEnrollmentAuthenticated:
        ::std::option::Option<PIBIO_ENGINE_CREATE_ENROLLMENT_AUTHENTICATED_FN>,
...
impl ::std::cmp::PartialEq for WINBIO_ENGINE_INTERFACE {
    fn eq(&self, other: &Self) -> bool {
        self.Version == other.Version
            ...
            && self.QueryPreferredFormat.map(|f| f as usize)
                == other.QueryPreferredFormat.map(|f| f as usize)
            && self.QueryIndexVectorSize.map(|f| f as usize)
                == other.QueryIndexVectorSize.map(|f| f as usize)
            && self.QueryHashAlgorithms.map(|f| f as usize)
                == other.QueryHashAlgorithms.map(|f| f as usize)
            && self.SetHashAlgorithm.map(|f| f as usize)
                == other.SetHashAlgorithm.map(|f| f as usize)
            && self.QuerySampleHint.map(|f| f as usize) == other.QuerySampleHint.map(|f| f as usize)
            && self.AcceptSampleData.map(|f| f as usize)
                == other.AcceptSampleData.map(|f| f as usize)
            && self.ExportEngineData.map(|f| f as usize)
                == other.ExportEngineData.map(|f| f as usize)
            && self.VerifyFeatureSet.map(|f| f as usize)
                == other.VerifyFeatureSet.map(|f| f as usize)
            && self.IdentifyFeatureSet.map(|f| f as usize)
                == other.IdentifyFeatureSet.map(|f| f as usize)
            && self.CreateEnrollment.map(|f| f as usize)
                == other.CreateEnrollment.map(|f| f as usize)
            && self.UpdateEnrollment.map(|f| f as usize)
                == other.UpdateEnrollment.map(|f| f as usize)
            && self.GetEnrollmentStatus.map(|f| f as usize)
                == other.GetEnrollmentStatus.map(|f| f as usize)
            && self.GetEnrollmentHash.map(|f| f as usize)
                == other.GetEnrollmentHash.map(|f| f as usize)
            && self.CheckForDuplicate.map(|f| f as usize)
                == other.CheckForDuplicate.map(|f| f as usize)
            && self.CommitEnrollment.map(|f| f as usize)
                == other.CommitEnrollment.map(|f| f as usize)
            && self.DiscardEnrollment.map(|f| f as usize)
                == other.DiscardEnrollment.map(|f| f as usize)
            && self.ControlUnit.map(|f| f as usize) == other.ControlUnit.map(|f| f as usize)
            && self.ControlUnitPrivileged.map(|f| f as usize)
                == other.ControlUnitPrivileged.map(|f| f as usize)
            && self.NotifyPowerChange.map(|f| f as usize)
                == other.NotifyPowerChange.map(|f| f as usize)
            ...
            && self.QueryExtendedInfo.map(|f| f as usize)
                == other.QueryExtendedInfo.map(|f| f as usize)
            && self.IdentifyAll.map(|f| f as usize) == other.IdentifyAll.map(|f| f as usize)
            && self.SetEnrollmentSelector.map(|f| f as usize)
                == other.SetEnrollmentSelector.map(|f| f as usize)
            && self.SetEnrollmentParameters.map(|f| f as usize)
                == other.SetEnrollmentParameters.map(|f| f as usize)
            && self.QueryExtendedEnrollmentStatus.map(|f| f as usize)
                == other.QueryExtendedEnrollmentStatus.map(|f| f as usize)
            && self.RefreshCache.map(|f| f as usize) == other.RefreshCache.map(|f| f as usize)
            && self.SelectCalibrationFormat.map(|f| f as usize)
                == other.SelectCalibrationFormat.map(|f| f as usize)
            && self.QueryCalibrationData.map(|f| f as usize)
                == other.QueryCalibrationData.map(|f| f as usize)
            && self.SetAccountPolicy.map(|f| f as usize)
                == other.SetAccountPolicy.map(|f| f as usize)
            && self.CreateKey.map(|f| f as usize) == other.CreateKey.map(|f| f as usize)
            && self.IdentifyFeatureSetSecure.map(|f| f as usize)
                == other.IdentifyFeatureSetSecure.map(|f| f as usize)
            && self.AcceptPrivateSensorTypeInfo.map(|f| f as usize)
                == other.AcceptPrivateSensorTypeInfo.map(|f| f as usize)
            && self.CreateEnrollmentAuthenticated.map(|f| f as usize)
                == other.CreateEnrollmentAuthenticated.map(|f| f as usize)
            && self.IdentifyFeatureSetAuthenticated.map(|f| f as usize)
...
impl ::std::fmt::Debug for WINBIO_EVENT_0_2 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_Unclaimed_e__Struct")
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_ENGINE_INFO_0_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_FacialFeatures_e__Struct")
            .field("Capabilities", &self.Capabilities)
            .field("EnrollmentRequirements", &self.EnrollmentRequirements)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_EXTENDED_ENGINE_INFO_0_0 {
    fn eq(&self, other: &Self) -> bool {
        self.Capabilities == other.Capabilities
            && self.EnrollmentRequirements == other.EnrollmentRequirements
    }
}
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_ENGINE_INFO_0_0_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_EnrollmentRequirements_e__Struct")
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_ENGINE_INFO_0_1 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_Fingerprint_e__Struct")
            .field("Capabilities", &self.Capabilities)
            .field("EnrollmentRequirements", &self.EnrollmentRequirements)
            .finish()
    }
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_ENGINE_INFO_0_1_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_EnrollmentRequirements_e__Struct")
            .field("GeneralSamples", &self.GeneralSamples)
            .field("Center", &self.Center)
            .field("TopEdge", &self.TopEdge)
            .field("BottomEdge", &self.BottomEdge)
            .field("LeftEdge", &self.LeftEdge)
            .field("RightEdge", &self.RightEdge)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_EXTENDED_ENGINE_INFO_0_1_0 {
    fn eq(&self, other: &Self) -> bool {
        self.GeneralSamples == other.GeneralSamples
            && self.Center == other.Center
            && self.TopEdge == other.TopEdge
            && self.BottomEdge == other.BottomEdge
            && self.LeftEdge == other.LeftEdge
            && self.RightEdge == other.RightEdge
    }
}
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_ENGINE_INFO_0_3 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_Voice_e__Struct")
            .field("Capabilities", &self.Capabilities)
            .field("EnrollmentRequirements", &self.EnrollmentRequirements)
            .finish()
    }
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_ENROLLMENT_PARAMETERS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_EXTENDED_ENROLLMENT_PARAMETERS")
            .field("Size", &self.Size)
            .field("SubFactor", &self.SubFactor)
            .finish()
    }
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_ENROLLMENT_STATUS_0_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_FacialFeatures_e__Struct")
            ...
            .field("OpaqueEngineData", &self.OpaqueEngineData)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for WINBIO_EXTENDED_ENROLLMENT_STATUS_0_0 {
    fn eq(&self, other: &Self) -> bool {
        self.BoundingBox == other.BoundingBox
            ...
            && self.OpaqueEngineData == other.OpaqueEngineData
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_ENROLLMENT_STATUS_0_0_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_OpaqueEngineData_e__Struct")
            .field("AdapterId", &self.AdapterId)
            .field("Data", &self.Data)
            .finish()
    }
    ...
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_Iris_e__Struct")
            ...
            .field(
                ...
                &self.StopCaptureAndShowCriticalFeedback,
            )
            .finish()
    }
}
...
impl ::std::cmp::PartialEq for WINBIO_EXTENDED_ENROLLMENT_STATUS_0_2 {
    fn eq(&self, other: &Self) -> bool {
        self.EyeBoundingBox_1 == other.EyeBoundingBox_1
            && self.EyeBoundingBox_2 == other.EyeBoundingBox_2
            && self.PupilCenter_1 == other.PupilCenter_1
            && self.PupilCenter_2 == other.PupilCenter_2
            && self.Distance == other.Distance
            && self.GridPointCompletionPercent == other.GridPointCompletionPercent
            && self.GridPointIndex == other.GridPointIndex
            && self.Point3D == other.Point3D
            && self.StopCaptureAndShowCriticalFeedback == other.StopCaptureAndShowCriticalFeedback
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_ENROLLMENT_STATUS_0_2_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_Point3D_e__Struct")
            .field("X", &self.X)
            .field("Y", &self.Y)
            .field("Z", &self.Z)
            .finish()
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_SENSOR_INFO_0_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_FacialFeatures_e__Struct")
            ...
            .field("MandatoryOrientation", &self.MandatoryOrientation)
            .field("HardwareInfo", &self.HardwareInfo)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for WINBIO_EXTENDED_SENSOR_INFO_0_0 {
    fn eq(&self, other: &Self) -> bool {
        self.FrameSize == other.FrameSize
            && self.FrameOffset == other.FrameOffset
            && self.MandatoryOrientation == other.MandatoryOrientation
            && self.HardwareInfo == other.HardwareInfo
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_SENSOR_INFO_0_0_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_HardwareInfo_e__Struct")
            .field("ColorSensorId", &self.ColorSensorId)
            .field("InfraredSensorId", &self.InfraredSensorId)
            .field(
                "InfraredSensorRotationAngle",
                &self.InfraredSensorRotationAngle,
            )
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_EXTENDED_SENSOR_INFO_0_0_0 {
    fn eq(&self, other: &Self) -> bool {
        self.ColorSensorId == other.ColorSensorId
            && self.InfraredSensorId == other.InfraredSensorId
            && self.InfraredSensorRotationAngle == other.InfraredSensorRotationAngle
    }
}
...
impl ::std::fmt::Debug for WINBIO_EXTENDED_UNIT_STATUS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_EXTENDED_UNIT_STATUS")
            .field("Availability", &self.Availability)
            .field("ReasonCode", &self.ReasonCode)
            .finish()
    }
}
...
pub const WINBIO_E_ADAPTER_INTEGRITY_FAILURE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860995i32 as _);
pub const WINBIO_E_AUTO_LOGON_DISABLED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860989i32 as _);
pub const WINBIO_E_BAD_CAPTURE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861048i32 as _);
pub const WINBIO_E_CALIBRATION_BUFFER_INVALID: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860975i32 as _);
pub const WINBIO_E_CALIBRATION_BUFFER_TOO_LARGE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860976i32 as _);
pub const WINBIO_E_CALIBRATION_BUFFER_TOO_SMALL: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860977i32 as _);
pub const WINBIO_E_CANCELED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861052i32 as _);
pub const WINBIO_E_CAPTURE_ABORTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861050i32 as _);
pub const WINBIO_E_CONFIGURATION_FAILURE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861005i32 as _);
pub const WINBIO_E_CRED_PROV_DISABLED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861008i32 as _);
pub const WINBIO_E_CRED_PROV_NO_CREDENTIAL: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861007i32 as _);
pub const WINBIO_E_CRED_PROV_SECURITY_LOCKOUT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860985i32 as _);
pub const WINBIO_E_DATABASE_ALREADY_EXISTS: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861034i32 as _);
pub const WINBIO_E_DATABASE_BAD_INDEX_VECTOR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861022i32 as _);
pub const WINBIO_E_DATABASE_CANT_CLOSE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861037i32 as _);
pub const WINBIO_E_DATABASE_CANT_CREATE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861039i32 as _);
pub const WINBIO_E_DATABASE_CANT_ERASE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861036i32 as _);
pub const WINBIO_E_DATABASE_CANT_FIND: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861035i32 as _);
pub const WINBIO_E_DATABASE_CANT_OPEN: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861038i32 as _);
pub const WINBIO_E_DATABASE_CORRUPTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861030i32 as _);
pub const WINBIO_E_DATABASE_EOF: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861023i32 as _);
pub const WINBIO_E_DATABASE_FULL: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861032i32 as _);
pub const WINBIO_E_DATABASE_LOCKED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861031i32 as _);
pub const WINBIO_E_DATABASE_NO_MORE_RECORDS: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861024i32 as _);
pub const WINBIO_E_DATABASE_NO_RESULTS: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861025i32 as _);
pub const WINBIO_E_DATABASE_NO_SUCH_RECORD: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861029i32 as _);
pub const WINBIO_E_DATABASE_READ_ERROR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861027i32 as _);
pub const WINBIO_E_DATABASE_WRITE_ERROR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861026i32 as _);
pub const WINBIO_E_DATA_COLLECTION_IN_PROGRESS: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861045i32 as _);
pub const WINBIO_E_DATA_PROTECTION_FAILURE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860986i32 as _);
pub const WINBIO_E_DEADLOCK_DETECTED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860992i32 as _);
pub const WINBIO_E_DEVICE_BUSY: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861040i32 as _);
pub const WINBIO_E_DEVICE_FAILURE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861002i32 as _);
pub const WINBIO_E_DISABLED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861006i32 as _);
pub const WINBIO_E_DUPLICATE_ENROLLMENT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861028i32 as _);
pub const WINBIO_E_DUPLICATE_TEMPLATE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861013i32 as _);
pub const WINBIO_E_ENROLLMENT_CANCELED_BY_SUSPEND: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860965i32 as _);
pub const WINBIO_E_ENROLLMENT_IN_PROGRESS: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861049i32 as _);
pub const WINBIO_E_EVENT_MONITOR_ACTIVE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860999i32 as _);
pub const WINBIO_E_FAST_USER_SWITCH_DISABLED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861001i32 as _);
pub const WINBIO_E_INCORRECT_BSP: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861020i32 as _);
pub const WINBIO_E_INCORRECT_SENSOR_POOL: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861019i32 as _);
pub const WINBIO_E_INCORRECT_SESSION_TYPE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860994i32 as _);
pub const WINBIO_E_INSECURE_SENSOR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860969i32 as _);
pub const WINBIO_E_INVALID_BUFFER: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860967i32 as _);
pub const WINBIO_E_INVALID_BUFFER_ID: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860968i32 as _);
pub const WINBIO_E_INVALID_CALIBRATION_FORMAT_ARRAY: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860980i32 as _);
pub const WINBIO_E_INVALID_CONTROL_CODE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861047i32 as _);
pub const WINBIO_E_INVALID_DEVICE_STATE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861041i32 as _);
pub const WINBIO_E_INVALID_KEY_IDENTIFIER: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860974i32 as _);
pub const WINBIO_E_INVALID_OPERATION: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861012i32 as _);
pub const WINBIO_E_INVALID_PROPERTY_ID: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860997i32 as _);
pub const WINBIO_E_INVALID_PROPERTY_TYPE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860998i32 as _);
pub const WINBIO_E_INVALID_SENSOR_MODE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861017i32 as _);
pub const WINBIO_E_INVALID_SUBFACTOR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860981i32 as _);
pub const WINBIO_E_INVALID_TICKET: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860988i32 as _);
pub const WINBIO_E_INVALID_UNIT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861054i32 as _);
pub const WINBIO_E_KEY_CREATION_FAILED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860973i32 as _);
pub const WINBIO_E_KEY_IDENTIFIER_BUFFER_TOO_SMALL: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860972i32 as _);
pub const WINBIO_E_LOCK_VIOLATION: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861014i32 as _);
pub const WINBIO_E_MAX_ERROR_COUNT_EXCEEDED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860990i32 as _);
pub const WINBIO_E_NOT_ACTIVE_CONSOLE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861000i32 as _);
pub const WINBIO_E_NO_CAPTURE_DATA: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861018i32 as _);
pub const WINBIO_E_NO_MATCH: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861051i32 as _);
pub const WINBIO_E_NO_PREBOOT_IDENTITY: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860991i32 as _);
pub const WINBIO_E_NO_SUPPORTED_CALIBRATION_FORMAT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860979i32 as _);
pub const WINBIO_E_POLICY_PROTECTION_UNAVAILABLE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860970i32 as _);
pub const WINBIO_E_PRESENCE_MONITOR_ACTIVE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860982i32 as _);
pub const WINBIO_E_PROPERTY_UNAVAILABLE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860971i32 as _);
pub const WINBIO_E_SAS_ENABLED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861003i32 as _);
pub const WINBIO_E_SELECTION_REQUIRED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860983i32 as _);
pub const WINBIO_E_SENSOR_UNAVAILABLE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861004i32 as _);
pub const WINBIO_E_SESSION_BUSY: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861011i32 as _);
pub const WINBIO_E_SESSION_HANDLE_CLOSED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860993i32 as _);
pub const WINBIO_E_TICKET_QUOTA_EXCEEDED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860987i32 as _);
pub const WINBIO_E_TRUSTLET_INTEGRITY_FAIL: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860966i32 as _);
pub const WINBIO_E_UNKNOWN_ID: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861053i32 as _);
pub const WINBIO_E_UNSUPPORTED_DATA_FORMAT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861044i32 as _);
pub const WINBIO_E_UNSUPPORTED_DATA_TYPE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861043i32 as _);
pub const WINBIO_E_UNSUPPORTED_FACTOR: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861055i32 as _);
pub const WINBIO_E_UNSUPPORTED_POOL_TYPE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860984i32 as _);
pub const WINBIO_E_UNSUPPORTED_PROPERTY: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860996i32 as _);
pub const WINBIO_E_UNSUPPORTED_PURPOSE: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146861042i32 as _);
pub const WINBIO_E_UNSUPPORTED_SENSOR_CALIBRATION_FORMAT: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2146860978i32 as _);
#[derive(:: std :: clone :: Clone, :: std :: marker :: Copy)]
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for WINBIO_FP_BU_STATE {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_FP_BU_STATE")
            .field("SensorAttached", &self.SensorAttached)
            .field("CreationResult", &self.CreationResult)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
...
pub struct WINBIO_FRAMEWORK_INTERFACE {
    ...
    pub VsmStorageCacheImportBegin:
        ::std::option::Option<PIBIO_FRAMEWORK_VSM_CACHE_IMPORT_BEGIN_FN>,
    ...
    pub VsmStorageCacheExportBegin:
        ::std::option::Option<PIBIO_FRAMEWORK_VSM_CACHE_EXPORT_BEGIN_FN>,
    ...
    pub VsmSensorAsyncImportRawBuffer:
        ::std::option::Option<PIBIO_SENSOR_ASYNC_IMPORT_RAW_BUFFER_FN>,
    pub VsmSensorAsyncImportSecureBuffer:
        ::std::option::Option<PIBIO_SENSOR_ASYNC_IMPORT_SECURE_BUFFER_FN>,
    ...
    pub LockAndValidateSecureBuffer:
        ::std::option::Option<PIBIO_FRAMEWORK_LOCK_AND_VALIDATE_SECURE_BUFFER_FN>,
    pub ReleaseSecureBuffer: ::std::option::Option<PIBIO_FRAMEWORK_RELEASE_SECURE_BUFFER_FN>,
    pub QueryAuthorizedEnrollments:
...
impl ::std::cmp::PartialEq for WINBIO_FRAMEWORK_INTERFACE {
    fn eq(&self, other: &Self) -> bool {
        self.Version == other.Version
            ...
            && self.VsmStorageAttach.map(|f| f as usize)
                == other.VsmStorageAttach.map(|f| f as usize)
            && self.VsmStorageDetach.map(|f| f as usize)
                == other.VsmStorageDetach.map(|f| f as usize)
            && self.VsmStorageClearContext.map(|f| f as usize)
                == other.VsmStorageClearContext.map(|f| f as usize)
            && self.VsmStorageCreateDatabase.map(|f| f as usize)
                == other.VsmStorageCreateDatabase.map(|f| f as usize)
            && self.VsmStorageOpenDatabase.map(|f| f as usize)
                == other.VsmStorageOpenDatabase.map(|f| f as usize)
            && self.VsmStorageCloseDatabase.map(|f| f as usize)
                == other.VsmStorageCloseDatabase.map(|f| f as usize)
            && self.VsmStorageDeleteRecord.map(|f| f as usize)
                == other.VsmStorageDeleteRecord.map(|f| f as usize)
            && self.VsmStorageNotifyPowerChange.map(|f| f as usize)
                == other.VsmStorageNotifyPowerChange.map(|f| f as usize)
            && self.VsmStoragePipelineInit.map(|f| f as usize)
                == other.VsmStoragePipelineInit.map(|f| f as usize)
            && self.VsmStoragePipelineCleanup.map(|f| f as usize)
                == other.VsmStoragePipelineCleanup.map(|f| f as usize)
            && self.VsmStorageActivate.map(|f| f as usize)
                == other.VsmStorageActivate.map(|f| f as usize)
            && self.VsmStorageDeactivate.map(|f| f as usize)
                == other.VsmStorageDeactivate.map(|f| f as usize)
            && self.VsmStorageQueryExtendedInfo.map(|f| f as usize)
                == other.VsmStorageQueryExtendedInfo.map(|f| f as usize)
            && self.VsmStorageCacheClear.map(|f| f as usize)
                == other.VsmStorageCacheClear.map(|f| f as usize)
            && self.VsmStorageCacheImportBegin.map(|f| f as usize)
                == other.VsmStorageCacheImportBegin.map(|f| f as usize)
            && self.VsmStorageCacheImportNext.map(|f| f as usize)
                == other.VsmStorageCacheImportNext.map(|f| f as usize)
            && self.VsmStorageCacheImportEnd.map(|f| f as usize)
                == other.VsmStorageCacheImportEnd.map(|f| f as usize)
            && self.VsmStorageCacheExportBegin.map(|f| f as usize)
                == other.VsmStorageCacheExportBegin.map(|f| f as usize)
            && self.VsmStorageCacheExportNext.map(|f| f as usize)
                == other.VsmStorageCacheExportNext.map(|f| f as usize)
            && self.VsmStorageCacheExportEnd.map(|f| f as usize)
                == other.VsmStorageCacheExportEnd.map(|f| f as usize)
            ...
            && self.VsmSensorClearContext.map(|f| f as usize)
                == other.VsmSensorClearContext.map(|f| f as usize)
            && self.VsmSensorPushDataToEngine.map(|f| f as usize)
                == other.VsmSensorPushDataToEngine.map(|f| f as usize)
            && self.VsmSensorNotifyPowerChange.map(|f| f as usize)
                == other.VsmSensorNotifyPowerChange.map(|f| f as usize)
            && self.VsmSensorPipelineInit.map(|f| f as usize)
                == other.VsmSensorPipelineInit.map(|f| f as usize)
            && self.VsmSensorPipelineCleanup.map(|f| f as usize)
                == other.VsmSensorPipelineCleanup.map(|f| f as usize)
            && self.VsmSensorActivate.map(|f| f as usize)
                == other.VsmSensorActivate.map(|f| f as usize)
            && self.VsmSensorDeactivate.map(|f| f as usize)
                == other.VsmSensorDeactivate.map(|f| f as usize)
            && self.VsmSensorAsyncImportRawBuffer.map(|f| f as usize)
                == other.VsmSensorAsyncImportRawBuffer.map(|f| f as usize)
            && self.VsmSensorAsyncImportSecureBuffer.map(|f| f as usize)
                == other.VsmSensorAsyncImportSecureBuffer.map(|f| f as usize)
            ...
            && self.LockAndValidateSecureBuffer.map(|f| f as usize)
                == other.LockAndValidateSecureBuffer.map(|f| f as usize)
            && self.ReleaseSecureBuffer.map(|f| f as usize)
                == other.ReleaseSecureBuffer.map(|f| f as usize)
            && self.QueryAuthorizedEnrollments.map(|f| f as usize)
                == other.QueryAuthorizedEnrollments.map(|f| f as usize)
...
impl ::std::fmt::Debug for WINBIO_GESTURE_METADATA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_GESTURE_METADATA")
            .field("Size", &self.Size)
            .field("BiometricType", &self.BiometricType)
...
impl ::std::cmp::PartialEq for WINBIO_GESTURE_METADATA {
    fn eq(&self, other: &Self) -> bool {
        self.Size == other.Size
            && self.BiometricType == other.BiometricType
...
impl ::std::fmt::Debug for WINBIO_GET_INDICATOR {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_GET_INDICATOR")
            .field("PayloadSize", &self.PayloadSize)
            .field("WinBioHresult", &self.WinBioHresult)
            .field("IndicatorStatus", &self.IndicatorStatus)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_GET_INDICATOR {
    fn eq(&self, other: &Self) -> bool {
        self.PayloadSize == other.PayloadSize
            && self.WinBioHresult == other.WinBioHresult
            && self.IndicatorStatus == other.IndicatorStatus
    }
}
...
impl ::std::fmt::Debug for WINBIO_IDENTITY_0_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_AccountSid_e__Struct")
            .field("Size", &self.Size)
            .field("Data", &self.Data)
            .finish()
    }
...
pub const WINBIO_I_EXTENDED_STATUS_INFORMATION: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(589826i32 as _);
pub const WINBIO_I_MORE_DATA: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(589825i32 as _);
...
impl ::std::fmt::Debug for WINBIO_NOTIFY_WAKE {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_NOTIFY_WAKE")
            .field("PayloadSize", &self.PayloadSize)
            .field("WinBioHresult", &self.WinBioHresult)
...
impl ::std::cmp::PartialEq for WINBIO_PIPELINE {
    fn eq(&self, other: &Self) -> bool {
        self.SensorHandle == other.SensorHandle
            ...
            && self.StorageHandle == other.StorageHandle
            && self.SensorInterface == other.SensorInterface
            && self.EngineInterface == other.EngineInterface
            && self.StorageInterface == other.StorageInterface
            && self.SensorContext == other.SensorContext
            && self.EngineContext == other.EngineContext
            && self.StorageContext == other.StorageContext
...
impl ::std::fmt::Debug for WINBIO_PRESENCE_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_Authorization_e__Struct")
            .field("Size", &self.Size)
            .field("Data", &self.Data)
            .finish()
    }
...
impl ::std::fmt::Debug for WINBIO_PRIVATE_SENSOR_TYPE_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_PRIVATE_SENSOR_TYPE_INFO")
            .field("PayloadSize", &self.PayloadSize)
            .field("WinBioHresult", &self.WinBioHresult)
            .field("PrivateSensorTypeInfo", &self.PrivateSensorTypeInfo)
            .finish()
    }
}
...
impl ::std::fmt::Debug for WINBIO_REGISTERED_FORMAT {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_REGISTERED_FORMAT")
...
impl ::std::fmt::Debug for WINBIO_SECURE_BUFFER_HEADER_V1 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_SECURE_BUFFER_HEADER_V1")
            .field("Type", &self.Type)
            .field("Size", &self.Size)
            .field("Flags", &self.Flags)
            .field("ValidationTag", &self.ValidationTag)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_SECURE_BUFFER_HEADER_V1 {
    fn eq(&self, other: &Self) -> bool {
        self.Type == other.Type
            && self.Size == other.Size
            && self.Flags == other.Flags
            && self.ValidationTag == other.ValidationTag
    }
}
...
impl ::std::cmp::PartialEq for WINBIO_SECURE_CONNECTION_DATA {
    fn eq(&self, other: &Self) -> bool {
        self.Size == other.Size
            && self.Version == other.Version
            && self.Flags == other.Flags
            && self.ModelCertificateSize == other.ModelCertificateSize
            && self.IntermediateCA1Size == other.IntermediateCA1Size
            && self.IntermediateCA2Size == other.IntermediateCA2Size
    }
}
...
impl ::std::fmt::Debug for WINBIO_SECURE_CONNECTION_PARAMS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_SECURE_CONNECTION_PARAMS")
            .field("PayloadSize", &self.PayloadSize)
            .field("Version", &self.Version)
            .field("Flags", &self.Flags)
            .finish()
...
impl ::std::cmp::PartialEq for WINBIO_SENSOR_INTERFACE {
    fn eq(&self, other: &Self) -> bool {
        self.Version == other.Version
            ...
            && self.SetIndicatorStatus.map(|f| f as usize)
                == other.SetIndicatorStatus.map(|f| f as usize)
            && self.GetIndicatorStatus.map(|f| f as usize)
                == other.GetIndicatorStatus.map(|f| f as usize)
            ...
            && self.ExportSensorData.map(|f| f as usize)
                == other.ExportSensorData.map(|f| f as usize)
            && self.Cancel.map(|f| f as usize) == other.Cancel.map(|f| f as usize)
            && self.PushDataToEngine.map(|f| f as usize)
                == other.PushDataToEngine.map(|f| f as usize)
            && self.ControlUnit.map(|f| f as usize) == other.ControlUnit.map(|f| f as usize)
            && self.ControlUnitPrivileged.map(|f| f as usize)
                == other.ControlUnitPrivileged.map(|f| f as usize)
            && self.NotifyPowerChange.map(|f| f as usize)
            ...
            && self.QueryExtendedInfo.map(|f| f as usize)
                == other.QueryExtendedInfo.map(|f| f as usize)
            && self.QueryCalibrationFormats.map(|f| f as usize)
                == other.QueryCalibrationFormats.map(|f| f as usize)
            && self.SetCalibrationFormat.map(|f| f as usize)
                == other.SetCalibrationFormat.map(|f| f as usize)
            && self.AcceptCalibrationData.map(|f| f as usize)
                == other.AcceptCalibrationData.map(|f| f as usize)
            && self.AsyncImportRawBuffer.map(|f| f as usize)
                == other.AsyncImportRawBuffer.map(|f| f as usize)
            && self.AsyncImportSecureBuffer.map(|f| f as usize)
                == other.AsyncImportSecureBuffer.map(|f| f as usize)
            && self.QueryPrivateSensorType.map(|f| f as usize)
                == other.QueryPrivateSensorType.map(|f| f as usize)
            ...
            && self.FinishNotifyWake.map(|f| f as usize)
...
impl ::std::fmt::Debug for WINBIO_SET_INDICATOR {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_SET_INDICATOR")
            .field("PayloadSize", &self.PayloadSize)
            .field("IndicatorStatus", &self.IndicatorStatus)
            .finish()
    }
...
impl ::std::cmp::PartialEq for WINBIO_STORAGE_INTERFACE {
    fn eq(&self, other: &Self) -> bool {
        self.Version == other.Version
            ...
            && self.GetCurrentRecord.map(|f| f as usize)
                == other.GetCurrentRecord.map(|f| f as usize)
            && self.ControlUnit.map(|f| f as usize) == other.ControlUnit.map(|f| f as usize)
            && self.ControlUnitPrivileged.map(|f| f as usize)
                == other.ControlUnitPrivileged.map(|f| f as usize)
            && self.NotifyPowerChange.map(|f| f as usize)
            ...
            && self.QueryExtendedInfo.map(|f| f as usize)
                == other.QueryExtendedInfo.map(|f| f as usize)
            && self.NotifyDatabaseChange.map(|f| f as usize)
                == other.NotifyDatabaseChange.map(|f| f as usize)
            && self.Reserved1.map(|f| f as usize) == other.Reserved1.map(|f| f as usize)
            && self.Reserved2.map(|f| f as usize) == other.Reserved2.map(|f| f as usize)
            && self.UpdateRecordBegin.map(|f| f as usize)
                == other.UpdateRecordBegin.map(|f| f as usize)
            && self.UpdateRecordCommit.map(|f| f as usize)
...
impl ::std::cmp::PartialEq for WINBIO_STORAGE_RECORD {
    fn eq(&self, other: &Self) -> bool {
        self.Identity == other.Identity
            && self.SubFactor == other.SubFactor
            && self.IndexVector == other.IndexVector
            && self.IndexElementCount == other.IndexElementCount
            && self.TemplateBlob == other.TemplateBlob
            && self.TemplateBlobSize == other.TemplateBlobSize
            && self.PayloadBlob == other.PayloadBlob
            && self.PayloadBlobSize == other.PayloadBlobSize
    }
}
...
impl ::std::fmt::Debug for WINBIO_STORAGE_SCHEMA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_STORAGE_SCHEMA")
            .field("BiometricFactor", &self.BiometricFactor)
            .field("DatabaseId", &self.DatabaseId)
            .field("DataFormat", &self.DataFormat)
            .field("Attributes", &self.Attributes)
            .field("FilePath", &self.FilePath)
            .field("ConnectionString", &self.ConnectionString)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_STORAGE_SCHEMA {
    fn eq(&self, other: &Self) -> bool {
        self.BiometricFactor == other.BiometricFactor
            && self.DatabaseId == other.DatabaseId
            && self.DataFormat == other.DataFormat
            && self.Attributes == other.Attributes
            && self.FilePath == other.FilePath
            && self.ConnectionString == other.ConnectionString
    }
}
...
impl ::std::fmt::Debug for WINBIO_SUPPORTED_ALGORITHMS {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_SUPPORTED_ALGORITHMS")
            .field("PayloadSize", &self.PayloadSize)
            .field("WinBioHresult", &self.WinBioHresult)
            .field("NumberOfAlgorithms", &self.NumberOfAlgorithms)
            .field("AlgorithmData", &self.AlgorithmData)
            .finish()
    }
}
impl ::std::cmp::PartialEq for WINBIO_SUPPORTED_ALGORITHMS {
    fn eq(&self, other: &Self) -> bool {
        self.PayloadSize == other.PayloadSize
            && self.WinBioHresult == other.WinBioHresult
            && self.NumberOfAlgorithms == other.NumberOfAlgorithms
            && self.AlgorithmData == other.AlgorithmData
    }
}
...
impl ::std::cmp::PartialEq for WINBIO_UNIT_SCHEMA {
    fn eq(&self, other: &Self) -> bool {
        self.UnitId == other.UnitId
            ...
            && self.SensorSubType == other.SensorSubType
            && self.Capabilities == other.Capabilities
            && self.DeviceInstanceId == other.DeviceInstanceId
            && self.Description == other.Description
...
impl ::std::fmt::Debug for WINBIO_UPDATE_FIRMWARE {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_UPDATE_FIRMWARE")
            .field("PayloadSize", &self.PayloadSize)
            .field("FirmwareData", &self.FirmwareData)
            .finish()
    }
}
...
impl ::std::fmt::Debug for WINBIO_VERSION {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WINBIO_VERSION")
            .field("MajorVersion", &self.MajorVersion)
            .field("MinorVersion", &self.MinorVersion)
            .finish()
    }
...
pub unsafe fn WinBioAsyncEnumBiometricUnits(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioAsyncEnumBiometricUnits(
            ::std::mem::transmute(frameworkhandle),
...
pub unsafe fn WinBioAsyncOpenSession<
    ...
    Param11: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
>(
    factor: u32,
...
pub unsafe fn WinBioCaptureSample(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioCaptureSample(
            ...
            ::std::mem::transmute(purpose),
            ::std::mem::transmute(flags),
            ::std::mem::transmute(unitid),
            ::std::mem::transmute(sample),
            ::std::mem::transmute(samplesize),
            ::std::mem::transmute(rejectdetail),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioCaptureSampleWithCallback(
    ...
    purpose: u8,
    flags: u8,
    capturecallback: ::std::option::Option<PWINBIO_CAPTURE_CALLBACK>,
    capturecallbackcontext: *const ::std::ffi::c_void,
) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn WinBioCaptureSampleWithCallback(
                ...
                purpose: u8,
                flags: u8,
                capturecallback: ::windows::runtime::RawPtr,
                capturecallbackcontext: *const ::std::ffi::c_void,
            ) -> ::windows::runtime::HRESULT;
        }
        WinBioCaptureSampleWithCallback(
            ...
            ::std::mem::transmute(purpose),
            ::std::mem::transmute(flags),
            ::std::mem::transmute(capturecallback),
            ::std::mem::transmute(capturecallbackcontext),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioDeleteTemplate(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioDeleteTemplate(
            ::std::mem::transmute(sessionhandle),
            ::std::mem::transmute(unitid),
            ::std::mem::transmute(identity),
            ::std::mem::transmute(subfactor),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioEnrollCapture(sessionhandle: u32) -> ::windows::runtime::Result<u32> {
    #[cfg(windows)]
    {
        ...
        let mut result__: <u32 as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        WinBioEnrollCapture(::std::mem::transmute(sessionhandle), &mut result__)
            .from_abi::<u32>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn WinBioEnrollCaptureWithCallback(
                sessionhandle: u32,
                enrollcallback: ::windows::runtime::RawPtr,
                enrollcallbackcontext: *const ::std::ffi::c_void,
            ) -> ::windows::runtime::HRESULT;
        }
        WinBioEnrollCaptureWithCallback(
            ::std::mem::transmute(sessionhandle),
            ::std::mem::transmute(enrollcallback),
            ::std::mem::transmute(enrollcallbackcontext),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioEnrollCommit(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioEnrollCommit(
            ::std::mem::transmute(sessionhandle),
            ::std::mem::transmute(identity),
            ::std::mem::transmute(isnewtemplate),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioEnrollSelect(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioEnrollSelect(
            ::std::mem::transmute(sessionhandle),
            ::std::mem::transmute(selectorvalue),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioEnumBiometricUnits(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioEnumBiometricUnits(
            ::std::mem::transmute(factor),
            ::std::mem::transmute(unitschemaarray),
            ::std::mem::transmute(unitcount),
        )
        .ok()
    }
...
pub unsafe fn WinBioEnumDatabases(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioEnumDatabases(
            ::std::mem::transmute(factor),
            ::std::mem::transmute(storageschemaarray),
            ::std::mem::transmute(storagecount),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioEnumEnrollments(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioEnumEnrollments(
            ...
            ::std::mem::transmute(unitid),
            ::std::mem::transmute(identity),
            ::std::mem::transmute(subfactorarray),
            ::std::mem::transmute(subfactorcount),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioEnumServiceProviders(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioEnumServiceProviders(
            ::std::mem::transmute(factor),
            ::std::mem::transmute(bspschemaarray),
            ::std::mem::transmute(bspcount),
        )
        .ok()
    }
    #[cfg(not(windows))]
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn WinBioGetCredentialState(
                ...
                r#type: WINBIO_CREDENTIAL_TYPE,
                credentialstate: *mut WINBIO_CREDENTIAL_STATE,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__: <WINBIO_CREDENTIAL_STATE as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        ...
        .from_abi::<WINBIO_CREDENTIAL_STATE>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub unsafe fn WinBioGetDomainLogonSetting(value: *mut u8, source: *mut WINBIO_SETTING_SOURCE) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(WinBioGetDomainLogonSetting(
...
pub unsafe fn WinBioGetEnabledSetting(value: *mut u8, source: *mut WINBIO_SETTING_SOURCE) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(WinBioGetEnabledSetting(
            ::std::mem::transmute(value),
            ::std::mem::transmute(source),
        ))
    }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn WinBioGetEnrolledFactors(
                accountowner: *const WINBIO_IDENTITY,
                enrolledfactors: *mut u32,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__: <u32 as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        WinBioGetEnrolledFactors(::std::mem::transmute(accountowner), &mut result__)
            .from_abi::<u32>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn WinBioGetLogonSetting(value: *mut u8, source: *mut WINBIO_SETTING_SOURCE) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(WinBioGetLogonSetting(
            ::std::mem::transmute(value),
            ::std::mem::transmute(source),
        ))
    }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn WinBioIdentifyWithCallback(
                sessionhandle: u32,
                identifycallback: ::windows::runtime::RawPtr,
                identifycallbackcontext: *const ::std::ffi::c_void,
            ) -> ::windows::runtime::HRESULT;
        }
        WinBioIdentifyWithCallback(
            ::std::mem::transmute(sessionhandle),
            ::std::mem::transmute(identifycallback),
            ::std::mem::transmute(identifycallbackcontext),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioLocateSensor(sessionhandle: u32) -> ::windows::runtime::Result<u32> {
    #[cfg(windows)]
    {
        ...
        let mut result__: <u32 as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        WinBioLocateSensor(::std::mem::transmute(sessionhandle), &mut result__)
            .from_abi::<u32>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn WinBioLocateSensorWithCallback(
                sessionhandle: u32,
                locatecallback: ::windows::runtime::RawPtr,
                locatecallbackcontext: *const ::std::ffi::c_void,
            ) -> ::windows::runtime::HRESULT;
        }
        WinBioLocateSensorWithCallback(
            ::std::mem::transmute(sessionhandle),
            ::std::mem::transmute(locatecallback),
            ::std::mem::transmute(locatecallbackcontext),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioRegisterEventMonitor(
    sessionhandle: u32,
    eventmask: u32,
    eventcallback: ::std::option::Option<PWINBIO_EVENT_CALLBACK>,
    eventcallbackcontext: *const ::std::ffi::c_void,
) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        ...
        WinBioRegisterEventMonitor(
            ...
            ::std::mem::transmute(eventcallbackcontext),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
pub unsafe fn WinBioSetCredential(
    ...
    #[cfg(windows)]
    {
        ...
        WinBioSetCredential(
            ...
            ::std::mem::transmute(credentialsize),
...
pub unsafe fn WinBioVerifyWithCallback(
    ...
    identity: *const WINBIO_IDENTITY,
    subfactor: u8,
    verifycallback: ::std::option::Option<PWINBIO_VERIFY_CALLBACK>,
    verifycallbackcontext: *const ::std::ffi::c_void,
) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn WinBioVerifyWithCallback(
                ...
                identity: *const WINBIO_IDENTITY,
                subfactor: u8,
                verifycallback: ::windows::runtime::RawPtr,
                verifycallbackcontext: *const ::std::ffi::c_void,
            ) -> ::windows::runtime::HRESULT;
        }
        WinBioVerifyWithCallback(
            ...
            ::std::mem::transmute(identity),
            ::std::mem::transmute(subfactor),
            ::std::mem::transmute(verifycallback),
            ::std::mem::transmute(verifycallbackcontext),
        )
        .ok()
    }
    #[cfg(not(windows))]
