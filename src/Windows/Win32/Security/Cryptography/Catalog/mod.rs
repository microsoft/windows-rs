...
>(
    ...
    pstronghashpolicy: *const super::CERT_STRONG_SIGN_PARA,
    dwflags: u32,
) -> super::super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn CryptCATAdminAcquireContext2(
                phcatadmin: *mut isize,
                pgsubsystem: *const ::windows::runtime::GUID,
                pwszhashalgorithm: super::super::super::Foundation::PWSTR,
                pstronghashpolicy: *const super::CERT_STRONG_SIGN_PARA,
                dwflags: u32,
            ) -> super::super::super::Foundation::BOOL;
        }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn CryptCATAdminAddCatalog(
                hcatadmin: isize,
                pwszcatalogfile: super::super::super::Foundation::PWSTR,
                pwszselectbasename: super::super::super::Foundation::PWSTR,
                dwflags: u32,
            ) -> isize;
        }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn CryptCATAdminPauseServiceForBackup(
                dwflags: u32,
                fresume: super::super::super::Foundation::BOOL,
            ) -> super::super::super::Foundation::BOOL;
        }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn CryptCATAllocSortedMemberInfo(
                ...
                pwszreferencetag: super::super::super::Foundation::PWSTR,
            ) -> *mut CRYPTCATMEMBER;
        }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn CryptCATCDFOpen(
                pwszfilepath: super::super::super::Foundation::PWSTR,
                pfnparseerror: ::windows::runtime::RawPtr,
            ) -> *mut CRYPTCATCDF;
        }
...
pub type PFN_CDF_PARSE_ERROR_CALLBACK = unsafe extern "system" fn(
    dwerrorarea: u32,
    dwlocalerror: u32,
    pwszline: super::super::super::Foundation::PWSTR,
);
