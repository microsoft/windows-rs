...
pub unsafe fn DdqCancelDiagnosticRecordOperation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::HDIAGNOSTIC_DATA_QUERY_SESSION>,
>(
    hsession: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn DdqCancelDiagnosticRecordOperation(
                hsession: super::HDIAGNOSTIC_DATA_QUERY_SESSION,
...
) -> ::windows::runtime::Result<super::HDIAGNOSTIC_DATA_QUERY_SESSION> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn DdqCreateSession(
                accesslevel: DdqAccessLevel,
                hsession: *mut super::HDIAGNOSTIC_DATA_QUERY_SESSION,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__: <super::HDIAGNOSTIC_DATA_QUERY_SESSION as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        DdqCreateSession(::std::mem::transmute(accesslevel), &mut result__)
            .from_abi::<super::HDIAGNOSTIC_DATA_QUERY_SESSION>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn DdqExtractDiagnosticReport(
                hsession: super::HDIAGNOSTIC_DATA_QUERY_SESSION,
                reportstoretype: u32,
                reportkey: super::super::Foundation::PWSTR,
                destinationpath: super::super::Foundation::PWSTR,
            ) -> ::windows::runtime::HRESULT;
        }
...
pub unsafe fn DdqFreeDiagnosticRecordLocaleTags<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::HDIAGNOSTIC_EVENT_TAG_DESCRIPTION>,
>(
...
pub unsafe fn DdqFreeDiagnosticRecordPage<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::HDIAGNOSTIC_RECORD>,
>(
    hrecord: Param0,
) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn DdqFreeDiagnosticRecordPage(
                hrecord: super::HDIAGNOSTIC_RECORD,
            ) -> ::windows::runtime::HRESULT;
        }
...
pub unsafe fn DdqFreeDiagnosticRecordProducerCategories<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn DdqFreeDiagnosticRecordProducerCategories(
                hcategorydescription: super::HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION,
            ) -> ::windows::runtime::HRESULT;
        }
...
pub unsafe fn DdqFreeDiagnosticRecordProducers<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn DdqFreeDiagnosticRecordProducers(
                hproducerdescription: super::HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION,
            ) -> ::windows::runtime::HRESULT;
        }
...
pub unsafe fn DdqFreeDiagnosticReport<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::HDIAGNOSTIC_REPORT>,
>(
    hreport: Param0,
) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn DdqFreeDiagnosticReport(
                hreport: super::HDIAGNOSTIC_REPORT,
            ) -> ::windows::runtime::HRESULT;
        }
...
>(
    hsession: Param0,
    producernames: *const super::super::Foundation::PWSTR,
...
>(
    hsession: Param0,
    locale: Param1,
) -> ::windows::runtime::Result<super::HDIAGNOSTIC_EVENT_TAG_DESCRIPTION> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn DdqGetDiagnosticRecordLocaleTags(
                hsession: super::HDIAGNOSTIC_DATA_QUERY_SESSION,
                locale: super::super::Foundation::PWSTR,
                htagdescription: *mut super::HDIAGNOSTIC_EVENT_TAG_DESCRIPTION,
            ) -> ::windows::runtime::HRESULT;
        }
        ...
        .from_abi::<super::HDIAGNOSTIC_EVENT_TAG_DESCRIPTION>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
>(
    ...
    pagerecordcount: u32,
    baserowid: i64,
) -> ::windows::runtime::Result<super::HDIAGNOSTIC_RECORD> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn DdqGetDiagnosticRecordPage(
                ...
                pagerecordcount: u32,
                baserowid: i64,
                hrecord: *mut super::HDIAGNOSTIC_RECORD,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__: <super::HDIAGNOSTIC_RECORD as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        ...
        .from_abi::<super::HDIAGNOSTIC_RECORD>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn DdqGetDiagnosticRecordPayload(
                hsession: super::HDIAGNOSTIC_DATA_QUERY_SESSION,
                rowid: i64,
                payload: *mut super::super::Foundation::PWSTR,
            ) -> ::windows::runtime::HRESULT;
        }
...
>(
    hsession: Param0,
    producername: Param1,
) -> ::windows::runtime::Result<super::HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn DdqGetDiagnosticRecordProducerCategories(
                hsession: super::HDIAGNOSTIC_DATA_QUERY_SESSION,
                producername: super::super::Foundation::PWSTR,
                hcategorydescription: *mut super::HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION,
            ) -> ::windows::runtime::HRESULT;
        }
        ...
        .from_abi::<super::HDIAGNOSTIC_EVENT_CATEGORY_DESCRIPTION>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
>(
    hsession: Param0,
) -> ::windows::runtime::Result<super::HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn DdqGetDiagnosticRecordProducers(
                hsession: super::HDIAGNOSTIC_DATA_QUERY_SESSION,
                hproducerdescription: *mut super::HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION,
            ) -> ::windows::runtime::HRESULT;
        }
        ...
        DdqGetDiagnosticRecordProducers(hsession.into_param().abi(), &mut result__)
            .from_abi::<super::HDIAGNOSTIC_EVENT_PRODUCER_DESCRIPTION>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
>(
    hsession: Param0,
    reportstoretype: u32,
) -> ::windows::runtime::Result<super::HDIAGNOSTIC_REPORT> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn DdqGetDiagnosticReport(
                hsession: super::HDIAGNOSTIC_DATA_QUERY_SESSION,
                reportstoretype: u32,
                hreport: *mut super::HDIAGNOSTIC_REPORT,
            ) -> ::windows::runtime::HRESULT;
        }
        let mut result__: <super::HDIAGNOSTIC_REPORT as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        ...
        .from_abi::<super::HDIAGNOSTIC_REPORT>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn DdqIsDiagnosticRecordSampledIn(
                ...
                eventversion: *const u32,
                eventkeywords: *const u64,
                issampledin: *mut super::super::Foundation::BOOL,
            ) -> ::windows::runtime::HRESULT;
        }
