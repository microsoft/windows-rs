...
impl AsyncIAssociatedIdentityProvider {
    ...
    pub unsafe fn Begin_AssociateIdentity<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::HWND>,
    >(
        &self,
        hwndparent: Param0,
    ...
    > {
        ...
        .from_abi::<super::super::super::super::System::PropertiesSystem::IPropertyStore>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Begin_DisassociateIdentity<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::HWND>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
        &self,
        hwndparent: Param0,
        lpszuniqueid: Param1,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Begin_ChangeCredential<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::HWND>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AsyncIAssociatedIdentityProvider
{
...
impl AsyncIConnectedIdentityProvider {
    pub unsafe fn Begin_ConnectIdentity(
        &self,
        authbuffer: *const u8,
        authbuffersize: u32,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(authbuffer),
            ::std::mem::transmute(authbuffersize),
        )
        .ok()
    }
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Finish_IsConnected(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::super::Foundation::BOOL> {
        let mut result__ : < super::super::super::super::Foundation:: BOOL as :: windows :: runtime :: Abi > :: Abi = :: std :: mem :: zeroed ( ) ;
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<super::super::super::super::Foundation::BOOL>(result__)
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Begin_GetUrl<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::System::Com::IBindCtx>,
    >(
        &self,
    ...
    pub unsafe fn Finish_GetAccountState(&self) -> ::windows::runtime::Result<ACCOUNT_STATE> {
        ...
        .from_abi::<ACCOUNT_STATE>(result__)
    }
}
...
pub struct AsyncIConnectedIdentityProvider_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        connected: *mut super::super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_System_Com")]
    pub  unsafe extern "system" fn(
...
impl AsyncIIdentityAdvise {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Begin_IdentityUpdated<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
        &self,
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dwidentityupdateevents),
            lpszuniqueid.into_param().abi(),
        )
        .ok()
    }
...
impl AsyncIIdentityAuthentication {
    pub unsafe fn Begin_SetIdentityCredential(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(credbuffer),
            ::std::mem::transmute(credbufferlength),
        )
        .ok()
    }
    ...
    pub unsafe fn Begin_ValidateIdentityCredential(
        ...
        credbuffer: *const u8,
        credbufferlength: u32,
        ppidentityproperties: *mut ::std::option::Option<
            super::super::super::super::System::PropertiesSystem::IPropertyStore,
        >,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ...
            ::std::mem::transmute(credbuffer),
            ::std::mem::transmute(credbufferlength),
            ::std::mem::transmute(ppidentityproperties),
        )
        .ok()
    }
    #[cfg(feature = "Win32_System_PropertiesSystem")]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for AsyncIIdentityAuthentication
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct AsyncIIdentityAuthentication_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        credbuffer: *const u8,
        credbufferlength: u32,
        ppidentityproperties: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_System_PropertiesSystem"))] usize,
    #[cfg(feature = "Win32_System_PropertiesSystem")]
    pub  unsafe extern "system" fn(
...
impl AsyncIIdentityProvider {
    ...
    pub unsafe fn Begin_GetIdentityEnum(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(eidentitytype),
            ::std::mem::transmute(pfilterkey),
            ::std::mem::transmute(pfilterpropvarvalue),
        )
        .ok()
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Finish_GetIdentityEnum(
        ...
        .from_abi::<super::super::super::super::System::Com::IEnumUnknown>(result__)
    }
    #[cfg(all(
        feature = "Win32_Foundation",
        feature = "Win32_System_Com",
    ...
    pub unsafe fn Begin_Create<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
        &self,
        lpszusername: Param0,
        ...
        (::windows::runtime::Interface::vtable(self).5)(
            ...
            ::std::mem::transmute(pkeywordstoadd),
        )
        .ok()
    }
    #[cfg(feature = "Win32_System_PropertiesSystem")]
    ...
    >(
        &self,
        ppropertystore: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            ppropertystore.into_param().abi(),
        )
        .ok()
    }
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).9)(
            ::std::mem::transmute_copy(self),
            lpszuniqueid.into_param().abi(),
            ::std::mem::transmute(pkeywordstodelete),
        )
        .ok()
    }
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Begin_FindByUniqueID<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
        &self,
    ...
    pub unsafe fn Begin_Advise<'a, Param0: ::windows::runtime::IntoParam<'a, IIdentityAdvise>>(
        &self,
        pidentityadvise: Param0,
        dwidentityupdateevents: u32,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).15)(
            ::std::mem::transmute_copy(self),
            pidentityadvise.into_param().abi(),
            ::std::mem::transmute(dwidentityupdateevents),
        )
        .ok()
    }
...
pub struct AsyncIIdentityProvider_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppropertystore: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_System_PropertiesSystem"))] usize,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
    #[cfg(all(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pidentityadvise: ::windows::runtime::RawPtr,
        dwidentityupdateevents: u32,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl AsyncIIdentityStore {
    ...
    pub unsafe fn Begin_GetAt(
        &self,
        dwprovider: u32,
        pprovguid: *mut ::windows::runtime::GUID,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dwprovider),
            ::std::mem::transmute(pprovguid),
        )
        .ok()
    }
    pub unsafe fn Finish_GetAt(
        &self,
        pprovguid: *mut ::windows::runtime::GUID,
        ppidentityprovider: *mut ::std::option::Option<::windows::runtime::IUnknown>,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(pprovguid),
            ::std::mem::transmute(ppidentityprovider),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Begin_AddToCache<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
        &self,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Begin_ConvertToSid<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
        &self,
    ...
    pub unsafe fn Finish_ConvertToSid(
        ...
        (::windows::runtime::Interface::vtable(self).10)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(psid),
            ::std::mem::transmute(pcbrequiredsid),
        )
        .ok()
    }
    #[cfg(all(
...
pub struct AsyncIIdentityStore_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pprovguid: *mut ::windows::runtime::GUID,
        ppidentityprovider: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl AsyncIIdentityStoreEx {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Begin_CreateConnectedIdentity<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
        &self,
        localname: Param0,
        connectedname: Param1,
        providerguid: *const ::windows::runtime::GUID,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            localname.into_param().abi(),
            connectedname.into_param().abi(),
            ::std::mem::transmute(providerguid),
        )
        .ok()
    }
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Begin_DeleteConnectedIdentity<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
        &self,
        connectedname: Param0,
        providerguid: *const ::windows::runtime::GUID,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
...
pub struct AsyncIIdentityStoreEx_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        localname: super::super::super::super::Foundation::PWSTR,
        connectedname: super::super::super::super::Foundation::PWSTR,
        providerguid: *const ::windows::runtime::GUID,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> ::windows::runtime::HRESULT,
...
pub const CIdentityProfileHandler: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3975528262,
    58294,
    17562,
    [181, 107, 67, 245, 143, 134, 120, 20],
);
pub const CoClassIdentityStore: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    819237446,
    53783,
    18015,
    [176, 11, 172, 157, 221, 101, 46, 183],
);
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl IAssociatedIdentityProvider {
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn DisassociateIdentity<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::HWND>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ChangeCredential<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::HWND>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
...
unsafe impl ::windows::runtime::Interface for IConnectedIdentityProvider {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        57484,
        17051,
        [150, 200, 103, 141, 19, 105, 236, 177],
    );
}
...
impl IIdentityProvider {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            lpszusername.into_param().abi(),
            ::std::mem::transmute(pppropertystore),
            ::std::mem::transmute(pkeywordstoadd),
        )
        .ok()
    }
    ...
    pub unsafe fn Advise<'a, Param0: ::windows::runtime::IntoParam<'a, IIdentityAdvise>>(
        &self,
        pidentityadvise: Param0,
        dwidentityupdateevents: IdentityUpdateEvent,
...
impl IIdentityStoreEx {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn CreateConnectedIdentity<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn DeleteConnectedIdentity<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::Foundation::PWSTR>,
    >(
        &self,
...
pub const OID_OAssociatedIdentityProviderObject: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2563089373,
        56168,
        20250,
        [141, 43, 144, 121, 205, 254, 175, 97],
    );
