...
impl ::std::fmt::Debug for FindSimilarFileIndexResults {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("FindSimilarFileIndexResults")
            .field("m_FileIndex", &self.m_FileIndex)
            .field("m_MatchCount", &self.m_MatchCount)
            .finish()
    }
}
...
pub const FindSimilarResults: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903443,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
);
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
...
impl IFindSimilarResults {
    ...
    pub unsafe fn GetNextFileId(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(numtraitsmatched),
            ::std::mem::transmute(similarityfileid),
        )
        .ok()
    }
}
...
impl IRdcComparator {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            endofinput.into_param().abi(),
            ::std::mem::transmute(endofoutput),
            ::std::mem::transmute(inputbuffer),
            ::std::mem::transmute(outputbuffer),
            ::std::mem::transmute(rdc_errorcode),
        )
        .ok()
    }
}
...
pub struct IRdcComparator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        endofinput: super::super::Foundation::BOOL,
        endofoutput: *mut super::super::Foundation::BOOL,
        inputbuffer: *mut RdcBufferPointer,
        outputbuffer: *mut RdcNeedPointer,
        rdc_errorcode: *mut RDC_ErrorCode,
...
impl IRdcFileReader {
    ...
    pub unsafe fn Read(
        ...
        buffer: *mut u8,
        eof: *mut super::super::Foundation::BOOL,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(offsetfilestart),
            ::std::mem::transmute(bytestoread),
            ::std::mem::transmute(bytesactuallyread),
            ::std::mem::transmute(buffer),
            ::std::mem::transmute(eof),
        )
        .ok()
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, IRdcFileReader> for &IRdcFileWriter {
    fn into_param(self) -> ::windows::runtime::Param<'a, IRdcFileReader> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IRdcFileReader>::into(
...
impl IRdcGenerator {
    pub unsafe fn GetGeneratorParameters(
        &self,
        level: u32,
    ) -> ::windows::runtime::Result<IRdcGeneratorParameters> {
        let mut result__: <IRdcGeneratorParameters as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
        ...
        .from_abi::<IRdcGeneratorParameters>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Process<
        'a,
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ...
            ::std::mem::transmute(outputbuffers),
            ::std::mem::transmute(rdc_errorcode),
        )
        .ok()
    }
...
pub struct IRdcGenerator_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        level: u32,
        igeneratorparameters: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IRdcGeneratorFilterMaxParameters {
    ...
    pub unsafe fn SetHashWindowSize(&self, hashwindowsize: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(hashwindowsize),
        )
        .ok()
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IRdcGeneratorFilterMaxParameters
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl IRdcGeneratorParameters {
    pub unsafe fn GetGeneratorParametersType(
        &self,
    ) -> ::windows::runtime::Result<GeneratorParametersType> {
        let mut result__: <GeneratorParametersType as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<GeneratorParametersType>(result__)
    }
    pub unsafe fn GetParametersVersion(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(currentversion),
            ::std::mem::transmute(minimumcompatibleappversion),
        )
        .ok()
    }
    ...
    pub unsafe fn Serialize(
        ...
        (::windows::runtime::Interface::vtable(self).6)(
            ...
            ::std::mem::transmute(parametersblob),
...
impl IRdcLibrary {
    pub unsafe fn ComputeDefaultRecursionDepth(
        &self,
        filesize: u64,
    ...
    pub unsafe fn CreateGeneratorParameters(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(parameterstype),
            ::std::mem::transmute(level),
            &mut result__,
        )
        .from_abi::<IRdcGeneratorParameters>(result__)
    ...
    pub unsafe fn CreateGenerator(
        &self,
        depth: u32,
        igeneratorparametersarray: *const ::std::option::Option<IRdcGeneratorParameters>,
    ) -> ::windows::runtime::Result<IRdcGenerator> {
        let mut result__: <IRdcGenerator as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(depth),
            ::std::mem::transmute(igeneratorparametersarray),
            &mut result__,
        )
        .from_abi::<IRdcGenerator>(result__)
    }
    pub unsafe fn CreateComparator<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IRdcFileReader>,
    >(
        &self,
        iseedsignaturesfile: Param0,
        comparatorbuffersize: u32,
    ) -> ::windows::runtime::Result<IRdcComparator> {
        let mut result__: <IRdcComparator as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            iseedsignaturesfile.into_param().abi(),
            ::std::mem::transmute(comparatorbuffersize),
            &mut result__,
        )
        .from_abi::<IRdcComparator>(result__)
    }
    pub unsafe fn CreateSignatureReader<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IRdcFileReader>,
    >(
        &self,
        ifilereader: Param0,
    ) -> ::windows::runtime::Result<IRdcSignatureReader> {
        let mut result__: <IRdcSignatureReader as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            ifilereader.into_param().abi(),
            &mut result__,
        )
        .from_abi::<IRdcSignatureReader>(result__)
    }
...
pub struct IRdcLibrary_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        depth: u32,
        igeneratorparametersarray: *const ::windows::runtime::RawPtr,
        igenerator: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        iseedsignaturesfile: ::windows::runtime::RawPtr,
        comparatorbuffersize: u32,
        icomparator: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ifilereader: ::windows::runtime::RawPtr,
        isignaturereader: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        currentversion: *mut u32,
...
impl IRdcSignatureReader {
    pub unsafe fn ReadHeader(&self) -> ::windows::runtime::Result<RDC_ErrorCode> {
        ...
        .from_abi::<RDC_ErrorCode>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ReadSignatures(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(rdcsignaturepointer),
            ::std::mem::transmute(endofoutput),
        )
        .ok()
    }
...
impl IRdcSimilarityGenerator {
    ...
    pub unsafe fn Results(&self) -> ::windows::runtime::Result<SimilarityData> {
        ...
        .from_abi::<SimilarityData>(result__)
    }
}
...
impl ISimilarity {
    ...
    >(
        ...
        recordsize: u32,
    ) -> ::windows::runtime::Result<RdcCreatedTables> {
        let mut result__: <RdcCreatedTables as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            path.into_param().abi(),
            truncate.into_param().abi(),
            ::std::mem::transmute(securitydescriptor),
            ::std::mem::transmute(recordsize),
            &mut result__,
        )
        .from_abi::<RdcCreatedTables>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn CreateTableIndirect<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ISimilarityTraitsMapping>,
        Param1: ::windows::runtime::IntoParam<'a, IRdcFileWriter>,
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            mapping.into_param().abi(),
            fileidfile.into_param().abi(),
            truncate.into_param().abi(),
            ::std::mem::transmute(recordsize),
            &mut result__,
        )
    ...
    pub unsafe fn Append(
        ...
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(similarityfileid),
            ::std::mem::transmute(similaritydata),
        )
        .ok()
    }
    pub unsafe fn FindSimilarFileId(
        ...
        resultssize: u32,
    ) -> ::windows::runtime::Result<IFindSimilarResults> {
        let mut result__: <IFindSimilarResults as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(similaritydata),
            ::std::mem::transmute(numberofmatchesrequired),
            ::std::mem::transmute(resultssize),
            &mut result__,
        )
        .from_abi::<IFindSimilarResults>(result__)
    }
    pub unsafe fn CopyAndSwap<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ISimilarity>,
        Param1: ::windows::runtime::IntoParam<'a, ISimilarityReportProgress>,
    >(
        &self,
        newsimilaritytables: Param0,
        reportprogress: Param1,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            newsimilaritytables.into_param().abi(),
            reportprogress.into_param().abi(),
        )
        .ok()
    }
...
pub struct ISimilarity_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        mapping: ::windows::runtime::RawPtr,
        fileidfile: ::windows::runtime::RawPtr,
        truncate: super::super::Foundation::BOOL,
        recordsize: u32,
        isnew: *mut RdcCreatedTables,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        isvalid: super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        ...
        numberofmatchesrequired: u16,
        resultssize: u32,
        findsimilarresults: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        newsimilaritytables: ::windows::runtime::RawPtr,
        reportprogress: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        recordcount: *mut u32,
...
impl ISimilarityFileIdTable {
    ...
    pub unsafe fn CreateTableIndirect<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IRdcFileWriter>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
    >(
        &self,
        fileidfile: Param0,
    ...
    ) -> ::windows::runtime::Result<SimilarityFileId> {
        let mut result__: <SimilarityFileId as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(similarityfileindex),
            &mut result__,
        )
        .from_abi::<SimilarityFileId>(result__)
    }
...
impl ISimilarityReportProgress {
    pub unsafe fn ReportProgress(&self, percentcompleted: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(percentcompleted),
        )
        .ok()
    }
}
...
impl ISimilarityTraitsMappedView {
    ...
    >(
        ...
        dirty: Param1,
        numelements: u32,
    ) -> ::windows::runtime::Result<SimilarityMappedViewInfo> {
        let mut result__: <SimilarityMappedViewInfo as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(index),
            dirty.into_param().abi(),
            ::std::mem::transmute(numelements),
            &mut result__,
        )
        .from_abi::<SimilarityMappedViewInfo>(result__)
    }
    pub unsafe fn GetView(&self, mappedpagebegin: *mut *mut u8, mappedpageend: *mut *mut u8) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(mappedpagebegin),
            ::std::mem::transmute(mappedpageend),
        ))
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ISimilarityTraitsMappedView
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ISimilarityTraitsMapping {
    ...
    pub unsafe fn CreateView(
        ...
        accessmode: RdcMappingAccessMode,
    ) -> ::windows::runtime::Result<ISimilarityTraitsMappedView> {
        let mut result__: <ISimilarityTraitsMappedView as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).9)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(minimummappedpages),
            ::std::mem::transmute(accessmode),
            &mut result__,
        )
        .from_abi::<ISimilarityTraitsMappedView>(result__)
    }
}
...
pub struct ISimilarityTraitsMapping_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        minimummappedpages: u32,
        accessmode: RdcMappingAccessMode,
        mappedview: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl ISimilarityTraitsTable {
    ...
    pub unsafe fn FindSimilarFileIndex(
        ...
        (::windows::runtime::Interface::vtable(self).7)(
            ...
            ::std::mem::transmute(similaritydata),
            ::std::mem::transmute(numberofmatchesrequired),
            ::std::mem::transmute(findsimilarfileindexresults),
            ::std::mem::transmute(resultssize),
            ::std::mem::transmute(resultsused),
        )
        .ok()
    ...
    pub unsafe fn BeginDump(&self) -> ::windows::runtime::Result<ISimilarityTableDumpState> {
        let mut result__: <ISimilarityTableDumpState as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<ISimilarityTableDumpState>(result__)
    }
...
pub struct ISimilarityTraitsTable_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        similaritytabledumpstate: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        fileindex: *mut u32,
...
impl ::std::fmt::Debug for RdcBufferPointer {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("RdcBufferPointer")
            .field("m_Size", &self.m_Size)
            .field("m_Used", &self.m_Used)
            .field("m_Data", &self.m_Data)
            .finish()
    }
}
...
pub const RdcComparator: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903435,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
...
pub const RdcFileReader: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903433,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
);
pub const RdcGenerator: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903432,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
);
pub const RdcGeneratorFilterMaxParameters: ::windows::runtime::GUID =
...
pub const RdcGeneratorParameters: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903430,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
);
pub const RdcLibrary: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903429,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
...
impl ::std::fmt::Debug for RdcNeed {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("RdcNeed")
            .field("m_BlockType", &self.m_BlockType)
            .field("m_FileOffset", &self.m_FileOffset)
            .field("m_BlockLength", &self.m_BlockLength)
            .finish()
    }
}
impl ::std::cmp::PartialEq for RdcNeed {
    fn eq(&self, other: &Self) -> bool {
        self.m_BlockType == other.m_BlockType
            && self.m_FileOffset == other.m_FileOffset
            && self.m_BlockLength == other.m_BlockLength
    }
}
...
impl ::std::fmt::Debug for RdcNeedPointer {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("RdcNeedPointer")
            .field("m_Size", &self.m_Size)
            .field("m_Used", &self.m_Used)
            .field("m_Data", &self.m_Data)
            .finish()
...
impl ::std::fmt::Debug for RdcSignature {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("RdcSignature")
            .field("m_Signature", &self.m_Signature)
            .field("m_BlockLength", &self.m_BlockLength)
            .finish()
    }
}
...
impl ::std::fmt::Debug for RdcSignaturePointer {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("RdcSignaturePointer")
            .field("m_Size", &self.m_Size)
            .field("m_Used", &self.m_Used)
            .field("m_Data", &self.m_Data)
            .finish()
...
pub const RdcSignatureReader: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903434,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
);
pub const RdcSimilarityGenerator: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903442,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
);
pub const Similarity: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903441,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
...
impl ::std::fmt::Debug for SimilarityData {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SimilarityData")
            .field("m_Data", &self.m_Data)
            .finish()
    }
}
...
impl ::std::fmt::Debug for SimilarityDumpData {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SimilarityDumpData")
            .field("m_FileIndex", &self.m_FileIndex)
            .field("m_Data", &self.m_Data)
            .finish()
    }
...
impl ::std::fmt::Debug for SimilarityFileId {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SimilarityFileId")
...
pub const SimilarityFileIdTable: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903440,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
...
impl ::std::fmt::Debug for SimilarityMappedViewInfo {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SimilarityMappedViewInfo")
            .field("m_Data", &self.m_Data)
            .field("m_Length", &self.m_Length)
            .finish()
    }
}
...
pub const SimilarityReportProgress: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2518903437,
        40380,
        4570,
...
pub const SimilarityTableDumpState: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2518903438,
        40380,
        4570,
...
pub const SimilarityTraitsMappedView: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2518903445,
        40380,
        4570,
...
pub const SimilarityTraitsMapping: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903444,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
);
pub const SimilarityTraitsTable: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    2518903439,
    40380,
    4570,
    [158, 63, 0, 17, 17, 74, 227, 17],
