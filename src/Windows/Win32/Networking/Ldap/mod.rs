...
#[cfg(feature = "Win32_Foundation")]
pub type DEREFERENCECONNECTION = unsafe extern "system" fn(
    primaryconnection: *mut ldap,
    connectiontodereference: *mut ldap,
) -> u32;
...
impl ::std::fmt::Debug for LDAPAPIFeatureInfoA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("LDAPAPIFeatureInfoA")
            .field("ldapaif_info_version", &self.ldapaif_info_version)
            .field("ldapaif_name", &self.ldapaif_name)
            .field("ldapaif_version", &self.ldapaif_version)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for LDAPAPIFeatureInfoA {
    fn eq(&self, other: &Self) -> bool {
        self.ldapaif_info_version == other.ldapaif_info_version
            && self.ldapaif_name == other.ldapaif_name
            && self.ldapaif_version == other.ldapaif_version
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for LDAPAPIFeatureInfoW {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("LDAPAPIFeatureInfoW")
            .field("ldapaif_info_version", &self.ldapaif_info_version)
            .field("ldapaif_name", &self.ldapaif_name)
            .field("ldapaif_version", &self.ldapaif_version)
            .finish()
...
impl ::std::cmp::PartialEq for LDAPMessage {
    fn eq(&self, other: &Self) -> bool {
        self.lm_msgid == other.lm_msgid
            && self.lm_msgtype == other.lm_msgtype
            && self.lm_ber == other.lm_ber
            && self.lm_chain == other.lm_chain
            && self.lm_next == other.lm_next
            && self.lm_time == other.lm_time
            && self.Connection == other.Connection
            && self.Request == other.Request
            && self.lm_returncode == other.lm_returncode
            && self.lm_referral == other.lm_referral
            && self.lm_chased == other.lm_chased
            && self.lm_eom == other.lm_eom
            && self.ConnectionReferenced == other.ConnectionReferenced
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for LDAP_BERVAL {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("LDAP_BERVAL")
            .field("bv_len", &self.bv_len)
            .field("bv_val", &self.bv_val)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for LDAP_REFERRAL_CALLBACK {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("LDAP_REFERRAL_CALLBACK")
            .field("SizeOfCallbacks", &self.SizeOfCallbacks)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for LDAP_REFERRAL_CALLBACK {
    fn eq(&self, other: &Self) -> bool {
        self.SizeOfCallbacks == other.SizeOfCallbacks
            && self.QueryForConnection.map(|f| f as usize)
                == other.QueryForConnection.map(|f| f as usize)
            && self.NotifyRoutine.map(|f| f as usize) == other.NotifyRoutine.map(|f| f as usize)
            && self.DereferenceRoutine.map(|f| f as usize)
                == other.DereferenceRoutine.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn LdapUTF8ToUnicode<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    lpsrcstr: Param0,
    cchsrc: i32,
    lpdeststr: super::super::Foundation::PWSTR,
    cchdest: i32,
) -> i32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(LdapUTF8ToUnicode(
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn LdapUnicodeToUTF8<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    lpsrcstr: Param0,
    cchsrc: i32,
    lpdeststr: super::super::Foundation::PSTR,
    cchdest: i32,
) -> i32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(LdapUnicodeToUTF8(
            lpsrcstr.into_param().abi(),
            ::std::mem::transmute(cchsrc),
            ::std::mem::transmute(lpdeststr),
            ::std::mem::transmute(cchdest),
...
#[cfg(feature = "Win32_Foundation")]
pub type NOTIFYOFNEWCONNECTION = unsafe extern "system" fn(
    primaryconnection: *mut ldap,
    referralfromconnection: *mut ldap,
    newdn: super::super::Foundation::PWSTR,
    hostname: super::super::Foundation::PSTR,
    newconnection: *mut ldap,
    portnumber: u32,
    secauthidentity: *mut ::std::ffi::c_void,
    currentuser: *mut ::std::ffi::c_void,
...
pub type QUERYFORCONNECTION = unsafe extern "system" fn(
    ...
    portnumber: u32,
    secauthidentity: *mut ::std::ffi::c_void,
    currentusertoken: *mut ::std::ffi::c_void,
    connectiontouse: *mut *mut ldap,
) -> u32;
...
pub unsafe fn ber_first_element(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ber_first_element(
            ::std::mem::transmute(pberelement),
            ::std::mem::transmute(plen),
            ::std::mem::transmute(ppopaque),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn ber_flatten(pberelement: *mut berelement, pberval: *mut *mut LDAP_BERVAL) -> i32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ber_flatten(
            ::std::mem::transmute(pberelement),
            ::std::mem::transmute(pberval),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn ber_free(pberelement: *mut berelement, fbuf: i32) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ber_free(
            ::std::mem::transmute(pberelement),
            ::std::mem::transmute(fbuf),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ber_next_element<
    'a,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ber_next_element(
                pberelement: *mut berelement,
                plen: *mut u32,
                opaque: super::super::Foundation::PSTR,
            ) -> u32;
        }
        ::std::mem::transmute(ber_next_element(
            ::std::mem::transmute(pberelement),
            ::std::mem::transmute(plen),
            opaque.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn ber_peek_tag(pberelement: *mut berelement, plen: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ber_peek_tag(
            ::std::mem::transmute(pberelement),
            ::std::mem::transmute(plen),
        ))
    }
...
pub unsafe fn ber_skip_tag(pberelement: *mut berelement, plen: *mut u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ber_skip_tag(
            ::std::mem::transmute(pberelement),
            ::std::mem::transmute(plen),
        ))
    }
...
impl ::std::fmt::Debug for ldap_0 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("_ld_sb_e__Struct")
            .field("sb_sd", &self.sb_sd)
            .field("Reserved1", &self.Reserved1)
            .field("sb_naddr", &self.sb_naddr)
...
impl ::std::cmp::PartialEq for ldap_0 {
    fn eq(&self, other: &Self) -> bool {
        self.sb_sd == other.sb_sd
            && self.Reserved1 == other.Reserved1
            && self.sb_naddr == other.sb_naddr
...
pub unsafe fn ldap_abandon(ld: *mut ldap, msgid: u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_abandon(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(msgid),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_add_ext(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(attrs),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_add_extA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(attrs),
            ::std::mem::transmute(servercontrols),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_add_extW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(attrs),
            ::std::mem::transmute(servercontrols),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_add_ext_s(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(attrs),
            ::std::mem::transmute(servercontrols),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_add_ext_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(attrs),
            ::std::mem::transmute(servercontrols),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_add_ext_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(attrs),
            ::std::mem::transmute(servercontrols),
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_bind(
                ld: *mut ldap,
                dn: super::super::Foundation::PSTR,
                cred: super::super::Foundation::PSTR,
                method: u32,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_bind(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            cred.into_param().abi(),
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_bindW(
                ld: *mut ldap,
                dn: super::super::Foundation::PWSTR,
                cred: super::super::Foundation::PWSTR,
                method: u32,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_bindW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            cred.into_param().abi(),
            ::std::mem::transmute(method),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_bind_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            cred.into_param().abi(),
            ::std::mem::transmute(method),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_bind_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            cred.into_param().abi(),
            ::std::mem::transmute(method),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_check_filterA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_check_filterA(
                ld: *mut ldap,
                searchfilter: super::super::Foundation::PSTR,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_check_filterA(
            ::std::mem::transmute(ld),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_check_filterW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_check_filterW(
                ld: *mut ldap,
                searchfilter: super::super::Foundation::PWSTR,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_check_filterW(
            ::std::mem::transmute(ld),
            searchfilter.into_param().abi(),
        ))
    }
...
pub unsafe fn ldap_close_extended_op(ld: *mut ldap, messagenumber: u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_close_extended_op(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(messagenumber),
        ))
    }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_compare(
                ld: *mut ldap,
                dn: super::super::Foundation::PSTR,
                attr: super::super::Foundation::PSTR,
                value: super::super::Foundation::PSTR,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_compare(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compareA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_compareW(
                ld: *mut ldap,
                dn: super::super::Foundation::PWSTR,
                attr: super::super::Foundation::PWSTR,
                value: super::super::Foundation::PWSTR,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_compareW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_compare_ext<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compare_ext(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_compare_extA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compare_extA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_compare_extW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compare_extW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_compare_ext_s<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compare_ext_s(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_compare_ext_sA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compare_ext_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_compare_ext_sW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compare_ext_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compare_s(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compare_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_compare_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            attr.into_param().abi(),
            value.into_param().abi(),
...
pub unsafe fn ldap_conn_from_msg(primaryconn: *mut ldap, res: *mut LDAPMessage) -> *mut ldap {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_conn_from_msg(
            ::std::mem::transmute(primaryconn),
...
pub unsafe fn ldap_connect(ld: *mut ldap, timeout: *mut LDAP_TIMEVAL) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_connect(
            ::std::mem::transmute(ld),
...
pub unsafe fn ldap_count_entries(ld: *mut ldap, res: *mut LDAPMessage) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_count_entries(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(res),
        ))
    }
...
pub unsafe fn ldap_count_references(ld: *mut ldap, res: *mut LDAPMessage) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_count_references(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(res),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_create_page_control(
    externalhandle: *mut ldap,
    pagesize: u32,
    cookie: *mut LDAP_BERVAL,
    iscritical: u8,
    control: *mut *mut ldapcontrolA,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_create_page_control(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(pagesize),
            ::std::mem::transmute(cookie),
            ::std::mem::transmute(iscritical),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_create_page_controlA(
    externalhandle: *mut ldap,
    pagesize: u32,
    cookie: *mut LDAP_BERVAL,
    iscritical: u8,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_create_page_controlA(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(pagesize),
            ::std::mem::transmute(cookie),
            ::std::mem::transmute(iscritical),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_create_page_controlW(
    externalhandle: *mut ldap,
    pagesize: u32,
    cookie: *mut LDAP_BERVAL,
    iscritical: u8,
    control: *mut *mut ldapcontrolW,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_create_page_controlW(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(pagesize),
            ::std::mem::transmute(cookie),
            ::std::mem::transmute(iscritical),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_create_sort_control(
    externalhandle: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_create_sort_control(
            ::std::mem::transmute(externalhandle),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_create_sort_controlA(
    externalhandle: *mut ldap,
    sortkeys: *mut *mut ldapsortkeyA,
    iscritical: u8,
    control: *mut *mut ldapcontrolA,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_create_sort_controlA(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(sortkeys),
            ::std::mem::transmute(iscritical),
            ::std::mem::transmute(control),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_create_sort_controlW(
    externalhandle: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_create_sort_controlW(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(sortkeys),
            ::std::mem::transmute(iscritical),
            ::std::mem::transmute(control),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_create_vlv_controlA(
    externalhandle: *mut ldap,
    vlvinfo: *mut ldapvlvinfo,
    iscritical: u8,
    control: *mut *mut ldapcontrolA,
) -> i32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_create_vlv_controlA(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(vlvinfo),
            ::std::mem::transmute(iscritical),
            ::std::mem::transmute(control),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_create_vlv_controlW(
    externalhandle: *mut ldap,
    vlvinfo: *mut ldapvlvinfo,
    iscritical: u8,
    control: *mut *mut ldapcontrolW,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_create_vlv_controlW(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(vlvinfo),
            ::std::mem::transmute(iscritical),
            ::std::mem::transmute(control),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_deleteA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_deleteW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_delete_ext(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(clientcontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_delete_extA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_delete_extA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(clientcontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_delete_extW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_delete_extW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(clientcontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_delete_ext_s<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_delete_ext_s(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(clientcontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_delete_ext_sA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_delete_ext_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(clientcontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_delete_ext_sW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_delete_ext_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(clientcontrols),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_delete_s(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_delete_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_delete_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
        ))
    }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_encode_sort_controlA(
                ...
                sortkeys: *mut *mut ldapsortkeyA,
                control: *mut ldapcontrolA,
                criticality: super::super::Foundation::BOOLEAN,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_encode_sort_controlA(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(sortkeys),
            ::std::mem::transmute(control),
            criticality.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_encode_sort_controlW<
    'a,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOLEAN>,
>(
    externalhandle: *mut ldap,
    sortkeys: *mut *mut ldapsortkeyW,
    control: *mut ldapcontrolW,
    criticality: Param3,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_encode_sort_controlW(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(sortkeys),
            ::std::mem::transmute(control),
            criticality.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_escape_filter_element<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    sourcefilterelement: Param0,
    sourcelength: u32,
    destfilterelement: super::super::Foundation::PSTR,
    destlength: u32,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_escape_filter_element(
            sourcefilterelement.into_param().abi(),
            ::std::mem::transmute(sourcelength),
            ::std::mem::transmute(destfilterelement),
            ::std::mem::transmute(destlength),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_escape_filter_elementA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    sourcefilterelement: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_escape_filter_elementA(
            sourcefilterelement.into_param().abi(),
            ::std::mem::transmute(sourcelength),
            ::std::mem::transmute(destfilterelement),
            ::std::mem::transmute(destlength),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_escape_filter_elementW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    sourcefilterelement: Param0,
    sourcelength: u32,
    destfilterelement: super::super::Foundation::PWSTR,
    destlength: u32,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_escape_filter_elementW(
            sourcefilterelement.into_param().abi(),
            ::std::mem::transmute(sourcelength),
            ::std::mem::transmute(destfilterelement),
            ::std::mem::transmute(destlength),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_explode_dn(
            dn.into_param().abi(),
            ::std::mem::transmute(notypes),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_explode_dnA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    dn: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_explode_dnA(
            dn.into_param().abi(),
            ::std::mem::transmute(notypes),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_explode_dnW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    dn: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_explode_dnW(
            dn.into_param().abi(),
            ::std::mem::transmute(notypes),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_extended_operation<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_extended_operation(
                ld: *mut ldap,
                oid: super::super::Foundation::PSTR,
                data: *mut LDAP_BERVAL,
                servercontrols: *mut *mut ldapcontrolA,
                clientcontrols: *mut *mut ldapcontrolA,
                messagenumber: *mut u32,
        ...
        ::std::mem::transmute(ldap_extended_operation(
            ::std::mem::transmute(ld),
            oid.into_param().abi(),
            ::std::mem::transmute(data),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_extended_operationA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_extended_operationA(
            ::std::mem::transmute(ld),
            oid.into_param().abi(),
            ::std::mem::transmute(data),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_extended_operationW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_extended_operationW(
                ld: *mut ldap,
                oid: super::super::Foundation::PWSTR,
                data: *mut LDAP_BERVAL,
                servercontrols: *mut *mut ldapcontrolW,
                clientcontrols: *mut *mut ldapcontrolW,
                messagenumber: *mut u32,
        ...
        ::std::mem::transmute(ldap_extended_operationW(
            ::std::mem::transmute(ld),
            oid.into_param().abi(),
            ::std::mem::transmute(data),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_extended_operation_sA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    externalhandle: *mut ldap,
    ...
    servercontrols: *mut *mut ldapcontrolA,
    clientcontrols: *mut *mut ldapcontrolA,
    returnedoid: *mut super::super::Foundation::PSTR,
    returneddata: *mut *mut LDAP_BERVAL,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_extended_operation_sA(
            ::std::mem::transmute(externalhandle),
            oid.into_param().abi(),
            ::std::mem::transmute(data),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(clientcontrols),
            ::std::mem::transmute(returnedoid),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_extended_operation_sW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    externalhandle: *mut ldap,
    ...
    servercontrols: *mut *mut ldapcontrolW,
    clientcontrols: *mut *mut ldapcontrolW,
    returnedoid: *mut super::super::Foundation::PWSTR,
    returneddata: *mut *mut LDAP_BERVAL,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_extended_operation_sW(
            ::std::mem::transmute(externalhandle),
            oid.into_param().abi(),
            ::std::mem::transmute(data),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_first_attribute(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_first_attribute(
            ::std::mem::transmute(ld),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_first_attributeA(
    ld: *mut ldap,
    entry: *mut LDAPMessage,
    ptr: *mut *mut berelement,
) -> super::super::Foundation::PSTR {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_first_attributeA(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
            ::std::mem::transmute(ptr),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_first_attributeW(
    ld: *mut ldap,
    entry: *mut LDAPMessage,
    ptr: *mut *mut berelement,
) -> super::super::Foundation::PWSTR {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_first_attributeW(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
            ::std::mem::transmute(ptr),
        ))
...
pub unsafe fn ldap_first_entry(ld: *mut ldap, res: *mut LDAPMessage) -> *mut LDAPMessage {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_first_entry(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(res),
        ))
    }
...
pub unsafe fn ldap_first_reference(ld: *mut ldap, res: *mut LDAPMessage) -> *mut LDAPMessage {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_first_reference(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(res),
        ))
    }
...
pub unsafe fn ldap_get_dnA(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_dnA(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
        ))
    }
...
pub unsafe fn ldap_get_dnW(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_dnW(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_next_page(
    externalhandle: *mut ldap,
    searchhandle: *mut ldapsearch,
    pagesize: u32,
    messagenumber: *mut u32,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_next_page(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(searchhandle),
            ::std::mem::transmute(pagesize),
            ::std::mem::transmute(messagenumber),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_next_page_s(
    externalhandle: *mut ldap,
    searchhandle: *mut ldapsearch,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_next_page_s(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(searchhandle),
            ::std::mem::transmute(timeout),
            ::std::mem::transmute(pagesize),
            ::std::mem::transmute(totalcount),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_option(
    ld: *mut ldap,
    option: i32,
    outvalue: *mut ::std::ffi::c_void,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_get_option(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(option),
            ::std::mem::transmute(outvalue),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_optionW(
    ld: *mut ldap,
    option: i32,
    outvalue: *mut ::std::ffi::c_void,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_optionW(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(option),
            ::std::mem::transmute(outvalue),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_paged_count(
    externalhandle: *mut ldap,
    searchblock: *mut ldapsearch,
    totalcount: *mut u32,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_paged_count(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(searchblock),
            ::std::mem::transmute(totalcount),
            ::std::mem::transmute(results),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_values(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
            attr.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_valuesA<
    'a,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_valuesA(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
            attr.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_valuesW<
    'a,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_valuesW(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
            attr.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_values_len<
    'a,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    externalhandle: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_values_len(
            ::std::mem::transmute(externalhandle),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_values_lenA<
    'a,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    externalhandle: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_values_lenA(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(message),
            attr.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_get_values_lenW<
    'a,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    externalhandle: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_get_values_lenW(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(message),
            attr.into_param().abi(),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modifyA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modifyW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify_ext(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_modify_extA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify_extA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_modify_extW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify_extW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_modify_ext_s<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify_ext_s(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_modify_ext_sA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify_ext_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_modify_ext_sW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ld: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify_ext_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
            ::std::mem::transmute(servercontrols),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify_s(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modify_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            ::std::mem::transmute(mods),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_modrdn(
                externalhandle: *mut ldap,
                distinguishedname: super::super::Foundation::PSTR,
                newdistinguishedname: super::super::Foundation::PSTR,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_modrdn(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdn2(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
            ::std::mem::transmute(deleteoldrdn),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdn2A(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
            ::std::mem::transmute(deleteoldrdn),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_modrdn2W(
                externalhandle: *mut ldap,
                distinguishedname: super::super::Foundation::PWSTR,
                newdistinguishedname: super::super::Foundation::PWSTR,
                deleteoldrdn: i32,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_modrdn2W(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
            ::std::mem::transmute(deleteoldrdn),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdn2_s(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
            ::std::mem::transmute(deleteoldrdn),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdn2_sA(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
            ::std::mem::transmute(deleteoldrdn),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdn2_sW(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
            ::std::mem::transmute(deleteoldrdn),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdnA(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdnW(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdn_s(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdn_sA(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_modrdn_sW(
            ::std::mem::transmute(externalhandle),
            distinguishedname.into_param().abi(),
            newdistinguishedname.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_next_attribute(
    ld: *mut ldap,
    entry: *mut LDAPMessage,
    ptr: *mut berelement,
) -> super::super::Foundation::PSTR {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_next_attribute(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
            ::std::mem::transmute(ptr),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_next_attributeA(
    ld: *mut ldap,
    entry: *mut LDAPMessage,
    ptr: *mut berelement,
) -> super::super::Foundation::PSTR {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_next_attributeA(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
            ::std::mem::transmute(ptr),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_next_attributeW(
    ld: *mut ldap,
    entry: *mut LDAPMessage,
    ptr: *mut berelement,
) -> super::super::Foundation::PWSTR {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_next_attributeW(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
            ::std::mem::transmute(ptr),
        ))
...
pub unsafe fn ldap_next_entry(ld: *mut ldap, entry: *mut LDAPMessage) -> *mut LDAPMessage {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_next_entry(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
        ))
    }
...
pub unsafe fn ldap_next_reference(ld: *mut ldap, entry: *mut LDAPMessage) -> *mut LDAPMessage {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_next_reference(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(entry),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_extended_resultA<
    'a,
    Param4: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOLEAN>,
>(
    connection: *mut ldap,
    resultmessage: *mut LDAPMessage,
    resultoid: *mut super::super::Foundation::PSTR,
    resultdata: *mut *mut LDAP_BERVAL,
    freeit: Param4,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_parse_extended_resultA(
                ...
                resultoid: *mut super::super::Foundation::PSTR,
                resultdata: *mut *mut LDAP_BERVAL,
                freeit: super::super::Foundation::BOOLEAN,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_parse_extended_resultA(
            ::std::mem::transmute(connection),
            ::std::mem::transmute(resultmessage),
            ::std::mem::transmute(resultoid),
            ::std::mem::transmute(resultdata),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_extended_resultW<
    'a,
    Param4: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOLEAN>,
>(
    connection: *mut ldap,
    resultmessage: *mut LDAPMessage,
    resultoid: *mut super::super::Foundation::PWSTR,
    resultdata: *mut *mut LDAP_BERVAL,
    freeit: Param4,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_extended_resultW(
            ::std::mem::transmute(connection),
            ::std::mem::transmute(resultmessage),
            ::std::mem::transmute(resultoid),
            ::std::mem::transmute(resultdata),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_page_control(
    externalhandle: *mut ldap,
    servercontrols: *mut *mut ldapcontrolA,
    totalcount: *mut u32,
    cookie: *mut *mut LDAP_BERVAL,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_parse_page_control(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(totalcount),
            ::std::mem::transmute(cookie),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_page_controlA(
    externalhandle: *mut ldap,
    servercontrols: *mut *mut ldapcontrolA,
    totalcount: *mut u32,
    cookie: *mut *mut LDAP_BERVAL,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_page_controlA(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(totalcount),
            ::std::mem::transmute(cookie),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_page_controlW(
    externalhandle: *mut ldap,
    servercontrols: *mut *mut ldapcontrolW,
    totalcount: *mut u32,
    cookie: *mut *mut LDAP_BERVAL,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_page_controlW(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(totalcount),
            ::std::mem::transmute(cookie),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_reference(
    connection: *mut ldap,
    resultmessage: *mut LDAPMessage,
    referrals: *mut *mut super::super::Foundation::PSTR,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_parse_reference(
            ::std::mem::transmute(connection),
            ::std::mem::transmute(resultmessage),
            ::std::mem::transmute(referrals),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_referenceA(
    connection: *mut ldap,
    resultmessage: *mut LDAPMessage,
    referrals: *mut *mut super::super::Foundation::PSTR,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_referenceA(
            ::std::mem::transmute(connection),
            ::std::mem::transmute(resultmessage),
            ::std::mem::transmute(referrals),
        ))
...
pub unsafe fn ldap_parse_referenceW(
    connection: *mut ldap,
    resultmessage: *mut LDAPMessage,
    referrals: *mut *mut super::super::Foundation::PWSTR,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_parse_referenceW(
            ::std::mem::transmute(connection),
            ::std::mem::transmute(resultmessage),
            ::std::mem::transmute(referrals),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_result<
    'a,
    Param7: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOLEAN>,
>(
    connection: *mut ldap,
    resultmessage: *mut LDAPMessage,
    returncode: *mut u32,
    matcheddns: *mut super::super::Foundation::PSTR,
    errormessage: *mut super::super::Foundation::PSTR,
    referrals: *mut *mut super::super::Foundation::PSTR,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_result(
            ::std::mem::transmute(connection),
            ::std::mem::transmute(resultmessage),
            ::std::mem::transmute(returncode),
            ::std::mem::transmute(matcheddns),
            ::std::mem::transmute(errormessage),
            ::std::mem::transmute(referrals),
            ::std::mem::transmute(servercontrols),
            freeit.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_resultA<
    'a,
    Param7: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOLEAN>,
>(
    connection: *mut ldap,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_resultA(
            ::std::mem::transmute(connection),
            ::std::mem::transmute(resultmessage),
            ::std::mem::transmute(returncode),
            ::std::mem::transmute(matcheddns),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_resultW<
    'a,
    Param7: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOLEAN>,
>(
    connection: *mut ldap,
    resultmessage: *mut LDAPMessage,
    returncode: *mut u32,
    matcheddns: *mut super::super::Foundation::PWSTR,
    errormessage: *mut super::super::Foundation::PWSTR,
    referrals: *mut *mut *mut u16,
    servercontrols: *mut *mut *mut ldapcontrolW,
    freeit: Param7,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_resultW(
            ::std::mem::transmute(connection),
            ::std::mem::transmute(resultmessage),
            ::std::mem::transmute(returncode),
            ::std::mem::transmute(matcheddns),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_sort_control(
    externalhandle: *mut ldap,
    control: *mut *mut ldapcontrolA,
    result: *mut u32,
    attribute: *mut super::super::Foundation::PSTR,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_parse_sort_control(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(control),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_sort_controlA(
    externalhandle: *mut ldap,
    control: *mut *mut ldapcontrolA,
    result: *mut u32,
    attribute: *mut super::super::Foundation::PSTR,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_sort_controlA(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(control),
            ::std::mem::transmute(result),
            ::std::mem::transmute(attribute),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_sort_controlW(
    externalhandle: *mut ldap,
    control: *mut *mut ldapcontrolW,
    result: *mut u32,
    attribute: *mut super::super::Foundation::PWSTR,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_parse_sort_controlW(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(control),
            ::std::mem::transmute(result),
            ::std::mem::transmute(attribute),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_vlv_controlA(
    externalhandle: *mut ldap,
    control: *mut *mut ldapcontrolA,
    targetpos: *mut u32,
    listcount: *mut u32,
    context: *mut *mut LDAP_BERVAL,
    errcode: *mut i32,
) -> i32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_vlv_controlA(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(control),
            ::std::mem::transmute(targetpos),
            ::std::mem::transmute(listcount),
            ::std::mem::transmute(context),
            ::std::mem::transmute(errcode),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_parse_vlv_controlW(
    externalhandle: *mut ldap,
    control: *mut *mut ldapcontrolW,
    targetpos: *mut u32,
    listcount: *mut u32,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_parse_vlv_controlW(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(control),
            ::std::mem::transmute(targetpos),
            ::std::mem::transmute(listcount),
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_rename_ext(
                ld: *mut ldap,
                dn: super::super::Foundation::PSTR,
                newrdn: super::super::Foundation::PSTR,
                newparent: super::super::Foundation::PSTR,
                deleteoldrdn: i32,
                servercontrols: *mut *mut ldapcontrolA,
                clientcontrols: *mut *mut ldapcontrolA,
                messagenumber: *mut u32,
        ...
        ::std::mem::transmute(ldap_rename_ext(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            newrdn.into_param().abi(),
            newparent.into_param().abi(),
            ::std::mem::transmute(deleteoldrdn),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(clientcontrols),
            ::std::mem::transmute(messagenumber),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_rename_extA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_rename_extA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            newrdn.into_param().abi(),
            newparent.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_rename_extW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_rename_extW(
                ld: *mut ldap,
                dn: super::super::Foundation::PWSTR,
                newrdn: super::super::Foundation::PWSTR,
                newparent: super::super::Foundation::PWSTR,
                deleteoldrdn: i32,
                servercontrols: *mut *mut ldapcontrolW,
                clientcontrols: *mut *mut ldapcontrolW,
                messagenumber: *mut u32,
        ...
        ::std::mem::transmute(ldap_rename_extW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            newrdn.into_param().abi(),
            newparent.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_rename_ext_s<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_rename_ext_s(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            newrdn.into_param().abi(),
            newparent.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_rename_ext_sA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_rename_ext_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            newrdn.into_param().abi(),
            newparent.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_rename_ext_sW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_rename_ext_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            newrdn.into_param().abi(),
            newparent.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_result(
    ld: *mut ldap,
    msgid: u32,
    all: u32,
    timeout: *const LDAP_TIMEVAL,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_result(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(msgid),
            ::std::mem::transmute(all),
            ::std::mem::transmute(timeout),
            ::std::mem::transmute(res),
        ))
    }
...
pub unsafe fn ldap_result2error(ld: *mut ldap, res: *mut LDAPMessage, freeit: u32) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_result2error(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(res),
            ::std::mem::transmute(freeit),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_sasl_bindA(
                externalhandle: *mut ldap,
                distname: super::super::Foundation::PSTR,
        ...
        ::std::mem::transmute(ldap_sasl_bindA(
            ::std::mem::transmute(externalhandle),
            distname.into_param().abi(),
            authmechanism.into_param().abi(),
            ::std::mem::transmute(cred),
            ::std::mem::transmute(serverctrls),
            ::std::mem::transmute(clientctrls),
            ::std::mem::transmute(messagenumber),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_sasl_bindW(
                externalhandle: *mut ldap,
                distname: super::super::Foundation::PWSTR,
                authmechanism: super::super::Foundation::PWSTR,
                cred: *const LDAP_BERVAL,
                serverctrls: *mut *mut ldapcontrolW,
                clientctrls: *mut *mut ldapcontrolW,
                messagenumber: *mut i32,
        ...
        ::std::mem::transmute(ldap_sasl_bindW(
            ::std::mem::transmute(externalhandle),
            distname.into_param().abi(),
            authmechanism.into_param().abi(),
            ::std::mem::transmute(cred),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_sasl_bind_sA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_sasl_bind_sA(
            ::std::mem::transmute(externalhandle),
            distname.into_param().abi(),
            authmechanism.into_param().abi(),
            ::std::mem::transmute(cred),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_sasl_bind_sW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_sasl_bind_sW(
            ::std::mem::transmute(externalhandle),
            distname.into_param().abi(),
            authmechanism.into_param().abi(),
            ::std::mem::transmute(cred),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_search(
                ld: *mut ldap,
                base: super::super::Foundation::PSTR,
                scope: u32,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_searchA(
            ::std::mem::transmute(ld),
            base.into_param().abi(),
            ::std::mem::transmute(scope),
            filter.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_searchW(
                ld: *mut ldap,
                base: super::super::Foundation::PWSTR,
                scope: u32,
        ...
        ::std::mem::transmute(ldap_searchW(
            ::std::mem::transmute(ld),
            base.into_param().abi(),
            ::std::mem::transmute(scope),
            filter.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_search_abandon_page(
    externalhandle: *mut ldap,
    searchblock: *mut ldapsearch,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_search_abandon_page(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(searchblock),
        ))
    }
...
>(
    ...
    attrs: *const *const i8,
    attrsonly: u32,
    servercontrols: *const *const ldapcontrolA,
    clientcontrols: *const *const ldapcontrolA,
    timelimit: u32,
    sizelimit: u32,
    messagenumber: *mut u32,
) -> u32 {
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_search_extA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_search_extW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    attrs: *const *const u16,
    attrsonly: u32,
    servercontrols: *const *const ldapcontrolW,
    clientcontrols: *const *const ldapcontrolW,
    timelimit: u32,
    sizelimit: u32,
    messagenumber: *mut u32,
) -> u32 {
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_search_ext_s<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_search_ext_sA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_search_ext_sW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_search_init_page<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_search_init_pageA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_search_init_pageW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_search_s(
            ::std::mem::transmute(ld),
            base.into_param().abi(),
            ::std::mem::transmute(scope),
            filter.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_search_sA(
            ::std::mem::transmute(ld),
            base.into_param().abi(),
            ::std::mem::transmute(scope),
            filter.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_search_sW(
            ::std::mem::transmute(ld),
            base.into_param().abi(),
            ::std::mem::transmute(scope),
            filter.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_search_st(
            ::std::mem::transmute(ld),
            base.into_param().abi(),
            ::std::mem::transmute(scope),
            filter.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_search_stA(
            ::std::mem::transmute(ld),
            base.into_param().abi(),
            ::std::mem::transmute(scope),
            filter.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_search_stW(
            ::std::mem::transmute(ld),
            base.into_param().abi(),
            ::std::mem::transmute(scope),
            filter.into_param().abi(),
...
pub unsafe fn ldap_set_dbg_routine(debugprintroutine: ::std::option::Option<DBGPRINT>) {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_set_dbg_routine(::std::mem::transmute(
            debugprintroutine,
        )))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_set_option(
    ld: *mut ldap,
    option: i32,
    invalue: *const ::std::ffi::c_void,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_set_option(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(option),
            ::std::mem::transmute(invalue),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_set_optionW(
    ld: *mut ldap,
    option: i32,
    invalue: *const ::std::ffi::c_void,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_set_optionW(
            ::std::mem::transmute(ld),
            ::std::mem::transmute(option),
            ::std::mem::transmute(invalue),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_simple_bind<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ldap_simple_bind(
                ld: *mut ldap,
                dn: super::super::Foundation::PSTR,
                passwd: super::super::Foundation::PSTR,
            ) -> u32;
        }
        ::std::mem::transmute(ldap_simple_bind(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_simple_bindA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_simple_bindA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            passwd.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_simple_bindW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_simple_bindW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            passwd.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_simple_bind_s<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_simple_bind_s(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            passwd.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_simple_bind_sA<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_simple_bind_sA(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            passwd.into_param().abi(),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_simple_bind_sW<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_simple_bind_sW(
            ::std::mem::transmute(ld),
            dn.into_param().abi(),
            passwd.into_param().abi(),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_sslinit(
            hostname.into_param().abi(),
            ::std::mem::transmute(portnumber),
            ::std::mem::transmute(secure),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_sslinitA(
            hostname.into_param().abi(),
            ::std::mem::transmute(portnumber),
            ::std::mem::transmute(secure),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_sslinitW(
            hostname.into_param().abi(),
            ::std::mem::transmute(portnumber),
            ::std::mem::transmute(secure),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_start_tls_sA(
    externalhandle: *mut ldap,
    serverreturnvalue: *mut u32,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_start_tls_sA(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(serverreturnvalue),
            ::std::mem::transmute(result),
            ::std::mem::transmute(servercontrols),
            ::std::mem::transmute(clientcontrols),
        ))
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_start_tls_sW(
    externalhandle: *mut ldap,
    serverreturnvalue: *mut u32,
    result: *mut *mut LDAPMessage,
    servercontrols: *mut *mut ldapcontrolW,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_start_tls_sW(
            ::std::mem::transmute(externalhandle),
            ::std::mem::transmute(serverreturnvalue),
            ::std::mem::transmute(result),
            ::std::mem::transmute(servercontrols),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_startup(
    version: *mut ldap_version_info,
    instance: *mut super::super::Foundation::HANDLE,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_startup(
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_ufn2dn<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ufn: Param0,
    pdn: *mut super::super::Foundation::PSTR,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_ufn2dn(
            ufn.into_param().abi(),
            ::std::mem::transmute(pdn),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ldap_ufn2dnA(
            ufn.into_param().abi(),
            ::std::mem::transmute(pdn),
        ))
    }
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn ldap_ufn2dnW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ufn: Param0,
    pdn: *mut super::super::Foundation::PWSTR,
) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(ldap_ufn2dnW(
            ufn.into_param().abi(),
            ::std::mem::transmute(pdn),
        ))
    }
...
impl ::std::fmt::Debug for ldap_version_info {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("ldap_version_info")
            .field("lv_size", &self.lv_size)
            .field("lv_major", &self.lv_major)
            .field("lv_minor", &self.lv_minor)
            .finish()
    }
}
impl ::std::cmp::PartialEq for ldap_version_info {
    fn eq(&self, other: &Self) -> bool {
        self.lv_size == other.lv_size
            && self.lv_major == other.lv_major
            && self.lv_minor == other.lv_minor
    }
}
...
impl ::std::cmp::PartialEq for ldapapiinfoA {
    fn eq(&self, other: &Self) -> bool {
        self.ldapai_info_version == other.ldapai_info_version
            ...
            && self.ldapai_protocol_version == other.ldapai_protocol_version
            && self.ldapai_extensions == other.ldapai_extensions
            && self.ldapai_vendor_name == other.ldapai_vendor_name
            && self.ldapai_vendor_version == other.ldapai_vendor_version
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for ldapcontrolA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("ldapcontrolA")
            .field("ldctl_oid", &self.ldctl_oid)
            .field("ldctl_value", &self.ldctl_value)
            .field("ldctl_iscritical", &self.ldctl_iscritical)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for ldapcontrolA {
    fn eq(&self, other: &Self) -> bool {
        self.ldctl_oid == other.ldctl_oid
            && self.ldctl_value == other.ldctl_value
            && self.ldctl_iscritical == other.ldctl_iscritical
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for ldapsortkeyA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("ldapsortkeyA")
            .field("sk_attrtype", &self.sk_attrtype)
            .field("sk_matchruleoid", &self.sk_matchruleoid)
            .field("sk_reverseorder", &self.sk_reverseorder)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for ldapsortkeyA {
    fn eq(&self, other: &Self) -> bool {
        self.sk_attrtype == other.sk_attrtype
            && self.sk_matchruleoid == other.sk_matchruleoid
            && self.sk_reverseorder == other.sk_reverseorder
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::cmp::PartialEq for ldapvlvinfo {
    fn eq(&self, other: &Self) -> bool {
        self.ldvlv_version == other.ldvlv_version
            && self.ldvlv_before_count == other.ldvlv_before_count
            && self.ldvlv_after_count == other.ldvlv_after_count
            && self.ldvlv_offset == other.ldvlv_offset
            && self.ldvlv_count == other.ldvlv_count
            && self.ldvlv_attrvalue == other.ldvlv_attrvalue
            && self.ldvlv_context == other.ldvlv_context
            && self.ldvlv_extradata == other.ldvlv_extradata
    }
}
#[cfg(feature = "Win32_Foundation")]
