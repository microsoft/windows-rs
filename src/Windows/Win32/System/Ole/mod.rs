...
impl IAdviseSinkEx {
    ...
    pub unsafe fn OnDataChange(
        &self,
        pformatetc: *const super::Com::FORMATETC,
        pstgmed: *const super::Com::STGMEDIUM,
    ) {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn OnRename<'a, Param0: ::windows::runtime::IntoParam<'a, super::Com::IMoniker>>(
        &self,
        pmk: Param0,
    ) {
...
impl<'a> ::windows::runtime::IntoParam<'a, super::Com::IAdviseSink> for IAdviseSinkEx {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Com::IAdviseSink> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<super::Com::IAdviseSink>::into(
            self,
        ))
    }
}
...
pub struct IAdviseSinkEx_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pformatetc: *const super::Com::FORMATETC,
        pstgmed: *const ::std::mem::ManuallyDrop<super::Com::STGMEDIUM>,
    ),
    #[cfg(not(all(
        feature = "Win32_Foundation",
        feature = "Win32_Graphics_Gdi",
...
impl<'a> ::windows::runtime::IntoParam<'a, super::Com::IClassFactory> for IClassFactory2 {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::Com::IClassFactory> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<super::Com::IClassFactory>::into(
            self,
        ))
    }
}
...
impl IFont {
    ...
    pub unsafe fn Size(&self) -> ::windows::runtime::Result<super::Com::CY> {
        ...
        .from_abi::<super::Com::CY>(result__)
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SetSize<'a, Param0: ::windows::runtime::IntoParam<'a, super::Com::CY>>(
        &self,
        size: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(
...
impl IFontDisp {
    ...
    pub unsafe fn GetTypeInfo(
        ...
        itinfo: u32,
        lcid: u32,
    ) -> ::windows::runtime::Result<Automation::ITypeInfo> {
        let mut result__: <Automation::ITypeInfo as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
        ...
        .from_abi::<Automation::ITypeInfo>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub unsafe fn Invoke(
        ...
        lcid: u32,
        wflags: u16,
        pdispparams: *const Automation::DISPPARAMS,
        pvarresult: *mut super::Com::VARIANT,
        pexcepinfo: *mut Automation::EXCEPINFO,
        puargerr: *mut u32,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, Automation::IDispatch> for &IFontDisp {
    fn into_param(self) -> ::windows::runtime::Param<'a, Automation::IDispatch> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<Automation::IDispatch>::into(
            ::std::clone::Clone::clone(self),
        ))
    }
}
...
pub struct IFontDisp_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        pexcepinfo: *mut ::std::mem::ManuallyDrop<Automation::EXCEPINFO>,
        puargerr: *mut u32,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Foundation",
...
impl IOleAdviseHolder {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Advise<'a, Param0: ::windows::runtime::IntoParam<'a, super::Com::IAdviseSink>>(
        &self,
        padvise: Param0,
    ...
    pub unsafe fn EnumAdvise(&self) -> ::windows::runtime::Result<super::Com::IEnumSTATDATA> {
        let mut result__: <super::Com::IEnumSTATDATA as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<super::Com::IEnumSTATDATA>(result__)
    }
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SendOnRename<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Com::IMoniker>,
    >(
        &self,
        pmk: Param0,
    ) -> ::windows::runtime::Result<()> {
...
impl IOleCache {
    ...
    >(
        &self,
        pformatetc: *const super::Com::FORMATETC,
        pmedium: *const super::Com::STGMEDIUM,
        frelease: Param2,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
...
pub struct IOleCache_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pformatetc: *const super::Com::FORMATETC,
        pmedium: *const ::std::mem::ManuallyDrop<super::Com::STGMEDIUM>,
...
impl IOleCacheControl {
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn OnRun<'a, Param0: ::windows::runtime::IntoParam<'a, super::Com::IDataObject>>(
        &self,
        pdataobject: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
...
impl IOleClientSite {
    ...
    pub unsafe fn GetMoniker(
        ...
        dwassign: u32,
        dwwhichmoniker: u32,
    ) -> ::windows::runtime::Result<super::Com::IMoniker> {
...
impl IOleCommandTarget {
    ...
    pub unsafe fn Exec(
        ...
        ncmdid: u32,
        ncmdexecopt: u32,
        pvain: *const super::Com::VARIANT,
        pvaout: *mut super::Com::VARIANT,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(pguidcmdgroup),
...
pub struct IOleCommandTarget_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        ncmdid: u32,
        ncmdexecopt: u32,
        pvain: *const ::std::mem::ManuallyDrop<super::Com::VARIANT>,
        pvaout: *mut ::std::mem::ManuallyDrop<super::Com::VARIANT>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Foundation",
        feature = "Win32_System_Com",
...
impl IOleContainer {
    ...
    pub unsafe fn ParseDisplayName<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Com::IBindCtx>,
    ...
    >(
        ...
        pcheaten: *mut u32,
        ppmkout: *mut ::std::option::Option<super::Com::IMoniker>,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            pbc.into_param().abi(),
...
impl IOleControlSite {
    ...
    pub unsafe fn GetExtendedControl(&self) -> ::windows::runtime::Result<Automation::IDispatch> {
        let mut result__: <Automation::IDispatch as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<Automation::IDispatch>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
...
impl IOleItemContainer {
    ...
    pub unsafe fn GetObject<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
        Param2: ::windows::runtime::IntoParam<'a, super::Com::IBindCtx>,
        T: ::windows::runtime::Interface,
    >(
        &self,
        pszitem: Param0,
...
impl IOleLink {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SetSourceMoniker<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Com::IMoniker>,
    >(
        &self,
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Update<'a, Param0: ::windows::runtime::IntoParam<'a, super::Com::IBindCtx>>(
        &self,
        pbc: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).13)(
...
impl IPersistPropertyBag {
    ...
    pub unsafe fn Load<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, Automation::IPropertyBag>,
        Param1: ::windows::runtime::IntoParam<'a, Automation::IErrorLog>,
    >(
        &self,
        ppropbag: Param0,
        perrorlog: Param1,
...
impl IPersistStreamInit {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn Load<'a, Param0: ::windows::runtime::IntoParam<'a, super::Com::IStream>>(
        &self,
        pstm: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
...
impl IPrint {
    ...
    pub unsafe fn Print<'a, Param4: ::windows::runtime::IntoParam<'a, IContinueCallback>>(
        &self,
        grfflags: u32,
        pptd: *mut *mut super::Com::DVTARGETDEVICE,
        pppageset: *mut *mut PAGESET,
        pstgmoptions: *mut super::Com::STGMEDIUM,
        pcallback: Param4,
        nfirstpage: i32,
...
pub struct IPrint_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        pptd: *mut *mut super::Com::DVTARGETDEVICE,
        pppageset: *mut *mut PAGESET,
        pstgmoptions: *mut ::std::mem::ManuallyDrop<super::Com::STGMEDIUM>,
...
impl IPropertyBag2 {
    ...
    pub unsafe fn Read<'a, Param2: ::windows::runtime::IntoParam<'a, Automation::IErrorLog>>(
        &self,
        cproperties: u32,
        ppropbag: *const PROPBAG2,
        perrlog: Param2,
        pvarvalue: *mut super::Com::VARIANT,
    ...
    pub unsafe fn Write(
        ...
        cproperties: u32,
        ppropbag: *const PROPBAG2,
        pvarvalue: *const super::Com::VARIANT,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(cproperties),
    ...
    pub unsafe fn LoadObject<
        ...
        Param3: ::windows::runtime::IntoParam<'a, Automation::IErrorLog>,
    >(
        &self,
        pstrname: Param0,
        dwhint: u32,
...
pub struct IPropertyBag2_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        ppropbag: *const PROPBAG2,
        perrlog: ::windows::runtime::RawPtr,
        pvarvalue: *mut ::std::mem::ManuallyDrop<super::Com::VARIANT>,
        phrerror: *mut ::windows::runtime::HRESULT,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Foundation",
    ...
    pub  unsafe extern "system" fn(
        ...
        cproperties: u32,
        ppropbag: *const PROPBAG2,
        pvarvalue: *const ::std::mem::ManuallyDrop<super::Com::VARIANT>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Foundation",
        feature = "Win32_System_Com",
...
impl IProvideMultipleClassInfo {
    ...
    pub unsafe fn GetInfoOfIndex(
        ...
        ppticoclass: *mut ::std::option::Option<Automation::ITypeInfo>,
        pdwtiflags: *mut u32,
...
pub struct IVBFormat_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        vdata: *mut ::std::mem::ManuallyDrop<super::Com::VARIANT>,
...
impl IViewObject {
    ...
    #[cfg(feature = "Win32_System_Com")]
    pub unsafe fn SetAdvise<
        'a,
        Param2: ::windows::runtime::IntoParam<'a, super::Com::IAdviseSink>,
    >(
        &self,
        aspects: u32,
        advf: u32,
    ...
    pub unsafe fn GetAdvise(
        ...
        paspects: *mut u32,
        padvf: *mut u32,
        ppadvsink: *mut ::std::option::Option<super::Com::IAdviseSink>,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
...
#[cfg(all(
    feature = "Win32_Foundation",
    feature = "Win32_System_LibraryLoader",
    feature = "Win32_UI_Controls_Dialogs"
))]
...
pub unsafe fn OleCreate<
    ...
    Param5: ::windows::runtime::IntoParam<'a, super::Com::StructuredStorage::IStorage>,
>(
    rclsid: *const ::windows::runtime::GUID,
    riid: *const ::windows::runtime::GUID,
    renderopt: u32,
    pformatetc: *mut super::Com::FORMATETC,
    pclientsite: Param4,
    pstg: Param5,
    ppvobj: *mut *mut ::std::ffi::c_void,
) -> ::windows::runtime::Result<()> {
...
pub unsafe fn OleCreateEmbeddingHelper<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>,
    Param3: ::windows::runtime::IntoParam<'a, super::Com::IClassFactory>,
>(
    clsid: *const ::windows::runtime::GUID,
    punkouter: Param1,
    flags: u32,
...
pub unsafe fn OleCreateEx<
    'a,
    Param7: ::windows::runtime::IntoParam<'a, super::Com::IAdviseSink>,
    Param9: ::windows::runtime::IntoParam<'a, IOleClientSite>,
    Param10: ::windows::runtime::IntoParam<'a, super::Com::StructuredStorage::IStorage>,
>(
    rclsid: *const ::windows::runtime::GUID,
    riid: *const ::windows::runtime::GUID,
    dwflags: u32,
...
pub unsafe fn OleCreateFromFile<
    ...
    Param6: ::windows::runtime::IntoParam<'a, super::Com::StructuredStorage::IStorage>,
>(
    rclsid: *const ::windows::runtime::GUID,
    lpszfilename: Param1,
    riid: *const ::windows::runtime::GUID,
...
pub unsafe fn OleCreateFromFileEx<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param8: ::windows::runtime::IntoParam<'a, super::Com::IAdviseSink>,
    Param10: ::windows::runtime::IntoParam<'a, IOleClientSite>,
    Param11: ::windows::runtime::IntoParam<'a, super::Com::StructuredStorage::IStorage>,
>(
    rclsid: *const ::windows::runtime::GUID,
    lpszfilename: Param1,
    riid: *const ::windows::runtime::GUID,
...
pub unsafe fn OleDoAutoConvert<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Com::StructuredStorage::IStorage>,
>(
    pstg: Param0,
...
pub unsafe fn OleGetClipboardWithEnterpriseInfo(
    dataobject: *mut ::std::option::Option<super::Com::IDataObject>,
...
#[cfg(feature = "Win32_System_Com")]
pub unsafe fn OleIsCurrentClipboard<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Com::IDataObject>,
>(
    pdataobj: Param0,
...
pub unsafe fn OleLoadPictureFile<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Com::VARIANT>,
>(
    varfilename: Param0,
) -> ::windows::runtime::Result<Automation::IDispatch> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn OleLoadPictureFile(
                varfilename: ::std::mem::ManuallyDrop<super::Com::VARIANT>,
...
pub unsafe fn OleLoadPictureFileEx<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Com::VARIANT>,
>(
    varfilename: Param0,
...
#[cfg(feature = "Win32_System_Com")]
pub unsafe fn OleQueryCreateFromData<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Com::IDataObject>,
>(
...
#[cfg(feature = "Win32_System_Com")]
pub unsafe fn OleQueryLinkFromData<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Com::IDataObject>,
>(
    psrcdataobject: Param0,
...
pub unsafe fn OleRegEnumFormatEtc(
    clsid: *const ::windows::runtime::GUID,
    dwdirection: u32,
) -> ::windows::runtime::Result<super::Com::IEnumFORMATETC> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        let mut result__: <super::Com::IEnumFORMATETC as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        OleRegEnumFormatEtc(
            ::std::mem::transmute(clsid),
        ...
        .from_abi::<super::Com::IEnumFORMATETC>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub unsafe fn OleSave<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Com::StructuredStorage::IPersistStorage>,
    Param1: ::windows::runtime::IntoParam<'a, super::Com::StructuredStorage::IStorage>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
>(
    pps: Param0,
    pstg: Param1,
...
pub unsafe fn OleSavePictureFile<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, Automation::IDispatch>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::BSTR>,
>(
...
pub unsafe fn OleSaveToStream<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Com::IPersistStream>,
    Param1: ::windows::runtime::IntoParam<'a, super::Com::IStream>,
>(
    ppstm: Param0,
    pstm: Param1,
