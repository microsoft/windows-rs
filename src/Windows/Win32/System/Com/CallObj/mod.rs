...
pub unsafe fn CoGetInterceptorFromTypeInfo<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Ole::Automation::ITypeInfo>,
>(
    iidintercepted: *const ::windows::runtime::GUID,
    punkouter: Param1,
    typeinfo: Param2,
...
impl ICallFrame {
    ...
    pub unsafe fn GetNames(
        &self,
        pwszinterface: *mut super::super::super::Foundation::PWSTR,
        pwszmethod: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::Result<()> {
...
pub struct ICallFrame_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        iparam: u32,
        pvar: *const ::std::mem::ManuallyDrop<super::VARIANT>,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        iparam: u32,
        pvar: *mut ::std::mem::ManuallyDrop<super::VARIANT>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Win32_Foundation", feature = "Win32_System_Ole_Automation")))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct ICallFrameWalker_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        iid: *const ::windows::runtime::GUID,
        ppvinterface: *const *const ::std::ffi::c_void,
        fin: super::super::super::Foundation::BOOL,
...
impl ICallIndirect {
    ...
    pub unsafe fn GetIID(
        &self,
        piid: *mut ::windows::runtime::GUID,
        pfderivesfromidispatch: *mut super::super::super::Foundation::BOOL,
        pcmethod: *mut u32,
        pwszinterface: *mut super::super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::Result<()> {
...
pub struct ICallUnmarshal_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        pbuffer: *const ::std::ffi::c_void,
        cbbuffer: u32,
        fforcebuffercopy: super::super::super::Foundation::BOOL,
        datarep: u32,
        pcontext: *const ::std::mem::ManuallyDrop<CALLFRAME_MARSHALCONTEXT>,
        pcbunmarshalled: *mut u32,
        ppframe: *mut ::windows::runtime::RawPtr,
