...
#[inline]
pub unsafe fn BSTR_UserFree(
    param0: *const u32,
    param1: *const super::super::super::Foundation::BSTR,
) {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn BSTR_UserFree(
                param0: *const u32,
                param1: *const ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
            );
        }
...
pub unsafe fn BSTR_UserMarshal(
    param0: *const u32,
    param1: *mut u8,
    param2: *const super::super::super::Foundation::BSTR,
) -> *mut u8 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn BSTR_UserMarshal(
                param0: *const u32,
                param1: *mut u8,
                param2: *const ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
            ) -> *mut u8;
        }
...
pub unsafe fn BSTR_UserUnmarshal(
    param0: *const u32,
    param1: *const u8,
    param2: *mut super::super::super::Foundation::BSTR,
) -> *mut u8 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn BSTR_UserUnmarshal(
                param0: *const u32,
                param1: *const u8,
                param2: *mut ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
            ) -> *mut u8;
        }
...
impl IMarshalingStream {
    ...
    pub unsafe fn CopyTo<'a, Param0: ::windows::runtime::IntoParam<'a, super::IStream>>(
        &self,
        pstm: Param0,
        cb: u64,
        pcbread: *mut u64,
...
impl<'a> ::windows::runtime::IntoParam<'a, super::IStream> for &IMarshalingStream {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::IStream> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<super::IStream>::into(
            ::std::clone::Clone::clone(self),
        ))
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, super::ISequentialStream> for IMarshalingStream {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::ISequentialStream> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<super::ISequentialStream>::into(
            self,
        ))
    }
}
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn STGMEDIUM_UserFree(
                param0: *const u32,
                param1: *const ::std::mem::ManuallyDrop<super::STGMEDIUM>,
            );
        }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn STGMEDIUM_UserMarshal(
                param0: *const u32,
                param1: *mut u8,
                param2: *const ::std::mem::ManuallyDrop<super::STGMEDIUM>,
            ) -> *mut u8;
        }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn STGMEDIUM_UserUnmarshal(
                param0: *const u32,
                param1: *const u8,
                param2: *mut ::std::mem::ManuallyDrop<super::STGMEDIUM>,
            ) -> *mut u8;
        }
...
pub unsafe fn VARIANT_UserFree(param0: *const u32, param1: *const super::VARIANT) {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn VARIANT_UserFree(
                param0: *const u32,
                param1: *const ::std::mem::ManuallyDrop<super::VARIANT>,
            );
        }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn VARIANT_UserMarshal(
                param0: *const u32,
                param1: *mut u8,
                param2: *const ::std::mem::ManuallyDrop<super::VARIANT>,
            ) -> *mut u8;
        }
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Ole_Automation"))]
#[inline]
pub unsafe fn VARIANT_UserSize(
    param0: *const u32,
    param1: u32,
    param2: *const super::VARIANT,
) -> u32 {
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Ole_Automation"))]
#[inline]
pub unsafe fn VARIANT_UserSize64(
    param0: *const u32,
    param1: u32,
    param2: *const super::VARIANT,
) -> u32 {
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn VARIANT_UserUnmarshal(
                param0: *const u32,
                param1: *const u8,
                param2: *mut ::std::mem::ManuallyDrop<super::VARIANT>,
            ) -> *mut u8;
        }
