...
impl IChannelCredentials {
    ...
    pub unsafe fn SetClientCertificateFromStore<
        ...
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BSTR>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::BSTR>,
        Param3: ::windows::runtime::IntoParam<'a, super::VARIANT>,
    >(
        &self,
...
pub struct IChannelCredentials_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        domain: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        username: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        password: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        impersonationlevel: i32,
        allowntlm: super::super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        storelocation: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        storename: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        findyype: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        findvalue: ::std::mem::ManuallyDrop<super::VARIANT>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Win32_Foundation", feature = "Win32_System_Ole_Automation")))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        subjectname: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        storelocation: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        storename: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        filename: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        password: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        keystorageflags: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Ole_Automation"))]
    pub  unsafe extern "system" fn(
        ...
        storelocation: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        storename: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        findtype: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        findvalue: ::std::mem::ManuallyDrop<super::VARIANT>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Win32_Foundation", feature = "Win32_System_Ole_Automation")))] usize,
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        storelocation: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        revocationmode: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        certificatevalidationmode: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        localissueraddres: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        localissuerbindingtype: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
        localissuerbinding: ::std::mem::ManuallyDrop<super::super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
