...
>(
    ...
    psztitle: Param1,
    pibsccaller: Param2,
) -> ::windows::runtime::Result<IBindStatusCallback> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        let mut result__: <IBindStatusCallback as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        ...
        .from_abi::<IBindStatusCallback>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
impl IMoniker {
    ...
    pub unsafe fn Load<'a, Param0: ::windows::runtime::IntoParam<'a, IStream>>(
        &self,
        pstm: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
    ...
    pub unsafe fn Save<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IStream>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
    >(
        &self,
        pstm: Param0,
