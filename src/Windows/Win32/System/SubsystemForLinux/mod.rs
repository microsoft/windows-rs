...
pub unsafe fn WslConfigureDistribution<
    'a,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        WslConfigureDistribution(
            distributionname.into_param().abi(),
            ::std::mem::transmute(defaultuid),
            ::std::mem::transmute(wsldistributionflags),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn WslGetDistributionConfiguration<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    distributionname: Param0,
    ...
    defaultenvironmentvariables: *mut *mut super::super::Foundation::PSTR,
    ...
    #[cfg(windows)]
    {
        ...
        WslGetDistributionConfiguration(
            distributionname.into_param().abi(),
            ::std::mem::transmute(distributionversion),
            ::std::mem::transmute(defaultuid),
            ::std::mem::transmute(wsldistributionflags),
            ::std::mem::transmute(defaultenvironmentvariables),
            ::std::mem::transmute(defaultenvironmentvariablecount),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(WslIsDistributionRegistered(
            distributionname.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn WslLaunch(
                distributionname: super::super::Foundation::PWSTR,
                command: super::super::Foundation::PWSTR,
                usecurrentworkingdirectory: super::super::Foundation::BOOL,
                stdin: super::super::Foundation::HANDLE,
                stdout: super::super::Foundation::HANDLE,
                stderr: super::super::Foundation::HANDLE,
                process: *mut super::super::Foundation::HANDLE,
            ) -> ::windows::runtime::HRESULT;
        }
        ...
        WslLaunch(
            ...
            usecurrentworkingdirectory.into_param().abi(),
            stdin.into_param().abi(),
            stdout.into_param().abi(),
            stderr.into_param().abi(),
            &mut result__,
        )
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn WslLaunchInteractive<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn WslRegisterDistribution<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    distributionname: Param0,
    targzfilename: Param1,
) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        #[link(name = "api-ms-win-wsl-api-l1-1-0")]
        extern "system" {
            fn WslRegisterDistribution(
                distributionname: super::super::Foundation::PWSTR,
                targzfilename: super::super::Foundation::PWSTR,
            ) -> ::windows::runtime::HRESULT;
        }
        WslRegisterDistribution(
            distributionname.into_param().abi(),
            targzfilename.into_param().abi(),
        )
        .ok()
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn WslUnregisterDistribution<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    distributionname: Param0,
