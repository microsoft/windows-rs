...
impl IWsbApplicationBackupSupport {
    ...
    pub unsafe fn CheckConsistency<
        'a,
    ...
    >(
        ...
        let mut result__: <IWsbApplicationAsync as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            wszwritermetadata.into_param().abi(),
            wszcomponentname.into_param().abi(),
            wszcomponentlogicalpath.into_param().abi(),
            ::std::mem::transmute(cvolumes),
            ::std::mem::transmute(rgwszsourcevolumepath),
            ::std::mem::transmute(rgwszsnapshotvolumepath),
            &mut result__,
        )
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IWsbApplicationBackupSupport
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IWsbApplicationBackupSupport_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        wszwritermetadata: super::super::Foundation::PWSTR,
        wszcomponentname: super::super::Foundation::PWSTR,
        wszcomponentlogicalpath: super::super::Foundation::PWSTR,
        cvolumes: u32,
        rgwszsourcevolumepath: *const super::super::Foundation::PWSTR,
        rgwszsnapshotvolumepath: *const super::super::Foundation::PWSTR,
...
impl IWsbApplicationRestoreSupport {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).3)(
            ...
            wszcomponentname.into_param().abi(),
            wszcomponentlogicalpath.into_param().abi(),
            bnorollforward.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn PostRestore<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    ...
    pub unsafe fn OrderComponents(
        &self,
        ccomponents: u32,
        rgcomponentname: *const super::super::Foundation::PWSTR,
        rgcomponentlogicalpaths: *const super::super::Foundation::PWSTR,
        prgcomponentname: *mut *mut super::super::Foundation::PWSTR,
        prgcomponentlogicalpath: *mut *mut super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(ccomponents),
            ::std::mem::transmute(rgcomponentname),
            ::std::mem::transmute(rgcomponentlogicalpaths),
            ::std::mem::transmute(prgcomponentname),
            ::std::mem::transmute(prgcomponentlogicalpath),
        )
        .ok()
    }
...
unsafe impl ::windows::runtime::Interface for IWsbApplicationRestoreSupport {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        20200,
        18200,
        [133, 249, 199, 219, 196, 171, 119, 170],
    );
}
...
pub struct IWsbApplicationRestoreSupport_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        wszcomponentname: super::super::Foundation::PWSTR,
        wszcomponentlogicalpath: super::super::Foundation::PWSTR,
        bnorollforward: super::super::Foundation::BOOLEAN,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
pub const WSBAPP_ASYNC_IN_PROGRESS: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(7995396i32 as _);
...
impl ::std::cmp::PartialEq for WSB_OB_REGISTRATION_INFO {
    fn eq(&self, other: &Self) -> bool {
        self.m_wszResourceDLL == other.m_wszResourceDLL
            && self.m_guidSnapinId == other.m_guidSnapinId
            && self.m_dwProviderName == other.m_dwProviderName
            && self.m_dwProviderIcon == other.m_dwProviderIcon
            && self.m_bSupportsRemoting == other.m_bSupportsRemoting
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for WSB_OB_STATUS_ENTRY {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WSB_OB_STATUS_ENTRY")
            .field("m_dwIcon", &self.m_dwIcon)
            .field("m_dwStatusEntryName", &self.m_dwStatusEntryName)
            .field("m_dwStatusEntryValue", &self.m_dwStatusEntryValue)
            .field("m_cValueTypePair", &self.m_cValueTypePair)
            .field("m_rgValueTypePair", &self.m_rgValueTypePair)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for WSB_OB_STATUS_ENTRY {
    fn eq(&self, other: &Self) -> bool {
        self.m_dwIcon == other.m_dwIcon
            && self.m_dwStatusEntryName == other.m_dwStatusEntryName
            && self.m_dwStatusEntryValue == other.m_dwStatusEntryValue
            && self.m_cValueTypePair == other.m_cValueTypePair
            && self.m_rgValueTypePair == other.m_rgValueTypePair
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for WSB_OB_STATUS_ENTRY_VALUE_TYPE_PAIR {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WSB_OB_STATUS_ENTRY_VALUE_TYPE_PAIR")
            .field(
                "m_wszObStatusEntryPairValue",
                &self.m_wszObStatusEntryPairValue,
            )
            .field("m_ObStatusEntryPairType", &self.m_ObStatusEntryPairType)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for WSB_OB_STATUS_ENTRY_VALUE_TYPE_PAIR {
    fn eq(&self, other: &Self) -> bool {
        self.m_wszObStatusEntryPairValue == other.m_wszObStatusEntryPairValue
            && self.m_ObStatusEntryPairType == other.m_ObStatusEntryPairType
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for WSB_OB_STATUS_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("WSB_OB_STATUS_INFO")
            .field("m_guidSnapinId", &self.m_guidSnapinId)
            .field("m_cStatusEntry", &self.m_cStatusEntry)
            .field("m_rgStatusEntry", &self.m_rgStatusEntry)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for WSB_OB_STATUS_INFO {
    fn eq(&self, other: &Self) -> bool {
        self.m_guidSnapinId == other.m_guidSnapinId
            && self.m_cStatusEntry == other.m_cStatusEntry
            && self.m_rgStatusEntry == other.m_rgStatusEntry
    }
}
#[cfg(feature = "Win32_Foundation")]
