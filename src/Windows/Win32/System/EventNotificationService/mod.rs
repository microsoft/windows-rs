...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<ISensLogon> for super::OleAutomation::IDispatch {
    fn from(value: ISensLogon) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
}
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::OleAutomation::IDispatch> for ISensLogon {
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<ISensLogon2> for super::OleAutomation::IDispatch {
    fn from(value: ISensLogon2) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
}
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::OleAutomation::IDispatch> for ISensLogon2 {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::OleAutomation::IDispatch> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<super::OleAutomation::IDispatch>::into(self),
        )
...
impl ISensNetwork {
    ...
    >(
        &self,
        bstrconnection: Param0,
        ultype: u32,
        lpqocinfo: *const SENS_QOCINFO,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            bstrconnection.into_param().abi(),
            ::std::mem::transmute(ultype),
            ::std::mem::transmute(lpqocinfo),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<ISensNetwork> for super::OleAutomation::IDispatch {
    fn from(value: ISensNetwork) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
}
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::OleAutomation::IDispatch> for ISensNetwork {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::OleAutomation::IDispatch> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<super::OleAutomation::IDispatch>::into(self),
        )
...
pub struct ISensNetwork_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        bstrconnection: ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
        ultype: u32,
        lpqocinfo: *const SENS_QOCINFO,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
...
impl ISensOnNow {
    ...
    pub unsafe fn OnBatteryPower(
        &self,
        dwbatterylifepercent: u32,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dwbatterylifepercent),
        )
        .ok()
    }
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<ISensOnNow> for super::OleAutomation::IDispatch {
    fn from(value: ISensOnNow) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
}
...
#[cfg(feature = "Win32_System_OleAutomation")]
impl<'a> ::windows::runtime::IntoParam<'a, super::OleAutomation::IDispatch> for ISensOnNow {
    fn into_param(self) -> ::windows::runtime::Param<'a, super::OleAutomation::IDispatch> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<super::OleAutomation::IDispatch>::into(self),
        )
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn IsDestinationReachableA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    lpszdestination: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(IsDestinationReachableA(
            lpszdestination.into_param().abi(),
            ::std::mem::transmute(lpqocinfo),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn IsDestinationReachableW<
    'a,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(IsDestinationReachableW(
            lpszdestination.into_param().abi(),
            ::std::mem::transmute(lpqocinfo),
        ))
    }
...
impl ::std::fmt::Debug for QOCINFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("QOCINFO")
            .field("dwSize", &self.dwSize)
            .field("dwFlags", &self.dwFlags)
            .field("dwInSpeed", &self.dwInSpeed)
            .field("dwOutSpeed", &self.dwOutSpeed)
            .finish()
    }
}
impl ::std::cmp::PartialEq for QOCINFO {
    fn eq(&self, other: &Self) -> bool {
        self.dwSize == other.dwSize
            ...
            && self.dwInSpeed == other.dwInSpeed
            && self.dwOutSpeed == other.dwOutSpeed
    }
}
...
pub const SENS: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3583494910,
    23455,
    4561,
    [141, 210, 0, 170, 0, 74, 189, 94],
);
pub const SENSGUID_EVENTCLASS_LOGON: ::windows::runtime::GUID =
...
pub const SENSGUID_EVENTCLASS_LOGON2: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3583477328,
        23455,
        4561,
...
pub const SENSGUID_EVENTCLASS_NETWORK: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3583477280,
        23455,
        4561,
...
pub const SENSGUID_EVENTCLASS_ONNOW: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3583477312,
        23455,
        4561,
...
pub const SENSGUID_PUBLISHER: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    1609440214,
    23451,
    4561,
    [141, 210, 0, 170, 0, 74, 189, 94],
);
pub const SENSGUID_SUBSCRIBER_LCE: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3549661872,
    23453,
    4561,
    [141, 210, 0, 170, 0, 74, 189, 94],
);
pub const SENSGUID_SUBSCRIBER_WININET: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3549661877,
        23453,
        4561,
