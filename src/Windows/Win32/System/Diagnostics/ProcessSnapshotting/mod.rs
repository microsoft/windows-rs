...
impl ::core::convert::From<u32> for PSS_CAPTURE_FLAGS {
...
impl ::core::convert::From<u32> for PSS_DUPLICATE_FLAGS {
    fn from(value: u32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<u32> for PSS_HANDLE_FLAGS {
    fn from(value: u32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for PSS_OBJECT_TYPE {
...
impl ::core::convert::From<u32> for PSS_PROCESS_FLAGS {
    fn from(value: u32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for PSS_QUERY_INFORMATION_CLASS {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
#[doc = "*Required features: `Win32_System_Diagnostics_ProcessSnapshotting`, `Win32_Foundation`, `Win32_System_Diagnostics_Debug`, `Win32_System_Kernel`, `Win32_System_SystemServices`*"]
...
impl ::core::convert::From<u32> for PSS_THREAD_FLAGS {
    fn from(value: u32) -> Self {
        Self(value)
    }
}
...
impl ::core::convert::From<i32> for PSS_WALK_INFORMATION_CLASS {
    fn from(value: i32) -> Self {
        Self(value)
    }
}
...
#[doc = "*Required features: `Win32_System_Diagnostics_ProcessSnapshotting`*"]
#[inline]
pub unsafe fn PssQuerySnapshot<'a, Param0: ::windows::runtime::IntoParam<'a, HPSS>>(snapshothandle: Param0, informationclass: PSS_QUERY_INFORMATION_CLASS, buffer: *mut ::core::ffi::c_void, bufferlength: u32) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
...
#[doc = "*Required features: `Win32_System_Diagnostics_ProcessSnapshotting`*"]
#[inline]
pub unsafe fn PssWalkSnapshot<'a, Param0: ::windows::runtime::IntoParam<'a, HPSS>, Param2: ::windows::runtime::IntoParam<'a, HPSSWALK>>(snapshothandle: Param0, informationclass: PSS_WALK_INFORMATION_CLASS, walkmarkerhandle: Param2, buffer: *mut ::core::ffi::c_void, bufferlength: u32) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
