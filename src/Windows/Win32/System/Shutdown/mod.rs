...
pub unsafe fn AbortSystemShutdownA<
    'a,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn AbortSystemShutdownW<
    'a,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn CheckForHiberboot<
    'a,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn CheckForHiberboot(
                phiberboot: *mut super::super::Foundation::BOOLEAN,
                bclearflag: super::super::Foundation::BOOLEAN,
            ) -> u32;
        }
        ::std::mem::transmute(CheckForHiberboot(
            ::std::mem::transmute(phiberboot),
            bclearflag.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn ExitWindowsEx(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ExitWindowsEx(
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn InitiateShutdownA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn InitiateShutdownA(
                lpmachinename: super::super::Foundation::PSTR,
                lpmessage: super::super::Foundation::PSTR,
                dwgraceperiod: u32,
                dwshutdownflags: SHUTDOWN_FLAGS,
                dwreason: SHUTDOWN_REASON,
            ) -> u32;
        }
        ::std::mem::transmute(InitiateShutdownA(
            lpmachinename.into_param().abi(),
            lpmessage.into_param().abi(),
            ::std::mem::transmute(dwgraceperiod),
            ::std::mem::transmute(dwshutdownflags),
            ::std::mem::transmute(dwreason),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn InitiateShutdownW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(InitiateShutdownW(
            lpmachinename.into_param().abi(),
            lpmessage.into_param().abi(),
            ::std::mem::transmute(dwgraceperiod),
            ::std::mem::transmute(dwshutdownflags),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn InitiateSystemShutdownA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn InitiateSystemShutdownA(
                ...
                lpmessage: super::super::Foundation::PSTR,
                dwtimeout: u32,
                bforceappsclosed: super::super::Foundation::BOOL,
                brebootaftershutdown: super::super::Foundation::BOOL,
            ) -> super::super::Foundation::BOOL;
        }
        ::std::mem::transmute(InitiateSystemShutdownA(
            lpmachinename.into_param().abi(),
            lpmessage.into_param().abi(),
            ::std::mem::transmute(dwtimeout),
            bforceappsclosed.into_param().abi(),
            brebootaftershutdown.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn InitiateSystemShutdownExA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(InitiateSystemShutdownExA(
            lpmachinename.into_param().abi(),
            lpmessage.into_param().abi(),
            ::std::mem::transmute(dwtimeout),
            bforceappsclosed.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(InitiateSystemShutdownExW(
            lpmachinename.into_param().abi(),
            lpmessage.into_param().abi(),
            ::std::mem::transmute(dwtimeout),
            bforceappsclosed.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn InitiateSystemShutdownW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(InitiateSystemShutdownW(
            lpmachinename.into_param().abi(),
            lpmessage.into_param().abi(),
            ::std::mem::transmute(dwtimeout),
            bforceappsclosed.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn ShutdownBlockReasonCreate<
    'a,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn ShutdownBlockReasonCreate(
                ...
                pwszreason: super::super::Foundation::PWSTR,
            ) -> super::super::Foundation::BOOL;
        }
        ::std::mem::transmute(ShutdownBlockReasonCreate(
            hwnd.into_param().abi(),
            pwszreason.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ShutdownBlockReasonQuery(
            hwnd.into_param().abi(),
            ::std::mem::transmute(pwszbuff),
            ::std::mem::transmute(pcchbuff),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
