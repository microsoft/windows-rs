...
pub unsafe fn RegisterWaitUntilOOBECompleted(
    ...
    waithandle: *mut *mut ::std::ffi::c_void,
) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "kernel32")]
        ...
        ::std::mem::transmute(RegisterWaitUntilOOBECompleted(
            ::std::mem::transmute(oobecompletedcallback),
            ::std::mem::transmute(callbackcontext),
            ::std::mem::transmute(waithandle),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn UnregisterWaitUntilOOBECompleted(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(UnregisterWaitUntilOOBECompleted(::std::mem::transmute(
            waithandle,
        )))
    }
    #[cfg(not(windows))]
