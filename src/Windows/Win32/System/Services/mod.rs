...
pub const CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        762980374,
        3166,
        17916,
        [156, 231, 87, 14, 94, 205, 233, 201],
    );
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn ChangeServiceConfig2A<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hservice: Param0,
    dwinfolevel: SERVICE_CONFIG,
    lpinfo: *const ::std::ffi::c_void,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ChangeServiceConfig2A(
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ChangeServiceConfig2W(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwinfolevel),
            ::std::mem::transmute(lpinfo),
        ))
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn CloseServiceHandle<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hscobject: Param0,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ControlService(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwcontrol),
            ::std::mem::transmute(lpservicestatus),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn ControlServiceExA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hservice: Param0,
    dwcontrol: u32,
    dwinfolevel: u32,
    pcontrolparams: *mut ::std::ffi::c_void,
) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "advapi32")]
        ...
        ::std::mem::transmute(ControlServiceExA(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwcontrol),
            ::std::mem::transmute(dwinfolevel),
            ::std::mem::transmute(pcontrolparams),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn ControlServiceExW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hservice: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(ControlServiceExW(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwcontrol),
            ::std::mem::transmute(dwinfolevel),
            ::std::mem::transmute(pcontrolparams),
...
pub const DOMAIN_JOIN_GUID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    484575930,
    38993,
    17441,
    [148, 48, 29, 222, 183, 102, 232, 9],
);
pub const DOMAIN_LEAVE_GUID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3719254382,
    22722,
    18534,
...
impl ::std::fmt::Debug for ENUM_SERVICE_STATUSA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("ENUM_SERVICE_STATUSA")
...
impl ::std::cmp::PartialEq for ENUM_SERVICE_STATUSA {
    fn eq(&self, other: &Self) -> bool {
        self.lpServiceName == other.lpServiceName
            ...
            && self.ServiceStatus == other.ServiceStatus
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for ENUM_SERVICE_STATUSW {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("ENUM_SERVICE_STATUSW")
            .field("lpServiceName", &self.lpServiceName)
            .field("lpDisplayName", &self.lpDisplayName)
            .field("ServiceStatus", &self.ServiceStatus)
            .finish()
...
impl ::std::fmt::Debug for ENUM_SERVICE_STATUS_PROCESSA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("ENUM_SERVICE_STATUS_PROCESSA")
            .field("lpServiceName", &self.lpServiceName)
            .field("lpDisplayName", &self.lpDisplayName)
            .field("ServiceStatusProcess", &self.ServiceStatusProcess)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for ENUM_SERVICE_STATUS_PROCESSA {
    fn eq(&self, other: &Self) -> bool {
        self.lpServiceName == other.lpServiceName
            && self.lpDisplayName == other.lpDisplayName
            && self.ServiceStatusProcess == other.ServiceStatusProcess
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for ENUM_SERVICE_STATUS_PROCESSW {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("ENUM_SERVICE_STATUS_PROCESSW")
            .field("lpServiceName", &self.lpServiceName)
            .field("lpDisplayName", &self.lpDisplayName)
            .field("ServiceStatusProcess", &self.ServiceStatusProcess)
            .finish()
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn EnumDependentServicesA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hservice: Param0,
    dwservicestate: ENUM_SERVICE_STATE,
    lpservices: *mut ENUM_SERVICE_STATUSA,
    cbbufsize: u32,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(EnumDependentServicesA(
            hservice.into_param().abi(),
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn EnumDependentServicesW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hservice: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(EnumDependentServicesW(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwservicestate),
            ::std::mem::transmute(lpservices),
            ::std::mem::transmute(cbbufsize),
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn EnumServicesStatusExA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
    Param9: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn EnumServicesStatusExA(
                ...
                lpservicesreturned: *mut u32,
                lpresumehandle: *mut u32,
                pszgroupname: super::super::Foundation::PSTR,
            ) -> super::super::Foundation::BOOL;
        }
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn EnumServicesStatusExW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
    Param9: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn EnumServicesStatusExW(
                ...
                lpservicesreturned: *mut u32,
                lpresumehandle: *mut u32,
                pszgroupname: super::super::Foundation::PWSTR,
            ) -> super::super::Foundation::BOOL;
        }
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn EnumServicesStatusW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hscmanager: Param0,
...
pub const FIREWALL_PORT_CLOSE_GUID: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        2705648952,
        36370,
        19940,
...
pub const FIREWALL_PORT_OPEN_GUID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    3075907079,
    33825,
    20192,
    [173, 16, 134, 145, 90, 253, 173, 9],
);
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn GetServiceDirectory<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, SERVICE_STATUS_HANDLE>,
>(
    hservicestatus: Param0,
    edirectorytype: SERVICE_DIRECTORY_TYPE,
    lppathbuffer: super::super::Foundation::PWSTR,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetServiceDirectory(
            hservicestatus.into_param().abi(),
            ::std::mem::transmute(edirectorytype),
            ::std::mem::transmute(lppathbuffer),
            ::std::mem::transmute(cchpathbufferlength),
            ::std::mem::transmute(lpcchrequiredbufferlength),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn GetServiceDisplayNameA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetServiceDisplayNameA(
            hscmanager.into_param().abi(),
            lpservicename.into_param().abi(),
            ::std::mem::transmute(lpdisplayname),
            ::std::mem::transmute(lpcchbuffer),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn GetServiceDisplayNameW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetServiceDisplayNameW(
            hscmanager.into_param().abi(),
            lpservicename.into_param().abi(),
            ::std::mem::transmute(lpdisplayname),
            ::std::mem::transmute(lpcchbuffer),
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn GetServiceKeyNameA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    hscmanager: Param0,
    lpdisplayname: Param1,
    lpservicename: super::super::Foundation::PSTR,
    lpcchbuffer: *mut u32,
) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetServiceKeyNameA(
            hscmanager.into_param().abi(),
            lpdisplayname.into_param().abi(),
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn GetServiceKeyNameW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetServiceKeyNameW(
            hscmanager.into_param().abi(),
            lpdisplayname.into_param().abi(),
            ::std::mem::transmute(lpservicename),
            ::std::mem::transmute(lpcchbuffer),
...
pub unsafe fn GetServiceRegistryStateKey<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, SERVICE_STATUS_HANDLE>,
>(
    servicestatushandle: Param0,
    statetype: SERVICE_REGISTRY_STATE_TYPE,
    accessmask: u32,
    servicestatekey: *mut super::Registry::HKEY,
) -> u32 {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetServiceRegistryStateKey(
            servicestatushandle.into_param().abi(),
            ::std::mem::transmute(statetype),
            ::std::mem::transmute(accessmask),
            ::std::mem::transmute(servicestatekey),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn GetSharedServiceDirectory<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetSharedServiceDirectory(
            servicehandle.into_param().abi(),
            ::std::mem::transmute(directorytype),
            ::std::mem::transmute(pathbuffer),
            ::std::mem::transmute(pathbufferlength),
            ::std::mem::transmute(requiredbufferlength),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(GetSharedServiceRegistryStateKey(
            servicehandle.into_param().abi(),
            ::std::mem::transmute(statetype),
            ::std::mem::transmute(accessmask),
            ::std::mem::transmute(servicestatekey),
...
pub type HANDLER_FUNCTION_EX = unsafe extern "system" fn(
    dwcontrol: u32,
    dweventtype: u32,
    lpeventdata: *mut ::std::ffi::c_void,
...
pub type LPSERVICE_MAIN_FUNCTIONA = unsafe extern "system" fn(
    ...
    lpserviceargvectors: *mut super::super::Foundation::PSTR,
);
#[cfg(feature = "Win32_Foundation")]
pub type LPSERVICE_MAIN_FUNCTIONW = unsafe extern "system" fn(
    dwnumservicesargs: u32,
    lpserviceargvectors: *mut super::super::Foundation::PWSTR,
);
#[cfg(feature = "Win32_Security")]
pub unsafe fn LockServiceDatabase<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hscmanager: Param0,
...
pub const MACHINE_POLICY_PRESENT_GUID: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        1704970982,
        23515,
        19881,
...
pub const NAMED_PIPE_EVENT_GUID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    528601393,
    16300,
    17719,
    [158, 12, 126, 123, 12, 47, 75, 85],
);
pub const NETWORK_MANAGER_FIRST_IP_ADDRESS_ARRIVAL_GUID: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        1328018142,
        5346,
        17163,
...
pub const NETWORK_MANAGER_LAST_IP_ADDRESS_REMOVAL_GUID: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3427509802,
        5678,
        17992,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn NotifyServiceStatusChangeA(
                hservice: super::super::Security::SC_HANDLE,
                dwnotifymask: SERVICE_NOTIFY,
                pnotifybuffer: *const ::std::mem::ManuallyDrop<SERVICE_NOTIFY_2A>,
            ) -> u32;
        }
        ::std::mem::transmute(NotifyServiceStatusChangeA(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwnotifymask),
            ::std::mem::transmute(pnotifybuffer),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn NotifyServiceStatusChangeW(
                hservice: super::super::Security::SC_HANDLE,
                dwnotifymask: SERVICE_NOTIFY,
                pnotifybuffer: *const ::std::mem::ManuallyDrop<SERVICE_NOTIFY_2W>,
            ) -> u32;
        }
        ::std::mem::transmute(NotifyServiceStatusChangeW(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwnotifymask),
            ::std::mem::transmute(pnotifybuffer),
        ))
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn OpenSCManagerA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
    Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    lpmachinename: Param0,
    lpdatabasename: Param1,
    dwdesiredaccess: u32,
) -> super::super::Security::SC_HANDLE {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn OpenSCManagerA(
                ...
                lpdatabasename: super::super::Foundation::PSTR,
                dwdesiredaccess: u32,
            ) -> super::super::Security::SC_HANDLE;
        }
        ::std::mem::transmute(OpenSCManagerA(
            lpmachinename.into_param().abi(),
            lpdatabasename.into_param().abi(),
            ::std::mem::transmute(dwdesiredaccess),
        ))
    }
    #[cfg(not(windows))]
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn OpenSCManagerW(
                ...
                lpdatabasename: super::super::Foundation::PWSTR,
                dwdesiredaccess: u32,
            ) -> super::super::Security::SC_HANDLE;
        }
        ::std::mem::transmute(OpenSCManagerW(
            lpmachinename.into_param().abi(),
            lpdatabasename.into_param().abi(),
            ::std::mem::transmute(dwdesiredaccess),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(OpenServiceA(
            hscmanager.into_param().abi(),
            lpservicename.into_param().abi(),
            ::std::mem::transmute(dwdesiredaccess),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(OpenServiceW(
            hscmanager.into_param().abi(),
            lpservicename.into_param().abi(),
            ::std::mem::transmute(dwdesiredaccess),
        ))
...
pub type PSC_NOTIFICATION_CALLBACK =
    unsafe extern "system" fn(dwnotify: u32, pcallbackcontext: *const ::std::ffi::c_void);
#[derive(:: std :: clone :: Clone, :: std :: marker :: Copy)]
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::cmp::PartialEq for QUERY_SERVICE_CONFIGA {
    fn eq(&self, other: &Self) -> bool {
        self.dwServiceType == other.dwServiceType
            && self.dwStartType == other.dwStartType
            && self.dwErrorControl == other.dwErrorControl
            && self.lpBinaryPathName == other.lpBinaryPathName
            && self.lpLoadOrderGroup == other.lpLoadOrderGroup
            && self.dwTagId == other.dwTagId
            && self.lpDependencies == other.lpDependencies
            && self.lpServiceStartName == other.lpServiceStartName
            && self.lpDisplayName == other.lpDisplayName
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for QUERY_SERVICE_LOCK_STATUSA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("QUERY_SERVICE_LOCK_STATUSA")
            .field("fIsLocked", &self.fIsLocked)
            .field("lpLockOwner", &self.lpLockOwner)
            .field("dwLockDuration", &self.dwLockDuration)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for QUERY_SERVICE_LOCK_STATUSA {
    fn eq(&self, other: &Self) -> bool {
        self.fIsLocked == other.fIsLocked
            && self.lpLockOwner == other.lpLockOwner
            && self.dwLockDuration == other.dwLockDuration
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for QUERY_SERVICE_LOCK_STATUSW {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("QUERY_SERVICE_LOCK_STATUSW")
            .field("fIsLocked", &self.fIsLocked)
            .field("lpLockOwner", &self.lpLockOwner)
            .field("dwLockDuration", &self.dwLockDuration)
            .finish()
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn QueryServiceConfig2A<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hservice: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(QueryServiceConfig2A(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwinfolevel),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(QueryServiceConfig2W(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwinfolevel),
            ::std::mem::transmute(lpbuffer),
            ::std::mem::transmute(cbbufsize),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(QueryServiceConfigA(
            hservice.into_param().abi(),
            ::std::mem::transmute(lpserviceconfig),
            ::std::mem::transmute(cbbufsize),
            ::std::mem::transmute(pcbbytesneeded),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(QueryServiceConfigW(
            hservice.into_param().abi(),
            ::std::mem::transmute(lpserviceconfig),
            ::std::mem::transmute(cbbufsize),
            ::std::mem::transmute(pcbbytesneeded),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn QueryServiceDynamicInformation<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, SERVICE_STATUS_HANDLE>,
>(
    hservicestatus: Param0,
    dwinfolevel: u32,
    ppdynamicinfo: *mut *mut ::std::ffi::c_void,
) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "advapi32")]
        ...
        ::std::mem::transmute(QueryServiceDynamicInformation(
            hservicestatus.into_param().abi(),
            ::std::mem::transmute(dwinfolevel),
            ::std::mem::transmute(ppdynamicinfo),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn QueryServiceLockStatusA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hscmanager: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(QueryServiceLockStatusA(
            hscmanager.into_param().abi(),
            ::std::mem::transmute(lplockstatus),
            ::std::mem::transmute(cbbufsize),
            ::std::mem::transmute(pcbbytesneeded),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(QueryServiceLockStatusW(
            hscmanager.into_param().abi(),
            ::std::mem::transmute(lplockstatus),
            ::std::mem::transmute(cbbufsize),
            ::std::mem::transmute(pcbbytesneeded),
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn QueryServiceObjectSecurity<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hservice: Param0,
    dwsecurityinformation: u32,
    lpsecuritydescriptor: *mut super::super::Security::SECURITY_DESCRIPTOR,
    cbbufsize: u32,
    pcbbytesneeded: *mut u32,
) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(QueryServiceObjectSecurity(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwsecurityinformation),
            ::std::mem::transmute(lpsecuritydescriptor),
            ::std::mem::transmute(cbbufsize),
            ::std::mem::transmute(pcbbytesneeded),
        ))
    }
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn QueryServiceStatus<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hservice: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(QueryServiceStatus(
            hservice.into_param().abi(),
            ::std::mem::transmute(lpservicestatus),
        ))
    }
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(QueryServiceStatusEx(
            hservice.into_param().abi(),
            ::std::mem::transmute(infolevel),
            ::std::mem::transmute(lpbuffer),
            ::std::mem::transmute(cbbufsize),
...
pub const RPC_INTERFACE_EVENT_GUID: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        3163607399,
        38000,
        16697,
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn RegisterServiceCtrlHandlerA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    lpservicename: Param0,
    lphandlerproc: ::std::option::Option<LPHANDLER_FUNCTION>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn RegisterServiceCtrlHandlerA(
                lpservicename: super::super::Foundation::PSTR,
                lphandlerproc: ::windows::runtime::RawPtr,
            ) -> SERVICE_STATUS_HANDLE;
        }
        ::std::mem::transmute(RegisterServiceCtrlHandlerA(
            lpservicename.into_param().abi(),
            ::std::mem::transmute(lphandlerproc),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn RegisterServiceCtrlHandlerExA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PSTR>,
>(
    lpservicename: Param0,
    lphandlerproc: ::std::option::Option<LPHANDLER_FUNCTION_EX>,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(RegisterServiceCtrlHandlerExA(
            lpservicename.into_param().abi(),
            ::std::mem::transmute(lphandlerproc),
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn RegisterServiceCtrlHandlerExW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    lpservicename: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(RegisterServiceCtrlHandlerExW(
            lpservicename.into_param().abi(),
            ::std::mem::transmute(lphandlerproc),
            ::std::mem::transmute(lpcontext),
        ))
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn RegisterServiceCtrlHandlerW<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    lpservicename: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(RegisterServiceCtrlHandlerW(
            lpservicename.into_param().abi(),
            ::std::mem::transmute(lphandlerproc),
        ))
    }
...
impl ::std::fmt::Debug for SERVICE_CONTROL_STATUS_REASON_PARAMSA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_CONTROL_STATUS_REASON_PARAMSA")
            .field("dwReason", &self.dwReason)
            .field("pszComment", &self.pszComment)
            .field("ServiceStatus", &self.ServiceStatus)
            .finish()
    }
}
...
impl ::std::cmp::PartialEq for SERVICE_CONTROL_STATUS_REASON_PARAMSA {
    fn eq(&self, other: &Self) -> bool {
        self.dwReason == other.dwReason
            && self.pszComment == other.pszComment
            && self.ServiceStatus == other.ServiceStatus
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for SERVICE_CONTROL_STATUS_REASON_PARAMSW {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_CONTROL_STATUS_REASON_PARAMSW")
            .field("dwReason", &self.dwReason)
            .field("pszComment", &self.pszComment)
            .field("ServiceStatus", &self.ServiceStatus)
            .finish()
...
impl ::std::fmt::Debug for SERVICE_DELAYED_AUTO_START_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_DELAYED_AUTO_START_INFO")
            .field("fDelayedAutostart", &self.fDelayedAutostart)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for SERVICE_DESCRIPTIONA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_DESCRIPTIONA")
            .field("lpDescription", &self.lpDescription)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for SERVICE_DESCRIPTIONW {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_DESCRIPTIONW")
            .field("lpDescription", &self.lpDescription)
            .finish()
    }
}
...
impl ::std::fmt::Debug for SERVICE_FAILURE_ACTIONSA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_FAILURE_ACTIONSA")
            .field("dwResetPeriod", &self.dwResetPeriod)
            .field("lpRebootMsg", &self.lpRebootMsg)
            .field("lpCommand", &self.lpCommand)
            .field("cActions", &self.cActions)
            .field("lpsaActions", &self.lpsaActions)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
impl ::std::cmp::PartialEq for SERVICE_FAILURE_ACTIONSA {
    fn eq(&self, other: &Self) -> bool {
        self.dwResetPeriod == other.dwResetPeriod
            && self.lpRebootMsg == other.lpRebootMsg
            && self.lpCommand == other.lpCommand
            && self.cActions == other.cActions
            && self.lpsaActions == other.lpsaActions
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for SERVICE_FAILURE_ACTIONSW {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_FAILURE_ACTIONSW")
            .field("dwResetPeriod", &self.dwResetPeriod)
            .field("lpRebootMsg", &self.lpRebootMsg)
            .field("lpCommand", &self.lpCommand)
            .field("cActions", &self.cActions)
...
impl ::std::fmt::Debug for SERVICE_FAILURE_ACTIONS_FLAG {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_FAILURE_ACTIONS_FLAG")
            .field(
                "fFailureActionsOnNonCrashFailures",
                &self.fFailureActionsOnNonCrashFailures,
            )
            .finish()
    }
}
...
impl ::std::fmt::Debug for SERVICE_LAUNCH_PROTECTED_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_LAUNCH_PROTECTED_INFO")
            .field("dwLaunchProtected", &self.dwLaunchProtected)
            .finish()
    }
}
...
pub type SERVICE_MAIN_FUNCTIONA =
    unsafe extern "system" fn(dwnumservicesargs: u32, lpserviceargvectors: *mut *mut i8);
#[cfg(feature = "Win32_Foundation")]
pub type SERVICE_MAIN_FUNCTIONW = unsafe extern "system" fn(
    dwnumservicesargs: u32,
    lpserviceargvectors: *mut super::super::Foundation::PWSTR,
);
#[derive(
...
impl ::std::fmt::Debug for SERVICE_NOTIFY_1 {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_NOTIFY_1")
...
impl ::std::cmp::PartialEq for SERVICE_NOTIFY_1 {
    fn eq(&self, other: &Self) -> bool {
        self.dwVersion == other.dwVersion
            && self.pfnNotifyCallback.map(|f| f as usize)
                == other.pfnNotifyCallback.map(|f| f as usize)
            && self.pContext == other.pContext
            && self.dwNotificationStatus == other.dwNotificationStatus
            && self.ServiceStatus == other.ServiceStatus
    }
}
...
impl ::std::cmp::PartialEq for SERVICE_NOTIFY_2A {
    fn eq(&self, other: &Self) -> bool {
        self.dwVersion == other.dwVersion
            ...
            && self.dwNotificationStatus == other.dwNotificationStatus
            && self.ServiceStatus == other.ServiceStatus
            && self.dwNotificationTriggered == other.dwNotificationTriggered
            && self.pszServiceNames == other.pszServiceNames
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for SERVICE_PREFERRED_NODE_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_PREFERRED_NODE_INFO")
            .field("usPreferredNode", &self.usPreferredNode)
            .field("fDelete", &self.fDelete)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for SERVICE_PRESHUTDOWN_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_PRESHUTDOWN_INFO")
            .field("dwPreshutdownTimeout", &self.dwPreshutdownTimeout)
            .finish()
    }
}
...
pub const ServiceRegistryStateParameters: SERVICE_REGISTRY_STATE_TYPE =
    SERVICE_REGISTRY_STATE_TYPE(0i32);
pub const ServiceRegistryStatePersistent: SERVICE_REGISTRY_STATE_TYPE =
    SERVICE_REGISTRY_STATE_TYPE(1i32);
pub const MaxServiceRegistryStateType: SERVICE_REGISTRY_STATE_TYPE =
    SERVICE_REGISTRY_STATE_TYPE(2i32);
...
impl ::std::fmt::Debug for SERVICE_REQUIRED_PRIVILEGES_INFOA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_REQUIRED_PRIVILEGES_INFOA")
            .field("pmszRequiredPrivileges", &self.pmszRequiredPrivileges)
            .finish()
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for SERVICE_REQUIRED_PRIVILEGES_INFOW {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_REQUIRED_PRIVILEGES_INFOW")
            .field("pmszRequiredPrivileges", &self.pmszRequiredPrivileges)
            .finish()
    }
}
...
pub const SERVICE_RUNS_IN_NON_SYSTEM_OR_NOT_RUNNING: SERVICE_RUNS_IN_PROCESS =
    SERVICE_RUNS_IN_PROCESS(0u32);
...
pub const ServiceSharedDirectoryPersistentState: SERVICE_SHARED_DIRECTORY_TYPE =
    SERVICE_SHARED_DIRECTORY_TYPE(0i32);
...
pub const ServiceSharedRegistryPersistentState: SERVICE_SHARED_REGISTRY_STATE_TYPE =
    SERVICE_SHARED_REGISTRY_STATE_TYPE(0i32);
...
impl ::std::fmt::Debug for SERVICE_SID_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_SID_INFO")
            .field("dwServiceSidType", &self.dwServiceSidType)
            .finish()
    }
}
...
impl ::std::fmt::Debug for SERVICE_START_REASON {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_START_REASON")
            .field("dwReason", &self.dwReason)
            .finish()
    }
}
...
impl ::std::cmp::PartialEq for SERVICE_STATUS {
    fn eq(&self, other: &Self) -> bool {
        self.dwServiceType == other.dwServiceType
            ...
            && self.dwControlsAccepted == other.dwControlsAccepted
            && self.dwWin32ExitCode == other.dwWin32ExitCode
            && self.dwServiceSpecificExitCode == other.dwServiceSpecificExitCode
            && self.dwCheckPoint == other.dwCheckPoint
            && self.dwWaitHint == other.dwWaitHint
    }
}
...
pub const SERVICE_CONTINUE_PENDING: SERVICE_STATUS_CURRENT_STATE =
    SERVICE_STATUS_CURRENT_STATE(5u32);
...
impl ::std::fmt::Debug for SERVICE_TABLE_ENTRYA {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_TABLE_ENTRYA")
            .field("lpServiceName", &self.lpServiceName)
            .finish()
    }
}
...
impl ::std::cmp::PartialEq for SERVICE_TABLE_ENTRYA {
    fn eq(&self, other: &Self) -> bool {
        self.lpServiceName == other.lpServiceName
            && self.lpServiceProc.map(|f| f as usize) == other.lpServiceProc.map(|f| f as usize)
    }
}
#[cfg(feature = "Win32_Foundation")]
...
impl ::std::fmt::Debug for SERVICE_TABLE_ENTRYW {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_TABLE_ENTRYW")
            .field("lpServiceName", &self.lpServiceName)
            .finish()
    }
}
...
impl ::std::fmt::Debug for SERVICE_TIMECHANGE_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_TIMECHANGE_INFO")
            .field("liNewTime", &self.liNewTime)
            .field("liOldTime", &self.liOldTime)
            .finish()
    }
}
...
impl ::std::fmt::Debug for SERVICE_TRIGGER {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_TRIGGER")
            .field("dwTriggerType", &self.dwTriggerType)
            .field("dwAction", &self.dwAction)
            .field("pTriggerSubtype", &self.pTriggerSubtype)
            .field("cDataItems", &self.cDataItems)
            .field("pDataItems", &self.pDataItems)
            .finish()
    }
}
impl ::std::cmp::PartialEq for SERVICE_TRIGGER {
    fn eq(&self, other: &Self) -> bool {
        self.dwTriggerType == other.dwTriggerType
            && self.dwAction == other.dwAction
            && self.pTriggerSubtype == other.pTriggerSubtype
            && self.cDataItems == other.cDataItems
            && self.pDataItems == other.pDataItems
    }
}
...
pub const SERVICE_TRIGGER_ACTION_SERVICE_START: SERVICE_TRIGGER_ACTION =
    SERVICE_TRIGGER_ACTION(1u32);
pub const SERVICE_TRIGGER_ACTION_SERVICE_STOP: SERVICE_TRIGGER_ACTION =
    SERVICE_TRIGGER_ACTION(2u32);
...
impl ::std::fmt::Debug for SERVICE_TRIGGER_CUSTOM_STATE_ID {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_TRIGGER_CUSTOM_STATE_ID")
            .field("Data", &self.Data)
            .finish()
    }
}
...
impl ::std::fmt::Debug for SERVICE_TRIGGER_INFO {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_TRIGGER_INFO")
            .field("cTriggers", &self.cTriggers)
            .field("pTriggers", &self.pTriggers)
...
impl ::std::cmp::PartialEq for SERVICE_TRIGGER_INFO {
    fn eq(&self, other: &Self) -> bool {
        self.cTriggers == other.cTriggers
            && self.pTriggers == other.pTriggers
...
impl ::std::fmt::Debug for SERVICE_TRIGGER_SPECIFIC_DATA_ITEM {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("SERVICE_TRIGGER_SPECIFIC_DATA_ITEM")
...
pub const SERVICE_TRIGGER_DATA_TYPE_BINARY: SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE =
    SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE(1u32);
pub const SERVICE_TRIGGER_DATA_TYPE_STRING: SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE =
    SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE(2u32);
pub const SERVICE_TRIGGER_DATA_TYPE_LEVEL: SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE =
    SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE(3u32);
pub const SERVICE_TRIGGER_DATA_TYPE_KEYWORD_ANY: SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE =
    SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE(4u32);
pub const SERVICE_TRIGGER_DATA_TYPE_KEYWORD_ALL: SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE =
    SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_DATA_TYPE(5u32);
...
pub const SERVICE_TRIGGER_TYPE_DEVICE_INTERFACE_ARRIVAL: SERVICE_TRIGGER_TYPE =
    SERVICE_TRIGGER_TYPE(1u32);
pub const SERVICE_TRIGGER_TYPE_DOMAIN_JOIN: SERVICE_TRIGGER_TYPE = SERVICE_TRIGGER_TYPE(3u32);
pub const SERVICE_TRIGGER_TYPE_FIREWALL_PORT_EVENT: SERVICE_TRIGGER_TYPE =
    SERVICE_TRIGGER_TYPE(4u32);
pub const SERVICE_TRIGGER_TYPE_GROUP_POLICY: SERVICE_TRIGGER_TYPE = SERVICE_TRIGGER_TYPE(5u32);
pub const SERVICE_TRIGGER_TYPE_IP_ADDRESS_AVAILABILITY: SERVICE_TRIGGER_TYPE =
    SERVICE_TRIGGER_TYPE(2u32);
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn SetServiceBits(
                hservicestatus: SERVICE_STATUS_HANDLE,
                dwservicebits: u32,
                bsetbitson: super::super::Foundation::BOOL,
                bupdateimmediately: super::super::Foundation::BOOL,
            ) -> super::super::Foundation::BOOL;
        }
        ::std::mem::transmute(SetServiceBits(
            hservicestatus.into_param().abi(),
            ::std::mem::transmute(dwservicebits),
            bsetbitson.into_param().abi(),
            bupdateimmediately.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(SetServiceObjectSecurity(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwsecurityinformation),
            ::std::mem::transmute(lpsecuritydescriptor),
        ))
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(SetServiceStatus(
            hservicestatus.into_param().abi(),
            ::std::mem::transmute(lpservicestatus),
        ))
    }
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn StartServiceA<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
>(
    hservice: Param0,
    dwnumserviceargs: u32,
    lpserviceargvectors: *const super::super::Foundation::PSTR,
) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "advapi32")]
        ...
        ::std::mem::transmute(StartServiceA(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwnumserviceargs),
            ::std::mem::transmute(lpserviceargvectors),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn StartServiceCtrlDispatcherA(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(StartServiceCtrlDispatcherA(::std::mem::transmute(
            lpservicestarttable,
        )))
    }
    #[cfg(not(windows))]
...
pub unsafe fn StartServiceCtrlDispatcherW(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(StartServiceCtrlDispatcherW(::std::mem::transmute(
            lpservicestarttable,
        )))
    }
    #[cfg(not(windows))]
...
>(
    hservice: Param0,
    dwnumserviceargs: u32,
    lpserviceargvectors: *const super::super::Foundation::PWSTR,
) -> super::super::Foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "advapi32")]
        ...
        ::std::mem::transmute(StartServiceW(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwnumserviceargs),
            ::std::mem::transmute(lpserviceargvectors),
        ))
...
pub const USER_POLICY_PRESENT_GUID: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        1425753800,
        61577,
        17996,
        [177, 253, 89, 209, 182, 44, 59, 80],
    );
#[cfg(feature = "Win32_Foundation")]
pub unsafe fn UnlockServiceDatabase(
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub unsafe fn WaitServiceState<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Security::SC_HANDLE>,
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn WaitServiceState(
                ...
                dwnotify: u32,
                dwtimeout: u32,
                hcancelevent: super::super::Foundation::HANDLE,
            ) -> u32;
        }
        ::std::mem::transmute(WaitServiceState(
            hservice.into_param().abi(),
            ::std::mem::transmute(dwnotify),
            ::std::mem::transmute(dwtimeout),
            hcancelevent.into_param().abi(),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
