...
#[cfg(feature = "Win32_System_OleAutomation")]
impl ::std::convert::From<DRendezvousSessionEvents> for super::OleAutomation::IDispatch {
    fn from(value: DRendezvousSessionEvents) -> Self {
        unsafe { ::std::mem::transmute(value) }
    }
}
...
impl IRendezvousApplication {
    pub unsafe fn SetRendezvousSession<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>,
    >(
        &self,
        prendezvoussession: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            prendezvoussession.into_param().abi(),
        )
        .ok()
    }
}
...
pub struct IRendezvousApplication_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        prendezvoussession: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IRendezvousSession {
    pub unsafe fn State(&self) -> ::windows::runtime::Result<RENDEZVOUS_SESSION_STATE> {
        let mut result__: <RENDEZVOUS_SESSION_STATE as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<RENDEZVOUS_SESSION_STATE>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
...
pub struct IRendezvousSession_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        hr: ::windows::runtime::HRESULT,
        bstrappdata: ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[derive(
...
pub const RendezvousApplication: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    192807322,
    46558,
    18426,
    [137, 102, 144, 130, 248, 47, 177, 146],
);
