...
impl IWaaSAssessor {
    ...
    pub unsafe fn GetOSUpdateAssessment(&self) -> ::windows::runtime::Result<OSUpdateAssessment> {
        let mut result__: <OSUpdateAssessment as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<OSUpdateAssessment>(result__)
    }
}
...
impl ::std::fmt::Debug for UpdateAssessment {
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        fmt.debug_struct("UpdateAssessment")
            .field("status", &self.status)
            .field("impact", &self.impact)
            .field("daysOutOfDate", &self.daysOutOfDate)
            .finish()
    }
}
impl ::std::cmp::PartialEq for UpdateAssessment {
    fn eq(&self, other: &Self) -> bool {
        self.status == other.status
            ...
            && self.daysOutOfDate == other.daysOutOfDate
    }
}
...
pub const WaaSAssessor: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    160364657,
    64159,
    18095,
    [137, 88, 192, 131, 81, 93, 124, 156],
);
