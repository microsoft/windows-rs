...
pub type JsBackgroundWorkItemCallback =
    unsafe extern "system" fn(callbackstate: *const ::std::ffi::c_void);
pub type JsBeforeCollectCallback =
    unsafe extern "system" fn(callbackstate: *const ::std::ffi::c_void);
#[inline]
pub unsafe fn JsBoolToBoolean(
    value: u8,
    booleanvalue: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsBoolToBoolean(
            ::std::mem::transmute(value),
            ::std::mem::transmute(booleanvalue),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsBooleanToBool(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsBooleanToBool(
            ::std::mem::transmute(value),
            ::std::mem::transmute(boolvalue),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsCallFunction(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsCallFunction(
            ::std::mem::transmute(function),
            ::std::mem::transmute(arguments),
            ::std::mem::transmute(argumentcount),
...
pub unsafe fn JsConstructObject(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsConstructObject(
            ::std::mem::transmute(function),
            ::std::mem::transmute(arguments),
            ::std::mem::transmute(argumentcount),
            ::std::mem::transmute(result),
...
pub unsafe fn JsConvertValueToBoolean(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsConvertValueToBoolean(
            ::std::mem::transmute(value),
            ::std::mem::transmute(booleanvalue),
        ))
    }
...
pub unsafe fn JsConvertValueToNumber(
    value: *const ::std::ffi::c_void,
    numbervalue: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsConvertValueToNumber(
            ::std::mem::transmute(value),
            ::std::mem::transmute(numbervalue),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsConvertValueToObject(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsConvertValueToObject(
            ::std::mem::transmute(value),
...
pub unsafe fn JsConvertValueToString(
    value: *const ::std::ffi::c_void,
    stringvalue: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsConvertValueToString(
            ::std::mem::transmute(value),
            ::std::mem::transmute(stringvalue),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsCreateArray(length: u32, result: *mut *mut ::std::ffi::c_void) -> JsErrorCode {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsCreateArray(
...
#[inline]
pub unsafe fn JsCreateContext<
    'a,
    Param1: ::windows::runtime::IntoParam<'a, super::Diagnostics::Debug::IDebugApplication64>,
>(
    runtime: *const ::std::ffi::c_void,
    debugapplication: Param1,
    newcontext: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn JsCreateContext(
                runtime: *const ::std::ffi::c_void,
                debugapplication: ::windows::runtime::RawPtr,
                newcontext: *mut *mut ::std::ffi::c_void,
            ) -> JsErrorCode;
        }
        ::std::mem::transmute(JsCreateContext(
            ::std::mem::transmute(runtime),
            debugapplication.into_param().abi(),
            ::std::mem::transmute(newcontext),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsCreateError(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsCreateError(
...
pub unsafe fn JsCreateExternalObject(
    ...
    finalizecallback: ::std::option::Option<JsFinalizeCallback>,
    object: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn JsCreateExternalObject(
                data: *const ::std::ffi::c_void,
                finalizecallback: ::windows::runtime::RawPtr,
                object: *mut *mut ::std::ffi::c_void,
            ) -> JsErrorCode;
        }
        ::std::mem::transmute(JsCreateExternalObject(
            ::std::mem::transmute(data),
            ::std::mem::transmute(finalizecallback),
            ::std::mem::transmute(object),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn JsCreateFunction(
    nativefunction: ::std::option::Option<JsNativeFunction>,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsCreateFunction(
            ::std::mem::transmute(nativefunction),
...
pub unsafe fn JsCreateRangeError(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsCreateRangeError(
            ::std::mem::transmute(message),
            ::std::mem::transmute(error),
        ))
    }
...
pub unsafe fn JsCreateReferenceError(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsCreateReferenceError(
            ::std::mem::transmute(message),
            ::std::mem::transmute(error),
        ))
    }
...
pub unsafe fn JsCreateRuntime(
    ...
    threadservice: ::std::option::Option<JsThreadServiceCallback>,
    runtime: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn JsCreateRuntime(
                attributes: JsRuntimeAttributes,
                runtimeversion: JsRuntimeVersion,
                threadservice: ::windows::runtime::RawPtr,
                runtime: *mut *mut ::std::ffi::c_void,
            ) -> JsErrorCode;
        }
        ::std::mem::transmute(JsCreateRuntime(
            ::std::mem::transmute(attributes),
            ::std::mem::transmute(runtimeversion),
            ::std::mem::transmute(threadservice),
            ::std::mem::transmute(runtime),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn JsCreateSyntaxError(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsCreateSyntaxError(
            ::std::mem::transmute(message),
            ::std::mem::transmute(error),
        ))
    }
...
pub unsafe fn JsCreateTypeError(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsCreateTypeError(
            ::std::mem::transmute(message),
            ::std::mem::transmute(error),
        ))
    }
...
pub unsafe fn JsCreateURIError(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsCreateURIError(
            ::std::mem::transmute(message),
            ::std::mem::transmute(error),
        ))
    }
...
pub unsafe fn JsDefineProperty(
    ...
    propertydescriptor: *const ::std::ffi::c_void,
    result: *mut bool,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsDefineProperty(
            ::std::mem::transmute(object),
            ::std::mem::transmute(propertyid),
            ::std::mem::transmute(propertydescriptor),
            ::std::mem::transmute(result),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn JsDeleteIndexedProperty(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsDeleteIndexedProperty(
            ::std::mem::transmute(object),
...
pub unsafe fn JsDeleteProperty(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsDeleteProperty(
            ::std::mem::transmute(object),
            ::std::mem::transmute(propertyid),
            ::std::mem::transmute(usestrictrules),
            ::std::mem::transmute(result),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn JsDoubleToNumber(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsDoubleToNumber(
            ::std::mem::transmute(doublevalue),
            ::std::mem::transmute(value),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn JsEnumerateHeap(
    enumerator: *mut ::std::option::Option<
        super::Diagnostics::Debug::IActiveScriptProfilerHeapEnum,
    >,
) -> JsErrorCode {
    #[cfg(windows)]
    {
...
pub unsafe fn JsEquals(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsEquals(
            ::std::mem::transmute(object1),
            ::std::mem::transmute(object2),
            ::std::mem::transmute(result),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn JsGetExtensionAllowed(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsGetExtensionAllowed(
            ::std::mem::transmute(object),
            ::std::mem::transmute(value),
        ))
    }
...
pub unsafe fn JsGetExternalData(
    object: *const ::std::ffi::c_void,
    externaldata: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsGetExternalData(
            ::std::mem::transmute(object),
            ::std::mem::transmute(externaldata),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsGetIndexedProperty(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsGetIndexedProperty(
            ::std::mem::transmute(object),
            ::std::mem::transmute(index),
            ::std::mem::transmute(result),
        ))
...
pub unsafe fn JsGetOwnPropertyDescriptor(
    object: *const ::std::ffi::c_void,
    propertyid: *const ::std::ffi::c_void,
    propertydescriptor: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsGetOwnPropertyDescriptor(
            ::std::mem::transmute(object),
            ::std::mem::transmute(propertyid),
            ::std::mem::transmute(propertydescriptor),
        ))
...
pub unsafe fn JsGetOwnPropertyNames(
    object: *const ::std::ffi::c_void,
    propertynames: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsGetOwnPropertyNames(
            ::std::mem::transmute(object),
...
pub unsafe fn JsGetProperty(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsGetProperty(
            ::std::mem::transmute(object),
            ::std::mem::transmute(propertyid),
            ::std::mem::transmute(value),
        ))
...
#[inline]
pub unsafe fn JsGetPropertyIdFromName<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    name: Param0,
    propertyid: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsGetPropertyIdFromName(
            name.into_param().abi(),
            ::std::mem::transmute(propertyid),
        ))
    }
...
pub unsafe fn JsGetPropertyNameFromId(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsGetPropertyNameFromId(
            ::std::mem::transmute(propertyid),
...
pub unsafe fn JsGetPrototype(
    object: *const ::std::ffi::c_void,
    prototypeobject: *mut *mut ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsGetPrototype(
            ::std::mem::transmute(object),
            ::std::mem::transmute(prototypeobject),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsGetRuntime(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsGetRuntime(
...
pub unsafe fn JsGetRuntimeMemoryLimit(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsGetRuntimeMemoryLimit(
            ::std::mem::transmute(runtime),
            ::std::mem::transmute(memorylimit),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsGetRuntimeMemoryUsage(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsGetRuntimeMemoryUsage(
            ::std::mem::transmute(runtime),
            ::std::mem::transmute(memoryusage),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsGetStringLength(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsGetStringLength(
            ::std::mem::transmute(stringvalue),
            ::std::mem::transmute(length),
        ))
    }
...
pub unsafe fn JsGetValueType(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsGetValueType(
            ::std::mem::transmute(value),
...
pub unsafe fn JsHasExternalData(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsHasExternalData(
            ::std::mem::transmute(object),
            ::std::mem::transmute(value),
        ))
    }
...
pub unsafe fn JsHasIndexedProperty(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsHasIndexedProperty(
            ::std::mem::transmute(object),
            ::std::mem::transmute(index),
            ::std::mem::transmute(result),
        ))
...
pub unsafe fn JsHasProperty(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsHasProperty(
            ::std::mem::transmute(object),
            ::std::mem::transmute(propertyid),
            ::std::mem::transmute(hasproperty),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsIntToNumber(intvalue: i32, value: *mut *mut ::std::ffi::c_void) -> JsErrorCode {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsIntToNumber(
            ::std::mem::transmute(intvalue),
            ::std::mem::transmute(value),
        ))
    }
    #[cfg(not(windows))]
...
pub unsafe fn JsIsEnumeratingHeap(isenumeratingheap: *mut bool) -> JsErrorCode {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsIsEnumeratingHeap(::std::mem::transmute(
            isenumeratingheap,
        )))
    }
    #[cfg(not(windows))]
...
pub unsafe fn JsIsRuntimeExecutionDisabled(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsIsRuntimeExecutionDisabled(
            ::std::mem::transmute(runtime),
            ::std::mem::transmute(isdisabled),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
pub type JsMemoryAllocationCallback = unsafe extern "system" fn(
    callbackstate: *const ::std::ffi::c_void,
...
pub type JsNativeFunction = unsafe extern "system" fn(
    callee: *const ::std::ffi::c_void,
...
pub unsafe fn JsNumberToDouble(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsNumberToDouble(
            ::std::mem::transmute(value),
            ::std::mem::transmute(doublevalue),
        ))
    }
    ...
    #[cfg(windows)]
    {
        ...
        extern "system" {
            fn JsParseScript(
                ...
                sourcecontext: usize,
                sourceurl: super::super::Foundation::PWSTR,
                result: *mut *mut ::std::ffi::c_void,
            ) -> JsErrorCode;
        }
        ::std::mem::transmute(JsParseScript(
            script.into_param().abi(),
            ::std::mem::transmute(sourcecontext),
            sourceurl.into_param().abi(),
            ::std::mem::transmute(result),
        ))
    }
    #[cfg(not(windows))]
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn JsParseSerializedScript<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsParseSerializedScript(
            script.into_param().abi(),
...
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsPointerToString(
            stringvalue.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn JsRunSerializedScript<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsRunSerializedScript(
            script.into_param().abi(),
            ::std::mem::transmute(buffer),
            ::std::mem::transmute(sourcecontext),
            sourceurl.into_param().abi(),
...
#[cfg(feature = "Win32_Foundation")]
#[inline]
pub unsafe fn JsSerializeScript<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
>(
    script: Param0,
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsSerializeScript(
            script.into_param().abi(),
            ::std::mem::transmute(buffer),
...
pub unsafe fn JsSetExternalData(
    object: *const ::std::ffi::c_void,
    externaldata: *const ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsSetExternalData(
            ::std::mem::transmute(object),
            ::std::mem::transmute(externaldata),
        ))
    }
...
pub unsafe fn JsSetIndexedProperty(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsSetIndexedProperty(
            ::std::mem::transmute(object),
            ::std::mem::transmute(index),
            ::std::mem::transmute(value),
        ))
...
pub unsafe fn JsSetProperty(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsSetProperty(
            ::std::mem::transmute(object),
            ::std::mem::transmute(propertyid),
            ::std::mem::transmute(value),
            ::std::mem::transmute(usestrictrules),
...
pub unsafe fn JsSetPrototype(
    object: *const ::std::ffi::c_void,
    prototypeobject: *const ::std::ffi::c_void,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        ...
        ::std::mem::transmute(JsSetPrototype(
            ::std::mem::transmute(object),
            ::std::mem::transmute(prototypeobject),
        ))
    }
...
pub unsafe fn JsSetRuntimeBeforeCollectCallback(
    runtime: *const ::std::ffi::c_void,
    callbackstate: *const ::std::ffi::c_void,
    beforecollectcallback: ::std::option::Option<JsBeforeCollectCallback>,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn JsSetRuntimeBeforeCollectCallback(
                runtime: *const ::std::ffi::c_void,
                callbackstate: *const ::std::ffi::c_void,
                beforecollectcallback: ::windows::runtime::RawPtr,
            ) -> JsErrorCode;
        }
        ::std::mem::transmute(JsSetRuntimeBeforeCollectCallback(
            ::std::mem::transmute(runtime),
            ::std::mem::transmute(callbackstate),
            ::std::mem::transmute(beforecollectcallback),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsSetRuntimeMemoryAllocationCallback(
    runtime: *const ::std::ffi::c_void,
    callbackstate: *const ::std::ffi::c_void,
    allocationcallback: ::std::option::Option<JsMemoryAllocationCallback>,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn JsSetRuntimeMemoryAllocationCallback(
                runtime: *const ::std::ffi::c_void,
                callbackstate: *const ::std::ffi::c_void,
                allocationcallback: ::windows::runtime::RawPtr,
            ) -> JsErrorCode;
        }
        ::std::mem::transmute(JsSetRuntimeMemoryAllocationCallback(
            ::std::mem::transmute(runtime),
            ::std::mem::transmute(callbackstate),
            ::std::mem::transmute(allocationcallback),
        ))
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
...
pub unsafe fn JsSetRuntimeMemoryLimit(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsSetRuntimeMemoryLimit(
            ::std::mem::transmute(runtime),
            ::std::mem::transmute(memorylimit),
        ))
    }
...
#[cfg(feature = "Win32_System_Diagnostics_Debug")]
#[inline]
pub unsafe fn JsStartDebugging<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Diagnostics::Debug::IDebugApplication64>,
>(
    debugapplication: Param0,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
...
#[cfg(feature = "Win32_System_Diagnostics_Debug")]
#[inline]
pub unsafe fn JsStartProfiling<
    'a,
    Param0: ::windows::runtime::IntoParam<'a, super::Diagnostics::Debug::IActiveScriptProfilerCallback>,
>(
    callback: Param0,
    eventmask: super::Diagnostics::Debug::PROFILER_EVENT_MASK,
    context: u32,
) -> JsErrorCode {
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsStartProfiling(
...
pub unsafe fn JsStrictEquals(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsStrictEquals(
            ::std::mem::transmute(object1),
            ::std::mem::transmute(object2),
            ::std::mem::transmute(result),
        ))
...
pub unsafe fn JsStringToPointer(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsStringToPointer(
            ::std::mem::transmute(value),
            ::std::mem::transmute(stringvalue),
            ::std::mem::transmute(stringlength),
        ))
...
pub type JsThreadServiceCallback = unsafe extern "system" fn(
    callback: ::windows::runtime::RawPtr,
    callbackstate: *const ::std::ffi::c_void,
) -> bool;
#[cfg(all(
...
pub unsafe fn JsVariantToValue(
    ...
    #[cfg(windows)]
    {
        ...
        ::std::mem::transmute(JsVariantToValue(
            ::std::mem::transmute(variant),
            ::std::mem::transmute(value),
        ))
    }
