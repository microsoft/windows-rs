...
impl IPhotoAcquire {
    ...
    pub unsafe fn CreatePhotoSource<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
        pszdevice: Param0,
    ) -> ::windows::runtime::Result<IPhotoAcquireSource> {
        let mut result__: <IPhotoAcquireSource as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        ...
        .from_abi::<IPhotoAcquireSource>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn Acquire<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPhotoAcquireSource>,
        ...
        Param4: ::windows::runtime::IntoParam<'a, IPhotoAcquireProgressCB>,
    >(
        &self,
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            pphotoacquiresource.into_param().abi(),
            fshowprogress.into_param().abi(),
            hwndparent.into_param().abi(),
            pszapplicationname.into_param().abi(),
            pphotoacquireprogresscb.into_param().abi(),
        )
        .ok()
    }
...
pub struct IPhotoAcquire_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        ppphotoacquiresource: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pphotoacquiresource: ::windows::runtime::RawPtr,
        fshowprogress: super::super::Foundation::BOOL,
        hwndparent: super::super::Foundation::HWND,
        pszapplicationname: super::super::Foundation::PWSTR,
        pphotoacquireprogresscb: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_System_Com")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppenumfilepaths: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
impl IPhotoAcquireDeviceSelectionDialog {
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetSubmitButtonText<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
        pszsubmitbuttontext: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            pszsubmitbuttontext.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            hwndparent.into_param().abi(),
            ::std::mem::transmute(dwdeviceflags),
            ::std::mem::transmute(pbstrdeviceid),
            ::std::mem::transmute(pndevicetype),
        )
        .ok()
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IPhotoAcquireDeviceSelectionDialog
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IPhotoAcquireDeviceSelectionDialog_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pszsubmitbuttontext: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl IPhotoAcquireItem {
    ...
    pub unsafe fn GetSubItemAt(
        &self,
        nitemindex: u32,
    ) -> ::windows::runtime::Result<IPhotoAcquireItem> {
        let mut result__: <IPhotoAcquireItem as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).11)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(nitemindex),
            &mut result__,
        )
        .from_abi::<IPhotoAcquireItem>(result__)
    }
}
...
pub struct IPhotoAcquireItem_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstritemname: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi"))]
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        key: *const super::super::System::PropertiesSystem::PROPERTYKEY,
        pv: *mut ::std::mem::ManuallyDrop<super::super::System::Com::StructuredStorage::PROPVARIANT>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Win32_Foundation",
        feature = "Win32_System_Com",
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pfcandelete: *mut super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        nitemindex: u32,
        ppphotoacquireitem: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
impl IPhotoAcquireOptionsDialog {
    ...
    >(
        &self,
        pszregistryroot: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            pszregistryroot.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            hwndparent.into_param().abi(),
            ::std::mem::transmute(ppnreturncode),
        )
        .ok()
    }
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for IPhotoAcquireOptionsDialog
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
pub struct IPhotoAcquireOptionsDialog_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pszregistryroot: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl IPhotoAcquirePlugin {
    pub unsafe fn Initialize<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPhotoAcquireSource>,
        Param1: ::windows::runtime::IntoParam<'a, IPhotoAcquireProgressCB>,
    >(
        &self,
        pphotoacquiresource: Param0,
        pphotoacquireprogresscb: Param1,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            pphotoacquiresource.into_param().abi(),
    ...
    pub unsafe fn ProcessItem<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, IPhotoAcquireItem>,
        Param2: ::windows::runtime::IntoParam<'a, super::super::System::Com::IStream>,
        Param3: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
        Param4: ::windows::runtime::IntoParam<'a, super::super::System::PropertiesSystem::IPropertyStore>,
    >(
        &self,
        dwacquirestage: u32,
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dwacquirestage),
            pphotoacquireitem.into_param().abi(),
            poriginalitemstream.into_param().abi(),
            pszfinalfilename.into_param().abi(),
            ppropertystore.into_param().abi(),
        )
        .ok()
    }
    pub unsafe fn TransferComplete(
        &self,
...
pub struct IPhotoAcquirePlugin_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        dwacquirestage: u32,
        pphotoacquireitem: ::windows::runtime::RawPtr,
        poriginalitemstream: ::windows::runtime::RawPtr,
        pszfinalfilename: super::super::Foundation::PWSTR,
...
impl IPhotoAcquireProgressCB {
    ...
    pub unsafe fn StartEnumeration<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPhotoAcquireSource>,
    >(
        &self,
    ...
    pub unsafe fn FoundItem<'a, Param0: ::windows::runtime::IntoParam<'a, IPhotoAcquireItem>>(
        &self,
        pphotoacquireitem: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            pphotoacquireitem.into_param().abi(),
    ...
    pub unsafe fn StartItemTransfer<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, IPhotoAcquireItem>,
    >(
        &self,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn DirectoryCreated<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).10)(
            ::std::mem::transmute_copy(self),
            foverall.into_param().abi(),
            ::std::mem::transmute(npercent),
        )
        .ok()
    }
    pub unsafe fn EndItemTransfer<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, IPhotoAcquireItem>,
    >(
        &self,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetDeleteAfterAcquire(
        &self,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ErrorAdvise<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
        hr: ::windows::runtime::HRESULT,
        pszerrormessage: Param1,
        nmessagetype: ERROR_ADVISE_MESSAGE_TYPE,
    ) -> ::windows::runtime::Result<ERROR_ADVISE_RESULT> {
        let mut result__: <ERROR_ADVISE_RESULT as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).20)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(hr),
            pszerrormessage.into_param().abi(),
            ::std::mem::transmute(nmessagetype),
            &mut result__,
        )
        .from_abi::<ERROR_ADVISE_RESULT>(result__)
    }
    #[cfg(all(
        feature = "Win32_Foundation",
        feature = "Win32_System_Com",
    ...
    pub unsafe fn GetUserInput<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>,
    >(
        &self,
        riidtype: *const ::windows::runtime::GUID,
        punknown: Param1,
        ...
        (::windows::runtime::Interface::vtable(self).21)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(riidtype),
            punknown.into_param().abi(),
            ::std::mem::transmute(ppropvarresult),
            ::std::mem::transmute(ppropvardefault),
        )
        .ok()
    }
}
...
pub struct IPhotoAcquireProgressCB_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        foverall: super::super::Foundation::BOOL,
        npercent: u32,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pfdeleteafteracquire: *mut super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        hr: ::windows::runtime::HRESULT,
        pszerrormessage: super::super::Foundation::PWSTR,
        nmessagetype: ERROR_ADVISE_MESSAGE_TYPE,
    ...
    pub  unsafe extern "system" fn(
        ...
        ppropvarresult: *mut ::std::mem::ManuallyDrop<
            super::super::System::Com::StructuredStorage::PROPVARIANT,
        >,
        ppropvardefault: *const ::std::mem::ManuallyDrop<
            super::super::System::Com::StructuredStorage::PROPVARIANT,
        >,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
...
impl IPhotoAcquireSettings {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn InitializeFromRegistry<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
        pszregistrykey: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(
            ::std::mem::transmute_copy(self),
            pszregistrykey.into_param().abi(),
        )
        .ok()
    }
    pub unsafe fn SetFlags(&self, dwphotoacquireflags: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(dwphotoacquireflags),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetOutputFilenameTemplate<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetSequenceZeroPadding<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
    >(
        &self,
        ...
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            fzeropad.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetGroupTag<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
    ...
    pub unsafe fn SetAcquisitionTime(
        ...
        (::windows::runtime::Interface::vtable(self).9)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(pftacquisitiontime),
        )
        .ok()
    }
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetOutputFilenameTemplate(
        &self,
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetSequenceZeroPadding(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::BOOL> {
        let mut result__: <super::super::Foundation::BOOL as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
pub struct IPhotoAcquireSettings_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pszregistrykey: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        psztemplate: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        fzeropad: super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pszgrouptag: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrtemplate: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pfzeropad: *mut super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrgrouptag: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl IPhotoAcquireSource {
    ...
    pub unsafe fn GetDeviceIcons(
        ...
        (::windows::runtime::Interface::vtable(self).4)(
            ...
            ::std::mem::transmute(phlargeicon),
            ::std::mem::transmute(phsmallicon),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn InitializeItemList<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
        Param1: ::windows::runtime::IntoParam<'a, IPhotoAcquireProgressCB>,
    >(
        &self,
        fforceenumeration: Param0,
        pphotoacquireprogresscb: Param1,
        pnitemcount: *mut u32,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(
            ::std::mem::transmute_copy(self),
            fforceenumeration.into_param().abi(),
            pphotoacquireprogresscb.into_param().abi(),
            ::std::mem::transmute(pnitemcount),
        )
        .ok()
    }
    ...
    pub unsafe fn GetPhotoAcquireSettings(
        &self,
    ) -> ::windows::runtime::Result<IPhotoAcquireSettings> {
        let mut result__: <IPhotoAcquireSettings as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<IPhotoAcquireSettings>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
...
pub struct IPhotoAcquireSource_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrfriendlyname: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_UI_WindowsAndMessaging")]
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        fforceenumeration: super::super::Foundation::BOOL,
        pphotoacquireprogresscb: ::windows::runtime::RawPtr,
        pnitemcount: *mut u32,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ppphotoacquiresettings: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl IPhotoProgressDialog {
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).7)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(ncheckboxid),
            fshow.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetCheckboxText<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
        ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID,
        pszcheckboxtext: Param1,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).8)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(ncheckboxid),
            pszcheckboxtext.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    >(
        ...
        (::windows::runtime::Interface::vtable(self).9)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(ncheckboxid),
            fchecked.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetCheckboxTooltip<
        'a,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
        ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID,
        pszcheckboxtooltiptext: Param1,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).10)(
            ::std::mem::transmute_copy(self),
            ::std::mem::transmute(ncheckboxid),
            pszcheckboxtooltiptext.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetProgressText<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
        pszprogresstext: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).15)(
            ::std::mem::transmute_copy(self),
            pszprogresstext.into_param().abi(),
        )
        .ok()
    }
    pub unsafe fn SetActionLinkCallback<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, IPhotoProgressActionCB>,
    >(
        &self,
        pphotoprogressactioncb: Param0,
    ) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).16)(
            ::std::mem::transmute_copy(self),
            pphotoprogressactioncb.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn SetActionLinkText<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::PWSTR>,
    >(
        &self,
        ...
        (::windows::runtime::Interface::vtable(self).17)(
            ::std::mem::transmute_copy(self),
            pszcaption.into_param().abi(),
        )
        .ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn ShowActionLink<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::BOOL>,
    >(
        &self,
...
pub struct IPhotoProgressDialog_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID,
        pszcheckboxtext: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID,
        fchecked: super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID,
        pszcheckboxtooltiptext: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        ncheckboxid: PROGRESS_DIALOG_CHECKBOX_ID,
        pfchecked: *mut super::super::Foundation::BOOL,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pszprogresstext: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pphotoprogressactioncb: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pszcaption: super::super::Foundation::PWSTR,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
...
impl IUserInputString {
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetSubmitButtonText(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::BSTR> {
        let mut result__: <super::super::Foundation::BSTR as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
    ...
    pub unsafe fn GetStringType(&self) -> ::windows::runtime::Result<USER_INPUT_STRING_TYPE> {
        let mut result__: <USER_INPUT_STRING_TYPE as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).6)(
            ::std::mem::transmute_copy(self),
            &mut result__,
        )
        .from_abi::<USER_INPUT_STRING_TYPE>(result__)
    }
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn GetTooltipText(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::BSTR> {
        let mut result__: <super::super::Foundation::BSTR as ::windows::runtime::Abi>::Abi =
            ::std::mem::zeroed();
...
pub struct IUserInputString_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrsubmitbuttontext: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrprompttitle: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(feature = "Win32_Foundation")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrstringid: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrtooltiptext: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        pbstrdefault: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        nindex: u32,
        pbstrmruentry: *mut ::std::mem::ManuallyDrop<super::super::Foundation::BSTR>,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    #[cfg(all(
        feature = "Win32_Graphics_Gdi",
...
pub const PHOTOACQ_ERROR_RESTART_REQUIRED: ::windows::runtime::HRESULT =
    ::windows::runtime::HRESULT(-2147180543i32 as _);
...
pub const PhotoAcquire: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    15887874,
    59890,
    19103,
    [159, 221, 90, 150, 47, 178, 106, 152],
);
pub const PhotoAcquireAutoPlayDropTarget: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        15863477,
        36822,
        19869,
        [183, 94, 54, 128, 23, 102, 200, 241],
    );
pub const PhotoAcquireAutoPlayHWEventHandler: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        15905843,
        17636,
        19848,
        [178, 176, 38, 152, 160, 169, 29, 186],
    );
pub const PhotoAcquireDeviceSelectionDialog: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        15899188,
        47265,
        18476,
        [188, 248, 58, 199, 176, 254, 143, 98],
    );
pub const PhotoAcquireOptionsDialog: ::windows::runtime::GUID =
    ::windows::runtime::GUID::from_values(
        15863969,
        25328,
        17291,
        [159, 126, 150, 24, 215, 42, 24, 49],
    );
pub const PhotoProgressDialog: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
    15879328,
    29839,
    20106,
    [137, 79, 14, 3, 87, 198, 121, 159],
);
#[derive(
    :: std :: cmp :: PartialEq,
    :: std :: cmp :: Eq,
