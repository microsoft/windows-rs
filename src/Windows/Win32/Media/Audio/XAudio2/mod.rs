...
#[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
#[inline]
pub unsafe fn CreateFX(clsid: *const ::windows::runtime::GUID, peffect: *mut ::std::option::Option<::windows::runtime::IUnknown>, pinitdat: *const ::std::ffi::c_void, initdatabytesize: u32) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn CreateFX(clsid: *const ::windows::runtime::GUID, peffect: *mut ::windows::runtime::RawPtr, pinitdat: *const ::std::ffi::c_void, initdatabytesize: u32) -> ::windows::runtime::HRESULT;
        }
        CreateFX(::std::mem::transmute(clsid), ::std::mem::transmute(peffect), ::std::mem::transmute(pinitdat), ::std::mem::transmute(initdatabytesize)).ok()
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
impl IXAPO {
    ...
    pub unsafe fn GetRegistrationProperties(&self) -> ::windows::runtime::Result<*mut XAPO_REGISTRATION_PROPERTIES> {
        let mut result__: <*mut XAPO_REGISTRATION_PROPERTIES as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).3)(::std::mem::transmute_copy(self), &mut result__).from_abi::<*mut XAPO_REGISTRATION_PROPERTIES>(result__)
    }
    ...
    pub unsafe fn IsInputFormatSupported(&self, poutputformat: *const super::super::Multimedia::WAVEFORMATEX, prequestedinputformat: *const super::super::Multimedia::WAVEFORMATEX) -> ::windows::runtime::Result<*mut super::super::Multimedia::WAVEFORMATEX> {
        ...
        (::windows::runtime::Interface::vtable(self).4)(::std::mem::transmute_copy(self), ::std::mem::transmute(poutputformat), ::std::mem::transmute(prequestedinputformat), &mut result__).from_abi::<*mut super::super::Multimedia::WAVEFORMATEX>(result__)
    }
    #[cfg(feature = "Win32_Media_Multimedia")]
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`, `Win32_Media_Multimedia`*"]
    pub unsafe fn IsOutputFormatSupported(&self, pinputformat: *const super::super::Multimedia::WAVEFORMATEX, prequestedoutputformat: *const super::super::Multimedia::WAVEFORMATEX) -> ::windows::runtime::Result<*mut super::super::Multimedia::WAVEFORMATEX> {
        let mut result__: <*mut super::super::Multimedia::WAVEFORMATEX as ::windows::runtime::Abi>::Abi = ::std::mem::zeroed();
        (::windows::runtime::Interface::vtable(self).5)(::std::mem::transmute_copy(self), ::std::mem::transmute(pinputformat), ::std::mem::transmute(prequestedoutputformat), &mut result__).from_abi::<*mut super::super::Multimedia::WAVEFORMATEX>(result__)
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn Initialize(&self, pdata: *const ::std::ffi::c_void, databytesize: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(::std::mem::transmute_copy(self), ::std::mem::transmute(pdata), ::std::mem::transmute(databytesize)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    ...
    pub unsafe fn LockForProcess(&self, inputlockedparametercount: u32, pinputlockedparameters: *const XAPO_LOCKFORPROCESS_PARAMETERS, outputlockedparametercount: u32, poutputlockedparameters: *const XAPO_LOCKFORPROCESS_PARAMETERS) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).8)(::std::mem::transmute_copy(self), ::std::mem::transmute(inputlockedparametercount), ::std::mem::transmute(pinputlockedparameters), ::std::mem::transmute(outputlockedparametercount), ::std::mem::transmute(poutputlockedparameters)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    ...
    pub unsafe fn CalcInputFrames(&self, outputframecount: u32) -> u32 {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).11)(::std::mem::transmute_copy(self), ::std::mem::transmute(outputframecount)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn CalcOutputFrames(&self, inputframecount: u32) -> u32 {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).12)(::std::mem::transmute_copy(self), ::std::mem::transmute(inputframecount)))
    }
}
...
pub struct IXAPO_abi(
    ...
    #[cfg(not(feature = "Win32_Media_Multimedia"))] usize,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, pdata: *const ::std::ffi::c_void, databytesize: u32) -> ::windows::runtime::HRESULT,
...
impl IXAPOHrtfParameters {
    ...
    pub unsafe fn SetSourcePosition(&self, position: *const HrtfPosition) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).3)(::std::mem::transmute_copy(self), ::std::mem::transmute(position)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetSourceOrientation(&self, orientation: *const HrtfOrientation) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(::std::mem::transmute_copy(self), ::std::mem::transmute(orientation)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetSourceGain(&self, gain: f32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(::std::mem::transmute_copy(self), ::std::mem::transmute(gain)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetEnvironment(&self, environment: HrtfEnvironment) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(::std::mem::transmute_copy(self), ::std::mem::transmute(environment)).ok()
    }
}
...
impl IXAPOParameters {
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetParameters(&self, pparameters: *const ::std::ffi::c_void, parameterbytesize: u32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).3)(::std::mem::transmute_copy(self), ::std::mem::transmute(pparameters), ::std::mem::transmute(parameterbytesize)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetParameters(&self, pparameters: *mut ::std::ffi::c_void, parameterbytesize: u32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).4)(::std::mem::transmute_copy(self), ::std::mem::transmute(pparameters), ::std::mem::transmute(parameterbytesize)))
    }
}
...
pub struct IXAPOParameters_abi(
    ...
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> u32,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr) -> u32,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, pparameters: *const ::std::ffi::c_void, parameterbytesize: u32),
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, pparameters: *mut ::std::ffi::c_void, parameterbytesize: u32),
);
#[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
#[repr(transparent)]
#[derive(:: std :: cmp :: PartialEq, :: std :: cmp :: Eq, :: std :: clone :: Clone, :: std :: fmt :: Debug, :: windows :: runtime :: DeriveInterface)]
...
impl IXAudio2 {
    ...
    pub unsafe fn UnregisterForCallbacks<'a, Param0: ::windows::runtime::IntoParam<'a, IXAudio2EngineCallback>>(&self, pcallback: Param0) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).4)(::std::mem::transmute_copy(self), pcallback.into_param().abi()))
    }
    ...
    pub unsafe fn CreateSourceVoice<'a, Param4: ::windows::runtime::IntoParam<'a, IXAudio2VoiceCallback>>(&self, ppsourcevoice: *mut ::std::option::Option<IXAudio2SourceVoice>, psourceformat: *const super::super::Multimedia::WAVEFORMATEX, flags: u32, maxfrequencyratio: f32, pcallback: Param4, psendlist: *const XAUDIO2_VOICE_SENDS, peffectchain: *const XAUDIO2_EFFECT_CHAIN) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(::std::mem::transmute_copy(self), ::std::mem::transmute(ppsourcevoice), ::std::mem::transmute(psourceformat), ::std::mem::transmute(flags), ::std::mem::transmute(maxfrequencyratio), pcallback.into_param().abi(), ::std::mem::transmute(psendlist), ::std::mem::transmute(peffectchain)).ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`, `Win32_Foundation`*"]
    pub unsafe fn CreateSubmixVoice(&self, ppsubmixvoice: *mut ::std::option::Option<IXAudio2SubmixVoice>, inputchannels: u32, inputsamplerate: u32, flags: u32, processingstage: u32, psendlist: *const XAUDIO2_VOICE_SENDS, peffectchain: *const XAUDIO2_EFFECT_CHAIN) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(::std::mem::transmute_copy(self), ::std::mem::transmute(ppsubmixvoice), ::std::mem::transmute(inputchannels), ::std::mem::transmute(inputsamplerate), ::std::mem::transmute(flags), ::std::mem::transmute(processingstage), ::std::mem::transmute(psendlist), ::std::mem::transmute(peffectchain)).ok()
    }
    ...
    pub unsafe fn CreateMasteringVoice<'a, Param4: ::windows::runtime::IntoParam<'a, super::super::super::Foundation::PWSTR>>(&self, ppmasteringvoice: *mut ::std::option::Option<IXAudio2MasteringVoice>, inputchannels: u32, inputsamplerate: u32, flags: u32, szdeviceid: Param4, peffectchain: *const XAUDIO2_EFFECT_CHAIN, streamcategory: super::CoreAudio::AUDIO_STREAM_CATEGORY) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).7)(::std::mem::transmute_copy(self), ::std::mem::transmute(ppmasteringvoice), ::std::mem::transmute(inputchannels), ::std::mem::transmute(inputsamplerate), ::std::mem::transmute(flags), szdeviceid.into_param().abi(), ::std::mem::transmute(peffectchain), ::std::mem::transmute(streamcategory)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    ...
    pub unsafe fn CommitChanges(&self, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).10)(::std::mem::transmute_copy(self), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetPerformanceData(&self, pperfdata: *mut XAUDIO2_PERFORMANCE_DATA) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).11)(::std::mem::transmute_copy(self), ::std::mem::transmute(pperfdata)))
    }
    #[cfg(feature = "Win32_Foundation")]
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`, `Win32_Foundation`*"]
    pub unsafe fn SetDebugConfiguration(&self, pdebugconfiguration: *const XAUDIO2_DEBUG_CONFIGURATION, preserved: *mut ::std::ffi::c_void) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).12)(::std::mem::transmute_copy(self), ::std::mem::transmute(pdebugconfiguration), ::std::mem::transmute(preserved)))
    }
}
...
pub struct IXAudio2_abi(
    ...
    #[cfg(feature = "Win32_Foundation")] pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, pdebugconfiguration: *const XAUDIO2_DEBUG_CONFIGURATION, preserved: *mut ::std::ffi::c_void),
    #[cfg(not(feature = "Win32_Foundation"))] usize,
);
#[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
#[repr(transparent)]
...
impl IXAudio2EngineCallback {
    ...
    pub unsafe fn OnCriticalError(&self, error: ::windows::runtime::HRESULT) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).5)(::std::mem::transmute_copy(self), ::std::mem::transmute(error)))
    }
}
...
impl IXAudio2Extension {
    ...
    pub unsafe fn GetProcessingQuantum(&self, quantumnumerator: *mut u32, quantumdenominator: *mut u32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).3)(::std::mem::transmute_copy(self), ::std::mem::transmute(quantumnumerator), ::std::mem::transmute(quantumdenominator)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetProcessor(&self, processor: *mut u32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).4)(::std::mem::transmute_copy(self), ::std::mem::transmute(processor)))
    }
}
...
impl IXAudio2MasteringVoice {
    ...
    pub unsafe fn GetVoiceDetails(&self, pvoicedetails: *mut XAUDIO2_VOICE_DETAILS) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).3)(::std::mem::transmute_copy(self), ::std::mem::transmute(pvoicedetails)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetOutputVoices(&self, psendlist: *const XAUDIO2_VOICE_SENDS) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).4)(::std::mem::transmute_copy(self), ::std::mem::transmute(psendlist)).ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`, `Win32_Foundation`*"]
    pub unsafe fn SetEffectChain(&self, peffectchain: *const XAUDIO2_EFFECT_CHAIN) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).5)(::std::mem::transmute_copy(self), ::std::mem::transmute(peffectchain)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn EnableEffect(&self, effectindex: u32, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).6)(::std::mem::transmute_copy(self), ::std::mem::transmute(effectindex), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn DisableEffect(&self, effectindex: u32, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).7)(::std::mem::transmute_copy(self), ::std::mem::transmute(effectindex), ::std::mem::transmute(operationset)).ok()
    }
    #[cfg(feature = "Win32_Foundation")]
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`, `Win32_Foundation`*"]
    pub unsafe fn GetEffectState(&self, effectindex: u32, penabled: *mut super::super::super::Foundation::BOOL) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).8)(::std::mem::transmute_copy(self), ::std::mem::transmute(effectindex), ::std::mem::transmute(penabled)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetEffectParameters(&self, effectindex: u32, pparameters: *const ::std::ffi::c_void, parametersbytesize: u32, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).9)(::std::mem::transmute_copy(self), ::std::mem::transmute(effectindex), ::std::mem::transmute(pparameters), ::std::mem::transmute(parametersbytesize), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetEffectParameters(&self, effectindex: u32, pparameters: *mut ::std::ffi::c_void, parametersbytesize: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).10)(::std::mem::transmute_copy(self), ::std::mem::transmute(effectindex), ::std::mem::transmute(pparameters), ::std::mem::transmute(parametersbytesize)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetFilterParameters(&self, pparameters: *const XAUDIO2_FILTER_PARAMETERS, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).11)(::std::mem::transmute_copy(self), ::std::mem::transmute(pparameters), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetFilterParameters(&self, pparameters: *mut XAUDIO2_FILTER_PARAMETERS) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).12)(::std::mem::transmute_copy(self), ::std::mem::transmute(pparameters)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetOutputFilterParameters<'a, Param0: ::windows::runtime::IntoParam<'a, IXAudio2Voice>>(&self, pdestinationvoice: Param0, pparameters: *const XAUDIO2_FILTER_PARAMETERS, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).13)(::std::mem::transmute_copy(self), pdestinationvoice.into_param().abi(), ::std::mem::transmute(pparameters), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetOutputFilterParameters<'a, Param0: ::windows::runtime::IntoParam<'a, IXAudio2Voice>>(&self, pdestinationvoice: Param0, pparameters: *mut XAUDIO2_FILTER_PARAMETERS) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).14)(::std::mem::transmute_copy(self), pdestinationvoice.into_param().abi(), ::std::mem::transmute(pparameters)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetVolume(&self, volume: f32, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).15)(::std::mem::transmute_copy(self), ::std::mem::transmute(volume), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetVolume(&self, pvolume: *mut f32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).16)(::std::mem::transmute_copy(self), ::std::mem::transmute(pvolume)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetChannelVolumes(&self, channels: u32, pvolumes: *const f32, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).17)(::std::mem::transmute_copy(self), ::std::mem::transmute(channels), ::std::mem::transmute(pvolumes), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetChannelVolumes(&self, channels: u32, pvolumes: *mut f32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).18)(::std::mem::transmute_copy(self), ::std::mem::transmute(channels), ::std::mem::transmute(pvolumes)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetOutputMatrix<'a, Param0: ::windows::runtime::IntoParam<'a, IXAudio2Voice>>(&self, pdestinationvoice: Param0, sourcechannels: u32, destinationchannels: u32, plevelmatrix: *const f32, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).19)(::std::mem::transmute_copy(self), pdestinationvoice.into_param().abi(), ::std::mem::transmute(sourcechannels), ::std::mem::transmute(destinationchannels), ::std::mem::transmute(plevelmatrix), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetOutputMatrix<'a, Param0: ::windows::runtime::IntoParam<'a, IXAudio2Voice>>(&self, pdestinationvoice: Param0, sourcechannels: u32, destinationchannels: u32, plevelmatrix: *mut f32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).20)(::std::mem::transmute_copy(self), pdestinationvoice.into_param().abi(), ::std::mem::transmute(sourcechannels), ::std::mem::transmute(destinationchannels), ::std::mem::transmute(plevelmatrix)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
...
pub struct IXAudio2MasteringVoice_abi(
    ...
    #[cfg(not(feature = "Win32_Foundation"))] usize,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, effectindex: u32, pparameters: *const ::std::ffi::c_void, parametersbytesize: u32, operationset: u32) -> ::windows::runtime::HRESULT,
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, effectindex: u32, pparameters: *mut ::std::ffi::c_void, parametersbytesize: u32) -> ::windows::runtime::HRESULT,
...
impl IXAudio2SourceVoice {
    ...
    pub unsafe fn Start(&self, flags: u32, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).22)(::std::mem::transmute_copy(self), ::std::mem::transmute(flags), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn Stop(&self, flags: u32, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).23)(::std::mem::transmute_copy(self), ::std::mem::transmute(flags), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SubmitSourceBuffer(&self, pbuffer: *const XAUDIO2_BUFFER, pbufferwma: *const XAUDIO2_BUFFER_WMA) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).24)(::std::mem::transmute_copy(self), ::std::mem::transmute(pbuffer), ::std::mem::transmute(pbufferwma)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    ...
    pub unsafe fn ExitLoop(&self, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).27)(::std::mem::transmute_copy(self), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetState(&self, pvoicestate: *mut XAUDIO2_VOICE_STATE, flags: u32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).28)(::std::mem::transmute_copy(self), ::std::mem::transmute(pvoicestate), ::std::mem::transmute(flags)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetFrequencyRatio(&self, ratio: f32, operationset: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).29)(::std::mem::transmute_copy(self), ::std::mem::transmute(ratio), ::std::mem::transmute(operationset)).ok()
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn GetFrequencyRatio(&self, pratio: *mut f32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).30)(::std::mem::transmute_copy(self), ::std::mem::transmute(pratio)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn SetSourceSampleRate(&self, newsourcesamplerate: u32) -> ::windows::runtime::Result<()> {
        (::windows::runtime::Interface::vtable(self).31)(::std::mem::transmute_copy(self), ::std::mem::transmute(newsourcesamplerate)).ok()
    }
}
...
impl IXAudio2VoiceCallback {
    ...
    pub unsafe fn OnVoiceProcessingPassStart(&self, bytesrequired: u32) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).3)(::std::mem::transmute_copy(self), ::std::mem::transmute(bytesrequired)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    ...
    pub unsafe fn OnBufferStart(&self, pbuffercontext: *mut ::std::ffi::c_void) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).6)(::std::mem::transmute_copy(self), ::std::mem::transmute(pbuffercontext)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn OnBufferEnd(&self, pbuffercontext: *mut ::std::ffi::c_void) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).7)(::std::mem::transmute_copy(self), ::std::mem::transmute(pbuffercontext)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn OnLoopEnd(&self, pbuffercontext: *mut ::std::ffi::c_void) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).8)(::std::mem::transmute_copy(self), ::std::mem::transmute(pbuffercontext)))
    }
    #[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
    pub unsafe fn OnVoiceError(&self, pbuffercontext: *mut ::std::ffi::c_void, error: ::windows::runtime::HRESULT) {
        ::std::mem::transmute((::windows::runtime::Interface::vtable(self).9)(::std::mem::transmute_copy(self), ::std::mem::transmute(pbuffercontext), ::std::mem::transmute(error)))
    }
}
...
pub struct IXAudio2VoiceCallback_abi(
    ...
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr),
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr),
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, pbuffercontext: *mut ::std::ffi::c_void),
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, pbuffercontext: *mut ::std::ffi::c_void),
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, pbuffercontext: *mut ::std::ffi::c_void),
    pub unsafe extern "system" fn(this: ::windows::runtime::RawPtr, pbuffercontext: *mut ::std::ffi::c_void, error: ::windows::runtime::HRESULT),
);
#[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
...
#[doc = "*Required features: `Win32_Media_Audio_XAudio2`*"]
#[inline]
pub unsafe fn XAudio2CreateWithVersionInfo(ppxaudio2: *mut ::std::option::Option<IXAudio2>, flags: u32, xaudio2processor: u32, ntddiversion: u32) -> ::windows::runtime::Result<()> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
        ...
        XAudio2CreateWithVersionInfo(::std::mem::transmute(ppxaudio2), ::std::mem::transmute(flags), ::std::mem::transmute(xaudio2processor), ::std::mem::transmute(ntddiversion)).ok()
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
