...
impl PreviewBuildsManager {
    ...
    pub fn IPreviewBuildsManagerStatics<
        R,
        F: FnOnce(&IPreviewBuildsManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for PreviewBuildsState {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Management.Update.PreviewBuildsState;{a2f2903e-b223-5f63-7546-3e8eac070a2e})",
    );
}
