...
impl ApplicationDataManager {
    ...
    >(
    ...
    ) -> ::windows::runtime::Result<super::super::Storage::ApplicationData> {
        Self::IApplicationDataManagerStatics(|this| unsafe {
            ...
            .from_abi::<super::super::Storage::ApplicationData>(result__)
        })
    }
    pub fn IApplicationDataManagerStatics<
        R,
        F: FnOnce(&IApplicationDataManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
