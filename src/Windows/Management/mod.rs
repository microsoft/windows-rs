...
impl MdmAlert {
    ...
    pub fn SetData<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        value: Param0,
    ...
    pub fn SetSource<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
    ...
    pub fn SetType<'a, Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>>(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
        let this = self;
...
unsafe impl ::windows::runtime::RuntimeType for MdmAlertDataType {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Management.MdmAlertDataType;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
unsafe impl ::windows::runtime::RuntimeType for MdmAlertMark {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Management.MdmAlertMark;i4)");
}
#[repr(transparent)]
#[derive(
    :: std :: cmp :: PartialEq,
...
impl MdmSession {
    ...
    pub fn Alerts(
        &self,
    ) -> ::windows::runtime::Result<super::Foundation::Collections::IVectorView<MdmAlert>> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::Foundation::Collections::IVectorView<MdmAlert>>(result__)
        }
    }
    ...
    pub fn StartWithAlertsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::Foundation::Collections::IIterable<MdmAlert>>,
    >(
        &self,
        alerts: Param0,
    ) -> ::windows::runtime::Result<super::Foundation::IAsyncAction> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).13)(
...
impl MdmSessionManager {
    #[cfg(feature = "Foundation_Collections")]
    pub fn SessionIds() -> ::windows::runtime::Result<
        super::Foundation::Collections::IVectorView<::windows::runtime::HSTRING>,
    > {
        Self::IMdmSessionManagerStatics(|this| unsafe {
            ...
            .from_abi::<super::Foundation::Collections::IVectorView<::windows::runtime::HSTRING>>(
                result__,
            )
        })
    }
    ...
    pub fn GetSessionById<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        sessionid: Param0,
    ) -> ::windows::runtime::Result<MdmSession> {
        Self::IMdmSessionManagerStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).9)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn IMdmSessionManagerStatics<
        R,
        F: FnOnce(&IMdmSessionManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for MdmSessionState {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Management.MdmSessionState;i4)");
}
