...
pub struct INamedPolicyStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        area: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
impl NamedPolicy {
    ...
    >(
        area: Param0,
        name: Param1,
    ) -> ::windows::runtime::Result<NamedPolicyData> {
    ...
    pub fn INamedPolicyStatics<
        R,
        F: FnOnce(&INamedPolicyStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<NamedPolicy, INamedPolicyStatics> =
...
unsafe impl ::windows::runtime::RuntimeType for NamedPolicyData {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Management.Policies.NamedPolicyData;{38dcb198-95ac-4077-a643-8078cae26400})",
    );
}
