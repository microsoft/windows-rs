...
impl MdmPolicy {
    ...
    pub fn IMdmAllowPolicyStatics<
        R,
        F: FnOnce(&IMdmAllowPolicyStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MdmPolicy, IMdmAllowPolicyStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IMdmPolicyStatics2<
        R,
        F: FnOnce(&IMdmPolicyStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MdmPolicy, IMdmPolicyStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl WorkplaceSettings {
    ...
    pub fn IWorkplaceSettingsStatics<
        R,
        F: FnOnce(&IWorkplaceSettingsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
