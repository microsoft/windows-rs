...
unsafe impl ::windows::runtime::Interface for ILocalCategoriesStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        33377,
        17185,
        [153, 116, 239, 146, 212, 154, 141, 202],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct ILocalLocationFinderResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut LocalLocationFinderStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct ILocalLocationFinderStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        searchterm: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        searcharea: ::windows::runtime::RawPtr,
        localcategory: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        maxresults: u32,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct ILocalLocationHoursOfOperationItem_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::Globalization::DayOfWeek,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for ILocalLocationRatingInfo {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        13140,
        17169,
        [139, 192, 162, 212, 213, 235, 128, 110],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IPlaceInfoHelperStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        location: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
);
...
impl LocalCategories {
    ...
    pub fn ILocalCategoriesStatics<
        R,
        F: FnOnce(&ILocalCategoriesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl LocalLocation {
    pub fn Address(&self) -> ::windows::runtime::Result<super::MapAddress> {
        ...
        unsafe {
            ...
            .from_abi::<super::MapAddress>(result__)
        }
    }
    ...
    pub fn Point(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Devices::Geolocation::Geopoint> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
            ...
            .from_abi::<super::super::super::Devices::Geolocation::Geopoint>(result__)
        }
    }
    ...
    pub fn RatingInfo(&self) -> ::windows::runtime::Result<LocalLocationRatingInfo> {
        ...
        unsafe {
            ...
            .from_abi::<LocalLocationRatingInfo>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
...
impl LocalLocationFinder {
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn FindLocalLocationsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::super::Devices::Geolocation::Geocircle>,
        Param2: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        searchterm: Param0,
        searcharea: Param1,
        localcategory: Param2,
        maxresults: u32,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<LocalLocationFinderResult>,
    > {
    ...
    pub fn ILocalLocationFinderStatics<
        R,
        F: FnOnce(&ILocalLocationFinderStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl LocalLocationFinderResult {
    ...
    pub fn LocalLocations(
        ...
        super::super::super::Foundation::Collections::IVectorView<LocalLocation>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::Collections::IVectorView<LocalLocation>>(
                result__,
            )
        }
    }
    pub fn Status(&self) -> ::windows::runtime::Result<LocalLocationFinderStatus> {
        ...
        unsafe {
            ...
            .from_abi::<LocalLocationFinderStatus>(result__)
        }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LocalLocationFinderResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl LocalLocationHoursOfOperationItem {
    ...
    pub fn Day(&self) -> ::windows::runtime::Result<super::super::super::Globalization::DayOfWeek> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::super::Globalization::DayOfWeek>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LocalLocationHoursOfOperationItem
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl LocalLocationRatingInfo {
    ...
    pub fn AggregateRating(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::IReference<f64>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::super::Foundation::IReference<f64>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn RatingCount(
...
impl PlaceInfoHelper {
    pub fn CreateFromLocalLocation<'a, Param0: ::windows::runtime::IntoParam<'a, LocalLocation>>(
        location: Param0,
    ) -> ::windows::runtime::Result<super::PlaceInfo> {
        Self::IPlaceInfoHelperStatics(|this| unsafe {
            ...
            .from_abi::<super::PlaceInfo>(result__)
        })
    }
    pub fn IPlaceInfoHelperStatics<
        R,
        F: FnOnce(&IPlaceInfoHelperStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
