...
impl EnhancedWaypoint {
    ...
    pub fn Point(
        &self,
    ) -> ::windows::runtime::Result<super::super::Devices::Geolocation::Geopoint> {
        let this = self;
        unsafe {
            ...
            .from_abi::<super::super::Devices::Geolocation::Geopoint>(result__)
        }
    }
    pub fn Kind(&self) -> ::windows::runtime::Result<WaypointKind> {
        ...
        unsafe {
            ...
            .from_abi::<WaypointKind>(result__)
        }
    }
    #[cfg(feature = "Devices_Geolocation")]
    pub fn Create<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
    >(
        point: Param0,
        kind: WaypointKind,
    ) -> ::windows::runtime::Result<EnhancedWaypoint> {
        Self::IEnhancedWaypointFactory(|this| unsafe {
            ...
            .from_abi::<EnhancedWaypoint>(result__)
        })
    }
    pub fn IEnhancedWaypointFactory<
        R,
        F: FnOnce(&IEnhancedWaypointFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
unsafe impl ::windows::runtime::RuntimeType for EnhancedWaypoint {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.EnhancedWaypoint;{ed268c74-5913-11e6-8b77-86f30ca893d3})",
    );
}
unsafe impl ::windows::runtime::Interface for EnhancedWaypoint {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        22803,
        4582,
        [139, 119, 134, 243, 12, 168, 147, 211],
    );
}
...
pub struct IManeuverWarning_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ManeuverWarningKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ManeuverWarningSeverity,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IMapAddress {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        41908,
        17556,
        [179, 255, 203, 169, 77, 182, 150, 153],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for IMapLocation {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        3492,
        17128,
        [158, 226, 169, 111, 207, 35, 113, 220],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IMapLocationFinderResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MapLocationFinderStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IMapLocationFinderStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        7261,
        20277,
        [162, 223, 170, 202, 148, 149, 149, 23],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IMapLocationFinderStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        querypoint: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        ...
        referencepoint: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Devices_Geolocation", feature = "Foundation")))] usize,
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
...
pub struct IMapRoute2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MapRouteRestrictions,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
...
pub struct IMapRoute3_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut TrafficCongestion,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IMapRoute4 {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        12371,
        20385,
        [128, 255, 212, 117, 243, 237, 30, 110],
    );
}
#[repr(C)]
#[doc(hidden)]
...
pub struct IMapRouteDrivingOptions_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MapRouteOptimization,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IMapRouteFinderResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MapRouteFinderStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IMapRouteFinderStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        startpoint: ::windows::runtime::RawPtr,
        endpoint: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Devices_Geolocation", feature = "Foundation")))] usize,
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    ...
    #[cfg(not(all(feature = "Devices_Geolocation", feature = "Foundation")))] usize,
    #[cfg(all(
        feature = "Devices_Geolocation",
        feature = "Foundation",
        feature = "Foundation_Collections"
    ))]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        waypoints: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(
        feature = "Devices_Geolocation",
...
pub struct IMapRouteManeuver_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MapRouteManeuverKind,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MapManeuverNotices,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IMapServiceStatics4_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut MapServiceDataUsagePreference,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
pub struct IPlaceInfoStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        identifier: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        defaultpoint: ::windows::runtime::RawPtr,
        options: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Devices_Geolocation"))] usize,
...
pub struct IPlaceInfoStatics2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        displayaddress: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl ManeuverWarning {
    pub fn Kind(&self) -> ::windows::runtime::Result<ManeuverWarningKind> {
        ...
        unsafe {
            ...
            .from_abi::<ManeuverWarningKind>(result__)
        }
    }
    pub fn Severity(&self) -> ::windows::runtime::Result<ManeuverWarningSeverity> {
        ...
        unsafe {
            ...
            .from_abi::<ManeuverWarningSeverity>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for ManeuverWarning {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.ManeuverWarning;{c1a36d8a-2630-4378-9e4a-6e44253dceba})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for MapAddress {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.MapAddress;{cfa7a973-a3b4-4494-b3ff-cba94db69699})",
    );
}
...
impl MapLocation {
    ...
    pub fn Address(&self) -> ::windows::runtime::Result<MapAddress> {
        ...
        unsafe {
            ...
            .from_abi::<MapAddress>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for MapLocation {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.MapLocation;{3c073f57-0da4-42e8-9ee2-a96fcf2371dc})",
    );
}
...
impl MapLocationFinder {
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn FindLocationsAtAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
    >(
        querypoint: Param0,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<MapLocationFinderResult>,
    > {
        Self::IMapLocationFinderStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                querypoint.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::Foundation::IAsyncOperation<MapLocationFinderResult>>(
                result__,
            )
        })
    }
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn FindLocationsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
    >(
        searchtext: Param0,
        referencepoint: Param1,
    ) -> ::windows::runtime::Result<
        super::super::Foundation::IAsyncOperation<MapLocationFinderResult>,
    > {
        Self::IMapLocationFinderStatics(|this| unsafe {
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn FindLocationsWithMaxCountAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
    >(
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn FindLocationsAtWithAccuracyAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
    >(
        querypoint: Param0,
    ...
    pub fn IMapLocationFinderStatics<
        R,
        F: FnOnce(&IMapLocationFinderStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IMapLocationFinderStatics2<
        R,
        F: FnOnce(&IMapLocationFinderStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl MapLocationFinderResult {
    ...
    pub fn Locations(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<MapLocation>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<MapLocation>>(result__)
        }
    }
    pub fn Status(&self) -> ::windows::runtime::Result<MapLocationFinderStatus> {
        ...
        unsafe {
            ...
            .from_abi::<MapLocationFinderStatus>(result__)
        }
    }
}
unsafe impl ::windows::runtime::RuntimeType for MapLocationFinderResult {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.MapLocationFinderResult;{43f1f179-e8cc-45f6-bed2-54ccbf965d9a})",
    );
}
...
impl MapManager {
    ...
    pub fn IMapManagerStatics<
        R,
        F: FnOnce(&IMapManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MapManager, IMapManagerStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl MapRoute {
    ...
    pub fn BoundingBox(
        &self,
    ) -> ::windows::runtime::Result<super::super::Devices::Geolocation::GeoboundingBox> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::Devices::Geolocation::GeoboundingBox>(result__)
        }
    }
    ...
    pub fn Path(&self) -> ::windows::runtime::Result<super::super::Devices::Geolocation::Geopath> {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Devices::Geolocation::Geopath>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Legs(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<MapRouteLeg>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<MapRouteLeg>>(result__)
        }
    }
    ...
    pub fn ViolatedRestrictions(&self) -> ::windows::runtime::Result<MapRouteRestrictions> {
        ...
        unsafe {
            ...
            .from_abi::<MapRouteRestrictions>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for MapRoute {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.MapRoute;{fb07b732-584d-4583-9c60-641fea274349})",
    );
}
...
impl MapRouteDrivingOptions {
    ...
    #[cfg(feature = "Foundation")]
    pub fn SetInitialHeading<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Foundation::IReference<f64>>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    pub fn RouteOptimization(&self) -> ::windows::runtime::Result<MapRouteOptimization> {
        ...
        unsafe {
            ...
            .from_abi::<MapRouteOptimization>(result__)
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for MapRouteDrivingOptions {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.MapRouteDrivingOptions;{6815364d-c6dc-4697-a452-b18f8f0b67a1})",
    );
}
...
impl MapRouteFinder {
    ...
    >(
        startpoint: Param0,
        endpoint: Param1,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<MapRouteFinderResult>>
    {
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn GetDrivingRouteWithOptimizationAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
    >(
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn GetDrivingRouteWithOptimizationAndRestrictionsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
    >(
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn GetDrivingRouteWithOptimizationRestrictionsAndHeadingAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
    >(
    ...
    pub fn GetDrivingRouteFromWaypointsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<
                super::super::Devices::Geolocation::Geopoint,
            >,
        >,
    >(
        waypoints: Param0,
    ...
    pub fn GetWalkingRouteFromWaypointsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn GetDrivingRouteWithOptionsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
        Param2: ::windows::runtime::IntoParam<'a, MapRouteDrivingOptions>,
    >(
        startpoint: Param0,
        endpoint: Param1,
        options: Param2,
    ...
    pub fn GetDrivingRouteFromEnhancedWaypointsAsync<
        ...
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<EnhancedWaypoint>,
        >,
    >(
        waypoints: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<MapRouteFinderResult>>
    ...
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn GetDrivingRouteFromEnhancedWaypointsWithOptionsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<EnhancedWaypoint>,
        >,
        Param1: ::windows::runtime::IntoParam<'a, MapRouteDrivingOptions>,
    >(
        waypoints: Param0,
        options: Param1,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<MapRouteFinderResult>>
    ...
    pub fn IMapRouteFinderStatics<
        R,
        F: FnOnce(&IMapRouteFinderStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IMapRouteFinderStatics2<
        R,
        F: FnOnce(&IMapRouteFinderStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
    ...
    pub fn IMapRouteFinderStatics3<
        R,
        F: FnOnce(&IMapRouteFinderStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl MapRouteFinderResult {
    ...
    pub fn Status(&self) -> ::windows::runtime::Result<MapRouteFinderStatus> {
        ...
        unsafe {
            ...
            .from_abi::<MapRouteFinderStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn AlternateRoutes(
        &self,
    ) -> ::windows::runtime::Result<super::super::Foundation::Collections::IVectorView<MapRoute>>
    {
...
unsafe impl ::windows::runtime::RuntimeType for MapRouteFinderResult {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.MapRouteFinderResult;{a868a31a-9422-46ac-8ca1-b1614d4bfbe2})",
    );
}
...
impl MapRouteLeg {
    ...
    pub fn Maneuvers(
        ...
        super::super::Foundation::Collections::IVectorView<MapRouteManeuver>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<MapRouteManeuver>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for MapRouteLeg {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.MapRouteLeg;{96f8b2f6-5bba-4d17-9db6-1a263fec7471})",
    );
}
...
impl MapRouteManeuver {
    ...
    pub fn Kind(&self) -> ::windows::runtime::Result<MapRouteManeuverKind> {
        ...
        unsafe {
            ...
            .from_abi::<MapRouteManeuverKind>(result__)
        }
    }
    ...
    pub fn ManeuverNotices(&self) -> ::windows::runtime::Result<MapManeuverNotices> {
        ...
        unsafe {
            ...
            .from_abi::<MapManeuverNotices>(result__)
        }
    }
    ...
    pub fn Warnings(
        ...
        super::super::Foundation::Collections::IVectorView<ManeuverWarning>,
    > {
        ...
        unsafe {
            ...
            .from_abi::<super::super::Foundation::Collections::IVectorView<ManeuverWarning>>(
                result__,
            )
        }
    }
...
unsafe impl ::windows::runtime::RuntimeType for MapRouteManeuver {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.MapRouteManeuver;{ed5c17f0-a6ab-4d65-a086-fa8a7e340df2})",
    );
}
...
impl MapService {
    ...
    pub fn DataUsagePreference() -> ::windows::runtime::Result<MapServiceDataUsagePreference> {
        Self::IMapServiceStatics4(|this| unsafe {
            ...
            .from_abi::<MapServiceDataUsagePreference>(result__)
        })
    }
    pub fn IMapServiceStatics<
        R,
        F: FnOnce(&IMapServiceStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MapService, IMapServiceStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IMapServiceStatics2<
        R,
        F: FnOnce(&IMapServiceStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MapService, IMapServiceStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IMapServiceStatics3<
        R,
        F: FnOnce(&IMapServiceStatics3) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MapService, IMapServiceStatics3> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IMapServiceStatics4<
        R,
        F: FnOnce(&IMapServiceStatics4) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<MapService, IMapServiceStatics4> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl MapServiceDataUsagePreference {
    ...
    pub const OfflineMapDataOnly: MapServiceDataUsagePreference =
        MapServiceDataUsagePreference(1i32);
}
...
impl PlaceInfo {
    ...
    pub fn Geoshape(
        &self,
    ) -> ::windows::runtime::Result<super::super::Devices::Geolocation::IGeoshape> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).11)(
    ...
    pub fn Create<
        ...
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
    >(
        referencepoint: Param0,
    ) -> ::windows::runtime::Result<PlaceInfo> {
        Self::IPlaceInfoStatics(|this| unsafe {
            ...
            .from_abi::<PlaceInfo>(result__)
        })
    }
    #[cfg(feature = "Devices_Geolocation")]
    pub fn CreateWithGeopointAndOptions<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
        Param1: ::windows::runtime::IntoParam<'a, PlaceInfoCreateOptions>,
    >(
        referencepoint: Param0,
        options: Param1,
    ) -> ::windows::runtime::Result<PlaceInfo> {
    ...
    #[cfg(feature = "Devices_Geolocation")]
    pub fn CreateFromIdentifierWithOptions<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, super::super::Devices::Geolocation::Geopoint>,
        Param2: ::windows::runtime::IntoParam<'a, PlaceInfoCreateOptions>,
    >(
        identifier: Param0,
        defaultpoint: Param1,
        options: Param2,
    ...
    pub fn CreateFromMapLocation<'a, Param0: ::windows::runtime::IntoParam<'a, MapLocation>>(
        location: Param0,
    ) -> ::windows::runtime::Result<PlaceInfo> {
        Self::IPlaceInfoStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn CreateFromAddress<
        ...
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        displayaddress: Param0,
    ) -> ::windows::runtime::Result<PlaceInfo> {
        Self::IPlaceInfoStatics2(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                displayaddress.into_param().abi(),
                &mut result__,
            )
            .from_abi::<PlaceInfo>(result__)
        })
    ...
    pub fn IPlaceInfoStatics<R, F: FnOnce(&IPlaceInfoStatics) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<PlaceInfo, IPlaceInfoStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IPlaceInfoStatics2<
        R,
        F: FnOnce(&IPlaceInfoStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<PlaceInfo, IPlaceInfoStatics2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
unsafe impl ::windows::runtime::RuntimeType for PlaceInfo {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.PlaceInfo;{9a0810b6-31c8-4f6a-9f18-950b4c38951a})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for PlaceInfoCreateOptions {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Maps.PlaceInfoCreateOptions;{cd33c125-67f1-4bb3-9907-ecce939b0399})",
    );
}
...
unsafe impl ::windows::runtime::RuntimeType for WaypointKind {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"enum(Windows.Services.Maps.WaypointKind;i4)");
}
