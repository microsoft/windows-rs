...
pub struct IOfflineMapPackage_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut OfflineMapPackageStatus,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct IOfflineMapPackageQueryResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut OfflineMapPackageQueryStatus,
    ) -> ::windows::runtime::HRESULT,
...
pub struct IOfflineMapPackageStartDownloadResult_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut OfflineMapPackageStartDownloadStatus,
    ) -> ::windows::runtime::HRESULT,
);
#[repr(transparent)]
#[derive(
...
unsafe impl ::windows::runtime::Interface for IOfflineMapPackageStatics {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        43057,
        19120,
        [148, 31, 105, 152, 250, 146, 146, 133],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IOfflineMapPackageStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        queryboundingbox: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Devices_Geolocation", feature = "Foundation")))] usize,
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        querycircle: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Devices_Geolocation", feature = "Foundation")))] usize,
);
...
impl OfflineMapPackage {
    pub fn Status(&self) -> ::windows::runtime::Result<OfflineMapPackageStatus> {
        ...
        unsafe {
            ...
            .from_abi::<OfflineMapPackageStatus>(result__)
        }
    }
    ...
    pub fn RequestStartDownloadAsync(
        ...
        super::super::super::Foundation::IAsyncOperation<OfflineMapPackageStartDownloadResult>,
    > {
        let this = self;
        unsafe {
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn FindPackagesAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Devices::Geolocation::Geopoint>,
    >(
        querypoint: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<OfflineMapPackageQueryResult>,
    > {
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn FindPackagesInBoundingBoxAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Devices::Geolocation::GeoboundingBox,
        >,
    >(
        queryboundingbox: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<OfflineMapPackageQueryResult>,
    > {
        Self::IOfflineMapPackageStatics(|this| unsafe {
            ...
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
                queryboundingbox.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<
                OfflineMapPackageQueryResult,
    ...
    #[cfg(all(feature = "Devices_Geolocation", feature = "Foundation"))]
    pub fn FindPackagesInGeocircleAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Devices::Geolocation::Geocircle>,
    >(
        querycircle: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<OfflineMapPackageQueryResult>,
    ...
    pub fn IOfflineMapPackageStatics<
        R,
        F: FnOnce(&IOfflineMapPackageStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl OfflineMapPackageQueryResult {
    pub fn Status(&self) -> ::windows::runtime::Result<OfflineMapPackageQueryStatus> {
        ...
        unsafe {
            ...
            .from_abi::<OfflineMapPackageQueryStatus>(result__)
        }
    }
    #[cfg(feature = "Foundation_Collections")]
    pub fn Packages(
        ...
        super::super::super::Foundation::Collections::IVectorView<OfflineMapPackage>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for OfflineMapPackageQueryResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a OfflineMapPackageQueryResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl OfflineMapPackageStartDownloadResult {
    pub fn Status(&self) -> ::windows::runtime::Result<OfflineMapPackageStartDownloadStatus> {
        ...
        unsafe {
            ...
            .from_abi::<OfflineMapPackageStartDownloadStatus>(result__)
        }
    }
}
...
impl ::std::convert::From<OfflineMapPackageStartDownloadResult>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a OfflineMapPackageStartDownloadResult
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl OfflineMapPackageStartDownloadStatus {
    pub const Success: OfflineMapPackageStartDownloadStatus =
        OfflineMapPackageStartDownloadStatus(0i32);
    pub const UnknownError: OfflineMapPackageStartDownloadStatus =
        OfflineMapPackageStartDownloadStatus(1i32);
    pub const InvalidCredentials: OfflineMapPackageStartDownloadStatus =
        OfflineMapPackageStartDownloadStatus(2i32);
    pub const DeniedWithoutCapability: OfflineMapPackageStartDownloadStatus =
        OfflineMapPackageStartDownloadStatus(3i32);
}
