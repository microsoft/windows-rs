...
impl CortanaActionableInsights {
    ...
    pub fn ShowInsightsForImageAsync<
        'a,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn ShowInsightsForImageWithOptionsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Storage::Streams::IRandomAccessStreamReference,
        >,
        Param1: ::windows::runtime::IntoParam<'a, CortanaActionableInsightsOptions>,
    >(
        &self,
        imagestream: Param0,
        options: Param1,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn ShowInsightsForTextAsync<
        'a,
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation")]
    pub fn ShowInsightsForTextWithOptionsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
        Param1: ::windows::runtime::IntoParam<'a, CortanaActionableInsightsOptions>,
    >(
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "ApplicationModel_DataTransfer", feature = "Foundation"))]
    pub fn ShowInsightsWithOptionsAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::ApplicationModel::DataTransfer::DataPackage,
    ...
    pub fn GetDefault() -> ::windows::runtime::Result<CortanaActionableInsights> {
        Self::ICortanaActionableInsightsStatics(|this| unsafe {
            ...
            .from_abi::<CortanaActionableInsights>(result__)
        })
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "System")]
    pub fn GetForUser<'a, Param0: ::windows::runtime::IntoParam<'a, super::super::System::User>>(
        user: Param0,
    ) -> ::windows::runtime::Result<CortanaActionableInsights> {
        Self::ICortanaActionableInsightsStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).7)(
                ::std::mem::transmute_copy(this),
    ...
    pub fn ICortanaActionableInsightsStatics<
        R,
        F: FnOnce(&ICortanaActionableInsightsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CortanaActionableInsights
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for CortanaActionableInsightsOptions
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CortanaActionableInsightsOptions
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for CortanaPermission {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Services.Cortana.CortanaPermission;i4)",
    );
}
#[derive(
    :: std :: cmp :: PartialEq,
...
impl CortanaPermissionsChangeResult {
    ...
    pub const DisabledByPolicy: CortanaPermissionsChangeResult =
        CortanaPermissionsChangeResult(2i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for CortanaPermissionsChangeResult {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.Services.Cortana.CortanaPermissionsChangeResult;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl CortanaPermissionsManager {
    ...
    pub fn ArePermissionsGrantedAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::Foundation::Collections::IIterable<CortanaPermission>,
        >,
    >(
        &self,
        permissions: Param0,
    ...
    >(
        ...
        super::super::Foundation::IAsyncOperation<CortanaPermissionsChangeResult>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<CortanaPermissionsChangeResult>>(
                result__,
            )
        }
    }
    ...
    pub fn GetDefault() -> ::windows::runtime::Result<CortanaPermissionsManager> {
        Self::ICortanaPermissionsManagerStatics(|this| unsafe {
            ...
            .from_abi::<CortanaPermissionsManager>(result__)
        })
    }
    pub fn ICortanaPermissionsManagerStatics<
        R,
        F: FnOnce(&ICortanaPermissionsManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a CortanaPermissionsManager
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl CortanaSettings {
    ...
    pub fn GetDefault() -> ::windows::runtime::Result<CortanaSettings> {
        Self::ICortanaSettingsStatics(|this| unsafe {
            ...
            .from_abi::<CortanaSettings>(result__)
        })
    }
    pub fn ICortanaSettingsStatics<
        R,
        F: FnOnce(&ICortanaSettingsStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
unsafe impl ::windows::runtime::RuntimeType for CortanaSettings {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"rc(Windows.Services.Cortana.CortanaSettings;{54d571a7-8062-40f4-abe7-dedfd697b019})",
    );
}
unsafe impl ::windows::runtime::Interface for CortanaSettings {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        32866,
        16628,
        [171, 231, 222, 223, 214, 151, 176, 25],
    );
}
...
pub struct ICortanaActionableInsights_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        datapackage: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct ICortanaPermissionsManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        permissions: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
