...
impl DualSimTile {
    ...
    ) -> ::windows::runtime::Result<super::super::UI::Notifications::TileUpdater> {
        Self::IDualSimTileStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).8)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::UI::Notifications::TileUpdater>(result__)
        })
    }
    #[cfg(feature = "UI_Notifications")]
    ...
    ) -> ::windows::runtime::Result<super::super::UI::Notifications::BadgeUpdater> {
        Self::IDualSimTileStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
                ::std::mem::transmute_copy(this),
            ...
            .from_abi::<super::super::UI::Notifications::BadgeUpdater>(result__)
        })
    }
    #[cfg(feature = "UI_Notifications")]
    ...
    ) -> ::windows::runtime::Result<super::super::UI::Notifications::ToastNotifier> {
        Self::IDualSimTileStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::UI::Notifications::ToastNotifier>(result__)
        })
    }
    #[cfg(feature = "UI_Notifications")]
    ...
    pub fn IDualSimTileStatics<
        R,
        F: FnOnce(&IDualSimTileStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<DualSimTile, IDualSimTileStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for IToastNotificationManagerStatics3 {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{2717f54b-50df-4455-8e6e-41e0fc8e13ce}");
}
