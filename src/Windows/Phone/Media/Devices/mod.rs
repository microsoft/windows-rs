...
impl AudioRoutingManager {
    ...
    pub fn AvailableAudioEndpoints(
        &self,
    ) -> ::windows::runtime::Result<AvailableAudioRoutingEndpoints> {
        let this = self;
        unsafe {
    ...
    pub fn IAudioRoutingManagerStatics<
        R,
        F: FnOnce(&IAudioRoutingManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
pub struct IAudioRoutingManager_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        endpointchangehandler: ::windows::runtime::RawPtr,
