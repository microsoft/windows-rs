...
impl ContactPartnerProvisioningManager {
    ...
    pub fn AssociateNetworkAccountAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::ContactStore>,
    ...
    pub fn IContactPartnerProvisioningManagerStatics<
        R,
        F: FnOnce(&IContactPartnerProvisioningManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ...
    pub fn IContactPartnerProvisioningManagerStatics2<
        R,
        F: FnOnce(&IContactPartnerProvisioningManagerStatics2) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
pub struct IContactPartnerProvisioningManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        networkname: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
...
pub struct IMessagePartnerProvisioningManagerStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        incoming: bool,
        read: bool,
        body: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        sender: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
    ...
    pub  unsafe extern "system" fn(
        ...
        recipients: ::windows::runtime::RawPtr,
        deliverytime: super::super::super::Foundation::DateTime,
        attachments: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(all(feature = "Foundation", feature = "Foundation_Collections")))] usize,
);
...
impl MessagePartnerProvisioningManager {
    ...
    pub fn IMessagePartnerProvisioningManagerStatics<
        R,
        F: FnOnce(&IMessagePartnerProvisioningManagerStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
