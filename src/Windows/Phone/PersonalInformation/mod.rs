...
impl ContactInformation {
    ...
    pub fn GetDisplayPictureAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Storage::Streams::IRandomAccessStream,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn IContactInformationStatics<
        R,
        F: FnOnce(&IContactInformationStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl<'a> ::windows::runtime::IntoParam<'a, IContactInformation> for &ContactInformation {
    fn into_param(self) -> ::windows::runtime::Param<'a, IContactInformation> {
        ::windows::runtime::Param::Owned(::std::convert::Into::<IContactInformation>::into(
...
impl ContactQueryResult {
    ...
    pub fn GetContactsAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<StoredContact>,
        >,
    > {
        let this = self;
        unsafe {
...
impl ContactStore {
    ...
    >(
        &self,
        id: Param0,
    ) -> ::windows::runtime::Result<super::super::Foundation::IAsyncOperation<StoredContact>> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
            ...
            .from_abi::<super::super::Foundation::IAsyncOperation<StoredContact>>(result__)
        }
    }
    #[cfg(feature = "Foundation")]
    pub fn FindContactByIdAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
    ...
    >(
        &self,
        options: Param0,
    ) -> ::windows::runtime::Result<ContactQueryResult> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).10)(
    ...
    pub fn GetChangesAsync(
        ...
        super::super::Foundation::IAsyncOperation<
            super::super::Foundation::Collections::IVectorView<ContactChangeRecord>,
        >,
    > {
        let this = self;
        unsafe {
    ...
    pub fn IContactStoreStatics<
        R,
        F: FnOnce(&IContactStoreStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<ContactStore, IContactStoreStatics> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
unsafe impl ::windows::runtime::RuntimeType for IContactInformation {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{e2b51ffc-e792-4ab7-b15b-f2e078664dea}");
}
...
unsafe impl ::windows::runtime::RuntimeType for IContactInformation2 {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{3198b20c-621e-4668-ac38-d667b87d06d5}");
}
...
pub struct IContactInformation2_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        returnvalue: super::super::Foundation::DateTime,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
);
#[repr(transparent)]
...
impl KnownContactProperties {
    ...
    pub fn IKnownContactPropertiesStatics<
        R,
        F: FnOnce(&IKnownContactPropertiesStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl StoredContact {
    ...
    pub fn CreateStoredContact<'a, Param0: ::windows::runtime::IntoParam<'a, ContactStore>>(
        store: Param0,
    ) -> ::windows::runtime::Result<StoredContact> {
    ...
    pub fn CreateStoredContactFromInformation<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, ContactStore>,
        Param1: ::windows::runtime::IntoParam<'a, ContactInformation>,
    >(
        store: Param0,
        contact: Param1,
    ) -> ::windows::runtime::Result<StoredContact> {
    ...
    pub fn IStoredContactFactory<
        R,
        F: FnOnce(&IStoredContactFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<StoredContact, IStoredContactFactory> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
