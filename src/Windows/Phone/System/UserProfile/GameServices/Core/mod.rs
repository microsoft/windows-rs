...
impl GameService {
    ...
    pub fn ServiceUri(
    ) -> ::windows::runtime::Result<super::super::super::super::super::Foundation::Uri> {
        Self::IGameService(|this| unsafe {
            ...
            .from_abi::<super::super::super::super::super::Foundation::Uri>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn GetGamerProfileAsync() -> ::windows::runtime::Result<
        super::super::super::super::super::Foundation::IAsyncOperation<
    ...
    > {
        Self::IGameService(|this| unsafe {
            ...
            .from_abi::<super::super::super::super::super::Foundation::IAsyncOperation<
                GameServicePropertyCollection,
            >>(result__)
        })
    }
    #[cfg(feature = "Foundation")]
    pub fn GetInstalledGameItemsAsync() -> ::windows::runtime::Result<
        super::super::super::super::super::Foundation::IAsyncOperation<
            GameServicePropertyCollection,
        >,
    > {
    ...
    pub fn GetPartnerTokenAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::super::super::Foundation::Uri>,
    >(
        audienceuri: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::super::super::Foundation::IAsyncOperation<::windows::runtime::HSTRING>,
    > {
        Self::IGameService(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(feature = "Foundation")]
    pub fn GetPrivilegesAsync() -> ::windows::runtime::Result<
        super::super::super::super::super::Foundation::IAsyncOperation<::windows::runtime::HSTRING>,
    > {
        Self::IGameService(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    pub fn PostResult<
        'a,
        Param4: ::windows::runtime::IntoParam<
            'a,
            super::super::super::super::super::Storage::Streams::IBuffer,
        >,
    >(
        gamevariant: u32,
    ...
    pub fn IGameService<R, F: FnOnce(&IGameService) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<GameService, IGameService> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
    pub fn IGameService2<R, F: FnOnce(&IGameService2) -> ::windows::runtime::Result<R>>(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<GameService, IGameService2> =
            ::windows::runtime::FactoryCache::new();
        unsafe { SHARED.call(callback) }
    }
}
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for GameServicePropertyCollection
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a GameServicePropertyCollection
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
pub struct IGameService_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        audienceuri: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(not(feature = "Foundation"))] usize,
    #[cfg(feature = "Foundation")]
