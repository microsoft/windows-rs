...
impl RetailMode {
    ...
    pub fn IRetailModeStatics<
        R,
        F: FnOnce(&IRetailModeStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<RetailMode, IRetailModeStatics> =
