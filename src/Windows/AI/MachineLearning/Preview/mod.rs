...
unsafe impl ::windows::runtime::RuntimeType for FeatureElementKindPreview {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.AI.MachineLearning.Preview.FeatureElementKindPreview;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
pub struct IImageVariableDescriptorPreview_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut super::super::super::Graphics::Imaging::BitmapPixelFormat,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for IInferencingOptionsPreview {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        19766,
        18345,
        [143, 104, 255, 203, 51, 157, 208, 252],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct IInferencingOptionsPreview_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut LearningModelDeviceKindPreview,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
pub struct ILearningModelBindingPreview_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        name: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        value: ::windows::runtime::RawPtr,
        metadata: ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
unsafe impl ::windows::runtime::Interface for ILearningModelEvaluationResultPreview {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        39011,
        16520,
        [132, 152, 135, 161, 244, 104, 111, 146],
    );
}
#[repr(C)]
#[doc(hidden)]
...
unsafe impl ::windows::runtime::Interface for ILearningModelPreview {
    ...
    const IID: ::windows::runtime::GUID = ::windows::runtime::GUID::from_values(
        ...
        37812,
        18316,
        [174, 184, 112, 21, 123, 240, 255, 148],
    );
}
#[repr(C)]
#[doc(hidden)]
pub struct ILearningModelPreview_abi(
    ...
    pub  unsafe extern "system" fn(
        ...
        correlationid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        features: ::windows::runtime::RawPtr,
        correlationid: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING>,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
pub struct ILearningModelPreviewStatics_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        modelfile: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        modelstream: ::windows::runtime::RawPtr,
        result__: *mut ::windows::runtime::RawPtr,
    ) -> ::windows::runtime::HRESULT,
...
impl ILearningModelVariableDescriptorPreview {
    ...
    pub fn ModelFeatureKind(&self) -> ::windows::runtime::Result<LearningModelFeatureKindPreview> {
        ...
        unsafe {
            ...
            .from_abi::<LearningModelFeatureKindPreview>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
...
unsafe impl ::windows::runtime::RuntimeType for ILearningModelVariableDescriptorPreview {
    const SIGNATURE: ::windows::runtime::ConstBuffer =
        ::windows::runtime::ConstBuffer::from_slice(b"{b13df682-fc30-492b-8ea0-ed1f53c0b038}");
}
impl ::std::convert::From<ILearningModelVariableDescriptorPreview>
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ILearningModelVariableDescriptorPreview
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ILearningModelVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
...
pub struct ILearningModelVariableDescriptorPreview_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut LearningModelFeatureKindPreview,
    ) -> ::windows::runtime::HRESULT,
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut bool,
...
pub struct IMapVariableDescriptorPreview_abi(
    ...
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
        result__: *mut FeatureElementKindPreview,
    ) -> ::windows::runtime::HRESULT,
    #[cfg(feature = "Foundation_Collections")]
    pub  unsafe extern "system" fn(
        this: ::windows::runtime::RawPtr,
...
impl ImageVariableDescriptorPreview {
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Graphics_Imaging")]
    pub fn BitmapPixelFormat(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Graphics::Imaging::BitmapPixelFormat> {
        let this = self;
        unsafe {
            let mut result__: super::super::super::Graphics::Imaging::BitmapPixelFormat =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<super::super::super::Graphics::Imaging::BitmapPixelFormat>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    ...
    pub fn Name(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
        let this =
            &::windows::runtime::Interface::cast::<ILearningModelVariableDescriptorPreview>(self)?;
        unsafe {
            let mut result__: ::std::mem::ManuallyDrop<::windows::runtime::HSTRING> =
                ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for ImageVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a ImageVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
}
impl ::std::convert::TryFrom<ImageVariableDescriptorPreview>
    for ILearningModelVariableDescriptorPreview
{
...
impl<'a> ::windows::runtime::IntoParam<'a, ILearningModelVariableDescriptorPreview>
    for ImageVariableDescriptorPreview
{
...
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ILearningModelVariableDescriptorPreview> {
        ::std::convert::TryInto::<ILearningModelVariableDescriptorPreview>::try_into(self)
...
impl InferencingOptionsPreview {
    #[cfg(feature = "deprecated")]
    pub fn PreferredDeviceKind(
        &self,
    ) -> ::windows::runtime::Result<LearningModelDeviceKindPreview> {
        let this = self;
        unsafe {
            ...
            .from_abi::<LearningModelDeviceKindPreview>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn SetPreferredDeviceKind(
        &self,
        value: LearningModelDeviceKindPreview,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a InferencingOptionsPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl LearningModelBindingPreview {
    ...
    pub fn First(
        ...
        super::super::super::Foundation::Collections::IIterator<
            super::super::super::Foundation::Collections::IKeyValuePair<
    ...
    pub fn Split(
        &self,
        first: &mut ::std::option::Option<
            super::super::super::Foundation::Collections::IMapView<
                ::windows::runtime::HSTRING,
                ::windows::runtime::IInspectable,
            >,
        >,
        second: &mut ::std::option::Option<
            super::super::super::Foundation::Collections::IMapView<
                ::windows::runtime::HSTRING,
                ::windows::runtime::IInspectable,
            >,
    ...
    #[cfg(feature = "deprecated")]
    pub fn CreateFromModel<'a, Param0: ::windows::runtime::IntoParam<'a, LearningModelPreview>>(
        model: Param0,
    ) -> ::windows::runtime::Result<LearningModelBindingPreview> {
        Self::ILearningModelBindingPreviewFactory(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                model.into_param().abi(),
                &mut result__,
            )
            .from_abi::<LearningModelBindingPreview>(result__)
        })
    }
    pub fn ILearningModelBindingPreviewFactory<
        R,
        F: FnOnce(&ILearningModelBindingPreviewFactory) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LearningModelBindingPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LearningModelBindingPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<LearningModelBindingPreview>
    for super::super::super::Foundation::Collections::IIterable<
        super::super::super::Foundation::Collections::IKeyValuePair<
            ::windows::runtime::HSTRING,
            ::windows::runtime::IInspectable,
        >,
...
#[cfg(feature = "Foundation_Collections")]
impl ::std::convert::TryFrom<LearningModelBindingPreview>
    for super::super::super::Foundation::Collections::IMapView<
        ::windows::runtime::HSTRING,
        ::windows::runtime::IInspectable,
    >
{
...
impl ::std::iter::IntoIterator for LearningModelBindingPreview {
    type Item = super::super::super::Foundation::Collections::IKeyValuePair<
        ::windows::runtime::HSTRING,
        ::windows::runtime::IInspectable,
    >;
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LearningModelDescriptionPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LearningModelDescriptionPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl LearningModelDeviceKindPreview {
    pub const LearningDeviceAny: LearningModelDeviceKindPreview =
        LearningModelDeviceKindPreview(0i32);
    pub const LearningDeviceCpu: LearningModelDeviceKindPreview =
        LearningModelDeviceKindPreview(1i32);
    pub const LearningDeviceGpu: LearningModelDeviceKindPreview =
        LearningModelDeviceKindPreview(2i32);
    pub const LearningDeviceNpu: LearningModelDeviceKindPreview =
        LearningModelDeviceKindPreview(3i32);
    pub const LearningDeviceDsp: LearningModelDeviceKindPreview =
        LearningModelDeviceKindPreview(4i32);
    pub const LearningDeviceFpga: LearningModelDeviceKindPreview =
        LearningModelDeviceKindPreview(5i32);
}
...
unsafe impl ::windows::runtime::RuntimeType for LearningModelDeviceKindPreview {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.AI.MachineLearning.Preview.LearningModelDeviceKindPreview;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LearningModelEvaluationResultPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl ::std::convert::From<LearningModelEvaluationResultPreview>
    for ::windows::runtime::IInspectable
{
    fn from(value: LearningModelEvaluationResultPreview) -> Self {
        value.0
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LearningModelEvaluationResultPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
unsafe impl ::windows::runtime::RuntimeType for LearningModelFeatureKindPreview {
    const SIGNATURE: ::windows::runtime::ConstBuffer = ::windows::runtime::ConstBuffer::from_slice(
        b"enum(Windows.AI.MachineLearning.Preview.LearningModelFeatureKindPreview;i4)",
    );
}
#[repr(transparent)]
#[derive(
...
impl LearningModelPreview {
    ...
    pub fn EvaluateAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, LearningModelBindingPreview>,
        Param1: ::windows::runtime::IntoParam<'a, ::windows::runtime::HSTRING>,
    >(
        &self,
        binding: Param0,
        correlationid: Param1,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<LearningModelEvaluationResultPreview>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "Foundation", feature = "Foundation_Collections"))]
    pub fn EvaluateFeaturesAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Foundation::Collections::IMap<
                ::windows::runtime::HSTRING,
                ::windows::runtime::IInspectable,
            >,
        >,
    ...
    pub fn Description(&self) -> ::windows::runtime::Result<LearningModelDescriptionPreview> {
        ...
        unsafe {
            ...
            .from_abi::<LearningModelDescriptionPreview>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn InferencingOptions(&self) -> ::windows::runtime::Result<InferencingOptionsPreview> {
        ...
        unsafe {
            ...
            .from_abi::<InferencingOptionsPreview>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn SetInferencingOptions<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, InferencingOptionsPreview>,
    >(
        &self,
        value: Param0,
    ) -> ::windows::runtime::Result<()> {
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "Foundation", feature = "Storage"))]
    pub fn LoadModelFromStorageFileAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<'a, super::super::super::Storage::IStorageFile>,
    >(
        modelfile: Param0,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::IAsyncOperation<LearningModelPreview>,
    > {
        Self::ILearningModelPreviewStatics(|this| unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
                ::std::mem::transmute_copy(this),
                modelfile.into_param().abi(),
                &mut result__,
            )
            .from_abi::<super::super::super::Foundation::IAsyncOperation<LearningModelPreview>>(
                result__,
            )
        })
    }
    #[cfg(feature = "deprecated")]
    #[cfg(all(feature = "Foundation", feature = "Storage_Streams"))]
    pub fn LoadModelFromStreamAsync<
        'a,
        Param0: ::windows::runtime::IntoParam<
            'a,
            super::super::super::Storage::Streams::IRandomAccessStreamReference,
        >,
    >(
        modelstream: Param0,
    ) -> ::windows::runtime::Result<
    ...
    pub fn ILearningModelPreviewStatics<
        R,
        F: FnOnce(&ILearningModelPreviewStatics) -> ::windows::runtime::Result<R>,
    >(
        callback: F,
    ) -> ::windows::runtime::Result<R> {
        static mut SHARED: ::windows::runtime::FactoryCache<
...
impl ::std::convert::From<&LearningModelVariableDescriptorPreview>
    for ::windows::runtime::IUnknown
{
    fn from(value: &LearningModelVariableDescriptorPreview) -> Self {
        ::std::convert::From::from(::std::clone::Clone::clone(value))
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for LearningModelVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a LearningModelVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
...
impl MapVariableDescriptorPreview {
    ...
    pub fn KeyKind(&self) -> ::windows::runtime::Result<FeatureElementKindPreview> {
        ...
        unsafe {
            ...
            .from_abi::<FeatureElementKindPreview>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation_Collections")]
    pub fn ValidStringKeys(
        &self,
    ) -> ::windows::runtime::Result<
        super::super::super::Foundation::Collections::IIterable<::windows::runtime::HSTRING>,
    > {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
    ...
    #[cfg(feature = "deprecated")]
    #[cfg(feature = "Foundation_Collections")]
    pub fn ValidIntegerKeys(
        &self,
    ) -> ::windows::runtime::Result<super::super::super::Foundation::Collections::IIterable<i64>>
    {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            ...
            .from_abi::<super::super::super::Foundation::Collections::IIterable<i64>>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn Fields(&self) -> ::windows::runtime::Result<ILearningModelVariableDescriptorPreview> {
        ...
        unsafe {
            ...
            .from_abi::<ILearningModelVariableDescriptorPreview>(result__)
        }
    }
    #[cfg(feature = "deprecated")]
    pub fn Name(&self) -> ::windows::runtime::Result<::windows::runtime::HSTRING> {
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for MapVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a MapVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
}
impl ::std::convert::TryFrom<MapVariableDescriptorPreview>
    for ILearningModelVariableDescriptorPreview
{
    type Error = ::windows::runtime::Error;
...
impl SequenceVariableDescriptorPreview {
    ...
    pub fn ElementType(
        &self,
    ) -> ::windows::runtime::Result<ILearningModelVariableDescriptorPreview> {
        let this = self;
        unsafe {
            let mut result__: ::windows::runtime::RawPtr = ::std::mem::zeroed();
            (::windows::runtime::Interface::vtable(this).6)(
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for SequenceVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a SequenceVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
}
impl ::std::convert::TryFrom<SequenceVariableDescriptorPreview>
    for ILearningModelVariableDescriptorPreview
{
    type Error = ::windows::runtime::Error;
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IUnknown>
    for TensorVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IUnknown> {
        ::windows::runtime::Param::Owned(
            ::std::convert::Into::<::windows::runtime::IUnknown>::into(self),
...
impl<'a> ::windows::runtime::IntoParam<'a, ::windows::runtime::IInspectable>
    for &'a TensorVariableDescriptorPreview
{
    fn into_param(self) -> ::windows::runtime::Param<'a, ::windows::runtime::IInspectable> {
        ::windows::runtime::Param::Borrowed(&self.0)
    }
}
impl ::std::convert::TryFrom<TensorVariableDescriptorPreview>
    for ILearningModelVariableDescriptorPreview
{
    type Error = ::windows::runtime::Error;
