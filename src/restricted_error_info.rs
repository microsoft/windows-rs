...
pub struct abi_IRestrictedErrorInfo {
    __base: [usize; 3],
    get_error_details: extern "system" fn(RawComPtr<IRestrictedErrorInfo>,*mut <BStr as RuntimeType>::Abi, *mut i32, *mut <BStr as RuntimeType>::Abi, *mut <BStr as RuntimeType>::Abi) -> ErrorCode,
}
