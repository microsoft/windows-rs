...
Rust trait. It is **part of [`windows-core`](windows-core.md)** and exists as a separate crate only
...
See [`windows-core`](windows-core.md) for how to declare an interface and pair it with
[`#[implement]`](windows-implement.md) - including a worked example and the `interface_decl!`
