        ...
        Windows::{
            ...
            Win32::{
                ...
                Graphics::{
                    ...
                    Dxgi::{
                        CreateDXGIFactory1, IDXGIAdapter, IDXGIDevice, IDXGIFactory2, IDXGIFactory7,
                        IDXGIOutput, IDXGISurface, IDXGISwapChain1, DXGI_ERROR_UNSUPPORTED,
                        DXGI_FORMAT, DXGI_PRESENT_TEST, DXGI_SAMPLE_DESC, DXGI_SWAP_CHAIN_DESC1,
